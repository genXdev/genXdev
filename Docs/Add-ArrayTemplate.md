...
```
Add-ArrayTemplate [-InputObject] <IEnumerable> [-Template] <String> [[-Delimiter] <String>]
 [[-Indentation] <Int32>] [-NewLine] [-EndDelimiter] [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
