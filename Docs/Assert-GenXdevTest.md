...
```
Assert-GenXdevTest [[-CmdletName] <String>] [[-TestFailedAction] <String>] [[-DefinitionMatches] <String>]
 [[-ModuleName] <String[]>] [-NoLocal] [-OnlyPublished] [-FromScripts] [-IncludeScripts]
 [-OnlyReturnModuleNames] [-ExactMatch] [-Verbosity <String>] [-StackTraceVerbosity <String>]
 [-AllowLongRunningTests] [-SkipModuleImports] [-SkipPSAnalyzerTests] [-SkipPesterTests]
...
Parameter Sets: (All)
Aliases:
Accepted values: None, FirstLine, Filtered, Full
...
Options: Ask, Continue, Stop, SolveWithAI, Write-Error, Throw

```yaml
Type: String
Parameter Sets: (All)
Aliases:
Accepted values: Ask, Continue, Stop, SolveWithAI, Write-Error, Throw
