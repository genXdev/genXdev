...
```
Confirm-InstallationConsent [-ApplicationName] <String> [-Source] <String> [-Description <String>]
 [-Publisher <String>] [-ForceConsent] [-ConsentToThirdPartySoftwareInstallation]
