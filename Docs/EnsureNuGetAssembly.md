...
```
EnsureNuGetAssembly [-PackageKey] <String> [-ManifestPath <String>] [-Version <String>] [-TypeName <String>]
 [-ForceLatest] [-Destination <String>] [-Description <String>] [-Publisher <String>] [-ForceConsent]
