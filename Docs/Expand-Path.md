...
```
Expand-Path [-FilePath] <String> [-CreateDirectory] [-CreateFile] [-DeleteExistingFile] [-ForceDrive <Char>]
 [-FileMustExist] [-DirectoryMustExist] [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
