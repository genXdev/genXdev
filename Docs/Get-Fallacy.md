...
```
Get-Fallacy [-InputObject] <Object> [[-Instructions] <String>] [[-Attachments] <String[]>]
 [-Functions <Hashtable[]>] [-ImageDetail <String>] [-NoConfirmationToolFunctionNames <String[]>]
 [-ExposedCmdLets <ExposedCmdletDefinition[]>] [-Temperature <Double>] [-LLMQueryType <String>]
 [-Model <String>] [-ApiEndpoint <String>] [-ApiKey <String>] [-TimeoutSeconds <Int32>]
 [-PreferencesDatabasePath <String>] [-ContinueLast] [-IncludeThoughts] [-NoSessionCaching] [-OpenInImdb]
 ...
 [-OnlyResponses] [-Speak] [-SpeakThoughts] [-SessionOnly] [-ClearSession] [-SkipSession]
