...
```
Get-TextTranslation [[-Text] <String>] [[-Attachments] <String[]>] [-Temperature <Double>]
 [-ImageDetail <String>] [-Functions <Hashtable[]>] [-ExposedCmdLets <ExposedCmdletDefinition[]>]
 [-NoConfirmationToolFunctionNames <String[]>] [-LLMType <String>] [-Model <String>] [-ApiEndpoint <String>]
 [-ApiKey <String>] [-PreferencesDatabasePath <String>] [-SetClipboard] [-DontAddThoughtsToHistory]
 [-ContinueLast] [-Speak] [-SpeakThoughts] [-NoSessionCaching] [-AllowDefaultTools] [-SessionOnly]
 [-ClearSession] [-SkipSession] [-AudioTemperature <Double>] [-TemperatureResponse <Double>]
 [-Language <String>] [-CpuThreads <Int32>] [-SuppressRegex <String>] [-AudioContextSize <Int32>]
 ...
 [-OutputMarkdownBlocksOnly] [-MarkupBlocksTypeFilter <String[]>] [-ProgressAction <ActionPreference>]
 [<CommonParameters>]
```
...
### -Language
Language code or name for processing (passed to LLM)
