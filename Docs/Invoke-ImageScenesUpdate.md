...
```
Invoke-ImageScenesUpdate [[-ImageDirectories] <String[]>] [-Recurse] [-OnlyNew] [-RetryFailed]
 ...
 [-Model <String>] [-ApiKey <String>] [-TimeoutSecond <Int32>] [-FacesDirectory <String>]
 [-PreferencesDatabasePath <String>] [-NoDockerInitialize] [-Force] [-UseGPU] [-ShowWindow] [-PassThru]
 [-AutoUpdateFaces] [-SessionOnly] [-ClearSession] [-SkipSession] [-ProgressAction <ActionPreference>]
 [<CommonParameters>]
```
