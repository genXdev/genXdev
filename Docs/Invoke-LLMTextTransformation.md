...
```
Invoke-LLMTextTransformation [[-Text] <String>] [[-Instructions] <String>] [[-Attachments] <String[]>]
 ...
 [-TimeoutSeconds <Int32>] [-PreferencesDatabasePath <String>] [-SetClipboard] [-DontAddThoughtsToHistory]
