...
```
Invoke-WindowsUpdate [-Install] [-AutoReboot] [[-Criteria] <String>] [-IncludeDrivers] [-GroupByCategory]
 [-NoBanner] [-NoRebootCheck] [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
