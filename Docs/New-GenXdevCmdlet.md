...
```
New-GenXdevCmdlet [-CmdletName] <String> [[-Synopsis] <String>] [[-Description] <String>]
 [[-BaseModuleName] <String>] [[-ModuleName] <String>] [[-CmdletAliases] <String[]>] [[-PromptKey] <String>]
 [[-Prompt] <String>] [-EditPrompt] [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
