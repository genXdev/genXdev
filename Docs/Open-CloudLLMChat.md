...
```
Open-CloudLLMChat [-Queries] <String[]> [[-EndPoint] <String>] [[-Language] <String>] [-Private] [-Force]
 [-Edge] [-Chrome] [-Chromium] [-Firefox] [-All] [-Monitor <Int32>] [-SideBySide] [-FullScreen] [-ShowWindow]
 ...
 [-KeysToSend <String[]>] [-FocusWindow] [-SetForeground] [-Maximize] [-SetRestored] [-Minimize]
 [-RestoreFocus] [-NewWindow] [-PassThru] [-ReturnURL] [-ReturnOnlyURL] [-SendKeyEscape]
 [-SendKeyHoldKeyboardFocus] [-SendKeyUseShiftEnter] [-SendKeyDelayMilliSeconds <Int32>]
...
Parameter Sets: (All)
Aliases:
Accepted values: BingCopilot, ChatGPT, DeepSearch, GithubCopilot, GoogleGemini, XGrok, All
