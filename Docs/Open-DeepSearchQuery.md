...
```
Open-DeepSearchQuery [-Queries] <String[]> [[-Language] <String>] [-Private] [-Force] [-Edge] [-Chrome]
 ...
 [-SetForeground] [-Maximize] [-SetRestored] [-RestoreFocus] [-NewWindow] [-PassThru] [-SendKeyEscape]
 [-SendKeyHoldKeyboardFocus] [-SendKeyUseShiftEnter] [-SendKeyDelayMilliSeconds <Int32>] [-NoBorders]
 [-SessionOnly] [-ClearSession] [-SkipSession] [-SideBySide] [-ProgressAction <ActionPreference>]
 [<CommonParameters>]
```
