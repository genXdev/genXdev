...
```
Open-SimularWebSiteInfo [-Queries] <String[]> [[-Language] <String>] [-Monitor <Int32>] [-Width <Int32>]
 [-Height <Int32>] [-X <Int32>] [-Y <Int32>] [-Left] [-Right] [-Top] [-Bottom] [-Centered] [-FullScreen]
 [-Private] [-NoBorders] [-Force] [-Edge] [-Chrome] [-Chromium] [-Firefox] [-All] [-ApplicationMode]
 [-NoBrowserExtensions] [-DisablePopupBlocker] [-AcceptLang <String>] [-KeysToSend <String[]>] [-SendKeyEscape]
 ...
 [-ReturnOnlyURL] [-SessionOnly] [-ClearSession] [-SkipSession] [-SideBySide]
