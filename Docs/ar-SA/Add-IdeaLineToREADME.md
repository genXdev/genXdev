...
> يُضيف عنصر فكرة إلى ملف README.md.

## Description

يضيف فكرة بختم زمني إلى القسم "## أفكار" في ملف README.md.
يمكن عرض القسم المعدل وفتحه في Visual Studio Code.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Line` | String | — | — | 0 | `''` | النص الفكرة لإضافته |
