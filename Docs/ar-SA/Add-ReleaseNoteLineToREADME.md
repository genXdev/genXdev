...
> يُضيف سطر ReleaseNote إلى ملف README مع طابع زمني.

## Description

يضيف سطر ReleaseNote إلى ملف README المحدد، مع بادئة التاريخ الحالي بتنسيق yyyyMMdd. يمكن تنسيق السطر كرمز وعرضه اختياريًا.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Line` | String | — | — | 0 | `''` | نص وصف ملاحظات الإصدار المراد إضافته |
...
> نص وصف ملاحظات الإصدار المراد إضافته
