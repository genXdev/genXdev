...
> يغلق واحدًا أو أكثر من مثيلات متصفح الويب بشكل انتقائي.

## Description

يوفر تحكمًا دقيقًا في إغلاق مثيلات متصفح الويب. يمكن استهداف متصفحات محددة (Edge, Chrome, Firefox) أو إغلاق جميع المتصفحات. يدعم إغلاق كل من النوافذ الرئيسية والعمليات الخلفية.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Edge` | SwitchParameter | — | — | Named | — | يغلق مثيلات متصفح Microsoft Edge *(Parameter set: )* |
| `-Chrome` | SwitchParameter | — | — | Named | — | يغلق مثيلات متصفح جوجل كروم *(Parameter set: )* |
| `-Chromium` | SwitchParameter | — | — | Named | — | يغلق المتصفح الافتراضي المستند على كروميوم *(Parameter set: )* |
| `-Firefox` | SwitchParameter | — | — | Named | — | يغلق مثيلات متصفح فايرفوكس *(Parameter set: )* |
...
| `-IncludeBackgroundProcesses` | SwitchParameter | — | — | Named | — | يغلق جميع المثيلات بما في ذلك المهام الخلفية |
...
> يغلق مثيلات متصفح Microsoft Edge
...
> يغلق المتصفح الافتراضي المستند على كروميوم
...
> يغلق جميع المثيلات بما في ذلك المهام الخلفية
