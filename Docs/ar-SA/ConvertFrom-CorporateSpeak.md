...
> يحول الخطاب المؤسسي المهذب والاحترافي إلى لغة مباشرة وواضحة باستخدام الذكاء الاصطناعي.

## Description

تقوم هذه الوظيفة بمعالجة النص المدخل لتحويل الاتصالات الدبلوماسية والشركات إلى لغة أكثر مباشرة ووضوحًا. يمكنها استقبال الإدخال مباشرة من خلال المعلمات، أو من خط الأنابيب، أو من الحافظة في النظام. تستخدم الوظيفة نماذج الذكاء الاصطناعي لتحليل النص وإعادة صياغته مع الحفاظ على الهدف الأصلي.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Text` | String | — | ✅ (ByValue) | 0 | — | النص المطلوب تحويله من لغة الشركات |
...
> النص المطلوب تحويله من لغة الشركات
