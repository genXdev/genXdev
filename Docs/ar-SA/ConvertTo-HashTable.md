...
> تحويل كائن PSCustomObject إلى جدول تجزئة بشكل تكراري.

## Description

* تحوّل هذه الوظيفة كائن PSCustomObject وجميع خصائص PSCustomObject المتداخلة فيه إلى جداول تجزئة.
* تتعامل مع المصفوفات وأنواع المجموعات الأخرى من خلال معالجة كل عنصر بشكل تكراري.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-InputObject` | Object | ✅ | ✅ (ByValue) | 0 | — | تحويل PSCustomObject إلى جدول تجزئة |
...
تحويل PSCustomObject إلى HashTable يحتوي على خصائص متداخلة.

## Parameter Details

### `-InputObject <Object>`

> تحويل PSCustomObject إلى جدول تجزئة
