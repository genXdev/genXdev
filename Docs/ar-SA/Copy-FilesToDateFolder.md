...
> ينسخ الملفات التي تطابق معايير البحث إلى مجلدات فرعية حسب التاريخ.

## Description

يبحث عن الملفات باستخدام نفس مجموعة المعلمات الخاصة بـ `Find-Item` وينسخ كل ملف مطابق إلى مجلد فرعي داخل `TargetFolder` بناءً على تاريخ إنشاء الملف أو تاريخ الوسائط. يدعم الأمر cmdlet مطابقة المحتوى، والبحث عبر محرك الأقراص، والعديد من المرشحات.

يحاول عدة استراتيجيات لتحديد تاريخ إنشاء أو التقاط دقيق للملف المحدد. تشمل الاستراتيجيات قراءة بيانات EXIF الوصفية للصور، وتحليل معلومات التاريخ/الوقت من أسماء الملفات، والرجوع إلى وقت آخر كتابة للملف في حالة عدم توفر معلومات موثوقة أخرى.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-TargetFolder` | String | ✅ | — | 0 | — | المجلد الجذر الهدف حيث سيتم نسخ الملفات المطابقة إلى مجلدات فرعية حسب التاريخ |
...
> المجلد الجذر الهدف حيث سيتم نسخ الملفات المطابقة إلى مجلدات فرعية حسب التاريخ
