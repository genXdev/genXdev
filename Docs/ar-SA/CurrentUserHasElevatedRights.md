...
> يتحقق مما إذا كان المستخدم الحالي يمتلك صلاحيات مرتفعة.

## Description

تحدد ما إذا كان مستخدم Windows الحالي لديه صلاحيات إدارية أو صلاحيات مشغل النسخ الاحتياطي من خلال التحقق من أدوار الأمان الأساسية الخاصة به. إرجاع صحيح إذا كان المستخدم لديه صلاحيات مرتفعة، وإلا إرجاع خطأ. توفر معالجة قوية للأخطاء المتعلقة بالأمان والوصول.
