...
> يبدأ تشغيل شاشة التوقف المكونة في ويندوز.

## Description

يقوم بتفعيل شاشة التوقف لنظام ويندوز عن طريق تشغيل الملف التنفيذي الافتراضي لشاشة التوقف (scrnsave.scr) مع المفتاح /s لبدء تشغيلها فورًا.
