...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-DisplacedVolumeInCubicMeters` | Double | ✅ | — | 0 | `0` | الحجم المزاح بالمتر المكعب |
| `-FluidDensityInKilogramsPerCubicMeter` | Double | ✅ | — | 1 | `0` | كثافة السائل بالكيلوغرام لكل متر مكعب |
| `-GravityInMetersPerSecondSquared` | Double | — | — | 2 | `0` | الجاذبية بوحدة م/ث² (الافتراضي: 9.81) |
| `-As` | String | — | — | 3 | — | وحدة إخراج القوة |

## Parameter Details

### `-DisplacedVolumeInCubicMeters <Double>`

> الحجم المزاح بالمتر المكعب
