...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-VelocityInMetersPerSecond` | Double | ✅ | — | 0 | `0` | السرعة بالمتر/ثانية |
| `-RadiusInMeters` | Double | ✅ | — | 1 | `0` | نصف القطر بالأمتار |
| `-As` | String | — | — | 2 | — | وحدة الإخراج للتسارع |
...
يحسب التسارع المركزي لسرعة 10 م/ث ونصف قطر 5 م، الناتج بوحدات g.
...
يحسب التسارع المركزي لسرعة 20 م/ث ونصف قطر 10 م باستخدام المعاملات الموضعية.
