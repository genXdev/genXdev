...
> يسترد جميع العمليات التي تنتمي إلى عملية PowerShell الحالية.

## Description

* يفحص جميع العمليات الجارية ويحدد تلك التي تحتوي على عملية PowerShell الحالية كسلف في سلسلة العملية الأصل.
* يشمل ذلك كلاً من العمليات الفرعية المباشرة ونسلها (الأحفاد، إلخ).
...
احصل على جميع العمليات الفرعية لجلسة PowerShell الحالية.
...
احصل على العمليات الفرعية مع إخراج مفصّل يظهر معلومات كشف العملية التفصيلية.
