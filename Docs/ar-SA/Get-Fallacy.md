...
> يحلل النص لتحديد المغالطات المنطقية باستخدام الكشف المدعوم بالذكاء الاصطناعي.

## Description

تقوم هذه الوظيفة بتحليل النص المقدم للكشف عن المغالطات المنطقية باستخدام نموذج ذكاء اصطناعي مدرب على قائمة المغالطات في ويكيبيديا. تُرجع معلومات مفصلة حول كل مغالطة تم العثور عليها، بما في ذلك الاقتباس المحدد، واسم المغالطة، والوصف، والشرح، والتصنيف الرسمي. تستخدم الوظيفة تنسيق استجابة منظم لضمان مخرجات متسقة.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-InputObject` | Object | ✅ | ✅ (ByValue) | 0 | — | السلام عليكم |
...
| `-AudioTemperature` | Double | — | — | Named | — | التحكم في درجة الحرارة لتوليد الصوت. |
| `-TemperatureResponse` | Double | — | — | Named | — | يتحكم في درجة حرارة توليد الاستجابة. |
| `-CpuThreads` | Int32 | — | — | Named | — | عدد خيوط المعالجة (CPU) التي يجب استخدامها للمعالجة. |
| `-SuppressRegex` | String | — | — | Named | — | تعبير نمطي لقمع بعض المخرجات. |
| `-AudioContextSize` | Int32 | — | — | Named | — | حجم سياق الصوت للمعالجة. |
| `-SilenceThreshold` | Double | — | — | Named | — | حد الكشف عن الصمت في الصوت. |
| `-LengthPenalty` | Double | — | — | Named | — | العقوبة المطبقة على الردود الأطول. |
| `-EntropyThreshold` | Double | — | — | Named | — | الحد الأدنى للإنتروبيا في توليد الردود. |
| `-LogProbThreshold` | Double | — | — | Named | — | حد احتمالية اللوغاريتم الناتج. |
| `-NoSpeechThreshold` | Double | — | — | Named | — | الحد الأدنى لاكتشاف عدم وجود كلام في الصوت. |
| `-DontSpeak` | SwitchParameter | — | — | Named | — | يمنع نطق الرد. |
| `-DontSpeakThoughts` | SwitchParameter | — | — | Named | — | يمنع التحدث بأفكار النموذج. |
| `-NoVOX` | SwitchParameter | — | — | Named | — | تعطيل VOX (التنشيط الصوتي). |
| `-UseDesktopAudioCapture` | SwitchParameter | — | — | Named | — | استخدم التقاط الصوت من سطح المكتب للإدخال. |
| `-NoContext` | SwitchParameter | — | — | Named | — | تعطيل السياق للطلب. |
| `-WithBeamSearchSamplingStrategy` | SwitchParameter | — | — | Named | — | استخدم استراتيجية أخذ العينات بالبحث الشعاعي. |
| `-OnlyResponses` | SwitchParameter | — | — | Named | — | هذا هو النص المترجم. |
...
يحلل النص المقدم من أجل المغالطات المنطقية ويعيد معلومات منظمة حول أي مغالطات تم اكتشافها.
...
تستخدم إدخال الأنابيب لتحليل النص بدرجة حرارة منخفضة للتحليل المركز.
...
يستخدم الاسم المستعار لتحليل النص بحثًا عن المغالطات المنطقية.
...
> التحكم في درجة الحرارة لتوليد الصوت.
...
> يتحكم في درجة حرارة توليد الاستجابة.
...
> عدد خيوط المعالجة (CPU) التي يجب استخدامها للمعالجة.
...
> العقوبة المطبقة على الردود الأطول.
...
> الحد الأدنى للإنتروبيا في توليد الردود.
...
> الحد الأدنى لاكتشاف عدم وجود كلام في الصوت.
...
> استخدم التقاط الصوت من سطح المكتب للإدخال.
