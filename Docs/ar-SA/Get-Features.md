...
> يعرض الميزات من ملف README.md.

## Description

يعرض جميع الميزات من قسم "## Features" في ملف README.md. يمكن استخدام README في الموقع الحالي، أو دليل ملف تعريف PowerShell، أو دليل OneDrive.
