...
> يعرض الأفكار من ملف README.md.

## Description

يعرض جميع الأفكار من قسم "## أفكار" في ملف README.md. يمكن استخدام إما ملف README في الموقع الحالي، أو دليل ملف تعريف PowerShell، أو دليل OneDrive.
