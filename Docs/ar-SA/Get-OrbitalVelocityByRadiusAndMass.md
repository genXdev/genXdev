...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-RadiusInMeters` | Double | ✅ | — | 0 | `0` | نصف القطر المداري بالأمتار |
| `-CentralMassInKilograms` | Double | ✅ | — | 1 | `0` | الكتلة المركزية بالكيلوغرام |
...
يستخدم كتلة الأرض ونصف قطرها للتوضيح.
...
حساب بسيط مع إخراج افتراضي بوحدة متر/ثانية.

## Parameter Details

### `-RadiusInMeters <Double>`

> نصف القطر المداري بالأمتار
