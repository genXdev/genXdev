...
> إرجاع كائن مساعد نافذة للنافذة الرئيسية لمحطة PowerShell.

## Description

* استرداد كائن مساعد WindowObj يمثل النافذة الرئيسية لعملية مضيف PowerShell الحالية.
* يسمح ذلك بالتعامل والتفاعل مع نافذة المحطة الطرفية نفسها.
...
استرداد كائن النافذة لنافذة محطة PowerShell الحالية.
