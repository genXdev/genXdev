...
يستخدم الصيغة R = (v² sin(2θ)) / g لحركة القذائف المثالية.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-InitialSpeedInMetersPerSecond` | Double | ✅ | — | 0 | `0` | السرعة الابتدائية بوحدة م/ث |
...
| `-As` | String | — | — | 3 | — | وحدة الإخراج للنطاق |
...
تحسب المدى باستخدام صيغة حركة المقذوفات.
...
يحسب النطاق باستخدام المعاملات الموضعية.
