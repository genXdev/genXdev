...
> يحسب زاوية الانكسار باستخدام قانون سنيل.

## Description

استخدم θ2 = arcsin( (n1 / n2) sin θ1 ).
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-IncidentAngleInDegrees` | Double | ✅ | — | 0 | `0` | زاوية السقوط بالدرجات |
| `-IndexOfRefraction1` | Double | ✅ | — | 1 | `0` | معامل الانكسار للوسط الأول |
| `-IndexOfRefraction2` | Double | ✅ | — | 2 | `0` | معامل الانكسار للوسط الثاني |
| `-As` | String | — | — | 3 | — | وحدة الإخراج للزاوية |
...
يحسب زاوية الانكسار عندما يمر الضوء من الهواء (معامل الانكسار = 1) إلى الماء (معامل الانكسار = 1.33) بزاوية سقوط مقدارها 30 درجة.
...
يحسب زاوية الانكسار عندما يمر الضوء من الهواء (n=1) إلى الزجاج (n=1.5) بزاوية سقوط 45 درجة.
