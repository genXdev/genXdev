...
> يعرض ReleaseNotes من ملف README.md.

## Description

يعرض جميع ملاحظات الإصدار من قسم "## ملاحظات الإصدار" في ملف README.md. يمكن استخدام إما ملف README في الموقع الحالي، أو دليل ملف تعريف PowerShell، أو دليل OneDrive.
...
| `-First` | Int32 | — | — | 0 | `0` | الحد من الإخراج إلى أول N سطر |
