...
> يحسب تردد الرنين لأنبوب مغلق.

## Description

يستخدم التردد الأساسي f = v / (4 L)
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-LengthInMeters` | Double | ✅ | — | 0 | `0` | الطول بالأمتار |
| `-SpeedInMetersPerSecond` | Double | ✅ | — | 1 | `0` | سرعة الموجة بوحدة م/ث *(Parameter set: )* |
| `-Medium` | String | ✅ | — | 1 | — | الوسيط *(Parameter set: )* |
| `-As` | String | — | — | 2 | — | وحدة الإخراج للتردد |
...
يحسب التردد الرنان لأنبوب طوله 0.5 متر في الهواء، الناتج بالكيلوهرتز.
...
يحسب تردد الرنين لأنبوب طوله متر واحد بسرعة موجة 343 م/ث.
