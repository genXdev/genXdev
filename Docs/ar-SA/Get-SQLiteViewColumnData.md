...
> يجلب بيانات الأعمدة من عرض SQLite مع تحديد اختياري للسجلات.

## Description

ينفذ استعلام SELECT على عرض SQLite محدد لاسترداد البيانات من عمود واحد. يدعم الاتصال إما عبر سلسلة اتصال أو مسار ملف قاعدة البيانات. يسمح بتحديد عدد السجلات المستردة أو استرداد جميع السجلات.
...
| `-ColumnName` | String | ✅ | — | 2 | — | اسم العمود. |
| `-Count` | Int32 | — | — | 3 | `100` | عدد السجلات المراد إرجاعها. القيمة الافتراضية هي 100. -1 للكل. |
