...
> تحسب زمن طيران المقذوف.

## Description

تستخدم T = (2 v sinθ) / g للحركة المثالية.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-InitialVelocityInMetersPerSecond` | Double | ✅ | — | 0 | `0` | السرعة الابتدائية بوحدة م/ث |
| `-AngleInDegrees` | Double | ✅ | — | 1 | `0` | زاوية الإطلاق بالدرجات |
| `-GravityInMetersPerSecondSquared` | Double | — | — | 2 | `0` | الجاذبية بوحدة م/ث² (الافتراضي: 9.81) |
| `-As` | String | — | — | 3 | — | وحدة إخراج للوقت |
...
تحسب زمن الطيران لقذيفة تُطلق بسرعة 20 م/ث بزاوية 45 درجة، الإخراج بالدقائق.
...
تحسب زمن الطيران لمقذوف يُطلق بسرعة 30 م/ث بزاوية 30 درجة.

## Parameter Details

### `-InitialVelocityInMetersPerSecond <Double>`

> السرعة الابتدائية بوحدة م/ث
...
> الجاذبية بوحدة م/ث² (الافتراضي: 9.81)
