...
> يعرض عناصر المهام من ملف README.md.

## Description

يعرض جميع عناصر المهام من قسم "## Todoos" في ملف README.md. يمكن استخدام README في الموقع الحالي، أو دليل ملف تعريف PowerShell، أو دليل OneDrive.
