...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-FrequencyInHertz` | Double | ✅ | — | 0 | `0` | التردد بالهرتز |
| `-WavelengthInMeters` | Double | ✅ | — | 1 | `0` | الطول الموجي بالأمتار |
| `-As` | String | — | — | 2 | — | وحدة الإخراج للسرعة |
...
تحسب سرعة الموجة باستخدام v = f * λ.
...
تحسب سرعة الموجة باستخدام معاملات الموضع.
