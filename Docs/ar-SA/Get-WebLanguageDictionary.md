...
> إرجاع قاموس معكوس لجميع اللغات التي تدعمها بحث Google.

## Description

* تقوم بإرجاع قاموس يربط أسماء اللغات برموزها المقابلة لجميع اللغات المدعومة من بحث Google.
* مفيد للبحث عن رموز اللغات في استعلامات الويب ومهام الترجمة.
...
يسترد قاموس تعيين أسماء اللغات إلى رموزها.
