...
> يحصل على معلومات الموقع والحالة للنوافذ.

## Description

يسترجع معلومات مفصلة عن موضع النافذة وحجمها وموضع الشاشة وحالة الإرساء وحالة التركيز للعمليات المحددة أو مقابض النوافذ.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-ProcessName` | String | — | ✅ (ByValue, ByPropertyName) | 0 | — | اسم العملية للنافذة للحصول على الموقع *(Parameter set: )* 🌐 *Supports wildcards* |
| `-Process` | Diagnostics.Process | — | ✅ (ByValue, ByPropertyName) | Named | — | عملية الحصول على موضع النافذة لـ *(Parameter set: )* |
...
> اسم العملية للنافذة للحصول على الموقع
...
> عملية الحصول على موضع النافذة لـ
