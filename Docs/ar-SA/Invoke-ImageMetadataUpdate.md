...
> تحديث بيانات EXIF الوصفية للصور في مجلد.

## Description

تستخرج هذه الوظيفة وتحديث بيانات EXIF الوصفية للصور في الأدلة المحددة.
تقوم بمعالجة كل صورة لاستخراج بيانات EXIF الوصفية التفصيلية بما في ذلك تفاصيل الكاميرا،
إحداثيات GPS، إعدادات التعريض، وغيرها من المعلومات التقنية. يتم تخزين البيانات
الوصفية في تدفقات NTFS بديلة كملف :EXIF.json لاستخدامها لاحقًا بواسطة وظائف
الفهرسة والبحث.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-ImageDirectories` | String[] | — | — | 0 | `@('.\')` | مصفوفة من مسارات الدليل لمعالجة تحديثات بيانات الصور الوصفية |
| `-RetryFailed` | SwitchParameter | — | — | Named | — | سيتم إعادة محاولة تحديث بيانات وصف الصورة التي فشلت سابقًا |
| `-OnlyNew` | SwitchParameter | — | — | Named | — | قم بمعالجة الصور التي لا تحتوي على ملفات بيانات وصفية فقط |
| `-Recurse` | SwitchParameter | — | — | Named | — | إذا تم التحديد، فسيقوم بمعالجة الصور في الدلائل الفرعية بشكل متكرر |
| `-Force` | SwitchParameter | — | — | Named | — | فرض إعادة بناء البيانات الوصفية حتى لو كانت موجودة بالفعل |
| `-PassThru` | SwitchParameter | — | — | Named | — | قم بإرجاع كائنات منظمة بدلاً من الإخراج إلى وحدة التحكم |
...
| `-SkipSession` | SwitchParameter | — | — | Named | — | لا تستخدم الإعدادات البديلة المخزنة في الجلسة لتفضيلات الذكاء الاصطناعي مثل اللغة، مجموعات الصور، إلخ |
...
> مصفوفة من مسارات الدليل لمعالجة تحديثات بيانات الصور الوصفية
...
> سيتم إعادة محاولة تحديث بيانات وصف الصورة التي فشلت سابقًا
...
> قم بمعالجة الصور التي لا تحتوي على ملفات بيانات وصفية فقط
...
> إذا تم التحديد، فسيقوم بمعالجة الصور في الدلائل الفرعية بشكل متكرر
...
> فرض إعادة بناء البيانات الوصفية حتى لو كانت موجودة بالفعل
...
> قم بإرجاع كائنات منظمة بدلاً من الإخراج إلى وحدة التحكم
...
> لا تستخدم الإعدادات البديلة المخزنة في الجلسة لتفضيلات الذكاء الاصطناعي مثل اللغة، مجموعات الصور، إلخ
