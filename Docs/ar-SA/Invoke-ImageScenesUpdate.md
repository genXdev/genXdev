...
> يقوم بتحديث بيانات تعريف تصنيف المشهد لملفات الصور في دليل محدد.

## Description

تعالج هذه الوظيفة الصور في دليل محدد لتصنيف المشاهد باستخدام الذكاء الاصطناعي. تنشئ ملفات وصفية بتنسيق JSON تحتوي على تصنيفات المشاهد ودرجات الثقة والتسميات. تدعم الوظيفة المعالجة المجمعة مع عتبات ثقة قابلة للتكوين، ويمكنها تخطي ملفات وصفية موجودة اختياريًا أو إعادة محاولة التصنيفات الفاشلة سابقًا.
...
يقوم بمعالجة جميع الصور في C:\Photos و D:\Pictures والأدلة الفرعية لتصنيف المشهد.
...
يستخدم الاسم المستعار لإعادة محاولة التصنيفات الفاشلة ومعالجة الصور الجديدة فقط في أدلة متعددة.
...
يُجبر إعادة بناء الحاوية ويستخدم تسريع GPU لمعالجة أسرع.
...
يقوم بمعالجة جميع الصور بشكل متكرر ويخزن فقط تصنيفات المشاهد بثقة >= 60%.
