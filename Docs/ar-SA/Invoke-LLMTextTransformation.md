...
> يحول النص باستخدام معالجة تعمل بالذكاء الاصطناعي.

## Description

تعالج هذه الوظيفة النص المدخل باستخدام نماذج الذكاء الاصطناعي لأداء تحويلات متنوعة مثل التدقيق الإملائي، إضافة الرموز التعبيرية، أو أي تحسين نصي آخر محدد من خلال التعليمات. يمكنها قبول الإدخال مباشرة عبر المعاملات، من خط الأنابيب، أو من الحافظة النظام.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Text` | String | — | ✅ (ByValue) | 0 | — | النص للتحويل |
| `-Instructions` | String | — | — | 1 | `('Check and correct any spelling or grammar ' +
            'errors in the text. Return the corrected text without any ' +
            'additional comments or explanations.')` | أوامر PowerShell (PowerShell Cmdlets) للنظام المالي |
...
> أوامر PowerShell (PowerShell Cmdlets) للنظام المالي
