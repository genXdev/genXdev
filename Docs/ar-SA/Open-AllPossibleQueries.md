...
> يفتح جميع أنواع الاستعلام الممكنة لمصطلحات البحث أو عناوين URL المقدمة.

## Description

تنفذ جميع cmdlets التي تتعامل مع استعلامات صفحات الويب، وتعالج كلاً من عناوين URL ومصطلحات البحث. بالنسبة لعناوين URL، تقوم باستعلامات خاصة بالموقع، وبالنسبة لمصطلحات البحث تنفذ استعلامات ويب عامة. تكتشف هذه الوظيفة وتنفذ ديناميكياً جميع cmdlets الاستعلام المتاحة من سلسلة وحدات GenXdev.Queries.
...
| `-SessionOnly` | SwitchParameter | — | — | Named | — | وضع الجلسة فقط لملف تعريف المتصفح. |
| `-ClearSession` | SwitchParameter | — | — | Named | — | امسح جلسة المتصفح قبل الفتح. |
| `-SkipSession` | SwitchParameter | — | — | Named | — | تجاوز استعادة جلسة المتصفح. |
...
يفتح جميع أنواع الاستعلامات الممكنة لـ "برمجة الباورشيل" على الشاشة الافتراضية.
...
يفتح جميع أنواع الاستعلامات الممكنة لرابط GitHub باستخدام الاسم المستعار والمعلمات القصيرة.
...
> وضع الجلسة فقط لملف تعريف المتصفح.
...
- [ConvertTo-Uris](https://github.com/genXdev/genXdev/blob/main/Docs/ar-SA/ConvertTo-Uris.md)
