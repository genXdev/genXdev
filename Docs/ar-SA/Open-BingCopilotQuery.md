...
> يفتح استعلام Bing CoPilot في متصفح ويب

## Description

يفتح استعلام Bing CoPilot في متصفح الويب. تقوم الوظيفة تلقائيًا بكتابة الاستعلام وإرساله باستخدام الوظيفة الأساسية Open-WebsiteAndPerformQuery. يوفر ذلك طريقة ملائمة للتفاعل مع Microsoft Copilot من PowerShell.
...
| `-ClearSession` | SwitchParameter | — | — | Named | — | امسح جلسة/ملف تعريف المتصفح قبل الفتح. |
| `-SkipSession` | SwitchParameter | — | — | Named | — | تخطي تحميل جلسة/ملف تعريف المتصفح. |
...
> امسح جلسة/ملف تعريف المتصفح قبل الفتح.
...
> تخطي تحميل جلسة/ملف تعريف المتصفح.
