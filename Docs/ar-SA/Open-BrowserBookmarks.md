...
> يفتح إشارات المتصفح التي تطابق معايير البحث المحددة.

## Description

يبحث في الإشارات المرجعية عبر متصفحات مايكروسوفت إيدج، جوجل كروم، وموزيلا فايرفوكس بناءً على استعلامات البحث المقدمة. يفتح الإشارات المرجعية المطابقة في المتصفح المحدد مع إعدادات نافذة وأوضاع متصفح قابلة للتكوين.

توفر هذه الدالة واجهة شاملة للعثور على إشارات المتصفح وفتحها مع خيارات تصفية وعرض متقدمة. وهي تدعم معايير بحث متعددة ويمكنها فتح النتائج في أي متصفح مثبت مع تخصيص واسع لتحديد موضع النافذة وسلوكها.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Queries` | String[] | — | ✅ (ByValue, ByPropertyName) | 0 | — | مصطلحات البحث لتصفية الإشارات المرجعية |
| `-Count` | Int32 | — | — | 1 | `50` | الحد الأقصى لعدد عناوين URL لفتحها |
| `-Edge` | SwitchParameter | — | — | Named | — | تحديد في Microsoft Edge |
| `-Chrome` | SwitchParameter | — | — | Named | — | تحديد في جوجل كروم |
| `-Firefox` | SwitchParameter | — | — | Named | — | حدد في فايرفوكس |
...
يبحث عن الإشارات المرجعية التي تحتوي على "github" في Microsoft Edge ويفتح أول 5 نتائج في المتصفح الافتراضي.
...
نفس ما سبق باستخدام الأسماء المستعارة - يبحث في إشارات Edge عن "gh" ويفتح 5 نتائج في المتصفح الافتراضي.
...
يبحث في إشارات كروم عن "تطوير" و"أدوات"، يفتح أول 10 نتائج في فايرفوكس على الجانب الأيسر من الشاشة.

## Parameter Details

### `-Queries <String[]>`

> مصطلحات البحث لتصفية الإشارات المرجعية
...
> الحد الأقصى لعدد عناوين URL لفتحها
