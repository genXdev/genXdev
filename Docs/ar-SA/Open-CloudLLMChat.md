...
> يفتح واجهة دردشة سحابية LLM للاستعلامات الذكية.

## Description

توفر هذه الوظيفة واجهة موحدة لفتح خدمات الدردشة السحابية المختلفة القائمة على الذكاء الاصطناعي في متصفح ويب. وهي تدعم منصات AI متعددة بما في ذلك ChatGPT وBingCopilot وGoogle Gemini وX Grok وDeepSearch وGitHub Copilot. تقوم الوظيفة تلقائيًا بتحديد الوظيفة المناسبة لنقطة النهاية وتمرير جميع المعلمات ذات الصلة لتكوين المتصفح وتحديد موضع النافذة.
...
| `-EndPoint` | String | — | — | 1 | `'XGrok'` | النقطة النهائية لاستدعاء الاستعلام عليها |
...
| `-Minimize` | SwitchParameter | — | — | Named | — | تصغير النافذة بعد تحديد الموقع |
...
يفتح ChatGPT ويُرسل الاستعلام حول وظائف PowerShell.
...
يستخدم الاسم المستعار لسؤال Google Gemini عن التعلم الآلي.
...
يعالج استعلامات متعددة عبر X Grok على الشاشة الافتراضية.
...
> النقطة النهائية لاستدعاء الاستعلام عليها
...
> تصغير النافذة بعد تحديد الموقع
...
- [Open-ChatGPTQuery](https://github.com/genXdev/genXdev/blob/main/Docs/ar-SA/Open-ChatGPTQuery.md)
