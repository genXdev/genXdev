...
> يفتح استعلام DeepSeek في متصفح ويب

## Description

يفتح استعلام DeepSeek في متصفح الويب، ويكتب الاستعلام ويضغط على Enter لتنفيذ البحث. تستخدم هذه الوظيفة محرك بحث DeepSeek الذكي لتقديم إجابات ورؤى ذكية للاستعلامات المقدمة.
...
يفتح DeepSeek ويبحث عن "دالة PowerShell" باستخدام الإعدادات الافتراضية.
...
استخدم الاسم المستعار للبحث عن "وظيفة باورشيل" مع المعلمات الافتراضية.
...
يفتح DeepSeek في وضع ملء الشاشة على الشاشة الأساسية للبحث عن "أساسيات تعلم الآلة".
