...
> يفتح كتالوج تطبيقات الويب التقدمية من GenXdev في متصفح ويب.

## Description

يفتح الكتالوج الذي يحتوي على تطبيقات GenXdev التقدمية المنشورة في متصفح الويب.
يفتح في وضع التطبيق مع تمكين وضع ملء الشاشة بشكل افتراضي لتوفير
تجربة مشاهدة مثالية للكتالوج. يدعم جميع خيارات تكوين متصفح الويب القياسية
بما في ذلك وضع الشاشة، وحجم النافذة، وتفضيلات اللغة.

تقوم الوظيفة تلقائيًا بتكوين المتصفح للحصول على أفضل تجربة مشاهدة للكتالوج
ويمكنها فتح مثيلات متعددة من المتصفح في وقت واحد. توفر
دعمًا شاملاً للغة وتحترم تفضيلات المستخدم لاختيار المتصفح
وموضع النافذة.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Language` | String | — | — | 0 | — | لغة نتائج البحث المُعادة |
...
| `-Monitor` | Int32 | — | — | Named | `-2` | الشاشة المستخدمة، 0 = الشاشة الافتراضية، -1 = تجاهل، -2 = الشاشة الثانوية المُهيأة، القيمة الافتراضية هي -1، بدون تحديد موضع |
| `-FullScreen` | SwitchParameter | — | — | Named | — | يفتح في وضع ملء الشاشة |
| `-ShowWindow` | SwitchParameter | — | — | Named | — | عرض نافذة المتصفح (غير مصغرة أو مخفية) |
...
يفتح كتالوج تطبيقات GenXdev على الشاشة 1 في وضع التطبيق مع تمكين وضع ملء الشاشة.
...
يفتح كتالوج تطبيقات GenXdev على الشاشة 1 باستخدام الأمر المستعار.
...
> عرض نافذة المتصفح (غير مصغرة أو مخفية)
...
- [Open-YabAIBattle](https://github.com/genXdev/genXdev/blob/main/Docs/ar-SA/Open-YabAIBattle.md)
