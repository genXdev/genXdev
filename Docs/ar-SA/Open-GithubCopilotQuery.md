...
> يفتح استعلام Github CoPilot في متصفح ويب

## Description

يفتح استعلام GitHub Copilot في متصفح الويب ويقوم تلقائيًا بإدخال الاستعلام المحدد. تنتظر الوظيفة تحميل الصفحة قبل كتابة الاستعلام. تستخدم هذه الوظيفة الوظيفة الأساسية Open-WebsiteAndPerformQuery للتعامل مع أتمتة المتصفح وتوفر طريقة ملائمة للتفاعل مع GitHub Copilot من PowerShell مع خيارات تكوين واسعة للمتصفح.
