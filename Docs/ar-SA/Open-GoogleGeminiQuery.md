...
> يفتح استعلام Google Gemini في متصفح ويب

## Description

يفتح استعلام Google Gemini في متصفح الويب، ويدخل الاستعلام تلقائيًا ويُرسله. يوفر ذلك طريقة سريعة للتفاعل مع ذكاء جوجل الاصطناعي Gemini. تدعم الوظيفة تحكمًا واسعًا في المتصفح بما في ذلك اختيار الشاشة، وتحديد موضع النافذة، وميزات أتمتة لوحة المفاتيح.
...
يفتح Google Gemini ويقدم الاستعلام "ما هو PowerShell؟".
...
يستخدم الاسم المستعار لإرسال استعلام حول المصفوفات عبر إدخال الأنابيب.
