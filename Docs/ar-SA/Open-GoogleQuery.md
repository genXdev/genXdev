...
> يفتح استعلامات جوجل في متصفح ويب مع إعدادات قابلة للتكوين وخيارات تخصيص واسعة.

## Description

يفتح استعلامات Google واحدة أو أكثر في متصفح ويب مع دعم شامل للغات متعددة، اختيار الشاشة، تحديد موضع النافذة، اختيار المتصفح، والأتمتة بلوحة المفاتيح. توفر الوظيفة واجهة غنية بالميزات لإجراء عمليات بحث Google مع تحكم دقيق في سلوك المتصفح ومظهره.

الميزات الرئيسية تشمل:
- دعم أكثر من 100 لغة عبر ترشيح لغة Google
- دعم الشاشات المتعددة مع اختيار تلقائي أو يدوي للشاشة
- تحديد موضع النافذة (يسار، يمين، أعلى، أسفل، توسيط، ملء الشاشة)
- دعم وضع التصفح الخاص/المجهول
- وضع التطبيق للتصفح بدون تشويش
- خيارات منع الملحقات والنوافذ المنبثقة
- إدارة التركيز ومعالجة النوافذ
- معالجة الدفعات من الاستعلامات مع دعم خط الأنابيب
- أتمتة ضغطات المفاتيح في نوافذ المتصفح
- تمرير ذكي للبارامترات إلى وظائف المتصفح الأساسية

تقوم الوظيفة بتنسيق استعلامات البحث تلقائياً لمحرك بحث Google وتطبيق ترشيح اللغة عند التحديد. جميع ميزات تحديد موضع المتصفح وإدارته موروثة من وظيفة Open-Webbrowser الأساسية.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Queries` | String[] | ✅ | ✅ (ByValue, ByPropertyName) | 0 | — | مصطلحات البحث للاستعلام على Google |
| `-Language` | String | — | — | 1 | — | اللغة المستخدمة في نتائج بحث Google |
...
يفتح بحث جوجل عن "برمجة PowerShell" باللغة الإنجليزية على الشاشة الأساسية.
...
يفتح بحث جوجل عن "خوارزميات التعلم الآلي" في وضع ملء الشاشة على الشاشة الثانية باستخدام الأسماء المستعارة.
...
يفتح عمليات بحث متعددة في Google عبر Chrome عبر إدخال الأنابيب، كل منها باللغة الإنجليزية.
...
يفتح بحثًا خاصًا عن "الذكاء الاصطناعي" في نافذة جديدة.
...
يفتح بحثًا في وضع التطبيق (بدون عناصر تحكم المتصفح) مع توسيطه على الشاشة.

## Parameter Details

### `-Queries <String[]>`

> مصطلحات البحث للاستعلام على Google
...
> اللغة المستخدمة في نتائج بحث Google
