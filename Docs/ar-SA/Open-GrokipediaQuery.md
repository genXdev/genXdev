...
> يفتح استعلام Grokipedia في متصفح الويب.

## Description

يفتح استعلام بحث واحد أو أكثر في جروكيبيديا في متصفح ويب مع خيارات تكوين واسعة. يدعم سلوك المتصفح القابل للتكوين، واختيار الشاشة، وتحديد موضع النافذة. يتم ترميز الاستعلامات بعنوان URL وفتحها باستخدام نطاق جروكيبيديا باللغة المحددة مع دعم توطين كامل.

توفر الوظيفة تحكمًا شاملاً في المتصفح بما في ذلك أوضاع التصفح الخاص، وتحديد موضع النافذة، وأتمتة لوحة المفاتيح، ودعم الشاشات المتعددة. تتعامل تلقائيًا مع ترميز URL ورسم خرائط رموز اللغة لنطاقات جروكيبيديا الدولية.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Queries` | String[] | ✅ | ✅ (ByValue, ByPropertyName) | 0 | — | استعلام بحث جروكيبيديا المراد تنفيذه |
...
يفتح بحث غروكيبيديا عن "PowerShell" باللغة الإنجليزية على الشاشة الافتراضية.
...
يفتح بحث جروكيبيديا باستخدام الاسم المستعار مع معاملات موضعية.
...
يبحث عن مصطلحات متعددة في جروكيبيديا باستخدام وضع التصفح الخاص.

## Parameter Details

### `-Queries <String[]>`

> استعلام بحث جروكيبيديا المراد تنفيذه
