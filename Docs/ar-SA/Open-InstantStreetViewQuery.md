...
> يفتح استعلامات InstantStreetView في متصفح ويب.

## Description

يفتح استعلامات InstantStreetView بطريقة قابلة للتكوين باستخدام وسائط سطر أوامر متصفح الويب. يدعم الاستعلامات المتعددة واختيار الشاشة. يوفر تحكمًا شاملاً في المتصفح بما في ذلك وضع النافذة وإعدادات اللغة والميزات الخاصة بالمتصفح.

تقوم الوظيفة تلقائيًا ببناء عناوين URL لـ InstantStreetView عن طريق ترميز استعلامات الموقع باستخدام URL وفتحها في المتصفح المحدد. تدعم جميع المتصفحات الرئيسية بما في ذلك Edge وChrome وFirefox مع خيارات تخصيص واسعة.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Queries` | String[] | ✅ | ✅ (ByValue, ByPropertyName) | 0 | — | استعلامات الموقع لعرضها في InstantStreetView |
...
| `-Monitor` | Int32 | — | — | Named | `-1` | الشاشة المراد استخدامها، 0 = الافتراضية، -1 = تجاهل، -2 = الشاشة الثانوية المكونة، القيمة الافتراضية هي $Global:DefaultSecondaryMonitor أو 2 إذا لم يتم العثور عليها |
...
يفتح InstantStreetView لـ Times Square في المتصفح الافتراضي على الشاشة الرئيسية.
...
يفتح InstantStreetView لبرج إيفل باستخدام الاسم المستعار 'isv' ويعرض على الشاشة الثانوية.
...
يفتح InstantStreetView لـ Big Ben باللغة الإنجليزية باستخدام وضع التصفح الخاص.
...
يفتح عدة استعلامات من InstantStreetView عبر خط الأنابيب في متصفح كروم
موضوعة على الجانب الأيسر من الشاشة.

## Parameter Details

### `-Queries <String[]>`

> استعلامات الموقع لعرضها في InstantStreetView
