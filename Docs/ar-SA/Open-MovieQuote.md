...
> يفتح مقطع فيديو لاقتباس من فيلم في متصفح ويب.

## Description

يبحث عن ويقتبس من الأفلام باستخدام playphrase.me، مع إمكانية تحديد إعدادات الشاشة والمتصفح. توفر هذه الوظيفة الوصول إلى قاعدة بيانات واسعة من اقتباسات الأفلام مع مقاطع فيديو، وتدعم لغات متعددة وخيارات متقدمة لتكوين المتصفح.

الميزات الرئيسية:
- البحث عن اقتباسات الأفلام من قاعدة بيانات واسعة
- دعم متعدد اللغات مع الكشف التلقائي عن اللغة
- تحديد موضع متقدم للمتصفح وإدارة النوافذ
- دعم متصفحات متعددة (Edge، Chrome، Firefox)
- دعم وضع التصفح الخاص
- أتمتة لوحة المفاتيح للتفاعل مع المتصفح
- دعم شاشات متعددة مع تحديد موضع دقيق
...
يفتح بحثًا عن الاقتباس الشهير من فيلم Terminator "سأعود".
...
يفتح بحثًا عن اقتباس كازابلانكا على الشاشة 1.
...
يفتح بحثًا عن اقتباس حرب النجوم باللغة الإنجليزية باستخدام التصفح الخاص.
...
يفتح عمليات بحث متعددة عن اقتباسات الأفلام في وضع الشاشة الكاملة في Chrome عبر خط الأنابيب.
