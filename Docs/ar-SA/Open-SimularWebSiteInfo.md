...
> يفتح معلومات موقع SimilarWeb للروابط المحددة في متصفح ويب.

## Description

يفتح استعلام "Similar web" في متصفح ويب بطريقة قابلة للتكوين باستخدام مفاتيح سطر الأوامر. يسمح بالتحقق من تحليلات مواقع الويب والمقارنات لتحليل حركة مرور موقع الويب وأبحاث المنافسين ورؤى التسويق الرقمي.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Queries` | String[] | ✅ | ✅ (ByValue, ByPropertyName) | 0 | — | روابط مواقع الويب لتحليلها على SimilarWeb |
...
يفتح تحليل SimilarWeb لـ Google.com على الشاشة الأساسية.
...
يفتح تحليل SimilarWeb باستخدام اسم الوظيفة مع وضعية المراقبة.
...
تحليل مواقع ويب متعددة من خلال إدخال خط الأنابيب مع وضع النافذة في المنتصف.
...
إرجاع رابط SimilarWeb لـ GitHub دون فتح المتصفح.

## Parameter Details

### `-Queries <String[]>`

> روابط مواقع الويب لتحليلها على SimilarWeb
