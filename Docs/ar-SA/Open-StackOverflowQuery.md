...
> يفتح استعلامات بحث Stack Overflow في متصفح الويب.

## Description

يفتح استعلام بحث واحد أو أكثر من Stack Overflow في متصفح ويب مع خيارات شاملة للمتصفح وإعدادات العرض. توفر هذه الدالة غلافًا متقدمًا حول وظيفة بحث Stack Overflow مع خيارات واسعة لوضع النافذة واختيار المتصفح وتخصيص السلوك.

الميزات الرئيسية:
- دعم استعلامات بحث متعددة مع إدخال خط الأنابيب
- كشف واختيار ذكي للمتصفح (Edge، Chrome، Firefox، جميع المتصفحات)
- وضع النافذة المتقدم (يسار، يمين، أعلى، أسفل، وسطي، ملء الشاشة)
- دعم شاشات متعددة مع اختيار تلقائي أو يدوي للشاشة
- دعم وضع التصفح الخاص/المجهول
- وضع التطبيق للتصفح بدون تشتيت
- دعم توطين اللغة لنتائج البحث الدولية
- خيارات حظر الإضافات والنوافذ المنبثقة
- إدارة التركيز ومعالجة النوافذ
- أتمتة ضغطات المفاتيح لنوافذ المتصفح
- خيارات إرجاع عنوان URL لسير العمل الآلي

تكتشف الدالة تلقائيًا إمكانيات النظام وتضبط السلوك وفقًا لذلك. بالنسبة للمتصفحات غير المثبتة على النظام، يتم تخطي العمليات بصمت دون أخطاء.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Queries` | String[] | ✅ | ✅ (ByValue, ByPropertyName) | 0 | — | استعلامات البحث الواجب إجراؤها على Stack Overflow |
| `-Language` | String | — | — | 1 | — | لغة نتائج البحث المرتجعة لمحتوى ستاك أوفرفلو المترجم |
...
| `-SessionOnly` | SwitchParameter | — | — | Named | — | استخدام الإعدادات البديلة المخزنة في الجلسة لتفضيلات بحث Stack Overflow |
| `-ClearSession` | SwitchParameter | — | — | Named | — | مسح الإعدادات البديلة المخزنة في الجلسة لتفضيلات البحث في Stack Overflow |
| `-SkipSession` | SwitchParameter | — | — | Named | — | تخزين الإعدادات فقط في التفضيلات الدائمة دون التأثير على الجلسة للبحث في Stack Overflow |
...
يفتح بحث Stack Overflow عن "مصفوفة PowerShell" على الشاشة الأساسية.
...
يفتح بحث Stack Overflow باستخدام الاسم المستعار مع تحديد موضع الشاشة.
...
يُفتح عمليات بحث متعددة على Stack Overflow في Chrome مع تفضيل اللغة الإنجليزية.
...
يُرجع رابط بحث Stack Overflow دون فتح متصفح.

## Parameter Details

### `-Queries <String[]>`

> استعلامات البحث الواجب إجراؤها على Stack Overflow
...
> لغة نتائج البحث المرتجعة لمحتوى ستاك أوفرفلو المترجم
...
> استخدام الإعدادات البديلة المخزنة في الجلسة لتفضيلات بحث Stack Overflow
...
> مسح الإعدادات البديلة المخزنة في الجلسة لتفضيلات البحث في Stack Overflow
...
> تخزين الإعدادات فقط في التفضيلات الدائمة دون التأثير على الجلسة للبحث في Stack Overflow
