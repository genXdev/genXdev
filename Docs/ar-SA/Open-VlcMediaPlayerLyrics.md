...
> يفتح متصفح ويب للبحث عن كلمات أغنية يتم تشغيلها حالياً في مشغل الوسائط VLC.

## Description

تكتشف هذه الوظيفة ما إذا كان مشغل الوسائط VLC قيد التشغيل وتبحث عن كلمات الأغاني بناءً على عنوان الوسائط المشغلة حاليًا. تفتح تلقائيًا استعلام بحث في متصفح الويب للعثور على كلمات الأغنية الحالية. تدعم الوظيفة متصفحات متعددة وتوفر خيارات واسعة لتحديد موضع النافذة وعرضها.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Queries` | String[] | — | ✅ (ByValue, ByPropertyName) 🌐 Remaining | 0 | — | عبارات البحث للعثور على مقطع صوتي |
| `-EndPoint` | String | — | — | 1 | `'Google'` | النقطة النهائية لاستدعاء الاستعلام |
...
| `-SessionOnly` | SwitchParameter | — | — | Named | — | استخدم جلسة لا يتم حفظها بعد إغلاق المتصفح |
| `-ClearSession` | SwitchParameter | — | — | Named | — | مسح بيانات جلسة المتصفح قبل فتح المتصفح |
| `-SkipSession` | SwitchParameter | — | — | Named | — | تخطي أي جلسة متصفح حالية |
...
يفتح بحث Google عن كلمات الأغنية التي يتم تشغيلها حاليًا في مشغل VLC.
...
يفتح بحث كلمات الأغاني في Microsoft Edge باستخدام وضع التصفح الخاص/المجهول.

## Parameter Details

### `-Queries <String[]>`

> عبارات البحث للعثور على مقطع صوتي
...
> النقطة النهائية لاستدعاء الاستعلام
...
> استخدم جلسة لا يتم حفظها بعد إغلاق المتصفح
...
> مسح بيانات جلسة المتصفح قبل فتح المتصفح
