...
> يفتح معلومات موقع WaybackMachine في متصفح الويب.

## Description

يفتح استعلام Waybackmachine في متصفح ويب، ويعرض الإصدارات التاريخية لعنوان URL أو موقع ويب محدد. يدعم الاستعلامات المتعددة واختيار الشاشة. يوفر الوصول إلى محتوى الويب المؤرشف عبر خدمة Wayback Machine من أرشيف الإنترنت.
...
| `-Language` | String | — | — | 1 | — | تفضيل اللغة لواجهة المتصفح والمحتوى |
...
| `-SessionOnly` | SwitchParameter | — | — | Named | — | استخدم الإعدادات البديلة المخزنة في الجلسة لتفضيلات أرشيف واي باك |
| `-ClearSession` | SwitchParameter | — | — | Named | — | مسح الإعدادات البديلة المخزنة في الجلسة لتفضيلات Wayback Machine |
...
يفتح أرشيف Wayback Machine لـ example.com على الشاشة الافتراضية.
...
يفتح أرشيف Wayback Machine لـ example.com باستخدام الأسماء المستعارة مع تجاهل وضع المراقبة.
...
يفتح أرشيف Wayback Machine لموقع microsoft.com في وضع التصفح المتخفي في Chrome.
...
> تفضيل اللغة لواجهة المتصفح والمحتوى
...
> استخدم الإعدادات البديلة المخزنة في الجلسة لتفضيلات أرشيف واي باك
...
> مسح الإعدادات البديلة المخزنة في الجلسة لتفضيلات Wayback Machine
