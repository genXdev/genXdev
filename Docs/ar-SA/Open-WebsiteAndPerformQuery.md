...
> يفتح صفحة ويب في متصفح ويب ويقوم بإجراء استعلام واحد أو أكثر.

## Description

تفتح هذه الوظيفة موقع ويب بواسطة عنوان URL في متصفح الويب الافتراضي، وتدخل استعلامًا واحدًا أو أكثر وتقدمها. وهي تدعم خيارات واسعة لاختيار الشاشة وتحديد موضع النافذة من خلال وظيفة Open-Webbrowser الأساسية.

تقوم الوظيفة بنسخ كل استعلام تلقائيًا إلى الحافظة وترسله إلى نافذة المتصفح باستخدام أتمتة لوحة المفاتيح. وتحافظ على محتوى الحافظة الأصلي وتستعيده بعد معالجة جميع الاستعلامات.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Url` | String | ✅ | ✅ (ByPropertyName) | 0 | — | عنوان URL للموقع الذي سيتم فتحه |
| `-Queries` | String[] | ✅ | ✅ (ByValue, ByPropertyName) | 1 | — | الاستعلام الذي سيتم تنفيذه. |
...
| `-SendKeyDelayMilliSeconds` | Int32 | — | — | Named | `500` | التأخير بين إرسال تسلسلات المفاتيح المختلفة بالملي ثانية |
...
يفتح Google ويبحث عن "دروس PowerShell" على الشاشة الافتراضية.

## Parameter Details

### `-Url <String>`

> عنوان URL للموقع الذي سيتم فتحه
