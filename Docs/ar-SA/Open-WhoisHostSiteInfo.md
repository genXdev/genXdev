...
> يفتح استعلام معلومات مضيف Whois في متصفح ويب.

## Description

يفتح استعلامات معلومات مضيف Whois في متصفح ويب لأسماء النطاقات أو عناوين IP. يدعم اختيار شاشة قابل للتكوين واستعلامات متعددة مع خيارات تكوين متصفح واسعة النطاق بما في ذلك تحديد موضع النافذة واختيار المتصفح وميزات التشغيل الآلي.
...
| `-SessionOnly` | SwitchParameter | — | — | Named | — | استخدم الإعدادات البديلة المخزنة في الجلسة لتفضيلات الذكاء الاصطناعي مثل اللغة، مجموعات الصور، إلخ. |
...
| `-SkipSession` | SwitchParameter | — | — | Named | — | قم بتخزين الإعدادات فقط في التفضيلات الدائمة دون التأثير على الجلسة بالنسبة لتفضيلات الذكاء الاصطناعي مثل اللغة ومجموعات الصور وما إلى ذلك. |
...
يفتح معلومات Whois لنطاقات متعددة على الشاشة الافتراضية.
...
يفتح معلومات Whois عن example.com باستخدام الأسماء المستعارة والمعلمات الموضعية.
...
يفتح معلومات Whois للنطاقات من خط الأنابيب في وضع التصفح الخاص في Chrome.
...
> استخدم الإعدادات البديلة المخزنة في الجلسة لتفضيلات الذكاء الاصطناعي مثل اللغة، مجموعات الصور، إلخ.
...
> قم بتخزين الإعدادات فقط في التفضيلات الدائمة دون التأثير على الجلسة بالنسبة لتفضيلات الذكاء الاصطناعي مثل اللغة ومجموعات الصور وما إلى ذلك.
