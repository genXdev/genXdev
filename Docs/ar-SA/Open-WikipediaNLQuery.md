...
> يفتح عمليات البحث في ويكيبيديا الهولندية في متصفح ويب.

## Description

يفتح استعلام 'ويكيبيديا - هولندا' في متصفح ويب، مع خيارات عرض قابلة للتكوين. يدعم البحث عن مصطلحات متعددة وتحديد الشاشة التي سيتم عرض النتائج عليها.
...
| `-SideBySide` | SwitchParameter | — | — | Named | — | يفتح نافذتي متصفح جنبًا إلى جنب |
| `-SessionOnly` | SwitchParameter | — | — | Named | — | استخدام ملفات تعريف الارتباط الخاصة بالجلسة فقط (بدون ملفات تعريف ارتباط دائمة) |
| `-ClearSession` | SwitchParameter | — | — | Named | — | مسح بيانات جلسة المتصفح قبل الفتح |
| `-SkipSession` | SwitchParameter | — | — | Named | — | تخطي استعادة جلسة المتصفح السابقة |
...
> يفتح نافذتي متصفح جنبًا إلى جنب
...
> استخدام ملفات تعريف الارتباط الخاصة بالجلسة فقط (بدون ملفات تعريف ارتباط دائمة)
...
> مسح بيانات جلسة المتصفح قبل الفتح
...
> تخطي استعادة جلسة المتصفح السابقة
