...
> يفتح استعلام ويكيبيديا في متصفح ويب.

## Description

يفتح استعلام بحث ويكيبيديا واحد أو أكثر في متصفح ويب مع خيارات تهيئة واسعة. يدعم سلوك المتصفح القابل للتهيئة، واختيار الشاشة، وتحديد مواضع النوافذ. يتم ترميز الاستعلامات بعنوان URL وفتحها باستخدام نطاق ويكيبيديا للغة المحددة مع دعم توطين كامل.

توفر الوظيفة تحكمًا شاملاً في المتصفح بما في ذلك أوضاع التصفح الخاص، وتحديد مواضع النوافذ، وأتمتة لوحة المفاتيح، ودعم الشاشات المتعددة. تتعامل تلقائيًا مع ترميز عنوان URL وتعيين رمز اللغة لنطاقات ويكيبيديا الدولية.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Queries` | String[] | ✅ | ✅ (ByValue, ByPropertyName) | 0 | — | استعلام بحث ويكيبيديا الذي سيتم تنفيذه |
| `-Language` | String | — | — | 1 | — | لغة نتائج بحث ويكيبيديا |
...
| `-Monitor` | Int32 | — | — | Named | `-1` | الشاشة المستخدمة، 0 = افتراضي، -1 = تجاهل، -2 = الشاشة الثانوية المهيأة |
...
| `-PassThru` | SwitchParameter | — | — | Named | — | إرجاع كائن عملية PowerShell يمثل عملية المتصفح |
...
يفتح بحثًا في ويكيبيديا عن "PowerShell" باللغة الإنجليزية على الشاشة الافتراضية.
...
يفتح بحث ويكيبيديا باستخدام الاسم المستعار مع معلمات الموضع.
...
يبحث عن مصطلحات متعددة في ويكيبيديا الألمانية باستخدام وضع التصفح الخاص.

## Parameter Details

### `-Queries <String[]>`

> استعلام بحث ويكيبيديا الذي سيتم تنفيذه
...
> الشاشة المستخدمة، 0 = افتراضي، -1 = تجاهل، -2 = الشاشة الثانوية المهيأة
...
> إرجاع كائن عملية PowerShell يمثل عملية المتصفح
