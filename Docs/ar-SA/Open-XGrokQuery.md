...
> يفتح استعلام X Grok في متصفح ويب

## Description

يفتح استعلام Groq X في متصفح الويب، ويكتب الاستعلام ويضغط على Enter لتنفيذ البحث. توفر هذه الوظيفة طريقة ملائمة للتفاعل مع مساعد Groq AI الخاص بـ X من خلال التحكم الآلي في المتصفح. تدعم الوظيفة تحكمًا واسعًا في المتصفح بما في ذلك اختيار الشاشة، وتحديد موضع النافذة، وميزات التشغيل الآلي للوحة المفاتيح.
