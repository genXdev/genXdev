...
> يفتح لعبة YAB في متصفح ويب مع إعدادات قابلة للتكوين.

## Description

يفتح موقع لعبة YAB في متصفح محدد مع خيارات عرض وسلوك متنوعة. يدعم أوضاع اللعبة المختلفة بما في ذلك وضع المشاهد. لعبة YAB هي لعبة ألغاز على الإنترنت يمكن لعبها بشكل تفاعلي أو مشاهدتها في وضع المشاهد حيث يلعب الذكاء الاصطناعي تلقائيًا.
...
يفتح لعبة YAB في وضع المشاهد باستخدام متصفح كروم بدون وضع ملء الشاشة، مع واجهة باللغة الإنجليزية.
...
يفتح لعبة YAB في متصفح Edge مع التصفح الخاص على الشاشة الثانية باستخدام أسماء مستعارة للوصول السريع.
