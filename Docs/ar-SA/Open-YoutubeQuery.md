...
> يفتح استعلامات بحث YouTube في متصفح ويب.

## Description

يفتح استعلام بحث واحد أو أكثر على YouTube في متصفح ويب مع خيارات تحديد المواقع والتكوين الواسعة. يدعم اختيار شاشة قابلة للتكوين، وإعدادات المتصفح، وأتمتة ضغطات المفاتيح من خلال معلمات ديناميكية موروثة من الأمر Cmdlet فتح-متصفح-ويب. يتم فتح كل استعلام في مثيل متصفح منفصل مع تحكم كامل في وضع النافذة ونوع المتصفح ولغة البحث.
...
يفتح بحث يوتيوب عن "درس PowerShell" على الشاشة الافتراضية.
...
يفتح بحث يوتيوب عن "كيفية البرمجة" على الشاشة الثانوية المهيأة باستخدام اسم الدالة المستعار.
