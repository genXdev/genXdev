...
> يزيل الملفات أو الدلائل بآليات احتياطية متعددة للحذف الموثوق.

## Description

توفر هذه الدالة طريقة قوية لحذف الملفات والدلائل من خلال محاولة طرق حذف متعددة بالتسلسل:
1. الحذف المباشر عبر أساليب System.IO للحصول على أفضل أداء
2. أمر Remove-Item المدرك للموفر في PowerShell كخيار احتياطي
3. وضع علامة للحذف عند إعادة تشغيل النظام التالي إذا فشلت الطرق الأخرى
يضمن هذا أقصى درجات الموثوقية عند إزالة العناصر عبر موفرات مختلفة.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Path` | String | ✅ | ✅ (ByValue, ByPropertyName) | 0 | — | المسار إلى العنصر المراد إزالته |
...
> المسار إلى العنصر المراد إزالته
