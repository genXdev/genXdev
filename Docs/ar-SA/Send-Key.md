...
> يرسل ضغطات مفاتيح محاكاة إلى نافذة أو عملية.

## Description

ترسل هذه الدالة إدخال لوحة المفاتيح إلى نافذة أو عملية مستهدفة باستخدام كائن Windows Script Host Shell. يمكنها استهداف النوافذ حسب اسم العملية، أو معرف العملية، أو مقبض النافذة. تدعم الدالة تسلسلات المفاتيح الخاصة، وأحرف الهروب، وخيارات التوقيت المختلفة لتوصيل المفاتيح بشكل موثوق.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-KeysToSend` | String[] | ✅ | ✅ (ByValue, ByPropertyName) | 0 | — | إدخال لوحة المفاتيح لإرساله كمصفوفة من السلاسل النصية |
| `-ProcessName` | String | — | ✅ (ByPropertyName) | Named | — | اسم العملية لإرسال المفاتيح إليها (يدعم أحرف البدل) *(Parameter set: )* 🌐 *Supports wildcards* |
| `-ProcessId` | Int32 | — | ✅ (ByPropertyName) | Named | — | معرف العملية لإرسال المفاتيح إليه *(Parameter set: )* |
| `-WindowHandle` | Int64 | — | ✅ (ByPropertyName) | Named | — | مقبض النافذة لإرسال المفاتيح إليه *(Parameter set: )* |
| `-SendKeyEscape` | SwitchParameter | — | — | Named | — | تجاهل أحرف التحكم والمعدلات في النص المدخل |
| `-SendKeyHoldKeyboardFocus` | SwitchParameter | — | — | Named | — | الاحتفاظ بتركيز لوحة المفاتيح على النافذة الهدف بعد إرسال المفاتيح |
| `-SendKeyUseShiftEnter` | SwitchParameter | — | — | Named | — | استخدم Shift+Enter بدلاً من Enter للأسطر الجديدة |
| `-SendKeyDelayMilliSeconds` | Int32 | — | — | Named | `10` | التأخير بين سلاسل الإدخال المختلفة بالمللي ثانية |
...
> إدخال لوحة المفاتيح لإرساله كمصفوفة من السلاسل النصية
...
> اسم العملية لإرسال المفاتيح إليها (يدعم أحرف البدل)
...
> معرف العملية لإرسال المفاتيح إليه
...
> مقبض النافذة لإرسال المفاتيح إليه
...
> تجاهل أحرف التحكم والمعدلات في النص المدخل
...
> الاحتفاظ بتركيز لوحة المفاتيح على النافذة الهدف بعد إرسال المفاتيح
...
> استخدم Shift+Enter بدلاً من Enter للأسطر الجديدة
...
> التأخير بين سلاسل الإدخال المختلفة بالمللي ثانية
