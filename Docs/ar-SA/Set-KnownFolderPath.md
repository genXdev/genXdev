...
> يقوم بتعديل المسار الفعلي لمجلد معروف في نظام ويندوز.

## Description

تستخدم واجهة برمجة تطبيقات Windows Shell32 لنقل مجلدات النظام مثل المستندات والتنزيلات وسطح المكتب أو مجلدات Windows المعروفة الأخرى إلى موقع جديد. تتحقق الوظيفة من وجود المسار الهدف، وتبحث عن المعرف الفريد (GUID) للمجلد من سجل المجلدات المعروفة الشامل، وتستخدم واجهة برمجة تطبيقات SHSetKnownFolderPath لتنفيذ النقل. تشمل حالات الاستخدام الشائعة نقل مجلدات المستخدم إلى محرك أقراص مختلف لإدارة المساحة أو التنظيم. يرجى توخي الحذر عند نقل المجلدات الحيوية للنظام لأن ذلك قد يؤثر على استقرار النظام.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-KnownFolder` | String | ✅ | — | 0 | — | المجلد المعروف للتعديل |
| `-Path` | String | ✅ | — | 1 | — | مسار جديد للمجلد المعروف |
