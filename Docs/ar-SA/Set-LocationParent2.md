...
> ينتقل لأعلى مستويين من الدليل في التسلسل الهرمي لنظام الملفات.

## Description

* يغير دليل العمل الحالي إلى دليل الجد (مستويين للأعلى).
...
ينتقل إلى الدليل الأصلي ويعرض محتوياته.
...
يستخدم الاسم المستعار '...' لنفس العملية.
