...
> ينتقل إلى أعلى خمسة مستويات من الدليل في التسلسل الهرمي لنظام الملفات.

## Description

* يغير دليل العمل الحالي بالانتقال لأعلى خمسة مستويات من الدليل الأصلي.
* يعرض محتويات الدليل الناتج.
* يوفر اسمًا مستعارًا مختصرًا '......' للتنقل السريع.
...
ينتقل إلى أعلى خمسة مستويات من الدليل من الموقع الحالي.
...
يستخدم الاسم المستعار للانتقال لأعلى خمسة مستويات دليل.
