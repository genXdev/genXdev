...
> تكوين محاذاة شريط المهام في ويندوز 11+ بين الموضعين المركزي والأيسر.

## Description

يضبط محاذاة شريط المهام في ويندوز 11 والإصدارات الأحدث عن طريق تعديل مفتاح التسجيل 'TaskbarAl' تحت HKCU:\SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer\Advanced. يمكن ضبط المحاذاة إما إلى الوسط (القيمة 1) أو إلى اليسار (القيمة 0).
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Justify` | String | ✅ | — | 0 | — | محاذاة شريط المهام (وسط أو يسار) |
...
> محاذاة شريط المهام (وسط أو يسار)
