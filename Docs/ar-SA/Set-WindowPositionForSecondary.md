...
> ضع النافذة على الشاشة الثانوية مع خيارات تخطيط محددة.

## Description

تتيح هذه الوظيفة وضع النوافذ على شاشة ثانوية مهيأة باستخدام
Set-WindowPosition مع خيارات تخطيط متنوعة تشمل إعدادات المحاذاة والحجم
والحدود. تتعامل مع اختيار الشاشة بناءً على التكوين العام وتوفر غلافًا مناسبًا
لوضع النوافذ على الشاشة الثانوية.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Process` | Diagnostics.Process[] | — | ✅ (ByValue, ByPropertyName) | 0 | — | عملية وضع النافذة |
| `-Monitor` | Int32 | — | — | Named | `-2` | الشاشة المراد استخدامها، 0=افتراضي، -1=تجاهل، -2=مكون |
| `-Width` | Int32 | — | — | Named | `-1` | العرض الأولي للنافذة |
| `-Height` | Int32 | — | — | Named | `-1` | الارتفاع الأولي للنافذة |
| `-X` | Int32 | — | — | Named | `-999999` | الموضع الأفقي الأولي للنافذة |
| `-Y` | Int32 | — | — | Named | `-999999` | الموضع الأولي Y للنافذة |
...
| `-FocusWindow` | SwitchParameter | — | — | Named | — | تركيز النافذة بعد التموضع |
| `-SetForeground` | SwitchParameter | — | — | Named | — | تعيين النافذة إلى المقدمة بعد تحديد الموضع |
...
| `-KeysToSend` | String[] | — | — | Named | — | ضغطات المفاتيح التي سيتم إرسالها إلى النافذة بعد التمركز |
...
| `-PassThru` | SwitchParameter | — | — | Named | — | إرجاع كائن العملية بعد التموضع |
| `-SideBySide` | SwitchParameter | — | — | Named | — | ضع النافذة جنبًا إلى جنب مع PowerShell على نفس الشاشة |
...
> الشاشة المراد استخدامها، 0=افتراضي، -1=تجاهل، -2=مكون
...
> تعيين النافذة إلى المقدمة بعد تحديد الموضع
...
> ضغطات المفاتيح التي سيتم إرسالها إلى النافذة بعد التمركز
...
> إرجاع كائن العملية بعد التموضع
...
> ضع النافذة جنبًا إلى جنب مع PowerShell على نفس الشاشة
