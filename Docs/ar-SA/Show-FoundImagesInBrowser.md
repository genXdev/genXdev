...
> يعرض نتائج البحث عن الصور في معرض ويب بتخطيط البناء.

## Description

يأخذ نتائج البحث عن الصور ويعرضها في تخطيط سقفي قائم على المتصفح.
يمكن تشغيله في الوضع التفاعلي مع إمكانية التحرير والحذف، أو في وضع العرض البسيط.
يقبل كائنات بيانات الصور عادةً من Find-Image ويعرضها مع تلميحات الأدوات التي تظهر بيانات التعريف مثل التعرف على الوجه، واكتشاف الكائنات، وبيانات تصنيف المشهد.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-InputObject` | Object[] | — | ✅ (ByValue) | 0 | `@()` | كائنات بيانات الصورة لعرضها في المعرض. |
| `-Interactive` | SwitchParameter | — | — | Named | — | سيتصل بالمتصفح ويضيف أزرارًا إضافية مثل تحرير وحذف |
| `-Title` | String | — | — | Named | `'Photo Gallery'` | عنوان المعرض |
| `-Description` | String | — | — | Named | `('Hover over images to see face recognition ' +
            'and object detection data')` | حرّك المؤشر فوق الصور لعرض بيانات التعرف على الوجوه واكتشاف الأشياء |
...
| `-NewWindow` | SwitchParameter | — | — | Named | — | إنشاء نافذة متصفح جديدة بدلاً من إعادة استخدام النافذة الموجودة |
| `-OnlyReturnHtml` | SwitchParameter | — | — | Named | — | أحتاج إلى النص الذي تريد ترجمته. يرجى تقديم النص الذي يحتوي على نصوص تعليمات أوامر PowerShell. |
| `-EmbedImages` | SwitchParameter | — | — | Named | — | قم بتضمين الصور كعناوين URL لبيانات base64 بدلاً من عناوين URL الخاصة بـ file:// لتحسين قابلية النقل. |
...
| `-PassThru` | SwitchParameter | — | — | Named | — | إرجاع كائن مساعد نافذة المتصفح لمزيد من المعالجة |
...
> كائنات بيانات الصورة لعرضها في المعرض.
...
> سيتصل بالمتصفح ويضيف أزرارًا إضافية مثل تحرير وحذف
...
> حرّك المؤشر فوق الصور لعرض بيانات التعرف على الوجوه واكتشاف الأشياء
...
> إنشاء نافذة متصفح جديدة بدلاً من إعادة استخدام النافذة الموجودة
...
> أحتاج إلى النص الذي تريد ترجمته. يرجى تقديم النص الذي يحتوي على نصوص تعليمات أوامر PowerShell.
...
> قم بتضمين الصور كعناوين URL لبيانات base64 بدلاً من عناوين URL الخاصة بـ file:// لتحسين قابلية النقل.
...
> إرجاع كائن مساعد نافذة المتصفح لمزيد من المعالجة
