...
> يفتح رابط URL في عدة متصفحات في وقت واحد بتخطيط فسيفسائي.

## Description

تنشئ هذه الوظيفة تخطيطًا شبكيًا لنوافذ المتصفح عن طريق فتح عنوان URL المحدد في Chrome وEdge وFirefox ونافذة تصفح خاصة. يتم ترتيب المتصفحات في نمط شبكي 2x2:
- Chrome: الربع العلوي الأيسر
- Edge: الربع السفلي الأيسر
- Firefox: الربع العلوي الأيمن
- النافذة الخاصة: الربع السفلي الأيمن

جميع المعلمات من Open-Webbrowser مدعومة ويتم تمريرها للتحكم في وضع المتصفح وسلوكه ومظهره. تعمل الوظيفة كغلاف يطبق تحديد موضع الأرباع بشكل ثابت مع السماح بالتخصيص الكامل لمعلمات تشغيل المتصفح.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Url` | String | ✅ | ✅ (ByValue, ByPropertyName) | 0 | — | عناوين URL التي سيتم فتحها في جميع المتصفحات في وقت واحد |
...
> عناوين URL التي سيتم فتحها في جميع المتصفحات في وقت واحد
