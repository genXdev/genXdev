...
> تحديث دفعة للكلمات الرئيسية للصور والوجوه والكائنات والمشاهد عبر أدلة نظام متعددة.

## Description

تقوم هذه الوظيفة بمعالجة الصور بشكل منهجي عبر أدلة نظام مختلفة
لتحديث كلماتها الرئيسية، وبيانات التعرف على الوجوه، وبيانات اكتشاف الكائنات، و
بيانات تصنيف المشاهد باستخدام خدمات الذكاء الاصطناعي. وهي تغطي مجلدات وسائط التخزين، وملفات النظام، والتنزيلات، وOneDrive، ومجلدات الصور الشخصية.

تقوم الوظيفة بمعالجة الصور بالمرور عبر كل دليل ومعالجة الملفات
بشكل فردي. يتم تنفيذ وظائف DeepStack (الوجوه، الكائنات، المشاهد) أولاً،
متبوعة بتوليد الكلمات الرئيسية والوصف.

وهذا يسمح بإخراج بيانات منظمة لعمليات الأنابيب مثل:
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-ImageDirectories` | String[] | ✅ | — | 0 | — | مصفوفة من مسارات الدليل لمعالجة تحديثات الصور |
...
| `-TimeoutSeconds` | Int32 | — | — | Named | — | المهلة الزمنية للطلب بالثواني، والقيمة الافتراضية هي 24 ساعة |
...
| `-NoRecurse` | SwitchParameter | — | — | Named | — | لا تتكرر في الدلائل الفرعية عند معالجة الصور |
| `-RedoAll` | SwitchParameter | — | — | Named | — | إعادة جميع الصور بغض النظر عن المعالجة السابقة |
...
> مصفوفة من مسارات الدليل لمعالجة تحديثات الصور
...
> لا تتكرر في الدلائل الفرعية عند معالجة الصور
...
> إعادة جميع الصور بغض النظر عن المعالجة السابقة
