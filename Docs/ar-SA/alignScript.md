...
> إرجاع سلسلة (مع تغيير المسافة البادئة) من سلسلة كتلة البرنامج النصي المقدمة

## Description

يغير المسافة البادئة لسلسلة كتلة نصية مع احترام المسافات البادئة الأصلية لكتلة التعليمات البرمجية
