...
> Interaktiver Dateiinhaltsvergleich und -genehmigung mit WinMerge.

## Description

Ermöglicht Inhaltsvergleich und -zusammenführung durch WinMerge, indem eine temporäre Datei mit vorgeschlagenen Änderungen erstellt wird. Der Benutzer kann Änderungen interaktiv überprüfen und ändern, bevor er sie genehmigt. Gibt den Genehmigungsstatus und den endgültigen Inhalt zurück.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-ContentPath` | String | ✅ | — | 0 | — | Pfad zur Zieldatei für den Vergleich |
...
> Pfad zur Zieldatei für den Vergleich
