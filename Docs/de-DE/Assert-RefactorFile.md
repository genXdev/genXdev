...
> Führt einen Refactoring-Vorgang für eine Quelldatei mithilfe der angegebenen IDE und KI-Prompt-Vorlage aus.

## Description

Diese Funktion automatisiert den Refactoring-Prozess, indem sie eine KI-Eingabeaufforderung basierend auf der Refactoring-Definition vorbereitet, die entsprechende IDE (VS Code oder Visual Studio) erkennt oder auswählt und die Zieldatei mit der vorbereiteten Aufforderung öffnet. Die Funktion übernimmt die Verarbeitung von Prompt-Vorlagen, die IDE-Erkennung und die Automatisierung des Refactoring-Workflows.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Path` | String | ✅ | — | 0 | — | Der Pfad zur zu verbessernden Quelldatei |
| `-RefactorSettings` | GenXdev.Helpers.RefactorSettings | — | — | 1 | `[GenXdev.Helpers.RefactorSettings]::new()` | Die Refactordefinition enthält Einstellungen und eine Promptvorlage |
...
> Der Pfad zur zu verbessernden Quelldatei
...
> Die Refactordefinition enthält Einstellungen und eine Promptvorlage
