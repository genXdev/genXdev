...
> Wandelt höfliche, professionelle Unternehmenssprache mithilfe von KI in direkte, klare Sprache um.

## Description

Diese Funktion verarbeitet Eingabetext, um diplomatische, geschäftliche Kommunikation in direktere und klarere Sprache zu transformieren. Sie kann Eingaben direkt über Parameter, aus der Pipeline oder aus der Systemablage akzeptieren. Die Funktion nutzt KI-Modelle zur Analyse und Umformulierung von Text, während die ursprüngliche Absicht erhalten bleibt.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Text` | String | — | ✅ (ByValue) | 0 | — | Der Text, der aus der Unternehmenssprache zu übersetzen ist |
...
> Der Text, der aus der Unternehmenssprache zu übersetzen ist
