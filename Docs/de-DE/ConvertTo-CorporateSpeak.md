...
> Wandelt direkten oder unverblümten Text mit KI in höfliche, professionelle Unternehmenssprache um.

## Description

Diese Funktion verarbeitet Eingabetext, um direkte oder potenziell schroffe Sprache in diplomatische, professionelle Unternehmenskommunikation umzuwandeln. Sie kann Eingaben direkt über Parameter, über die Pipeline oder aus der System-Zwischenablage akzeptieren. Die Funktion nutzt KI-Modelle, um Text zu analysieren und umzuformulieren, während die ursprüngliche Absicht erhalten bleibt.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Text` | String | — | ✅ (ByValue) | 0 | — | Der umzuwandelnde Text für die Unternehmenssprache |
...
> Der umzuwandelnde Text für die Unternehmenssprache
