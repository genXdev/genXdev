...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Text` | String | — | ✅ (ByValue) | 0 | — | I would be delighted to assist you in converting the text to a diplomatic register. However, it appears that the original text has not been provided. Could you kindly share the source material you wish to have transformed? |
