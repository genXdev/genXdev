...
> Kopiert Dateien, die den Suchkriterien entsprechen, in datumsbasierte Unterordner.

## Description

Durchsucht Dateien mit dem gleichen Parametersatz wie `Find-Item` und kopiert jede gefundene Datei basierend auf dem Erstellungs- oder Mediendatum in einen Unterordner von `TargetFolder`. Das Cmdlet unterstützt Inhaltsübereinstimmungen, laufwerksweite Suchen und viele Filter.

Versucht mehrere Strategien, um ein genaues Erstellungs- oder Aufnahmedatum für die angegebene Datei zu ermitteln. Zu den Strategien gehören das Lesen von EXIF-Metadaten aus Bildern, das Analysieren von Datums-/Uhrzeitinformationen aus Dateinamen und das Zurückfallen auf die letzte Schreibzeit der Datei, wenn keine anderen zuverlässigen Informationen verfügbar sind.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-TargetFolder` | String | ✅ | — | 0 | — | Ziel-Stammordner, in den übereinstimmende Dateien in datumsbasierte Unterordner kopiert werden |
...
Copy-FilesToDateFolder -TargetFolder 'D:\Archiv' -Name '*.jpg' -WhatIf
...
Copy-FilesToDateFolder -TargetFolder 'E:\Medien\Videos' -Name '.*\.mp4'

## Parameter Details

### `-TargetFolder <String>`

> Ziel-Stammordner, in den übereinstimmende Dateien in datumsbasierte Unterordner kopiert werden
