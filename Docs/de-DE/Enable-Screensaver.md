...
Aktiviert den Windows-Bildschirmschoner, indem die Standard-Bildschirmschoner-ausführbare Datei (scrnsave.scr) mit dem Schalter /s ausgeführt wird, um ihn sofort zu starten.
