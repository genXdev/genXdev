...
> Suchen Sie doppelte Dateien in mehreren Verzeichnissen basierend auf konfigurierbaren Kriterien.

## Description

Durchsucht angegebene Verzeichnisse rekursiv nach doppelten Dateien. Dateien gelten als Duplikate, wenn der Inhalt entweder exakt gleich ist oder mit dem gleichen Inhalt beginnt (für den partiellen Vergleich mit dem Parameter -ComparePartial). Das Cmdlet verwendet einen schnellen Hash der ersten Bytes der Datei für eine effiziente Gruppierung, bevor vollständige Inhaltsvergleiche durchgeführt werden. Die Größe dieses schnellen Hashs kann mit dem Parameter -CompareByteLength konfiguriert werden, um eine Abwägung zwischen Leistung und Genauigkeit bei der Duplikaterkennung zu ermöglichen. Nur Dateien mit einer Mindestlänge von diesem CompareByteLength-Wert werden für die Duplikaterkennung berücksichtigt; kleinere Dateien werden nur anhand des Dateinamens gruppiert.
...
| `-ComparePartial` | SwitchParameter | — | — | Named | — | Es werden Dateien mit unterschiedlichen Größen zurückgegeben, solange sie mit demselben Dateinamen und Inhalt beginnen. Dadurch werden fehlerhafte Downloads/Kopiervorgänge erkannt. |
| `-CompareByteLength` | Int32 | — | — | Named | `65536` | Schneller Vergleich der Bytelänge von Dateien, verwendet für schnelle Indizierung und Suche nach Duplikaten, dies vergleicht nicht den Inhalt von Dateien |
...
> Es werden Dateien mit unterschiedlichen Größen zurückgegeben, solange sie mit demselben Dateinamen und Inhalt beginnen. Dadurch werden fehlerhafte Downloads/Kopiervorgänge erkannt.
...
> Schneller Vergleich der Bytelänge von Dateien, verwendet für schnelle Indizierung und Suche nach Duplikaten, dies vergleicht nicht den Inhalt von Dateien
