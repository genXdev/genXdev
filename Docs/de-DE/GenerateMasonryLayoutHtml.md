...
> Generiert ein responsives Masonry-Layout-HTML-Galerie aus Bilddaten.

## Description

Erstellt eine interaktive HTML-Galerie mit responsivem Masonry-Grid-Layout zur Anzeige von Bildern. Enthält:
- Responsives Grid-Layout, das sich an die Bildschirmgröße anpasst
- Bild-Tooltips mit Beschreibungen und Schlüsselwörtern
- Klicken zum Kopieren der Bildpfad-Funktionalität
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Images` | Object | ✅ | — | 0 | — | Array von Bildobjekten mit Pfad, Schlüsselwörtern und Beschreibung |
...
| `-CanDelete` | SwitchParameter | — | — | Named | `$false` | Ob das Löschen aktiviert ist |
| `-EmbedImages` | SwitchParameter | — | — | Named | `$false` | Betten Sie Bilder als base64-Daten-URLs anstelle von file://-URLs ein, um eine bessere Portabilität zu gewährleisten. |
...
| `-PageSize` | Int32 | — | — | Named | `20` | Anzahl der pro Seite zu ladenden Bilder (für dynamisches Laden) |
| `-MaxPrintImages` | Int32 | — | — | Named | `50` | Maximale Anzahl der Bilder, die für den Druckmodus geladen werden sollen |
| `-RootMargin` | String | — | — | Named | `'1200px'` | IntersectionObserver rootMargin für unendlichen Scroll-Auslöser (z. B. "1200px") |
| `-Threshold` | Double | — | — | Named | `0.1` | IntersectionObserver-Schwellenwert für den Auslöser des unendlichen Scrollens |
...
> Array von Bildobjekten mit Pfad, Schlüsselwörtern und Beschreibung
...
> Ausgabepfad für die generierte HTML-Datei
...
> Ob die Bearbeitung aktiviert ist
...
> Betten Sie Bilder als base64-Daten-URLs anstelle von file://-URLs ein, um eine bessere Portabilität zu gewährleisten.
...
> Anzahl der pro Seite zu ladenden Bilder (für dynamisches Laden)
...
> Maximale Anzahl der Bilder, die für den Druckmodus geladen werden sollen
...
> IntersectionObserver rootMargin für unendlichen Scroll-Auslöser (z. B. "1200px")
...
> IntersectionObserver-Schwellenwert für den Auslöser des unendlichen Scrollens
