...
> Ruft die konfigurierte Standardsprache für Bildmetadatenvorgänge ab.

## Description

* Dieses Cmdlet ruft die Standardsprache ab, die vom GenXdev.AI-Modul
  für Bildmetadaten-Operationen verwendet wird.
* Es prüft zuerst globale Variablen (außer SkipSession ist angegeben), greift dann
  auf dauerhafte Einstellungen zurück und verwendet schließlich Systemstandards.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Language` | String | — | — | 0 | — | Die Standardsprache für Bildmetadatenoperationen |
| `-PreferencesDatabasePath` | String | — | — | Named | — | Datenbankpfad für Präferenzdatendateien |
| `-SessionOnly` | SwitchParameter | — | — | Named | `False` | Verwenden Sie alternative Einstellungen, die in der Sitzung gespeichert sind, für KI-Präferenzen wie Sprache, Bildsammlungen usw. |
...
Ruft die aktuell konfigurierte Sprache aus globalen Variablen oder Einstellungen ab.
...
Ruft die konfigurierte Sprache aus den dauerhaften Einstellungen ab, ignoriert die Sitzung.
...
Löschen Sie die Sitzungseinstellung und holen Sie die Sprache aus den dauerhaften Einstellungen.

## Parameter Details

### `-Language <String>`

> Die Standardsprache für Bildmetadatenoperationen
