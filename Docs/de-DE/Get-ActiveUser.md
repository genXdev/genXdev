...
> Ruft eine Liste eindeutiger Benutzernamen aus aktuell aktiven Systemprozessen ab.

## Description

Fragt alle laufenden Prozesse auf dem System ab, extrahiert den zugehörigen Benutzernamen für jeden Prozess und gibt eine deduplizierte Liste der Benutzer zurück, die aktive Prozesse haben. Dies ist nützlich für die Systemadministration und die Sicherheitsüberwachung.
