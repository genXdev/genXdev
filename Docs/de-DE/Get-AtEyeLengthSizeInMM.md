...
> Berechnet die scheinbare Größe in mm eines Objekts auf Armeslänge.

## Description

Berechnet die Größe, die ein Objekt zu haben scheint, wenn es aus durchschnittlicher Armlänge eines Erwachsenen (ungefähr 0,7 Meter) betrachtet wird, basierend auf seiner tatsächlichen Größe und Entfernung. Die Berechnung verwendet die Kleinwinkelnäherung für die Winkelgröße.
...
| `-EyeToArmLengthInMeters` | Double | — | — | Named | `0` | Der Abstand auf Armlänge in Metern. Standardwert ist 0,7. |
...
> Der Abstand zum Objekt in Metern.
...
> Der Abstand auf Armlänge in Metern. Standardwert ist 0,7.
