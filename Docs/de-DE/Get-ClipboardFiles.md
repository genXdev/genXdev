...
> Ruft Dateien von der Windows-Zwischenablage ab, die für Dateivorgänge wie Kopieren/Einfügen festgelegt wurden.

## Description

* Diese Funktion ruft Dateipfade aus der Windows-Zwischenablage ab, die zuvor für Dateioperationen festgelegt wurden.
* Sie verarbeitet automatisch sowohl STA- als auch MTA-Threading-Modi und gewährleistet so Kompatibilität in verschiedenen PowerShell-Ausführungskontexten.
* Die Funktion validiert die Dateiexistenz und gibt nur vorhandene Dateien/Verzeichnisse als Objekte zurück, ähnlich der Ausgabe von Get-ChildItem oder Get-Item.
...
Ruft alle Dateien ab, die sich derzeit in der Zwischenablage befinden, als Dateisystemobjekte.
...
Zwischenablagedateien abrufen und ihre vollständigen Pfade anzeigen.
...
Nur Textdateien aus der Zwischenablage abrufen.
