...
> Ruft das Prozessobjekt des Fensters ab, das aktuell den Tastaturfokus besitzt.

## Description

* Dieses Cmdlet verwendet Windows-API-Aufrufe über P/Invoke, um das Process-Objekt zu identifizieren und zurückzugeben, das mit dem aktuell fokussierten Fenster verknüpft ist.
* Es nutzt die User32.dll-Funktionen GetForegroundWindow und GetWindowThreadProcessId, um zu bestimmen, welches Fenster den Fokus hat, und dessen zugehörige Prozess-ID zu ermitteln.
...
Ruft das Prozessobjekt für das Fenster ab, das gerade den Tastaturfokus hat.
