...
> Zeigt Funktionen aus einer README.md-Datei an.

## Description

Zeigt alle Features aus dem Abschnitt "## Features" einer README.md-Datei an. Kann entweder die README im aktuellen Verzeichnis, im PowerShell-Profilverzeichnis oder im OneDrive-Verzeichnis verwenden.
