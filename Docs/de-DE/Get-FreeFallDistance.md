...
> Berechnet die zurückgelegte Fallstrecke während des freien Falls für eine bestimmte Zeitdauer.

## Description

Berechnet die Fallstrecke während des freien Falls mithilfe einer numerischen Methode, die Luftwiderstand und Endgeschwindigkeit berücksichtigt.
...
| `-TerminalVelocityInMetersPerSecond` | Double | — | — | 1 | `0` | Die Endgeschwindigkeit in Metern pro Sekunde (Standardwert: 53) |
...
Berechnet den in 10 Sekunden zurückgelegten Fallweg in Fuß.
...
Berechnet die Entfernung in 5 Sekunden in Metern.

## Parameter Details

### `-DurationInSeconds <Double>`

> Die Zeitdauer des Falls in Sekunden
...
> Die Endgeschwindigkeit in Metern pro Sekunde (Standardwert: 53)
...
> Die Erdbeschleunigung in m/s² (Standard: 9,81)
...
> Die Einheit für die Ausgabeentfernung
