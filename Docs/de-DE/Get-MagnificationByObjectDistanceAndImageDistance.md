...
> Berechnet die Vergrößerung für eine Linse.

## Description

Verwendet m = - (Bildabstand / Gegenstandsabstand).
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-ObjectDistanceInMeters` | Double | ✅ | — | 0 | `0` | Objektabstand in Metern |
...
Berechnet die Vergrößerung bei einer Objektentfernung von 0,5 m und einer Bildentfernung von 1 m.
