...
* Sucht den vollständigen Pfad zum Windows Defender-Befehlszeilentool (MpCmdRun.exe) und gibt ihn zurück.
* Das Cmdlet überprüft den Standardinstallationsort in Program Files und bietet eine entsprechende Fehlerbehandlung, falls die Datei nicht gefunden wird.
