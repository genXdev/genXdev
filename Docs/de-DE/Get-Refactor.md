...
> Ruft Refactordefinitionen aus GenXdev-Einstellungen basierend auf Namensmustern ab.

## Description

Durchsucht und lädt Refactor-Definitionssätze, die in den GenXdev-Einstellungen gespeichert sind. Jeder Refactor-Satz wird als JSON-Zeichenfolge in einer Einstellung gespeichert, deren Name mit 'refactor_set_' beginnt. Die Funktion deserialisiert passende Sätze zu Objekten.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Name` | String[] | — | ✅ (ByValue, ByPropertyName) | 0 | `@('*')` | Muster, nach denen Refactoring-Definitionen gesucht werden sollen 🌐 *Supports wildcards* |
...
> Muster, nach denen Refactoring-Definitionen gesucht werden sollen
