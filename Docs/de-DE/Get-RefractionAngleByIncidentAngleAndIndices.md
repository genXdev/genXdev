...
> Berechnet den Brechungswinkel mithilfe des Snelliusschen Brechungsgesetzes.
...
| `-As` | String | — | — | 3 | — | Ausgabeeinheit für Winkel |
...
Berechnet den Brechungswinkel, wenn Licht aus Luft (n=1) mit einem Einfallswinkel von 30 Grad in Wasser (n=1,33) eintritt.
...
Berechnet den Brechungswinkel, wenn Licht aus Luft (n=1) mit einem Einfallswinkel von 45 Grad in Glas (n=1,5) eintritt.
