...
> Ruft Daten aus einer SQLite-Datenbanktabelle ab, mit optionaler Begrenzung der Datensätze.

## Description

Diese Funktion fragt Daten aus einer SQLite-Datenbanktabelle ab, entweder über eine Verbindungszeichenfolge oder einen Datenbankdateipfad. Sie bietet Flexibilität bei der Verbindung zur Datenbank und der Steuerung der Datenmenge, die über den Count-Parameter abgerufen wird.
...
| `-TableName` | String | ✅ | — | 1 | — | Der Name der Tabelle, aus der Daten abgefragt werden sollen. |
