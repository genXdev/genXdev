...
> Ruft Fensterinformationen für angegebene Prozesse oder Fensterhandles ab.

## Description

* Ruft Fensterinformationen mithilfe von Prozessname, -ID oder Fensterhandle ab.
* Gibt WindowObj-Objekte mit Details zu den Hauptfenstern übereinstimmender Prozesse zurück.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-ProcessName` | String | — | ✅ (ByPropertyName) | 0 | — | Name des Prozesses, für den Fensterinformationen abgerufen werden sollen 🌐 *Supports wildcards* |
| `-ProcessId` | Int32 | — | ✅ (ByPropertyName) | Named | `0` | ID des Prozesses, für den Fensterinformationen abgerufen werden sollen |
| `-WindowHandle` | Int64 | — | ✅ (ByPropertyName) | Named | `0` | Das Fensterhandle, für das Informationen abgerufen werden sollen |
...
Ruft Fensterinformationen für alle Prozesse namens "notepad" ab.
...
> Name des Prozesses, für den Fensterinformationen abgerufen werden sollen
...
> ID des Prozesses, für den Fensterinformationen abgerufen werden sollen
...
> Das Fensterhandle, für das Informationen abgerufen werden sollen
