...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-PowershellCmdline` | String | ✅ | — | 0 | — | Der Benutzer möchte den Status des Dienstes "wuauserv" (Windows Update) abrufen. Verwenden Sie das Cmdlet Get-Service mit dem Parameter -Name, gefolgt vom Dienstnamen. |
...
Generiert einen PowerShell-Befehl, um laufende Prozesse aufzulisten
...
Verwendet den Alias, um einen Befehl zum Auffinden von heute geänderten Dateien zu generieren.
...
Generiert einen Befehl zum Stoppen eines Dienstes und kopiert ihn in die Zwischenablage.

## Parameter Details

### `-PowershellCmdline <String>`

> Der Benutzer möchte den Status des Dienstes "wuauserv" (Windows Update) abrufen. Verwenden Sie das Cmdlet Get-Service mit dem Parameter -Name, gefolgt vom Dienstnamen.
