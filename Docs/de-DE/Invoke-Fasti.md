...
Extrahiert automatisch gängige Archivformate (zip, 7z, tar, usw.), die im aktuellen Verzeichnis gefunden werden, in einzelne Ordner, die nach dem jeweiligen Archiv benannt sind. Nach erfolgreicher Extraktion werden die ursprünglichen Archivdateien gelöscht. Erfordert, dass 7-Zip auf dem System installiert ist.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Password` | String | — | — | 0 | — | Geben Sie das Passwort für die verschlüsselten Archive ein |
| `-ExtractOutputToo` | SwitchParameter | — | — | Named | — | Archive in extrahierten Ordnern rekursiv extrahieren |
...
> Geben Sie das Passwort für die verschlüsselten Archive ein
...
> Archive in extrahierten Ordnern rekursiv extrahieren
