...
> Formatiert PowerShell-Skriptdateien mithilfe der Formatierungsregeln von PSScriptAnalyzer.

## Description

Diese Funktion wendet PowerShell-Formatierungsregeln auf Skriptdateien an, indem sie das Invoke-Formatter-Cmdlet von PSScriptAnalyzer verwendet. Sie kann einzelne Dateien verarbeiten oder mehrere Dateien in Verzeichnissen rekursiv formatieren. Die Funktion verwendet anpassbare Formatierungseinstellungen und bietet eine detaillierte Protokollierung des Formatierungsprozesses.
...
| `-Settings` | Object | — | — | Named | — | Eine Hashtabelle mit Einstellungen oder ein Pfad zu einer PowerShell-Datendatei (.psd1), die die Formatierungseinstellungen enthält. |
...
| `-Recurse` | SwitchParameter | — | — | Named | — | Durchläuft rekursiv Dateien in Unterverzeichnissen. |
...
> Gibt den Pfad zur zu formatierenden Skriptdatei an.
...
> Eine Hashtabelle mit Einstellungen oder ein Pfad zu einer PowerShell-Datendatei (.psd1), die die Formatierungseinstellungen enthält.
...
> Der Bereich, in dem die Formatierung erfolgen soll, als Array von vier Ganzzahlen: Startzeilennummer, Startspaltennummer, Endzeilennummer, Endspaltennummer.
...
> Durchläuft rekursiv Dateien in Unterverzeichnissen.
