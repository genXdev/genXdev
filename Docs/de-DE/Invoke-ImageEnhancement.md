...
> Verbessert ein Bild, indem es es mit DeepStack 4-fach vergrößert und die Qualität steigert.

## Description

Diese Funktion verbessert ein Bild, indem es auf die 4-fache Breite und Höhe des Originals vergrößert wird, während gleichzeitig die Bildqualität gesteigert wird. Sie verwendet eine lokale DeepStack-Bildverbesserungs-API, die auf einem konfigurierbaren Port läuft, und gibt das verbesserte Bild als base64-Daten zurück oder speichert es in einer Datei. Die Funktion unterstützt GPU-Beschleunigung und Docker-Container-Management.
...
> Der lokale Pfad zur Bilddatei, die verbessert werden soll
...
> Optionaler Pfad, unter dem das verbesserte Bild gespeichert werden soll
