...
> Transformiert Text mithilfe KI-gestützter Verarbeitung.

## Description

Diese Funktion verarbeitet Eingabetext mithilfe von KI-Modellen, um verschiedene Transformationen wie Rechtschreibprüfung, Hinzufügen von Emoticons oder andere Textverbesserungen durchzuführen, die durch Anweisungen angegeben werden. Sie kann Eingaben direkt über Parameter, von der Pipeline oder von der Systemzwischenablage akzeptieren.
...
.DESCRIPTION
    Das Cmdlet New-SqlDatabase erstellt eine neue Datenbank auf einer Instanz von SQL Server.
    Es erfordert die Angabe des Servernamens und des Datenbanknamens.
.PARAMETER ServerInstance
    Gibt den Namen der SQL Server-Instanz an.
.PARAMETER DatabaseName
    Gibt den Namen der zu erstellenden Datenbank an.
.EXAMPLE
    C:\PS> New-SqlDatabase -ServerInstance "MeinServer" -DatabaseName "MeineDatenbank"
    
    Beschreibung
    -----------
    Dieser Befehl erstellt eine Datenbank mit dem Namen "MeineDatenbank" auf der Instanz "MeinServer".
.NOTES
    Autor: John Doe
...
| `-Instructions` | String | — | — | 1 | `('Check and correct any spelling or grammar ' +
            ...
            'additional comments or explanations.')` | ### Zusammenfassung
Das Cmdlet `Set-DhcpServerv4MulticastScope` ändert die Einstellungen eines IPv4-Multicastbereichs auf dem DHCP-Serverdienst.

### Beschreibung
Das Cmdlet `Set-DhcpServerv4MulticastScope` ändert die Einstellungen eines vorhandenen IPv4-Multicastbereichs auf dem DHCP-Serverdienst.

### Parameter

#### -ComputerName
Gibt den DNS-Namen oder die IP-Adresse des Zielcomputers an, auf dem das Cmdlet ausgeführt wird. Wenn dieser Parameter nicht angegeben wird, wird der lokale Computer verwendet.

#### -Name
Gibt den Namen des Multicastbereichs an, der geändert werden soll.

### Beispiele

#### Beispiel 1: Ändern der Beschreibung eines Multicastbereichs
```
PS C:\> Set-DhcpServerv4MulticastScope -ComputerName "dhcpserver.contoso.com" -Name „MulticastScope“ -Description „Updated description“
```
Dieser Befehl ändert die Beschreibung des Multicastbereichs namens MulticastScope.

### Verwandte Links
- [Add-DhcpServerv4MulticastScope](https://docs.microsoft.com/powershell/module/dhcpserver/Add-DhcpServerv4MulticastScope)
- [Get-DhcpServerv4MulticastScope](https://docs.microsoft.com/powershell/module/dhcpserver/Get-DhcpServerv4MulticastScope)
- [Remove-DhcpServerv4MulticastScope](https://docs.microsoft.com/powershell/module/dhcpserver/Remove-DhcpServerv4MulticastScope) |
