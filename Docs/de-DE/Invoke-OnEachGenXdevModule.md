...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Script` | ScriptBlock | ✅ | — | 0 | — | Der für jedes GenXdev-Modul auszuführende Skriptblock |
...
| `-FromScripts` | SwitchParameter | — | — | Named | — | Skriptverzeichnis anstelle von Modulverzeichnissen verarbeiten |
| `-IncludeScripts` | SwitchParameter | — | — | Named | — | Enthält das Skriptverzeichnis zusätzlich zu regulären Modulen |
...
Listet alle Namen von GenXdev-Modulen auf.
...
Listet den Inhalt des GenXdev.AI-Modulverzeichnisses mithilfe eines Alias auf.

## Parameter Details

### `-Script <ScriptBlock>`

> Der für jedes GenXdev-Modul auszuführende Skriptblock
...
> Schließt lokale Entwicklungsmodule von der Verarbeitung aus
...
> Enthält nur veröffentlichte Module, die über LICENSE- und README.md-Dateien verfügen
...
> Skriptverzeichnis anstelle von Modulverzeichnissen verarbeiten
