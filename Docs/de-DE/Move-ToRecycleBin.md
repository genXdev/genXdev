...
* Verschiebt Dateien oder Verzeichnisse sicher in den Papierkorb, selbst wenn sie gerade verwendet werden, unter Verwendung der Windows Shell API.
* Die Funktion verwendet das Shell.Application COM-Objekt, um den Vorgang durchzuführen, und gewährleistet ein ordnungsgemäßes Recycling-Verhalten sowie die Möglichkeit zum Rückgängigmachen.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Path` | String[] | ✅ | ✅ (ByValue, ByPropertyName) | 0 | — | Geben Sie den/die Pfad(e) an, der/die in den Papierkorb verschoben werden sollen |
...
Verschieben einer einzelnen Datei in den Papierkorb.
...
Verschieben Sie mehrere Dateien mithilfe der Pipeline und eines Alias in den Papierkorb.

## Parameter Details

### `-Path <String[]>`

> Geben Sie den/die Pfad(e) an, der/die in den Papierkorb verschoben werden sollen
