...
| `-SetEnvironmentVariable` | SwitchParameter | — | — | Named | — | Speichern Sie das Token in der Benutzervariable GENXDEV_MCP_TOKEN |
| `-Force` | SwitchParameter | — | — | Named | — | Vorhandene Umgebungsvariable ohne Bestätigung überschreiben |

## Parameter Details

### `-Length <Int32>`

> Die Länge des Tokens in Bytes (Standard: 32, Minimum: 16)
...
> Speichern Sie das Token in der Benutzervariable GENXDEV_MCP_TOKEN
...
> Vorhandene Umgebungsvariable ohne Bestätigung überschreiben
