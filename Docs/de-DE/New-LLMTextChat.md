...
> Startet eine interaktive Text-Chat-Sitzung mit KI-Fähigkeiten.

## Description

Initiiert eine interaktive Chat-Sitzung mit KI-Funktionen, die es Benutzern ermöglicht, während des Gesprächs PowerShell-Funktionen hinzuzufügen oder zu entfernen und PowerShell-Befehle auszuführen. Diese Funktion bietet eine umfassende Schnittstelle für KI-gestützte Konversationen mit umfangreichen Tool-Integrationen und Anpassungsoptionen.
...
| `-Temperature` | Double | — | — | 3 | `-1` | Temperatur für die Zufälligkeit der Antwort (0,0–1,0) |
...
| `-MarkupBlocksTypeFilter` | String[] | — | — | Named | `@('json', 'powershell', 'C#', 'python', 'javascript', 'typescript', 'html', 'css', 'yaml', 'xml', 'bash')` | Es werden nur Markup-Blöcke der angegebenen Typen ausgegeben |
...
| `-ChatOnce` | SwitchParameter | — | — | Named | — | Wird intern verwendet, um den Chat-Modus nur einmal nach dem LLM-Aufruf zu starten *(hidden)* |
...
| `-NoConfirmationToolFunctionNames` | String[] | — | — | Named | — | Namen von Tool-Funktionen, die keine Bestätigung erfordern sollten |
| `-MaxToolcallBackLength` | Int32 | — | — | Named | — | Maximale Länge für Tool-Rückrufantworten |
...
| `-AudioContextSize` | Object | — | — | Named | — | Audio-Kontextgröße für die Verarbeitung |
| `-SilenceThreshold` | Object | — | — | Named | — | Schwellenwert für Stille bei der Audioverarbeitung |
| `-LengthPenalty` | Object | — | — | Named | — | Längenstrafe für die Sequenzerzeugung |
| `-EntropyThreshold` | Object | — | — | Named | — | Entropieschwellenwert für die Ausgabefilterung |
| `-LogProbThreshold` | Object | — | — | Named | — | Schwellenwert für die Log-Wahrscheinlichkeit zur Ausgabefilterung |
| `-NoSpeechThreshold` | Object | — | — | Named | — | Kein Schwellenwert für Spracherkennung bei Audiodetektion |
| `-DontSpeak` | Object | — | — | Named | — | Sprachausgabe deaktivieren |
| `-DontSpeakThoughts` | Object | — | — | Named | — | Sprachausgabe für Gedanken deaktivieren |
| `-NoVOX` | Object | — | — | Named | — | VOX (Sprachaktivierung) deaktivieren |
| `-UseDesktopAudioCapture` | Object | — | — | Named | — | Desktop-Audioaufnahme verwenden |
| `-NoContext` | Object | — | — | Named | — | Kontextverwendung deaktivieren |
| `-WithBeamSearchSamplingStrategy` | Object | — | — | Named | — | Strategie zur Strahlsuche verwenden |
| `-OnlyResponses` | Object | — | — | Named | — | .SYNOPSIS
Fügt einem Benutzer eine Gruppenmitgliedschaft hinzu.

.DESCRIPTION
Das Cmdlet "Add-ADGroupMember" fügt einen oder mehrere Benutzer, Computer, Gruppen oder Dienstkonten einer Active Directory-Gruppe hinzu.

.PARAMETER Identity
Gibt die Active Directory-Gruppe an, der die Mitglieder hinzugefügt werden sollen. Sie können die Gruppe über ihren Distinguished Name, GUID, Sicherheitskennung (SID) oder SamAccountName angeben.

.PARAMETER Members
Gibt die Mitglieder an, die der Gruppe hinzugefügt werden sollen. Sie können Mitglieder über ihren Distinguished Name, GUID, Sicherheitskennung (SID) oder SamAccountName angeben.

.EXAMPLE
PS C:\> Add-ADGroupMember -Identity "Domänen-Admins" -Members "Benutzer1","Benutzer2"

Dieser Befehl fügt die Benutzer "Benutzer1" und "Benutzer2" zur Gruppe "Domänen-Admins" hinzu. |
...
> Namen von Tool-Funktionen, die keine Bestätigung erfordern sollten
...
> Maximale Länge für Tool-Rückrufantworten
...
> Sprache für das Modell oder die Ausgabe
...
> Schwellenwert für Stille bei der Audioverarbeitung
...
> Kontextverwendung deaktivieren
