...
> Öffnet alle möglichen Abfragetypen für die angegebenen Suchbegriffe oder URLs.

## Description

Führt alle Cmdlets aus, die Webseitenabfragen verarbeiten, und verarbeitet sowohl URLs als auch Suchbegriffe. Bei URLs führt es seitenbezogene Abfragen durch, bei Suchbegriffen allgemeine Webabfragen. Diese Funktion erkennt und führt dynamisch alle verfügbaren Abfrage-Cmdlets aus der GenXdev.Queries-Modulfamilie aus.
...
| `-SessionOnly` | SwitchParameter | — | — | Named | — | Nur Sitzungsmodus für das Browserprofil verwenden. |
| `-ClearSession` | SwitchParameter | — | — | Named | — | Browsersitzung vor dem Öffnen löschen. |
| `-SkipSession` | SwitchParameter | — | — | Named | — | Browsersitzungswiederherstellung überspringen. |
...
Öffnet alle möglichen Abfragetypen für "PowerShell-Scripting" auf dem Standardmonitor.
...
Öffnet alle möglichen Abfragetypen für die GitHub-URL mithilfe von Alias und kurzen Parametern.
...
> Nur Sitzungsmodus für das Browserprofil verwenden.
...
> Browsersitzung vor dem Öffnen löschen.
...
> Browsersitzungswiederherstellung überspringen.
...
- [ConvertTo-Uris](https://github.com/genXdev/genXdev/blob/main/de-DE/ConvertTo-Uris.md)
