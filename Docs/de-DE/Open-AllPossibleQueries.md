...
> Öffnet alle möglichen Abfragetypen für angegebene Suchbegriffe oder URLs.

## Description

Führt alle Cmdlets aus, die Webseitenabfragen verarbeiten, und verarbeitet sowohl URLs als auch Suchbegriffe. Für URLs führt es domänenspezifische Abfragen durch, und für Suchbegriffe führt es allgemeine Webabfragen aus. Diese Funktion erkennt und führt dynamisch alle verfügbaren Abfrage-Cmdlets aus der GenXdev.Queries-Modulfamilie aus.
...
| `-SessionOnly` | SwitchParameter | — | — | Named | — | Sitzung nur-Modus für Browserprofil verwenden. |
| `-ClearSession` | SwitchParameter | — | — | Named | — | Browsersitzung vor dem Öffnen löschen. |
| `-SkipSession` | SwitchParameter | — | — | Named | — | Browser-Sitzungswiederherstellung überspringen. |
...
Öffnet alle möglichen Abfragetypen für die GitHub-URL mit Alias- und Kurzparametern.
