...
Öffnet eine oder mehrere Bing-Suchanfragen in einem Webbrowser mit konfigurierbaren Browsereinstellungen und Befehlszeilenschaltern. Diese Funktion bietet eine umfassende Schnittstelle zur Durchführung von Bing-Suchen mit umfangreichen Anpassungsoptionen für den Browser, einschließlich Fensterpositionierung, Monitorauswahl, privatem Surfen und Tastaturautomatisierung.

Die Funktion kodiert Abfragen automatisch in URL-Format und formatiert sie für die Bing-Such-API. Sie unterstützt alle gängigen Browser wie Edge, Chrome und Firefox mit Funktionen wie privatem Surfen, Anwendungsmodus, präziser Fensterverwaltung und Tastaturautomatisierung.
...
Öffnet eine Bing-Suche unter Verwendung des Aliases und der kurzen Parameternamen.
...
Öffnet eine private Browsersitzung, um nach „maschinellem Lernen“ zu suchen, mit englischen Suchergebnissen.
...
Durchsucht mehrere Begriffe über die Pipeline und öffnet die Ergebnisse in allen installierten Browsern, wobei die Fenster auf der linken Seite des Bildschirms positioniert werden.
