...
> Öffnet Browser-Lesezeichen, die den angegebenen Suchkriterien entsprechen.

## Description

Durchsucht Lesezeichen in Microsoft Edge, Google Chrome und Mozilla Firefox anhand bereitgestellter Suchabfragen. Öffnet passende Lesezeichen im ausgewählten Browser mit konfigurierbaren Fenstereinstellungen und Browsermodi.

Diese Funktion bietet eine umfassende Schnittstelle zum Suchen und Öffnen von Browser-Lesezeichen mit erweiterten Filter- und Anzeigeoptionen. Sie unterstützt mehrere Suchkriterien und kann Ergebnisse in jedem installierten Browser mit umfangreichen Anpassungsmöglichkeiten für Fensterposition und -verhalten öffnen.
...
| `-Count` | Int32 | — | — | 1 | `50` | Maximale Anzahl zu öffnender URLs |
| `-Edge` | SwitchParameter | — | — | Named | — | In Microsoft Edge auswählen |
| `-Chrome` | SwitchParameter | — | — | Named | — | In Google Chrome auswählen |
| `-Firefox` | SwitchParameter | — | — | Named | — | In Firefox auswählen |
...
| `-ShowWindow` | SwitchParameter | — | — | Named | — | Zeige das Browserfenster an (nicht 1D oder ausgeblendet) |
...
Sucht nach Lesezeichen, die „github“ enthalten, in Microsoft Edge und öffnet die ersten 5 Ergebnisse im Standardbrowser.
...
Gleiche wie oben mit Aliasen - durchsucht Edge-Lesezeichen nach "gh" und öffnet 5 Ergebnisse im Standardbrowser.
...
Sucht in Chrome-Lesezeichen nach "Entwicklung" und "Werkzeugen", öffnet die ersten 10 Ergebnisse in Firefox, positioniert auf der linken Bildschirmseite.

## Parameter Details

### `-Queries <String[]>`

> Suchbegriffe zum Filtern von Lesezeichen
...
> Maximale Anzahl zu öffnender URLs
...
> Zeige das Browserfenster an (nicht 1D oder ausgeblendet)
