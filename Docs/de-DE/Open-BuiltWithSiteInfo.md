...
> Öffnet BuiltWith-Websiteabfragen in einem Webbrowser.

## Description

Öffnet eine BuiltWith-Abfrage in einem Webbrowser, mit konfigurierbaren Monitor-Einstellungen und Optionen für das Browserverhalten. Die Funktion analysiert Website-Technologie-Stacks, indem sie den Technologie-Profiling-Dienst von BuiltWith.com abfragt, der detaillierte Informationen über Webtechnologien, Frameworks und Dienste bereitstellt, die von Websites verwendet werden.

BuiltWith.com ist ein umfassender Technologie-Nachschlagedienst, der Webtechnologien, Frameworks, Content-Management-Systeme, Analysetools, Hosting-Anbieter und andere Softwarekomponenten identifiziert, die von jeder Website verwendet werden. Diese Funktion bietet eine PowerShell-Schnittstelle zur schnellen Analyse von Technologie-Stacks, ohne manuell zur BuiltWith-Website navigieren zu müssen.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Queries` | String[] | ✅ | ✅ (ByValue, ByPropertyName) | 0 | — | Die Website-URLs oder Domains, die auf BuiltWith.com abgefragt werden sollen |
| `-Language` | String | — | — | 1 | — | Die Sprache der zurückgegebenen Suchergebnisse |
| `-Monitor` | Int32 | — | — | 2 | `-1` | Der zu verwendende Monitor, 0 = Standard, -1 = verwerfen, -2 = Konfigurierter sekundärer Monitor, Standardwert ist -1, keine Positionierung |
...
Öffnet eine BuiltWith-Technologieanalyse für Microsoft.com auf dem Standardmonitor.
...
Analysiert Microsoft.com mithilfe von Pipeline-Eingabe, wobei die Monitorpositionierung verworfen wird.

## Parameter Details

### `-Queries <String[]>`

> Die Website-URLs oder Domains, die auf BuiltWith.com abgefragt werden sollen
