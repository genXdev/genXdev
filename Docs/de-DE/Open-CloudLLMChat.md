...
> Öffnet eine Cloud-LLM-Chatoberfläche für KI-Anfragen.

## Description

Diese Funktion bietet eine einheitliche Schnittstelle zum Öffnen verschiedener cloudbasierter KI-Chatdienste in einem Webbrowser. Sie unterstützt mehrere KI-Plattformen, darunter ChatGPT, BingCopilot, Google Gemini, X Grok, DeepSearch und GitHub Copilot. Die Funktion wählt automatisch die entsprechende endpunktspezifische Funktion aus und leitet alle relevanten Parameter für die Browserkonfiguration und Fensterpositionierung weiter.
...
| `-EndPoint` | String | — | — | 1 | `'XGrok'` | Der Endpunkt, um die Abfrage aufzurufen |
...
| `-Minimize` | SwitchParameter | — | — | Named | — | Fenster nach dem Positionieren minimieren |
...
Verarbeitet mehrere Abfragen über X Grok auf dem Standardmonitor.
...
> Fenster nach dem Positionieren minimieren
...
- [Open-XGrokQuery](https://github.com/genXdev/genXdev/blob/main/de-DE/Open-XGrokQuery.md)
