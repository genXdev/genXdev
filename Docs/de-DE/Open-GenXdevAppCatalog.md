...
> Öffnet den Katalog der progressiven Web-Apps von GenXdev in einem Webbrowser.

## Description

Öffnet den Katalog mit veröffentlichten GenXdev Progressive Web Apps in einem Webbrowser. Öffnet im Anwendungsmodus, standardmäßig mit Vollbildmodus, um eine optimale Ansicht des Katalogs zu ermöglichen. Unterstützt alle Standardkonfigurationsoptionen von Webbrowsern, einschließlich Monitorplatzierung, Fenstergröße und Spracheinstellungen.

Die Funktion konfiguriert den Browser automatisch für die beste Katalogansicht und kann mehrere Browserinstanzen gleichzeitig öffnen. Sie bietet umfassende Sprachunterstützung und respektiert Benutzereinstellungen für die Browserauswahl und -positionierung.
...
| `-ShowWindow` | SwitchParameter | — | — | Named | — | Das Browserfenster anzeigen (nicht minimiert oder versteckt) |
...
Öffnet den GenXdev-App-Katalog auf Monitor 1 im Anwendungsmodus mit aktiviertem Vollbild.
...
Öffnet den GenXdev-App-Katalog auf Monitor 1 mithilfe des Alias-Befehls.
...
> Das Browserfenster anzeigen (nicht minimiert oder versteckt)
