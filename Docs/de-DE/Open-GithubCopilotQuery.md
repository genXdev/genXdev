...
> Öffnet eine Github CoPilot-Abfrage in einem Webbrowser

## Description

Öffnet eine GitHub CoPilot-Abfrage im Webbrowser und gibt die angegebene Abfrage automatisch ein. Die Funktion wartet, bis die Seite geladen ist, bevor sie die Abfrage eingibt. Diese Funktion verwendet die zugrunde liegende Open-WebsiteAndPerformQuery-Funktion, um die Browserautomatisierung zu handhaben, und bietet eine bequeme Möglichkeit, mit GitHub Copilot von PowerShell mit umfangreichen Browserkonfigurationsoptionen zu interagieren.
