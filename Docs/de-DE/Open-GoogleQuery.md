...
> Öffnet Google-Abfragen in einem Webbrowser mit konfigurierbaren Einstellungen und umfangreichen Anpassungsoptionen.

## Description

Öffnet eine oder mehrere Google-Abfragen in einem Webbrowser mit umfassender Unterstützung
für mehrere Sprachen, Monitorauswahl, Fensterpositionierung, Browserauswahl
und Tastaturautomatisierung. Die Funktion bietet eine funktionsreiche
Schnittstelle zur Durchführung von Google-Suchen mit präziser Kontrolle über
Browserverhalten und -darstellung.

Zu den wichtigsten Funktionen gehören:
- Unterstützung für über 100 Sprachen über Googles Sprachfilter
...
- Unterstützung für privaten/inkognito Browsermodus
- Anwendungsmodus für ablenkungsfreies Surfen
- Optionen zum Blockieren von Erweiterungen und Pop-ups
- Fokusverwaltung und Fenstermanipulation
- Batch-Abfrageverarbeitung mit Pipeline-Unterstützung
- Tastaturautomatisierung für Browserfenster
- Intelligente Parameterweitergabe an zugrunde liegende Browserfunktionen

Die Funktion formatiert Suchabfragen automatisch für Google-Suchmaschine
und wendet Sprachfilterung an, wenn angegeben. Alle Browserpositionierungs- und
Verwaltungsfunktionen werden von der zugrunde liegenden Open-Webbrowser-Funktion geerbt.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Queries` | String[] | ✅ | ✅ (ByValue, ByPropertyName) | 0 | — | Die Suchbegriffe, die bei Google abgefragt werden sollen |
| `-Language` | String | — | — | 1 | — | Die Sprache für Google-Suchergebnisse |
...
Öffnet eine Google-Suche nach "PowerShell-Skripterstellung" auf Englisch auf dem primären Monitor.
...
Öffnet eine Google-Suche nach "machine learning algorithms" im Vollbildmodus auf Monitor 2 unter Verwendung von Aliasen.
...
Öffnet mehrere Google-Suchen in Chrome über Pipeline-Eingabe, jeweils auf Englisch.
...
Öffnet eine private Browsersuche nach "künstlicher Intelligenz" in einem neuen Fenster.
...
Öffnet eine Suche im Anwendungsmodus (ohne Browserelemente), die auf dem Bildschirm zentriert wird.

## Parameter Details

### `-Queries <String[]>`

> Die Suchbegriffe, die bei Google abgefragt werden sollen
...
> Die Sprache für Google-Suchergebnisse
...
> Der zu verwendende Monitor: 0 = Standard, -1 = verwerfen, -2 = Konfigurierter sekundärer Monitor, Standard ist -1
