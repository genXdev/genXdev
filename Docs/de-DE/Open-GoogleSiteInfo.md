...
> Öffnet Google-Site-Informationenabfragen in einem Webbrowser.

## Description

Öffnet mehrere Google-Suchanfragen zu Seiteninformationen (site:, link:, related:) in einem Webbrowser für die angegebene(n) Domain(s).
...
| `-SessionOnly` | SwitchParameter | — | — | Named | — | Nur Sitzungsmodus für Browserprofil verwenden (keine dauerhaften Daten) |
| `-ClearSession` | SwitchParameter | — | — | Named | — | Browser-Sitzungs-/Profildaten vor dem Öffnen löschen |
| `-SkipSession` | SwitchParameter | — | — | Named | — | Verwenden Sie keine Browsersitzung/das Standardprofil (Standardeinstellung verwenden) |
