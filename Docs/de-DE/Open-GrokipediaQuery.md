...
Öffnet eine oder mehrere Grokipedia-Suchanfragen in einem Webbrowser mit umfangreichen Konfigurationsoptionen. Unterstützt konfigurierbares Browserverhalten, Monitorauswahl und Fensterpositionierung. Die Suchanfragen werden URL-kodiert und über die angegebene Sprachdomäne von Grokipedia mit vollständiger Lokalisierungsunterstützung geöffnet.

Die Funktion bietet umfassende Browsersteuerung, einschließlich privater Browsermodi, Fensterpositionierung, Tastaturautomatisierung und Multi-Monitor-Unterstützung. Sie verarbeitet automatisch URL-Kodierung und Sprachcode-Zuordnung für internationale Grokipedia-Domänen.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Queries` | String[] | ✅ | ✅ (ByValue, ByPropertyName) | 0 | — | Die auszuführende Grokipedia-Suchanfrage |
...
| `-Monitor` | Int32 | — | — | Named | `-1` | Der zu verwendende Monitor, 0 = Standard, -1 = verwerfen, -2 = Konfigurierter Sekundärmonitor |
...
Öffnet eine Grokipedia-Suche unter Verwendung des Alias mit Positionsparametern.
...
Durchsucht Grokipedia nach mehreren Begriffen im privaten Browsermodus.

## Parameter Details

### `-Queries <String[]>`

> Die auszuführende Grokipedia-Suchanfrage
...
> Der zu verwendende Monitor, 0 = Standard, -1 = verwerfen, -2 = Konfigurierter Sekundärmonitor
...
> Gibt ein PowerShell-Prozessobjekt zurück, das den Browserprozess darstellt.
