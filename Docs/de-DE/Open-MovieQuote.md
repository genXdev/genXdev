...
> Öffnet ein Video eines Filmzitats in einem Webbrowser.

## Description

Durchsucht und öffnet Filmzitate mit playphrase.me, wobei die Angabe von Monitor- und Browsereinstellungen möglich ist. Diese Funktion bietet Zugriff auf eine umfangreiche Datenbank von Filmzitaten mit Videoclips, unterstützt mehrere Sprachen und erweiterte Browserkonfigurationsoptionen.

Hauptmerkmale:
- Suche nach Filmzitaten aus einer umfangreichen Datenbank
- Mehrsprachige Unterstützung mit automatischer Spracherkennung
- Erweiterte Browserpositionierung und Fensterverwaltung
- Unterstützung mehrerer Browser (Edge, Chrome, Firefox)
- Unterstützung des privaten Browsermodus
- Tastaturautomatisierung für die Browserinteraktion
- Multi-Monitor-Unterstützung mit präziser Positionierung
...
Öffnet eine Suche nach dem berühmten Terminator-Zitat „Ich komme wieder“.
...
Öffnet eine Suche nach dem Casablanca-Zitat auf Monitor 1.
...
Öffnet eine Suche nach dem Star-Wars-Zitat auf Englisch im privaten Browsing.
...
Öffnet mehrere Filmzitatsuchen im Vollbildmodus von Chrome über die Pipeline.
