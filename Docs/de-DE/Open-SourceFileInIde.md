...
Diese Funktion öffnet eine angegebene Quelldatei entweder in Visual Studio Code oder Visual Studio. Sie kann direkt zu einer bestimmten Zeilennummer navigieren und optional Tastatureingaben an die IDE senden, nachdem die Datei geöffnet wurde. Die Funktion versucht zu bestimmen, welche IDE basierend auf dem aktuellen Host-Prozess, laufenden Anwendungen oder Benutzerauswahl verwendet werden soll.
...
| `-SendKeyEscape` | SwitchParameter | — | — | Named | — | Steuerzeichen und Modifikatoren maskieren |
| `-SendKeyHoldKeyboardFocus` | SwitchParameter | — | — | Named | — | Tastaturfokus auf Zielfenster halten |
| `-SendKeyUseShiftEnter` | SwitchParameter | — | — | Named | — | Verwenden Sie Umschalt+Eingabe anstelle von Eingabe |
| `-SendKeyDelayMilliSeconds` | Int32 | — | — | Named | — | Verzögerung zwischen verschiedenen Eingabezeichenfolgen in Millisekunden |
...
> Der Pfad zur zu öffnenden Quelldatei
...
> Die Zeilennummer, zu der navigiert werden soll
...
> Array von Tastatureingaben, die an die Anwendung gesendet werden sollen
...
> Steuerzeichen und Modifikatoren maskieren
...
> Tastaturfokus auf Zielfenster halten
...
> Verwenden Sie Umschalt+Eingabe anstelle von Eingabe
