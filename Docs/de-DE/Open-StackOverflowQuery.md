...
> Öffnet Stack Overflow-Suchabfragen in einem Webbrowser.
...
- Sprachlokalisierungsunterstützung für internationale Suchergebnisse
...
Die Funktion erkennt automatisch die Systemfähigkeiten und passt das Verhalten entsprechend an. Für nicht auf dem System installierte Browser werden Vorgänge stillschweigend ohne Fehler übersprungen.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Queries` | String[] | ✅ | ✅ (ByValue, ByPropertyName) | 0 | — | Die Suchanfragen, die auf Stack Overflow durchgeführt werden sollen |
| `-Language` | String | — | — | 1 | — | Die Sprache der zurückgegebenen Suchergebnisse für lokalisierte Stack Overflow-Inhalte |
...
| `-SessionOnly` | SwitchParameter | — | — | Named | — | Im Sitzung gespeicherte alternative Einstellungen für die Stack Overflow-Suchpräferenzen verwenden |
| `-ClearSession` | SwitchParameter | — | — | Named | — | Löschen Sie alternative Einstellungen, die für die Stack Overflow-Suchpräferenzen in der Sitzung gespeichert sind. |
| `-SkipSession` | SwitchParameter | — | — | Named | — | Einstellungen nur in persistenten Präferenzen speichern, ohne die Sitzung für die Stack Overflow-Suche zu beeinflussen |
...
Öffnet eine Stack Overflow-Suche nach „powershell array“ auf dem primären Monitor.
...
Öffnet eine Stack Overflow-Suche mit dem Alias und der Monitorpositionierung.
...
> Die Suchanfragen, die auf Stack Overflow durchgeführt werden sollen
...
> Die Sprache der zurückgegebenen Suchergebnisse für lokalisierte Stack Overflow-Inhalte
...
> Im Sitzung gespeicherte alternative Einstellungen für die Stack Overflow-Suchpräferenzen verwenden
...
> Löschen Sie alternative Einstellungen, die für die Stack Overflow-Suchpräferenzen in der Sitzung gespeichert sind.
...
> Einstellungen nur in persistenten Präferenzen speichern, ohne die Sitzung für die Stack Overflow-Suche zu beeinflussen
