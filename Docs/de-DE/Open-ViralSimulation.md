...
> Öffnet ein virales Simulationsspiel in einem Webbrowser mit umfangreichen Konfigurationsoptionen.

## Description

Öffnet das virale Simulationsspiel unter https://viral.genxdev.net/ in einem bestimmten Webbrowser mit konfigurierbaren Fenstereinstellungen, Positionierung und Verhaltensoptionen. Unterstützt mehrere Browser, privates Surfen, Anwendungsmodus und umfassende Fensterverwaltungsfunktionen.

Die Funktion bietet ein interaktives Erlebnis der viralen Simulation mit Funktionen wie:
- Unterstützung mehrerer Browser (Edge, Chrome, Firefox)
- Steuerung der Fensterposition und -größe
- Vollbild- und Anwendungsmodusoptionen
- Möglichkeiten für privates Surfen
- Unterstützung für Tastaturautomatisierung
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Language` | String | — | — | 0 | — | Die Sprache für die Anzeige von Webinhalten und die Browserspracheinstellungen |
...
Öffnet die Virussimulation in Google Chrome mit privatem Browsermodus und ohne Vollbild.
...
Öffnet die virale Simulation mit Aliasen in Chrome, Inkognito-Modus und ohne Vollbild.

## Parameter Details

### `-Language <String>`

> Die Sprache für die Anzeige von Webinhalten und die Browserspracheinstellungen
