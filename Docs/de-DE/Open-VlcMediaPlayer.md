...
> Startet und steuert VLC Media Player mit umfangreichen Konfigurationsoptionen.

## Description

Diese Funktion bietet eine umfassende Schnittstelle zum Starten und Steuern des VLC Media Players mit Unterstützung für Fensterpositionierung, Monitorauswahl, Wiedergabeeinstellungen, Audio- und Videofilter, Untertitelverwaltung, Mehrsprachunterstützung, Netzwerk-Proxy-Einstellungen und erweiterte Leistungsoptionen. Die Funktion kann VLC automatisch installieren, falls nicht vorhanden, und bietet umfangreiche Anpassungsmöglichkeiten für Media-Playbook-Szenarien. Sie integriert sich nahtlos in das GenXdev-Fensterverwaltungssystem und unterstützt die Automatisierung von Tastatureingaben über die Send-Key-Funktionalität.
...
| `-Monitor` | Int32 | — | — | Named | `-1` | Der zu verwendende Monitor, 0 = Standard, -1 bedeutet verwerfen |
...
| `-RestoreFocus` | SwitchParameter | — | — | Named | — | PowerShell-Fensterfokus nach dem Öffnen von VLC wiederherstellen |
...
> Die Mediendatei(en) oder URL(s), die in VLC geöffnet werden sollen
...
> PowerShell-Fensterfokus nach dem Öffnen von VLC wiederherstellen
