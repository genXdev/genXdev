...
> Öffnet die WaybackMachine-Websiteinformationen in einem Webbrowser.
...
| `-SessionOnly` | SwitchParameter | — | — | Named | — | Use alternative settings stored in session for Wayback Machine preferences |
| `-ClearSession` | SwitchParameter | — | — | Named | — | Klare alternative Einstellungen, die in der Sitzung für Wayback Machine-Einstellungen gespeichert sind |
...
Öffnet das Wayback-Machine-Archiv für example.com unter Verwendung von Aliasen mit Monitorpositionierung verworfen.
