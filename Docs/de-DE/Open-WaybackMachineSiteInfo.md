...
> Öffnet WaybackMachine-Website-Informationen in einem Webbrowser.

## Description

Öffnet eine Waybackmachine-Abfrage in einem Webbrowser und zeigt historische Versionen der angegebenen URL oder Website an. Unterstützt mehrere Abfragen und Monitorauswahl. Bietet Zugriff auf archivierte Webinhalte über den Wayback Machine-Dienst des Internet Archive.
...
| `-Language` | String | — | — | 1 | — | Die Spracheinstellung für die Browseroberfläche und den Inhalt |
...
| `-SessionOnly` | SwitchParameter | — | — | Named | — | Alternative Einstellungen verwenden, die in der Sitzung für Wayback Machine-Präferenzen gespeichert sind |
| `-ClearSession` | SwitchParameter | — | — | Named | — | Alternativ-Einstellungen, die in der Sitzung für Wayback Machine-Präferenzen gespeichert sind, löschen. |
...
Öffnet das Wayback-Machine-Archiv für example.com auf dem Standardmonitor.
...
Öffnet das Wayback Machine-Archiv für example.com mit Aliassen unter Verwendung von Monitor-Positionierung, die verworfen wird.
...
Öffnet das Wayback Machine-Archiv für microsoft.com im Inkognito-Modus von Chrome.
...
> Die Spracheinstellung für die Browseroberfläche und den Inhalt
...
> Alternative Einstellungen verwenden, die in der Sitzung für Wayback Machine-Präferenzen gespeichert sind
...
> Alternativ-Einstellungen, die in der Sitzung für Wayback Machine-Präferenzen gespeichert sind, löschen.
