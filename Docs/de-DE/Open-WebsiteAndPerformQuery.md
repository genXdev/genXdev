...
Diese Funktion öffnet eine Website per URL im Standard-Webbrowser, gibt eine oder mehrere Abfragen ein und sendet sie ab. Sie unterstützt umfangreiche Monitorauswahl- und Fensterpositionierungsoptionen durch die zugrunde liegende Open-Webbrowser-Funktion.

Die Funktion kopiert automatisch jede Abfrage in die Zwischenablage und sendet sie mithilfe der Tastaturautomation an das Browserfenster. Sie bewahrt den ursprünglichen Inhalt der Zwischenablage und stellt ihn wieder her, nachdem alle Abfragen verarbeitet wurden.
...
| `-SendKeyDelayMilliSeconds` | Int32 | — | — | Named | `500` | Verzögerung zwischen dem Senden unterschiedlicher Tastensequenzen in Millisekunden |
...
> Die URL der zu öffnenden Website
