...
> Öffnet eine Whois-Hostinformationsabfrage in einem Webbrowser.

## Description

Öffnet Whois-Hostinformationsabfragen in einem Webbrowser für Domainnamen oder IP-Adressen. Unterstützt konfigurierbare Monitorauswahl und mehrere Abfragen mit umfangreichen Browserkonfigurationsoptionen einschließlich Fensterpositionierung, Browserauswahl und Automatisierungsfunktionen.
...
| `-SessionOnly` | SwitchParameter | — | — | Named | — | Verwenden Sie alternative Einstellungen, die in der Sitzung gespeichert sind, für KI-Präferenzen wie Sprache, Bildersammlungen usw. |
| `-ClearSession` | SwitchParameter | — | — | Named | — | Löschen Sie alternative, in der Sitzung gespeicherte Einstellungen für KI-Präferenzen wie Sprache, Bildersammlungen usw. |
| `-SkipSession` | SwitchParameter | — | — | Named | — | Einstellungen nur in dauerhaften Voreinstellungen speichern, ohne die Sitzung für KI-Voreinstellungen wie Sprache, Bildersammlungen usw. zu beeinflussen. |
...
Öffnet Whois-Informationen für mehrere Domains auf dem Standardmonitor.
...
Öffnet Whois-Informationen für example.com unter Verwendung von Aliasnamen und Positionsparametern.
...
Öffnet Whois-Informationen für Domänen aus der Pipeline im privaten Chrome-Modus.
...
> Verwenden Sie alternative Einstellungen, die in der Sitzung gespeichert sind, für KI-Präferenzen wie Sprache, Bildersammlungen usw.
...
> Löschen Sie alternative, in der Sitzung gespeicherte Einstellungen für KI-Präferenzen wie Sprache, Bildersammlungen usw.
...
> Einstellungen nur in dauerhaften Voreinstellungen speichern, ohne die Sitzung für KI-Voreinstellungen wie Sprache, Bildersammlungen usw. zu beeinflussen.
