...
Öffnet eine 'Wikipedia - Die Niederlande'-Abfrage in einem Webbrowser mit konfigurierbaren Anzeigeoptionen. Unterstützt die Suche nach mehreren Begriffen und die Angabe, auf welchem Monitor die Ergebnisse angezeigt werden sollen.
...
| `-SessionOnly` | SwitchParameter | — | — | Named | — | Use session-only cookies (no persistent cookies) |
| `-ClearSession` | SwitchParameter | — | — | Named | — | Browsersitzungsdaten vor dem Öffnen löschen |
