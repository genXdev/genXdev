...
> Öffnet niederländische Wikipedia-Suchen in einem Webbrowser.

## Description

Öffnet eine 'Wikipedia - Niederlande'-Abfrage in einem Webbrowser mit konfigurierbaren Anzeigeoptionen. Unterstützt die Suche nach mehreren Begriffen und die Angabe, auf welchem Monitor die Ergebnisse angezeigt werden sollen.
...
| `-SideBySide` | SwitchParameter | — | — | Named | — | Öffnet zwei Browserfenster nebeneinander |
| `-SessionOnly` | SwitchParameter | — | — | Named | — | Nur Sitzungs-Cookies verwenden (keine persistenten Cookies) |
| `-ClearSession` | SwitchParameter | — | — | Named | — | Browser-Sitzungsdaten vor dem Öffnen löschen |
| `-SkipSession` | SwitchParameter | — | — | Named | — | Vorherige Browsersitzung nicht wiederherstellen |
...
> Öffnet zwei Browserfenster nebeneinander
...
> Nur Sitzungs-Cookies verwenden (keine persistenten Cookies)
...
> Browser-Sitzungsdaten vor dem Öffnen löschen
...
> Vorherige Browsersitzung nicht wiederherstellen
