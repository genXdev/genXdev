...
Öffnet die YAB-Spielwebsite in einem angegebenen Browser mit verschiedenen Anzeige- und Verhaltensoptionen. Unterstützt verschiedene Spielmodi, einschließlich des Zuschauermodus. Das YAB-Spiel ist ein Online-Puzzlespiel, das interaktiv gespielt oder im Zuschauermodus beobachtet werden kann, bei dem die KI automatisch spielt.
...
Öffnet das YAB-Spiel im Zuschauermodus mit Chrome-Browser ohne Vollbild und englischer Benutzeroberfläche.
...
Öffnet das YAB-Spiel im Edge-Browser mit privatem Surfen auf Monitor 2 unter Verwendung von Aliasen für den schnellen Zugriff.
