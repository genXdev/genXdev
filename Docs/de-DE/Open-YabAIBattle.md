...
Diese Funktion startet das YabAI Battle-Spiel in einem Webbrowser mit umfangreichen Anpassungsoptionen für Fensterplatzierung, Browserauswahl und Anzeigemodus. Sie dient als Wrapper um die GenXdev\Open-Webbrowser-Funktion mit spielspezifischer URL-Konstruktion und Parameterverarbeitung.

Die Funktion unterstützt zwei Spielmodi:
- Kampfmodus: Starten eines neuen KI-gegen-KI-Kampfes
- Zuschauermodus: Ansehen bestehender KI-Kämpfe

Zu den Browser-Positionierungsoptionen gehören links, rechts, oben, unten, zentriert und Vollbildmodi mit Multi-Monitor-Unterstützung. Die Funktion verwaltet automatisch die Einstellungen für den Anwendungsmodus und die Browsererweiterungsverwaltung für ein optimales Spielerlebnis.
...
| `-SendKeyEscape` | SwitchParameter | — | — | Named | — | Escape-Steuerzeichen beim Senden von Tasten. |
...
| `-SendKeyUseShiftEnter` | SwitchParameter | — | — | Named | — | Senden Sie Umschalt+Eingabe anstelle der normalen Eingabetaste für Zeilenumbrüche beim Senden von Tasten. |
...
| `-RestoreFocus` | SwitchParameter | — | — | Named | — | Nach dem Öffnen des Browsers den Fokus auf das vorherige Fenster zurückgeben. |
...
Öffnet das YabAI Battle-Spiel in Microsoft Edge im InPrivate-Modus ohne Vollbild.
...
Öffnet das Spiel mit Aliassen für Edge, Inkognito-Modus und ohne Vollbild.
...
Öffnet das Spiel mit spanischer Sprachoberfläche, positioniert auf der linken Seite von Monitor 1.

## Parameter Details

### `-Language <String>`

> Die Sprache der Spieloberfläche
...
> Senden Sie Umschalt+Eingabe anstelle der normalen Eingabetaste für Zeilenumbrüche beim Senden von Tasten.
...
> Verzögerung in Millisekunden zwischen dem Senden jedes Schlüssels.
...
> Nach dem Öffnen des Browsers den Fokus auf das vorherige Fenster zurückgeben.
