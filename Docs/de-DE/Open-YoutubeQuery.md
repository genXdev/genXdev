...
> Öffnet YouTube-Suchanfragen in einem Webbrowser.

## Description

Öffnet eine oder mehrere YouTube-Suchanfragen in einem Webbrowser mit umfangreichen Positionierungs- und Konfigurationsoptionen. Unterstützt konfigurierbare Monitorauswahl, Browsereinstellungen und Tastaturautomatisierung durch dynamische Parameter, die vom Open-Webbrowser-Cmdlet geerbt werden. Jede Abfrage wird in einer separaten Browserinstanz geöffnet, mit voller Kontrolle über Fensterpositionierung, Browsertyp und Suchsprache.
...
Öffnet eine YouTube-Suche nach "PowerShell-Tutorial" auf dem Standardmonitor.
...
Öffnet eine YouTube-Suche nach „how to code“ auf dem konfigurierten sekundären Monitor unter Verwendung des Funktionsalias.
