...
Öffnet eine oder mehrere YouTube-Suchanfragen in einem Webbrowser mit umfangreichen Positionierungs- und Konfigurationsoptionen. Unterstützt konfigurierbare Monitorauswahl, Browsereinstellungen und Tastaturautomatisierung durch dynamische Parameter, die vom Cmdlet Open-Webbrowser geerbt werden. Jede Abfrage wird in einer separaten Browserinstanz geöffnet mit vollständiger Kontrolle über Fensterpositionierung, Browsertyp und Suchsprache.
...
Öffnet eine YouTube-Suche nach „how to code“ auf dem konfigurierten zweiten Monitor unter Verwendung des Funktionsalias.
