...
Liest den Abschnitt „## Versionshinweise“ aus einer README.md-Datei, sammelt alle
unvollständigen Versionshinweise (Zeilen, die mit - ☐ beginnen), schreibt sie in das
Feld ReleaseNotes von GenXdev.psd1 und markiert sie im README als abgeschlossen (☐ → ☒).
Beide Dateien werden in einem atomaren Vorgang aktualisiert.
