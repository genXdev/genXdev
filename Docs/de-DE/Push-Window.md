...
Drückt einen Fenster-Helfer für das aktuell fokussierte Fenster auf den Stapel. Ermöglicht die Anwendung verschiedener Fenstertransformationen vor oder nach dem Drücken. Diese Funktion erfasst das aktuelle Fenster und speichert es für den späteren Abruf mit Pop-Window, während optional Positionierung, Größenanpassung und visuelle Effekte angewendet werden.
