...
> Schiebt das aktuelle Fenster mit optionalen Änderungen auf den Fensterstapel.

## Description

Schiebt einen Fenster-Helfer für das aktuell fokussierte Fenster auf den Stapel.
Ermöglicht die Anwendung verschiedener Fenstertransformationen vor oder nach dem Schieben.
Diese Funktion erfasst das aktuelle Fenster und speichert es für den späteren Abruf
mit Pop-Window, wobei optional Positionierung, Größenanpassung und visuelle
Effekte angewendet werden können.
