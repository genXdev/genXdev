...
* Erstellt einen Screenshot des Desktops vom angegebenen Monitor und speichert ihn als Bilddatei.
* Unterstützt mehrere Monitore und erkennt automatisch die korrekten Bildschirmgrenzen sowie Skalierungsfaktoren für High-DPI-Displays.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Monitor` | Int32 | ✅ | ✅ (ByPropertyName) | 0 | `0` | Monitorindex zum Erfassen (0 = primärer Monitor, 1+ = bestimmter Monitor, -1 = alle Monitore) |
| `-OutputPath` | String | ✅ | ✅ (ByPropertyName) | 1 | — | Vollständiger Pfad, unter dem der Screenshot gespeichert wird |
| `-Quality` | Int32 | — | — | Named | `0` | JPEG-Qualitätsstufe (1-100), gilt nur für das JPEG-Format |
...
Erstellt einen Screenshot des zweiten Monitors mit hoher JPEG-Qualität.
...
Erfasst alle Monitore kombiniert in einem einzigen Screenshot-Bild.

## Parameter Details

### `-Monitor <Int32>`

> Monitorindex zum Erfassen (0 = primärer Monitor, 1+ = bestimmter Monitor, -1 = alle Monitore)
...
> Vollständiger Pfad, unter dem der Screenshot gespeichert wird
...
> JPEG-Qualitätsstufe (1-100), gilt nur für das JPEG-Format
