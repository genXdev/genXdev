...
Diese Funktion nimmt Bildsuchergebnisse entgegen und extrahiert/speichert einzelne Gesichtsbereiche als separate Bilddateien. Sie kann mit verschiedenen Kriterien nach Gesichtern suchen und diese in einem angegebenen Ausgabeverzeichnis speichern. Die Funktion unterstützt die Suche nach Beschreibung, Schlüsselwörtern, Personen, Objekten, Szenen, Bildtyp, Stiltyp und allgemeiner Stimmung. Sie kann auch nach Nacktheit und explizitem Inhalt filtern.
...
| `-Scenes` | String[] | — | — | Named | `@()` | Szenen zum Suchen, Platzhalter erlaubt. |
| `-PictureType` | String[] | — | — | Named | `@()` | Nach zu filternden Bildtypen, Platzhalter erlaubt. |
| `-StyleType` | String[] | — | — | Named | `@()` | Stiltypen zum Filtern, Platzhalter sind erlaubt. |
...
| `-PathLike` | String[] | — | — | Named | `@()` | Array von Verzeichnispfad-ähnlichen Suchzeichenfolgen zum Filtern von Bildern nach Pfad (SQL-LIKE-Muster, z.B. '%\2024\%') |
| `-InputObject` | Object[] | — | ✅ (ByValue) | Named | — | Akzeptiert Suchergebnisse von einem vorherigen -PassThru-Aufruf, um die Ansicht neu zu generieren. |
| `-OutputDirectory` | String | — | — | Named | `'.\'` | Verzeichnis zum Speichern von beschnittenen Gesichtsbildern. |
...
| `-ForceIndexRebuild` | SwitchParameter | — | — | Named | — | Erzwinge den Neubau der Bildindexdatenbank. |
...
| `-SaveUnknownPersons` | SwitchParameter | — | — | Named | — | Erkannte unbekannte Personen auch als Objekte speichern. |
...
> Der zu suchende Beschreibungstext, Platzhalter erlaubt.
...
> Szenen zum Suchen, Platzhalter erlaubt.
...
> Nach zu filternden Bildtypen, Platzhalter erlaubt.
...
> Stiltypen zum Filtern, Platzhalter sind erlaubt.
...
> Allgemeine Stimmungen zum Filtern, Platzhalter erlaubt.
...
> Array von Verzeichnispfad-ähnlichen Suchzeichenfolgen zum Filtern von Bildern nach Pfad (SQL-LIKE-Muster, z.B. '%\2024\%')
...
> Akzeptiert Suchergebnisse von einem vorherigen -PassThru-Aufruf, um die Ansicht neu zu generieren.
...
> Verzeichnis zum Speichern von beschnittenen Gesichtsbildern.
...
> Erzwinge den Neubau der Bildindexdatenbank.
...
> Erkannte unbekannte Personen auch als Objekte speichern.
