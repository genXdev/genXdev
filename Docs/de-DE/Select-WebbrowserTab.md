...
> Wählt einen Browsertab aus laufenden, von Playwright verwalteten Browsern aus.

## Description

Listet Browser-Tabs aus allen laufenden Playwright-verwalteten Browserinstanzen auf und wählt sie aus. Ohne Auswahlkriterien aufgerufen, zeigt es eine Tabelle aller verfügbaren Tabs über alle Browsertypen hinweg an. Unterstützt die Auswahl nach numerischem Index, URL-Muster oder direkter Seitenreferenz.

Wenn ein Tab ausgewählt wird, setzt es $Global:chromeController und $Global:chromeSession für die Abwärtskompatibilität mit anderen Webbrowser-Cmdlets.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Id` | Int32 | — | — | 0 | `-1` | Tab-Index aus der angezeigten Liste *(Parameter set: )* |
| `-Name` | String | ✅ | — | 0 | — | Wählt ersten Tab aus, der diesen Text in seiner URL enthält *(Parameter set: )* 🌐 *Supports wildcards* |
| `-ByReference` | Object | ✅ | — | Named | — | Direkte Seitenreferenz aus einem Playwright-Browserzustand *(Parameter set: )* |
| `-Edge` | SwitchParameter | — | — | Named | — | Filtert Registerkarten zu Microsoft Edge-Browserinstanzen |
| `-Chrome` | SwitchParameter | — | — | Named | — | Filtert Registerkarten auf Google Chrome-Browserinstanzen |
| `-Chromium` | SwitchParameter | — | — | Named | — | Filtert Tabs zu Chromium-basierten Browserinstanzen (Edge oder Chrome) |
| `-Firefox` | SwitchParameter | — | — | Named | — | Filtert Tabs auf Firefox-Browserinstanzen |
| `-PlayWright` | SwitchParameter | — | — | Named | — | Filtert die Registerkarten auf alle von Playwright verwalteten Browsertypen |
| `-Webkit` | SwitchParameter | — | — | Named | — | Filtert Registerkarten auf WebKit-Browserinstanzen |
| `-All` | SwitchParameter | — | — | Named | — | Registerkarten von allen Browsertypen anzeigen (keine Filterung) |
...
> Tab-Index aus der angezeigten Liste
...
> Wählt ersten Tab aus, der diesen Text in seiner URL enthält
...
> Direkte Seitenreferenz aus einem Playwright-Browserzustand
...
> Filtert Registerkarten zu Microsoft Edge-Browserinstanzen
...
> Filtert Registerkarten auf Google Chrome-Browserinstanzen
...
> Filtert Tabs zu Chromium-basierten Browserinstanzen (Edge oder Chrome)
...
> Filtert Tabs auf Firefox-Browserinstanzen
...
> Filtert die Registerkarten auf alle von Playwright verwalteten Browsertypen
...
> Filtert Registerkarten auf WebKit-Browserinstanzen
...
> Registerkarten von allen Browsertypen anzeigen (keine Filterung)
...
> Bestätigung überspringen und ersten passenden Tab auswählen
