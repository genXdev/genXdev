...
Legt das Gesichter-Verzeichnis dauerhaft in den Einstellungen fest.
...
Legt das Gesichterverzeichnis nur für die aktuelle Sitzung fest (Globale Variable).
...
Löscht die Einstellung des Gesichtsordners der Sitzung (globale Variable), ohne dauerhafte Einstellungen zu beeinflussen.
