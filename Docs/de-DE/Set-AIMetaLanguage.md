...
> Legt die Standardsprache und optional die Bildverzeichnisse für die Metadatenoperationen von GenXdev.AI fest.

## Description

Diese Funktion konfiguriert die globale Standardsprache für Bildmetadatenoperationen im Modul GenXdev.AI. Optional kann sie auch die globalen Bildverzeichnisse festlegen. Beide Einstellungen werden im Präferenzspeicher des Moduls für die Verwendung in mehreren Sitzungen gespeichert.
...
Legt die Sprache nur für die aktuelle Sitzung fest (Globale Variable).
...
Löscht die Spracheinstellung der Sitzung (Globale Variable), ohne dass dauerhafte Einstellungen beeinflusst werden.
