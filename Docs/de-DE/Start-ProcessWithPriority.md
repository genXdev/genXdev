...
* Startet eine ausführbare Datei mit einem anpassbaren Prioritätslevel und bietet Optionen für Warte- und Prozessverwaltung.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-FilePath` | String | ✅ | — | 0 | — | Pfad zur auszuführenden ausführbaren Datei |
...
| `-NoWait` | SwitchParameter | — | — | Named | `False` | Nicht auf den Abschluss des Prozesses warten |
| `-PassThru` | SwitchParameter | — | — | Named | `False` | Geben Sie das Prozessobjekt zurück |
...
Startet Editor mit niedriger Priorität und kehrt sofort zurück.
...
Verwendet den 'nice'-Alias, um einen Prozess mit hoher Priorität zu starten.

## Parameter Details

### `-FilePath <String>`

> Pfad zur auszuführenden ausführbaren Datei
...
> Nicht auf den Abschluss des Prozesses warten
...
> Geben Sie das Prozessobjekt zurück
