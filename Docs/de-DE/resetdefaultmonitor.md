...
Dieses Skript stellt die standardmäßige Konfiguration des sekundären Monitors für das System wieder her,
wobei der sekundäre Monitor auf den ursprünglichen Standardwert zurückgesetzt wird.
Dies ist nützlich für Benutzer, die nach der Verwendung von nebeneinander angeordneten Konfigurationen zu ihrem vorherigen Multi-Monitor-Setup zurückkehren möchten.
Siehe auch: Funktion 'sidebyside', um für neue Fenster in den Nebeneinander-Modus zu wechseln.
...
Stellt die standardmäßige Zweitmonitor-Konfiguration für das System wieder her.
