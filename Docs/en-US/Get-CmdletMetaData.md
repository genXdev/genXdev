...
| `-Model` | String | — | — | 3 | — | The model identifier or pattern to use for AI translations |
| `-ApiEndpoint` | String | — | — | 4 | — | The API endpoint URL for AI translations |
| `-ApiKey` | String | — | — | 5 | — | The API key for authenticated AI translations |
| `-NoSupportForJsonSchema` | String | — | — | 6 | — | Indicates that LLM has no support for JSON schemas |
