...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Text` | String | — | ✅ (ByValue) | 0 | — | The statement to evaluate |
...
| `-AllowDefaultTools` | SwitchParameter | — | — | Named | — | Allow AI to use default tools and capabilities |
...
| `-Language` | String | — | — | Named | — | Language code or name for the response |
