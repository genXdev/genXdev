...
| `-SessionOnly` | SwitchParameter | — | — | Named | — | Use session-only mode for browser profile. |
| `-ClearSession` | SwitchParameter | — | — | Named | — | Clear browser session before opening. |
| `-SkipSession` | SwitchParameter | — | — | Named | — | Skip browser session restore. |
