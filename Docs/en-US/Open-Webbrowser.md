...
| `-PreferPlaywrightBrowser` | SwitchParameter | — | — | Named | — | Use the bundled Playwright browser binary instead of the OS-installed browser via channel. Only affects Chrome, Edge, and Chromium modes. Implies -PlayWright |
