...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-ProcessName` | String | — | ✅ (ByValue, ByPropertyName) | 0 | — | The process name of the window to position *(Parameter set: )* 🌐 *Supports wildcards* |
| `-Process` | Diagnostics.Process | — | ✅ (ByValue, ByPropertyName) | Named | — | The process of the window to position *(Parameter set: )* |
| `-WindowHelper` | GenXdev.Helpers.WindowObj[] | — | ✅ (ByValue, ByPropertyName) | Named | — | Get-Window helper object for direct window manipulation *(Parameter set: )* |
| `-Monitor` | Int32 | — | — | Named | `-1` | Monitor selection: 0=primary, 1+=specific monitor, -1=current, -2=secondary |
| `-NoBorders` | SwitchParameter | — | — | Named | — | Removes the borders of the window |
| `-Width` | Int32 | — | — | Named | `-1` | Window width in pixels |
| `-Height` | Int32 | — | — | Named | `-999999` | Window height in pixels |
| `-X` | Int32 | — | — | Named | `-999999` | Window horizontal position in pixels |
| `-Y` | Int32 | — | — | Named | `-999999` | Window vertical position in pixels |
