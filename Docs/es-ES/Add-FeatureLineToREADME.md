...
> Agrega una línea de característica al archivo README con una marca de tiempo.

## Description

Agrega una línea de característica al archivo README especificado, con el prefijo de la fecha actual en formato aaaMMdd. La línea puede tener formato de código y mostrarse opcionalmente.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Line` | String | — | — | 0 | `''` | El texto de descripción de la característica a agregar |
...
> El texto de descripción de la característica a agregar
