...
> Agrega un elemento de idea al archivo README.md.

## Description

Agrega una idea con marca de tiempo a la sección "## Ideas" de un archivo README.md.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Line` | String | — | — | 0 | `''` | El texto de la idea a añadir |
