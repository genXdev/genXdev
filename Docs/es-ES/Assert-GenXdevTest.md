...
Esta función proporciona un marco de pruebas para los módulos de GenXdev, ofreciendo ejecución de pruebas a múltiples niveles, desde módulos completos hasta cmdlets individuales. Integra PSScriptAnalyzer para análisis estático de código, Pester para pruebas unitarias y PSScriptAnalyzer para análisis estático de código. La función incluye manejo inteligente de errores con capacidades de resolución impulsadas por IA e informes detallados de progreso para flujos de trabajo de desarrollo.
...
| `-TestFailedAction` | String | — | — | 1 | `'Continue'` | Acción a realizar cuando una prueba falla. Opciones: Ask, Continue, Stop, SolveWithAI, Write-Error, Throw |
| `-DefinitionMatches` | String | — | ✅ (ByValue, ByPropertyName) | 2 | — | Expresión regular para coincidir con definiciones de cmdlets |
| `-ModuleName` | String[] | — | ✅ (ByValue, ByPropertyName) | 3 | — | Nombres de módulos de GenXdev a buscar 🌐 *Supports wildcards* |
| `-NoLocal` | SwitchParameter | — | — | Named | — | Omitir la búsqueda en las rutas de módulos locales |
...
| `-IncludeScripts` | SwitchParameter | — | — | Named | — | Incluye el directorio de scripts además de los módulos regulares *(Parameter set: )* |
| `-OnlyReturnModuleNames` | SwitchParameter | — | — | Named | — | Solo devuelve nombres de módulos únicos |
...
| `-StackTraceVerbosity` | String | — | — | Named | `'FirstLine'` | Nivel de detalle del seguimiento de la pila |
...
| `-SkipModuleImports` | SwitchParameter | — | — | Named | — | Omite la importación de módulos GenXdev antes de las pruebas *(Parameter set: )* |
| `-SkipPSAnalyzerTests` | SwitchParameter | — | — | Named | — | Omite la ejecución de las pruebas de PSAnalyzer |
| `-SkipPesterTests` | SwitchParameter | — | — | Named | — | Omite la invocación de las pruebas de Pester |
...
> Acción a realizar cuando una prueba falla. Opciones: Ask, Continue, Stop, SolveWithAI, Write-Error, Throw
...
> Expresión regular para coincidir con definiciones de cmdlets
...
> Omitir la búsqueda en las rutas de módulos locales
...
> Buscar solo en rutas de módulos publicados
...
> Buscar en archivos de script en lugar de módulos
...
> Solo devuelve nombres de módulos únicos
...
> Requiere coincidencias exactas para los nombres de cmdlet
...
> Nivel de detalle del seguimiento de la pila
...
> También selecciona pruebas unitarias que tienen largas duraciones de ejecución.
...
> Omite la importación de módulos GenXdev antes de las pruebas
...
> Omite la ejecución de las pruebas de PSAnalyzer
...
> Omite la invocación de las pruebas de Pester
