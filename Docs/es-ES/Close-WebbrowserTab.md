...
> Cierra la pestaña del navegador web actualmente seleccionada.

## Description

Cierra la pestaña del navegador web actualmente seleccionada usando el método CloseAsync() de ChromeDriver. Si no hay ninguna pestaña seleccionada, la función intentará automáticamente seleccionar la última pestaña utilizada antes de cerrarla.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Edge` | SwitchParameter | — | — | Named | — | Navegar usando el navegador Microsoft Edge |
| `-Chrome` | SwitchParameter | — | — | Named | — | Navegar usando el navegador web Google Chrome |
