...
> Copia los archivos que coinciden con los criterios de búsqueda en subcarpetas basadas en la fecha.

## Description

Busca archivos utilizando el mismo conjunto de parámetros que `Find-Item` y copia cada archivo coincidente en una subcarpeta de `TargetFolder` según la fecha de creación o la fecha de captura del archivo. El cmdlet admite coincidencia de contenido, búsquedas en toda la unidad y muchos filtros.

Intenta varias estrategias para determinar una fecha de creación o captura precisa para el archivo especificado. Las estrategias incluyen leer metadatos EXIF de imágenes, analizar información de fecha/hora de los nombres de archivo y recurrir a la hora de última escritura del archivo cuando no hay otra información fiable disponible.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-TargetFolder` | String | ✅ | — | 0 | — | Carpeta raíz de destino donde los archivos coincidentes se copiarán en subcarpetas basadas en la fecha |
...
| `-DeleteEmptyDirs` | SwitchParameter | — | — | Named | — | Eliminar los directorios de origen vacíos después de mover los archivos |
| `-TargetFolderNameDateSyntax` | String | — | — | Named | `'Year + Month'` | Sintaxis de fecha del nombre de carpeta de destino |
...
Copy-FilesToDateFolder -TargetFolder 'D:\Archivo' -Name '*.jpg' -WhatIf
...
> Carpeta raíz de destino donde los archivos coincidentes se copiarán en subcarpetas basadas en la fecha
...
> Eliminar los directorios de origen vacíos después de mover los archivos
...
> Sintaxis de fecha del nombre de carpeta de destino
