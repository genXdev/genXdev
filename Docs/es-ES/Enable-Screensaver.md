...
Activa el protector de pantalla del sistema Windows ejecutando el ejecutable de protector de pantalla predeterminado (scrnsave.scr) con el modificador /s para iniciarlo de inmediato.
