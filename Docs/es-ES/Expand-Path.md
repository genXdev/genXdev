...
> Expande cualquier referencia de archivo dada a una ruta completa.

## Description

Expande cualquier referencia de archivo dada a una ruta completa, con respecto al directorio actual del usuario. Opcionalmente puede asegurar que los directorios o archivos existan.
...
| `-CreateDirectory` | SwitchParameter | — | — | Named | — | Creará el directorio si no existe |
...
| `-FileMustExist` | SwitchParameter | — | — | Named | — | Producirá un error si el archivo no existe |
...
> Creará el directorio si no existe
...
> Creará un archivo vacío si no existe
...
> Eliminará el archivo si ya existe
...
> Forzará el uso de una unidad específica
...
> Producirá un error si el archivo no existe
...
> Lanzará una excepción si el directorio no existe
