...
Recupera marcadores de Microsoft Edge, Google Chrome o Mozilla Firefox
navegadores instalados en el sistema. La función puede filtrar por tipo de navegador y
devuelve información detallada de los marcadores, incluyendo nombre, URL, ubicación de carpeta y
marcas de tiempo. Maneja automáticamente el consentimiento para la instalación del paquete NuGet System.Data.SQLite
al leer marcadores de Firefox.
...
| `-Edge` | SwitchParameter | — | — | Named | — | Devuelve los marcadores de Microsoft Edge |
| `-Firefox` | SwitchParameter | — | — | Named | — | Devuelve los marcadores de Mozilla Firefox *(Parameter set: )* |
| `-ForceConsent` | SwitchParameter | — | — | Named | — | Forzar el consentimiento para la instalación de software de terceros |
...
> Devuelve los marcadores de Google Chrome
...
> Devuelve los marcadores de Microsoft Edge
...
> Devuelve los marcadores de Mozilla Firefox
...
> Forzar el consentimiento para la instalación de software de terceros
...
> Consentimiento para la instalación de software de terceros
