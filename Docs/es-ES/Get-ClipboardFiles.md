...
> Obtiene archivos del portapapeles de Windows que se establecieron para operaciones de archivos como copiar/pegar.

## Description

* Esta función recupera rutas de archivo del portapapeles de Windows que fueron
  establecidas previamente para operaciones con archivos.
* Maneja automáticamente los modos de subprocesamiento STA y MTA, asegurando
  compatibilidad en diferentes contextos de ejecución de PowerShell.
* La función valida la existencia de archivos y devuelve solo los archivos y directorios
  existentes como objetos similares a la salida de Get-ChildItem o Get-Item.
...
Obtener solo archivos de texto del portapapeles.
