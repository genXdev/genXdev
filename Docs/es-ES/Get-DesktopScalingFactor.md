...
> Recupera el factor de escala de visualización de Windows (configuración de DPI) para un monitor especificado.

## Description

* Obtiene el factor de escala de visualización de Windows actual configurado para un monitor en el sistema.
...
* Si no se especifica un monitor, devuelve el factor de escala para la pantalla principal.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Monitor` | Int32 | — | — | 0 | `0` | El índice de monitor a comprobar (0 = monitor principal) |
...
Devuelve el porcentaje del factor de escalado para el monitor principal.
...
> El índice de monitor a comprobar (0 = monitor principal)
