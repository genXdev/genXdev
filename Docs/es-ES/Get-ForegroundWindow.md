...
> Obtiene el identificador de la ventana activa en primer plano actual.

## Description

* Este cmdlet recupera el identificador de ventana (HWND) de la ventana que se encuentra actualmente en primer plano y tiene el foco del teclado.
* Utiliza funciones de la API de Windows a través de P/Invoke para interactuar con la biblioteca User32.dll.
...
Recupera y devuelve el identificador IntPtr de la ventana activa actual.
...
Almacena el identificador de la ventana activa en una variable y la muestra.
