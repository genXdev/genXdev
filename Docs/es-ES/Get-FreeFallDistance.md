...
> Calcula la distancia de caída libre durante un período de tiempo determinado.
...
Calcula la distancia de caída en 10 segundos en pies.
...
> La velocidad terminal en metros por segundo (predeterminado: 53)
...
> La aceleración debida a la gravedad en m/s² (predeterminado: 9.81)
...
> La unidad para la distancia de salida
