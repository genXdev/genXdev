...
> Calcula el tiempo necesario para que un objeto caiga una altura determinada durante una caída libre.

## Description

Calcula la duración del tiempo necesario para que un objeto caiga desde una altura especificada utilizando un método numérico que tiene en cuenta la resistencia del aire y la velocidad terminal. El cálculo utiliza pequeños intervalos de tiempo para modelar con precisión la física de objetos en caída con restricciones realistas de velocidad terminal.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-HeightInMeters` | Double | ✅ | — | 0 | `0` | La altura de caída en metros |
| `-TerminalVelocityInMs` | Double | — | — | 1 | `0` | La velocidad terminal en metros por segundo (por defecto: 53 m/s para un humano) |
...
Calcula el tiempo requerido para caer 100 metros con velocidad terminal humana predeterminada.
...
Calcula el tiempo necesario para caer 50 metros usando el parámetro posicional y la velocidad terminal predeterminada.
...
> La velocidad terminal en metros por segundo (por defecto: 53 m/s para un humano)
...
> La unidad para el tiempo de salida
