...
> Recupera los módulos de GenXDev en orden de dependencia.

## Description

Esta función devuelve una lista de módulos GenXDev organizados en el orden de dependencia correcto para garantizar una carga adecuada de los módulos. Primero recupera toda la información de los módulos y luego los ordena según sus dependencias, comenzando con los módulos principales y terminando con los módulos dependientes. Esto asegura que los módulos se carguen en la secuencia correcta.
...
> Uno o más nombres de módulo para filtrar
