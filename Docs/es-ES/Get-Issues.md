...
> Muestra los problemas de un archivo README.md.

## Description

Muestra todas las incidencias de la sección "## Issues" de un archivo README.md. Puede usar el README en la ubicación actual, el directorio de perfil de PowerShell o el directorio de OneDrive.
