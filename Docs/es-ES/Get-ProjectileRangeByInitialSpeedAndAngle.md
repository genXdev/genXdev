...
Utiliza la fórmula R = (v² sin(2θ)) / g para el movimiento parabólico ideal.
...
| `-As` | String | — | — | 3 | — | Unidad de salida para el intervalo |
...
Calcula el alcance usando la fórmula de movimiento de proyectil.
...
> Unidad de salida para el intervalo
