...
Muestra todas las notas de la versión de la sección "## Release notes" de un archivo README.md. Puede usar el README en la ubicación actual, el directorio de perfil de PowerShell o el directorio de OneDrive.
