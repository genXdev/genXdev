...
Esta función consulta datos de una tabla de base de datos SQLite usando una cadena de conexión o una ruta de archivo de base de datos. Proporciona flexibilidad para conectarse a la base de datos y controlar la cantidad de datos recuperados mediante el parámetro Count.
...
| `-TableName` | String | ✅ | — | 1 | — | El nombre de la tabla desde la que consultar datos. |
