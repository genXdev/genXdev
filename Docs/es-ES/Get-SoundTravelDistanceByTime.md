...
> Calcula la distancia que recorre el sonido en un tiempo determinado.

## Description

Utiliza la fórmula distancia = velocidad * tiempo, con la velocidad predeterminada del sonido en el aire.
...
| `-Medium` | String | ✅ | — | 1 | — | El medio a través del cual viaja el sonido *(Parameter set: )* |
...
Calcula la distancia que viaja el sonido en el agua durante 5 segundos y convierte el resultado a kilómetros.
...
> El medio a través del cual viaja el sonido
