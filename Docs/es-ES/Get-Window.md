...
> Obtiene información de ventanas para procesos o identificadores de ventana especificados.

## Description

* Recupera información de ventanas utilizando el nombre del proceso, ID o identificador de ventana.
...
| `-ProcessId` | Int32 | — | ✅ (ByPropertyName) | Named | `0` | Identificador del proceso para el que se obtendrá la información de la ventana |
...
Recupera información de ventanas para todos los procesos llamados "notepad".
...
Recupera información de la ventana para la ventana con identificador 45678.

## Parameter Details

### `-ProcessName <String>`

> Nombre del proceso para obtener información de la ventana
...
> Identificador del proceso para el que se obtendrá la información de la ventana
...
> Identificador de ventana para obtener información
