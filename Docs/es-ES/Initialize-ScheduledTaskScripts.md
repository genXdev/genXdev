...
> Crea tareas programadas que ejecutan scripts de PowerShell en intervalos especificados.
...
- Cada hora de días específicos (p. ej., lunes a las 13:00)
- Diariamente a horas específicas (p. ej., todos los días a las 15:00)
...
> La ruta del directorio donde se crearán los scripts de tareas
...
> Prefijo para los nombres de las tareas programadas
