...
> Inicializa y configura las rutas de búsqueda del sistema para la administración de paquetes.

## Description

* Crea una lista exhaustiva de rutas de búsqueda combinando ubicaciones predeterminadas del sistema, rutas de Chocolatey, rutas de herramientas de desarrollo y rutas de paquetes personalizadas.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-WorkspaceFolder` | String | — | — | 0 | — | La ruta de la carpeta del espacio de trabajo que se utilizará para los módulos de node y las rutas de PowerShell. |
...
Inicializa las rutas de búsqueda utilizando la carpeta de espacio de trabajo predeterminada.
...
Inicializa las rutas de búsqueda utilizando una carpeta de espacio de trabajo específica.

## Parameter Details

### `-WorkspaceFolder <String>`

> La ruta de la carpeta del espacio de trabajo que se utilizará para los módulos de node y las rutas de PowerShell.
