...
> Da formato a los archivos de script de PowerShell utilizando las reglas de formato de PSScriptAnalyzer.

## Description

Esta función aplica las reglas de formato de PowerShell a archivos de script utilizando el cmdlet Invoke-Formatter de PSScriptAnalyzer. Puede procesar archivos individuales o formatear de forma recursiva múltiples archivos en directorios. La función utiliza configuraciones de formato personalizables y proporciona un registro detallado del proceso de formateo.
...
| `-Settings` | Object | — | — | Named | — | Una tabla hash de configuración o una ruta a un archivo de datos de PowerShell (.psd1) que contiene la configuración de formato. |
| `-Range` | Int32[] | — | — | Named | — | El rango dentro del cual debe realizarse el formato como una matriz de cuatro enteros: número de línea inicial, número de columna inicial, número de línea final, número de columna final. |
| `-Recurse` | SwitchParameter | — | — | Named | — | Procesa archivos de forma recursiva en subdirectorios. |
...
> Especifica la ruta al archivo de script que se va a formatear.
...
> Una tabla hash de configuración o una ruta a un archivo de datos de PowerShell (.psd1) que contiene la configuración de formato.
...
> El rango dentro del cual debe realizarse el formato como una matriz de cuatro enteros: número de línea inicial, número de columna inicial, número de línea final, número de columna final.
...
> Procesa archivos de forma recursiva en subdirectorios.
