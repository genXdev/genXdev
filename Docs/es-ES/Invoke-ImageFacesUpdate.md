...
Esta función procesa imágenes en un directorio específico para identificar y analizar
rostros utilizando tecnología de reconocimiento AI. Crea o actualiza archivos de metadatos
que contienen información facial para cada imagen. Los metadatos se almacenan en un
...
> URL del endpoint de la API, por defecto http://localhost:1234/v1/chat/completions
