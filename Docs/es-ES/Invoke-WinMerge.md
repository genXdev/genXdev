...
Inicia la aplicación WinMerge para comparar archivos de origen y destino en una vista de diferencias lado a lado. La función valida la existencia de ambos archivos de entrada y asegura que WinMerge esté instalado correctamente antes de iniciarlo. Proporciona funcionalidad de espera opcional para pausar la ejecución hasta que WinMerge se cierre.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-SourcecodeFilePath` | String | ✅ | — | 0 | — | Ruta al archivo de origen que se va a comparar |
| `-TargetcodeFilePath` | String | ✅ | — | 1 | — | Ruta al archivo de destino con el que comparar |
| `-Wait` | SwitchParameter | — | — | Named | — | Esperar a que WinMerge se cierre antes de continuar |
...
> Ruta al archivo de origen que se va a comparar
...
> Ruta al archivo de destino con el que comparar
...
> Esperar a que WinMerge se cierre antes de continuar
