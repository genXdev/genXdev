...
Esta función verifica las actualizaciones de Windows, las actualizaciones de paquetes winget y las actualizaciones de módulos de PowerShell. Puede mostrar las actualizaciones disponibles o instalarlas automáticamente. La función requiere privilegios administrativos para instalar las actualizaciones de Windows y puede reiniciar el sistema opcionalmente si las actualizaciones requieren un reinicio.
...
| `-AutoReboot` | SwitchParameter | — | — | Named | — | Reiniciar automáticamente si las actualizaciones requieren un reinicio |
| `-Criteria` | String | — | — | 0 | `"IsInstalled=0 and IsHidden=0 and AutoSelectOnWebSites=1"` | Criterio de búsqueda personalizado de Windows Update |
| `-IncludeDrivers` | SwitchParameter | — | — | Named | — | Incluir controladores en la búsqueda de actualizaciones |
| `-ProcessOptionalUpdates` | SwitchParameter | — | — | Named | — | Incluye actualizaciones opcionales y el aviso para instalar cada una |
| `-GroupByCategory` | SwitchParameter | — | — | Named | — | Agrupe y coloree la salida por categoría de actualización |
| `-NoBanner` | SwitchParameter | — | — | Named | — | Deshabilitar la salida de banner/estado |
| `-NoRebootCheck` | SwitchParameter | — | — | Named | — | Omitir verificación/informe de requisito de reinicio |
...
Instala todas las actualizaciones importantes automáticamente y solicita cada actualización opcional de forma individual, permitiendo la instalación selectiva de actualizaciones opcionales.
...
> Instalar automáticamente las actualizaciones de Windows disponibles
...
> Reiniciar automáticamente si las actualizaciones requieren un reinicio
...
> Criterio de búsqueda personalizado de Windows Update
...
> Incluir controladores en la búsqueda de actualizaciones
...
> Incluye actualizaciones opcionales y el aviso para instalar cada una
...
> Agrupe y coloree la salida por categoría de actualización
...
> Deshabilitar la salida de banner/estado
...
> Omitir verificación/informe de requisito de reinicio
