...
> Inicia una sesión de chat interactiva con texto y capacidades de IA.

## Description

Inicia una sesión de chat interactiva con capacidades de IA, permitiendo a los usuarios agregar o eliminar funciones de PowerShell durante la conversación y ejecutar comandos de PowerShell. Esta función proporciona una interfaz integral para conversaciones impulsadas por IA con una amplia integración de herramientas y opciones de personalización.
...
| `-ChatOnce` | SwitchParameter | — | — | Named | — | Usado internamente, para invocar el modo chat solo una vez después de la invocación de llm *(hidden)* |
...
| `-NoConfirmationToolFunctionNames` | String[] | — | — | Named | — | Nombres de funciones de herramienta que no deberían requerir confirmación |
| `-MaxToolcallBackLength` | Int32 | — | — | Named | — | Longitud máxima para respuestas de devolución de llamada de herramientas |
...
| `-Language` | Object | — | — | Named | — | Idioma para el modelo o la salida |
...
| `-AudioContextSize` | Object | — | — | Named | — | Tamaño del contexto de audio para procesamiento |
...
| `-DontSpeak` | Object | — | — | Named | — | Deshabilitar la salida de voz |
| `-DontSpeakThoughts` | Object | — | — | Named | — | Deshabilitar la salida de voz para los pensamientos |
| `-NoVOX` | Object | — | — | Named | — | Desactivar VOX (activación por voz) |
| `-UseDesktopAudioCapture` | Object | — | — | Named | — | Usar captura de audio del escritorio |
| `-NoContext` | Object | — | — | Named | — | Deshabilitar el uso de contexto |
| `-WithBeamSearchSamplingStrategy` | Object | — | — | Named | — | Utilice la estrategia de muestreo por haz |
| `-OnlyResponses` | Object | — | — | Named | — | Estás configurando PowerShell 7 como la aplicación predeterminada para abrir archivos de script .ps1. |
...
> Nombres de funciones de herramienta que no deberían requerir confirmación
...
> Longitud máxima para respuestas de devolución de llamada de herramientas
...
> Idioma para el modelo o la salida
...
> Usar captura de audio del escritorio
...
> Estás configurando PowerShell 7 como la aplicación predeterminada para abrir archivos de script .ps1.
