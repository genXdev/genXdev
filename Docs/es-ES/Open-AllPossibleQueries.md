...
> Abre todos los tipos de consulta posibles para los términos de búsqueda o URL proporcionados.

## Description

Ejecuta todos los cmdlets que manejan consultas de páginas web, procesando tanto URL como términos de búsqueda. Para las URL, realiza consultas específicas del sitio, y para los términos de búsqueda ejecuta consultas web generales. Esta función descubre y ejecuta dinámicamente todos los cmdlets de consulta disponibles de la familia de módulos GenXdev.Queries.
...
| `-SkipSession` | SwitchParameter | — | — | Named | — | Omitir la restauración de la sesión del navegador. |
...
Abre todos los tipos de consulta posibles para "scripts de PowerShell" en el monitor predeterminado.
...
Abre todos los tipos de consultas posibles para la URL de GitHub utilizando alias y parámetros cortos.
...
> Limpiar la sesión del navegador antes de abrir.
...
> Omitir la restauración de la sesión del navegador.
...
- [ConvertTo-Uris](https://github.com/genXdev/genXdev/blob/main/Docs/es-ES/ConvertTo-Uris.md)
