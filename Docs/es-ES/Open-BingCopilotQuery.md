...
Abre una consulta de Bing Copilot en el navegador web. La función escribe automáticamente la consulta y la envía utilizando la función subyacente Open-WebsiteAndPerformQuery. Esto proporciona una forma conveniente de interactuar con Microsoft Copilot desde PowerShell.
...
| `-SessionOnly` | SwitchParameter | — | — | Named | — | Usar el modo solo de sesión para el perfil del navegador. |
| `-ClearSession` | SwitchParameter | — | — | Named | — | Limpiar sesión/perfil del navegador antes de abrir. |
| `-SkipSession` | SwitchParameter | — | — | Named | — | Omitir la carga de sesión/perfil del navegador. |
...
> Usar el modo solo de sesión para el perfil del navegador.
...
> Limpiar sesión/perfil del navegador antes de abrir.
...
> Omitir la carga de sesión/perfil del navegador.
