...
Abre una o varias consultas de búsqueda de Bing en un navegador web, utilizando configuraciones de navegador y parámetros de línea de comandos configurables. Esta función proporciona una interfaz completa para realizar búsquedas en Bing con amplias opciones de personalización del navegador, incluyendo posicionamiento de ventanas, selección de monitor, navegación privada y automatización de pulsaciones de teclas.
...
Abre una búsqueda de Bing utilizando el alias y los nombres de parámetros cortos.
...
Busca varios términos mediante canalización y abre los resultados en todos los navegadores instalados, colocando las ventanas en el lado izquierdo de la pantalla.
