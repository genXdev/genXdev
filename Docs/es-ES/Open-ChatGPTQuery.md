...
> Abre una consulta de ChatGPT en un navegador web.

## Description

Abre ChatGPT en un navegador web, introduce automáticamente la consulta especificada y la envía. Admite múltiples consultas que se ejecutarán utilizando la función subyacente Open-WebsiteAndPerformQuery. Esta función proporciona una forma conveniente de interactuar con el ChatGPT de OpenAI desde PowerShell con amplias opciones de configuración del navegador.
...
| `-ShowWindow` | SwitchParameter | — | — | Named | — | Mostrar la ventana del navegador |
...
Envíe múltiples consultas usando el nombre completo del parámetro.
...
Enviar una consulta usando alias y canalización.
...
- [Open-BingCopilotQuery](https://github.com/genXdev/genXdev/blob/main/Docs/es-ES/Open-BingCopilotQuery.md)
- [Open-CloudLLMChat](https://github.com/genXdev/genXdev/blob/main/Docs/es-ES/Open-CloudLLMChat.md)
- [Open-DeepSearchQuery](https://github.com/genXdev/genXdev/blob/main/Docs/es-ES/Open-DeepSearchQuery.md)
- [Open-GithubCopilotQuery](https://github.com/genXdev/genXdev/blob/main/Docs/es-ES/Open-GithubCopilotQuery.md)
- [Open-GoogleGeminiQuery](https://github.com/genXdev/genXdev/blob/main/Docs/es-ES/Open-GoogleGeminiQuery.md)
- [Open-XGrokQuery](https://github.com/genXdev/genXdev/blob/main/Docs/es-ES/Open-XGrokQuery.md)
