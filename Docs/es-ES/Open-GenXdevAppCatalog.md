...
Abre el catálogo con los progressive webapps publicados de GenXdev en un navegador web.
Se abre en modo aplicación con pantalla completa habilitada por defecto para proporcionar una experiencia de visualización óptima del catálogo. Admite todas las opciones de configuración estándar del navegador web, incluyendo la colocación del monitor, el tamaño de la ventana y las preferencias de idioma.

La función configura automáticamente el navegador para la mejor experiencia de visualización del catálogo y puede abrir varias instancias del navegador simultáneamente. Ofrece soporte completo de idiomas y respeta las preferencias del usuario en cuanto a la selección y posicionamiento del navegador.
...
Abre el catálogo de la aplicación GenXdev en el monitor 1 en modo aplicación con pantalla completa activada.
...
Abre el catálogo de GenXdev en el monitor 1 usando el comando alias.
