...
> Abre una consulta de GitHub Copilot en un navegador web

## Description

Abre una consulta de Github CoPilot en el navegador web e introduce automáticamente la consulta especificada. La función espera a que la página se cargue antes de escribir la consulta. Esta función utiliza la función subyacente Open-WebsiteAndPerformQuery para manejar la automatización del navegador y proporciona una forma conveniente de interactuar con GitHub Copilot desde PowerShell con amplias opciones de configuración del navegador.
