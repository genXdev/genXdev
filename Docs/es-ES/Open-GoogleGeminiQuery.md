...
> Abre una consulta de Google Gemini en un navegador web

## Description

Abre una consulta de Google Gemini en el navegador web, introduce automáticamente la consulta y la envía. Esto proporciona una forma rápida de interactuar con la IA Gemini de Google. La función admite un control extenso del navegador, incluida la selección de monitores, la posición de las ventanas y funciones de automatización del teclado.
...
Abre Google Gemini y envía la consulta "¿Qué es PowerShell?".
...
Utiliza el alias para enviar una consulta sobre matrices a través de la entrada de canalización.
