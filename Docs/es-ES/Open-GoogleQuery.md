...
> Abre consultas de Google en un navegador web con opciones configurables y amplias opciones de personalización.
...
de navegador y automatización del teclado. La función proporciona una interfaz rica
en funciones para realizar búsquedas en Google con control preciso sobre el
comportamiento y la apariencia del navegador.

Las características principales incluyen:
- Soporte para más de 100 idiomas mediante el filtrado de idiomas de Google
...
- Opciones para bloquear extensiones y ventanas emergentes
- Gestión de enfoque y manipulación de ventanas
- Procesamiento por lotes de consultas con soporte de canalización
- Automatización de pulsaciones de teclas en ventanas del navegador
- Paso inteligente de parámetros a las funciones subyacentes del navegador

La función formatea automáticamente las consultas de búsqueda para el motor de búsqueda
de Google y aplica el filtrado de idiomas cuando se especifica. Todas las funciones de
posicionamiento y gestión del navegador se heredan de la función Open-Webbrowser subyacente.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Queries` | String[] | ✅ | ✅ (ByValue, ByPropertyName) | 0 | — | Los términos de búsqueda para consultar en Google |
| `-Language` | String | — | — | 1 | — | El idioma para los resultados de búsqueda de Google |
...
| `-Monitor` | Int32 | — | — | Named | `-1` | El monitor a utilizar, 0 = predeterminado, -1 es descartar, -2 = monitor secundario configurado, por defecto es -1 |
...
Abre una búsqueda de Google para "PowerShell scripting" en inglés en el monitor principal.
...
Abre una búsqueda de Google para "algoritmos de aprendizaje automático" en modo de pantalla completa en el monitor 2 usando alias.
...
Abre una búsqueda en modo aplicación (sin controles del navegador) centrada en la pantalla.

## Parameter Details

### `-Queries <String[]>`

> Los términos de búsqueda para consultar en Google
...
> El idioma para los resultados de búsqueda de Google
...
> El monitor a utilizar, 0 = predeterminado, -1 es descartar, -2 = monitor secundario configurado, por defecto es -1
