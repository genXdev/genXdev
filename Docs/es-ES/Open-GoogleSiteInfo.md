...
> Abre consultas de información de sitios de Google en un navegador web.
...
| `-SessionOnly` | SwitchParameter | — | — | Named | — | Usar el modo solo de sesión para el perfil del navegador (sin datos persistentes) |
| `-ClearSession` | SwitchParameter | — | — | Named | — | Limpiar los datos de sesión/perfil del navegador antes de abrir |
| `-SkipSession` | SwitchParameter | — | — | Named | — | Omitir el uso de una sesión/perfil del navegador (usar el predeterminado) |
...
> Usar el modo solo de sesión para el perfil del navegador (sin datos persistentes)
...
> Limpiar los datos de sesión/perfil del navegador antes de abrir
...
> Omitir el uso de una sesión/perfil del navegador (usar el predeterminado)
...
> Abrir ventanas del navegador una al lado de la otra
