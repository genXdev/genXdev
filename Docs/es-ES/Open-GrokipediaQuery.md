...
> Abre una consulta de Grokipedia en un navegador web.

## Description

Abre una o varias consultas de búsqueda de Grokipedia en un navegador web con amplias opciones de configuración. Admite comportamiento configurable del navegador, selección de monitor y posicionamiento de ventanas. Las consultas se codifican en URL y se abren utilizando el dominio de Grokipedia del idioma especificado con soporte completo de localización.

La función proporciona un control completo del navegador, incluyendo modos de navegación privada, posicionamiento de ventanas, automatización del teclado y soporte para múltiples monitores. Maneja automáticamente la codificación de URL y la asignación de códigos de idioma para dominios internacionales de Grokipedia.
...
| `-SessionOnly` | SwitchParameter | — | — | Named | — | Usar configuraciones alternativas almacenadas en la sesión para las preferencias de IA. |
| `-ClearSession` | SwitchParameter | — | — | Named | — | Borrar configuraciones alternativas almacenadas en la sesión para las preferencias de IA. |
...
Abre una búsqueda en Grokipedia de "PowerShell" en inglés en el monitor predeterminado.
...
Abre una búsqueda de Grokipedia utilizando el alias con parámetros posicionales.
...
Busca varios términos en Grokipedia usando el modo de navegación privada.

## Parameter Details

### `-Queries <String[]>`

> La consulta de búsqueda de Grokipedia a ejecutar
...
> Devuelve un objeto de proceso de PowerShell que representa el proceso del navegador
...
> Usar configuraciones alternativas almacenadas en la sesión para las preferencias de IA.
...
> Borrar configuraciones alternativas almacenadas en la sesión para las preferencias de IA.
