...
Abre una consulta de «Internet Movie Database» en un navegador web con amplias opciones de configuración. Esta función proporciona un contenedor conveniente para la funcionalidad de búsqueda de IMDB, permitiendo a los usuarios buscar películas, programas de televisión, actores y otro contenido de entretenimiento directamente desde PowerShell.

La función acepta términos de búsqueda y construye las URL de búsqueda correctas de IMDB, luego las abre en el navegador web especificado con opciones personalizables de posición de ventana, selección de navegador y opciones de visualización. Es compatible con todos los navegadores principales, incluidos Edge, Chrome y Firefox, con opciones de navegación privada, modo de pantalla completa y gestión de ventanas.

Las características clave incluyen compatibilidad con múltiples monitores, localización de idiomas, automatización del teclado y opciones completas de configuración del navegador. La función puede manejar múltiples consultas de búsqueda simultáneamente y proporciona opciones tanto para uso interactivo como para flujos de trabajo automatizados.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Queries` | String[] | ✅ | ✅ (ByValue, ByPropertyName) | 0 | — | Los términos de búsqueda a consultar en IMDB |
...
| `-SendKeyEscape` | SwitchParameter | — | — | Named | — | Escapa caracteres de control al enviar teclas al navegador |
| `-SendKeyHoldKeyboardFocus` | SwitchParameter | — | — | Named | — | Impide devolver el foco del teclado a PowerShell después de enviar pulsaciones de teclas |
| `-SendKeyUseShiftEnter` | SwitchParameter | — | — | Named | — | Usa Shift+Enter en lugar de Enter normal para saltos de línea al enviar teclas |
...
Abre una búsqueda en IMDb para "The Matrix" en el monitor predeterminado.
...
Abre una búsqueda en IMDB para "The Matrix" utilizando los parámetros de alias y abreviatura.
...
Busca múltiples películas en IMDB con resultados en francés en Chrome.
...
Busca a Tom Hanks en IMDB en modo de pantalla completa y luego devuelve el foco a PowerShell.

## Parameter Details

### `-Queries <String[]>`

> Los términos de búsqueda a consultar en IMDB
...
> Desactiva la funcionalidad de bloqueo de ventanas emergentes del navegador
...
> Escapa caracteres de control al enviar teclas al navegador
...
> Impide devolver el foco del teclado a PowerShell después de enviar pulsaciones de teclas
...
> Usa Shift+Enter en lugar de Enter normal para saltos de línea al enviar teclas
