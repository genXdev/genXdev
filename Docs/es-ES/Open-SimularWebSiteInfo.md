...
> Abre la información del sitio web de SimilarWeb para las URL especificadas en un navegador web.

## Description

Abre una consulta de "Sitios similares" en un navegador web de manera configurable usando interruptores de línea de comandos. Permite ver análisis y comparaciones de sitios web para análisis de tráfico web, investigación de competidores y conocimientos de marketing digital.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Queries` | String[] | ✅ | ✅ (ByValue, ByPropertyName) | 0 | — | Las URL del sitio web para analizar en SimilarWeb |
...
Abre un análisis de SimilarWeb para Google.com en el monitor principal.
...
Abre un análisis de SimilarWeb usando el alias de la función con posicionamiento del monitor.
...
Analiza múltiples sitios web a través de la entrada de canalización con posicionamiento de ventana centrado.
...
Devuelve la URL de SimilarWeb para GitHub sin abrir el navegador.

## Parameter Details

### `-Queries <String[]>`

> Las URL del sitio web para analizar en SimilarWeb
