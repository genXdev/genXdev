...
> Abre consultas de búsqueda de Stack Overflow en un navegador web.

## Description

Abre una o más consultas de búsqueda de Stack Overflow en un navegador web con opciones completas de configuración del navegador y la pantalla. Esta función proporciona un contenedor avanzado alrededor de la funcionalidad de búsqueda de Stack Overflow con amplias opciones para la posición de la ventana, la selección del navegador y la personalización del comportamiento.

Características principales:
- Soporte para múltiples consultas de búsqueda con entrada a través de tuberías
- Detección y selección inteligente del navegador (Edge, Chrome, Firefox, todos los navegadores)
...
- Soporte de localización de idiomas para resultados de búsqueda internacionales
...
- Opciones de devolución de URL para flujos de trabajo de automatización

La función detecta automáticamente las capacidades del sistema y ajusta el comportamiento en consecuencia. Para navegadores no instalados en el sistema, las operaciones se omiten silenciosamente sin errores.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Queries` | String[] | ✅ | ✅ (ByValue, ByPropertyName) | 0 | — | Las consultas de búsqueda que realizar en Stack Overflow |
| `-Language` | String | — | — | 1 | — | El idioma de los resultados de búsqueda devueltos para contenido localizado de Stack Overflow |
| `-Monitor` | Int32 | — | — | Named | `-1` | El monitor a utilizar, 0 = predeterminado, -1 es descartar, -2 = Monitor secundario configurado, por defecto es -1, sin posicionamiento |
...
| `-AcceptLang` | String | — | — | Named | — | Establecer el encabezado HTTP de idioma aceptado del navegador |
...
| `-SessionOnly` | SwitchParameter | — | — | Named | — | Usar configuraciones alternativas almacenadas en la sesión para las preferencias de búsqueda de Stack Overflow |
| `-ClearSession` | SwitchParameter | — | — | Named | — | Borrar configuraciones alternativas almacenadas en la sesión para las preferencias de búsqueda de Stack Overflow |
| `-SkipSession` | SwitchParameter | — | — | Named | — | Almacenar la configuración solo en preferencias persistentes sin afectar la sesión para la búsqueda de Stack Overflow |
...
Abre una búsqueda de Stack Overflow para "powershell array" en el monitor principal.
...
Abre una búsqueda en Stack Overflow usando el alias con posición del monitor.
...
Devuelve la URL de búsqueda de Stack Overflow sin abrir un navegador.

## Parameter Details

### `-Queries <String[]>`

> Las consultas de búsqueda que realizar en Stack Overflow
...
> El idioma de los resultados de búsqueda devueltos para contenido localizado de Stack Overflow
...
> Usar configuraciones alternativas almacenadas en la sesión para las preferencias de búsqueda de Stack Overflow
...
> Borrar configuraciones alternativas almacenadas en la sesión para las preferencias de búsqueda de Stack Overflow
...
> Almacenar la configuración solo en preferencias persistentes sin afectar la sesión para la búsqueda de Stack Overflow
