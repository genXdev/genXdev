...
> Abre un juego de simulación viral en un navegador web con amplias opciones de configuración.

## Description

Abre el juego de simulación viral en https://viral.genxdev.net/ en un navegador web especificado con opciones configurables de ventana, posicionamiento y comportamiento. Admite múltiples navegadores, navegación privada, modo aplicación y funciones completas de gestión de ventanas.

La función proporciona una experiencia interactiva de simulación viral con características como:
- Soporte para múltiples navegadores (Edge, Chrome, Firefox)
- Controles de posicionamiento y tamaño de ventana
- Opciones de pantalla completa y modo aplicación
- Capacidades de navegación privada
- Soporte para automatización de teclado
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Language` | String | — | — | 0 | — | El idioma para la visualización del contenido web y la configuración de idioma del navegador |
...
| `-Monitor` | Int32 | — | — | Named | `-2` | El monitor a usar, 0 = predeterminado, -1 es descartar, -2 = Monitor secundario configurado, por defecto $Global:DefaultSecondaryMonitor o 2 si no se encuentra |
...
Abre la simulación viral en Google Chrome con modo de navegación privada y sin
pantalla completa.
...
Abre la simulación viral usando alias con Chrome, modo incógnito y sin pantalla completa.

## Parameter Details

### `-Language <String>`

> El idioma para la visualización del contenido web y la configuración de idioma del navegador
