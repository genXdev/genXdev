...
> Abre un navegador web para buscar letras de la música que se está reproduciendo en VLC.

## Description

Esta función detecta si VLC Media Player está en ejecución y busca letras basándose en el título del medio que se está reproduciendo actualmente. Abre automáticamente una consulta de búsqueda en un navegador web para encontrar las letras de la pista actual. La función admite múltiples navegadores y proporciona amplias opciones de posicionamiento de ventana y visualización.
...
| `-SessionOnly` | SwitchParameter | — | — | Named | — | Usar una sesión que no se mantenga después de cerrar el navegador |
| `-ClearSession` | SwitchParameter | — | — | Named | — | Borrar los datos de sesión del navegador antes de abrirlo |
| `-SkipSession` | SwitchParameter | — | — | Named | — | Omitir el uso de cualquier sesión de navegador existente |
...
Abre una búsqueda en Google para la letra de la canción que se está reproduciendo actualmente en VLC.
...
> Términos de búsqueda para encontrar una pista
...
> Usar una sesión que no se mantenga después de cerrar el navegador
...
> Borrar los datos de sesión del navegador antes de abrirlo
...
> Omitir el uso de cualquier sesión de navegador existente
