...
> Abre la información del sitio web de WaybackMachine en un navegador web.

## Description

Abre una consulta de Waybackmachine en un navegador web, mostrando versiones históricas de la URL o sitio web especificado. Admite múltiples consultas y selección de monitor. Proporciona acceso a contenido web archivado a través del servicio Wayback Machine de Internet Archive.
...
| `-Language` | String | — | — | 1 | — | La preferencia de idioma para la interfaz y el contenido del navegador |
...
| `-SessionOnly` | SwitchParameter | — | — | Named | — | Utilizar configuraciones alternativas almacenadas en la sesión para las preferencias de Wayback Machine |
| `-ClearSession` | SwitchParameter | — | — | Named | — | Borrar configuraciones alternativas almacenadas en la sesión para las preferencias de Wayback Machine |
...
Abre el archivo de Wayback Machine para example.com en el monitor predeterminado.
...
Abre el archivo de Wayback Machine para example.com usando alias con posicionamiento de monitor descartado.
...
Abre el archivo de Wayback Machine para microsoft.com en el modo incógnito de Chrome.
...
> La preferencia de idioma para la interfaz y el contenido del navegador
...
> Utilizar configuraciones alternativas almacenadas en la sesión para las preferencias de Wayback Machine
...
> Borrar configuraciones alternativas almacenadas en la sesión para las preferencias de Wayback Machine
