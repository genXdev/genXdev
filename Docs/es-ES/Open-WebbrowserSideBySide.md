...
> Abre una nueva ventana del navegador web con posicionamiento específico.

## Description

Abre una nueva ventana del navegador (Edge o Chrome) ubicada en el lado derecho del monitor principal en modo de fondo.
