...
> Abre una nueva ventana del navegador web con una posición específica.

## Description

Abre una nueva ventana del navegador (Edge o Chrome) situada en el lado derecho del monitor principal en modo de fondo.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Url` | String[] | — | ✅ (ByValue) | 0 | — | Las direcciones URL para abrir en el navegador |
