...
Esta función abre un sitio web por URL en el navegador web predeterminado, introduce una o más consultas y las envía. Admite una amplia selección de monitores y opciones de posicionamiento de ventanas a través de la función subyacente Open-Webbrowser.

La función copia automáticamente cada consulta al portapapeles y la envía a la ventana del navegador mediante automatización del teclado. Conserva el contenido original del portapapeles y lo restaura después de que se procesen todas las consultas.
