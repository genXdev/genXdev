...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Url` | String | ✅ | ✅ (ByPropertyName) | 0 | — | La URL del sitio web que se va a abrir |
...
| `-SendKeyDelayMilliSeconds` | Int32 | — | — | Named | `500` | Retraso entre el envío de diferentes secuencias de teclas en milisegundos |
