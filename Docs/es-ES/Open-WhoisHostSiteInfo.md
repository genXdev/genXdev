...
> Abre una consulta de información de host Whois en un navegador web.

## Description

Abre consultas de información de host Whois en un navegador web para nombres de dominio o direcciones IP. Admite selección de monitor configurable y múltiples consultas con opciones extensas de configuración del navegador, incluyendo posicionamiento de ventanas, selección de navegador y funciones de automatización.
...
| `-SessionOnly` | SwitchParameter | — | — | Named | — | Utilice configuraciones alternativas almacenadas en la sesión para las preferencias de IA como idioma, colecciones de imágenes, etc. |
...
| `-SkipSession` | SwitchParameter | — | — | Named | — | Almacene la configuración solo en preferencias persistentes sin afectar la sesión para las preferencias de IA como Idioma, colecciones de imágenes, etc. |
...
Abre la información Whois de varios dominios en el monitor predeterminado.
...
Abre la información Whois de example.com usando alias y parámetros posicionales.
...
Abre información Whois de dominios desde la canalización en el modo incógnito de Chrome.
...
> Utilice configuraciones alternativas almacenadas en la sesión para las preferencias de IA como idioma, colecciones de imágenes, etc.
...
> Almacene la configuración solo en preferencias persistentes sin afectar la sesión para las preferencias de IA como Idioma, colecciones de imágenes, etc.
