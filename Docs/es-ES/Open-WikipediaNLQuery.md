...
| `-SessionOnly` | SwitchParameter | — | — | Named | — | Usar cookies solo de sesión (sin cookies persistentes) |
| `-ClearSession` | SwitchParameter | — | — | Named | — | Limpiar los datos de sesión del navegador antes de abrir |
| `-SkipSession` | SwitchParameter | — | — | Named | — | Saltar restauración de la sesión anterior del navegador |
