...
> Abre búsquedas de Wikipedia en neerlandés en un navegador web.

## Description

Abre una consulta 'Wikipedia - Países Bajos' en un navegador web, con opciones de visualización configurables. Admite la búsqueda de varios términos y permite especificar en qué monitor mostrar los resultados.
...
| `-SideBySide` | SwitchParameter | — | — | Named | — | Abre dos ventanas del navegador una al lado de la otra |
| `-SessionOnly` | SwitchParameter | — | — | Named | — | Usar solo cookies de sesión (sin cookies persistentes) |
| `-ClearSession` | SwitchParameter | — | — | Named | — | Limpiar los datos de sesión del navegador antes de abrir |
...
> Usar solo cookies de sesión (sin cookies persistentes)
...
> Limpiar los datos de sesión del navegador antes de abrir
...
> Omitir la restauración de la sesión anterior del navegador
