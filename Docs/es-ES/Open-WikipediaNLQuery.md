...
Abre una consulta de 'Wikipedia - Países Bajos' en un navegador web, con opciones de visualización configurables. Admite la búsqueda de múltiples términos y especificar en qué monitor mostrar los resultados.
