...
Abre una o más consultas de Wolfram Alpha en un navegador web. Admite selección configurable de monitor y opciones de navegador a través de parámetros dinámicos. Proporciona control completo del navegador, incluyendo posicionamiento, tamaño y capacidades de automatización para flujos de trabajo mejorados de computación científica.
...
Abre una consulta de Wolfram Alpha para la masa del sol en el monitor predeterminado.
...
Abre múltiples consultas de Wolfram Alpha usando el alias para cálculos científicos rápidos.
...
Abre una consulta de cálculo en modo de pantalla completa con preferencia de idioma inglés mediante entrada de pipeline.
