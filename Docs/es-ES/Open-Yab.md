...
Abre el sitio web del juego YAB en un navegador especificado con varias opciones de visualización y comportamiento. Admite diferentes modos de juego, incluido el modo espectador. El juego YAB es un juego de rompecabezas en línea que se puede jugar de forma interactiva o ver en modo espectador, donde la IA juega automáticamente.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Language` | String | — | — | 0 | — | El idioma de la interfaz del juego |
...
| `-ShowWindow` | SwitchParameter | — | — | Named | — | Muestra la ventana del navegador (no minimizada ni oculta) |
