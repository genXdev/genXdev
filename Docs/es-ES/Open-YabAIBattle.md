...
> Abre el juego YabAI Battle en un navegador web.

## Description

Esta función inicia el juego YabAI Battle en un navegador web con amplias opciones de personalización para la colocación de la ventana, la selección del navegador y el modo de visualización. Proporciona un envoltorio alrededor de la función GenXdev\Open-Webbrowser con la construcción de URL específica del juego y el manejo de parámetros.

La función admite dos modos de juego:
- Modo Batalla: Iniciar una nueva batalla IA vs IA
- Modo Espectador: Ver batallas IA existentes
...
| `-SendKeyUseShiftEnter` | SwitchParameter | — | — | Named | — | Envía Mayús+Intro en lugar de Intro normal para los saltos de línea al enviar teclas. |
...
| `-RestoreFocus` | SwitchParameter | — | — | Named | — | Restaurar el enfoque en la ventana anterior después de abrir el navegador. |
...
Abre el juego con la interfaz en español situada en el lado izquierdo del monitor 1.
...
> Envía Mayús+Intro en lugar de Intro normal para los saltos de línea al enviar teclas.
...
> Retraso en milisegundos entre el envío de cada tecla.
...
> Restaurar el enfoque en la ventana anterior después de abrir el navegador.
