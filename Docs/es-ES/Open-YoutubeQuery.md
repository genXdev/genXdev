...
Abre una búsqueda en YouTube de "tutorial de PowerShell" en el monitor predeterminado.
...
Abre una búsqueda en YouTube de "how to code" en el monitor secundario configurado usando el alias de la función.
