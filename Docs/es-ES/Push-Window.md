...
> Empuja la ventana actual a la pila de ventanas con modificaciones opcionales.

## Description

Empuja un asistente de ventana para la ventana actualmente enfocada sobre la pila.
Permite aplicar varias transformaciones de ventana antes o después de empujar.
Esta función captura la ventana actual y la almacena para su posterior recuperación
con Pop-Window, mientras aplica opcionalmente posicionamiento, dimensionamiento y efectos visuales.
