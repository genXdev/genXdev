...
> Expande los objetos de entrada en nombres de archivo y directorio, admitiendo varios filtros y opciones de salida.

## Description

Esta función procesa objetos de entrada (archivos, directorios o colecciones)
y los expande en nombres de archivo y directorio. Admite filtrado,
coincidencia de patrones y puede generar resultados como objetos. La función está
diseñada para trabajar con entrada de canalización y proporciona opciones para recursividad,
flujos de datos alternativos y más.
...
| `-File` | SwitchParameter | — | — | Named | — | Devuelve solo archivos |
...
| `-FilesAndDirectories` | SwitchParameter | — | — | Named | — | Incluya tanto archivos como directorios *(Parameter set: )* |
...
> Objeto de entrada que contiene nombres de archivos o directorios
