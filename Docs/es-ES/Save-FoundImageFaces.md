...
Esta función toma los resultados de búsqueda de imágenes y extrae/guarda regiones de rostros individuales como archivos de imagen separados. Puede buscar rostros utilizando varios criterios y guardarlos en un directorio de salida especificado. La función admite búsqueda por descripción, palabras clave, personas, objetos, escenas, tipo de imagen, tipo de estilo y estado de ánimo general. También puede filtrar por contenido de desnudez y explícito.
...
| `-Scenes` | String[] | — | — | Named | `@()` | Escenas a buscar, se permiten caracteres comodín. |
| `-PictureType` | String[] | — | — | Named | `@()` | Tipos de imagen por los que filtrar, se permiten caracteres comodín. |
| `-StyleType` | String[] | — | — | Named | `@()` | Tipos de estilo para filtrar, se permiten caracteres comodín. |
| `-OverallMood` | String[] | — | — | Named | `@()` | Estados de ánimo generales a filtrar, se permiten comodines. |
...
| `-PathLike` | String[] | — | — | Named | `@()` | Matriz de cadenas de búsqueda con formato de ruta de directorio para filtrar imágenes por ruta (patrones SQL LIKE, p. ej., '%\2024\%') |
| `-InputObject` | Object[] | — | ✅ (ByValue) | Named | — | Acepta los resultados de búsqueda de una llamada anterior -PassThru para regenerar la vista. |
| `-OutputDirectory` | String | — | — | Named | `'.\'` | Directorio para guardar las imágenes de rostros recortados. |
...
| `-SaveUnknownPersons` | SwitchParameter | — | — | Named | — | También guarde personas desconocidas detectadas como objetos. |
...
> Escenas a buscar, se permiten caracteres comodín.
...
> Tipos de imagen por los que filtrar, se permiten caracteres comodín.
...
> Tipos de estilo para filtrar, se permiten caracteres comodín.
...
> Estados de ánimo generales a filtrar, se permiten comodines.
...
> Matriz de cadenas de búsqueda con formato de ruta de directorio para filtrar imágenes por ruta (patrones SQL LIKE, p. ej., '%\2024\%')
...
> Acepta los resultados de búsqueda de una llamada anterior -PassThru para regenerar la vista.
...
> Directorio para guardar las imágenes de rostros recortados.
...
> Forzar reconstrucción de la base de datos del índice de imágenes.
...
> También guarde personas desconocidas detectadas como objetos.
