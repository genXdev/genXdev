...
> Anuncia la hora actual mediante texto a voz.

## Description

Esta función obtiene la hora actual y utiliza el motor de texto a voz del sistema para anunciarla verbalmente en formato de horas y minutos. Es útil para fines de accesibilidad o cuando se necesita un anuncio audible de la hora.
