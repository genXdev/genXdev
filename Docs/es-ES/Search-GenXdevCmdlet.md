...
> Busca un cmdlet de GenXdev y opcionalmente lo abre en un IDE para editarlo.
...
| `-OnlyPublished` | SwitchParameter | — | — | Named | — | Limitar la búsqueda solo a las rutas de módulos publicados |
...
| `-EditCmdlet` | SwitchParameter | — | — | Named | — | Además abre el archivo en el editor después de encontrarlo |
...
> Limitar la búsqueda solo a las rutas de módulos publicados
...
> Abrir el cmdlet encontrado en Visual Studio Code
...
> Abrir el cmdlet encontrado en Visual Studio
...
> Además abre el archivo en el editor después de encontrarlo
