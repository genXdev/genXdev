...
> Envía un paquete mágico Wake-on-LAN para activar equipos remotos en la red.

## Description

Construye y transmite un paquete mágico Wake-on-LAN (WOL) a las direcciones MAC especificadas. El paquete mágico es una transmisión UDP que contiene la dirección MAC objetivo repetida 16 veces, lo que activa las interfaces de red compatibles para encender el ordenador. Admite direcciones de difusión y puertos personalizados.
...
| `-BroadcastAddress` | String | — | — | 1 | `"255.255.255.255"` | La dirección IP de broadcast a la que enviar el paquete mágico (por defecto: 255.255.255.255) |
...
Envía un paquete mágico para activar el equipo con la dirección MAC especificada.
...
Envía paquetes mágicos a varios equipos en el puerto 9 mediante entrada de tubería.

## Parameter Details

### `-MacAddress <String[]>`

> Una o más direcciones MAC a las que enviar el paquete mágico (p. ej., 00:11:22:33:44:55)
...
> La dirección IP de broadcast a la que enviar el paquete mágico (por defecto: 255.255.255.255)
...
> El puerto UDP para enviar el paquete mágico (predeterminado: 4000)
