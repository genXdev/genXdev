...
Utiliza la API de Windows Shell32 para reubicar carpetas del sistema como Documentos, Descargas, Escritorio u otras carpetas conocidas de Windows en una nueva ubicación. La función valida que la ruta de destino exista, busca el GUID único de la carpeta en el registro completo de carpetas conocidas y utiliza la API SHSetKnownFolderPath para realizar la reubicación. Los casos de uso comunes incluyen mover carpetas de usuario a una unidad diferente para la gestión del espacio o la organización. Tenga precaución al mover carpetas críticas del sistema, ya que esto puede afectar la estabilidad del sistema.
...
> Nueva ruta para la carpeta conocida
