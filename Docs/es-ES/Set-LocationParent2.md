...
> Navega dos niveles hacia arriba en la jerarquía del sistema de archivos.

## Description

* Cambia el directorio de trabajo actual al directorio abuelo
  (dos niveles arriba).
...
Cambia al directorio padre del padre y muestra su contenido.
...
Usa el alias '...' para la misma operación.
