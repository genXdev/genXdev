...
Proporciona un control preciso sobre la posición y el tamaño de las ventanas cuando se especifican parámetros de posicionamiento. Es compatible con múltiples monitores, eliminación de bordes y varias posiciones predefinidas como división izquierda/derecha, división superior/inferior y colocación centrada. Las ventanas se pueden posicionar mediante coordenadas o utilizando diseños predefinidos. Sin parámetros de posicionamiento, la función no realiza ninguna acción sobre la ventana.
...
| `-Process` | Diagnostics.Process | — | ✅ (ByValue, ByPropertyName) | Named | — | El proceso de posicionamiento de la ventana *(Parameter set: )* |
...
| `-Width` | Int32 | — | — | Named | `-1` | Anchura de la ventana en píxeles |
...
> El nombre del proceso de la ventana a posicionar
...
> Selección de monitor: 0=principal, 1+=monitor específico, -1=actual, -2=secundario
...
> Posición horizontal de la ventana en píxeles
...
> Posición vertical de la ventana en píxeles
