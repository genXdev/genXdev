...
> Posiciona una ventana en el monitor secundario con opciones de diseño especificadas.

## Description

Esta función permite posicionar ventanas en un monitor secundario configurado usando Set-WindowPosition con varias opciones de diseño, incluyendo alineación, tamaño y configuraciones de borde. Maneja la selección del monitor según la configuración global y proporciona un envoltorio conveniente para el posicionamiento de ventanas en el monitor secundario.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Process` | Diagnostics.Process[] | — | ✅ (ByValue, ByPropertyName) | 0 | — | El proceso de posicionamiento de la ventana |
| `-Monitor` | Int32 | — | — | Named | `-2` | El monitor a usar, 0=predeterminado, -1=descartar, -2=configurado |
...
| `-Y` | Int32 | — | — | Named | `-999999` | La posición Y inicial de la ventana |
...
| `-SetForeground` | SwitchParameter | — | — | Named | — | Colocar la ventana en primer plano después de posicionarla |
...
| `-PassThru` | SwitchParameter | — | — | Named | — | Devuelve el objeto de proceso después de posicionarlo |
| `-SideBySide` | SwitchParameter | — | — | Named | — | Colocar la ventana lado a lado con PowerShell en el mismo monitor |
...
> El proceso de posicionamiento de la ventana
...
> El monitor a usar, 0=predeterminado, -1=descartar, -2=configurado
...
> Enfocar la ventana después de posicionar
...
> Colocar la ventana en primer plano después de posicionarla
...
> Pulsaciones de teclas para enviar a la ventana después de posicionarla
...
> Devuelve el objeto de proceso después de posicionarlo
...
> Colocar la ventana lado a lado con PowerShell en el mismo monitor
