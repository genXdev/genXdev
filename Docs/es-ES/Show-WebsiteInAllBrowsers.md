...
> Abre una URL en varios navegadores simultáneamente en un diseño de mosaico.

## Description

Esta función crea un diseño de mosaico de ventanas del navegador abriendo la URL especificada en Chrome, Edge, Firefox y una ventana de navegación privada. Los navegadores se organizan en un patrón de cuadrícula de 2x2:
- Chrome: Cuadrante superior izquierdo
- Edge: Cuadrante inferior izquierdo
- Firefox: Cuadrante superior derecho
- Ventana privada: Cuadrante inferior derecho

Todos los parámetros de Open-Webbrowser son compatibles y se pasan para controlar el posicionamiento, comportamiento y apariencia del navegador. La función actúa como un contenedor que aplica un posicionamiento constante en cuadrantes, permitiendo una personalización completa de los parámetros de inicio del navegador.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Url` | String | ✅ | ✅ (ByValue, ByPropertyName) | 0 | — | Las URL que se abrirán en todos los navegadores simultáneamente |
...
> Las URL que se abrirán en todos los navegadores simultáneamente
