...
> Examina archivos o directorios en busca de malware usando Windows Defender.

## Description

* Realiza un análisis específico de archivos o directorios utilizando la interfaz de línea de comandos de Windows Defender (MpCmdRun.exe).
* Puede analizar solo en modo de detección o con corrección automática de amenazas habilitada.
* Devuelve verdadero si no se detectan amenazas, falso si se encuentran amenazas o si el análisis falla.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-FilePath` | String | ✅ | ✅ (ByValue, ByPropertyName) | 0 | — | La ruta al archivo o directorio a escanear |
| `-EnableRemediation` | SwitchParameter | — | — | Named | `False` | Indica a Windows Defender que realice acciones contra las amenazas |
...
Escanea el archivo especificado y muestra una salida detallada.
...
Escanea el archivo usando el alias y habilita la corrección.
...
Envía la ruta del archivo al cmdlet usando un alias.

## Parameter Details

### `-FilePath <String>`

> La ruta al archivo o directorio a escanear
...
> Indica a Windows Defender que realice acciones contra las amenazas
