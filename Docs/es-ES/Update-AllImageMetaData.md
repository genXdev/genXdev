...
Esta función procesa sistemáticamente imágenes en varios directorios del sistema para actualizar sus palabras clave, datos de reconocimiento facial, datos de detección de objetos y datos de clasificación de escenas utilizando servicios de IA. Abarca las carpetas de almacenamiento multimedia, archivos del sistema, descargas, OneDrive y fotos personales.

La función procesa imágenes recorriendo cada directorio y procesando archivos individualmente. Las funciones de DeepStack (caras, objetos, escenas) se ejecutan primero, seguidas de la generación de palabras clave y descripciones.

Esto permite la salida de datos estructurados para operaciones de canalización como:
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-ImageDirectories` | String[] | ✅ | — | 0 | — | Matriz de rutas de directorio para procesar actualizaciones de imágenes |
...
| `-TimeoutSeconds` | Int32 | — | — | Named | — | Tiempo de espera en segundos para la solicitud, el valor predeterminado es 24 horas |
...
| `-NoRecurse` | SwitchParameter | — | — | Named | — | No recorrer subdirectorios al procesar imágenes |
| `-RedoAll` | SwitchParameter | — | — | Named | — | Redo todas las imágenes independientemente del procesamiento anterior |
...
> Matriz de rutas de directorio para procesar actualizaciones de imágenes
...
> No recorrer subdirectorios al procesar imágenes
...
> Redo todas las imágenes independientemente del procesamiento anterior
