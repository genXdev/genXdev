...
> Devuelve una cadena (con sangría modificada) de una cadena de bloque de script proporcionada

## Description

Cambia la sangría de una cadena de bloque de script respetando las sangrías originales del bloque de código
