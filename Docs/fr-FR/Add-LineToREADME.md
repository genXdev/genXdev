...
> Ajoute une ligne à un fichier markdown README.md dans une section spécifiée.

## Description

Recherche et modifie un fichier README.md en ajoutant une nouvelle ligne à une section spécifiée.
Peut créer la section si elle n'existe pas. Prend en charge le formatage des lignes en tant que blocs
de code et l'affichage de la section modifiée.

Effectue d'abord une recherche dans le répertoire actuel, puis remonte les répertoires pour trouver l'emplacement
du README. S'il n'est pas trouvé, utilise le README dans le répertoire de profil PowerShell.
...
> La section à laquelle ajouter la ligne
...
> Ouvrir dans Visual Studio Code après modification
