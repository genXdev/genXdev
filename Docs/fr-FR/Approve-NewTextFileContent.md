...
> Comparaison interactive du contenu des fichiers et approbation à l'aide de WinMerge.

## Description

Facilite la comparaison et la fusion de contenu via WinMerge en créant un fichier temporaire avec les modifications proposées. L'utilisateur peut examiner et modifier les changements de manière interactive avant de les approuver. Renvoie l'état d'approbation et le contenu final.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-ContentPath` | String | ✅ | — | 0 | — | Chemin vers le fichier cible pour la comparaison |
...
> Chemin vers le fichier cible pour la comparaison
