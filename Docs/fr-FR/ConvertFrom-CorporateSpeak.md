...
> Convertit le discours corporate poli et professionnel en langage direct et clair à l'aide de l'IA.

## Description

Cette fonction traite le texte d'entrée pour transformer les communications diplomatiques et corporatives en un langage plus direct et clair. Elle peut accepter les entrées directement via des paramètres, depuis le pipeline ou depuis le presse-papiers système. La fonction exploite des modèles d'IA pour analyser et reformuler le texte tout en préservant l'intention originale.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Text` | String | — | ✅ (ByValue) | 0 | — | Le texte à convertir du jargon d'entreprise |
...
> Le texte à convertir du jargon d'entreprise
