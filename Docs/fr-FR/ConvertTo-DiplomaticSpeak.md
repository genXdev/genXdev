...
> Transforme un texte direct ou brusque en langage diplomatique poli et nuancé.

## Description

Cette fonction transforme la saisie utilisateur, qu'il s'agisse d'un ton direct ou brutal, en un langage diplomatique et plein de tact, adapté aux discussions de haut niveau, aux négociations ou aux communications formelles. La fonction utilise des modèles de langage IA pour conserver l'intention originale tout en adoucissant le ton et en rendant le message plus diplomatique et professionnel.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Text` | String | — | ✅ (ByValue) | 0 | — | The text to convert to diplomatic language |
...
> The text to convert to diplomatic language
