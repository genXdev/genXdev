...
Obtient le répertoire des visages actuellement configuré à partir des variables globales ou des préférences.
...
Obtient le répertoire des visages configuré à partir des préférences persistantes uniquement, en ignorant tout paramètre de session.
...
Efface le paramètre du répertoire des sessions faciales, puis obtient le répertoire à partir des préférences persistantes.
...
Retourne le répertoire spécifié après avoir développé le chemin.

## Parameter Details

### `-FacesDirectory <String>`

> Chemin du répertoire pour les fichiers d'images de visages
