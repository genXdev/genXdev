...
| `-ArmLengthInMeters` | Double | — | — | 2 | `0` | La longueur du bras en mètres (par défaut : 0,7) |
| `-As` | String | — | — | 3 | — | L'unité pour la taille de sortie |
...
Calcule la taille apparente à l'aide des paramètres de position.

## Parameter Details

### `-DistanceInMeters <Double>`

> La distance à l'objet en mètres
...
> La longueur du bras en mètres (par défaut : 0,7)
...
> L'unité pour la taille de sortie
