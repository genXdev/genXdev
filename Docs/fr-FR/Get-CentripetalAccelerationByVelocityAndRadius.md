...
| `-As` | String | — | — | 2 | — | Unité de sortie pour l'accélération |
...
Calcule l'accélération centripète pour une vitesse de 10 m/s et un rayon de 5 m, sortie en unités g.
...
Calcule l'accélération centripète pour une vitesse de 20 m/s et un rayon de 10 m à l'aide de paramètres positionnels.
...
> Unité de sortie pour l'accélération
