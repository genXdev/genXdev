...
* Examine tous les processus en cours d'exécution et identifie ceux qui ont le processus PowerShell actuel comme ancêtre dans leur chaîne de processus parent.
...
Obtenir tous les processus enfants de la session PowerShell actuelle.
...
Obtenez les processus enfants avec une sortie détaillée montrant les informations approfondies de détection des processus.
