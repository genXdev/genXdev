...
* Cette applet de commande utilise des appels API Windows via P/Invoke pour identifier et retourner l'objet Process associé à la fenêtre actuellement active.
* Elle exploite les fonctions GetForegroundWindow et GetWindowThreadProcessId de la bibliothèque User32.dll pour déterminer quelle fenêtre a le focus et obtenir son ID de processus associé.
