...
> Renvoie le navigateur web par défaut configuré pour l'utilisateur actuel.

## Description

* Récupère les informations sur le navigateur web par défaut du système en interrogeant le Registre Windows.
* Renvoie une table de hachage contenant le nom du navigateur, sa description, le chemin de l'icône et le chemin de l'exécutable.
