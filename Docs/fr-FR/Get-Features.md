...
> Affiche les fonctionnalités à partir d'un fichier README.md.

## Description

Affiche toutes les fonctionnalités de la section "## Fonctionnalités" d'un fichier README.md. Peut utiliser soit le README dans le répertoire actuel, le répertoire de profil PowerShell, ou le répertoire OneDrive.
