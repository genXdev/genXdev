...
> Affiche les fonctionnalités d'un fichier README.md.

## Description

Affiche toutes les fonctionnalités de la section « ## Features » d'un fichier README.md. Peut utiliser le README dans le répertoire actuel, le répertoire du profil PowerShell ou le répertoire OneDrive.
