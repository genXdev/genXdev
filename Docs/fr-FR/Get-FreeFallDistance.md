...
> Calcule la distance de chute libre pendant une durée donnée.
...
| `-GravityInMetersPerSecondSquared` | Double | — | — | 2 | `0` | L'accélération due à la gravité en m/s² (par défaut : 9,81) |
...
Calcule la distance de chute en 10 secondes en pieds.
...
> La vitesse terminale en mètres par seconde (par défaut : 53)
...
> L'accélération due à la gravité en m/s² (par défaut : 9,81)
...
> L'unité pour la distance de sortie
