...
| `-GravityInMetersPerSecondSquared` | Double | — | — | 1 | `0` | Gravité en m/s². Valeur par défaut 9.81. |
| `-As` | String | — | — | 2 | — | Unité de sortie pour la vélocité. Par défaut 'm/s'. |
...
Calcule la vitesse d'impact pour une chute de 100 mètres et affiche le résultat en km/h.
...
> Gravité en m/s². Valeur par défaut 9.81.
...
> Unité de sortie pour la vélocité. Par défaut 'm/s'.
