...
> Affiche les problèmes à partir d'un fichier README.md.

## Description

Affiche tous les problèmes de la section "## Issues" d'un fichier README.md. Peut utiliser
le README dans l'emplacement actuel, le répertoire du profil PowerShell ou le
répertoire OneDrive.
