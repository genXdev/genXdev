...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-KnownFolder` | String | ✅ | — | 0 | — | Le nom du dossier connu de Windows pour lequel obtenir le chemin |
...
> Le nom du dossier connu de Windows pour lequel obtenir le chemin
