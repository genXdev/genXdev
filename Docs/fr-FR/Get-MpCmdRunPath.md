...
> Obtient le chemin de l'exécutable MpCmdRun.exe de Windows Defender.

## Description

* Localise et retourne le chemin complet de l'utilitaire en ligne de commande Windows Defender (MpCmdRun.exe).
* L'applet de commande vérifie l'emplacement d'installation standard dans Program Files et fournit une gestion d'erreur appropriée si le fichier n'est pas trouvé.
...
Récupère le chemin d'accès complet à l'outil en ligne de commande de Windows Defender.
