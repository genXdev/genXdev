...
> Retourne un objet d'aide pour la fenêtre principale du terminal PowerShell.

## Description

* Récupère un objet d'aide WindowObj qui représente la fenêtre principale du
  processus hôte PowerShell actuel.
* Cela permet la manipulation et l'interaction avec la fenêtre du terminal elle-même.
...
Récupère l'objet WindowObj pour la fenêtre du terminal PowerShell actuelle.
