...
> Capture les messages d'erreur de divers flux et utilise un LLM pour suggérer des correctifs.

## Description

Cette cmdlet capture les messages d'erreur provenant de divers flux PowerShell (entrée pipeline, verbose, information, erreur et avertissement) et formule une invite structurée pour qu'un LLM analyse et suggère des correctifs. Elle exécute ensuite la requête LLM et renvoie la solution suggérée.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Script` | ScriptBlock | ✅ | ✅ (ByValue) | 0 | — | Le script à exécuter et à analyser pour les erreurs |
...
| `-ExposedCmdLets` | GenXdev.Helpers.ExposedCmdletDefinition[] | — | — | Named | `$null` | Tableau des définitions de commandes PowerShell à utiliser comme outils |
...
| `-ImageDetail` | Object | — | — | Named | — | Niveau de détail de l'image pour la requête LLM. |
| `-TTLSeconds` | Object | — | — | Named | — | Durée de vie en secondes pour la requête LLM. |
| `-IncludeThoughts` | Object | — | — | Named | — | Vous êtes un assistant utile conçu pour produire du JSON. |
| `-OutputMarkdownBlocksOnly` | Object | — | — | Named | — | .PARAMETER AclName
Spécifie le nom de la liste de contrôle d'accès (ACL) pour cette règle. |
| `-MarkupBlocksTypeFilter` | Object | — | — | Named | — | Filtrer les types de blocs de balisage dans la réponse du LLM. |
| `-ChatOnce` | Object | — | — | Named | — | Exécutez le chat une seule fois pour la requête LLM. |
| `-MaxToolcallBackLength` | Object | — | — | Named | — | Longueur maximale de rappel d'outil pour la requête LLM. |
...
| `-LengthPenalty` | Object | — | — | Named | — | Pénalité de longueur pour la sortie du LLM. |
| `-EntropyThreshold` | Object | — | — | Named | — | Seuil d'entropie pour la sortie du LLM. |
| `-LogProbThreshold` | Object | — | — | Named | — | Seuil de probabilité logarithmique pour la sortie LLM. |
| `-NoSpeechThreshold` | Object | — | — | Named | — | Aucun seuil de parole pour le traitement audio. |
| `-DontSpeak` | Object | — | — | Named | — | Ne pas produire de sortie audio. |
| `-DontSpeakThoughts` | Object | — | — | Named | — | .
PARAMÈTRES
    -ComputerName <String[]>
        Spécifie le nom de l'ordinateur où la commande est exécutée.
    ...
    -Credential <PSCredential>
        Spécifie un compte utilisateur disposant de l'autorisation d'effectuer cette action.
        ...
        Accepter l'entrée de pipeline ?  False
        Accepter les caractères génériques ? False |
| `-NoVOX` | Object | — | — | Named | — | Désactiver VOX pour la sortie audio. |
| `-UseDesktopAudioCapture` | Object | — | — | Named | — | Utilisez la capture audio du bureau. |
| `-NoContext` | Object | — | — | Named | — | N'utilisez pas le contexte pour la requête LLM. |
| `-WithBeamSearchSamplingStrategy` | Object | — | — | Named | — | Utilisez la stratégie d'échantillonnage par faisceau. |
| `-OnlyResponses` | Object | — | — | Named | — | Assurez-vous que le service de notifications d'événement est en cours d'exécution. |
...
> Le script à exécuter et à analyser pour les erreurs
...
> Pièces jointes à inclure dans la requête LLM.
...
> Niveau de détail de l'image pour la requête LLM.
...
> Durée de vie en secondes pour la requête LLM.
...
> Filtrer les types de blocs de balisage dans la réponse du LLM.
...
> Exécutez le chat une seule fois pour la requête LLM.
...
> Longueur maximale de rappel d'outil pour la requête LLM.
...
> Taille du contexte audio pour la requête LLM.
...
> Pénalité de longueur pour la sortie du LLM.
...
> Seuil d'entropie pour la sortie du LLM.
...
> Seuil de probabilité logarithmique pour la sortie LLM.
...
> Aucun seuil de parole pour le traitement audio.
...
> Ne pas produire de sortie audio.
...
> Désactiver VOX pour la sortie audio.
...
> N'utilisez pas le contexte pour la requête LLM.
...
> Assurez-vous que le service de notifications d'événement est en cours d'exécution.
