...
Affiche tous les éléments de la liste de tâches de la section "## Todoos" d'un fichier README.md. Peut utiliser le README dans le répertoire courant, le répertoire du profil PowerShell ou le répertoire OneDrive.
