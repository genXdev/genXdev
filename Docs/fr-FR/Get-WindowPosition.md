...
Récupère des informations détaillées sur le positionnement, la taille, l'emplacement sur l'écran, l'état d'ancrage et l'état de focus des fenêtres pour des processus ou des handles de fenêtre spécifiés.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-ProcessName` | String | — | ✅ (ByValue, ByPropertyName) | 0 | — | Le nom du processus de la fenêtre pour laquelle obtenir la position *(Parameter set: )* 🌐 *Supports wildcards* |
| `-Process` | Diagnostics.Process | — | ✅ (ByValue, ByPropertyName) | Named | — | Le processus de la fenêtre pour obtenir la position de *(Parameter set: )* |
...
> Le nom du processus de la fenêtre pour laquelle obtenir la position
...
> Le processus de la fenêtre pour obtenir la position de
