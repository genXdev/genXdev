...
> Transforme du texte à l'aide d'un traitement basé sur l'IA.

## Description

Cette fonction traite le texte d'entrée à l'aide de modèles d'IA pour effectuer diverses transformations telles que la vérification orthographique, l'ajout d'émoticônes ou toute autre amélioration de texte spécifiée via des instructions. Elle peut accepter une entrée directement via des paramètres, depuis le pipeline ou depuis le presse-papiers du système.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Text` | String | — | ✅ (ByValue) | 0 | — | Le texte à transformer |
| `-Instructions` | String | — | — | 1 | `('Check and correct any spelling or grammar ' +
            'errors in the text. Return the corrected text without any ' +
            'additional comments or explanations.')` | Instructions pour le modèle d'IA sur la façon de transformer le texte |
...
> Instructions pour le modèle d'IA sur la façon de transformer le texte
