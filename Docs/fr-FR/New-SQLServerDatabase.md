...
| `-DataFilePath` | String | — | — | Named | — | Chemin de fichier de données optionnel (.mdf) pour la création d'une base de données basée sur fichier. *(Parameter set: )* |
| `-LogFilePath` | String | — | — | Named | — | Chemin facultatif du fichier journal (.ldf) pour la création de base de données basée sur des fichiers. *(Parameter set: )* |
| `-DetachAfterCreation` | SwitchParameter | — | — | Named | — | Détacher la base de données après création (pour les bases de données basées sur fichiers). *(Parameter set: )* |
...
> Le nom de la base de données SQL Server à créer
...
> La chaîne de connexion pour se connecter à SQL Server
...
> Chemin de fichier de données optionnel (.mdf) pour la création d'une base de données basée sur fichier.
...
> Chemin facultatif du fichier journal (.ldf) pour la création de base de données basée sur des fichiers.
...
> Détacher la base de données après création (pour les bases de données basées sur fichiers).
