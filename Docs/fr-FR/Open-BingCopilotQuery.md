...
> Ouvre une requête Bing CoPilot dans un navigateur web

## Description

Ouvre une requête Bing CoPilot dans le navigateur Web. La fonction tape automatiquement la requête et la soumet à l'aide de la fonction sous-jacente Open-WebsiteAndPerformQuery. Cela offre un moyen pratique d'interagir avec Microsoft Copilot depuis PowerShell.
...
| `-SessionOnly` | SwitchParameter | — | — | Named | — | Utiliser le mode session uniquement pour le profil du navigateur. |
| `-ClearSession` | SwitchParameter | — | — | Named | — | Effacer la session/profil du navigateur avant d'ouvrir. |
| `-SkipSession` | SwitchParameter | — | — | Named | — | Ignorer le chargement de session/profil du navigateur. |
...
> Utiliser le mode session uniquement pour le profil du navigateur.
...
> Effacer la session/profil du navigateur avant d'ouvrir.
...
> Ignorer le chargement de session/profil du navigateur.
...
- [Open-XGrokQuery](https://github.com/genXdev/genXdev/blob/main/Docs/fr-FROpen-XGrokQuery.md)
