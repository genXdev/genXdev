...
> Ouvre une requête DeepSeek dans un navigateur web

## Description

Ouvre une requête DeepSeek dans le navigateur web, saisit la requête et appuie sur Entrée pour exécuter la recherche. Cette fonction exploite le moteur de recherche IA DeepSeek pour fournir des réponses intelligentes et des éclairages pour les requêtes fournies.
...
Ouvre DeepSeek et recherche « powershell function » en utilisant les paramètres par défaut.
...
Utilise l'alias pour rechercher "fonction powershell" avec les paramètres par défaut.
...
Ouvre DeepSeek en mode plein écran sur le moniteur principal pour rechercher « notions de base de l'apprentissage automatique ».
