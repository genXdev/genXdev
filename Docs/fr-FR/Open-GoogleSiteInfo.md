...
> Ouvre les requêtes d'informations sur les sites Google dans un navigateur Web.
...
| `-SkipSession` | SwitchParameter | — | — | Named | — | Ignorer l'utilisation d'une session/profil de navigateur (utiliser la valeur par défaut) |
...
> Utiliser le mode session uniquement pour le profil du navigateur (aucune donnée persistante)
...
> Effacer les données de session/profil du navigateur avant l'ouverture
...
> Ignorer l'utilisation d'une session/profil de navigateur (utiliser la valeur par défaut)
