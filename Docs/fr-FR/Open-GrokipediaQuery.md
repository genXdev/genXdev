...
> Ouvre une requête Grokipedia dans un navigateur web.

## Description

Ouvre une ou plusieurs requêtes de recherche Grokipedia dans un navigateur Web avec des options de configuration étendues. Prend en charge le comportement configurable du navigateur, la sélection du moniteur et le positionnement des fenêtres. Les requêtes sont encodées en URL et ouvertes en utilisant le domaine Grokipedia de la langue spécifiée avec une prise en charge complète de la localisation.

La fonction offre un contrôle complet du navigateur, y compris les modes de navigation privée, le positionnement des fenêtres, l'automatisation du clavier et la prise en charge de plusieurs moniteurs. Elle gère automatiquement l'encodage des URL et le mappage des codes de langue pour les domaines Grokipedia internationaux.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Queries` | String[] | ✅ | ✅ (ByValue, ByPropertyName) | 0 | — | La requête de recherche Grokipedia à exécuter |
...
Ouvre une recherche Grokipedia pour « PowerShell » en anglais sur le moniteur par défaut.
...
Ouvre une recherche Grokipedia en utilisant l'alias avec des paramètres positionnels.
...
Recherche plusieurs termes dans Grokipédia en utilisant le mode de navigation privée.

## Parameter Details

### `-Queries <String[]>`

> La requête de recherche Grokipedia à exécuter
