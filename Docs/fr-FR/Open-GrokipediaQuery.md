...
> Ouvre une requête Grokipédia dans un navigateur web.

## Description

Ouvre une ou plusieurs requêtes de recherche Grokipedia dans un navigateur web avec des options de configuration étendues. Prend en charge le comportement configurable du navigateur, la sélection du moniteur et le positionnement de la fenêtre. Les requêtes sont encodées en URL et ouvertes en utilisant le domaine Grokipedia de la langue spécifiée avec une prise en charge complète de la localisation.

La fonction offre un contrôle complet du navigateur, y compris les modes de navigation privée, le positionnement de la fenêtre, l'automatisation du clavier et la prise en charge multi-moniteur. Elle gère automatiquement l'encodage URL et le mappage des codes de langue pour les domaines Grokipedia internationaux.
...
Recherche plusieurs termes sur Grokipédia en mode de navigation privée.
