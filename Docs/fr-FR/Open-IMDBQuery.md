...
Ouvre une requête « Internet Movie Database » dans un navigateur Web avec des options de configuration étendues. Cette fonction fournit un wrapper pratique autour de la fonctionnalité de recherche IMDB, permettant aux utilisateurs de rechercher des films, des émissions de télévision, des acteurs et d'autres contenus de divertissement directement depuis PowerShell.

La fonction accepte les termes de recherche et construit les URL de recherche IMDB appropriées, puis les ouvre dans le navigateur Web spécifié avec un positionnement de fenêtre personnalisable, une sélection de navigateur et des options d'affichage. Elle prend en charge tous les principaux navigateurs, y compris Edge, Chrome et Firefox, avec des options de navigation privée, de mode plein écran et de gestion des fenêtres.

Les principales fonctionnalités incluent la prise en charge multi-moniteurs, la localisation linguistique, l'automatisation du clavier et des options de configuration complètes du navigateur. La fonction peut gérer plusieurs requêtes de recherche simultanément et propose des options pour une utilisation interactive et des flux de travail automatisés.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Queries` | String[] | ✅ | ✅ (ByValue, ByPropertyName) | 0 | — | Les termes de recherche à interroger sur IMDB |
...
| `-DisablePopupBlocker` | SwitchParameter | — | — | Named | — | Désactive la fonction de blocage des popups du navigateur |
...
| `-SendKeyUseShiftEnter` | SwitchParameter | — | — | Named | — | Utilise Maj+Entrée au lieu d'Entrée normale pour les sauts de ligne lors de l'envoi des touches |
...
Ouvre une recherche IMDB pour "The Matrix" sur le moniteur par défaut.
...
Ouvre une recherche IMDB pour "The Matrix" en utilisant les paramètres d'alias et de raccourci.
...
Recherche plusieurs films sur IMDB avec des résultats en langue française dans Chrome.
...
Recherche Tom Hanks sur IMDB en mode plein écran, puis rend le focus à PowerShell.

## Parameter Details

### `-Queries <String[]>`

> Les termes de recherche à interroger sur IMDB
...
> Désactive la fonction de blocage des popups du navigateur
...
> Échappe les caractères de contrôle lors de l'envoi de frappes au navigateur
...
> Empêche le retour du focus clavier à PowerShell après l'envoi de frappes
...
> Utilise Maj+Entrée au lieu d'Entrée normale pour les sauts de ligne lors de l'envoi des touches
