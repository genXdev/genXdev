...
> Ouvre une vidéo de citation de film dans un navigateur web.

## Description

Recherche et ouvre des citations de films en utilisant playphrase.me, permettant de spécifier le moniteur et les paramètres du navigateur. Cette fonction donne accès à une vaste base de données de citations de films avec des clips vidéo, prenant en charge plusieurs langues et des options avancées de configuration du navigateur.
...
- Positionnement avancé du navigateur et gestion des fenêtres
...
- Prise en charge de plusieurs moniteurs avec positionnement précis
...
Ouvre une recherche pour la célèbre citation de Terminator "I'll be back".
...
Ouvre une recherche pour la citation de Star Wars en anglais en utilisant la navigation privée.
...
Ouvre plusieurs recherches de citations de films en mode plein écran dans Chrome via le pipeline.
