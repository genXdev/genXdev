...
> Ouvre les informations du site Web SimilarWeb pour les URL spécifiées dans un navigateur Web.

## Description

Ouvre une requête « Similar web » dans un navigateur web de manière configurable à l'aide de commutateurs en ligne de commande. Permet de vérifier les analyses et les comparaisons de sites web pour l'analyse du trafic Web, la recherche concurrentielle et les informations marketing numériques.
...
Ouvre une analyse SimilarWeb pour Google.com sur le moniteur principal.
...
Ouvre une analyse SimilarWeb en utilisant l'alias de fonction avec le positionnement du moniteur.
...
Analyse plusieurs sites Web via l'entrée du pipeline avec un positionnement centré de la fenêtre.
...
Retourne l'URL SimilarWeb pour GitHub sans ouvrir le navigateur.

## Parameter Details

### `-Queries <String[]>`

> Les URL des sites Web à analyser sur SimilarWeb
