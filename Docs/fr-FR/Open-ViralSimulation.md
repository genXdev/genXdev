...
> Ouvre un jeu de simulation virale dans un navigateur web avec des options de configuration étendues.

## Description

Ouvre le jeu de simulation virale à l'adresse https://viral.genxdev.net/ dans un navigateur web spécifié avec des paramètres de fenêtre configurables, des options de positionnement et de comportement. Prend en charge plusieurs navigateurs, la navigation privée, le mode application et des fonctionnalités complètes de gestion des fenêtres.

La fonction offre une expérience de simulation virale interactive avec des fonctionnalités comme :
- Prise en charge de plusieurs navigateurs (Edge, Chrome, Firefox)
- Contrôles de positionnement et de redimensionnement de la fenêtre
- Options de plein écran et de mode application
- Capacités de navigation privée
- Prise en charge de l'automatisation du clavier
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Language` | String | — | — | 0 | — | La langue d'affichage du contenu web et les paramètres de langue du navigateur |
...
Ouvre la simulation virale dans Google Chrome en mode de navigation privée et sans plein écran.
...
Ouvre la simulation virale en utilisant des alias avec Chrome, en mode navigation privée et sans plein écran.

## Parameter Details

### `-Language <String>`

> La langue d'affichage du contenu web et les paramètres de langue du navigateur
