...
> Ouvre un navigateur web pour rechercher les paroles du média en cours de lecture sur VLC.

## Description

Cette fonction détecte si VLC Media Player est en cours d'exécution et recherche les paroles en fonction du titre du média en cours de lecture. Elle ouvre automatiquement une requête de recherche dans un navigateur Web pour trouver les paroles de la piste actuelle. La fonction prend en charge plusieurs navigateurs et offre des options étendues de positionnement et d'affichage des fenêtres.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Queries` | String[] | — | ✅ (ByValue, ByPropertyName) 🌐 Remaining | 0 | — | Termes de recherche pour trouver un morceau |
...
| `-SessionOnly` | SwitchParameter | — | — | Named | — | Utiliser une session qui n'est pas persistée après la fermeture du navigateur |
| `-ClearSession` | SwitchParameter | — | — | Named | — | Effacer les données de session du navigateur avant d'ouvrir le navigateur |
| `-SkipSession` | SwitchParameter | — | — | Named | — | Ignorer toute session de navigateur existante |
| `-SideBySide` | SwitchParameter | — | — | Named | — | Ouvrir les fenêtres du navigateur côte à côte |
...
Ouvre une recherche Google pour les paroles du morceau en cours de lecture dans VLC.
...
Ouvre la recherche de paroles dans Microsoft Edge en mode privé/incognito.

## Parameter Details

### `-Queries <String[]>`

> Termes de recherche pour trouver un morceau
...
> Utiliser une session qui n'est pas persistée après la fermeture du navigateur
...
> Effacer les données de session du navigateur avant d'ouvrir le navigateur
...
> Ignorer toute session de navigateur existante
...
> Ouvrir les fenêtres du navigateur côte à côte
