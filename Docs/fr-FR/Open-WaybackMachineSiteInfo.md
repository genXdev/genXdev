...
> Ouvre les informations du site WaybackMachine dans un navigateur Web.

## Description

Ouvre une requête Waybackmachine dans un navigateur web, affichant les versions historiques de l'URL ou du site spécifié. Prend en charge plusieurs requêtes et la sélection de moniteur. Fournit un accès au contenu web archivé via le service Wayback Machine d'Internet Archive.
...
| `-Language` | String | — | — | 1 | — | La préférence de langue pour l'interface et le contenu du navigateur |
...
| `-SessionOnly` | SwitchParameter | — | — | Named | — | Utiliser des paramètres alternatifs stockés en session pour les préférences de Wayback Machine |
| `-ClearSession` | SwitchParameter | — | — | Named | — | Effacer les paramètres alternatifs stockés dans la session pour les préférences de Wayback Machine |
...
Ouvre l'archive Wayback Machine pour example.com sur le moniteur par défaut.
...
Ouvre l'archive Wayback Machine pour example.com à l'aide d'alias avec le positionnement du moniteur ignoré.
...
Ouvre les archives Wayback Machine pour microsoft.com dans le mode navigation privée de Chrome.
...
> La préférence de langue pour l'interface et le contenu du navigateur
...
> Utiliser des paramètres alternatifs stockés en session pour les préférences de Wayback Machine
...
> Effacer les paramètres alternatifs stockés dans la session pour les préférences de Wayback Machine
