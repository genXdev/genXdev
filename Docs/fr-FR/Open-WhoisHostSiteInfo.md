...
| `-SessionOnly` | SwitchParameter | — | — | Named | — | Utilisez les paramètres alternatifs stockés dans la session pour les préférences IA comme la langue, les collections d'images, etc. |
| `-ClearSession` | SwitchParameter | — | — | Named | — | Effacer les paramètres alternatifs stockés dans la session pour les préférences IA telles que la langue, les collections d'images, etc. |
| `-SkipSession` | SwitchParameter | — | — | Named | — | Stockez les paramètres uniquement dans les préférences persistantes sans affecter la session pour les préférences d'IA comme la langue, les collections d'images, etc. |
...
Ouvre les informations Whois pour plusieurs domaines sur le moniteur par défaut.
...
Ouvre les informations Whois pour les domaines du pipeline en mode privé Chrome.
...
> Utilisez les paramètres alternatifs stockés dans la session pour les préférences IA comme la langue, les collections d'images, etc.
...
> Effacer les paramètres alternatifs stockés dans la session pour les préférences IA telles que la langue, les collections d'images, etc.
...
> Stockez les paramètres uniquement dans les préférences persistantes sans affecter la session pour les préférences d'IA comme la langue, les collections d'images, etc.
