...
Ouvre une requête 'Wikipédia - Les Pays-Bas' dans un navigateur web, avec des options d'affichage configurables. Prend en charge la recherche de plusieurs termes et la spécification du moniteur sur lequel afficher les résultats.
...
| `-SideBySide` | SwitchParameter | — | — | Named | — | Ouvre deux fenêtres de navigateur côte à côte |
| `-SessionOnly` | SwitchParameter | — | — | Named | — | Utiliser uniquement des cookies de session (pas de cookies persistants) |
| `-ClearSession` | SwitchParameter | — | — | Named | — | Effacer les données de session du navigateur avant l'ouverture |
...
> Utiliser uniquement des cookies de session (pas de cookies persistants)
...
> Effacer les données de session du navigateur avant l'ouverture
