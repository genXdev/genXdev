...
> Ouvre une requête Wikipedia dans un navigateur web.

## Description

Ouvre une ou plusieurs requêtes de recherche Wikipedia dans un navigateur Web avec des options de configuration étendues. Prend en charge le comportement configurable du navigateur, la sélection du moniteur et le positionnement des fenêtres. Les requêtes sont encodées en URL et ouvertes en utilisant le domaine Wikipedia de la langue spécifiée avec un support complet de localisation.

La fonction offre un contrôle complet du navigateur incluant les modes de navigation privée, le positionnement des fenêtres, l'automatisation du clavier et le support multi-moniteur. Elle gère automatiquement l'encodage des URL et le mappage des codes de langue pour les domaines Wikipedia internationaux.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Queries` | String[] | ✅ | ✅ (ByValue, ByPropertyName) | 0 | — | La requête de recherche Wikipédia à exécuter |
| `-Language` | String | — | — | 1 | — | La langue des résultats de recherche Wikipédia |
...
| `-PassThru` | SwitchParameter | — | — | Named | — | Retourne un objet processus PowerShell représentant le processus du navigateur |
...
Ouvre une recherche Wikipedia pour "PowerShell" en anglais sur le moniteur par défaut.
...
Ouvre une recherche Wikipedia en utilisant l'alias avec des paramètres positionnels.
...
Recherche plusieurs termes dans Wikipédia allemand en utilisant le mode de navigation privée.

## Parameter Details

### `-Queries <String[]>`

> La requête de recherche Wikipédia à exécuter
...
> La langue des résultats de recherche Wikipédia
...
> Retourne un objet processus PowerShell représentant le processus du navigateur
