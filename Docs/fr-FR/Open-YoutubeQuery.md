...
Ouvert une recherche YouTube pour "PowerShell tutorial" sur le moniteur par défaut.
...
Ouvre une recherche YouTube pour "how to code" sur le moniteur secondaire configuré en utilisant l'alias de la fonction.
