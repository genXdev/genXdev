...
> Extrait de la pile le dernier assistant de fenêtre actif, avec des modifications optionnelles.

## Description

Extrait une fenêtre assistante de la pile et applique éventuellement des transformations de fenêtre.
Si la pile est vide ou contient des fenêtres invalides, renvoie la fenêtre actuellement
focalisée. Cette fonction vous permet de manipuler des fenêtres précédemment sauvegardées
avec Push-Window, en appliquant divers effets de positionnement, de dimensionnement et visuels.
