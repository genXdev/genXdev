...
> Convertit l'entrée audio en temps réel en texte à l'aide du modèle Whisper AI.

## Description

Cette cmdlet capture l'audio à partir du microphone ou du bureau et le transcrit en texte en temps réel à l'aide du modèle Whisper AI. Elle prend en charge diverses sources audio, la détection de silence et plusieurs options de configuration pour la reconnaissance vocale.
...
| `-UseDesktopAudioCapture` | SwitchParameter | — | — | Named | `False` | Utiliser la capture audio du bureau au lieu du microphone |
| `-UseDesktopAndRecordingDevice` | SwitchParameter | — | — | Named | `False` | S'il faut utiliser à la fois la capture audio du bureau et le périphérique d'enregistrement simultanément |
| `-AudioDevice` | String | — | — | Named | — | Utilisez à la fois le bureau et le périphérique d'enregistrement |
...
| `-IgnoreSilence` | SwitchParameter | — | — | Named | `False` | Ignorer ou non le silence (cela perturbera les horodatages) |
...
| `-SilenceThreshold` | Nullable`1[[System.Int32, System.Private.CoreLib, Version=10.0.0.0, Culture=neutral, PublicKeyToken=7cec85d7bea7798e]] | — | — | Named | — | Seuil de détection du silence (0..32767, valeur par défaut : 30) |
...
Utilisation de base avec microphone.
...
Utilisation de la capture audio du bureau.
...
Utilisation d'un périphérique audio spécifique.
...
> Utiliser la capture audio du bureau au lieu du microphone
...
> S'il faut utiliser à la fois la capture audio du bureau et le périphérique d'enregistrement simultanément
...
> Ignorer ou non le silence (cela perturbera les horodatages)
...
> Durée maximale de silence avant l'arrêt automatique de l'enregistrement
...
> Type de modèle Whisper à utiliser, par défaut Small
