...
Cette fonction enregistre une image de visage avec l'API de reconnaissance faciale DeepStack en téléchargeant l'image vers le point de terminaison de l'API locale. Elle s'assure que le service DeepStack est en cours d'exécution et valide le fichier image avant le téléchargement. La fonction inclut une logique de réessai, une gestion des erreurs et un nettoyage en cas d'échec.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Identifier` | String | ✅ | — | 0 | — | L'identifiant unique du visage (par exemple, le nom de la personne) |
...
> L'identifiant unique du visage (par exemple, le nom de la personne)
...
> Tableau de chemins locaux vers des fichiers image (png, jpg, jpeg ou gif)
