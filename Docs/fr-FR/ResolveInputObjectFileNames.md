...
Cette fonction traite les objets d'entrée (fichiers, répertoires ou collections) et les développe en noms de fichiers et répertoires. Elle prend en charge le filtrage, la correspondance de modèles, et peut renvoyer les résultats sous forme d'objets. La fonction est conçue pour fonctionner avec l'entrée de pipeline et offre des options pour la récursivité, les flux de données alternatifs, et plus encore.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-InputObject` | Object | — | ✅ (ByValue, ByPropertyName) | 0 | — | Objet d'entrée contenant les noms de fichiers ou répertoires |
| `-File` | SwitchParameter | — | — | Named | — | Retourner uniquement les fichiers |
...
> Objet d'entrée contenant les noms de fichiers ou répertoires
...
> Retourner uniquement les fichiers
