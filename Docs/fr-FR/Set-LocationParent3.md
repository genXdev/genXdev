...
> Remonte de trois niveaux de répertoire dans la hiérarchie du système de fichiers.

## Description

* Modifie le répertoire de travail actuel en remontant de trois niveaux dans la hiérarchie du système de fichiers.
* Affiche le contenu du répertoire résultant.
...
Navigue vers le haut de trois niveaux de répertoire à partir de l'emplacement actuel.
...
Utilise l'alias pour remonter de trois niveaux de répertoires.
