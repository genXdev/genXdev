...
Définit l'emplacement (URL) de l'onglet actuellement sélectionné du navigateur Web. Prend en charge les navigateurs Edge et Chrome via des commutateurs optionnels. La navigation comprend la validation de l'URL et garantit le chargement correct de la page via des opérations asynchrones.
...
| `-Edge` | SwitchParameter | — | — | Named | — | Naviguer à l'aide du navigateur Microsoft Edge *(Parameter set: )* |
| `-Chrome` | SwitchParameter | — | — | Named | — | Naviguer avec le navigateur Google Chrome *(Parameter set: )* |
| `-Chromium` | SwitchParameter | — | — | Named | — | Naviguez en utilisant Microsoft Edge ou Google Chrome, selon le navigateur par défaut. |
...
> Naviguer à l'aide du navigateur Microsoft Edge
...
> Naviguer avec le navigateur Google Chrome
...
> Naviguez en utilisant Microsoft Edge ou Google Chrome, selon le navigateur par défaut.
...
> Naviguer en utilisant le navigateur Firefox
...
> Naviguer à l'aide du navigateur WebKit géré par Playwright
