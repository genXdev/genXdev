...
| `-Monitor` | Int32 | — | — | Named | `-2` | Le moniteur à utiliser, 0=par défaut, -1=ignorer, -2=configuré |
...
| `-FocusWindow` | SwitchParameter | — | — | Named | — | Mettre la fenêtre au premier plan après le positionnement |
| `-SetForeground` | SwitchParameter | — | — | Named | — | Définir la fenêtre au premier plan après le positionnement |
...
| `-PassThru` | SwitchParameter | — | — | Named | — | Retourne l'objet processus après positionnement |
| `-SideBySide` | SwitchParameter | — | — | Named | — | Placer la fenêtre côte à côte avec PowerShell sur le même écran |
...
> Le moniteur à utiliser, 0=par défaut, -1=ignorer, -2=configuré
...
> Mettre la fenêtre au premier plan après le positionnement
...
> Définir la fenêtre au premier plan après le positionnement
...
> Frappes à envoyer à la fenêtre après le positionnement
...
> Retourne l'objet processus après positionnement
...
> Placer la fenêtre côte à côte avec PowerShell sur le même écran
