...
Affiche les verbes approuvés de PowerShell dans une liste séparée par des virgules. Si des verbes spécifiques sont fournis en entrée, seuls les verbes correspondants seront affichés. Prend en charge les caractères génériques.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Verb` | String[] | — | ✅ (ByValue, ByPropertyName) | 0 | `@()` | Un ou plusieurs modèles de verbe à filtrer (prend en charge les caractères génériques) 🌐 *Supports wildcards* |
...
> Un ou plusieurs modèles de verbe à filtrer (prend en charge les caractères génériques)
