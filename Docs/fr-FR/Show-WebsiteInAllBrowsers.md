...
Cette fonction crée une disposition en mosaïque de fenêtres de navigateur en ouvrant l'URL spécifiée dans Chrome, Edge, Firefox et une fenêtre de navigation privée. Les navigateurs sont disposés selon une grille 2x2 :
...
Tous les paramètres d'Open-Webbrowser sont pris en charge et transmis pour contrôler le positionnement, le comportement et l'apparence des navigateurs. La fonction agit comme un wrapper qui applique un positionnement cohérent en quadrants tout en permettant une personnalisation complète des paramètres de lancement des navigateurs.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Url` | String | ✅ | ✅ (ByValue, ByPropertyName) | 0 | — | Les URL à ouvrir dans tous les navigateurs simultanément |
...
> Les URL à ouvrir dans tous les navigateurs simultanément
