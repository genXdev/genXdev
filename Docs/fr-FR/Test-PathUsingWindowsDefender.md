...
> Analyse les fichiers ou répertoires à la recherche de logiciels malveillants à l'aide de Windows Defender.

## Description

* Effectue une analyse ciblée de fichiers ou de répertoires spécifiés à l'aide de l'interface en ligne de commande de Windows Defender (MpCmdRun.exe).
* Peut effectuer une analyse en mode détection uniquement ou avec correction automatique des menaces activée.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-FilePath` | String | ✅ | ✅ (ByValue, ByPropertyName) | 0 | — | Le chemin du fichier ou du répertoire à analyser |
| `-EnableRemediation` | SwitchParameter | — | — | Named | `False` | Demande à Windows Defender d'agir sur les menaces |
...
Analyse le fichier à l'aide de l'alias et active la correction.
...
Dirige le chemin du fichier vers l'applet de commande à l'aide d'un alias.

## Parameter Details

### `-FilePath <String>`

> Le chemin du fichier ou du répertoire à analyser
...
> Demande à Windows Defender d'agir sur les menaces
