...
Fournit une gestion complète des ensembles de refactorisation en :
...
- Prenant en charge la sélection et le traitement de fichiers basés sur LLM
- Supportant la gestion automatique et manuelle des fichiers
- Tenant des journaux détaillés de toutes les opérations
- Gérant gracieusement les fichiers supprimés (ignorés sauf si CleanUpDeletedFiles est utilisé)
...
| `-Refactor` | GenXdev.Helpers.RefactorDefinition[] | — | — | 1 | — | L'ensemble de refactorisation à mettre à jour *(Parameter set: )* |
| `-FilesToAdd` | IO.FileInfo[] | — | — | 2 | `@()` | Noms de fichiers à ajouter |
| `-FilesToRemove` | IO.FileInfo[] | — | — | 3 | `@()` | Noms de fichiers à supprimer |
| `-SelectByModifiedDateFrom` | DateTime | — | — | Named | — | Sélectionner les fichiers par date de modification à partir de |
| `-SelectByModifiedDateTo` | DateTime | — | — | Named | — | Sélectionner les fichiers par date de modification pour |
| `-SelectByCreationDateFrom` | DateTime | — | — | Named | — | Sélectionnez les fichiers par date de création à partir de |
| `-SelectByCreationDateTo` | DateTime | — | — | Named | — | Sélectionner les fichiers par date de création pour |
...
| `-SelectionScript` | String | — | — | Named | — | Script PowerShell pour sélectionner des éléments à refactoriser |
| `-SelectionPrompt` | String | — | — | Named | — | S'il est fourni, invoquera le LLM pour effectuer la sélection en fonction du contenu du script |
...
| `-Priority` | Int32 | — | — | Named | — | Priorité pour cette refactorisation de l'ensemble |
| `-ExposedCmdLets` | GenXdev.Helpers.ExposedCmdletDefinition[] | — | — | Named | `@()` | Tableau de définitions de commandes PowerShell à utiliser comme outils lors de la sélection du LLM |
| `-KeysToSend` | String[] | — | — | Named | `@()` | Les touches à solliciter en tant que frappes de touches après l'ouverture du fichier |
...
| `-AskBeforeLLMSelection` | SwitchParameter | — | — | Named | — | Bascule pour supprimer l'interaction utilisateur |
| `-PerformAutoSelections` | SwitchParameter | — | — | Named | — | Activer le traitement de sélection de fichiers basé sur LLM |
| `-PerformAISelections` | SwitchParameter | — | — | Named | — | Passer à la gestion de tous les fichiers dans l'ensemble de refactorisation |
| `-RetryFailedLLMSelections` | SwitchParameter | — | — | Named | — | Passer en mode reprise des sélections LLM ayant échoué |
| `-Clear` | SwitchParameter | — | — | Named | — | Effacer tous les fichiers de l'ensemble de refactorisation |
| `-ClearLog` | SwitchParameter | — | — | Named | — | Effacez le journal de l'ensemble de refactorisation |
...
| `-ReprocessModifiedFiles` | SwitchParameter | — | — | Named | — | Reprocesse automatiquement les fichiers modifiés depuis la dernière mise à jour |
...
> L'ensemble de refactorisation à mettre à jour
...
> Sélectionner les fichiers par date de modification à partir de
...
> Sélectionner les fichiers par date de modification pour
...
> Sélectionnez les fichiers par date de création à partir de
...
> Sélectionner les fichiers par date de création pour
...
> Script PowerShell pour sélectionner des éléments à refactoriser
...
> S'il est fourni, invoquera le LLM pour effectuer la sélection en fonction du contenu du script
...
> Tableau de définitions de commandes PowerShell à utiliser comme outils lors de la sélection du LLM
...
> Les touches à solliciter en tant que frappes de touches après l'ouverture du fichier
...
> Bascule pour supprimer l'interaction utilisateur
...
> Activer le traitement de sélection de fichiers basé sur LLM
...
> Passer à la gestion de tous les fichiers dans l'ensemble de refactorisation
...
> Passer en mode reprise des sélections LLM ayant échoué
...
> Effacer tous les fichiers de l'ensemble de refactorisation
...
> Effacez le journal de l'ensemble de refactorisation
...
> Reprocesse automatiquement les fichiers modifiés depuis la dernière mise à jour
