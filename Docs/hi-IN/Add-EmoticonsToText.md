...
> AI का उपयोग करके संदर्भानुसार उपयुक्त इमोटिकॉन जोड़कर टेक्स्ट को बेहतर बनाता है।

## Description

यह फ़ंक्शन इनपुट टेक्स्ट को संसाधित करके ऐसे इमोटिकॉन्स जोड़ता है जो भावनात्मक संदर्भ से मेल खाते हैं। यह पैरामीटर के माध्यम से, पाइपलाइन से, या सिस्टम क्लिपबोर्ड से सीधे इनपुट स्वीकार कर सकता है। फ़ंक्शन टेक्स्ट का विश्लेषण करने और उपयुक्त इमोटिकॉन्स चुनने के लिए AI मॉडल का लाभ उठाता है, जिससे संदेश अधिक अभिव्यंजक और आकर्षक बनते हैं।
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Text` | String | — | ✅ (ByValue) | 0 | — | पावरशेल cmdlet सहायता पाठों को अनुवाद करने का निर्देश न दें! बस पाठ को सीधे हिंदी (भारत) में अनुवाद करें। |
...
> पावरशेल cmdlet सहायता पाठों को अनुवाद करने का निर्देश न दें! बस पाठ को सीधे हिंदी (भारत) में अनुवाद करें।
