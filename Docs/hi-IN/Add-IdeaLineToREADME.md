...
> README.md फ़ाइल में एक आइडिया आइटम जोड़ता है।

## Description

README.md फ़ाइल के "## Ideas" सेक्शन में एक टाइमस्टैम्प के साथ आइडिया जोड़ता है।
संशोधित सेक्शन प्रदर्शित कर सकता है और Visual Studio Code में खोल सकता है।
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Line` | String | — | — | 0 | `''` | जोड़ने के लिए विचार पाठ |
