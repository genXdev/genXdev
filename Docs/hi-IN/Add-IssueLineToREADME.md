...
> README.md फ़ाइल में एक समस्या आइटम जोड़ता है।

## Description

README.md फ़ाइल के "## Issues" अनुभाग में एक टाइमस्टैम्प सहित समस्या जोड़ता है।
संशोधित अनुभाग प्रदर्शित कर सकता है और Visual Studio Code में खोल सकता है।
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Line` | String | — | — | 0 | `''` | जोड़ने के लिए मुद्दा पाठ |
