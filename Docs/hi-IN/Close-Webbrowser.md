...
> एक या अधिक वेबब्राउज़र इंस्टेंस को चुनिंदा रूप से बंद करता है।

## Description

वेब ब्राउज़र इंस्टेंस बंद करने पर ग्रैन्युलर नियंत्रण प्रदान करता है। विशिष्ट ब्राउज़र (एज, क्रोम, फ़ायरफ़ॉक्स) को लक्षित कर सकता है या सभी ब्राउज़र बंद कर सकता है। मुख्य विंडो और पृष्ठभूमि प्रक्रियाओं दोनों को बंद करने का समर्थन करता है।
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Edge` | SwitchParameter | — | — | Named | — | माइक्रोसॉफ्ट एज ब्राउज़र इंस्टेंस बंद करता है *(Parameter set: )* |
| `-Chrome` | SwitchParameter | — | — | Named | — | Google Chrome ब्राउज़र इंस्टेंस बंद करता है *(Parameter set: )* |
| `-Chromium` | SwitchParameter | — | — | Named | — | डिफ़ॉल्ट क्रोमियम-आधारित ब्राउज़र बंद करता है *(Parameter set: )* |
| `-Firefox` | SwitchParameter | — | — | Named | — | फ़ायरफ़ॉक्स ब्राउज़र इंस्टेंस बंद करता है *(Parameter set: )* |
...
| `-IncludeBackgroundProcesses` | SwitchParameter | — | — | Named | — | पृष्ठभूमि कार्यों सहित सभी इंस्टेंस को बंद करता है |
...
> माइक्रोसॉफ्ट एज ब्राउज़र इंस्टेंस बंद करता है
...
> Google Chrome ब्राउज़र इंस्टेंस बंद करता है
...
> डिफ़ॉल्ट क्रोमियम-आधारित ब्राउज़र बंद करता है
...
> फ़ायरफ़ॉक्स ब्राउज़र इंस्टेंस बंद करता है
...
> पृष्ठभूमि कार्यों सहित सभी इंस्टेंस को बंद करता है
