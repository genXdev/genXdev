...
> AI का उपयोग करके सीधे या कठोर पाठ को विनम्र, पेशेवर कॉर्पोरेट भाषा में परिवर्तित करता है।

## Description

यह फ़ंक्शन इनपुट टेक्स्ट को प्रोसेस करता है ताकि सीधी या संभावित रूप से कठोर भाषा को कूटनीतिक, पेशेवर कॉर्पोरेट संचार में बदल सके। यह पैरामीटर के माध्यम से, पाइपलाइन से, या सिस्टम क्लिपबोर्ड से सीधे इनपुट स्वीकार कर सकता है। यह फ़ंक्शन मूल आशय को संरक्षित करते हुए टेक्स्ट का विश्लेषण और पुनर्लेखन करने के लिए AI मॉडल का उपयोग करता है।
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Text` | String | — | ✅ (ByValue) | 0 | — | कॉर्पोरेट भाषा में परिवर्तित करने हेतु पाठ |
...
> कॉर्पोरेट भाषा में परिवर्तित करने हेतु पाठ
