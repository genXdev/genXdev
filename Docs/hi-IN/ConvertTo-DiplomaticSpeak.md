...
> सीधे या कठोर पाठ को विनम्र, कूटनीतिक भाषा में परिवर्तित करता है।

## Description

यह फ़ंक्शन उपयोगकर्ता इनपुट को सीधे या कठोर वाक्यांशों से उच्च स्तरीय चर्चाओं, वार्ताओं या औपचारिक संचार के लिए उपयुक्त कूटनीतिक, चतुर भाषा में रूपांतरित करता है। यह फ़ंक्शन मूल आशय को बनाए रखते हुए स्वर को नरम करने और संदेश को अधिक कूटनीतिक और पेशेवर बनाने के लिए AI भाषा मॉडल का उपयोग करता है।
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Text` | String | — | ✅ (ByValue) | 0 | — | कृपया निम्नलिखित पाठ को कूटनीतिक भाषा में परिवर्तित करें। |
...
> कृपया निम्नलिखित पाठ को कूटनीतिक भाषा में परिवर्तित करें।
