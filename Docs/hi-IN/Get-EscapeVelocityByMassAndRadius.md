...
> पलायन वेग की गणना करता है।

## Description

v = sqrt(2 G M / r) का उपयोग करता है।
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-MassInKilograms` | Double | ✅ | — | 0 | `0` | शरीर का द्रव्यमान किग्रा में |
| `-RadiusInMeters` | Double | ✅ | — | 1 | `0` | मीटर में त्रिज्या |
| `-As` | String | — | — | 2 | — | वेग के लिए आउटपुट इकाई |
...
पृथ्वी के द्रव्यमान और त्रिज्या वाले पिंड के लिए पलायन वेग की गणना करता है।
...
डिफ़ॉल्ट मीटर/सेकंड इकाइयों का उपयोग करके एस्केप वेलोसिटी की गणना करता है।

## Parameter Details

### `-MassInKilograms <Double>`

> शरीर का द्रव्यमान किग्रा में
