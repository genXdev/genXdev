...
> README.md फ़ाइल से समस्याएँ प्रदर्शित करता है।

## Description

README.md फ़ाइल के "## Issues" अनुभाग से सभी मुद्दों को दिखाता है। वर्तमान स्थान, PowerShell प्रोफ़ाइल निर्देशिका या OneDrive निर्देशिका में README का उपयोग कर सकते हैं।
