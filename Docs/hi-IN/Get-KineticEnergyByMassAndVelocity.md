...
> गतिज ऊर्जा की गणना करता है।

## Description

KE = 1/2 m v² का उपयोग करता है।
...
| `-VelocityInMetersPerSecond` | Double | ✅ | — | 1 | `0` | वेग m/s में |
| `-As` | String | — | — | 2 | — | ऊर्जा के लिए आउटपुट इकाई |
...
10kg द्रव्यमान 5 m/s की गति से गतिमान की गतिज ऊर्जा की गणना करता है और कैलोरी में आउटपुट देता है।
...
स्थितीय पैरामीटर का उपयोग करके 5 किग्रा द्रव्यमान को 10 मी/से की गति से चलाने पर गतिज ऊर्जा की गणना करता है।
