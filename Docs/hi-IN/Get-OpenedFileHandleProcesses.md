...
> निर्दिष्ट फ़ाइलों के लिए खुले फ़ाइल हैंडल वाली प्रक्रियाओं को पुनर्प्राप्त करता है।

## Description

* किन प्रक्रियाओं में एक या अधिक निर्दिष्ट फ़ाइलों के लिए वर्तमान में खुले हैंडल हैं, इसकी पहचान करने के लिए Sysinternals handle.exe टूल का उपयोग करता है।
* यह निर्धारित करने में उपयोगी है कि कौन सी प्रक्रियाएँ फ़ाइल संचालन जैसे विलोपन या संशोधन को रोक रही हैं।
* आवश्यकता है कि Sysinternals सूट से handle.exe स्थापित हो और सिस्टम पथ में उपलब्ध हो।
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-FilePath` | String[] | ✅ | ✅ (ByValue, ByPropertyName) | 0 | — | खुले हैंडल की जाँच करने के लिए फ़ाइल(फ़ाइलों) का पथ |
...
निर्दिष्ट फ़ाइल के लिए खुले हैंडल वाली सभी प्रक्रियाओं को पहचानता है।
...
पाइपलाइन इनपुट के माध्यम से एकाधिक फ़ाइलों की जाँच करता है कि क्या उन पर हैंडल खुले हैं।

## Parameter Details

### `-FilePath <String[]>`

> खुले हैंडल की जाँच करने के लिए फ़ाइल(फ़ाइलों) का पथ
