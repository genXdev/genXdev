...
> SQLite डेटाबेस से तालिका नामों की सूची प्राप्त करता है।

## Description

SQLite डेटाबेस से सभी उपयोगकर्ता-परिभाषित तालिका नामों को पुनः प्राप्त करने के लिए sqlite_master सिस्टम तालिका पर क्वेरी करता है। या तो सीधे कनेक्शन स्ट्रिंग या डेटाबेस फ़ाइल पथ के माध्यम से कनेक्ट करने का समर्थन करता है। तालिका नामों को स्ट्रिंग्स के संग्रह के रूप में लौटाता है।
