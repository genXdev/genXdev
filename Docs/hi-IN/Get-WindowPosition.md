...
> विंडोज़ की स्थिति और स्थिति की जानकारी प्राप्त करता है।

## Description

निर्दिष्ट प्रक्रियाओं या विंडो हैंडल के लिए विंडो स्थिति, आकार, मॉनिटर प्लेसमेंट, डॉकिंग स्थिति और फोकस स्थिति के बारे में विस्तृत जानकारी प्राप्त करता है।
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-ProcessName` | String | — | ✅ (ByValue, ByPropertyName) | 0 | — | स्थिति प्राप्त करने के लिए विंडो की प्रक्रिया का नाम *(Parameter set: )* 🌐 *Supports wildcards* |
| `-Process` | Diagnostics.Process | — | ✅ (ByValue, ByPropertyName) | Named | — | पोजीशन प्राप्त करने के लिए विंडो की प्रक्रिया *(Parameter set: )* |
...
> स्थिति प्राप्त करने के लिए विंडो की प्रक्रिया का नाम
...
> पोजीशन प्राप्त करने के लिए विंडो की प्रक्रिया
