...
> सत्यापन और पैरामीटर फ़िल्टरिंग के साथ एक उपकरण कॉल फ़ंक्शन निष्पादित करता है।

## Description

यह फ़ंक्शन तर्कों को मान्य करके, पैरामीटर फ़िल्टर करके, और उचित पुष्टिकरण हैंडलिंग के साथ कॉलबैक निष्पादित करके टूल कॉल को प्रोसेस करता है। यह स्क्रिप्ट ब्लॉक और कमांड जानकारी दोनों कॉलबैक का समर्थन करता है।
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-ToolCall` | Collections.Hashtable | ✅ | — | 0 | — | यह एक उपकरण कॉल ऑब्जेक्ट है जिसमें फ़ंक्शन विवरण और तर्क शामिल हैं |
...
| `-ForceAsText` | SwitchParameter | — | — | Named | — | बलपूर्वक आउटपुट को टेक्स्ट के रूप में |
...
> यह एक उपकरण कॉल ऑब्जेक्ट है जिसमें फ़ंक्शन विवरण और तर्क शामिल हैं
...
> बलपूर्वक आउटपुट को टेक्स्ट के रूप में
