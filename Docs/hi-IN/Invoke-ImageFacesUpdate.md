...
> निर्दिष्ट निर्देशिका में छवि फ़ाइलों के लिए चेहरा पहचान मेटाडेटा अपडेट करता है।

## Description

यह फ़ंक्शन निर्दिष्ट निर्देशिका में छवियों को संसाधित करता है ताकि AI पहचान तकनीक का उपयोग करके चेहरों की पहचान और विश्लेषण किया जा सके। यह प्रत्येक छवि के लिए चेहरे की जानकारी वाली मेटाडेटा फ़ाइलें बनाता या अपडेट करता है। मेटाडेटा एक अलग फ़ाइल में संग्रहीत किया जाता है जिसमें
