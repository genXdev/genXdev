...
> किसी निर्देशिका में छवियों के लिए EXIF मेटाडेटा अपडेट करता है।

## Description

यह फ़ंक्शन निर्दिष्ट निर्देशिकाओं में छवियों के लिए EXIF मेटाडेटा निकालता और अद्यतन करता है।
यह प्रत्येक छवि को संसाधित करके कैमरा विवरण,
GPS निर्देशांक, एक्सपोज़र सेटिंग्स और अन्य तकनीकी जानकारी सहित विस्तृत EXIF मेटाडेटा निकालता है।
मेटाडेटा को बाद में इंडेक्सिंग और खोज फ़ंक्शनों द्वारा उपयोग के लिए
वैकल्पिक NTFS स्ट्रीम में :EXIF.json के रूप में संग्रहीत किया जाता है।
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-ImageDirectories` | String[] | — | — | 0 | `@('.\')` | छवि मेटाडेटा अपडेट के लिए प्रक्रिया करने हेतु निर्देशिका पथों की सरणी |
| `-RetryFailed` | SwitchParameter | — | — | Named | — | पहले विफल रही छवि मेटाडेटा अपडेट को पुनः प्रयास करेगा |
| `-OnlyNew` | SwitchParameter | — | — | Named | — | केवल उन छवियों को संसाधित करें जिनमें पहले से मेटाडेटा फ़ाइलें नहीं हैं |
| `-Recurse` | SwitchParameter | — | — | Named | — | यदि निर्दिष्ट किया गया है, तो उपनिर्देशिकाओं में रिकर्सिव रूप से छवियों को संसाधित करता है |
| `-Force` | SwitchParameter | — | — | Named | — | मौजूद होने पर भी मेटाडेटा को पुनर्निर्माण करने के लिए बाध्य करें |
| `-PassThru` | SwitchParameter | — | — | Named | — | कंसोल पर आउटपुट करने के बजाय संरचित ऑब्जेक्ट लौटाएं |
...
> छवि मेटाडेटा अपडेट के लिए प्रक्रिया करने हेतु निर्देशिका पथों की सरणी
...
> पहले विफल रही छवि मेटाडेटा अपडेट को पुनः प्रयास करेगा
...
> केवल उन छवियों को संसाधित करें जिनमें पहले से मेटाडेटा फ़ाइलें नहीं हैं
...
> यदि निर्दिष्ट किया गया है, तो उपनिर्देशिकाओं में रिकर्सिव रूप से छवियों को संसाधित करता है
...
> मौजूद होने पर भी मेटाडेटा को पुनर्निर्माण करने के लिए बाध्य करें
...
> कंसोल पर आउटपुट करने के बजाय संरचित ऑब्जेक्ट लौटाएं
