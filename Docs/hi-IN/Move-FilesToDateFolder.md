...
> खोज मानदंडों से मेल खाने वाली फ़ाइलों को दिनांक-आधारित उपफ़ोल्डरों में ले जाता है।

## Description

`Find-Item` के समान पैरामीटर सेट का उपयोग करके फ़ाइलों की खोज करता है और प्रत्येक मिलान की गई फ़ाइल को उसकी निर्माण या मीडिया तिथि के आधार पर `TargetFolder` के एक उपफ़ोल्डर में ले जाता है। cmdlet सामग्री मिलान, ड्राइव-वाइड खोज और कई फ़िल्टर का समर्थन करता है। यह स्थानांतरण के बाद वैकल्पिक रूप से खाली स्रोत फ़ोल्डरों को हटा सकता है।

निर्दिष्ट फ़ाइल के लिए एक सटीक निर्माण या कैप्चर तिथि निर्धारित करने के लिए कई रणनीतियों का प्रयास करता है। रणनीतियों में छवि EXIF मेटाडेटा पढ़ना, फ़ाइल नामों से दिनांक/समय जानकारी पार्स करना, और जब कोई अन्य विश्वसनीय जानकारी उपलब्ध नहीं होती है तो फ़ाइल के अंतिम-लेखन समय पर वापस जाना शामिल है।
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-TargetFolder` | String | ✅ | — | 0 | — | लक्ष्य रूट फ़ोल्डर जहाँ मिलान की गई फ़ाइलें तिथि-आधारित उपफ़ोल्डरों में ले जाया जाएँगा |
...
| `-DeleteEmptyDirs` | SwitchParameter | — | — | Named | — | फ़ाइलें स्थानांतरित करने के बाद खाली स्रोत निर्देशिकाओं को हटाएं |
| `-TargetFolderNameDateSyntax` | String | — | — | Named | `'Year + Month'` | लक्ष्य फ़ोल्डर नाम दिनांक सिंटैक्स |
...
> लक्ष्य रूट फ़ोल्डर जहाँ मिलान की गई फ़ाइलें तिथि-आधारित उपफ़ोल्डरों में ले जाया जाएँगा
...
> फ़ाइलें स्थानांतरित करने के बाद खाली स्रोत निर्देशिकाओं को हटाएं
...
> लक्ष्य फ़ोल्डर नाम दिनांक सिंटैक्स
