...
> दिए गए खोज शब्दों या URL के लिए सभी संभावित क्वेरी प्रकार खोलता है।

## Description

सभी cmdlets को निष्पादित करता है जो वेब पेज क्वेरी को संभालते हैं, URL और खोज शब्दों दोनों को प्रोसेस करता है। URL के लिए, यह साइट-विशिष्ट क्वेरी करता है, और खोज शब्दों के लिए सामान्य वेब क्वेरी निष्पादित करता है। यह फ़ंक्शन GenXdev.Queries मॉड्यूल परिवार से सभी उपलब्ध क्वेरी cmdlets को गतिशील रूप से खोजता और निष्पादित करता है।
...
| `-SessionOnly` | SwitchParameter | — | — | Named | — | ब्राउज़र प्रोफ़ाइल के लिए केवल-सत्र मोड का उपयोग करें। |
| `-ClearSession` | SwitchParameter | — | — | Named | — | ब्राउज़र सत्र खोलने से पहले साफ़ करें। |
| `-SkipSession` | SwitchParameter | — | — | Named | — | ब्राउज़र सत्र पुनर्स्थापना छोड़ें। |
...
डिफ़ॉल्ट मॉनिटर पर "पावरशेल स्क्रिप्टिंग" के लिए सभी संभावित क्वेरी प्रकार खोलता है।
...
GitHub URL के लिए उपनाम और छोटे पैरामीटर का उपयोग करके सभी संभावित क्वेरी प्रकार खोलता है।
...
> ब्राउज़र प्रोफ़ाइल के लिए केवल-सत्र मोड का उपयोग करें।
...
> ब्राउज़र सत्र खोलने से पहले साफ़ करें।
...
> ब्राउज़र सत्र पुनर्स्थापना छोड़ें।
...
- [ConvertTo-Uris](https://github.com/genXdev/genXdev/blob/main/Docs/hi-IN/ConvertTo-Uris.md)
