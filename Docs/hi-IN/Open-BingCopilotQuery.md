...
> एक वेब ब्राउज़र में Bing CoPilot क्वेरी खोलता है

## Description

वेब ब्राउज़र में Bing CoPilot क्वेरी खोलता है। यह फ़ंक्शन अंतर्निहित Open-WebsiteAndPerformQuery फ़ंक्शन का उपयोग करके स्वचालित रूप से क्वेरी टाइप करता है और सबमिट करता है। यह PowerShell से Microsoft Copilot के साथ इंटरैक्ट करने का एक सुविधाजनक तरीका प्रदान करता है।
...
| `-ClearSession` | SwitchParameter | — | — | Named | — | ब्राउज़र सत्र/प्रोफ़ाइल खोलने से पहले साफ़ करें। |
| `-SkipSession` | SwitchParameter | — | — | Named | — | ब्राउज़र सत्र/प्रोफ़ाइल लोडिंग छोड़ें। |
...
> ब्राउज़र सत्र/प्रोफ़ाइल खोलने से पहले साफ़ करें।
...
> ब्राउज़र सत्र/प्रोफ़ाइल लोडिंग छोड़ें।
...
- [Open-CloudLLMChat](https://github.com/genXdev/genXdev/blob/main/Docs/hi-IN/Open-CloudLLMChat.md)
