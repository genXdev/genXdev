...
> वेब ब्राउज़र में ChatGPT क्वेरी खोलता है।

## Description

वेब ब्राउज़र में ChatGPT खोलता है, स्वचालित रूप से निर्दिष्ट क्वेरी दर्ज करता है और सबमिट करता है। अंतर्निहित Open-WebsiteAndPerformQuery फ़ंक्शन का उपयोग करके निष्पादित की जाने वाली कई क्वेरी का समर्थन करता है। यह फ़ंक्शन PowerShell से OpenAI के ChatGPT के साथ इंटरैक्ट करने का एक सुविधाजनक तरीका प्रदान करता है, जिसमें व्यापक ब्राउज़र कॉन्फ़िगरेशन विकल्प शामिल हैं।
...
| `-ShowWindow` | SwitchParameter | — | — | Named | — | ब्राउज़र विंडो दिखाएं |
...
पूर्ण पैरामीटर नाम का उपयोग करके एकाधिक क्वेरी सबमिट करें।
...
उपनाम और पाइपलाइन का उपयोग करके एक क्वेरी सबमिट करें।
