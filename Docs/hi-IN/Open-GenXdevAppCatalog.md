...
> जेनएक्सडेव प्रगतिशील वेबऐप्स कैटलॉग को वेब ब्राउज़र में खोलता है।

## Description

प्रकाशित GenXdev प्रगतिशील वेब ऐप्स के साथ कैटलॉग को वेब ब्राउज़र में खोलता है।
डिफ़ॉल्ट रूप से पूर्ण स्क्रीन सक्षम के साथ एप्लिकेशन मोड में खुलता है ताकि
कैटलॉग के लिए एक इष्टतम देखने का अनुभव प्रदान किया जा सके। मॉनिटर प्लेसमेंट, विंडो साइज़िंग और भाषा
प्राथमिकताओं सहित सभी मानक वेब ब्राउज़र कॉन्फ़िगरेशन विकल्पों का समर्थन करता है।

यह फ़ंक्शन स्वचालित रूप से बेहतरीन कैटलॉग देखने के अनुभव के लिए ब्राउज़र को कॉन्फ़िगर करता है
और एक साथ कई ब्राउज़र इंस्टेंस खोल सकता है। यह व्यापक भाषा समर्थन प्रदान करता है और ब्राउज़र चयन
और स्थिति के लिए उपयोगकर्ता की प्राथमिकताओं का सम्मान करता है।
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Language` | String | — | — | 0 | — | वापस किए गए खोज परिणामों की भाषा |
...
मॉनिटर 1 पर GenXdev ऐप कैटलॉग को पूर्ण स्क्रीन के साथ एप्लिकेशन मोड में खोलता है।
...
एलियास कमांड का उपयोग करके मॉनिटर 1 पर GenXdev ऐप कैटलॉग खोलता है।
