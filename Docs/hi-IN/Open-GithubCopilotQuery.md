...
> एक वेब ब्राउज़र में Github CoPilot क्वेरी खोलता है

## Description

वेब ब्राउज़र में GitHub Copilot क्वेरी खोलता है और निर्दिष्ट क्वेरी को स्वचालित रूप से दर्ज करता है। फ़ंक्शन क्वेरी टाइप करने से पहले पेज के लोड होने की प्रतीक्षा करता है। यह फ़ंक्शन ब्राउज़र ऑटोमेशन को संभालने के लिए अंतर्निहित Open-WebsiteAndPerformQuery फ़ंक्शन का उपयोग करता है और व्यापक ब्राउज़र कॉन्फ़िगरेशन विकल्पों के साथ PowerShell से GitHub Copilot के साथ बातचीत करने का एक सुविधाजनक तरीका प्रदान करता है।
