...
> वेब ब्राउज़र में Google Gemini क्वेरी खोलता है

## Description

वेब ब्राउज़र में Google Gemini क्वेरी खोलता है, स्वचालित रूप से क्वेरी दर्ज करता है और इसे सबमिट करता है। यह Google के Gemini AI के साथ बातचीत करने का एक त्वरित तरीका प्रदान करता है। यह फ़ंक्शन मॉनिटर चयन, विंडो पोजिशनिंग और कीबोर्ड ऑटोमेशन सुविधाओं सहित व्यापक ब्राउज़र नियंत्रण का समर्थन करता है।
...
गूगल जेमिनी खोलता है और क्वेरी "PowerShell क्या है?" सबमिट करता है।
...
पाइपलाइन इनपुट के माध्यम से ऐरे के बारे में क्वेरी सबमिट करने के लिए उपनाम का उपयोग करता है।
