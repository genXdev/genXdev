...
> कॉन्फ़िगरेबल सेटिंग्स और व्यापक अनुकूलन विकल्पों के साथ वेब ब्राउज़र में Google क्वेरी खोलता है।
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Queries` | String[] | ✅ | ✅ (ByValue, ByPropertyName) | 0 | — | गूगल पर खोजने के लिए खोज शब्द |
| `-Language` | String | — | — | 1 | — | Google खोज परिणामों की भाषा |
...
| `-Monitor` | Int32 | — | — | Named | `-1` | उपयोग करने के लिए मॉनिटर, 0 = डिफ़ॉल्ट, -1 छोड़ दें, -2 = कॉन्फ़िगर किया गया द्वितीयक मॉनिटर, डिफ़ॉल्ट -1 है |
...
प्राथमिक मॉनिटर पर अंग्रेज़ी में "PowerShell scripting" के लिए Google खोज खोलता है।
...
उपनामों का उपयोग करके मॉनिटर 2 पर पूर्ण स्क्रीन मोड में 'मशीन लर्निंग एल्गोरिदम' के लिए Google खोज खोलता है
...
पाइपलाइन इनपुट के माध्यम से Chrome में अंग्रेजी में अनेक Google खोजें खोलता है।
...
एक नई विंडो में "कृत्रिम बुद्धिमत्ता" के लिए निजी ब्राउज़िंग खोज खोलता है।
...
एक खोज को एप्लिकेशन मोड में (कोई ब्राउज़र नियंत्रण नहीं) स्क्रीन पर केंद्रित करके खोलता है।

## Parameter Details

### `-Queries <String[]>`

> गूगल पर खोजने के लिए खोज शब्द
...
> उपयोग करने के लिए मॉनिटर, 0 = डिफ़ॉल्ट, -1 छोड़ दें, -2 = कॉन्फ़िगर किया गया द्वितीयक मॉनिटर, डिफ़ॉल्ट -1 है
