...
> वेब ब्राउज़र में Grokipedia क्वेरी खोलता है।

## Description

एक या अधिक ग्रॉकीपीडिया खोज क्वेरी को व्यापक कॉन्फ़िगरेशन विकल्पों के साथ वेब ब्राउज़र में खोलता है। कॉन्फ़िगरेबल ब्राउज़र व्यवहार, मॉनिटर चयन और विंडो पोजीशनिंग का समर्थन करता है। क्वेरी URL एन्कोडेड होती हैं और निर्दिष्ट भाषा के ग्रॉकीपीडिया डोमेन का उपयोग करके पूर्ण स्थानीयकरण समर्थन के साथ खोली जाती हैं।

यह फ़ंक्शन प्राइवेट ब्राउज़िंग मोड, विंडो पोजीशनिंग, कीबोर्ड ऑटोमेशन और मल्टी-मॉनिटर सपोर्ट सहित व्यापक ब्राउज़र नियंत्रण प्रदान करता है। यह अंतरराष्ट्रीय ग्रॉकीपीडिया डोमेन के लिए स्वचालित रूप से URL एन्कोडिंग और भाषा कोड मैपिंग को संभालता है।
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Queries` | String[] | ✅ | ✅ (ByValue, ByPropertyName) | 0 | — | ग्रॉकिपीडिया खोज क्वेरी को निष्पादित करने के लिए |
...
डिफ़ॉल्ट मॉनिटर पर "PowerShell" के लिए अंग्रेज़ी में ग्रॉकीपीडिया खोज खोलता है।
...
अलियास के साथ स्थितिगत पैरामीटर का उपयोग करके ग्रॉकीपीडिया खोज खोलता है।
...
निजी ब्राउज़िंग मोड का उपयोग करके Grokipedia में एकाधिक पदों की खोज करता है।

## Parameter Details

### `-Queries <String[]>`

> ग्रॉकिपीडिया खोज क्वेरी को निष्पादित करने के लिए
