...
> IMDB खोज क्वेरी को वेब ब्राउज़र में खोलता है।

## Description

एक वेब ब्राउज़र में व्यापक कॉन्फ़िगरेशन विकल्पों के साथ "इंटरनेट मूवी डेटाबेस" क्वेरी खोलता है। यह फ़ंक्शन IMDB खोज कार्यक्षमता के चारों ओर एक सुविधाजनक रैपर प्रदान करता है, जिससे उपयोगकर्ता PowerShell से सीधे फिल्मों, टीवी शो, अभिनेताओं और अन्य मनोरंजन सामग्री की खोज कर सकते हैं।

फ़ंक्शन खोज शब्दों को स्वीकार करता है और उचित IMDB खोज URL बनाता है, फिर उन्हें निर्दिष्ट वेब ब्राउज़र में अनुकूलन योग्य विंडो पोजिशनिंग, ब्राउज़र चयन और डिस्प्ले विकल्पों के साथ खोलता है। यह Edge, Chrome और Firefox सहित सभी प्रमुख ब्राउज़रों का समर्थन करता है, जिसमें प्राइवेट ब्राउज़िंग, फुलस्क्रीन मोड और विंडो प्रबंधन के विकल्प शामिल हैं।

प्रमुख विशेषताओं में मल्टी-मॉनिटर समर्थन, भाषा स्थानीयकरण, कीबोर्ड ऑटोमेशन और व्यापक ब्राउज़र कॉन्फ़िगरेशन विकल्प शामिल हैं। फ़ंक्शन एक साथ कई खोज क्वेरी को संभाल सकता है और इंटरैक्टिव उपयोग और स्वचालित कार्यप्रवाह दोनों के लिए विकल्प प्रदान करता है।
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Queries` | String[] | ✅ | ✅ (ByValue, ByPropertyName) | 0 | — | IMDB पर खोजने के लिए खोज शब्द |
...
| `-DisablePopupBlocker` | SwitchParameter | — | — | Named | — | ब्राउज़र की पॉपअप ब्लॉकिंग सुविधा को अक्षम करता है |
...
| `-SendKeyEscape` | SwitchParameter | — | — | Named | — | ब्राउज़र को कीस्ट्रोक भेजते समय नियंत्रण वर्णों को एस्केप करता है |
| `-SendKeyHoldKeyboardFocus` | SwitchParameter | — | — | Named | — | कीस्ट्रोक भेजने के बाद PowerShell में कीबोर्ड फ़ोकस वापस लौटने से रोकता है |
| `-SendKeyUseShiftEnter` | SwitchParameter | — | — | Named | — | कुंजियाँ भेजते समय सामान्य एंटर के बजाय लाइन ब्रेक के लिए Shift+Enter का उपयोग करता है |
...
डिफ़ॉल्ट मॉनिटर पर "द मैट्रिक्स" के लिए IMDB खोज खोलता है।
...
एलियास और शॉर्टहैंड पैरामीटर का उपयोग करके 'द मैट्रिक्स' के लिए एक IMDB खोज खोलता है।
...
Chrome में फ्रेंच भाषा के परिणामों के साथ IMDB पर कई फिल्में खोजता है।
...
टॉम हैंक्स को आईएमडीबी पर पूर्ण स्क्रीन मोड में खोजता है, फिर फोकस को पावरशेल पर वापस लौटाता है।

## Parameter Details

### `-Queries <String[]>`

> IMDB पर खोजने के लिए खोज शब्द
...
> ब्राउज़र की पॉपअप ब्लॉकिंग सुविधा को अक्षम करता है
...
> ब्राउज़र को कीस्ट्रोक भेजते समय नियंत्रण वर्णों को एस्केप करता है
...
> कीस्ट्रोक भेजने के बाद PowerShell में कीबोर्ड फ़ोकस वापस लौटने से रोकता है
...
> कुंजियाँ भेजते समय सामान्य एंटर के बजाय लाइन ब्रेक के लिए Shift+Enter का उपयोग करता है
