...
> InstantStreetView क्वेरी को वेब ब्राउज़र में खोलता है।

## Description

विन्यास योग्य तरीके से वेब ब्राउज़र कमांड लाइन स्विच का उपयोग करके InstantStreetView क्वेरी खोलता है। एकाधिक क्वेरी और मॉनिटर चयन का समर्थन करता है। विंडो पोजिशनिंग, भाषा सेटिंग्स और ब्राउज़र-विशिष्ट सुविधाओं सहित व्यापक ब्राउज़र नियंत्रण प्रदान करता है।

यह फ़ंक्शन स्वचालित रूप से स्थान क्वेरी को URL-एन्कोड करके और उन्हें निर्दिष्ट ब्राउज़र में खोलकर InstantStreetView URL बनाता है। व्यापक अनुकूलन विकल्पों के साथ Edge, Chrome और Firefox सहित सभी प्रमुख ब्राउज़रों का समर्थन करता है।
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Queries` | String[] | ✅ | ✅ (ByValue, ByPropertyName) | 0 | — | InstantStreetView में देखने के लिए स्थान क्वेरी |
| `-Language` | String | — | — | 1 | — | वापस किए गए खोज परिणामों की भाषा |
...
प्राथमिक मॉनिटर पर डिफ़ॉल्ट ब्राउज़र में टाइम्स स्क्वायर के लिए InstantStreetView खोलता है।
...
एलियास 'isv' का उपयोग करके एफिल टॉवर के लिए InstantStreetView खोलता है और द्वितीयक मॉनिटर पर प्रदर्शित करता है।
...
बिग बेन के लिए निजी ब्राउज़िंग मोड में अंग्रेजी भाषा में इंस्टेंटस्ट्रीटव्यू खोलता है।
...
पाइपलाइन के माध्यम से क्रोम ब्राउज़र में एकाधिक इंस्टेंटस्ट्रीटव्यू क्वेरी खोलता है, जो स्क्रीन के बाईं ओर स्थित हैं।

## Parameter Details

### `-Queries <String[]>`

> InstantStreetView में देखने के लिए स्थान क्वेरी
