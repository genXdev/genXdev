...
> निर्दिष्ट URL के लिए SimilarWeb वेबसाइट जानकारी को वेब ब्राउज़र में खोलता है।

## Description

कमांड लाइन स्विच का उपयोग करके कॉन्फ़िगरेबल तरीके से वेब ब्राउज़र में 'समान वेब' क्वेरी खोलता है। वेबसाइट ट्रैफ़िक विश्लेषण, प्रतिस्पर्धी अनुसंधान और डिजिटल मार्केटिंग अंतर्दृष्टि के लिए वेबसाइट एनालिटिक्स और तुलना की जाँच करने की अनुमति देता है।
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Queries` | String[] | ✅ | ✅ (ByValue, ByPropertyName) | 0 | — | SimilarWeb पर विश्लेषण करने के लिए वेबसाइट URL |
...
प्राथमिक मॉनिटर पर Google.com के लिए SimilarWeb विश्लेषण खोलता है।
...
फंक्शन उपनाम का उपयोग करके मॉनिटर स्थिति के साथ एक SimilarWeb विश्लेषण खोलता है।
...
पाइपलाइन इनपुट के माध्यम से केंद्रित विंडो स्थिति के साथ कई वेबसाइटों का विश्लेषण करता है।
...
बिना ब्राउज़र खोले GitHub के लिए SimilarWeb URL लौटाता है।

## Parameter Details

### `-Queries <String[]>`

> SimilarWeb पर विश्लेषण करने के लिए वेबसाइट URL
