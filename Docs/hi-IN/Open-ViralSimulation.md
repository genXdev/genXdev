...
> एक वेब ब्राउज़र में व्यापक कॉन्फ़िगरेशन विकल्पों के साथ एक वायरल सिमुलेशन गेम खोलता है।

## Description

वायरल सिमुलेशन गेम को https://viral.genxdev.net/ पर निर्दिष्ट वेब ब्राउज़र में कॉन्फ़िगरेबल विंडो सेटिंग्स, स्थिति निर्धारण और व्यवहार विकल्पों के साथ खोलता है। कई ब्राउज़रों, निजी ब्राउज़िंग, एप्लिकेशन मोड और व्यापक विंडो प्रबंधन सुविधाओं का समर्थन करता है।

यह फ़ंक्शन निम्नलिखित सुविधाओं के साथ एक इंटरैक्टिव वायरल सिमुलेशन अनुभव प्रदान करता है:
- एकाधिक ब्राउज़र समर्थन (Edge, Chrome, Firefox)
- विंडो स्थिति निर्धारण और आकार नियंत्रण
- फ़ुल-स्क्रीन और एप्लिकेशन मोड विकल्प
- निजी ब्राउज़िंग क्षमताएं
- कीबोर्ड स्वचालन समर्थन
- मल्टी-मॉनिटर समर्थन
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Language` | String | — | — | 0 | — | वेब सामग्री प्रदर्शन और ब्राउज़र भाषा सेटिंग्स के लिए भाषा |
...
| `-Monitor` | Int32 | — | — | Named | `-2` | उपयोग करने के लिए मॉनिटर, 0 = डिफ़ॉल्ट, -1 को त्यागें, -2 = कॉन्फ़िगर किया गया द्वितीयक मॉनिटर, डिफ़ॉल्ट रूप से $Global:DefaultSecondaryMonitor या न मिलने पर 2 |
...
गूगल क्रोम में प्राइवेट ब्राउज़िंग मोड और बिना फ़ुलस्क्रीन के वायरल सिमुलेशन खोलता है।
...
उपनामों के साथ वायरल सिमुलेशन को क्रोम, गुप्त मोड और बिना फुलस्क्रीन के खोलता है।

## Parameter Details

### `-Language <String>`

> वेब सामग्री प्रदर्शन और ब्राउज़र भाषा सेटिंग्स के लिए भाषा
...
- [Open-Yab](https://github.com/genXdev/genXdev/blob/main/Docs/hi-IN/Open-Yab.md)
