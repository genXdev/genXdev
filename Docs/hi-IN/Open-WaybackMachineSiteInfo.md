...
> वेब ब्राउज़र में वेबैकमशीन साइट जानकारी खोलता है।

## Description

वेब ब्राउज़र में वेबैकमशीन क्वेरी खोलता है, निर्दिष्ट URL या वेबसाइट के ऐतिहासिक संस्करण प्रदर्शित करता है। कई क्वेरी और मॉनिटर चयन का समर्थन करता है। इंटरनेट आर्काइव की वेबैक मशीन सेवा के माध्यम से संग्रहीत वेब सामग्री तक पहुंच प्रदान करता है।
...
| `-Language` | String | — | — | 1 | — | ब्राउज़र इंटरफ़ेस और सामग्री के लिए भाषा प्राथमिकता |
...
| `-SessionOnly` | SwitchParameter | — | — | Named | — | वेबैक मशीन प्राथमिकताओं के लिए सत्र में संग्रहीत वैकल्पिक सेटिंग्स का उपयोग करें |
| `-ClearSession` | SwitchParameter | — | — | Named | — | वेबैक मशीन वरीयताओं के लिए सत्र में संग्रहीत वैकल्पिक सेटिंग्स साफ़ करें |
...
डिफ़ॉल्ट मॉनिटर पर example.com के लिए वेबैक मशीन संग्रह खोलता है।
...
example.com के लिए वेबैक मशीन संग्रह को उपनामों का उपयोग करके खोलता है और मॉनिटर स्थिति को त्याग दिया जाता है।
...
क्रोम के गुप्त मोड में microsoft.com के लिए वेबैक मशीन आर्काइव खोलता है।
...
> ब्राउज़र इंटरफ़ेस और सामग्री के लिए भाषा प्राथमिकता
...
> वेबैक मशीन प्राथमिकताओं के लिए सत्र में संग्रहीत वैकल्पिक सेटिंग्स का उपयोग करें
...
> वेबैक मशीन वरीयताओं के लिए सत्र में संग्रहीत वैकल्पिक सेटिंग्स साफ़ करें
