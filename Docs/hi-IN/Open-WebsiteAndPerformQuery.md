...
> एक वेबब्राउज़र में एक वेबपेज खोलता है और एक या अधिक क्वेरी करता है।

## Description

यह फ़ंक्शन डिफ़ॉल्ट वेब ब्राउज़र में URL द्वारा एक वेबसाइट खोलता है, एक या अधिक क्वेरी दर्ज करता है और उन्हें सबमिट करता है। यह अंतर्निहित Open-Webbrowser फ़ंक्शन के माध्यम से व्यापक मॉनिटर चयन और विंडो पोजिशनिंग विकल्पों का समर्थन करता है।

फ़ंक्शन स्वचालित रूप से प्रत्येक क्वेरी को क्लिपबोर्ड पर कॉपी करता है और कीबोर्ड ऑटोमेशन का उपयोग करके ब्राउज़र विंडो में भेजता है। यह मूल क्लिपबोर्ड सामग्री को संरक्षित करता है और सभी क्वेरी प्रोसेस होने के बाद इसे पुनर्स्थापित करता है।
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Url` | String | ✅ | ✅ (ByPropertyName) | 0 | — | खोले जाने वाली वेबसाइट का URL |
...
| `-SendKeyDelayMilliSeconds` | Int32 | — | — | Named | `500` | विभिन्न कुंजी अनुक्रमों को भेजने के बीच का विलंब मिलीसेकंड में |
...
Google खोलता है और 'PowerShell' के लिए खोज करता है।
...
डिफ़ॉल्ट मॉनिटर पर Google खोलता है और "PowerShell ट्यूटोरियल" खोजता है।

## Parameter Details

### `-Url <String>`

> खोले जाने वाली वेबसाइट का URL
