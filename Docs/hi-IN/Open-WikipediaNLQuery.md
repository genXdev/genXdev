...
> डच विकिपीडिया खोजों को एक वेब ब्राउज़र में खोलता है।

## Description

वेब ब्राउज़र में 'विकिपीडिया - नीदरलैंड' क्वेरी को कॉन्फ़िगरेबल डिस्प्ले विकल्पों के साथ खोलता है। कई शब्दों की खोज और किस मॉनिटर पर परिणाम प्रदर्शित करना है, यह निर्दिष्ट करने का समर्थन करता है।
...
| `-SideBySide` | SwitchParameter | — | — | Named | — | दो ब्राउज़र विंडो को एक-दूसरे के बगल में खोलता है |
| `-SessionOnly` | SwitchParameter | — | — | Named | — | केवल सत्र-आधारित कुकीज़ का उपयोग करें (कोई स्थायी कुकीज़ नहीं) |
| `-ClearSession` | SwitchParameter | — | — | Named | — | ब्राउज़र सत्र डेटा खोलने से पहले साफ़ करें |
| `-SkipSession` | SwitchParameter | — | — | Named | — | पिछले ब्राउज़र सत्र को पुनर्स्थापित करना छोड़ें |
...
> दो ब्राउज़र विंडो को एक-दूसरे के बगल में खोलता है
...
> केवल सत्र-आधारित कुकीज़ का उपयोग करें (कोई स्थायी कुकीज़ नहीं)
...
> ब्राउज़र सत्र डेटा खोलने से पहले साफ़ करें
...
> पिछले ब्राउज़र सत्र को पुनर्स्थापित करना छोड़ें
