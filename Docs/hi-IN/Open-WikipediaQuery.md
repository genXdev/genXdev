...
> वेब ब्राउज़र में विकिपीडिया क्वेरी खोलता है।

## Description

व्यापक कॉन्फ़िगरेशन विकल्पों के साथ एक या अधिक विकिपीडिया खोज क्वेरी को वेब ब्राउज़र में खोलता है। कॉन्फ़िगरेबल ब्राउज़र व्यवहार, मॉनिटर चयन और विंडो पोजिशनिंग का समर्थन करता है। क्वेरी URL एन्कोडेड होती हैं और पूर्ण स्थानीयकरण समर्थन के साथ निर्दिष्ट भाषा के विकिपीडिया डोमेन का उपयोग करके खोली जाती हैं।

यह फ़ंक्शन प्राइवेट ब्राउज़िंग मोड, विंडो पोजिशनिंग, कीबोर्ड ऑटोमेशन और मल्टी-मॉनिटर समर्थन सहित व्यापक ब्राउज़र नियंत्रण प्रदान करता है। यह अंतर्राष्ट्रीय विकिपीडिया डोमेन के लिए स्वचालित रूप से URL एन्कोडिंग और भाषा कोड मैपिंग को संभालता है।
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Queries` | String[] | ✅ | ✅ (ByValue, ByPropertyName) | 0 | — | निष्पादित करने के लिए विकिपीडिया खोज क्वेरी |
| `-Language` | String | — | — | 1 | — | विकिपीडिया खोज परिणामों की भाषा |
...
| `-PassThru` | SwitchParameter | — | — | Named | — | ब्राउज़र प्रक्रिया का प्रतिनिधित्व करने वाला एक PowerShell प्रक्रिया ऑब्जेक्ट लौटाता है |
...
डिफ़ॉल्ट मॉनिटर पर "पावरशेल" के लिए अंग्रेज़ी में विकिपीडिया खोज खोलता है।
...
उपनाम के साथ स्थितीय पैरामीटर का उपयोग करके विकिपीडिया खोज खोलता है।
...
निजी ब्राउज़िंग मोड का उपयोग करके जर्मन विकिपीडिया में कई शब्दों की खोज करता है।

## Parameter Details

### `-Queries <String[]>`

> निष्पादित करने के लिए विकिपीडिया खोज क्वेरी
...
> विकिपीडिया खोज परिणामों की भाषा
...
> ब्राउज़र प्रक्रिया का प्रतिनिधित्व करने वाला एक PowerShell प्रक्रिया ऑब्जेक्ट लौटाता है
