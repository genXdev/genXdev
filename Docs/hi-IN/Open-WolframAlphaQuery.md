...
> वेब ब्राउज़र में वोल्फ्राम अल्फा क्वेरी खोलता है।

## Description

एक या अधिक Wolfram Alpha क्वेरी को वेब ब्राउज़र में खोलता है। डायनामिक पैरामीटर के माध्यम से कॉन्फ़िगरेबल मॉनिटर चयन और ब्राउज़र विकल्पों का समर्थन करता है। उन्नत वैज्ञानिक कंप्यूटेशन वर्कफ़्लो के लिए स्थिति, आकार और ऑटोमेशन क्षमताओं सहित व्यापक ब्राउज़र नियंत्रण प्रदान करता है।
...
| `-SendKeyEscape` | SwitchParameter | — | — | Named | — | कुंजी भेजते समय नियंत्रण वर्णों को एस्केप करें। |
| `-SendKeyHoldKeyboardFocus` | SwitchParameter | — | — | Named | — | कीज़ भेजने के बाद PowerShell को कीबोर्ड फोकस वापस लेने से रोकें। |
| `-SendKeyUseShiftEnter` | SwitchParameter | — | — | Named | — | कुंजियाँ भेजते समय नियमित एंटर के बजाय लाइन ब्रेक के लिए Shift+Enter भेजें। |
| `-SendKeyDelayMilliSeconds` | Int32 | — | — | Named | — | विभिन्न कुंजी अनुक्रमों को भेजने के बीच मिलीसेकंड में देरी। |
...
डिफ़ॉल्ट मॉनिटर पर सूर्य के द्रव्यमान के लिए वुल्फ्राम अल्फा क्वेरी खोलता है।
...
त्वरित वैज्ञानिक गणनाओं के लिए उपनाम का उपयोग करके एकाधिक वोल्फ्राम अल्फा क्वेरी खोलता है।
...
पाइपलाइन इनपुट के माध्यम से अंग्रेजी भाषा प्राथमिकता के साथ कैलकुलस क्वेरी को फुलस्क्रीन मोड में खोलता है।
...
> कुंजियाँ भेजते समय नियमित एंटर के बजाय लाइन ब्रेक के लिए Shift+Enter भेजें।
