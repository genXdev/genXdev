...
> YAB गेम को कॉन्फ़िगरेबल सेटिंग्स के साथ वेब ब्राउज़र में खोलता है।

## Description

YAB गेम वेबसाइट को एक निर्दिष्ट ब्राउज़र में विभिन्न प्रदर्शन और व्यवहार विकल्पों के साथ खोलता है। दर्शक मोड सहित विभिन्न गेम मोड का समर्थन करता है। YAB गेम एक ऑनलाइन पहेली गेम है जिसे इंटरैक्टिव रूप से खेला जा सकता है या दर्शक मोड में देखा जा सकता है जहां AI स्वचालित रूप से खेलता है।
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Language` | String | — | — | 0 | — | गेम इंटरफ़ेस की भाषा |
...
| `-Monitor` | Int32 | — | — | Named | `-2` | उपयोग करने के लिए मॉनिटर, 0 = डिफ़ॉल्ट, -1 हटा दें, -2 = कॉन्फ़िगर किया गया द्वितीयक मॉनिटर, डिफ़ॉल्ट -1, कोई स्थिति निर्धारण नहीं |
| `-FullScreen` | SwitchParameter | — | — | Named | — | पूर्ण स्क्रीन मोड में खोलता है |
| `-ShowWindow` | SwitchParameter | — | — | Named | — | ब्राउज़र विंडो दिखाएं (न्यूनतम या छिपा हुआ नहीं) |
...
| `-SpectateOnly` | SwitchParameter | — | — | Named | — | नया खेल शुरू न करें, बस AI को खेलते हुए देखें |
| `-NoFullScreen` | SwitchParameter | — | — | Named | — | फ़ुलस्क्रीन मोड में न खोलें |
| `-NoApplicationMode` | SwitchParameter | — | — | Named | — | ब्राउज़र नियंत्रण दिखाएं |
...
YAB गेम को क्रोम ब्राउज़र में दर्शक मोड में खोलें, बिना फुलस्क्रीन के, अंग्रेजी भाषा इंटरफ़ेस के साथ।
...
त्वरित पहुँच के लिए उपनामों का उपयोग करते हुए YAB गेम को मॉनिटर 2 पर निजी ब्राउज़िंग के साथ एज ब्राउज़र में खोलता है।

## Parameter Details

### `-Language <String>`

> गेम इंटरफ़ेस की भाषा
...
> ब्राउज़र विंडो दिखाएं (न्यूनतम या छिपा हुआ नहीं)
...
> नया खेल शुरू न करें, बस AI को खेलते हुए देखें
...
- [Open-GameOfLife](https://github.com/genXdev/genXdev/blob/main/Docs/hi-IN/Open-GameOfLife.md)
- [Open-GenXdevAppCatalog](https://github.com/genXdev/genXdev/blob/main/Docs/hi-IN/Open-GenXdevAppCatalog.md)
- [Open-Timeline](https://github.com/genXdev/genXdev/blob/main/Docs/hi-IN/Open-Timeline.md)
- [Open-ViralSimulation](https://github.com/genXdev/genXdev/blob/main/Docs/hi-IN/Open-ViralSimulation.md)
- [Open-YabAIBattle](https://github.com/genXdev/genXdev/blob/main/Docs/hi-IN/Open-YabAIBattle.md)
