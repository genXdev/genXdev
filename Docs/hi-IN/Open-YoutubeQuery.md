...
> यूट्यूब खोज क्वेरी को वेब ब्राउज़र में खोलता है।

## Description

वेब ब्राउज़र में एक या अधिक YouTube खोज क्वेरी को व्यापक स्थिति और कॉन्फ़िगरेशन विकल्पों के साथ खोलता है। कॉन्फ़िगर करने योग्य मॉनिटर चयन, ब्राउज़र सेटिंग्स और Open-Webbrowser cmdlet से प्राप्त गतिशील पैरामीटर के माध्यम से कीस्ट्रोक ऑटोमेशन का समर्थन करता है। प्रत्येक क्वेरी एक अलग ब्राउज़र इंस्टेंस में खुलती है जिसमें विंडो पोजिशनिंग, ब्राउज़र प्रकार और खोज भाषा पर पूर्ण नियंत्रण होता है।
...
डिफ़ॉल्ट मॉनिटर पर "PowerShell ट्यूटोरियल" के लिए YouTube खोज खोलता है।
...
'हाउ टू कोड' के लिए YouTube खोज को कॉन्फ़िगर किए गए सेकेंडरी मॉनिटर पर फ़ंक्शन उपनाम का उपयोग करके खोलता है।
