...
> वैकल्पिक संशोधनों के साथ वर्तमान विंडो को विंडो स्टैक पर धकेलता है।

## Description

वर्तमान में फोकस की गई विंडो के लिए एक विंडो हेल्पर को स्टैक पर धकेलता है।
धक्का देने से पहले या बाद में विभिन्न विंडो परिवर्तन लागू करने की अनुमति देता है।
यह फ़ंक्शन वर्तमान विंडो को कैप्चर करता है और इसे बाद में Pop-Window के साथ पुनर्प्राप्त करने के लिए संग्रहीत करता है, जबकि वैकल्पिक रूप से स्थिति, आकार और दृश्य प्रभाव लागू करता है।
