...
> एक WireGuard VPN पीयर कॉन्फ़िगरेशन को हटाता है।

## Description

यह फ़ंक्शन डॉकर कंटेनर में चल रहे सर्वर से वायरगार्ड VPN पीयर कॉन्फ़िगरेशन को हटाता है। यह पीयर की कॉन्फ़िगरेशन फ़ाइलों को हटाता है और वायरगार्ड सर्वर को अपडेट करता है ताकि इस पीयर से कनेक्शन स्वीकार करना बंद कर दे। फ़ंक्शन हटाने से पहले पीयर के अस्तित्व को मान्य करता है और जब तक फोर्स पैरामीटर निर्दिष्ट नहीं किया जाता है, तब तक पुष्टि संकेत प्रदान करता है।
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-PeerName` | String | ✅ | — | 0 | — | हटाए जाने वाले पीयर का नाम |
...
| `-Force` | SwitchParameter | — | — | Named | — | बिना पुष्टि के बलपूर्वक हटाना |
| `-NoDockerInitialize` | SwitchParameter | — | — | Named | — | जब मूल फ़ंक्शन द्वारा कॉल किया जाए तो Docker आरंभीकरण छोड़ें |
...
पुष्टि संकेत के साथ "MyPhone" नामक सहकर्मी को हटाता है।
...
बिना पुष्टि प्रॉम्प्ट के "टैबलेट" नामक सहकर्मी को हटाता है।
...
स्थितीय पैरामीटर सिंटैक्स का उपयोग करके पीयर को हटाता है।

## Parameter Details

### `-PeerName <String>`

> हटाए जाने वाले पीयर का नाम
...
> जब मूल फ़ंक्शन द्वारा कॉल किया जाए तो Docker आरंभीकरण छोड़ें
