...
> किसी विंडो या प्रक्रिया में अनुकरणित कीस्ट्रोक्स भेजता है।

## Description

यह फ़ंक्शन विंडोज़ स्क्रिप्ट होस्ट शेल ऑब्जेक्ट का उपयोग करके लक्ष्य विंडो या प्रक्रिया में कीबोर्ड इनपुट भेजता है। यह प्रक्रिया नाम, प्रक्रिया आईडी या विंडो हैंडल द्वारा विंडो को लक्षित कर सकता है। फ़ंक्शन विशेष कुंजी अनुक्रम, एस्केप कैरेक्टर और विश्वसनीय कुंजी वितरण के लिए विभिन्न समय विकल्पों का समर्थन करता है।
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-KeysToSend` | String[] | ✅ | ✅ (ByValue, ByPropertyName) | 0 | — | स्ट्रिंग्स की एक सरणी के रूप में भेजने के लिए कीबोर्ड इनपुट |
| `-ProcessName` | String | — | ✅ (ByPropertyName) | Named | — | कुंजियाँ भेजने की प्रक्रिया का नाम (वाइल्डकार्ड समर्थित) *(Parameter set: )* 🌐 *Supports wildcards* |
| `-ProcessId` | Int32 | — | ✅ (ByPropertyName) | Named | — | कुंजी भेजने के लिए प्रक्रिया का आईडी *(Parameter set: )* |
| `-WindowHandle` | Int64 | — | ✅ (ByPropertyName) | Named | — | कुंजियाँ भेजने के लिए विंडो हैंडल *(Parameter set: )* |
| `-SendKeyEscape` | SwitchParameter | — | — | Named | — | इनपुट टेक्स्ट में नियंत्रण वर्णों और संशोधकों को एस्केप करें |
| `-SendKeyHoldKeyboardFocus` | SwitchParameter | — | — | Named | — | कीज़ भेजने के बाद लक्ष्य विंडो पर कीबोर्ड फोकस रखें |
| `-SendKeyUseShiftEnter` | SwitchParameter | — | — | Named | — | नई पंक्तियों के लिए Enter के बजाय Shift+Enter का उपयोग करें |
| `-SendKeyDelayMilliSeconds` | Int32 | — | — | Named | `10` | विभिन्न इनपुट स्ट्रिंग्स के बीच मिलीसेकंड में विलंब |
...
> स्ट्रिंग्स की एक सरणी के रूप में भेजने के लिए कीबोर्ड इनपुट
...
> कुंजियाँ भेजने की प्रक्रिया का नाम (वाइल्डकार्ड समर्थित)
...
> कुंजी भेजने के लिए प्रक्रिया का आईडी
...
> कुंजियाँ भेजने के लिए विंडो हैंडल
...
> इनपुट टेक्स्ट में नियंत्रण वर्णों और संशोधकों को एस्केप करें
...
> कीज़ भेजने के बाद लक्ष्य विंडो पर कीबोर्ड फोकस रखें
...
> नई पंक्तियों के लिए Enter के बजाय Shift+Enter का उपयोग करें
