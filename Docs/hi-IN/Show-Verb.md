...
> सभी PowerShell क्रियाओं की एक छोटी वर्णमाला सूची दिखाता है।

## Description

पॉवरशेल स्वीकृत क्रियाओं को अल्पविराम से अलग की गई सूची में प्रदर्शित करता है। यदि विशिष्ट क्रियाएँ इनपुट के रूप में प्रदान की जाती हैं, तो केवल मेल खाने वाली क्रियाएँ दिखाई जाएँगी। वाइल्डकार्ड का समर्थन करता है।
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Verb` | String[] | — | ✅ (ByValue, ByPropertyName) | 0 | `@()` | फ़िल्टर करने के लिए एक या अधिक क्रिया पैटर्न (वाइल्डकार्ड का समर्थन करता है) 🌐 *Supports wildcards* |
...
> फ़िल्टर करने के लिए एक या अधिक क्रिया पैटर्न (वाइल्डकार्ड का समर्थन करता है)
