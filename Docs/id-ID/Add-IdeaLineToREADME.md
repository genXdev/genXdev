...
> Menambahkan item ide ke file README.md.

## Description

Menambahkan ide yang diberi stempel waktu ke bagian "## Ideas" dari file README.md.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Line` | String | — | — | 0 | `''` | Teks ide yang akan ditambahkan |
...
> Teks ide yang akan ditambahkan
