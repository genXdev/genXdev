...
> Mengonversi teks langsung atau blak-blakan menjadi bahasa korporat yang sopan dan profesional menggunakan AI.

## Description

Fungsi ini memproses teks masukan untuk mengubah bahasa yang langsung atau berpotensi kasar menjadi komunikasi korporat yang diplomatis dan profesional. Fungsi ini dapat menerima masukan langsung melalui parameter, dari pipeline, atau dari clipboard sistem. Fungsi ini memanfaatkan model AI untuk menganalisis dan merumuskan ulang teks sambil mempertahankan maksud aslinya.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Text` | String | — | ✅ (ByValue) | 0 | — | Teks untuk diubah menjadi bahasa korporat |
...
> Teks untuk diubah menjadi bahasa korporat
