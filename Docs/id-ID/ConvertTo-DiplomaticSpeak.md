...
> Mengonversi teks langsung atau blak-blakan menjadi bahasa diplomatis yang sopan dan bijaksana.

## Description

Fungsi ini mengubah input pengguna dari frasa langsung atau blak-blakan menjadi bahasa diplomatis, bijaksana yang cocok untuk diskusi tingkat tinggi, negosiasi, atau komunikasi formal. Fungsi ini menggunakan model bahasa AI untuk mempertahankan maksud asli sambil melunakkan nada dan membuat pesan lebih diplomatis dan profesional.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Text` | String | — | ✅ (ByValue) | 0 | — | Berikut adalah teks yang akan diubah menjadi bahasa diplomatis |
...
> Berikut adalah teks yang akan diubah menjadi bahasa diplomatis
