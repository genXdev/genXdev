...
> Menyalin file yang cocok dengan kriteria pencarian ke dalam subfolder berdasarkan tanggal.

## Description

Mencari file menggunakan himpunan parameter yang sama dengan `Find-Item` dan menyalin setiap file yang cocok ke dalam subfolder dari `TargetFolder` berdasarkan tanggal pembuatan atau tanggal media file. Cmdlet ini mendukung pencocokan konten, pencarian di seluruh drive, dan banyak filter.

Mencoba beberapa strategi untuk menentukan tanggal pembuatan atau pengambilan yang akurat untuk file yang ditentukan. Strategi termasuk membaca metadata EXIF gambar, mengurai informasi tanggal/waktu dari nama file, dan kembali ke waktu tulis terakhir file ketika tidak ada informasi andal lainnya yang tersedia.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-TargetFolder` | String | ✅ | — | 0 | — | Folder akar target tempat file yang cocok akan disalin ke subfolder berdasarkan tanggal |
...
Copy-FilesToDateFolder -TargetFolder 'D:\Archive' -Nama '*.jpg' -WhatIf
...
> Folder akar target tempat file yang cocok akan disalin ke subfolder berdasarkan tanggal
