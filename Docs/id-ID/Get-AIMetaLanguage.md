...
> Mendapatkan bahasa default yang dikonfigurasi untuk operasi metadata gambar.

## Description

* Cmdlet ini mengambil bahasa default yang digunakan oleh modul GenXdev.AI
  untuk operasi metadata gambar.
* Pertama memeriksa variabel Global (kecuali SkipSession ditentukan), lalu
  kembali ke preferensi persisten, dan akhirnya menggunakan default sistem.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Language` | String | — | — | 0 | — | Bahasa default untuk operasi metadata gambar |
| `-PreferencesDatabasePath` | String | — | — | Named | — | Jalur database untuk file data preferensi |
| `-SessionOnly` | SwitchParameter | — | — | Named | `False` | Gunakan pengaturan alternatif yang disimpan dalam sesi untuk preferensi AI seperti Bahasa, koleksi Gambar, dll |
| `-ClearSession` | SwitchParameter | — | — | Named | `False` | Hapus pengaturan sesi (Variabel global) sebelum mengambil |
| `-SkipSession` | SwitchParameter | — | — | Named | `False` | Jangan gunakan pengaturan alternatif yang disimpan dalam sesi untuk preferensi AI seperti Bahasa, Koleksi gambar, dll. |
...
Dapatkan bahasa yang saat ini dikonfigurasi dari variabel Global atau preferensi.
...
Dapatkan bahasa yang dikonfigurasi dari preferensi persisten, mengabaikan sesi.
...
Hapus pengaturan sesi dan dapatkan bahasa dari preferensi persisten.

## Parameter Details

### `-Language <String>`

> Bahasa default untuk operasi metadata gambar
