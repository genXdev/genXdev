...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-DisplacedVolumeInCubicMeters` | Double | ✅ | — | 0 | `0` | Volume yang dipindahkan dalam m³ |
| `-FluidDensityInKilogramsPerCubicMeter` | Double | ✅ | — | 1 | `0` | Kepadatan fluida dalam kg/m³ |
| `-GravityInMetersPerSecondSquared` | Double | — | — | 2 | `0` | Gravitasi dalam m/s² (default: 9,81) |
| `-As` | String | — | — | 3 | — | Satuan output untuk gaya |

## Parameter Details

### `-DisplacedVolumeInCubicMeters <Double>`

> Volume yang dipindahkan dalam m³
