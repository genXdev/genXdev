...
> Mengambil objek proses dari jendela yang saat ini memiliki fokus keyboard.

## Description

* Cmdlet ini menggunakan panggilan API Windows melalui P/Invoke untuk mengidentifikasi dan
  mengembalikan objek Process yang terkait dengan jendela yang saat ini difokuskan.
* Ini memanfaatkan fungsi User32.dll GetForegroundWindow dan
  GetWindowThreadProcessId untuk menentukan jendela mana yang memiliki fokus dan mendapatkan
  ID proses yang terkait.
...
Mengambil objek proses untuk jendela yang saat ini memiliki fokus keyboard.
