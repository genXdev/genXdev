...
> Mengambil modul GenXDev dalam urutan dependensi.

## Description

Fungsi ini mengembalikan daftar modul GenXDev yang diatur dalam urutan dependensi yang benar untuk memastikan pemuatan modul yang tepat. Pertama, fungsi ini mengambil semua informasi modul, lalu mengurutkannya berdasarkan dependensi, dimulai dengan modul inti dan diakhiri dengan modul dependen. Ini memastikan modul dimuat dalam urutan yang benar.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-ModuleName` | String[] | — | ✅ (ByValue, ByPropertyName) | 0 | `@('GenXdev*')` | Satu atau lebih nama modul untuk difilter |
...
> Satu atau lebih nama modul untuk difilter
