...
> Menampilkan ide-ide dari file README.md.

## Description

Menampilkan semua ide dari bagian "## Ideas" dari file README.md. Dapat menggunakan README di lokasi saat ini, direktori profil PowerShell, atau direktori OneDrive.
