...
> Mengenali wajah dalam gambar yang diunggah dengan membandingkan ke wajah yang dikenal menggunakan DeepStack.

## Description

Fungsi ini menganalisis file gambar untuk mengidentifikasi wajah dengan membandingkannya dengan wajah yang dikenal dalam database. Fungsi ini menggunakan API pengenalan wajah DeepStack lokal yang berjalan pada port yang dapat dikonfigurasi dan mengembalikan kecocokan wajah dengan skor kepercayaannya. Fungsi ini mendukung akselerasi GPU, ambang batas kepercayaan kustom, dan manajemen kontainer Docker.
