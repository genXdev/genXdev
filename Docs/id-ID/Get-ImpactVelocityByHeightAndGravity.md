...
> Menghitung kecepatan tumbukan dari ketinggian.

## Description

Menggunakan v = sqrt(2 g h) dengan mengabaikan hambatan udara.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-HeightInMeters` | Double | ✅ | — | 0 | `0` | Tinggi dalam meter |
| `-GravityInMetersPerSecondSquared` | Double | — | — | 1 | `0` | Gravitasi dalam m/s². Standar 9,81. |
| `-As` | String | — | — | 2 | — | Satuan output untuk kecepatan. Default 'm/s'. |
...
Menghitung kecepatan tumbukan untuk jatuh setinggi 100 meter dan menampilkan hasil dalam km/jam.
...
Menghitung kecepatan tumbukan untuk jatuh setinggi 50 meter menggunakan unit bawaan.
...
> Gravitasi dalam m/s². Standar 9,81.
...
> Satuan output untuk kecepatan. Default 'm/s'.
