...
> Menampilkan masalah dari file README.md.

## Description

Menampilkan semua masalah dari bagian "## Issues" dari file README.md. Dapat menggunakan README di lokasi saat ini, direktori profil PowerShell, atau direktori OneDrive.
