...
| `-VelocityInMetersPerSecond` | Double | ✅ | — | 1 | `0` | Kecepatan dalam m/s |
| `-As` | String | — | — | 2 | — | Satuan output untuk momentum |
