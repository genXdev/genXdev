...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-MassInKilograms` | Double | ✅ | — | 0 | `0` | Massa dalam kg |
| `-HeightInMeters` | Double | ✅ | — | 1 | `0` | Tinggi dalam meter |
| `-GravityInMetersPerSecondSquared` | Double | — | — | 2 | `0` | Gravitasi dalam m/s² (default: 9,81) |
| `-As` | String | — | — | 3 | — | Satuan keluaran untuk energi |
...
Menghitung energi potensial gravitasi untuk massa 10kg pada ketinggian 5 meter, menghasilkan output dalam kalori.
...
Menunjukkan penggunaan parameter posisi untuk menghitung energi potensial.
...
> Gravitasi dalam m/s² (default: 9,81)
