...
> Menampilkan ReleaseNotes dari file README.md.

## Description

Menampilkan semua Catatan Rilis dari bagian "## Release notes" dari file README.md. Dapat menggunakan README di lokasi saat ini, direktori profil PowerShell, atau direktori OneDrive.
