...
> Membuat dan mengembalikan objek transaksi SQL Server untuk operasi batch.

## Description

Membuat objek koneksi database SQL Server dan transaksi yang dapat digunakan untuk operasi batch. Pemanggil bertanggung jawab untuk melakukan commit atau rollback transaksi. Memerlukan database SQL Server dan koneksi yang sudah ada.
