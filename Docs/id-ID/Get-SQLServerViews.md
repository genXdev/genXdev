...
> Mengambil daftar tampilan dari database SQL Server.

## Description

Mengambil semua nama tampilan dari database SQL Server yang ditentukan. Mengembalikan array nama tampilan yang dapat digunakan untuk operasi database selanjutnya. Fungsi ini mendukung dua set parameter untuk fleksibilitas: menyediakan string koneksi atau nama database dengan server.
