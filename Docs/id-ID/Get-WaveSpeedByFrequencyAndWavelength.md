...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-FrequencyInHertz` | Double | ✅ | — | 0 | `0` | Frekuensi dalam Hz |
| `-WavelengthInMeters` | Double | ✅ | — | 1 | `0` | Panjang gelombang dalam meter |
| `-As` | String | — | — | 2 | — | Unit keluaran untuk kecepatan |
...
Menghitung kecepatan gelombang menggunakan v = f * λ.
...
Menghitung kecepatan gelombang dengan parameter posisi.
