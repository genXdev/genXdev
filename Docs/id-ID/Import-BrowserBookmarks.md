...
> Mengimpor bookmark dari berkas atau koleksi ke dalam peramban web.

## Description

Mengimpor bookmark ke Microsoft Edge atau Google Chrome dari file CSV atau kumpulan objek bookmark. Bookmark ditambahkan ke bilah bookmark browser atau folder tertentu. Impor Firefox saat ini tidak didukung.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-InputFile` | String | — | — | 0 | — | Jalur ke file CSV dengan markah yang akan diimpor *(Parameter set: )* |
| `-Bookmarks` | Array | — | — | 0 | — | Kumpulan bookmark untuk diimpor *(Parameter set: )* |
| `-Chrome` | SwitchParameter | — | — | Named | — | Impor ke Google Chrome |
| `-Edge` | SwitchParameter | — | — | Named | — | Impor ke Microsoft Edge |
| `-Firefox` | SwitchParameter | — | — | Named | — | Impor ke Firefox (tidak didukung) |
...
> Jalur ke file CSV dengan markah yang akan diimpor
...
> Kumpulan bookmark untuk diimpor
...
> Impor ke Firefox (tidak didukung)
