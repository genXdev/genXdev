...
> Memperbarui metadata gambar dengan deskripsi dan kata kunci yang dihasilkan AI.

## Description

Fungsi Invoke-ImageKeywordUpdate menganalisis gambar menggunakan AI untuk menghasilkan deskripsi, kata kunci, dan metadata lainnya. Fungsi ini membuat file JSON pendamping untuk setiap gambar yang berisi informasi ini. Fungsi dapat memproses gambar baru saja atau memperbarui metadata yang sudah ada, dan mendukung pemindaian direktori secara rekursif.
