...
> Memperbarui metadata klasifikasi pemandangan untuk file gambar di direktori yang ditentukan.

## Description

Fungsi ini memproses gambar dalam direktori yang ditentukan untuk mengklasifikasikan pemandangan menggunakan kecerdasan buatan. Fungsi ini membuat file metadata JSON yang berisi klasifikasi pemandangan, skor kepercayaan, dan label. Fungsi ini mendukung pemrosesan batch dengan ambang kepercayaan yang dapat dikonfigurasi dan secara opsional dapat melewati file metadata yang sudah ada atau mencoba ulang klasifikasi yang sebelumnya gagal.
...
Memproses semua gambar di C:\Photos dan D:\Pictures serta subdirektorinya untuk klasifikasi pemandangan.
...
Menggunakan alias untuk mencoba ulang klasifikasi yang gagal dan hanya memproses gambar baru di beberapa direktori.
...
Memaksa pembangunan ulang kontainer dan menggunakan akselerasi GPU untuk pemrosesan yang lebih cepat.
...
Memproses semua gambar secara rekursif dan hanya menyimpan klasifikasi pemandangan dengan kepercayaan >= 60%.
