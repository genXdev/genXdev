...
> Menjalankan satu atau lebih kueri SQL terhadap database SQL Server dengan dukungan transaksi.

## Description

Menjalankan kueri SQL terhadap database SQL Server dengan dukungan parameter dan isolasi transaksi yang dapat dikonfigurasi. Dapat menggunakan transaksi eksternal untuk operasi batch atau membuat transaksi internal sendiri. Saat menggunakan transaksi eksternal, pemanggil bertanggung jawab untuk melakukan commit/rollback. Prioritas koneksi: Transaction > ConnectionString > DatabaseName (memerlukan Server).
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Queries` | String[] | — | ✅ (ByValue, ByPropertyName) | 0 | — | Kueri atau kueri yang akan dijalankan. |
| `-DatabaseName` | String | — | — | 1 | `'master'` | Nama database SQL Server. |
| `-Server` | String | — | — | 2 | `'.'` | Nama instans SQL Server. |
| `-Transaction` | Object | — | — | 3 | — | Sebuah transaksi SQL Server yang ada untuk digunakan dalam kueri. |
| `-ConnectionString` | String | — | — | 4 | — | String koneksi ke database SQL. |
| `-SqlParameters` | Collections.Hashtable[] | — | ✅ (ByValue, ByPropertyName) | 5 | `@()` | Parameter kueri sebagai tabel hash. |
...
> Sebuah transaksi SQL Server yang ada untuk digunakan dalam kueri.
...
> String koneksi ke database SQL.
