...
> Membuka semua jenis kueri yang mungkin untuk istilah pencarian atau URL yang diberikan.

## Description

Menjalankan semua cmdlet yang menangani kueri halaman web, memproses baik URL maupun istilah pencarian. Untuk URL, ia melakukan kueri spesifik situs, dan untuk istilah pencarian ia menjalankan kueri web umum. Fungsi ini secara dinamis menemukan dan menjalankan semua cmdlet kueri yang tersedia dari keluarga modul GenXdev.Queries.
...
| `-ClearSession` | SwitchParameter | — | — | Named | — | Hapus sesi browser sebelum membuka. |
| `-SkipSession` | SwitchParameter | — | — | Named | — | Lewati pemulihan sesi browser. |
...
Membuka semua jenis kueri yang memungkinkan untuk "powershell scripting" di monitor default.
...
Membuka semua jenis kueri yang memungkinkan untuk URL GitHub menggunakan alias dan parameter pendek.
...
> Hapus sesi browser sebelum membuka.
...
- [ConvertTo-Uris](https://github.com/genXdev/genXdev/blob/main/Docs/id-ID/ConvertTo-Uris.md)
