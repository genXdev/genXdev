...
> Membuka kueri penelusuran Bing di peramban web.

## Description

Membuka satu atau lebih kueri pencarian Bing di peramban web, menggunakan pengaturan peramban yang dapat dikonfigurasi dan sakelar baris perintah. Fungsi ini menyediakan antarmuka yang komprehensif untuk melakukan pencarian Bing dengan opsi kustomisasi peramban yang luas termasuk penempatan jendela, pemilihan monitor, penjelajahan pribadi, dan otomatisasi penekanan tombol.

Fungsi ini secara otomatis melakukan URL-encoding pada kueri dan memformatnya untuk API pencarian Bing. Ini mendukung semua peramban utama termasuk Edge, Chrome, dan Firefox dengan fitur-fitur seperti penjelajahan pribadi, mode aplikasi, manajemen jendela yang presisi, dan otomatisasi penekanan tombol.
...
Membuka pencarian Bing untuk "PowerShell scripting" pada monitor default.
...
Membuka pencarian Bing menggunakan alias dan nama parameter pendek.
...
Membuka sesi penjelajahan pribadi untuk mencari "machine learning" dengan hasil bahasa Inggris.
...
Melakukan pencarian untuk beberapa istilah melalui pipeline dan membuka hasil di semua peramban yang terinstal, memposisikan jendela di sisi kiri layar.
