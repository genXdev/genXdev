...
> Membuka kueri situs web BuiltWith di peramban web.

## Description

Membuka kueri BuiltWith di peramban web, dengan pengaturan monitor yang dapat dikonfigurasi dan opsi perilaku peramban. Fungsi ini menganalisis tumpukan teknologi situs web dengan menanyakan layanan profil teknologi BuiltWith.com, yang menyediakan informasi mendetail tentang teknologi web, kerangka kerja, dan layanan yang digunakan oleh situs web.

BuiltWith.com adalah layanan pencarian teknologi komprehensif yang mengidentifikasi teknologi web, kerangka kerja, sistem manajemen konten, alat analitik, penyedia hosting, dan komponen perangkat lunak lain yang digunakan oleh situs web mana pun. Fungsi ini menyediakan antarmuka PowerShell untuk menganalisis tumpukan teknologi dengan cepat tanpa perlu menavigasi secara manual ke situs web BuiltWith.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Queries` | String[] | ✅ | ✅ (ByValue, ByPropertyName) | 0 | — | URL atau domain situs web yang akan ditanyakan di BuiltWith.com |
| `-Language` | String | — | — | 1 | — | Bahasa dari hasil pencarian yang dikembalikan |
| `-Monitor` | Int32 | — | — | 2 | `-1` | Monitor yang digunakan, 0 = default, -1 = dibuang, -2 = Monitor sekunder yang dikonfigurasi, default ke -1, tanpa posisi |
...
Membuka analisis teknologi BuiltWith untuk Microsoft.com di monitor default.
...
Menganalisis Microsoft.com menggunakan input pipeline dengan penempatan monitor yang dibuang.

## Parameter Details

### `-Queries <String[]>`

> URL atau domain situs web yang akan ditanyakan di BuiltWith.com
