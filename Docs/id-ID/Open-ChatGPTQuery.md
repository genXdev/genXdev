...
> Membuka kueri ChatGPT di peramban web.

## Description

Membuka ChatGPT di peramban web, secara otomatis memasukkan kueri yang ditentukan dan mengirimkannya. Mendukung beberapa kueri yang akan dieksekusi menggunakan fungsi Open-WebsiteAndPerformQuery yang mendasarinya. Fungsi ini menyediakan cara yang nyaman untuk berinteraksi dengan ChatGPT OpenAI dari PowerShell dengan opsi konfigurasi peramban yang ekstensif.
...
| `-ShowWindow` | SwitchParameter | — | — | Named | — | Tampilkan jendela browser |
...
Kirim beberapa kueri menggunakan nama parameter lengkap.
...
Kirim kueri menggunakan alias dan pipeline.
