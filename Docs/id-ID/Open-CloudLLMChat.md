...
> Membuka antarmuka obrolan LLM cloud untuk kueri AI.

## Description

Fungsi ini menyediakan antarmuka terpadu untuk membuka berbagai layanan obrolan AI berbasis cloud di browser web. Fungsi ini mendukung beberapa platform AI termasuk ChatGPT, BingCopilot, Google Gemini, X Grok, DeepSearch, dan GitHub Copilot. Fungsi ini secara otomatis memilih fungsi khusus titik akhir yang sesuai dan meneruskan semua parameter yang relevan untuk konfigurasi browser dan penentuan posisi jendela.
...
| `-EndPoint` | String | — | — | 1 | `'XGrok'` | Titik akhir untuk menjalankan kueri |
...
Membuka ChatGPT dan mengirimkan pertanyaan tentang fungsi PowerShell.
...
Menggunakan alias untuk bertanya kepada Google Gemini tentang machine learning.
...
Memproses beberapa kueri melalui X Grok pada monitor default.
