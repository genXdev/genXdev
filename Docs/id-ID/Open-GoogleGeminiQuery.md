...
> Membuka kueri Google Gemini di peramban web

## Description

Membuka kueri Google Gemini di peramban web, secara otomatis memasukkan kueri dan mengirimkannya. Ini menyediakan cara cepat untuk berinteraksi dengan AI Gemini Google. Fungsi ini mendukung kontrol peramban yang ekstensif termasuk pemilihan monitor, penentuan posisi jendela, dan fitur otomatisasi keyboard.
...
Membuka Google Gemini dan mengirimkan kueri "Apa itu PowerShell?".
...
Menggunakan alias untuk mengirimkan kueri tentang array melalui input pipeline.
