...
> Membuka kueri Google di browser web dengan pengaturan yang dapat dikonfigurasi dan opsi kustomisasi yang ekstensif.

## Description

Membuka satu atau lebih kueri Google di browser web dengan dukungan komprehensif untuk banyak bahasa, pemilihan monitor, penentuan posisi jendela, pemilihan browser, dan otomatisasi keyboard. Fungsi ini menyediakan antarmuka kaya fitur untuk melakukan pencarian Google dengan kontrol yang presisi atas perilaku dan tampilan browser.

Fitur utama meliputi:
- Dukungan untuk 100+ bahasa melalui pemfilteran bahasa Google
- Dukungan multi-monitor dengan pemilihan monitor otomatis atau manual
- Penentuan posisi jendela (kiri, kanan, atas, bawah, tengah, layar penuh)
...
- Pemrosesan kueri batch dengan dukungan pipa
- Otomatisasi penekanan tombol ke jendela browser
- Parameter pintar yang diteruskan ke fungsi browser yang mendasarinya

Fungsi ini secara otomatis memformat kueri pencarian untuk mesin pencari Google dan menerapkan pemfilteran bahasa saat ditentukan. Semua fitur penentuan posisi dan manajemen browser diwarisi dari fungsi Open-Webbrowser yang mendasarinya.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Queries` | String[] | ✅ | ✅ (ByValue, ByPropertyName) | 0 | — | Istilah pencarian untuk ditanyakan di Google |
| `-Language` | String | — | — | 1 | — | Bahasa untuk hasil pencarian Google |
...
Membuka pencarian Google untuk "PowerShell scripting" dalam bahasa Inggris di monitor utama.
...
Membuka pencarian Google untuk "algoritma pembelajaran mesin" dalam mode layar penuh di monitor 2 menggunakan alias.
...
Membuka beberapa pencarian Google di Chrome melalui input pipeline, masing-masing dalam bahasa Inggris.
...
Membuka pencarian pribadi untuk "kecerdasan buatan" di jendela baru.
...
Membuka pencarian dalam mode aplikasi (tanpa kontrol browser) yang terpusat di layar.

## Parameter Details

### `-Queries <String[]>`

> Istilah pencarian untuk ditanyakan di Google
...
> Bahasa untuk hasil pencarian Google
