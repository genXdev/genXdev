...
> Membuka kueri Grokipedia di peramban web.

## Description

Membuka satu atau lebih kueri pencarian Grokipedia di peramban web dengan opsi konfigurasi yang ekstensif. Mendukung perilaku peramban yang dapat dikonfigurasi, pemilihan monitor, dan penentuan posisi jendela. Kueri dienkode URL dan dibuka menggunakan domain Grokipedia bahasa yang ditentukan dengan dukungan lokalisasi penuh.

Fungsi ini menyediakan kontrol peramban yang komprehensif termasuk mode penjelajahan pribadi, penentuan posisi jendela, otomatisasi keyboard, dan dukungan multi-monitor. Secara otomatis menangani enkode URL dan pemetaan kode bahasa untuk domain Grokipedia internasional.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Queries` | String[] | ✅ | ✅ (ByValue, ByPropertyName) | 0 | — | Kueri pencarian Grokipedia yang akan dijalankan |
...
Membuka pencarian Grokipedia untuk "PowerShell" dalam bahasa Inggris di monitor default.
...
Membuka pencarian Grokipedia menggunakan alias dengan parameter posisional.
...
Mencari beberapa istilah di Grokipedia menggunakan mode penjelajahan pribadi.

## Parameter Details

### `-Queries <String[]>`

> Kueri pencarian Grokipedia yang akan dijalankan
