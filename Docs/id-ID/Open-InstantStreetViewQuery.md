...
> Membuka kueri InstantStreetView di peramban web.

## Description

Membuka kueri InstantStreetView dengan cara yang dapat dikonfigurasi menggunakan sakelar baris perintah browser web. Mendukung beberapa kueri dan pemilihan monitor. Menyediakan kontrol browser yang komprehensif termasuk penentuan posisi jendela, pengaturan bahasa, dan fitur khusus browser.

Fungsi ini secara otomatis membuat URL InstantStreetView dengan menyandikan URL kueri lokasi dan membukanya di browser yang ditentukan. Mendukung semua browser utama termasuk Edge, Chrome, dan Firefox dengan opsi kustomisasi yang ekstensif.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Queries` | String[] | ✅ | ✅ (ByValue, ByPropertyName) | 0 | — | Kueri lokasi untuk dilihat di InstantStreetView |
...
| `-Monitor` | Int32 | — | — | Named | `-1` | Monitor yang digunakan, 0 = default, -1 = dibuang, -2 = Monitor sekunder yang dikonfigurasi, default ke $Global:DefaultSecondaryMonitor atau 2 jika tidak ditemukan |
...
Membuka InstantStreetView untuk Times Square di browser default pada monitor utama.
...
Membuka InstantStreetView untuk Menara Eiffel menggunakan alias 'isv' dan menampilkan di monitor sekunder.
...
Membuka InstantStreetView untuk Big Ben dalam bahasa Inggris menggunakan mode penjelajahan pribadi.
...
Membuka beberapa kueri InstantStreetView melalui pipeline di browser Chrome yang diposisikan di sisi kiri layar.

## Parameter Details

### `-Queries <String[]>`

> Kueri lokasi untuk dilihat di InstantStreetView
