...
> Memulai browser yang dikelola oleh Playwright dengan profil pengguna yang persisten.
...
Meluncurkan instance browser yang didukung oleh Playwright. Parameter BrowserType menentukan mesin browser dan mode peluncuran yang digunakan:

- ChromeNormal / EdgeNormal: Meluncurkan Chrome atau Edge yang terinstal di OS Anda melalui Channel API Playwright, menghindari bilah info "dikendalikan oleh otomatisasi" dan masalah deteksi anti-bot.
- ChromiumNormal: Mendeteksi secara otomatis Chrome atau Edge (mana yang terinstal dan diatur sebagai default sistem) dan menggunakan Channel API. Jatuh kembali ke Chromium Playwright bawaan jika tidak ada yang terinstal.
- ChromiumPlaywright: Selalu menggunakan biner Chromium bawaan Playwright (bukan browser yang terinstal di OS).
- FirefoxPlaywright: Menggunakan biner Firefox bawaan Playwright. Channel API tidak tersedia untuk Firefox di binding Playwright .NET.
- WebKitPlaywright: Menggunakan biner WebKit bawaan Playwright.

Tindakan anti-deteksi yang diterapkan untuk browser berbasis Chromium:
- Menonaktifkan flag otomatisasi blink (menghapus bilah info)
- Mengatur viewport ke null dan memulai dalam mode maksimal untuk ukuran jendela asli
- Menggunakan skema warna 'no-preference' untuk menghindari latar belakang putih
- Mengatur argumen browser standar (no-first-run, no-default-browser-check)

Profil persisten per BrowserType disimpan di bawah GenXdev AppData.
Browser yang diluncurkan beserta konteks/halamannya disimpan di $Global:GenXdevPlaywright untuk digunakan oleh cmdlet lain.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-BrowserType` | String | — | — | 0 | `'ChromiumNormal'` | Browser yang akan diluncurkan: Chrome, Edge, Chromium (mendeteksi otomatis Chrome atau Edge), Firefox, atau WebKit |
| `-Headless` | SwitchParameter | — | — | Named | — | Jalankan peramban tanpa jendela yang terlihat |
| `-Proxy` | String | — | — | Named | — | URL server proksi (misalnya http://proxy:8080) |
| `-AcceptLang` | String | — | — | Named | — | Mengatur header HTTP Accept-Language peramban |
| `-Width` | Int32 | — | — | Named | `-1` | Lebar viewport awal dalam piksel |
| `-Height` | Int32 | — | — | Named | `-1` | Tinggi area pandang awal dalam piksel |
| `-Force` | SwitchParameter | — | — | Named | — | Tutup browser yang ada dan mulai yang baru |
...
| `-Fullscreen` | SwitchParameter | — | — | Named | — | Memaksimalkan jendela untuk mengisi seluruh layar |
...
| `-PassThru` | SwitchParameter | — | — | Named | — | Mengembalikan objek pembantu jendela untuk manipulasi lebih lanjut |
...
> Browser yang akan diluncurkan: Chrome, Edge, Chromium (mendeteksi otomatis Chrome atau Edge), Firefox, atau WebKit
...
> URL server proksi (misalnya http://proxy:8080)
...
> Mengatur header HTTP Accept-Language peramban
...
> Lebar viewport awal dalam piksel
...
> Tinggi area pandang awal dalam piksel
...
> Tutup browser yang ada dan mulai yang baru
...
> Memaksimalkan jendela untuk mengisi seluruh layar
...
> Mengembalikan objek pembantu jendela untuk manipulasi lebih lanjut
