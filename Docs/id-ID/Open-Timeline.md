...
| `-BrowserExtensions` | SwitchParameter | — | — | Named | — | Jangan mencegah pemuatan ekstensi peramban |
...
| `-Language` | String | — | — | 1 | — | Mengganti bahasa default browser, atau pilih [Semua] untuk rotasi semua bahasa setiap menit |
| `-DragedNodeBackground` | String | — | — | Named | `$null` | Timpa css-color-style untuk mewarnai latar belakang node yang sedang diseret saat ini |
| `-FocusedNodeBackground` | String | — | — | Named | `$null` | Timpa gaya css-color untuk mewarnai latar belakang node yang fokus (di tengah) |
| `-FocusedNodeForeground` | String | — | — | Named | `$null` | Timpa css-color-style untuk mewarnai teks latar depan dari node yang difokuskan (di tengah) |
| `-UnFocusedNodeBackground` | String | — | — | Named | `$null` | Timpa gaya css-color untuk mewarnai latar belakang node yang fokus (di tengah) |
| `-UnFocusedNodeForeground` | String | — | — | Named | `$null` | Timpa css-color-style untuk mewarnai teks latar depan node yang tidak terfokus (di tengah) |
| `-BorderLightColor` | String | — | — | Named | `$null` | Timpa warna default css border-light-color |
| `-BorderDarkColor` | String | — | — | Named | `$null` | Timpa gaya warna border-dark-color default CSS |
| `-BorderWidth` | Int32 | — | — | Named | `1` | Menimpa lebar default untuk menggambar batas simpul |
| `-RotationDelaySeconds` | Int32 | — | — | Named | `15` | Menimpa lebar default untuk penundaan rotasi latar belakang |
