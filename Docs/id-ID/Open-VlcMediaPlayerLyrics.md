...
> Membuka peramban web untuk mencari lirik dari media VLC yang sedang diputar.

## Description

Fungsi ini mendeteksi apakah VLC Media Player sedang berjalan dan mencari lirik berdasarkan judul media yang sedang diputar. Fungsi ini secara otomatis membuka kueri pencarian di peramban web untuk menemukan lirik lagu saat ini. Fungsi ini mendukung beberapa peramban dan menyediakan opsi penempatan jendela serta tampilan yang ekstensif.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Queries` | String[] | — | ✅ (ByValue, ByPropertyName) 🌐 Remaining | 0 | — | Istilah pencarian untuk menemukan trek |
| `-EndPoint` | String | — | — | 1 | `'Google'` | Titik akhir untuk memanggil kueri |
...
| `-SessionOnly` | SwitchParameter | — | — | Named | — | Gunakan sesi yang tidak dipertahankan setelah menutup browser |
| `-ClearSession` | SwitchParameter | — | — | Named | — | Hapus data sesi browser sebelum membuka browser |
| `-SkipSession` | SwitchParameter | — | — | Named | — | Lewati penggunaan sesi peramban yang ada |
...
Membuka pencarian Google untuk lirik dari pemutaran VLC saat ini.
...
Membuka pencarian lirik di Microsoft Edge menggunakan mode privat/penyamaran.

## Parameter Details

### `-Queries <String[]>`

> Istilah pencarian untuk menemukan trek
...
> Titik akhir untuk memanggil kueri
...
> Gunakan sesi yang tidak dipertahankan setelah menutup browser
...
> Hapus data sesi browser sebelum membuka browser
...
> Lewati penggunaan sesi peramban yang ada
