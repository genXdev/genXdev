...
| `-Language` | String | — | — | 1 | — | Preferensi bahasa untuk antarmuka dan konten browser |
...
| `-SessionOnly` | SwitchParameter | — | — | Named | — | Gunakan pengaturan alternatif yang disimpan dalam sesi untuk preferensi Wayback Machine |
| `-ClearSession` | SwitchParameter | — | — | Named | — | Hapus pengaturan alternatif yang tersimpan dalam sesi untuk preferensi Wayback Machine |
