...
> Membuka halaman web di browser web dan melakukan satu atau lebih kueri.

## Description

Fungsi ini membuka situs web berdasarkan URL di peramban web default, memasukkan satu atau lebih kueri, dan mengirimkannya. Fungsi ini mendukung pemilihan monitor yang ekstensif dan opsi penempatan jendela melalui fungsi Open-Webbrowser yang mendasarinya.

Fungsi ini secara otomatis menyalin setiap kueri ke clipboard dan mengirimkannya ke jendela peramban menggunakan otomatisasi keyboard. Fungsi ini menyimpan konten clipboard asli dan memulihkannya setelah semua kueri diproses.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Url` | String | ✅ | ✅ (ByPropertyName) | 0 | — | URL situs web yang akan dibuka |
...
| `-SendKeyDelayMilliSeconds` | Int32 | — | — | Named | `500` | Penundaan antara pengiriman urutan tombol yang berbeda dalam milidetik |
...
Membuka Google dan mencari "PowerShell".
...
Membuka Google dan mencari "tutorial PowerShell" di monitor default.

## Parameter Details

### `-Url <String>`

> URL situs web yang akan dibuka
