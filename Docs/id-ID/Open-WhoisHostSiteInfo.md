...
> Membuka kueri informasi host Whois di peramban web.

## Description

Membuka kueri informasi host Whois di browser web untuk nama domain atau alamat IP. Mendukung pemilihan monitor yang dapat dikonfigurasi dan beberapa kueri dengan opsi konfigurasi browser yang ekstensif termasuk penentuan posisi jendela, pemilihan browser, dan fitur otomatisasi.
...
| `-ClearSession` | SwitchParameter | — | — | Named | — | Hapus pengaturan alternatif yang disimpan dalam sesi untuk preferensi AI seperti Bahasa, koleksi Gambar, dll. |
| `-SkipSession` | SwitchParameter | — | — | Named | — | Simpan pengaturan hanya di preferensi persisten tanpa mempengaruhi sesi untuk preferensi AI seperti Bahasa, Koleksi gambar, dll. |
...
Membuka informasi Whois untuk beberapa domain di monitor default.
...
Membuka informasi Whois untuk example.com menggunakan alias dan parameter posisi.
...
Membuka informasi Whois untuk domain dari alur dalam mode privat Chrome.
...
> Hapus pengaturan alternatif yang disimpan dalam sesi untuk preferensi AI seperti Bahasa, koleksi Gambar, dll.
...
> Simpan pengaturan hanya di preferensi persisten tanpa mempengaruhi sesi untuk preferensi AI seperti Bahasa, Koleksi gambar, dll.
