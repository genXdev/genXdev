...
> Membuka pencarian Wikipedia Belanda di peramban web.

## Description

Membuka kueri 'Wikipedia - Belanda' di peramban web, dengan opsi tampilan yang dapat dikonfigurasi. Mendukung pencarian beberapa istilah dan menentukan monitor mana untuk menampilkan hasil.
...
| `-SideBySide` | SwitchParameter | — | — | Named | — | Membuka dua jendela browser secara berdampingan |
| `-SessionOnly` | SwitchParameter | — | — | Named | — | Gunakan cookie sesi saja (tanpa cookie persisten) |
| `-ClearSession` | SwitchParameter | — | — | Named | — | Hapus data sesi browser sebelum membuka |
| `-SkipSession` | SwitchParameter | — | — | Named | — | Lewati pemulihan sesi browser sebelumnya |
...
> Membuka dua jendela browser secara berdampingan
...
> Gunakan cookie sesi saja (tanpa cookie persisten)
...
> Hapus data sesi browser sebelum membuka
...
> Lewati pemulihan sesi browser sebelumnya
