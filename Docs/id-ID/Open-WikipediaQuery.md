...
> Membuka kueri Wikipedia di peramban web.

## Description

Membuka satu atau lebih kueri pencarian Wikipedia di peramban web dengan opsi konfigurasi yang ekstensif. Mendukung perilaku peramban yang dapat dikonfigurasi, pemilihan monitor, dan penentuan posisi jendela. Kueri dienkode URL dan dibuka menggunakan domain Wikipedia bahasa yang ditentukan dengan dukungan lokalisasi penuh.

Fungsi ini menyediakan kontrol peramban yang komprehensif termasuk mode penjelajahan pribadi, penentuan posisi jendela, otomatisasi keyboard, dan dukungan multi-monitor. Secara otomatis menangani enkode URL dan pemetaan kode bahasa untuk domain Wikipedia internasional.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Queries` | String[] | ✅ | ✅ (ByValue, ByPropertyName) | 0 | — | Kueri pencarian Wikipedia yang akan dijalankan |
| `-Language` | String | — | — | 1 | — | Bahasa dari hasil pencarian Wikipedia |
...
| `-PassThru` | SwitchParameter | — | — | Named | — | Mengembalikan objek proses PowerShell yang mewakili proses browser |
...
Membuka pencarian Wikipedia untuk "PowerShell" dalam bahasa Inggris di monitor bawaan.
...
Membuka pencarian Wikipedia menggunakan alias dengan parameter posisi.
...
Mencari beberapa istilah di Wikipedia Jerman menggunakan mode penjelajahan pribadi.

## Parameter Details

### `-Queries <String[]>`

> Kueri pencarian Wikipedia yang akan dijalankan
...
> Bahasa dari hasil pencarian Wikipedia
...
> Mengembalikan objek proses PowerShell yang mewakili proses browser
