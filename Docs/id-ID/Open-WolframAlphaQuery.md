...
> Membuka kueri Wolfram Alpha di peramban web.

## Description

Membuka satu atau lebih kueri Wolfram Alpha di peramban web. Mendukung pemilihan monitor yang dapat dikonfigurasi dan opsi peramban melalui parameter dinamis. Menyediakan kontrol peramban yang komprehensif termasuk penentuan posisi, ukuran, dan kemampuan otomatisasi untuk meningkatkan alur kerja komputasi ilmiah.
...
| `-SendKeyEscape` | SwitchParameter | — | — | Named | — | Loloskan karakter kontrol saat mengirimkan tombol. |
...
| `-SendKeyUseShiftEnter` | SwitchParameter | — | — | Named | — | Kirim Shift+Enter sebagai pengganti Enter biasa untuk membuat jeda baris saat mengirim tombol. |
...
Membuka kueri Wolfram Alpha untuk massa matahari di monitor default.
...
Membuka beberapa kueri Wolfram Alpha menggunakan alias untuk komputasi ilmiah cepat.
...
Membuka kueri kalkulus dalam mode layar penuh dengan preferensi bahasa Inggris melalui input pipeline.
...
> Kirim Shift+Enter sebagai pengganti Enter biasa untuk membuat jeda baris saat mengirim tombol.
