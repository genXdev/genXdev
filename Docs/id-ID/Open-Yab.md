...
> Membuka game YAB di peramban web dengan pengaturan yang dapat dikonfigurasi.

## Description

Membuka situs web game YAB di browser yang ditentukan dengan berbagai opsi tampilan dan perilaku. Mendukung mode permainan yang berbeda termasuk mode penonton. Game YAB adalah game puzzle online yang dapat dimainkan secara interaktif atau ditonton dalam mode penonton di mana AI bermain secara otomatis.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Language` | String | — | — | 0 | — | Bahasa antarmuka permainan |
...
| `-SpectateOnly` | SwitchParameter | — | — | Named | — | Jangan memulai permainan baru, hanya tonton AI bermain |
...
Membuka game YAB dalam mode penonton menggunakan browser Chrome tanpa layar penuh,
dengan antarmuka bahasa Inggris.
...
Membuka game YAB di browser Edge dengan penjelajahan pribadi di monitor 2 menggunakan alias untuk akses cepat.

## Parameter Details

### `-Language <String>`

> Bahasa antarmuka permainan
