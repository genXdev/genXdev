...
> Membuka kueri pencarian YouTube di peramban web.

## Description

Membuka satu atau lebih kueri pencarian YouTube di peramban web dengan opsi penempatan dan konfigurasi yang ekstensif. Mendukung pemilihan monitor yang dapat dikonfigurasi, pengaturan peramban, dan otomatisasi penekanan tombol melalui parameter dinamis yang diwarisi dari cmdlet Open-Webbrowser. Setiap kueri dibuka dalam instans peramban terpisah dengan kontrol penuh atas penempatan jendela, jenis peramban, dan bahasa pencarian.
...
Membuka pencarian YouTube untuk "tutorial PowerShell" pada monitor default.
...
Membuka pencarian YouTube untuk "cara coding" di monitor sekunder yang dikonfigurasi menggunakan alias fungsi.
