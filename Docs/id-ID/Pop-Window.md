...
> Menghapus pembantu jendela aktif terakhir dari tumpukan dengan modifikasi opsional.

## Description

Mengambil jendela pembantu dari tumpukan dan secara opsional menerapkan transformasi jendela. Jika tumpukan kosong atau berisi jendela yang tidak valid, mengembalikan jendela yang sedang difokuskan. Fungsi ini memungkinkan Anda memanipulasi jendela yang sebelumnya disimpan dengan Push-Window, dengan menerapkan berbagai efek penempatan, ukuran, dan visual.
