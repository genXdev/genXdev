...
> Menghapus set refaktor dari sistem preferensi GenXdev.

## Description

Mengelola set refaktor dalam sistem preferensi GenXdev dengan menghapus entri yang ditentukan. Bekerja dengan set refaktor kustom dan default. Set default dilindungi kecuali diizinkan secara eksplisit untuk dihapus. Semua set refaktor diidentifikasi dengan awalan "refactor_set_" dalam sistem preferensi.
...
| `-RemoveDefault` | SwitchParameter | — | — | Named | — | Beralih juga untuk menghapus set refaktor standar |
| `-PreferencesDatabasePath` | String | — | — | Named | — | Jalur database untuk file data preferensi |
| `-DefaultValue` | String | — | ✅ (ByPropertyName) | Named | — | Nilai default jika preferensi tidak ditemukan |
| `-SessionOnly` | SwitchParameter | — | — | Named | — | Gunakan pengaturan alternatif yang disimpan dalam sesi untuk preferensi Data seperti Bahasa, jalur Database, dll. |
| `-ClearSession` | SwitchParameter | — | — | Named | — | Hapus pengaturan sesi (Variabel global) sebelum mengambil |
| `-SkipSession` | SwitchParameter | — | — | Named | — | Jangan gunakan pengaturan alternatif yang disimpan dalam sesi untuk preferensi Data seperti Bahasa, jalur Database, dll |
...
> Beralih juga untuk menghapus set refaktor standar
