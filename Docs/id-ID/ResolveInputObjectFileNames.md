...
> Memperluas objek masukan menjadi nama file dan direktori, mendukung berbagai filter dan opsi keluaran.

## Description

Fungsi ini memproses objek input (file, direktori, atau koleksi)
dan memperluasnya menjadi nama file dan direktori. Ini mendukung pemfilteran,
pencocokan pola, dan dapat menampilkan hasil sebagai objek. Fungsi ini
dirancang untuk bekerja dengan input pipeline dan menyediakan opsi untuk rekursi,
aliran data alternatif, dan lainnya.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-InputObject` | Object | — | ✅ (ByValue, ByPropertyName) | 0 | — | Objek input yang berisi nama file atau direktori |
| `-File` | SwitchParameter | — | — | Named | — | .SYNOPSIS
    Membantu mengelola perangkat melalui koneksi SSH.
.DESCRIPTION
    Cmdlet ini memungkinkan Anda untuk mengelola perangkat dari jarak jauh menggunakan protokol Secure Shell (SSH). Anda dapat menjalankan perintah, mengelola file, dan mengotomatiskan tugas pada perangkat jarak jauh yang mendukung SSH.

    Cmdlet ini mendukung otentikasi kata sandi, otentikasi kunci publik, dan berbagai opsi konfigurasi lainnya untuk menyesuaikan koneksi SSH.

    Anda dapat menggunakan cmdlet ini untuk mengelola server Linux, sakelar jaringan, dan perangkat lain yang mendukung SSH. |
| `-Pattern` | String | — | — | 1 | — | Pola ekspresi reguler untuk mencari dalam konten *(Parameter set: )* 🌐 *Supports wildcards* |
...
| `-Directory` | SwitchParameter | — | — | Named | — | Cari hanya direktori *(Parameter set: )* |
| `-FilesAndDirectories` | SwitchParameter | — | — | Named | — | Sertakan file dan direktori *(Parameter set: )* |
...
> Objek input yang berisi nama file atau direktori
