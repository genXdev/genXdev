...
| `-OnlyPublished` | SwitchParameter | — | — | Named | — | Batasi pencarian hanya ke jalur modul yang dipublikasikan |
| `-FromScripts` | SwitchParameter | — | — | Named | — | Cari di file skrip, bukan file modul |
| `-Code` | SwitchParameter | — | — | Named | — | Buka cmdlet yang ditemukan di Visual Studio Code |
| `-VisualStudio` | SwitchParameter | — | — | Named | — | Buka cmdlet yang ditemukan di Visual Studio |
| `-EditCmdlet` | SwitchParameter | — | — | Named | — | Juga membuka file di editor setelah ditemukan |
