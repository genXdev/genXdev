...
> Mengirimkan paket ajaib Wake-on-LAN untuk membangunkan komputer jarak jauh di jaringan.

## Description

Membangun dan menyiarkan paket ajaib Wake-on-LAN (WOL) ke alamat MAC yang ditentukan. Paket ajaib adalah siaran UDP yang berisi alamat MAC target yang diulang 16 kali, yang memicu antarmuka jaringan yang didukung untuk menyalakan komputer. Mendukung alamat siaran dan port kustom.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-MacAddress` | String[] | ✅ | ✅ (ByValue, ByPropertyName) | 0 | — | Satu atau lebih alamat MAC untuk mengirim paket ajaib (misalnya, 00:11:22:33:44:55) |
| `-BroadcastAddress` | String | — | — | 1 | `"255.255.255.255"` | Alamat IP siaran untuk mengirim magic packet (default: 255.255.255.255) |
| `-Port` | Int32 | — | — | 2 | `4000` | Port UDP untuk mengirim paket ajaib (default: 4000) |
...
Mengirim paket ajaib untuk menyalakan komputer dengan alamat MAC yang ditentukan.
...
Mengirim paket ajaib ke beberapa komputer di port 9 melalui input pipeline.

## Parameter Details

### `-MacAddress <String[]>`

> Satu atau lebih alamat MAC untuk mengirim paket ajaib (misalnya, 00:11:22:33:44:55)
...
> Alamat IP siaran untuk mengirim magic packet (default: 255.255.255.255)
...
> Port UDP untuk mengirim paket ajaib (default: 4000)
