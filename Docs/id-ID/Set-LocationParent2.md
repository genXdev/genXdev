...
> Menavigasi naik dua tingkat direktori dalam hierarki sistem file.

## Description

* Mengubah direktori kerja saat ini ke direktori kakek (dua tingkat ke atas).
* Menampilkan konten direktori yang dihasilkan.
...
Mengubah ke direktori induk dan menampilkan isinya.
...
Menggunakan alias '...' untuk operasi yang sama.
