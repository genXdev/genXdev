...
> Menavigasi naik tiga tingkat direktori dalam hierarki sistem file.

## Description

* Mengubah direktori kerja saat ini dengan naik tiga direktori induk
  dalam hierarki sistem berkas.
* Menampilkan isi dari direktori hasil.
...
Menavigasi naik tiga tingkat direktori dari lokasi saat ini.
...
Menggunakan alias untuk naik tiga level direktori.
