...
> Navigasi naik lima tingkat direktori dalam hierarki sistem berkas.

## Description

* Mengubah direktori kerja saat ini dengan naik lima level direktori induk.
* Menampilkan isi direktori yang dihasilkan.
* Menyediakan alias singkat yang praktis '......' untuk navigasi cepat.
...
Naik lima level direktori dari lokasi saat ini.
...
Menggunakan alias untuk naik lima tingkat direktori.
