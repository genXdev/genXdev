...
> Menyalakan daya monitor.

## Description

Menggunakan API Windows melalui GenXdev.Helpers.WindowObj untuk membangunkan monitor dari status tidur/mati. Ini berguna untuk skrip otomatisasi yang perlu memastikan monitor dalam keadaan menyala.
...
Menyalakan daya monitor menggunakan alias.
