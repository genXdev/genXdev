...
> Mengonfigurasi perataan bilah tugas Windows 11+ antara posisi tengah dan kiri.

## Description

Mengatur perataan bilah tugas di Windows 11 dan versi yang lebih baru dengan memodifikasi kunci registri 'TaskbarAl' di bawah HKCU:\SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer\Advanced. Perataan dapat diatur ke tengah (nilai 1) atau kiri (nilai 0).
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Justify` | String | ✅ | — | 0 | — | Perataan bilah tugas (Tengah atau Kiri) |
...
> Perataan bilah tugas (Tengah atau Kiri)
