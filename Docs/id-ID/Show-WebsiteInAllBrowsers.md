...
> Membuka URL di beberapa peramban secara bersamaan dalam tata letak mozaik.

## Description

Fungsi ini membuat tata letak mozaik dari jendela browser dengan membuka URL yang ditentukan di Chrome, Edge, Firefox, dan jendela penjelajahan pribadi. Browser-browser tersebut disusun dalam pola grid 2x2:
- Chrome: Kuadran kiri atas
- Edge: Kuadran kiri bawah
- Firefox: Kuadran kanan atas
- Jendela pribadi: Kuadran kanan bawah

Semua parameter dari Open-Webbrowser didukung dan diteruskan untuk mengontrol posisi, perilaku, dan tampilan browser. Fungsi ini bertindak sebagai pembungkus yang menerapkan posisi kuadran yang konsisten sambil memungkinkan kustomisasi penuh dari parameter peluncuran browser.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Url` | String | ✅ | ✅ (ByValue, ByPropertyName) | 0 | — | URL yang akan dibuka di semua browser secara bersamaan |
...
> URL yang akan dibuka di semua browser secara bersamaan
