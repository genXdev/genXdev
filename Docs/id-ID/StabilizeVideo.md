...
> Menstabilkan file .mp4 terbaru atau yang ditentukan menggunakan FFmpeg + vid.stab (tanpa batas hitam).

## Description

Two-pass vid.stab stabilisasi dengan optzoom=1 (zoom/otomatis potong sehingga batas tidak pernah terlihat) ditambah penajaman ringan. Bekerja persis seperti cmdlet Save-Video Anda — sangat sederhana.
