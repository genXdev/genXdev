...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Port` | Int32 | — | — | 0 | `2175` | Port tempat server MCP akan mendengarkan (bawaan: 2175) |
| `-ExposedCmdLets` | GenXdev.Helpers.ExposedCmdletDefinition[] | — | — | 1 | `@()` | Array definisi perintah PowerShell untuk diekspos sebagai alat MCP |
| `-NoConfirmationToolFunctionNames` | String[] | — | — | 2 | `@()` | Array nama perintah yang dapat dieksekusi tanpa konfirmasi pengguna |
| `-StopExisting` | SwitchParameter | — | — | Named | — | Hentikan server MCP yang sudah berjalan pada port yang ditentukan sebelum memulai yang baru |
| `-MaxOutputLength` | Int32 | — | — | 3 | `75000` | Panjang maksimum keluaran alat dalam karakter sebelum dipotong (default: 75000) |
| `-Token` | String | — | — | 4 | `$null` | Token autentikasi diperlukan agar klien dapat terhubung ke server MCP |

## Parameter Details

### `-Port <Int32>`

> Port tempat server MCP akan mendengarkan (bawaan: 2175)
...
> Array definisi perintah PowerShell untuk diekspos sebagai alat MCP
...
> Array nama perintah yang dapat dieksekusi tanpa konfirmasi pengguna
...
> Hentikan server MCP yang sudah berjalan pada port yang ditentukan sebelum memulai yang baru
...
> Panjang maksimum keluaran alat dalam karakter sebelum dipotong (default: 75000)
...
> Token autentikasi diperlukan agar klien dapat terhubung ke server MCP
