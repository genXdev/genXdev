...
> Menjeda pemutaran video di semua sesi browser yang aktif.

## Description

Mengiterasi semua sesi browser yang aktif dan menjeda video yang sedang diputar dengan mengeksekusi perintah JavaScript. Fungsi ini mempertahankan status sesi asli dan menangani kesalahan dengan baik.
