...
> Menghapus semua wajah yang terdaftar dari sistem pengenalan wajah DeepStack.

## Description

Fungsi ini menghapus semua wajah yang terdaftar dari database pengenalan wajah DeepStack dengan menghapus semua file wajah dari direktori penyimpanan data dan memulai ulang layanan untuk memuat ulang registrasi wajah yang kosong. Ini adalah operasi destruktif yang tidak dapat dibatalkan dan akan menghapus semua data wajah yang terdaftar secara permanen.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Force` | SwitchParameter | — | — | Named | — | Melewati prompt konfirmasi saat menghapus semua wajah yang terdaftar |
...
Menghapus semua wajah yang terdaftar dengan prompt konfirmasi.
...
Menghapus semua wajah yang terdaftar tanpa prompt konfirmasi.
...
Menggunakan alias untuk menghapus semua wajah tanpa konfirmasi.

## Parameter Details

### `-Force`

> Melewati prompt konfirmasi saat menghapus semua wajah yang terdaftar
