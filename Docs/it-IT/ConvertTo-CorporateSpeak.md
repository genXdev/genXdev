...
> Converte testi diretti o bruschi in un linguaggio aziendale educato e professionale utilizzando l'IA.

## Description

Questa funzione elabora il testo in input per trasformare un linguaggio diretto o potenzialmente duro in comunicazioni aziendali diplomatiche e professionali. Può accettare input direttamente tramite parametri, dalla pipeline o dagli appunti di sistema. La funzione sfrutta modelli di intelligenza artificiale per analizzare e riformulare il testo preservando l'intento originale.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Text` | String | — | ✅ (ByValue) | 0 | — | Il testo da convertire in linguaggio aziendale |
...
> Il testo da convertire in linguaggio aziendale
