...
> Converte testi diretti o bruschi in un linguaggio diplomatico, educato e discreto.

## Description

Questa funzione trasforma l'input dell'utente da una formulazione diretta o brusca in un linguaggio diplomatico, discreto, adatto a discussioni di alto livello, negoziazioni o comunicazioni formali. La funzione utilizza modelli linguistici AI per mantenere l'intento originale mentre ammorbidisce il tono e rende il messaggio più diplomatico e professionale.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Text` | String | — | ✅ (ByValue) | 0 | — | Il testo da convertire in linguaggio diplomatico |
...
> Il testo da convertire in linguaggio diplomatico
