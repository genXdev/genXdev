...
> Verifica se l'utente corrente dispone di privilegi elevati.

## Description

Determina se l'utente Windows corrente dispone di privilegi amministrativi o di operatore di backup verificando i ruoli dell'entità di sicurezza. Restituisce true se l'utente ha diritti elevati, false in caso contrario. Implementa una gestione robusta degli errori per problemi relativi alla sicurezza e all'accesso.
