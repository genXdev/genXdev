...
> Recupera un elenco di nomi utente univoci dai processi di sistema attualmente attivi.

## Description

Interroga tutti i processi in esecuzione sul sistema, estrae il nome utente associato a ciascun processo e restituisce un elenco deduplicato degli utenti che hanno processi attivi. Questo è utile per l'amministrazione di sistema e il monitoraggio della sicurezza.
