...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-VelocityInMetersPerSecond` | Double | ✅ | — | 0 | `0` | Velocità in m/s |
| `-RadiusInMeters` | Double | ✅ | — | 1 | `0` | Raggio in metri |
| `-As` | String | — | — | 2 | — | Unità di output per l'accelerazione |
...
Calcola l'accelerazione centripeta per velocità 10 m/s e raggio 5 m, output in unità g.
...
Calcola l'accelerazione centripeta per velocità 20 m/s e raggio 10 m utilizzando parametri posizionali.
...
> Unità di output per l'accelerazione
