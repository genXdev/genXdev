...
> Calcola la velocità di fuga.

## Description

Utilizza v = sqrt(2 G M / r).
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-MassInKilograms` | Double | ✅ | — | 0 | `0` | Massa del corpo in kg |
...
Calcola la velocità di fuga per un corpo con massa e raggio terrestri.
...
Calcola la velocità di fuga utilizzando le unità predefinite m/s.
