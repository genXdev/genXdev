...
> Mostra le funzionalità di un file README.md.

## Description

Mostra tutte le funzionalità dalla sezione "## Features" di un file README.md. Può utilizzare il README nella posizione corrente, nella directory del profilo PowerShell o nella directory OneDrive.
