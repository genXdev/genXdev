...
> Recupera i moduli GenXDev in ordine di dipendenza.

## Description

Questa funzione restituisce un elenco di moduli GenXDev disposti nell'ordine corretto delle dipendenze per garantire un caricamento appropriato dei moduli. Recupera prima tutte le informazioni sui moduli e poi li ordina in base alle loro dipendenze, iniziando con i moduli principali e terminando con i moduli dipendenti. Ciò garantisce che i moduli vengano caricati nella sequenza corretta.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-ModuleName` | String[] | — | ✅ (ByValue, ByPropertyName) | 0 | `@('GenXdev*')` | Uno o più nomi di modulo per filtrare |
...
> Uno o più nomi di modulo per filtrare
