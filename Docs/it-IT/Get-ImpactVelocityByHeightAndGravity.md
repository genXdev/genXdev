...
> Calcola la velocità d'impatto a partire dall'altezza.

## Description

Utilizza v = sqrt(2 g h) ignorando la resistenza dell'aria.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-HeightInMeters` | Double | ✅ | — | 0 | `0` | Altezza in metri |
| `-GravityInMetersPerSecondSquared` | Double | — | — | 1 | `0` | Gravità in m/s². Predefinito 9,81. |
| `-As` | String | — | — | 2 | — | Unità di output per la velocità. Predefinito 'm/s'. |
...
Calcola la velocità d'impatto per una caduta di 100 metri e la restituisce in km/h.
...
Calcola la velocità d'impatto per una caduta di 50 metri utilizzando le unità predefinite.
...
> Unità di output per la velocità. Predefinito 'm/s'.
