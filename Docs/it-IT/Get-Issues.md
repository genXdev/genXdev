...
> Mostra i problemi da un file README.md.

## Description

Mostra tutti i problemi dalla sezione "## Issues" di un file README.md. Può utilizzare il README nella posizione corrente, nella directory del profilo PowerShell o nella directory OneDrive.
