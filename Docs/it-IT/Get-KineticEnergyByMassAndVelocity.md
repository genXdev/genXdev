...
| `-VelocityInMetersPerSecond` | Double | ✅ | — | 1 | `0` | Velocità in m/s |
| `-As` | String | — | — | 2 | — | Unità di output per l'energia |
...
Calcola l'energia cinetica per una massa di 10 kg che si muove a 5 m/s e restituisce il risultato in calorie.
...
Calcola l'energia cinetica per una massa di 5 kg che si muove a 10 m/s usando parametri posizionali.
