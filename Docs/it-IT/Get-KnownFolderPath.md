...
> Ottiene il percorso di una cartella conosciuta di Windows utilizzando l'API Shell32 di Windows.

## Description

Recupera il percorso di una cartella conosciuta di Windows specificata utilizzando la funzione SHGetKnownFolderPath dell'API Shell32. Questo metodo è più affidabile rispetto all'uso di variabili d'ambiente poiché funziona in modo coerente tra diverse versioni di Windows e impostazioni linguistiche. Supporta tutte le cartelle conosciute standard di Windows come Documenti, Download, AppData, ecc.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-KnownFolder` | String | ✅ | — | 0 | — | Il nome della cartella nota di Windows per cui ottenere il percorso |
...
> Il nome della cartella nota di Windows per cui ottenere il percorso
