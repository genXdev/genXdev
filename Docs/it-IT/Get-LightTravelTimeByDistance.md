...
> Calcola il tempo impiegato dalla luce per percorrere una distanza.

## Description

Utilizza t = d / c, dove c dipende dal mezzo.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-DistanceInMeters` | Double | ✅ | — | 0 | `0` | Distanza in metri |
| `-SpeedOfLightInMetersPerSecond` | Double | — | — | 1 | `0` | Velocità della luce in m/s (predefinito: 299792458) *(Parameter set: )* |
| `-Medium` | String | ✅ | — | 1 | — | Il mezzo attraverso cui la luce viaggia *(Parameter set: )* |
| `-As` | String | — | — | 2 | — | Unità di output per il tempo |
...
Calcola il tempo impiegato dalla luce per percorrere la distanza dal sole attraverso l'acqua, in minuti.
...
Calcola il tempo per la luce di percorrere 300000000 metri a 225000000 m/s.
...
> Velocità della luce in m/s (predefinito: 299792458)
...
> Il mezzo attraverso cui la luce viaggia
