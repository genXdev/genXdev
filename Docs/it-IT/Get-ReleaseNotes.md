...
> Visualizza le Note di rilascio da un file README.md.

## Description

Mostra tutte le note di rilascio dalla sezione "## Note di rilascio" di un file README.md. Può utilizzare il README nella posizione corrente, nella directory del profilo PowerShell o nella directory di OneDrive.
