...
> Recupera i dati da una tabella di database SQL con limitazione opzionale dei record.

## Description

Questa funzione interroga i dati da una tabella di database SQL utilizzando una stringa di connessione o un percorso di file di database. Offre flessibilità nella connessione al database e nel controllo della quantità di dati recuperati tramite il parametro Count.
...
| `-TableName` | String | ✅ | — | 2 | — | Il nome della tabella da cui interrogare i dati. |
| `-Count` | Int32 | — | — | 3 | `100` | Il numero massimo di record da restituire. -1 per tutti. |
