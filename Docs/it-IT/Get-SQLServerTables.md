...
> Recupera un elenco di nomi di tabelle da un database SQL Server.

## Description

Esegue query sulle tabelle di sistema di SQL Server per recuperare tutti i nomi di tabelle definite dall'utente da un database di SQL Server. Supporta la connessione tramite una stringa di connessione diretta o un nome di database con parametri del server. Restituisce i nomi delle tabelle come una collezione di stringhe.
