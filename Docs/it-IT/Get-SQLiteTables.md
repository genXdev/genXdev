...
> Recupera un elenco di nomi di tabelle da un database SQLite.

## Description

Interroga la tabella di sistema sqlite_master per recuperare tutti i nomi di tabelle definite dall'utente da un database SQLite. Supporta la connessione tramite una stringa di connessione diretta o un percorso file del database. Restituisce i nomi delle tabelle come una raccolta di stringhe.
