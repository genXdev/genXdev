...
> Calcola il tempo di volo di un proiettile.

## Description

Utilizza T = (2 v sinθ) / g per il moto ideale.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-InitialVelocityInMetersPerSecond` | Double | ✅ | — | 0 | `0` | Velocità iniziale in m/s |
| `-AngleInDegrees` | Double | ✅ | — | 1 | `0` | Angolo di lancio in gradi |
| `-GravityInMetersPerSecondSquared` | Double | — | — | 2 | `0` | Gravità in m/s² (predefinito: 9,81) |
| `-As` | String | — | — | 3 | — | Unità di output per il tempo |
...
Calcola il tempo di volo per un proiettile lanciato a 20 m/s a 45 gradi, output in minuti.
...
Calcola il tempo di volo per un proiettile lanciato a 30 m/s con un angolo di 30 gradi.
