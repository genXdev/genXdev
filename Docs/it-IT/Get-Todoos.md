...
> Mostra gli elementi delle attività da un file README.md.

## Description

Mostra tutti gli elementi todo dalla sezione "## Todoos" di un file README.md. Può utilizzare il README nella posizione corrente, la directory del profilo PowerShell o la directory OneDrive.
