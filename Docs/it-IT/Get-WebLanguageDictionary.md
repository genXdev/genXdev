...
> Restituisce un dizionario invertito per tutte le lingue supportate da Google Search.

## Description

* Restituisce un dizionario che associa i nomi delle lingue ai rispettivi codici linguistici per tutte le lingue supportate da Google Search.
* Utile per la ricerca di codici lingua in query web e attività di traduzione.
...
Recupera il dizionario che associa i nomi delle lingue ai loro codici.
