...
> Esegue una chiamata a una funzione strumentale con convalida e filtraggio dei parametri.

## Description

Questa funzione elabora le chiamate agli strumenti convalidando gli argomenti, filtrando i parametri ed eseguendo callback con una corretta gestione delle conferme. Supporta sia callback di script block che di comando info.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-ToolCall` | Collections.Hashtable | ✅ | — | 0 | — | ### Set-StrictMode
Imposta e applica le regole di codifica nelle espressioni, negli script e negli script block. |
...
| `-ForceAsText` | SwitchParameter | — | — | Named | — | Forza output come testo |
