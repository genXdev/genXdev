...
> Aggiorna i metadati di riconoscimento facciale per i file immagine in una directory specificata.

## Description

Questa funzione elabora le immagini in una directory specificata per identificare e analizzare i volti utilizzando la tecnologia di riconoscimento AI. Crea o aggiorna file di metadati contenenti informazioni sui volti per ogni immagine. I metadati vengono memorizzati in un file separato con
