...
> Aggiorna i metadati di classificazione delle scene per i file immagine in una directory specificata.

## Description

Questa funzione elabora le immagini in una directory specificata per classificare le scene utilizzando l'intelligenza artificiale. Crea file di metadati JSON contenenti classificazioni delle scene, punteggi di confidenza ed etichette. La funzione supporta l'elaborazione batch con soglie di confidenza configurabili e può opzionalmente saltare i file di metadati esistenti o riprovare classificazioni precedentemente fallite.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-ImageDirectories` | String[] | — | — | 0 | `@('.\')` | I percorsi delle directory contenenti le immagini da elaborare |
| `-Recurse` | SwitchParameter | — | — | Named | — | Elabora immagini nella directory specificata e in tutte le sottodirectory |
| `-OnlyNew` | SwitchParameter | — | — | Named | — | Elabora solo le immagini che non hanno già file di metadati facciali |
...
| `-TimeoutSecond` | Int32 | — | — | Named | — | Timeout in secondi per la richiesta, il default è 24 ore |
...
| `-ShowWindow` | SwitchParameter | — | — | Named | — | Mostra la finestra Docker durante l'inizializzazione |
...
Elabora tutte le immagini in C:\Photos e D:\Pictures e nelle relative sottodirectory per la classificazione della scena.
...
Utilizza alias per ritentare classificazioni fallite e per elaborare solo nuove immagini in più directory.
...
Forza la ricostruzione del contenitore e utilizza l'accelerazione GPU per un'elaborazione più rapida.
...
Elabora tutte le immagini in modo ricorsivo e memorizza solo le classificazioni delle scene con confidenza >= 60%.

## Parameter Details

### `-ImageDirectories <String[]>`

> I percorsi delle directory contenenti le immagini da elaborare
...
> Elabora immagini nella directory specificata e in tutte le sottodirectory
...
> Elabora solo le immagini che non hanno già file di metadati facciali
...
> Mostra la finestra Docker durante l'inizializzazione
