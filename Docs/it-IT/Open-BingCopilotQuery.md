...
> Apre una query di Bing CoPilot in un browser web

## Description

Apre una query di Bing CoPilot nel browser web. La funzione digita automaticamente la query e la invia utilizzando la funzione sottostante Open-WebsiteAndPerformQuery. Questo fornisce un modo conveniente per interagire con Microsoft Copilot da PowerShell.
...
| `-ShowWindow` | SwitchParameter | — | — | Named | — | Si apre in modalità a schermo intero |
...
| `-SessionOnly` | SwitchParameter | — | — | Named | — | Utilizza la modalità solo sessione per il profilo del browser. |
| `-ClearSession` | SwitchParameter | — | — | Named | — | Pulisci la sessione/profilo del browser prima di aprire. |
| `-SkipSession` | SwitchParameter | — | — | Named | — | Salta caricamento sessione/profilo browser. |
...
> Utilizza la modalità solo sessione per il profilo del browser.
...
> Pulisci la sessione/profilo del browser prima di aprire.
...
> Salta caricamento sessione/profilo browser.
