...
> Apre il catalogo delle progressive webapp di GenXdev in un browser web.

## Description

Apre il catalogo con le progressive webapp GenXdev pubblicate in un browser web. Si apre in modalità applicazione con schermo intero abilitato per impostazione predefinita per offrire un'esperienza di visualizzazione ottimale del catalogo. Supporta tutte le opzioni standard di configurazione del browser web, inclusa la posizione del monitor, il dimensionamento della finestra e le preferenze linguistiche.

La funzione configura automaticamente il browser per la migliore esperienza di visualizzazione del catalogo e può aprire più istanze del browser contemporaneamente. Fornisce un supporto linguistico completo e rispetta le preferenze dell'utente per la selezione e il posizionamento del browser.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Language` | String | — | — | 0 | — | La lingua dei risultati di ricerca restituiti |
...
| `-Monitor` | Int32 | — | — | Named | `-2` | Il monitor da utilizzare, 0 = predefinito, -1 è scartato, -2 = Monitor secondario configurato, default a -1, nessun posizionamento |
| `-FullScreen` | SwitchParameter | — | — | Named | — | Si apre in modalità a schermo intero |
| `-ShowWindow` | SwitchParameter | — | — | Named | — | Mostra la finestra del browser (non ridotta a icona o nascosta) |
...
Apre il catalogo app GenXdev sul monitor 1 in modalità applicazione con schermo intero abilitato.
...
Apre il catalogo di GenXdev sul monitor 1 utilizzando il comando alias.
...
> Mostra la finestra del browser (non ridotta a icona o nascosta)
