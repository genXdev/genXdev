...
> Apre una query di Github CoPilot in un browser web

## Description

Apre una query di GitHub Copilot nel browser web e inserisce automaticamente la query specificata. La funzione attende che la pagina venga caricata prima di digitare la query. Questa funzione utilizza la funzione sottostante Open-WebsiteAndPerformQuery per gestire l'automazione del browser e fornisce un modo conveniente per interagire con GitHub Copilot da PowerShell con ampie opzioni di configurazione del browser.
