...
> Apre le query di informazioni sui siti di Google in un browser web.

## Description

Apre più query di ricerca Google relative alle informazioni sul sito (site:, link:, related:) in un browser web per il/i dominio/i specificato/i.
...
| `-NoBorders` | SwitchParameter | — | — | Named | — | Rimuove i bordi della finestra dal browser |
| `-SessionOnly` | SwitchParameter | — | — | Named | — | Usa la modalità solo sessione per il profilo del browser (nessun dato persistente) |
| `-ClearSession` | SwitchParameter | — | — | Named | — | Cancellare i dati della sessione/profilo del browser prima di aprire |
| `-SkipSession` | SwitchParameter | — | — | Named | — | Salta l'utilizzo di una sessione/profilo del browser (usa predefinito) |
...
> Rimuove i bordi della finestra dal browser
...
> Usa la modalità solo sessione per il profilo del browser (nessun dato persistente)
...
> Cancellare i dati della sessione/profilo del browser prima di aprire
...
> Salta l'utilizzo di una sessione/profilo del browser (usa predefinito)
