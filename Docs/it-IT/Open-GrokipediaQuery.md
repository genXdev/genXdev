...
Apre una o più query di ricerca di Grokipedia in un browser web con opzioni di configurazione estese. Supporta il comportamento configurabile del browser, la selezione del monitor e il posizionamento delle finestre. Le query vengono codificate in URL e aperte utilizzando il dominio di Grokipedia della lingua specificata con supporto completo per la localizzazione.

La funzione fornisce un controllo completo del browser, incluse modalità di navigazione privata, posizionamento delle finestre, automazione della tastiera e supporto multi-monitor. Gestisce automaticamente la codifica URL e il mapping dei codici lingua per i domini internazionali di Grokipedia.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Queries` | String[] | ✅ | ✅ (ByValue, ByPropertyName) | 0 | — | La query di ricerca di Grokipedia da eseguire |
...
Cerca più termini in Grokipedia utilizzando la modalità di navigazione privata.
