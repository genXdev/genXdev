...
> Apre le query di InstantStreetView in un browser web.

## Description

Apre le query di InstantStreetView in modo configurabile utilizzando i parametri della riga di comando del browser web. Supporta più query e la selezione del monitor. Fornisce un controllo completo del browser, inclusi posizionamento della finestra, impostazioni della lingua e funzionalità specifiche del browser.

La funzione costruisce automaticamente gli URL di InstantStreetView codificando le query di posizione e aprendole nel browser specificato. Supporta tutti i browser principali, inclusi Edge, Chrome e Firefox, con ampie opzioni di personalizzazione.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Queries` | String[] | ✅ | ✅ (ByValue, ByPropertyName) | 0 | — | Le query di localizzazione da visualizzare in InstantStreetView |
...
| `-SideBySide` | SwitchParameter | — | — | Named | — | Apri le finestre del browser affiancate |
...
Apre InstantStreetView per Times Square nel browser predefinito sul monitor principale.
...
Apre InstantStreetView per la Torre Eiffel utilizzando l'alias 'isv' e visualizza sul monitor secondario.
...
Apre InstantStreetView per Big Ben in lingua inglese utilizzando la modalità di navigazione privata.
...
Apre più query di InstantStreetView tramite pipeline nel browser Chrome posizionate sul lato sinistro dello schermo.

## Parameter Details

### `-Queries <String[]>`

> Le query di localizzazione da visualizzare in InstantStreetView
