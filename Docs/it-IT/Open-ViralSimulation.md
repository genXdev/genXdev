...
> Apre un gioco di simulazione virale in un browser web con ampie opzioni di configurazione.

## Description

Apre il gioco di simulazione virale all'indirizzo https://viral.genxdev.net/ in un browser web specificato con opzioni configurabili per finestra, posizionamento e comportamento. Supporta più browser, navigazione privata, modalità applicazione e funzionalità complete di gestione delle finestre.

La funzione fornisce un'esperienza interattiva di simulazione virale con funzionalità come:
- Supporto per più browser (Edge, Chrome, Firefox)
- Controlli di posizionamento e dimensionamento della finestra
- Opzioni a schermo intero e modalità applicazione
- Funzionalità di navigazione privata
- Supporto per l'automazione della tastiera
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Language` | String | — | — | 0 | — | La lingua per la visualizzazione dei contenuti web e le impostazioni della lingua del browser |
...
| `-Monitor` | Int32 | — | — | Named | `-2` | Il monitor da utilizzare, 0 = predefinito, -1 scarta, -2 = secondo monitor configurato, per impostazione predefinita $Global:DefaultSecondaryMonitor o 2 se non trovato |
...
Apre la simulazione virale in Google Chrome con modalità di navigazione in incognito e senza schermo intero.
...
Apre la simulazione virale usando alias con Chrome, in modalità incognito e senza schermo intero.

## Parameter Details

### `-Language <String>`

> La lingua per la visualizzazione dei contenuti web e le impostazioni della lingua del browser
