...
> Apre un browser web per cercare i testi delle canzoni in riproduzione su VLC.

## Description

Questa funzione rileva se VLC Media Player è in esecuzione e cerca i testi delle canzoni in base al titolo del contenuto multimediale attualmente in riproduzione. Apre automaticamente una query di ricerca in un browser web per trovare i testi della traccia corrente. La funzione supporta più browser e offre opzioni estese per il posizionamento delle finestre e la visualizzazione.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Queries` | String[] | — | ✅ (ByValue, ByPropertyName) 🌐 Remaining | 0 | — | Termini di ricerca per trovare una traccia |
| `-EndPoint` | String | — | — | 1 | `'Google'` | L'endpoint su cui eseguire la query |
...
| `-SessionOnly` | SwitchParameter | — | — | Named | — | Utilizzare una sessione che non viene conservata dopo la chiusura del browser |
| `-ClearSession` | SwitchParameter | — | — | Named | — | Cancellare i dati della sessione del browser prima di aprire il browser |
| `-SkipSession` | SwitchParameter | — | — | Named | — | Non utilizzare alcuna sessione browser esistente |
...
Apre una ricerca Google per i testi del brano attualmente in riproduzione su VLC.
...
Apre la ricerca dei testi in Microsoft Edge in modalità privata/in incognito.

## Parameter Details

### `-Queries <String[]>`

> Termini di ricerca per trovare una traccia
...
> Utilizzare una sessione che non viene conservata dopo la chiusura del browser
...
> Cancellare i dati della sessione del browser prima di aprire il browser
...
> Non utilizzare alcuna sessione browser esistente
