...
> Apre le informazioni del sito WaybackMachine in un browser web.

## Description

Apre una query di Waybackmachine in un browser web, visualizzando le versioni storiche dell'URL o del sito specificato. Supporta query multiple e selezione del monitor. Fornisce accesso ai contenuti web archiviati tramite il servizio Wayback Machine di Internet Archive.
...
| `-Language` | String | — | — | 1 | — | La preferenza linguistica per l'interfaccia e il contenuto del browser |
...
| `-SessionOnly` | SwitchParameter | — | — | Named | — | Utilizza impostazioni alternative memorizzate nella sessione per le preferenze di Wayback Machine |
| `-ClearSession` | SwitchParameter | — | — | Named | — | Cancella le impostazioni alternative memorizzate nella sessione per le preferenze di Wayback Machine |
...
Apre l'archivio della Wayback Machine per example.com sul monitor predefinito.
...
Apre l'archivio Wayback Machine per example.com utilizzando alias con posizionamento del monitor scartato.
...
Apre l'archivio Wayback Machine per microsoft.com in modalità di navigazione in incognito di Chrome.
...
> La preferenza linguistica per l'interfaccia e il contenuto del browser
...
> Utilizza impostazioni alternative memorizzate nella sessione per le preferenze di Wayback Machine
...
> Cancella le impostazioni alternative memorizzate nella sessione per le preferenze di Wayback Machine
