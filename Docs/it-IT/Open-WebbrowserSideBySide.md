...
> Avvia una nuova finestra del browser web con posizionamento specifico.

## Description

Apre una nuova finestra del browser (Edge o Chrome) posizionata sul lato destro del monitor primario in modalità background.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Url` | String[] | — | ✅ (ByValue) | 0 | — | Gli URL da aprire nel browser |
