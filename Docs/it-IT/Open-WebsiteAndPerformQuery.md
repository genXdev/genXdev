...
> Apre una pagina web in un browser web ed esegue una o più query.

## Description

Questa funzione apre un sito web tramite URL nel browser web predefinito, inserisce una o più query e le invia. Supporta l'ampia selezione del monitor e le opzioni di posizionamento della finestra attraverso la funzione sottostante Open-Webbrowser.

La funzione copia automaticamente ogni query negli appunti e la invia alla finestra del browser utilizzando l'automazione della tastiera. Preserva il contenuto originale degli appunti e lo ripristina dopo che tutte le query sono state elaborate.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Url` | String | ✅ | ✅ (ByPropertyName) | 0 | — | L'URL del sito web da aprire |
...
| `-SendKeyDelayMilliSeconds` | Int32 | — | — | Named | `500` | Ritardo in millisecondi tra l'invio di diverse sequenze di tasti |
...
Apre Google e cerca "PowerShell".
...
Apre Google e cerca "PowerShell tutorials" sul monitor predefinito.

## Parameter Details

### `-Url <String>`

> L'URL del sito web da aprire
