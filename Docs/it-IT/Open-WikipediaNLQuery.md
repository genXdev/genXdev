...
> Apre le ricerche su Wikipedia in olandese in un browser web.

## Description

Apre una query 'Wikipedia - Paesi Bassi' in un browser web, con opzioni di visualizzazione configurabili. Supporta la ricerca di più termini e la specifica del monitor su cui visualizzare i risultati.
...
| `-SideBySide` | SwitchParameter | — | — | Named | — | Apre due finestre del browser affiancate |
| `-SessionOnly` | SwitchParameter | — | — | Named | — | Utilizza cookie di sessione (nessun cookie persistente) |
| `-ClearSession` | SwitchParameter | — | — | Named | — | Cancella i dati della sessione del browser prima di aprire |
| `-SkipSession` | SwitchParameter | — | — | Named | — | Salta il ripristino della sessione precedente del browser |
...
> Apre due finestre del browser affiancate
...
> Utilizza cookie di sessione (nessun cookie persistente)
...
> Cancella i dati della sessione del browser prima di aprire
