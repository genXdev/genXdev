...
> Apre una query di Wikipedia in un browser web.

## Description

Apre una o più query di ricerca di Wikipedia in un browser web con ampie opzioni di configurazione. Supporta il comportamento configurabile del browser, la selezione del monitor e il posizionamento delle finestre. Le query vengono codificate in URL e aperte utilizzando il dominio Wikipedia della lingua specificata con supporto completo per la localizzazione.

La funzione fornisce un controllo completo del browser, incluse modalità di navigazione privata, posizionamento delle finestre, automazione della tastiera e supporto multi-monitor. Gestisce automaticamente la codifica URL e il mapping del codice lingua per i domini Wikipedia internazionali.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Queries` | String[] | ✅ | ✅ (ByValue, ByPropertyName) | 0 | — | La query di ricerca Wikipedia da eseguire |
| `-Language` | String | — | — | 1 | — | La lingua dei risultati di ricerca di Wikipedia |
...
| `-Monitor` | Int32 | — | — | Named | `-1` | Il monitor da utilizzare, 0 = predefinito, -1 = ignora, -2 = monitor secondario configurato |
...
| `-PassThru` | SwitchParameter | — | — | Named | — | Restituisce un oggetto processo di PowerShell che rappresenta il processo del browser |
...
Apre una ricerca su Wikipedia per "PowerShell" in inglese sul monitor predefinito.
...
Apre una ricerca su Wikipedia utilizzando l'alias con parametri posizionali.
...
Cerca più termini nella Wikipedia tedesca utilizzando la modalità di navigazione privata.

## Parameter Details

### `-Queries <String[]>`

> La query di ricerca Wikipedia da eseguire
...
> La lingua dei risultati di ricerca di Wikipedia
