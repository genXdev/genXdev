...
> Apre il gioco YAB in un browser web con impostazioni configurabili.

## Description

Apre il sito web del gioco YAB in un browser specificato con varie opzioni di visualizzazione e comportamento. Supporta diverse modalità di gioco, inclusa la modalità spettatore. Il gioco YAB è un puzzle game online che può essere giocato in modo interattivo o guardato in modalità spettatore, dove l'IA gioca automaticamente.
...
Apre il gioco YAB in modalità spettatore utilizzando il browser Chrome senza schermo intero, con interfaccia in lingua inglese.
...
Apre il gioco YAB nel browser Edge con navigazione privata sul monitor 2 utilizzando alias per un accesso rapido.
