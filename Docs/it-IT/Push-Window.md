...
> Inserisce la finestra corrente nello stack delle finestre con modifiche opzionali.

## Description

Inserisce un helper per finestra nella pila per la finestra attualmente in primo piano.
Consente di applicare varie trasformazioni alla finestra prima o dopo l'inserimento.
Questa funzione cattura la finestra corrente e la memorizza per un successivo recupero
con Pop-Window, applicando opzionalmente posizionamento, dimensionamento ed effetti
visivi.
