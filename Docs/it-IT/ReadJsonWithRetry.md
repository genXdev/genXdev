...
> Legge file JSON con logica di ripetizione e pulizia automatica del blocco.

## Description

Tenta di leggere un file JSON con logica di ripetizione per gestire l'accesso concorrente. Implementa la pulizia automatica dei file di blocco obsoleti. Restituisce una tabella hash vuota se il file non esiste.
