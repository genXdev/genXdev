...
> Invia un pacchetto magico Wake-on-LAN per riattivare computer remoti sulla rete.

## Description

Costruisce e trasmette un pacchetto magico Wake-on-LAN (WOL) agli indirizzi MAC specificati. Il pacchetto magico è una trasmissione UDP che contiene l'indirizzo MAC di destinazione ripetuto 16 volte, il che attiva le interfacce di rete supportate per accendere il computer. Supporta indirizzi broadcast e porte personalizzati.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-MacAddress` | String[] | ✅ | ✅ (ByValue, ByPropertyName) | 0 | — | Uno o più indirizzi MAC a cui inviare il pacchetto magico (ad es. 00:11:22:33:44:55) |
| `-BroadcastAddress` | String | — | — | 1 | `"255.255.255.255"` | L'indirizzo IP broadcast a cui inviare il magic packet (predefinito: 255.255.255.255) |
| `-Port` | Int32 | — | — | 2 | `4000` | La porta UDP su cui inviare il magic packet (default: 4000) |
...
Invia un pacchetto magico per accendere il computer con l'indirizzo MAC specificato.
...
Invia pacchetti magici a più computer sulla porta 9 tramite input pipeline.

## Parameter Details

### `-MacAddress <String[]>`

> Uno o più indirizzi MAC a cui inviare il pacchetto magico (ad es. 00:11:22:33:44:55)
...
> L'indirizzo IP broadcast a cui inviare il magic packet (predefinito: 255.255.255.255)
...
> La porta UDP su cui inviare il magic packet (default: 4000)
