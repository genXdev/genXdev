...
> Naviga su di quattro livelli di directory nella gerarchia del filesystem.

## Description

* Sposta di quattro livelli di directory verso l'alto dalla posizione corrente nel
  filesystem.
* Dopo la navigazione, visualizza il contenuto della directory risultante.
...
Sposta su di quattro livelli di directory dalla posizione corrente.
...
Utilizza l'alias per salire di quattro livelli di directory.
