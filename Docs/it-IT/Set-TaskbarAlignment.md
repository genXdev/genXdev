...
> Configura l'allineamento della barra delle applicazioni di Windows 11+ tra le posizioni centrale e sinistra.

## Description

Imposta l'allineamento della barra delle applicazioni in Windows 11 e versioni successive modificando la chiave di registro 'TaskbarAl' sotto HKCU:\SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer\Advanced. L'allineamento può essere impostato al centro (valore 1) o a sinistra (valore 0).
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Justify` | String | ✅ | — | 0 | — | Allineamento della barra delle applicazioni (Centrato o Sinistra) |
...
> Allineamento della barra delle applicazioni (Centrato o Sinistra)
