...
> Posiziona una finestra sul monitor secondario con le opzioni di layout specificate.

## Description

Questa funzione consente di posizionare finestre su un monitor secondario configurato utilizzando Set-WindowPosition con varie opzioni di layout tra cui allineamento, dimensione e impostazioni dei bordi. Gestisce la selezione del monitor in base alla configurazione globale e fornisce un comodo wrapper per il posizionamento delle finestre sul monitor secondario.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Process` | Diagnostics.Process[] | — | ✅ (ByValue, ByPropertyName) | 0 | — | Il processo di posizionamento della finestra |
| `-Monitor` | Int32 | — | — | Named | `-2` | Il monitor da usare, 0=predefinito, -1=scarta, -2=configurato |
| `-Width` | Int32 | — | — | Named | `-1` | La larghezza iniziale della finestra |
| `-Height` | Int32 | — | — | Named | `-1` | L'altezza iniziale della finestra |
| `-X` | Int32 | — | — | Named | `-999999` | La posizione iniziale X della finestra |
| `-Y` | Int32 | — | — | Named | `-999999` | La posizione Y iniziale della finestra |
...
| `-FocusWindow` | SwitchParameter | — | — | Named | — | Messa a fuoco della finestra dopo il posizionamento |
| `-SetForeground` | SwitchParameter | — | — | Named | — | Porta la finestra in primo piano dopo il posizionamento |
...
| `-KeysToSend` | String[] | — | — | Named | — | Tasti da inviare alla finestra dopo il posizionamento |
...
| `-PassThru` | SwitchParameter | — | — | Named | — | Restituisce l'oggetto processo dopo il posizionamento |
| `-SideBySide` | SwitchParameter | — | — | Named | — | Posiziona la finestra affiancata a PowerShell sullo stesso monitor |
...
> Il monitor da usare, 0=predefinito, -1=scarta, -2=configurato
...
> Messa a fuoco della finestra dopo il posizionamento
...
> Porta la finestra in primo piano dopo il posizionamento
...
> Tasti da inviare alla finestra dopo il posizionamento
...
> Restituisce l'oggetto processo dopo il posizionamento
...
> Posiziona la finestra affiancata a PowerShell sullo stesso monitor
