...
> Elimina un volto registrato da DeepStack tramite il suo identificatore.

## Description

Questa funzione elimina un volto dal sistema di riconoscimento facciale DeepStack utilizzando il suo identificatore univoco. Comunica con l'endpoint API per rimuovere permanentemente i dati del volto registrato dal sistema.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Identifier` | String | ✅ | ✅ (ByValue, ByPropertyName) | 0 | — | Identificatore univoco del volto da eliminare dal sistema DeepStack |
| `-ContainerName` | String | — | — | 1 | `'deepstack_face_recognition'` | Il nome del contenitore Docker |
| `-VolumeName` | String | — | — | 2 | `'deepstack_face_data'` | Il nome del volume Docker per l'archiviazione persistente |
| `-ServicePort` | Int32 | — | — | 3 | `5000` | Il numero di porta per il servizio DeepStack |
| `-HealthCheckTimeout` | Int32 | — | — | 4 | `60` | Tempo massimo in secondi per attendere il controllo di integrità del servizio |
| `-HealthCheckInterval` | Int32 | — | — | 5 | `3` | Intervallo in secondi tra i tentativi di controllo dello stato |
| `-ImageName` | String | — | — | 6 | — | Nome personalizzato dell'immagine Docker da utilizzare |
...
> Identificatore univoco del volto da eliminare dal sistema DeepStack
