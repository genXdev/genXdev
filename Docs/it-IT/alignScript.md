...
> Restituisce una stringa (con indentazione modificata) di una stringa di scriptblock fornita

## Description

Modifica l'indentazione di una stringa di scriptblock rispettando le indentazioni originali del blocco di codice
