...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Text` | String | — | ✅ (ByValue) | 0 | — | We are seeking to convert the aforementioned text into a more formalized corporate vernacular, thereby aligning its verbiage with our organizational lexicon and communication standards. |
