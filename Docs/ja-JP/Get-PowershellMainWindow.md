...
> PowerShell ターミナルのメイン ウィンドウ用のウィンドウ ヘルパー オブジェクトを返します。

## Description

現在のPowerShellホストプロセスのメインウィンドウを表すWindowObjヘルパーオブジェクトを取得します。
これにより、ターミナルウィンドウ自体の操作や対話が可能になります。
...
現在のPowerShellターミナルウィンドウのWindowObjを取得します。
