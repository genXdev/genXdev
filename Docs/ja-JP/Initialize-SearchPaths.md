...
> パッケージ管理のためのシステム検索パスを初期化および構成します。

## Description

* デフォルトのシステムロケーション、Chocolateyパス、開発ツールパス、カスタムパッケージパスを組み合わせて、包括的な検索パスのリストを構築します。
...
既定のワークスペース フォルダーを使用して検索パスを初期化します。
...
特定のワークスペースフォルダーを使用して検索パスを初期化します。

## Parameter Details

### `-WorkspaceFolder <String>`

> ノードモジュールとPowerShellパスに使用するワークスペースフォルダのパス。
