...
> Bing CoPilot クエリをウェブブラウザで開きます

## Description

Bing CoPilotのクエリをウェブブラウザで開きます。この関数は、基盤となるOpen-WebsiteAndPerformQuery関数を使用して、自動的にクエリを入力し送信します。これにより、PowerShellからMicrosoft Copilotと対話する便利な方法が提供されます。
...
| `-ClearSession` | SwitchParameter | — | — | Named | — | ブラウザのセッション/プロファイルを開く前にクリアしてください。 |
| `-SkipSession` | SwitchParameter | — | — | Named | — | ブラウザのセッション/プロファイル読み込みをスキップします。 |
...
> ブラウザのセッション/プロファイルを開く前にクリアしてください。
...
- [Open-XGrokQuery](https://github.com/genXdev/genXdev/blob/main/Docs/ja-JP/Open-XGrokQuery.md)
