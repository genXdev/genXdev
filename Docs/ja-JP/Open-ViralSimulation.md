...
> 豊富な設定オプションを備えたウイルスシミュレーションゲームをウェブブラウザで開きます。

## Description

https://viral.genxdev.net/ にあるウイルスシミュレーションゲームを、指定されたWebブラウザで、設定可能なウィンドウ設定、配置、動作オプションとともに開きます。複数のブラウザ、プライベートブラウジング、アプリケーションモード、および包括的なウィンドウ管理機能をサポートします。

この関数は、次のような機能を備えたインタラクティブなウイルスシミュレーション体験を提供します：
- 複数のブラウザサポート（Edge、Chrome、Firefox）
- ウィンドウの配置とサイズ制御
- 全画面およびアプリケーションモードオプション
- プライベートブラウジング機能
- キーボード自動化サポート
- マルチモニターサポート
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Language` | String | — | — | 0 | — | Webコンテンツ表示とブラウザの言語設定のための言語 |
...
Google Chromeのプライベートブラウジングモードでウイルスシミュレーションを開き、全画面表示は行いません。
...
エイリアスを使用してウイルスシミュレーションをChrome、シークレットモード、フルスクリーンなしで開きます。

## Parameter Details

### `-Language <String>`

> Webコンテンツ表示とブラウザの言語設定のための言語
