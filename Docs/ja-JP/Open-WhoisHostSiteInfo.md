...
ドメイン名またはIPアドレスに対するWhoisホスト情報クエリをWebブラウザで開きます。設定可能なモニター選択、複数クエリ、ウィンドウ位置指定、ブラウザ選択、自動化機能を含む広範なブラウザ設定オプションをサポートします。
...
| `-SessionOnly` | SwitchParameter | — | — | Named | — | AIの言語、画像コレクションなどの設定に関して、セッションに保存された代替設定を使用します。 |
| `-ClearSession` | SwitchParameter | — | — | Named | — | 言語、画像コレクションなどのAI設定のためにセッションに保存されている代替設定をクリアします。 |
| `-SkipSession` | SwitchParameter | — | — | Named | — | 言語や画像コレクションなどのAI設定について、セッションに影響を与えずに永続的な設定のみを保存します。 |
...
エイリアスと位置パラメーターを使用してexample.comのWhois情報を開きます。
...
> AIの言語、画像コレクションなどの設定に関して、セッションに保存された代替設定を使用します。
...
> 言語、画像コレクションなどのAI設定のためにセッションに保存されている代替設定をクリアします。
...
> 言語や画像コレクションなどのAI設定について、セッションに影響を与えずに永続的な設定のみを保存します。
