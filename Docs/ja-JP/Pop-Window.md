...
> スタックから最後のアクティブウィンドウヘルパーを、オプションの変更を加えてポップします。

## Description

スタックからウィンドウヘルパーをポップし、必要に応じてウィンドウ変換を適用します。スタックが空であるか無効なウィンドウが含まれている場合は、現在フォーカスされているウィンドウを返します。この関数を使用すると、Push-Windowで以前に保存されたウィンドウを操作し、さまざまな位置、サイズ、視覚効果を適用できます。
