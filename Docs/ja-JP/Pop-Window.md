...
> スタックから最後のアクティブウィンドウヘルパーをポップします。オプションの変更が可能です。

## Description

スタックからウィンドウヘルパーをポップし、必要に応じてウィンドウ変換を適用します。
スタックが空であるか、無効なウィンドウが含まれている場合は、現在フォーカスされているウィンドウを返します。
この関数は、Push-Windowで以前に保存されたウィンドウを操作し、さまざまな配置、サイズ変更、視覚効果を適用できます。
