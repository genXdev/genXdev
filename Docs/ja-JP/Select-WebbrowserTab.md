...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Id` | Int32 | — | — | 0 | `-1` | 表示されているリストからのタブ識別子 *(Parameter set: )* |
| `-Name` | String | ✅ | — | 0 | — | URL内のこの名前を含む最初のタブを選択 *(Parameter set: )* 🌐 *Supports wildcards* |
| `-ByReference` | PSObject | ✅ | — | Named | — | Get-ChromiumSessionReference を使用して参照からタブを選択します *(Parameter set: )* |
...
| `-Force` | SwitchParameter | — | — | Named | — | 必要に応じてブラウザを再起動します |
