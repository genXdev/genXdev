...
> AI를 사용하여 문맥에 맞는 이모티콘을 추가하여 텍스트를 향상시킵니다.

## Description

이 함수는 입력 텍스트를 처리하여 감정 컨텍스트에 맞는 이모티콘을 추가합니다. 매개변수, 파이프라인 또는 시스템 클립보드를 통해 직접 입력을 받을 수 있습니다. 이 함수는 AI 모델을 활용하여 텍스트를 분석하고 적절한 이모티콘을 선택하여 메시지를 더 표현력 있고 매력적으로 만듭니다.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Text` | String | — | ✅ (ByValue) | 0 | — | 텍스트에 이모티콘을 추가하여 개선하세요 |
