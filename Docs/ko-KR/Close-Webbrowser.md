...
> 하나 이상의 웹브라우저 인스턴스를 선택적으로 닫습니다.

## Description

웹 브라우저 인스턴스 종료에 대한 세부적인 제어를 제공합니다. 특정 브라우저(Edge, Chrome, Firefox)를 대상으로 하거나 모든 브라우저를 종료할 수 있습니다. 기본 창과 백그라운드 프로세스를 모두 종료하는 것을 지원합니다.
...
| `-Chrome` | SwitchParameter | — | — | Named | — | Google Chrome 브라우저 인스턴스를 닫습니다 *(Parameter set: )* |
| `-Chromium` | SwitchParameter | — | — | Named | — | 기본 크로미움 기반 브라우저를 닫습니다 *(Parameter set: )* |
...
| `-IncludeBackgroundProcesses` | SwitchParameter | — | — | Named | — | 백그라운드 작업을 포함한 모든 인스턴스를 닫습니다 |
...
> Microsoft Edge 브라우저 인스턴스를 닫습니다
