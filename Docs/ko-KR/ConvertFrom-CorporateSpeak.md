...
> 정중하고 전문적인 회사체의 말을 AI를 사용하여 직접적이고 명확한 언어로 변환합니다.

## Description

이 함수는 외교적, 기업적 커뮤니케이션을 더 직접적이고 명확한 언어로 변환하기 위해 입력 텍스트를 처리합니다. 매개변수를 통해 직접 입력을 받거나, 파이프라인에서, 또는 시스템 클립보드에서 입력을 받을 수 있습니다. 이 함수는 AI 모델을 활용하여 원래 의도를 유지하면서 텍스트를 분석하고 다시 표현합니다.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Text` | String | — | ✅ (ByValue) | 0 | — | 회사 용어로 변환할 텍스트 |
