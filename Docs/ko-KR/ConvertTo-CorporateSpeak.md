...
> AI를 사용하여 직설적이거나 거친 텍스트를 정중하고 전문적인 기업체 스타일로 변환합니다.

## Description

이 함수는 입력 텍스트를 처리하여 직접적이거나 거칠 수 있는 언어를 외교적이고 전문적인 회사 커뮤니케이션으로 변환합니다. 함수는 매개변수를 통한 직접 입력, 파이프라인 입력 또는 시스템 클립보드 입력을 허용합니다. AI 모델을 활용하여 원래 의도를 유지하면서 텍스트를 분석하고 바꿔 씁니다.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Text` | String | — | ✅ (ByValue) | 0 | — | 당신이 변환할 텍스트 |
