...
> 직접적이거나 노골적인 텍스트를 예의 바르고 세심한 외교적 언어로 변환합니다.

## Description

이 함수는 사용자 입력을 직설적이거나 퉁명스러운 표현에서 고위급 토론, 협상 또는 공식 커뮤니케이션에 적합한 외교적이고 재치 있는 언어로 변환합니다. 이 함수는 AI 언어 모델을 사용하여 원래 의도를 유지하면서 어조를 부드럽게 하고 메시지를 보다 외교적이고 전문적으로 만듭니다.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Text` | String | — | ✅ (ByValue) | 0 | — | 제공된 텍스트가 없어 변환할 수 없습니다. 원문을 입력해 주시면 외교적 어조로 변환해 드리겠습니다. |
...
> 제공된 텍스트가 없어 변환할 수 없습니다. 원문을 입력해 주시면 외교적 어조로 변환해 드리겠습니다.
