...
| `-DensityInKilogramsPerCubicMeter` | Double | ✅ | — | 1 | `0` | 유체 밀도 (kg/m³) |
...
속도 10 m/s, 공기 밀도 1.225 kg/m³, 면적 1 m², 항력 계수 0.5를 사용하여 항력을 계산하고 파운드힘으로 출력합니다.
...
위치 매개변수를 사용하여 항력 계산: 속도 20 m/s, 밀도 1.225 kg/m³, 면적 2 m², 계수 0.3.
