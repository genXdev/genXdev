...
* 일치하는 프로세스의 기본 창에 대한 세부 정보가 포함된 WindowObj 개체를 반환합니다.
* 프로세스 이름으로 검색할 때 와일드카드를 지원합니다.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-ProcessName` | String | — | ✅ (ByPropertyName) | 0 | — | 창 정보를 가져올 프로세스의 이름 🌐 *Supports wildcards* |
...
이름이 "notepad"인 모든 프로세스의 창 정보를 검색합니다.
