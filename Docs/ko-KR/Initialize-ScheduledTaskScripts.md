...
> 지정된 간격으로 PowerShell 스크립트를 실행하는 예약된 작업을 만듭니다.

## Description

PowerShell 스크립트를 다양한 간격으로 실행하는 예약된 작업을 생성 및 구성합니다:
- 시스템 시작
- 사용자 로그온
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-FilePath` | String | — | — | 0 | `''` | 작업 스크립트가 생성될 디렉터리 경로 |
