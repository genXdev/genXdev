...
> 웹 브라우저에서 ChatGPT 쿼리를 엽니다.

## Description

웹 브라우저에서 ChatGPT를 열고 지정된 쿼리를 자동으로 입력하여 제출합니다. 기본 Open-WebsiteAndPerformQuery 함수를 사용하여 실행되는 여러 쿼리를 지원합니다. 이 함수는 광범위한 브라우저 구성 옵션을 통해 PowerShell에서 OpenAI의 ChatGPT와 상호 작용할 수 있는 편리한 방법을 제공합니다.
...
| `-ShowWindow` | SwitchParameter | — | — | Named | — | 브라우저 창 표시 |
...
- [Open-CloudLLMChat](https://github.com/genXdev/genXdev/blob/main/Docs/ko-KR/Open-CloudLLMChat.md)
