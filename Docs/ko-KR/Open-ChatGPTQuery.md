...
웹 브라우저에서 ChatGPT를 열고, 지정된 쿼리를 자동으로 입력한 후 제출합니다. 기본 Open-WebsiteAndPerformQuery 함수를 사용하여 여러 쿼리를 실행할 수 있습니다. 이 함수는 광범위한 브라우저 구성 옵션을 통해 PowerShell에서 OpenAI의 ChatGPT와 상호 작용할 수 있는 편리한 방법을 제공합니다.
...
| `-ShowWindow` | SwitchParameter | — | — | Named | — | 브라우저 창을 표시합니다 |
...
전체 매개변수 이름을 사용하여 여러 쿼리를 제출하십시오.
