...
기본적으로 전체 화면이 활성화된 애플리케이션 모드로 열려 카탈로그의 최적의 보기 환경을 제공합니다.
모니터 배치, 창 크기 조정, 언어 기본 설정 등 모든 표준 웹 브라우저 구성 옵션을 지원합니다.

이 함수는 최상의 카탈로그 보기 환경을 위해 브라우저를 자동으로 구성하며 여러 브라우저 인스턴스를 동시에 열 수 있습니다.
포괄적인 언어 지원을 제공하며 브라우저 선택 및 위치 지정에 대한 사용자 기본 설정을 존중합니다.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Language` | String | — | — | 0 | — | 반환된 검색 결과의 언어 |
...
| `-ShowWindow` | SwitchParameter | — | — | Named | — | 브라우저 창을 표시합니다(최소화되거나 숨겨지지 않음) |
...
모니터 1에서 GenXdev 앱 카탈로그를 애플리케이션 모드로 열고 전체 화면을 활성화합니다.
...
별칭 명령을 사용하여 모니터 1에서 GenXdev 앱 카탈로그를 엽니다.
...
- [Open-GameOfLife](https://github.com/genXdev/genXdev/blob/main/Docs/ko-KR/Open-GameOfLife.md)
