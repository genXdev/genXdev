...
> 지정된 URL에 대한 SimilarWeb 웹사이트 정보를 웹 브라우저에서 엽니다.

## Description

구성 가능한 방식으로 명령줄 스위치를 사용하여 웹 브라우저에서 "Similar Web" 쿼리를 엽니다. 웹사이트 트래픽 분석, 경쟁사 조사, 디지털 마케팅 인사이트를 위한 웹사이트 분석 및 비교를 확인할 수 있습니다.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Queries` | String[] | ✅ | ✅ (ByValue, ByPropertyName) | 0 | — | SimilarWeb에서 분석할 웹사이트 URL들 |
...
주 모니터에서 Google.com의 SimilarWeb 분석을 엽니다.
...
함수 별칭을 사용하여 모니터 위치와 함께 SimilarWeb 분석을 엽니다.
...
파이프라인 입력을 통해 여러 웹사이트를 분석하며, 창이 중앙에 위치합니다.
...
브라우저를 열지 않고 GitHub의 SimilarWeb URL을 반환합니다.

## Parameter Details

### `-Queries <String[]>`

> SimilarWeb에서 분석할 웹사이트 URL들
