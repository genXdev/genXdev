...
> 현재 시간, 날짜, 세기, 천년을 표시하는 대화형 타임라인을 엽니다.

## Description

웹 기반 대화형 타임라인을 엽니다.
여러 언어와 시각적 사용자 지정 옵션을 지원합니다.
...
| `-BrowserExtensions` | SwitchParameter | — | — | Named | — | 브라우저 확장 프로그램 로드를 차단하지 않음 |
...
| `-Language` | String | — | — | 1 | — | 기본 브라우저 언어를 재정의하거나 [모두]를 선택하여 모든 언어를 매분 순환합니다. |
| `-DragedNodeBackground` | String | — | — | Named | `$null` | 현재 드래그 중인 노드의 배경을 칠하기 위한 css-color-style 덮어쓰기 |
| `-FocusedNodeBackground` | String | — | — | Named | `$null` | 중앙에 있는 포커스된 노드의 배경을 칠하기 위한 css-color-style을 재정의합니다 |
| `-FocusedNodeForeground` | String | — | — | Named | `$null` | 포커스된(중앙) 노드의 전경 텍스트를 칠하기 위한 css-color-style을 재정의합니다. |
| `-UnFocusedNodeBackground` | String | — | — | Named | `$null` | 중앙에 있는 포커스된 노드의 배경을 칠하기 위한 css-color-style을 재정의합니다 |
| `-UnFocusedNodeForeground` | String | — | — | Named | `$null` | 포커스되지 않은 노드(중앙에 있는)의 전경 텍스트를 그리기 위한 css-color-style을 재정의합니다. |
| `-BorderLightColor` | String | — | — | Named | `$null` | 기본 CSS 테두리-밝은-색상(colorstyle) 덮어쓰기 |
| `-BorderDarkColor` | String | — | — | Named | `$null` | 기본 CSS border-dark-color 색상 스타일 덮어쓰기 |
| `-BorderWidth` | Int32 | — | — | Named | `1` | 노드 테두리 그리기의 기본 너비를 재정의합니다 |
...
반 고흐에서 영감을 받은 시각 자료와 함께 영어로 대화형 타임라인을 엽니다.
...
> 기본 브라우저 언어를 재정의하거나 [모두]를 선택하여 모든 언어를 매분 순환합니다.
...
> 현재 드래그 중인 노드의 배경을 칠하기 위한 css-color-style 덮어쓰기
...
> 중앙에 있는 포커스된 노드의 배경을 칠하기 위한 css-color-style을 재정의합니다
...
> 포커스된(중앙) 노드의 전경 텍스트를 칠하기 위한 css-color-style을 재정의합니다.
...
> 포커스되지 않은 노드(중앙에 있는)의 전경 텍스트를 그리기 위한 css-color-style을 재정의합니다.
...
> 기본 CSS 테두리-밝은-색상(colorstyle) 덮어쓰기
...
> 기본 CSS border-dark-color 색상 스타일 덮어쓰기
