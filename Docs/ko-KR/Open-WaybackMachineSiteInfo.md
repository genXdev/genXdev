...
웹 브라우저에서 Waybackmachine 쿼리를 열어 지정된 URL 또는 웹사이트의 과거 버전을 표시합니다. 여러 쿼리와 모니터 선택을 지원합니다. Internet Archive의 Wayback Machine 서비스를 통해 보관된 웹 콘텐츠에 액세스할 수 있습니다.
...
| `-Language` | String | — | — | 1 | — | 브라우저 인터페이스 및 콘텐츠의 언어 기본 설정 |
...
| `-SessionOnly` | SwitchParameter | — | — | Named | — | Wayback Machine 환경 설정에 대해 세션에 저장된 대체 설정 사용 |
| `-ClearSession` | SwitchParameter | — | — | Named | — | 세션에 저장된 Wayback Machine 환경 설정의 대체 설정을 지웁니다. |
...
모니터 위치 지정이 무시된 상태에서 별칭을 사용하여 example.com에 대한 Wayback Machine 아카이브를 엽니다.
...
Chrome의 시크릿 모드에서 microsoft.com에 대한 Wayback Machine 아카이브를 엽니다.
...
> Wayback Machine 환경 설정에 대해 세션에 저장된 대체 설정 사용
...
> 세션에 저장된 Wayback Machine 환경 설정의 대체 설정을 지웁니다.
