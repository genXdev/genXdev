...
| `-Language` | String | — | — | 1 | — | 브라우저 인터페이스와 콘텐츠의 언어 설정 |
...
| `-SessionOnly` | SwitchParameter | — | — | Named | — | 세션에 저장된 대체 설정을 사용하여 Wayback Machine 기본 설정 지정 |
| `-ClearSession` | SwitchParameter | — | — | Named | — | Wayback Machine 환경 설정을 위해 세션에 저장된 대체 설정을 지웁니다. |
