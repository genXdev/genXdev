...
웹 브라우저에서 도메인 이름 또는 IP 주소에 대한 Whois 호스트 정보 조회를 엽니다. 구성 가능한 모니터 선택과 여러 쿼리를 지원하며 창 위치, 브라우저 선택 및 자동화 기능을 포함한 광범위한 브라우저 구성 옵션을 제공합니다.
...
| `-SessionOnly` | SwitchParameter | — | — | Named | — | 세션에 저장된 대체 설정을 사용하여 언어, 이미지 컬렉션 등의 AI 기본 설정을 적용합니다. |
| `-ClearSession` | SwitchParameter | — | — | Named | — | AI 기본 설정(언어, 이미지 컬렉션 등)에 대한 세션에 저장된 대체 설정을 지웁니다. |
| `-SkipSession` | SwitchParameter | — | — | Named | — | 언어, 이미지 컬렉션 등 AI 기본 설정에 대해 세션에 영향을 주지 않고 영구 기본 설정에만 설정을 저장합니다. |
...
별칭 및 위치 매개 변수를 사용하여 example.com에 대한 Whois 정보를 엽니다.
...
파이프라인에서 도메인의 Whois 정보를 Chrome 비공개 모드로 엽니다.
...
> 세션에 저장된 대체 설정을 사용하여 언어, 이미지 컬렉션 등의 AI 기본 설정을 적용합니다.
...
> AI 기본 설정(언어, 이미지 컬렉션 등)에 대한 세션에 저장된 대체 설정을 지웁니다.
...
> 언어, 이미지 컬렉션 등 AI 기본 설정에 대해 세션에 영향을 주지 않고 영구 기본 설정에만 설정을 저장합니다.
