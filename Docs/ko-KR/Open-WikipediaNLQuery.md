...
웹 브라우저에서 '위키백과 - 네덜란드' 검색을 열며, 표시 옵션을 구성할 수 있습니다. 여러 검색어를 지원하고 결과를 표시할 모니터를 지정할 수 있습니다.
...
| `-SideBySide` | SwitchParameter | — | — | Named | — | 두 개의 브라우저 창을 나란히 엽니다 |
| `-SessionOnly` | SwitchParameter | — | — | Named | — | 세션 전용 쿠키 사용 (영구 쿠키 없음) |
