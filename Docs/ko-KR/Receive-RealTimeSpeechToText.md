...
이 cmdlet은 마이크나 데스크톱에서 오디오를 캡처하고 Whisper AI 모델을 사용하여 실시간으로 텍스트로 변환합니다. 다양한 오디오 소스, 무음 감지 및 음성 인식을 위한 여러 구성 옵션을 지원합니다.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-ModelFileDirectoryPath` | String | — | — | Named | — | 모델 파일 경로 |
| `-UseDesktopAudioCapture` | SwitchParameter | — | — | Named | `False` | 데스크톱 오디오 캡처를 마이크 대신 사용할지 여부 |
| `-UseDesktopAndRecordingDevice` | SwitchParameter | — | — | Named | `False` | 데스크톱 오디오 캡처와 녹음 장치를 동시에 사용할지 여부 |
| `-AudioDevice` | String | — | — | Named | — | 데스크톱과 녹음 장치를 모두 사용 |
...
| `-IgnoreSilence` | SwitchParameter | — | — | Named | `False` | 무음 무시 여부 (타임스탬프가 손상될 수 있음) |
| `-MaxDurationOfSilence` | Nullable`1[[System.TimeSpan, System.Private.CoreLib, Version=10.0.0.0, Culture=neutral, PublicKeyToken=7cec85d7bea7798e]] | — | — | Named | — | 자동으로 녹음을 중지하기 전 최대 무음 지속 시간 |
| `-SilenceThreshold` | Nullable`1[[System.Int32, System.Private.CoreLib, Version=10.0.0.0, Culture=neutral, PublicKeyToken=7cec85d7bea7798e]] | — | — | Named | — | 소리 감지 임계값 (0~32767, 기본값 30) |
...
> 데스크톱 오디오 캡처와 녹음 장치를 동시에 사용할지 여부
