...
> 지정된 창을 전면으로 가져와 활성 창으로 만듭니다.

## Description

* 여러 Win32 API 메서드를 사용하여 최대한 안정적으로 창을 포그라운드 창으로 만듭니다.
* 먼저 SwitchToThisWindow API를 사용하려고 시도한 후, 필요한 경우 SetForegroundWindow로 대체합니다.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-WindowHandle` | IntPtr | ✅ | — | 0 | `0` | 포그라운드 창으로 설정할 창 핸들 |
