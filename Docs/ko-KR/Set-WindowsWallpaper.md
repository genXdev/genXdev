...
* 지정된 디렉터리에서 임의의 이미지 파일을 선택하여 Windows 바탕 화면 배경으로 설정합니다.
* JPG/JPEG 이미지 형식을 지원하며 기본적으로 배경 화면을 화면에 맞게 설정합니다.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-InputObject` | Object | — | ✅ (ByValue, ByPropertyName) | 0 | — | 배경 화면 이미지가 포함된 디렉터리의 경로 |
...
C:\Wallpapers 디렉터리에서 무작위 배경화면을 설정합니다.
...
별칭을 사용하여 기본 디렉터리에서 임의의 배경 화면을 설정합니다.

## Parameter Details

### `-InputObject <Object>`

> 배경 화면 이미지가 포함된 디렉터리의 경로
