...
Open-Webbrowser의 모든 매개변수가 지원되며 브라우저 위치 지정, 동작 및 모양을 제어하기 위해 전달됩니다. 이 함수는 일관된 사분면 위치 지정을 적용하면서 브라우저 시작 매개변수의 전체 사용자 지정을 허용하는 래퍼 역할을 합니다.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Url` | String | ✅ | ✅ (ByValue, ByPropertyName) | 0 | — | 모든 브라우저에서 동시에 열 URL |
