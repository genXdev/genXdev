...
> Verbetert tekst door contextueel passende emoticons toe te voegen met behulp van AI.

## Description

Deze functie verwerkt invoertekst om emoticons toe te voegen die passen bij de emotionele context. Het kan invoer accepteren via parameters, uit de pijplijn of van het systeemklembord. De functie maakt gebruik van AI-modellen om de tekst te analyseren en geschikte emoticons te selecteren, waardoor berichten expressiever en aantrekkelijker worden.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Text` | String | — | ✅ (ByValue) | 0 | — | De tekst om te verrijken met emoji's |
...
> De tekst om te verrijken met emoji's
