...
Voegt een idee met tijdstempel toe aan de sectie "## Ideeën" van een README.md-bestand.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Line` | String | — | — | 0 | `''` | Het idee tekst om toe te voegen |
...
> Het idee tekst om toe te voegen
