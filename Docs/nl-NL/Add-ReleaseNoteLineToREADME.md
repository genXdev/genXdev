...
Voegt een ReleaseNote-regel toe aan het opgegeven README-bestand, voorafgegaan door de huidige datum in yyyyMMdd-indeling. De regel kan als code worden opgemaakt en optioneel worden weergegeven.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Line` | String | — | — | 0 | `''` | De tekst van de ReleaseNote-beschrijving om toe te voegen |
| `-Code` | SwitchParameter | — | — | Named | — | Formatteer de regel als code |
| `-Show` | SwitchParameter | — | — | Named | — | Geef de README weer na het toevoegen van de regel |
...
> De tekst van de ReleaseNote-beschrijving om toe te voegen
...
> Geef de README weer na het toevoegen van de regel
