...
> Converteert beleefde, professionele bedrijfstaal naar directe, duidelijke taal met behulp van AI.

## Description

Deze functie verwerkt invoertekst om diplomatieke, zakelijke communicatie om te zetten in directere en duidelijkere taal. Het kan invoer rechtstreeks accepteren via parameters, vanuit de pijplijn of vanuit het systeemklembord. De functie maakt gebruik van AI-modellen om tekst te analyseren en te herformuleren, met behoud van de oorspronkelijke intentie.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Text` | String | — | ✅ (ByValue) | 0 | — | De tekst om te zetten van bedrijfsjargon |
...
> De tekst om te zetten van bedrijfsjargon
