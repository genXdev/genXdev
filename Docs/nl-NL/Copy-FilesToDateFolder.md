...
> Kopieert bestanden die overeenkomen met zoekcriteria naar submappen op basis van datum.

## Description

Zoekt naar bestanden met dezelfde parameterset als `Find-Item` en kopieert elk overeenkomend bestand naar een submap van `TargetFolder`, gebaseerd op de aanmaak- of mediadatum van het bestand. De cmdlet ondersteunt inhoudsovereenkomst, schijfbrede zoekopdrachten en vele filters.

Probeert verschillende strategieën om een nauwkeurige aanmaak- of opnamedatum voor het opgegeven bestand te bepalen. Strategieën omvatten het lezen van EXIF-metadata van afbeeldingen, het parseren van datum/tijd-informatie uit bestandsnamen, en terugvallen op de laatste schrijftijd van het bestand wanneer geen andere betrouwbare informatie beschikbaar is.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-TargetFolder` | String | ✅ | — | 0 | — | Doelmap waar overeenkomende bestanden worden gekopieerd naar submap op basis van datum |
...
Kopieer-BestandenNaarDatumMap -Doelmap 'E:\Media\Videos' -Naam '.\*.mp4'

## Parameter Details

### `-TargetFolder <String>`

> Doelmap waar overeenkomende bestanden worden gekopieerd naar submap op basis van datum
