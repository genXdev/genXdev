...
Breidt een gegeven bestandsverwijzing uit naar een volledig pad, ten opzichte van de huidige map van de gebruiker. Kan optioneel controleren of mappen of bestanden bestaan.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-FilePath` | String | ✅ | ✅ (ByValue, ByPropertyName) | 0 | — | Pad om uit te vouwen |
| `-CreateDirectory` | SwitchParameter | — | — | Named | — | Maakt een map aan als deze nog niet bestaat |
| `-CreateFile` | SwitchParameter | — | — | Named | — | Maakt een leeg bestand aan als dit nog niet bestaat |
| `-DeleteExistingFile` | SwitchParameter | — | — | Named | — | Verwijdert het bestand als het al bestaat |
| `-ForceDrive` | Char | — | — | Named | `'*'` | Forceert het gebruik van een specifiek station |
| `-FileMustExist` | SwitchParameter | — | — | Named | — | Zal een fout geven als het bestand niet bestaat |
| `-DirectoryMustExist` | SwitchParameter | — | — | Named | — | Wordt een fout gegenereerd als de map niet bestaat |
...
> Maakt een leeg bestand aan als dit nog niet bestaat
...
> Verwijdert het bestand als het al bestaat
...
> Forceert het gebruik van een specifiek station
...
> Zal een fout geven als het bestand niet bestaat
...
> Wordt een fout gegenereerd als de map niet bestaat
