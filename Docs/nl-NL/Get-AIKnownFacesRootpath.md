...
> Haalt de geconfigureerde map op voor gezichtsafbeeldingsbestanden die worden gebruikt in GenXdev.AI-bewerkingen.

## Description

Deze functie haalt de globale gezichtsdirectory op die wordt gebruikt door de GenXdev.AI-module voor verschillende gezichtsherkennings- en AI-bewerkingen. Het controleert eerst globale variabelen (tenzij SkipSession is opgegeven), valt dan terug op persistente voorkeuren en gebruikt ten slotte systeemstandaarden.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-FacesDirectory` | String | — | — | 0 | — | Mappad voor gezichtsafbeeldingsbestanden |
...
Haalt de momenteel geconfigureerde gezichtenmap op uit globale variabelen of voorkeuren.
...
Haalt alleen de geconfigureerde gezichtenmap op uit persistente voorkeuren, waarbij eventuele sessie-instellingen worden genegeerd.
...
Wist de sessie mappeninstelling voor gezichten en haalt vervolgens de map op uit persistente voorkeuren.
...
Retourneert de opgegeven map na het uitbreiden van het pad.

## Parameter Details

### `-FacesDirectory <String>`

> Mappad voor gezichtsafbeeldingsbestanden
