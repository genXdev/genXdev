...
> Retourneert een woordenboek van alle geïnstalleerde BCP 47-taaltags en hun weergavenamen.
...
* Gebruikt de .NET CultureInfo API om alle specifieke culturen te inventariseren die op het systeem zijn geïnstalleerd, waardoor dit de gezaghebbende bron van waarheid is voor PowerShell-help taalmapnamen en vertaaldoeltalen.
* Woordenboeksleutels omvatten:
  ...
  - Eenvoudige taalnamen toegewezen aan hun meest voorkomende regio (bijv. "English" -> "en-US", "Dutch" -> "nl-NL")
```
## Syntax
...
Haal het volledige BCP 47-woordenboek op.
...
Valideer en los een taalcode op voor het genereren van help.
