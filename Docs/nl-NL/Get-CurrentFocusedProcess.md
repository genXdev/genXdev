...
* Deze cmdlet gebruikt Windows API-aanroepen via P/Invoke om het Procesobject te identificeren en retourneren dat is gekoppeld aan het momenteel gefocuste venster.
* Het maakt gebruik van de User32.dll-functies GetForegroundWindow en GetWindowThreadProcessId om te bepalen welk venster focus heeft en het bijbehorende proces-ID te verkrijgen.
...
Haalt het procesobject op voor het venster dat momenteel de toetsenbordfocus heeft.
