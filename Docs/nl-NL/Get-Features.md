...
> Geeft functies weer uit een README.md-bestand.

## Description

Toont alle functies uit de sectie "## Features" van een README.md-bestand. Kan de README in de huidige locatie, de PowerShell-profielmap of de OneDrive-map gebruiken.
...
| `-First` | Int32 | — | — | 0 | `0` | Beperk uitvoer tot de eerste N regels |
...
> Beperk uitvoer tot de eerste N regels
