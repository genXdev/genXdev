...
> Berekent de afgelegde afstand tijdens vrije val voor een bepaalde tijdsduur.
...
| `-TerminalVelocityInMetersPerSecond` | Double | — | — | 1 | `0` | De eindsnelheid in meters per seconde (standaard: 53) |
...
Berekent de in 10 seconden gevallen afstand in voet.
...
> De eindsnelheid in meters per seconde (standaard: 53)
...
> De versnelling door de zwaartekracht in m/s² (standaard: 9,81)
...
> De eenheid voor de uitvoerafstand
