...
> Berekent de gevallen hoogte tijdens vrije val voor een gegeven tijdsduur.

## Description

Berekent de afstand die valt tijdens vrije val met behulp van een numerieke methode die rekening houdt met luchtweerstand en eindsnelheid.
...
Berekent de gevallen hoogte in 10 seconden met standaard menselijke eindsnelheid.
...
Berekent de gevallen hoogte in 5 seconden met behulp van positionele parameter en standaard eindsnelheid.
...
Berekent de gevallen hoogte in 10 seconden en retourneert het resultaat in voet.

## Parameter Details

### `-DurationInSeconds <Double>`

> De tijdsduur van de val in seconden
...
> De eenheid voor de uitvoerhoogte
