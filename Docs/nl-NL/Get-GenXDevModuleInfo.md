...
Deze functie onderzoekt GenXdev PowerShell-modules en retourneert informatie over hun configuratie, versies en aanwezigheid van belangrijke bestanden. Het kan zowel opgegeven modules als alle beschikbare modules verwerken.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-ModuleName` | String[] | — | ✅ (ByValue, ByPropertyName) | 0 | `@()` | Namen van modules die moeten worden geanalyseerd |
...
> Namen van modules die moeten worden geanalyseerd
