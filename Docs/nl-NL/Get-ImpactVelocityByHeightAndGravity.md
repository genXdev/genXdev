...
> Berekent impactsnelheid op basis van hoogte.

## Description

Gebruikt v = sqrt(2 g h) waarbij luchtweerstand wordt genegeerd.
...
| `-As` | String | — | — | 2 | — | Uitvoereenheid voor snelheid. Standaard 'm/s'. |
...
Berekent impactsnelheid voor een val van 100 meter en voert uit in km/u.
...
Berekent de impactsnelheid voor een val van 50 meter met standaard eenheden.
...
> Uitvoereenheid voor snelheid. Standaard 'm/s'.
