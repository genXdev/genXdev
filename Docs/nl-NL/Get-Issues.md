...
> Geeft problemen weer uit een README.md-bestand.

## Description

Toont alle problemen uit de sectie '## Issues' van een README.md-bestand. Kan de README in de huidige locatie, PowerShell-profielmap of OneDrive-map gebruiken.
