...
| `-As` | String | — | — | 2 | — | Uitvoereenheid voor energie |
...
Berekent kinetische energie voor een massa van 10 kg die met 5 m/s beweegt en voert uit in calorieën.
...
Berekent kinetische energie voor een massa van 5 kg die beweegt met 10 m/s met behulp van positionele parameters.
