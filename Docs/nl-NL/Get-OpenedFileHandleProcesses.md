...
> Haalt processen op die open bestandshandvatten hebben naar opgegeven bestanden.

## Description

* Gebruikt het Sysinternals-handle.exe-hulpprogramma om processen te identificeren die
  momenteel open ingangen hebben naar een of meer opgegeven bestanden.
* Nuttig om te bepalen welke processen bestandsbewerkingen zoals verwijderen of
  wijzigen belemmeren.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-FilePath` | String[] | ✅ | ✅ (ByValue, ByPropertyName) | 0 | — | Het pad naar het bestand/de bestanden dat/die moet worden gecontroleerd op openstaande handvatten |
...
Identificeert alle processen die open ingangen naar het opgegeven bestand hebben.
...
Controleert meerdere bestanden via pijplijninvoer op processen met open handvatten.

## Parameter Details

### `-FilePath <String[]>`

> Het pad naar het bestand/de bestanden dat/die moet worden gecontroleerd op openstaande handvatten
