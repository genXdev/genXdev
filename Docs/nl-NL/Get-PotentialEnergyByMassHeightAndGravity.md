...
> Berekent de gravitationele potentiële energie.
...
| `-As` | String | — | — | 3 | — | Uitvoereenheid voor energie |
...
Berekent de zwaarte-energie voor een massa van 10 kg op een hoogte van 5 meter, en geeft het resultaat weer in calorieën.
