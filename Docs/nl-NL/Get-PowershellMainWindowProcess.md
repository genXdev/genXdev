...
* Doorloopt de processtructuur omhoog vanaf het huidige PowerShell-proces om het bovenliggende venster te vinden dat verantwoordelijk is voor het hosten van de terminal.
* Als het directe bovenliggende proces geen hoofdvensterhandle heeft, zoekt het naar vergelijkbare processen die wel hoofdvensters hebben.
...
Retourneert het proces dat de huidige PowerShell-sessie host en toont de naam.
