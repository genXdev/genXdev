...
> Berekent de brekingshoek met behulp van de wet van Snellius.
...
| `-As` | String | — | — | 3 | — | Uitvoereenheid voor hoek |
...
Berekent de brekingshoek wanneer licht van lucht (n=1) naar water (n=1,33) gaat bij een invalshoek van 30 graden.
...
Berekent de brekingshoek wanneer licht van lucht (n=1) naar glas (n=1,5) gaat onder een invalshoek van 45 graden.

## Parameter Details

### `-IncidentAngleInDegrees <Double>`

> Invalshoek in graden
...
> Brekingsindex van het eerste medium
...
> Brekingsindex van het tweede medium
