...
Gebruikt f = v / (4L) voor de grondfrequentie.
...
| `-As` | String | — | — | 2 | — | Uitvoereenheid voor frequentie |
...
Berekent de resonantiefrequentie voor een buis van 1 meter met een golfsnelheid van 343 m/s.
