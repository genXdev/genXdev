...
> Haalt een lijst met tabelnamen uit een SQL Server-database op.

## Description

Voert een query uit op de systeemtabellen van SQL Server om alle door de gebruiker gedefinieerde tabelnamen op te halen uit een SQL Server-database. Ondersteunt verbinding via een directe verbindingsreeks of een databasenaam met serverparameters. Retourneert de tabelnamen als een verzameling tekenreeksen.
