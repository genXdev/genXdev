...
Analyseert de opgegeven films om gemeenschappelijke eigenschappen te vinden en retourneert een lijst van 10 vergelijkbare filmtitels. Gebruikt AI om patronen en thema's in de invoerfilms te identificeren om relevante aanbevelingen te suggereren.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Movies` | String[] | ✅ | — | 0 | — | Array van filmtitels om op overeenkomsten te analyseren |
...
| `-Monitor` | Int32 | — | — | Named | `-1` | Monitorindex of -naam voor plaatsing van browservenster |
| `-Width` | Int32 | — | — | Named | `-1` | Breedte van het browservenster in pixels |
| `-Height` | Int32 | — | — | Named | `-1` | Hoogte van het browservenster in pixels |
| `-AcceptLang` | String | — | — | Named | — | Accept-Language HTTP-header voor browsersessie |
| `-Private` | SwitchParameter | — | — | Named | — | Open browser in private/incognito-modus |
| `-Chrome` | SwitchParameter | — | — | Named | — | Gebruik Google Chrome voor browsersessie |
| `-Chromium` | SwitchParameter | — | — | Named | — | Gebruik Chromium voor de browsersessie |
| `-Firefox` | SwitchParameter | — | — | Named | — | Gebruik Mozilla Firefox voor de browsersessie |
| `-Left` | Int32 | — | — | Named | — | Linkerpositie van het browservenster in pixels |
| `-Right` | Int32 | — | — | Named | — | Rechterpositie van het browser venster in pixels |
| `-Bottom` | Int32 | — | — | Named | — | Onderste positie van het browservenster in pixels |
| `-Centered` | SwitchParameter | — | — | Named | — | Open browservenster gecentreerd op het scherm |
| `-FullScreen` | SwitchParameter | — | — | Named | — | Open browser in volledig scherm |
| `-ApplicationMode` | SwitchParameter | — | — | Named | — | Open browser in applicatiemodus (minimale gebruikersinterface) |
| `-NoBrowserExtensions` | SwitchParameter | — | — | Named | — | Browser-extensies uitschakelen voor sessie |
| `-DisablePopupBlocker` | SwitchParameter | — | — | Named | — | Popup blocker uitschakelen in browsersessie |
| `-FocusWindow` | SwitchParameter | — | — | Named | — | Het browservenster focussen na het openen |
| `-SetForeground` | SwitchParameter | — | — | Named | — | Browser venster naar voorgrond zetten na openen |
| `-Maximize` | SwitchParameter | — | — | Named | — | Maximaliseer het browservenster na het openen |
| `-RestoreFocus` | SwitchParameter | — | — | Named | — | Focus herstellen naar vorig venster na het sluiten van de browser |
| `-NewWindow` | SwitchParameter | — | — | Named | — | Open elk IMDB-resultaat in een nieuw browservenster |
| `-ReturnURL` | SwitchParameter | — | — | Named | — | Retourneer de URL na het openen van de IMDB-zoekopdracht |
| `-ReturnOnlyURL` | SwitchParameter | — | — | Named | — | Geef alleen de URL terug zonder de browser te openen |
| `-SendKeyEscape` | SwitchParameter | — | — | Named | — | Stuur Escape-toets naar browser na openen |
| `-SendKeyHoldKeyboardFocus` | SwitchParameter | — | — | Named | — | Toetsenbordfocus in browser behouden na het verzenden van toetsen |
| `-SendKeyUseShiftEnter` | SwitchParameter | — | — | Named | — | Gebruik Shift+Enter bij het verzenden van toetsaanslagen naar de browser |
| `-SendKeyDelayMilliSeconds` | Int32 | — | — | Named | — | Vertraging in milliseconden tussen het verzenden van toetsen naar de browser |
| `-NoBorders` | SwitchParameter | — | — | Named | — | Open browservenster zonder randen |
...
| `-SideBySide` | SwitchParameter | — | — | Named | — | Open browser vensters naast elkaar voor elk resultaat |
...
| `-Instructions` | String | — | — | Named | — | Instructies voor het AI-model over het genereren van de tekenreekslijst |
| `-Attachments` | String[] | — | — | Named | — | Matrix van bestandspaden om bij te voegen |
| `-ImageDetail` | String | — | — | Named | — | Detailniveau van afbeelding voor beeldverwerking. |
| `-Functions` | Collections.Hashtable[] | — | — | Named | — | Matrix met functiedefinities die door het AI-model kunnen worden aangeroepen tijdens de verwerking. |
| `-ExposedCmdLets` | GenXdev.Helpers.ExposedCmdletDefinition[] | — | — | Named | — | Array van PowerShell-opdrachtdefinities om als hulpmiddelen te gebruiken die de AI kan aanroepen. |
| `-NoConfirmationToolFunctionNames` | String[] | — | — | Named | — | Reeks opdrachtnamen die geen bevestiging vereisen voor uitvoering. |
| `-AudioTemperature` | Double | — | — | Named | — | Temperatuur voor audiogeneratie. |
| `-TemperatureResponse` | Double | — | — | Named | — | Temperatuur voor het genereren van reacties. |
...
| `-DontSpeakThoughts` | SwitchParameter | — | — | Named | — | Schakel gedachten uitspraak uit. |
...
New-AzureRmVM -ResourceGroupName $ResourceGroup.ResourceGroupName -Location $ResourceGroup.Location `
    -VM $VMConfig |
| `-SetClipboard` | SwitchParameter | — | — | Named | — | Wanneer opgegeven, kopieert de resulterende tekenreekslijst na verwerking terug naar het systeemklembord. |
...
| `-AllowDefaultTools` | SwitchParameter | — | — | Named | — | Standaard tools inschakelen voor het AI-model. |
...
> Array van filmtitels om op overeenkomsten te analyseren
...
> Taal voor IMDB-zoekopdracht of browsersessie
...
> Monitorindex of -naam voor plaatsing van browservenster
...
> Breedte van het browservenster in pixels
...
> Hoogte van het browservenster in pixels
...
> Accept-Language HTTP-header voor browsersessie
...
> Open browser in private/incognito-modus
...
> Gebruik Google Chrome voor browsersessie
...
> Gebruik Chromium voor de browsersessie
...
> Gebruik Mozilla Firefox voor de browsersessie
...
> Linkerpositie van het browservenster in pixels
...
> Rechterpositie van het browser venster in pixels
...
> Onderste positie van het browservenster in pixels
...
> Open browservenster gecentreerd op het scherm
...
> Open browser in volledig scherm
...
> Open browser in applicatiemodus (minimale gebruikersinterface)
...
> Browser-extensies uitschakelen voor sessie
...
> Popup blocker uitschakelen in browsersessie
...
> Browser venster naar voorgrond zetten na openen
...
> Maximaliseer het browservenster na het openen
...
> Focus herstellen naar vorig venster na het sluiten van de browser
...
> Open elk IMDB-resultaat in een nieuw browservenster
...
> Retourneer de URL na het openen van de IMDB-zoekopdracht
...
> Geef alleen de URL terug zonder de browser te openen
...
> Stuur Escape-toets naar browser na openen
...
> Toetsenbordfocus in browser behouden na het verzenden van toetsen
...
> Gebruik Shift+Enter bij het verzenden van toetsaanslagen naar de browser
...
> Vertraging in milliseconden tussen het verzenden van toetsen naar de browser
...
> Open browservenster zonder randen
...
> Open browser vensters naast elkaar voor elk resultaat
...
> Detailniveau van afbeelding voor beeldverwerking.
...
> Matrix met functiedefinities die door het AI-model kunnen worden aangeroepen tijdens de verwerking.
...
> Array van PowerShell-opdrachtdefinities om als hulpmiddelen te gebruiken die de AI kan aanroepen.
...
> Reeks opdrachtnamen die geen bevestiging vereisen voor uitvoering.
...
> Schakel gedachten uitspraak uit.
...
> Wanneer opgegeven, kopieert de resulterende tekenreekslijst na verwerking terug naar het systeemklembord.
...
> Standaard tools inschakelen voor het AI-model.
