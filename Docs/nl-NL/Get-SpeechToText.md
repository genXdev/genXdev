...
> Converteert audiobestanden naar tekst met behulp van het Whisper-spraakherkenningsmodel van OpenAI.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-ModelFileDirectoryPath` | String | — | — | Named | — | Pad naar de modelbestandsdirectory |
| `-Input` | Object | ✅ | ✅ (ByValue) | 0 | — | Pads naar audiobestand, een FileInfo-object of een ander audioformaat dat door Whisper wordt ondersteund. |
...
| `-ModelType` | Whisper.net.Ggml.GgmlType | — | — | Named | `Tiny` | Te gebruiken Whisper-modeltype, standaard LargeV3Turbo |
...
Transcribeert Spaanse audio en vertaalt het naar het Engels.
...
Retourneert SegmentData-objecten met precieze timinginformatie.

## Parameter Details

### `-ModelFileDirectoryPath <String>`

> Pad naar de modelbestandsdirectory
...
> Pads naar audiobestand, een FileInfo-object of een ander audioformaat dat door Whisper wordt ondersteund.
