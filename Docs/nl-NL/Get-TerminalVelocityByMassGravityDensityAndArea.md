...
| `-AreaInSquareMeters` | Double | ✅ | — | 3 | `0` | Dwarsdoorsnede in m² |
| `-DragCoefficient` | Double | — | — | 4 | `0` | Weerstandscoëfficiënt (standaard: 0,5) |
| `-As` | String | — | — | 5 | — | Uitvoereenheid voor snelheid |
...
Berekent de eindsnelheid voor een massa van 80 kg in lucht met een weerstandscoëfficiënt van 1,0, en geeft het resultaat in mph.
...
> Weerstandscoëfficiënt (standaard: 0,5)
