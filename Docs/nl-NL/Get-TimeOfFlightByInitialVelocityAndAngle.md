...
| `-As` | String | — | — | 3 | — | Uitvoereenheid voor tijd |
...
Berekent de vluchttijd voor een projectiel dat wordt gelanceerd met 20 m/s onder een hoek van 45 graden, uitvoer in minuten.
