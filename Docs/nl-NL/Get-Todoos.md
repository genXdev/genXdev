...
> Geeft todo-items weer uit een README.md-bestand.

## Description

Toont alle taken uit het '## Todoos'-gedeelte van een README.md-bestand. Kan de README in de huidige locatie, de PowerShell-profielmap of de OneDrive-map gebruiken.
