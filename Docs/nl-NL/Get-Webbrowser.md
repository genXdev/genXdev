...
* Detecteert moderne webbrowsers die op het systeem zijn geïnstalleerd en retourneert details over deze browsers.
* Haalt informatie op zoals naam, beschrijving, pictogrampad, uitvoerbaar pad en standaardbrowserstatus door de Windows-registerdatabase op te vragen.
...
Filters om alleen de systeemstandaardbrowser weer te geven.

## Parameter Details

### `-Edge`

> Selecteert Microsoft Edge browserinstanties
...
> Selecteert Google Chrome browserinstanties
...
> Selecteert de standaard chromium-gebaseerde browser
...
> Selecteert Firefox browserinstanties
