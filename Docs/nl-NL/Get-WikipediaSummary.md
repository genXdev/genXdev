...
Queryt de Wikipedia API om een beknopte samenvatting van het opgegeven onderwerp te krijgen,
waarbij inhoud tussen haakjes wordt verwijderd voor een betere leesbaarheid.
...
- [Get-NextAffirmation](https://github.com/genXdev/genXdev/blob/main/Docs/nl-NL/Get-NextAffirmation.md)
