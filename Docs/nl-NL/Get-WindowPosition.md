...
> Haalt de positie- en statusinformatie van vensters op.

## Description

Haalt gedetailleerde informatie op over vensterpositionering, grootte, monitorplaatsing,
dockingstatus en focusstatus voor gespecificeerde processen of vensterhandvatten.
