...
* Bouwt een uitgebreide lijst van zoekpaden door standaard systeemlocaties, Chocolatey-paden, ontwikkeltoolpaden en aangepaste pakketpaden te combineren.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-WorkspaceFolder` | String | — | — | 0 | — | Het pad naar de werkruimtemap dat moet worden gebruikt voor node-modules en PowerShell-paden. |
...
Initialiseert zoekpaden met behulp van de standaardwerkruimtemap.
...
> Het pad naar de werkruimtemap dat moet worden gebruikt voor node-modules en PowerShell-paden.
