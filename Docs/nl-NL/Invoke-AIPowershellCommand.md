...
> Genereert en voert PowerShell-opdrachten uit met behulp van AI-ondersteuning.

## Description

Gebruikt AI-modellen om PowerShell-opdrachten te genereren op basis van natuurlijke taalquery's. De functie kan opdrachten rechtstreeks naar het PowerShell-venster sturen of naar het klembord kopiëren. Het maakt gebruik van AI-modellen om natuurlijke taal te interpreteren en om te zetten in uitvoerbare PowerShell-opdrachten met uitgebreide parameterondersteuning voor verschillende AI-backends.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-PowershellCmdline` | String | ✅ | — | 0 | — | De natuurlijke taalquery om een commando te genereren voor |
...
Gebruikt het alias om een opdracht te genereren voor het vinden van bestanden die vandaag zijn gewijzigd.
...
Genereert een opdracht om een service te stoppen en kopieert deze naar het klembord.

## Parameter Details

### `-PowershellCmdline <String>`

> De natuurlijke taalquery om een commando te genereren voor
