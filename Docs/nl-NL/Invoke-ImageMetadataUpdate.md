...
> Werk EXIF-metadata voor afbeeldingen in een map bij.
...
wordt opgeslagen in alternatieve NTFS-streams als :EXIF.json voor later gebruik door indexerings- en
zoekfuncties.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-ImageDirectories` | String[] | — | — | 0 | `@('.\')` | Matrix van mappaden om te verwerken voor bijwerken van afbeeldingsmetadata |
| `-RetryFailed` | SwitchParameter | — | — | Named | — | Eerdere mislukte metadatabijwerkingen van afbeeldingen worden opnieuw geprobeerd |
| `-OnlyNew` | SwitchParameter | — | — | Named | — | Verwerk alleen afbeeldingen die nog geen metadatabestanden hebben |
| `-Recurse` | SwitchParameter | — | — | Named | — | Indien opgegeven, verwerkt afbeeldingen ook in submappen (recursief). |
| `-Force` | SwitchParameter | — | — | Named | — | Dwing herbouw van metagegevens af, zelfs als deze al bestaan |
| `-PassThru` | SwitchParameter | — | — | Named | — | Retourneer gestructureerde objecten in plaats van uitvoer naar console |
...
| `-SkipSession` | SwitchParameter | — | — | Named | — | Gebruik geen alternatieve instellingen die zijn opgeslagen in sessie voor AI-voorkeuren zoals Taal, Afbeeldingscollecties, enz. |
...
> Matrix van mappaden om te verwerken voor bijwerken van afbeeldingsmetadata
...
> Eerdere mislukte metadatabijwerkingen van afbeeldingen worden opnieuw geprobeerd
...
> Verwerk alleen afbeeldingen die nog geen metadatabestanden hebben
...
> Indien opgegeven, verwerkt afbeeldingen ook in submappen (recursief).
...
> Dwing herbouw van metagegevens af, zelfs als deze al bestaan
...
> Retourneer gestructureerde objecten in plaats van uitvoer naar console
...
> Gebruik geen alternatieve instellingen die zijn opgeslagen in sessie voor AI-voorkeuren zoals Taal, Afbeeldingscollecties, enz.
