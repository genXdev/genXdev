...
> Werk de metagegevens voor scèneclassificatie bij voor afbeeldingsbestanden in een opgegeven map.

## Description

Deze functie verwerkt afbeeldingen in een opgegeven map om scènes te classificeren met behulp van kunstmatige intelligentie. Het maakt JSON-metadatabestanden aan met scèneclassificaties, betrouwbaarheidsscores en labels. De functie ondersteunt batchverwerking met configureerbare betrouwbaarheidsdrempels en kan optioneel bestaande metadatabestanden overslaan of eerder mislukte classificaties opnieuw proberen.
...
Gebruikt alias om mislukte classificaties opnieuw te proberen en alleen nieuwe afbeeldingen in meerdere mappen te verwerken.
...
Dwingt herbouw van de container af en gebruikt GPU-versnelling voor snellere verwerking.
...
Verwerkt alle afbeeldingen recursief en slaat alleen scèneclassificaties op met betrouwbaarheid >= 60%.
