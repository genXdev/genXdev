...
> Evalueert een verklaring met behulp van AI om te bepalen of deze waar of onwaar is.

## Description

Deze functie gebruikt AI-modellen om uitspraken te evalueren en hun waarheidswaarde te bepalen. Het kan invoer accepteren via parameters, vanuit de pijplijn of vanaf het systeemklembord. De functie retourneert een booleaans resultaat samen met het betrouwbaarheidsniveau en de onderbouwing van het AI-model.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Text` | String | — | ✅ (ByValue) | 0 | — | Het volgende bevat PowerShell-cmdlet-help-teksten die moeten worden vertaald naar het Nederlands (Nederland). Vertaal ALLEEN voor mensen leesbare tekst. Geef GEEN code, opmaak of gestructureerde gegevens terug anders dan de vertaalde tekst. Behoud alle syntaxis, structuur en technische elementen zoals programmeersleutelwoorden, tags of dataformaat-specifieke elementen. Vertaal alleen voor mensen leesbare tekstgedeelten zoals opmerkingen, tekenreekswaarden, documentatie of natuurlijke taalinhoud. Houd exact dezelfde opmaak, inspringing en regeleinden aan. Vertaal nooit id's, functienamen, variabelen of technische sleutelwoorden. |
...
| `-AllowDefaultTools` | SwitchParameter | — | — | Named | — | AI toestaan om standaardhulpmiddelen en -mogelijkheden te gebruiken |
...
| `-OutputMarkdownBlocksOnly` | SwitchParameter | — | — | Named | — | Gebruik deze opdracht om de WiredTiger-cachegrootte in te stellen die wordt gebruikt door MongoDB. Bedenk dat hoe groter de cache, hoe meer gegevens MongoDB in het geheugen kan opslaan, wat over het algemeen de queryprestaties verbetert, maar tegelijkertijd ook het geheugengebruik verhoogt. |
| `-MarkupBlocksTypeFilter` | String[] | — | — | Named | — | Filteren op specifieke typen opmaakblokken |
...
| `-SuppressRegex` | String | — | — | Named | — | Reguliere expressie om uit uitvoer te onderdrukken |
| `-AudioContextSize` | Int32 | — | — | Named | — | Audio contextgrootte voor verwerking |
| `-SilenceThreshold` | Double | — | — | Named | — | Drempelwaarde voor stilte bij audiodetectie |
| `-LengthPenalty` | Double | — | — | Named | — | Straf voor lengte bij sequentiegeneratie |
| `-EntropyThreshold` | Double | — | — | Named | — | Entropiedrempel voor uitvoerfiltering |
| `-LogProbThreshold` | Double | — | — | Named | — | Drempelwaarde voor logkans bij uitvoerfiltering |
...
| `-DontSpeakThoughts` | SwitchParameter | — | — | Named | — | Spraakuitvoer voor gedachten uitschakelen |
| `-NoVOX` | SwitchParameter | — | — | Named | — | Schakel VOX (spraakactivering) uit |
| `-UseDesktopAudioCapture` | SwitchParameter | — | — | Named | — | Gebruik desktopaudio-opname voor invoer |
...
| `-OnlyResponses` | SwitchParameter | — | — | Named | — | .PARAMETER Force
Hiermee wordt de opdracht uitgevoerd zonder verdere bevestiging. |
...
> Het volgende bevat PowerShell-cmdlet-help-teksten die moeten worden vertaald naar het Nederlands (Nederland). Vertaal ALLEEN voor mensen leesbare tekst. Geef GEEN code, opmaak of gestructureerde gegevens terug anders dan de vertaalde tekst. Behoud alle syntaxis, structuur en technische elementen zoals programmeersleutelwoorden, tags of dataformaat-specifieke elementen. Vertaal alleen voor mensen leesbare tekstgedeelten zoals opmerkingen, tekenreekswaarden, documentatie of natuurlijke taalinhoud. Houd exact dezelfde opmaak, inspringing en regeleinden aan. Vertaal nooit id's, functienamen, variabelen of technische sleutelwoorden.
...
> Instructies voor het AI-model over hoe de verklaring te evalueren
...
> Voeg geen modelgedachten toe aan de gespreksgeschiedenis
...
> AI toestaan om standaardhulpmiddelen en -mogelijkheden te gebruiken
...
> Gebruik deze opdracht om de WiredTiger-cachegrootte in te stellen die wordt gebruikt door MongoDB. Bedenk dat hoe groter de cache, hoe meer gegevens MongoDB in het geheugen kan opslaan, wat over het algemeen de queryprestaties verbetert, maar tegelijkertijd ook het geheugengebruik verhoogt.
...
> Filteren op specifieke typen opmaakblokken
...
> Temperatuur voor willekeurigheid van audiorespons
...
> Reguliere expressie om uit uitvoer te onderdrukken
...
> Drempelwaarde voor stilte bij audiodetectie
...
> Gebruik desktopaudio-opname voor invoer
...
> Gebruik geen context in de query
