...
> Transformeert tekst met behulp van AI-gestuurde verwerking.

## Description

Deze functie verwerkt invoertekst met behulp van AI-modellen om verschillende transformaties uit te voeren, zoals spellingcontrole, het toevoegen van emoticons of elke andere tekstverbetering die via instructies wordt gespecificeerd. Het kan invoer rechtstreeks via parameters, van de pijplijn of van het systeemklembord accepteren.
...
Hiermee wordt de naam van de computer opgegeven waarvoor u de netwerkstuurprogrammagebeurtenissen wilt ophalen. Als deze parameter wordt weggelaten, wordt de opdracht uitgevoerd op de lokale computer. |
| `-Instructions` | String | — | — | 1 | `('Check and correct any spelling or grammar ' +
            'errors in the text. Return the corrected text without any ' +
            'additional comments or explanations.')` | Deze cmdlet retourneert alleen groepen waarvan ik lid ben in de huidige sessie. |
...
> Deze cmdlet retourneert alleen groepen waarvan ik lid ben in de huidige sessie.
