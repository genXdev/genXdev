...
Opent een Bing CoPilot-query in de webbrowser. De functie typt automatisch de query en verzendt deze met behulp van de onderliggende Open-WebsiteAndPerformQuery-functie. Dit biedt een handige manier om vanuit PowerShell met Microsoft Copilot te communiceren.
...
| `-SkipSession` | SwitchParameter | — | — | Named | — | Sla browsersessie-/profiel laden over. |
