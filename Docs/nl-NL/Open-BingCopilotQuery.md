...
> Opent een Bing CoPilot-query in een webbrowser

## Description

Opent een Bing CoPilot-query in de webbrowser. De functie typt automatisch de query en verzendt deze met behulp van de onderliggende functie Open-WebsiteAndPerformQuery. Dit biedt een handige manier om vanuit PowerShell met Microsoft Copilot te communiceren.
...
| `-SessionOnly` | SwitchParameter | — | — | Named | — | Gebruik sessie-alleen-modus voor browserprofiel. |
| `-ClearSession` | SwitchParameter | — | — | Named | — | Wis browsersessie/profiel voordat u opent. |
| `-SkipSession` | SwitchParameter | — | — | Named | — | Sessie/profiel laden van browser overslaan. |
...
> Gebruik sessie-alleen-modus voor browserprofiel.
...
> Wis browsersessie/profiel voordat u opent.
...
> Sessie/profiel laden van browser overslaan.
