...
Opent een of meerdere Bing-zoekopdrachten in een webbrowser, met configureerbare browserinstellingen en opdrachtregelschakelaars. Deze functie biedt een uitgebreide interface voor het uitvoeren van Bing-zoekopdrachten met uitgebreide aanpassingsmogelijkheden voor de browser, waaronder vensterpositionering, monitorkeuze, privé browsen en toetsenbordautomatisering.

De functie codeert zoekopdrachten automatisch in URL-formaat en formatteert ze voor de Bing-zoek-API. Het ondersteunt alle grote browsers zoals Edge, Chrome en Firefox met functies zoals privé browsen, applicatiemodus, nauwkeurig vensterbeheer en toetsenbordautomatisering.
...
Opent een Bing-zoekopdracht voor 'PowerShell scripting' op de standaardmonitor.
...
Opent een Bing-zoekopdracht met behulp van de alias en korte parameternamen.
...
Opent een privé-browsersessie om te zoeken naar 'machine learning' met
...
Zoekt naar meerdere termen via pijplijn en opent resultaten in alle geïnstalleerde browsers, waarbij vensters aan de linkerkant van het scherm worden geplaatst.
