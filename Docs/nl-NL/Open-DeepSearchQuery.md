...
> Opent een DeepSeek-query in een webbrowser

## Description

Opent een DeepSeek-query in de webbrowser, typt de query in en drukt op Enter om de zoekopdracht uit te voeren. Deze functie maakt gebruik van de DeepSeek AI-zoekmachine om intelligente antwoorden en inzichten te bieden voor de opgegeven query's.
...
Opent DeepSeek en zoekt naar "powershell function" met standaardinstellingen.
...
Gebruikt het alias om te zoeken naar "powershell function" met standaardparameters.
...
Opent DeepSeek in de volledige-schermmodus op het primaire beeldscherm om te zoeken naar "machine learning basics".
