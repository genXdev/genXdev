...
Wordt geopend in de applicatiemodus met volledig scherm standaard ingeschakeld voor een optimale
weergave-ervaring van de catalogus. Ondersteunt alle standaard webbrowserconfiguratie-opties,
waaronder monitorplaatsing, venstergrootte en taalvoorkeuren.

De functie configureert de browser automatisch voor de beste catalogusweergave-ervaring
en kan meerdere browserinstanties tegelijk openen. Het biedt uitgebreide taalondersteuning
en respecteert gebruikersvoorkeuren voor browserselectie en -positionering.
...
Opent de GenXdev app-catalogus op monitor 1 met behulp van de alias-opdracht.
