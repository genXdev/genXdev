...
> Opent een Github CoPilot-query in een webbrowser

## Description

Opent een Github CoPilot-query in de webbrowser en voert automatisch de opgegeven query in. De functie wacht tot de pagina is geladen voordat de query wordt getypt. Deze functie maakt gebruik van de onderliggende Open-WebsiteAndPerformQuery-functie voor browserautomatisering en biedt een handige manier om vanuit PowerShell met GitHub Copilot te werken, inclusief uitgebreide browserconfiguratieopties.
