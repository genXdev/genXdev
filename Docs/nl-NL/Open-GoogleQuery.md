...
> Opent Google-zoekopdrachten in een webbrowser met configureerbare instellingen en uitgebreide aanpassingsmogelijkheden.

## Description

Opent een of meerdere Google-query's in een webbrowser met uitgebreide ondersteuning
voor meerdere talen, monitorselectie, vensterpositionering, browser-
selectie en toetsenbordautomatisering. De functie biedt een functierijke
interface voor het uitvoeren van Google-zoekopdrachten met nauwkeurige controle over browser-
gedrag en -uiterlijk.

Belangrijke functies zijn onder andere:
- Ondersteuning voor meer dan 100 talen via Google's taal filter
- Ondersteuning voor meerdere monitoren met automatische of handmatige monitorselectie
- Vensterpositionering (links, rechts, boven, onder, gecentreerd, volledig scherm)
- Ondersteuning voor privé-/incognito browse-modus
...
- Batch-queryverwerking met pijplijnondersteuning
- Toetsenbordautomatisering naar browservensters
- Slimme parameterdoorvoer naar onderliggende browserfuncties

De functie formatteert zoekopdrachten automatisch voor Google's zoekmachine
en past taalfiltering toe wanneer gespecificeerd. Alle browserpositionerings- en
beheerfuncties worden overgenomen van de onderliggende Open-Webbrowser-functie.
...
Opent een Google-zoekopdracht voor "PowerShell scripting" in het Engels op het primaire beeldscherm.
...
Opent een Google-zoekopdracht voor "machine learning algorithms" in volledig scherm op monitor 2 met behulp van aliassen.
...
Opent meerdere Google-zoekopdrachten in Chrome via pipeline-invoer, elk in het Engels.
...
Opent een privé-zoekopdracht voor 'kunstmatige intelligentie' in een nieuw venster.
...
Opent een zoekopdracht in de toepassingsmodus (geen browserbediening) gecentreerd op het scherm.
