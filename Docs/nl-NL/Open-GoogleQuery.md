...
> Opent Google-query's in een webbrowser met configureerbare instellingen en uitgebreide aanpassingsmogelijkheden.

## Description

Opent een of meerdere Google-zoekopdrachten in een webbrowser met uitgebreide ondersteuning
voor meerdere talen, monitorselectie, vensterpositionering, browserselectie
en toetsenbordautomatisering. De functie biedt een rijk aan interfaces
voor het uitvoeren van Google-zoekopdrachten met nauwkeurige controle over browser
engedrag en uiterlijk.

Belangrijkste functies zijn:
- Ondersteuning voor 100+ talen via Google's taalfilter
- Ondersteuning voor meerdere monitors met automatische of handmatige monitorselectie
...
- Focusbeheer en vensterbewerking
- Batchverwerking van queries met pijplijnondersteuning
...
en past taalfiltering toe indien gespecificeerd. Alle browserpositionerings- en
beheerfuncties zijn overgenomen van de onderliggende Open-Webbrowser-functie.
...
Opent een Google-zoekopdracht voor 'PowerShell scripting' in het Engels op de primaire monitor.
...
Opent een Google-zoekopdracht voor 'machine learning algoritmen' in volledig scherm op monitor 2 met behulp van aliassen.
...
Opent meerdere Google-zoekopdrachten in Chrome via pijplijninvoer, elk in het Engels.
...
Opent een privé-browsingzoekopdracht voor "kunstmatige intelligentie" in een nieuw venster.
...
Opent een zoekopdracht in de modus Toepassing (geen browserbesturingselementen) gecentreerd op het scherm.

## Parameter Details

### `-Queries <String[]>`

> De zoektermen om op Google te zoeken
...
> De taal voor Google-zoekresultaten
