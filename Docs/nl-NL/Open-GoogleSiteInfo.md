...
> Opent Google-site-informatiequery's in een webbrowser.

## Description

Opent meerdere Google-zoekopdrachten met betrekking tot site-informatie (site:, link:, related:) in een webbrowser voor de opgegeven domein(en).
...
| `-SessionOnly` | SwitchParameter | — | — | Named | — | Gebruik sessie-only-modus voor browserprofiel (geen permanente gegevens) |
| `-ClearSession` | SwitchParameter | — | — | Named | — | Browsersessie-/profielgegevens wissen voordat u opent |
| `-SkipSession` | SwitchParameter | — | — | Named | — | Sla het gebruik van een browsersessie/-profiel over (gebruik standaard) |
...
> Gebruik sessie-only-modus voor browserprofiel (geen permanente gegevens)
...
> Browsersessie-/profielgegevens wissen voordat u opent
...
> Sla het gebruik van een browsersessie/-profiel over (gebruik standaard)
