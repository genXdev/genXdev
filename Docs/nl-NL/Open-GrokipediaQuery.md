...
De functie biedt uitgebreide browserbesturing, waaronder privé-navigatiemodi, vensterpositionering, toetsenbordautomatisering en ondersteuning voor meerdere monitoren. Het verwerkt automatisch URL-codering en taalcode-mapping voor internationale Grokipedia-domeinen.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Queries` | String[] | ✅ | ✅ (ByValue, ByPropertyName) | 0 | — | De Grokipedia-zoekopdracht die moet worden uitgevoerd |
...
Zoekt naar meerdere termen in Grokipedia met de privémodus.
