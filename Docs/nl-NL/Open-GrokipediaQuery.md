...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Queries` | String[] | ✅ | ✅ (ByValue, ByPropertyName) | 0 | — | De te zoeken query in Grokipedia is het uitvoeren van de volgende zoekopdracht |
...
| `-PassThru` | SwitchParameter | — | — | Named | — | Geeft een PowerShell-procesobject terug dat het browserproces vertegenwoordigt |
