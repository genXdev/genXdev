...
Opent een 'Similar web'-query in een webbrowser op een configureerbare manier met behulp van opdrachtregelopties. Hiermee kunt u website-analyses en vergelijkingen controleren voor websiteverkeersanalyse, concurrentieonderzoek en digitale marketinginzichten.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Queries` | String[] | ✅ | ✅ (ByValue, ByPropertyName) | 0 | — | De website-URL's om te analyseren op SimilarWeb |
...
Opent een SimilarWeb-analyse met behulp van de functiealias en monitorpositionering.
...
Retourneert de SimilarWeb-URL voor GitHub zonder de browser te openen.

## Parameter Details

### `-Queries <String[]>`

> De website-URL's om te analyseren op SimilarWeb
