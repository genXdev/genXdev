...
> Opent een interactieve tijdlijn met de huidige tijd, datum, eeuw en millennium.
...
| `-BrowserExtensions` | SwitchParameter | — | — | Named | — | Voorkom niet dat browserextensies worden geladen |
...
| `-SpectateOnly` | SwitchParameter | — | — | Named | — | Begin geen nieuw spel, kijk alleen hoe de AI speelt |
...
| `-Language` | String | — | — | 1 | — | Standaardbrowsertaal overschrijven of [Alle] selecteren voor elke minuut rotatie van alle talen |
| `-DragedNodeBackground` | String | — | — | Named | `$null` | Overschrijf de css-kleurstijl voor het schilderen van de achtergrond van het momenteel gesleepte knooppunt |
| `-FocusedNodeBackground` | String | — | — | Named | `$null` | Overschrijf de css-color-stijl voor het schilderen van de achtergrond van het gefocuste knooppunt (in het midden) |
| `-FocusedNodeForeground` | String | — | — | Named | `$null` | Overschrijf de css-kleur-stijl voor het schilderen van de voorgrondtekst van het gefocusseerde knooppunt (in het midden) |
| `-UnFocusedNodeBackground` | String | — | — | Named | `$null` | Overschrijf de css-color-stijl voor het schilderen van de achtergrond van het gefocuste knooppunt (in het midden) |
| `-UnFocusedNodeForeground` | String | — | — | Named | `$null` | Overschrijf de css-kleur stijl voor het schilderen van de niet-gefocuste knooppunt (in het midden) voorgrondtekst |
| `-BorderLightColor` | String | — | — | Named | `$null` | Overschrijf de standaard css border-light-color colorstyle |
| `-BorderDarkColor` | String | — | — | Named | `$null` | Overschrijf de standaard css border-dark-color kleurstijl |
| `-BorderWidth` | Int32 | — | — | Named | `1` | Overschrijf de standaardbreedte voor het tekenen van de knooppuntranden |
| `-RotationDelaySeconds` | Int32 | — | — | Named | `15` | De standaardbreedte voor de rotatievertraging van de achtergrond overschrijven |
...
Opent een interactieve tijdlijn met visuele stijlen geïnspireerd op Van Gogh.
...
> Voorkom niet dat browserextensies worden geladen
...
> Begin geen nieuw spel, kijk alleen hoe de AI speelt
...
> Standaardbrowsertaal overschrijven of [Alle] selecteren voor elke minuut rotatie van alle talen
...
> Overschrijf de css-kleurstijl voor het schilderen van de achtergrond van het momenteel gesleepte knooppunt
...
> Overschrijf de css-color-stijl voor het schilderen van de achtergrond van het gefocuste knooppunt (in het midden)
...
> Overschrijf de css-kleur-stijl voor het schilderen van de voorgrondtekst van het gefocusseerde knooppunt (in het midden)
...
> Overschrijf de css-kleur stijl voor het schilderen van de niet-gefocuste knooppunt (in het midden) voorgrondtekst
...
> Overschrijf de standaard css border-light-color colorstyle
...
> Overschrijf de standaard css border-dark-color kleurstijl
...
> Overschrijf de standaardbreedte voor het tekenen van de knooppuntranden
...
> De standaardbreedte voor de rotatievertraging van de achtergrond overschrijven
...
- [Open-GameOfLife](https://github.com/genXdev/genXdev/blob/main/Docs/nl-NL/Open-GameOfLife.md)
