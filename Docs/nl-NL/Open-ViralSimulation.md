...
> Opent een virussimulatiespel in een webbrowser met uitgebreide configuratieopties.

## Description

Opent de virale simulatiegame op https://viral.genxdev.net/ in een opgegeven webbrowser met configureerbare vensterinstellingen, positionering en gedragsopties. Ondersteunt meerdere browsers, privénavigatie, applicatiemodus en uitgebreide vensterbeheerfuncties.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Language` | String | — | — | 0 | — | De taal voor de weergave van webinhoud en de browser taalinstellingen |
...
| `-Monitor` | Int32 | — | — | Named | `-2` | De monitor om te gebruiken, 0 = standaard, -1 is negeren, -2 = geconfigureerde secundaire monitor, standaard ingesteld op $Global:DefaultSecondaryMonitor of 2 indien niet gevonden |
...
Opent virale simulatie in Google Chrome in de privémodus zonder volledig scherm.
...
> De taal voor de weergave van webinhoud en de browser taalinstellingen
