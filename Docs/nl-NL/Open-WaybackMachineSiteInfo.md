...
| `-SessionOnly` | SwitchParameter | — | — | Named | — | Gebruik alternatieve instellingen opgeslagen in sessie voor Wayback Machine voorkeuren |
| `-ClearSession` | SwitchParameter | — | — | Named | — | Alternatieve instellingen die zijn opgeslagen in de sessie voor Wayback Machine-voorkeuren gewist |
