...
Opent een Waybackmachine-query in een webbrowser, met historische versies van de opgegeven URL of website. Ondersteunt meerdere queries en monitorselectie. Biedt toegang tot gearchiveerde webinhoud via de Wayback Machine-service van het Internet Archive.
...
Opent het Wayback Machine-archief voor example.com met behulp van aliassen met monitorpositionering verwijderd.
