...
> Opent WaybackMachine-site-informatie in een webbrowser.

## Description

Opent een Waybackmachine-query in een webbrowser, met weergave van historische versies
van de opgegeven URL of website. Ondersteunt meerdere query's en monitor-
selectie. Biedt toegang tot gearchiveerde webinhoud via de Wayback Machine-service
...
| `-Language` | String | — | — | 1 | — | De taalvoorkeur voor de browserinterface en -inhoud |
...
| `-SessionOnly` | SwitchParameter | — | — | Named | — | Gebruik alternatieve instellingen opgeslagen in de sessie voor Wayback Machine-voorkeuren |
| `-ClearSession` | SwitchParameter | — | — | Named | — | Wis alternatieve instellingen opgeslagen in sessie voor Wayback Machine voorkeuren |
...
Opent het Wayback Machine-archief voor example.com op de standaardmonitor.
...
Opent het Wayback Machine-archief voor example.com met behulp van aliassen waarbij monitorpositionering wordt genegeerd.
...
Opent het Wayback Machine-archief voor microsoft.com in de incognitomodus van Chrome.
...
> De taalvoorkeur voor de browserinterface en -inhoud
...
> Gebruik alternatieve instellingen opgeslagen in de sessie voor Wayback Machine-voorkeuren
...
> Wis alternatieve instellingen opgeslagen in sessie voor Wayback Machine voorkeuren
