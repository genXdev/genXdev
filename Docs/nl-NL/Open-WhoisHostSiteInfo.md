...
> Opent een Whois-hostinformatiequery in een webbrowser.

## Description

Opent Whois hostinformatiequery's in een webbrowser voor domeinnamen of IP-adressen. Ondersteunt configureerbare monitorkeuze en meerdere query's met uitgebreide browserconfiguratieopties, waaronder vensterpositionering, browserkeuze en automatiseringsfuncties.
...
| `-SessionOnly` | SwitchParameter | — | — | Named | — | Gebruik alternatieve instellingen opgeslagen in de sessie voor AI-voorkeuren zoals taal, afbeeldingscollecties, enz. |
| `-ClearSession` | SwitchParameter | — | — | Named | — | Wis gewiste alternatieve instellingen opgeslagen in sessie voor AI-voorkeuren zoals taal, afbeeldingsverzamelingen, enz. |
| `-SkipSession` | SwitchParameter | — | — | Named | — | Bewaar instellingen alleen in permanente voorkeuren zonder de sessie te beïnvloeden voor AI-voorkeuren zoals taal, afbeeldingscollecties, enz. |
...
Opent Whois-informatie voor meerdere domeinen op het standaard beeldscherm.
...
Opent de Whois-informatie voor example.com met behulp van aliassen en positionele parameters.
...
Opent WhoIs-informatie voor domeinen uit de pijplijn in de privémodus van Chrome.
