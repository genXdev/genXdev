...
> Opent een Wikipedia-query in een webbrowser.

## Description

Opent een of meerdere Wikipedia-zoekopdrachten in een webbrowser met uitgebreide configuratiemogelijkheden. Ondersteunt configureerbaar browser gedrag, monitorselectie en vensterpositionering. Zoekopdrachten worden URL-gecodeerd en geopend met het opgegeven taal Wikipedia-domein met volledige lokalisatie ondersteuning.

De functie biedt uitgebreide browsercontrole, inclusief privé browsen modi, vensterpositionering, toetsenbordautomatisering en ondersteuning voor meerdere monitoren. Het behandelt automatisch URL-codering en taalcodetoewijzing voor internationale Wikipedia-domeinen.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Queries` | String[] | ✅ | ✅ (ByValue, ByPropertyName) | 0 | — | De Wikipedia-zoekopdracht om uit te voeren |
| `-Language` | String | — | — | 1 | — | De taal van de Wikipedia-zoekresultaten |
...
| `-PassThru` | SwitchParameter | — | — | Named | — | Retourneert een PowerShell-procesobject dat het browserproces vertegenwoordigt |
...
Opent een Wikipedia-zoekopdracht voor 'PowerShell' in het Engels op de standaardmonitor.
...
Opent een Wikipedia-zoekopdracht met behulp van het alias met positionele parameters.
...
Zoekt naar meerdere termen in de Duitse Wikipedia met behulp van de privénavigatiemodus.

## Parameter Details

### `-Queries <String[]>`

> De Wikipedia-zoekopdracht om uit te voeren
...
> De taal van de Wikipedia-zoekresultaten
