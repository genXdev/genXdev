...
Opent een of meerdere Wolfram Alpha-query's in een webbrowser. Ondersteunt configureerbare monitorselectie en browseropties via dynamische parameters. Biedt uitgebreide browsercontrole, inclusief positionering, formaataanpassing en automatiseringsmogelijkheden voor verbeterde wetenschappelijke rekenworkflows.
...
| `-SendKeyEscape` | SwitchParameter | — | — | Named | — | Ontsnap besturingstekens bij het verzenden van toetsen. |
...
| `-SendKeyUseShiftEnter` | SwitchParameter | — | — | Named | — | Stuur Shift+Enter in plaats van gewoon Enter voor regeleinden bij het verzenden van toetsen. |
...
| `-ClearSession` | SwitchParameter | — | — | Named | — | Wis alternatieve instellingen die in de sessie zijn opgeslagen voor AI-voorkeuren. |
| `-SkipSession` | SwitchParameter | — | — | Named | — | Sla instellingen alleen op in permanente voorkeuren zonder de sessie te beïnvloeden. |
...
Opent meerdere Wolfram Alpha-query's met behulp van de alias voor snelle wetenschappelijke berekeningen.
...
Opent een calculusquery in volledig scherm met Engelse taalvoorkeur
via pijplijninvoer.
...
> Stuur Shift+Enter in plaats van gewoon Enter voor regeleinden bij het verzenden van toetsen.
