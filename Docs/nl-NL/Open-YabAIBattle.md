...
Deze functie start het YabAI Battle-spel in een webbrowser met uitgebreide aanpassingsopties voor vensterplaatsing, browserkeuze en weergavemodus. Het biedt een wrapper rond de GenXdev\Open-Webbrowser-functie met gamespecifieke URL-constructie en parameterafhandeling.

De functie ondersteunt twee spelmodi:
- Gevechtsmodus: Start een nieuwe AI vs AI-veldslag
- Toeschouwermodus: Bekijk bestaande AI-veldslagen

Opties voor browserpositionering omvatten links, rechts, boven, onder, gecentreerd en volledig scherm met ondersteuning voor meerdere monitoren. De functie handelt automatisch instellingen voor de toepassingsmodus en browserextensiebeheer af voor een optimale speelervaring.
...
> Vertraging in milliseconden tussen het verzenden van elke toets.
...
> Herstel de focus naar het vorige venster na het openen van de browser.
