...
> Open YouTube-zoekopdrachten in een webbrowser.

## Description

Opent één of meerdere YouTube-zoekopdrachten in een webbrowser met uitgebreide positionerings- en configuratiemogelijkheden. Ondersteunt configureerbare monitorselectie, browserinstellingen en toetsenbordautomatisering via dynamische parameters die zijn overgenomen van de Open-Webbrowser-cmdlet. Elke query wordt geopend in een aparte browserinstantie met volledige controle over vensterpositionering, browsertype en zoektaal.
...
Opent een YouTube-zoekopdracht voor "PowerShell tutorial" op de standaardmonitor.
...
Opent een YouTube-zoekopdracht voor "how to code" op de geconfigureerde secundaire monitor met behulp van de functiealias.
