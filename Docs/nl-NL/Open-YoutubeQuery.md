...
> Opent YouTube-zoekopdrachten in een webbrowser.

## Description

Opent een of meerdere YouTube-zoekopdrachten in een webbrowser met uitgebreide positionerings- en configuratiemogelijkheden. Ondersteunt configureerbare monitorselectie, browserinstellingen en toetsenbordautomatisering via dynamische parameters die worden overgenomen van de Open-Webbrowser cmdlet. Elke zoekopdracht wordt geopend in een aparte browserinstantie met volledige controle over vensterpositionering, browsertype en zoektaal.
...
Opent een YouTube-zoekopdracht voor 'hoe te programmeren' op de geconfigureerde secundaire monitor met behulp van de functie-alias.
