...
> Haalt de laatste actieve vensterhelper van de stapel met optionele aanpassingen.

## Description

Haalt een vensterhelper van de stapel en past optioneel venstertransformaties toe. Als de stapel leeg is of ongeldige vensters bevat, wordt het momenteel gefocuste venster geretourneerd. Met deze functie kunt u vensters manipuleren die eerder zijn opgeslagen met Push-Window, waarbij verschillende positionerings-, formaat- en visuele effecten worden toegepast.
