...
> Duwt het huidige venster naar de vensterstack met optionele aanpassingen.

## Description

Duwt een vensterhelper voor het momenteel gefocuste venster op de stapel.
Maakt het mogelijk om verschillende venstertransformaties toe te passen voor of na het duwen.
Deze functie legt de huidige venster vast en slaat het op voor later ophalen
