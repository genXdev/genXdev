...
> Duwt het huidige venster naar de vensterstack met optionele wijzigingen.

## Description

Pusht een vensterhelper voor het momenteel gefocuste venster op de stapel.
Maakt het mogelijk om verschillende venstertransformaties toe te passen voor of na het pushen.
Deze functie legt het huidige venster vast en slaat het op voor later ophalen
met Pop-Window, terwijl optioneel positionering, grootte en visuele
effecten kunnen worden toegepast.
