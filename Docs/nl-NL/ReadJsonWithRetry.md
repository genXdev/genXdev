...
> Leest JSON-bestand met opnieuw proberen en automatische vergrendelingsopruiming.

## Description

Probeert een JSON-bestand te lezen met herhaallogica om gelijktijdige toegang af te handelen.
Implementeert automatische opruiming van verlopen vergrendelingsbestanden. Geeft een lege hashtable terug als
