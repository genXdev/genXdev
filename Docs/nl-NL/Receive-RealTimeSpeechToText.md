...
Deze cmdlet legt audio van microfoon of bureaublad vast en transponeert dit in real-time naar tekst met behulp van het Whisper AI-model. Het ondersteunt verschillende audiobronnen, stiltedetectie en meerdere configuratie-opties voor spraakherkenning.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-ModelFileDirectoryPath` | String | — | — | Named | — | Pad naar het modelbestand |
| `-UseDesktopAudioCapture` | SwitchParameter | — | — | Named | `False` | Of u desktop-audiocaptuur wilt gebruiken in plaats van microfoon |
| `-UseDesktopAndRecordingDevice` | SwitchParameter | — | — | Named | `False` | Of zowel desktop-audio-opname als opnameapparaat tegelijkertijd moeten worden gebruikt |
| `-AudioDevice` | String | — | — | Named | — | Gebruik zowel desktop als opnameapparaat |
| `-Passthru` | SwitchParameter | — | — | Named | `False` | Retourneert objecten in plaats van tekenreeksen |
| `-WithTokenTimestamps` | SwitchParameter | — | — | Named | `False` | Of token-tijdstempels moeten worden opgenomen |
| `-TokenTimestampsSumThreshold` | Single | — | — | Named | `0` | Drempelwaarde voor som van token-tijdstempels, standaard ingesteld op 0,5 |
| `-SplitOnWord` | SwitchParameter | — | — | Named | `False` | Of er op woordgrenzen moet worden gesplitst |
| `-MaxTokensPerSegment` | Nullable`1[[System.Int32, System.Private.CoreLib, Version=10.0.0.0, Culture=neutral, PublicKeyToken=7cec85d7bea7798e]] | — | — | Named | — | Maximaal aantal tokens per segment |
| `-IgnoreSilence` | SwitchParameter | — | — | Named | `False` | Of stilte genegeerd moet worden (zal tijdstempels verstoren) |
| `-MaxDurationOfSilence` | Nullable`1[[System.TimeSpan, System.Private.CoreLib, Version=10.0.0.0, Culture=neutral, PublicKeyToken=7cec85d7bea7798e]] | — | — | Named | — | Maximale duur van stilte voordat de opname automatisch stopt |
| `-SilenceThreshold` | Nullable`1[[System.Int32, System.Private.CoreLib, Version=10.0.0.0, Culture=neutral, PublicKeyToken=7cec85d7bea7798e]] | — | — | Named | — | Stille-detectiedrempel (0..32767, standaard 30) |
| `-LanguageIn` | String | — | — | Named | — | Stelt de invoertaal in om te detecteren, standaard ingesteld op 'nl' |
...
| `-TemperatureInc` | Nullable`1[[System.Single, System.Private.CoreLib, Version=10.0.0.0, Culture=neutral, PublicKeyToken=7cec85d7bea7798e]] | — | — | Named | — | Temperatuurverhoging |
| `-WithTranslate` | SwitchParameter | — | — | Named | `False` | Of de uitvoer moet worden vertaald |
...
| `-WithProgress` | SwitchParameter | — | — | Named | `False` | Of de voortgang moet worden weergegeven |
...
| `-DontSuppressBlank` | SwitchParameter | — | — | Named | `False` | Of lege regels NIET moeten worden onderdrukt |
...
| `-MaxLastTextTokens` | Nullable`1[[System.Int32, System.Private.CoreLib, Version=10.0.0.0, Culture=neutral, PublicKeyToken=7cec85d7bea7798e]] | — | — | Named | — | Maximaal aantal laatste teksttokens |
| `-SingleSegmentOnly` | SwitchParameter | — | — | Named | `False` | Of alleen één segment moet worden gebruikt |
| `-PrintSpecialTokens` | SwitchParameter | — | — | Named | `False` | Of speciale tokens moeten worden afgedrukt |
| `-MaxSegmentLength` | Nullable`1[[System.Int32, System.Private.CoreLib, Version=10.0.0.0, Culture=neutral, PublicKeyToken=7cec85d7bea7798e]] | — | — | Named | — | Maximale segmentlengte |
| `-MaxInitialTimestamp` | Nullable`1[[System.TimeSpan, System.Private.CoreLib, Version=10.0.0.0, Culture=neutral, PublicKeyToken=7cec85d7bea7798e]] | — | — | Named | — | Start tijdstempels op dit moment |
| `-LengthPenalty` | Nullable`1[[System.Single, System.Private.CoreLib, Version=10.0.0.0, Culture=neutral, PublicKeyToken=7cec85d7bea7798e]] | — | — | Named | — | Lengteboete |
...
| `-LogProbThreshold` | Nullable`1[[System.Single, System.Private.CoreLib, Version=10.0.0.0, Culture=neutral, PublicKeyToken=7cec85d7bea7798e]] | — | — | Named | — | Drempelwaarde voor logaritmische waarschijnlijkheid |
...
| `-ModelType` | Whisper.net.Ggml.GgmlType | — | — | Named | `Tiny` | Te gebruiken Whisper-modeltype, standaard ingesteld op Small |
...
Gebruikmaken van desktop audio-opname.
...
Gebruik van specifiek audioapparaat.
...
> Of u desktop-audiocaptuur wilt gebruiken in plaats van microfoon
...
> Of zowel desktop-audio-opname als opnameapparaat tegelijkertijd moeten worden gebruikt
...
> Of token-tijdstempels moeten worden opgenomen
...
> Stelt de invoertaal in om te detecteren, standaard ingesteld op 'nl'
...
> Temperatuur voor spraakdetectie
...
> Of de uitvoer moet worden vertaald
...
> Te gebruiken Whisper-modeltype, standaard ingesteld op Small
