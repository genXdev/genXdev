...
Deze functie registreert een gezichtsafbeelding bij de DeepStack gezichtsherkennings-API door de afbeelding te uploaden naar het lokale API-eindpunt. Het zorgt ervoor dat de DeepStack-service actief is en valideert het afbeeldingsbestand vóór upload. De functie bevat herstelpogingen, foutafhandeling en opschoning bij mislukking.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Identifier` | String | ✅ | — | 0 | — | De unieke identificatie voor het gezicht (bijvoorbeeld de naam van de persoon) |
...
> De unieke identificatie voor het gezicht (bijvoorbeeld de naam van de persoon)
...
> Array van lokale paden naar afbeeldingsbestanden (png, jpg, jpeg of gif)
