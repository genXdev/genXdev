...
| `-Name` | String | ✅ | — | 0 | — | Selecteert het eerste tabblad met deze naam in de URL *(Parameter set: )* 🌐 *Supports wildcards* |
| `-ByReference` | PSObject | ✅ | — | Named | — | Selecteer tab met referentie uit Get-ChromiumSessionReference *(Parameter set: )* |
...
| `-Force` | SwitchParameter | — | — | Named | — | Start browser opnieuw indien nodig |
