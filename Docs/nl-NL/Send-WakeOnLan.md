...
> Verzendt een Wake-on-LAN-magicpacket om externe computers op het netwerk te activeren.

## Description

Construeert en verzendt een Wake-on-LAN (WOL) magisch pakket naar het opgegeven MAC-adres(sen). Het magische pakket is een UDP-broadcast die het doel-MAC-adres 16 keer herhaald bevat, waardoor ondersteunde netwerkinterfaces de computer kunnen inschakelen. Ondersteunt aangepaste broadcastadressen en poorten.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-MacAddress` | String[] | ✅ | ✅ (ByValue, ByPropertyName) | 0 | — | Een of meer MAC-adressen om het magische pakket naar te sturen (bijv. 00:11:22:33:44:55) |
| `-BroadcastAddress` | String | — | — | 1 | `"255.255.255.255"` | Het broadcast IP-adres om het magische pakket naar te verzenden (standaard: 255.255.255.255) |
| `-Port` | Int32 | — | — | 2 | `4000` | De UDP-poort om het magische pakket naar te sturen (standaard: 4000) |
...
Verstuurt een magisch pakket om de computer met het opgegeven MAC-adres te wekken.
...
Verzendt magische pakketten naar meerdere computers op poort 9 via pijplijninvoer.

## Parameter Details

### `-MacAddress <String[]>`

> Een of meer MAC-adressen om het magische pakket naar te sturen (bijv. 00:11:22:33:44:55)
...
> Het broadcast IP-adres om het magische pakket naar te verzenden (standaard: 255.255.255.255)
...
> De UDP-poort om het magische pakket naar te sturen (standaard: 4000)
