...
> Stelt bestanden in op het Windows-klembord voor bestandbewerkingen zoals kopiëren/plakken.

## Description

Deze functie kopieert een of meerdere bestandspaden naar het Windows-klembord, waardoor bestandsbewerkingen zoals plakken in Windows Verkenner mogelijk worden. Het verwerkt automatisch zowel STA- als MTA-threadingmodi, wat compatibiliteit in verschillende PowerShell-uitvoeringscontexten garandeert. De functie valideert het bestaan van bestanden voordat paden aan het klembord worden toegevoegd.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-InputObject` | String[] | ✅ | ✅ (ByValue, ByPropertyName) | 0 | — | Matrix van bestandspaden om aan het klembord toe te voegen |
...
> Matrix van bestandspaden om aan het klembord toe te voegen
