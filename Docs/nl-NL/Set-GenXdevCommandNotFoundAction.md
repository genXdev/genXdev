...
> Stelt aangepaste afhandeling voor niet-gevonden commando's in

## Description

Configureert PowerShell om onbekende opdrachten af te handelen door naar mappen te navigeren.
