...
> Navigeert drie mapniveaus omhoog in de bestandssysteemhiërarchie.

## Description

* Wijzigt de huidige werkmap door drie niveaus omhoog te gaan in de bestandssysteemhiërarchie.
...
Navigeert drie niveaus omhoog in de mapstructuur vanaf de huidige locatie.
...
Gebruikt het alias om drie mapniveaus omhoog te navigeren.
