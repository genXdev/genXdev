...
> Navigeert vijf mappen omhoog in de bestandssysteemhiërarchie.

## Description

* Wijzigt de huidige werkmap door vijf bovenliggende mappen omhoog te gaan.
* Toont de inhoud van de resulterende map.
* Biedt een handige verkorte alias '......' voor snelle navigatie.
...
Navigeert vijf mapniveaus omhoog vanaf de huidige locatie.
...
Gebruikt het alias om vijf directoriëniveaus omhoog te navigeren.
