...
> Opent een URL tegelijkertijd in meerdere browsers in een mozaïeklay-out.

## Description

Deze functie maakt een mozaïeklay-out van browservensters door de opgegeven URL te openen in Chrome, Edge, Firefox en een privé-browservenster. De browsers worden gerangschikt in een 2x2 rasterpatroon:
- Chrome: Kwadrant linksboven
- Edge: Kwadrant linksonder
- Firefox: Kwadrant rechtsboven
- Privévenster: Kwadrant rechtsonder

Alle parameters van Open-Webbrowser worden ondersteund en doorgegeven om de positionering, het gedrag en het uiterlijk van de browser te beheren. De functie fungeert als een wrapper die consistente kwadrantpositionering toepast, terwijl volledige aanpassing van de browserstartparameters mogelijk is.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Url` | String | ✅ | ✅ (ByValue, ByPropertyName) | 0 | — | De URL's die in alle browsers tegelijk moeten worden geopend |
...
> De URL's die in alle browsers tegelijk moeten worden geopend
