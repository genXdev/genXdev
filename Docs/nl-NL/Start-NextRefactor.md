...
> Gaat door met of herstart een code-refactoring-sessie.

## Description

Beheert codeherstructureringsoperaties door herstructureringsdefinities in
prioriteitsvolgorde te verwerken. Verzorgt bestandsselectie, voortgangsregistratie, foutafhandeling en
biedt interactieve gebruikerscontrole over het herstructureringsproces.
...
| `-FilesToAdd` | IO.FileInfo[] | — | — | 1 | `@()` | Bestandsnamen om toe te voegen |
| `-FilesToRemove` | IO.FileInfo[] | — | — | 2 | `@()` | Te verwijderen bestandsnamen |
