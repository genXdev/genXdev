...
* Kan scannen in alleen-detectiemodus of met automatische herstel van bedreigingen ingeschakeld.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-FilePath` | String | ✅ | ✅ (ByValue, ByPropertyName) | 0 | — | Het pad naar het te scannen bestand of de te scannen map |
| `-EnableRemediation` | SwitchParameter | — | — | Named | `False` | Instrueert Windows Defender om actie te ondernemen tegen bedreigingen |
...
Scant het opgegeven bestand en geeft uitgebreide uitvoer weer.
...
Scant het bestand met behulp van het alias en schakelt herstel in.
...
> Het pad naar het te scannen bestand of de te scannen map
...
> Instrueert Windows Defender om actie te ondernemen tegen bedreigingen
