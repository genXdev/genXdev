...
> Ulepsza tekst, dodając odpowiednie kontekstowo emotikony za pomocą sztucznej inteligencji.

## Description

Ta funkcja przetwarza tekst wejściowy, dodając emotikony pasujące do emocjonalnego kontekstu. Może przyjmować dane wejściowe bezpośrednio przez parametry, z potoku lub ze schowka systemowego. Funkcja wykorzystuje modele AI do analizy tekstu i wyboru odpowiednich emotikonów, dzięki czemu komunikaty stają się bardziej wyraziste i angażujące.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Text` | String | — | ✅ (ByValue) | 0 | — | Tekst do wzbogacenia emotikonami |
...
> Tekst do wzbogacenia emotikonami
