...
> Dodaje linię funkcji do pliku README z oznaczeniem czasu.

## Description

Dodaje wiersz funkcji do określonego pliku README, poprzedzony bieżącą datą w formacie yyyyMMdd. Wiersz może być sformatowany jako kod i opcjonalnie wyświetlany.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Line` | String | — | — | 0 | `''` | Tekst opisu funkcji do dodania |
...
> Tekst opisu funkcji do dodania
