...
> Dodaje element pomysłu do pliku README.md.

## Description

Dodaje opatrzoną znacznikiem czasu ideę do sekcji „## Ideas” w pliku README.md.
Może wyświetlić zmodyfikowaną sekcję i otworzyć ją w programie Visual Studio Code.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Line` | String | — | — | 0 | `''` | Tekst pomysłu do dodania |
