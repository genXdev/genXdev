...
> Dodaje element problemu do pliku README.md.

## Description

Dodaje opatrzoną znacznikiem czasu kwestię do sekcji „## Issues” pliku README.md.
Może wyświetlić zmodyfikowaną sekcję i otworzyć ją w Visual Studio Code.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Line` | String | — | — | 0 | `''` | Tekst problemu do dodania |
| `-Code` | SwitchParameter | — | — | Named | — | Otwórz README w Visual Studio Code |
...
> Otwórz README w Visual Studio Code
