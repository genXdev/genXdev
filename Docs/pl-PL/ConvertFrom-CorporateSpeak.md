...
> Konwertuje uprzejmą, profesjonalną mowę korporacyjną na bezpośredni, jasny język przy użyciu AI.

## Description

Ta funkcja przetwarza tekst wejściowy, przekształcając dyplomatyczne, korporacyjne komunikaty na bardziej bezpośredni i jasny język. Może przyjmować dane wejściowe bezpośrednio przez parametry, z potoku lub ze schowka systemowego. Funkcja wykorzystuje modele AI do analizy i parafrazowania tekstu, zachowując oryginalny zamiar.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Text` | String | — | ✅ (ByValue) | 0 | — | Tekst do przekonwertowania z języka korporacyjnego |
...
> Tekst do przekonwertowania z języka korporacyjnego
