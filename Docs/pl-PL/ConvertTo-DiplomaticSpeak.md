...
> Konwertuje bezpośredni lub dosadny tekst na uprzejmy, taktowny język dyplomatyczny.

## Description

Ta funkcja przekształca bezpośrednie lub szorstkie wypowiedzi użytkownika w język dyplomatyczny i taktowny, odpowiedni do dyskusji na wysokim szczeblu, negocjacji lub komunikacji formalnej. Funkcja wykorzystuje modele językowe AI, aby zachować pierwotną intencję, jednocześnie łagodząc ton i czyniąc przekaz bardziej dyplomatycznym i profesjonalnym.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Text` | String | — | ✅ (ByValue) | 0 | — | Tekst do przekształcenia na język dyplomatyczny |
...
> Tekst do przekształcenia na język dyplomatyczny
