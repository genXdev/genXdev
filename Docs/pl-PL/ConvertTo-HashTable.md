...
> Konwertuje obiekt PSCustomObject na tablicę haszującą rekurencyjnie.

## Description

* Ta funkcja konwertuje obiekt PSCustomObject oraz wszystkie jego zagnieżdżone właściwości PSCustomObject na tablice mieszające (HashTables).
* Obsługuje tablice i inne typy kolekcji, przetwarzając każdy element rekurencyjnie.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-InputObject` | Object | ✅ | ✅ (ByValue) | 0 | — | Obiekt PSCustomObject do konwersji na HashTable |
...
Konwertuj PSCustomObject na HashTable z zagnieżdżonymi właściwościami.

## Parameter Details

### `-InputObject <Object>`

> Obiekt PSCustomObject do konwersji na HashTable
