...
> Konwertuje funkcje PowerShell na definicje funkcji API OpenAI LLM.

## Description

Przyjmuje zdefiniowane polecenia cmdlet i generuje definicje funkcji zgodne z API OpenAI LLM, zawierające informacje o parametrach i procedurach obsługi zwrotnej.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-ExposedCmdLets` | GenXdev.Helpers.ExposedCmdletDefinition[] | — | ✅ (ByValue) | 0 | `@()` | Polecenia PowerShell do konwersji na funkcje narzędziowe |
...
> Polecenia PowerShell do konwersji na funkcje narzędziowe
