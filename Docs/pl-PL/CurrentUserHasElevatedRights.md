...
> Sprawdza, czy bieżący użytkownik ma podniesione uprawnienia.

## Description

Określa, czy bieżący użytkownik systemu Windows ma uprawnienia administracyjne lub operatora kopii zapasowych, sprawdzając ich role podmiotów zabezpieczeń. Zwraca wartość true, jeśli użytkownik ma podwyższone prawa, w przeciwnym razie false. Implementuje solidną obsługę błędów dla problemów związanych z zabezpieczeniami i dostępem.
