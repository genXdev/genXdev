...
> Uruchamia skonfigurowany wygaszacz ekranu systemu Windows.

## Description

Aktywuje wygaszacz ekranu systemu Windows, uruchamiając domyślny plik wykonywalny wygaszacza (scrnsave.scr) z przełącznikiem /s, aby natychmiast go uruchomić.
