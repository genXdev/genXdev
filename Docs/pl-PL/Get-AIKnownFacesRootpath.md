...
> Pobiera skonfigurowany katalog plików obrazów twarzy używanych w operacjach GenXdev.AI.

## Description

Ta funkcja pobiera globalny katalog twarzy używany przez moduł GenXdev.AI do różnych operacji rozpoznawania twarzy i sztucznej inteligencji. Najpierw sprawdza zmienne globalne (chyba że określono SkipSession), następnie przechodzi do trwałych preferencji, a na końcu używa domyślnych ustawień systemowych.
...
Pobiera aktualnie skonfigurowany katalog twarzy ze zmiennych globalnych lub preferencji.
...
Pobiera skonfigurowany katalog twarzy tylko z trwałych preferencji, ignorując wszelkie ustawienia sesji.
...
Czyści ustawienie katalogu twarzy sesji, a następnie pobiera katalog z preferencji trwałych.
...
Zwraca określony katalog po rozwinięciu ścieżki.
