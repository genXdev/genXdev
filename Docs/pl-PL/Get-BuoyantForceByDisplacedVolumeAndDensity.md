...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-DisplacedVolumeInCubicMeters` | Double | ✅ | — | 0 | `0` | Przemieszczona objętość w m³ |
| `-FluidDensityInKilogramsPerCubicMeter` | Double | ✅ | — | 1 | `0` | Gęstość płynu w kg/m³ |
| `-GravityInMetersPerSecondSquared` | Double | — | — | 2 | `0` | Grawitacja w m/s² (domyślnie: 9,81) |
| `-As` | String | — | — | 3 | — | Jednostka wyjściowa siły |

## Parameter Details

### `-DisplacedVolumeInCubicMeters <Double>`

> Przemieszczona objętość w m³
