...
> Pobiera obiekt procesu okna, które aktualnie posiada fokus klawiatury.

## Description

* To polecenie cmdlet używa wywołań API systemu Windows przez P/Invoke w celu zidentyfikowania i zwrócenia obiektu Process związanego z aktualnie aktywnym oknem.
* Wykorzystuje funkcje GetForegroundWindow i GetWindowThreadProcessId z biblioteki User32.dll, aby określić, które okno ma fokus i uzyskać jego identyfikator procesu.
...
Pobiera obiekt procesu dla okna, które aktualnie ma fokus klawiatury.
