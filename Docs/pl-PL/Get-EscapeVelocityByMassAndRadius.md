...
> Oblicza prędkość ucieczki.

## Description

Używa v = sqrt(2 G M / r).
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-MassInKilograms` | Double | ✅ | — | 0 | `0` | Masa ciała w kg |
...
Oblicza prędkość ucieczki dla ciała o masie i promieniu Ziemi.
...
Oblicza prędkość ucieczki przy użyciu domyślnych jednostek m/s.
