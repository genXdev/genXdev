...
> Wyświetla funkcje z pliku README.md.

## Description

Pokazuje wszystkie funkcje z sekcji „## Features” pliku README.md. Może używać README w bieżącej lokalizacji, katalogu profilu PowerShell lub katalogu OneDrive.
