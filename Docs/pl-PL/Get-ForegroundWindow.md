...
> Pobiera uchwyt do aktualnie aktywnego okna na pierwszym planie.

## Description

* To polecenie cmdlet pobiera uchwyt okna (HWND) okna, które jest
  aktualnie na pierwszym planie i ma fokus klawiatury.
* Używa funkcji interfejsu API systemu Windows przez P/Invoke do interakcji z
  biblioteką User32.dll.
...
Pobiera i zwraca uchwyt IntPtr aktywnego okna.
...
Przechowuje uchwyt okna na pierwszym planie w zmiennej i wyświetla go.
