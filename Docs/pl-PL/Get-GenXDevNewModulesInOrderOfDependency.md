...
> Pobiera moduły GenXDev w kolejności zależności.

## Description

Ta funkcja zwraca listę modułów GenXDev ułożonych w odpowiedniej kolejności zależności, aby zapewnić prawidłowe ładowanie modułów. Najpierw pobiera wszystkie informacje o modułach, a następnie porządkuje je na podstawie ich zależności, zaczynając od modułów podstawowych, a kończąc na modułach zależnych. Zapewnia to ładowanie modułów w prawidłowej sekwencji.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-ModuleName` | String[] | — | ✅ (ByValue, ByPropertyName) | 0 | `@('GenXdev*')` | Jedna lub więcej nazw modułów do filtrowania |
...
> Jedna lub więcej nazw modułów do filtrowania
