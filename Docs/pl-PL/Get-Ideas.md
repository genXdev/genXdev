...
> Wyświetla pomysły z pliku README.md.

## Description

Pokazuje wszystkie pomysły z sekcji "## Ideas" pliku README.md. Można użyć README z bieżącej lokalizacji, katalogu profilu PowerShell lub katalogu OneDrive.
