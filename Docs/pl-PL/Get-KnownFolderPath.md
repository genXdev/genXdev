...
> Pobiera ścieżkę znanego folderu systemu Windows przy użyciu interfejsu API Shell32.

## Description

Pobiera ścieżkę określonego znanego folderu systemu Windows przy użyciu funkcji SHGetKnownFolderPath z API Shell32. Ta metoda jest bardziej niezawodna niż używanie zmiennych środowiskowych, ponieważ działa spójnie w różnych wersjach systemu Windows i ustawieniach językowych. Obsługuje wszystkie standardowe znane foldery systemu Windows, takie jak Dokumenty, Pobrane, AppData itp.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-KnownFolder` | String | ✅ | — | 0 | — | Nazwa znanego folderu systemu Windows, dla którego pobierana jest ścieżka |
...
> Nazwa znanego folderu systemu Windows, dla którego pobierana jest ścieżka
