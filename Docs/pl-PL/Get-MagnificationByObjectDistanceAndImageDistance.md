...
> Oblicza powiększenie dla soczewki.

## Description

Używa m = - (odległość obrazu / odległość obiektu).
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-ObjectDistanceInMeters` | Double | ✅ | — | 0 | `0` | Odległość obiektu w metrach |
| `-ImageDistanceInMeters` | Double | ✅ | — | 1 | `0` | Odległość obrazu w metrach |
...
Oblicza powiększenie przy odległości przedmiotu 0,5 m i odległości obrazu 1 m.
...
Oblicza powiększenie przy użyciu parametrów pozycyjnych.

## Parameter Details

### `-ObjectDistanceInMeters <Double>`

> Odległość obiektu w metrach
