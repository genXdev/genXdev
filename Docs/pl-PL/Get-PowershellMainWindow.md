...
> Zwraca obiekt pomocniczy okna dla głównego okna terminala PowerShell.

## Description

* Pobiera obiekt pomocniczy WindowObj reprezentujący główne okno
  bieżącego procesu hosta PowerShell.
* Umożliwia to manipulację i interakcję z samym oknem terminala.
...
Pobiera obiekt WindowObj dla bieżącego okna terminala PowerShell.
