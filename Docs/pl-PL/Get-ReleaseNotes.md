...
> Wyświetla informacje o wydaniu z pliku README.md.

## Description

Pokazuje wszystkie informacje o wersji z sekcji "## Informacje o wersji" pliku README.md. Może używać pliku README w bieżącej lokalizacji, katalogu profilu PowerShell lub katalogu OneDrive.
