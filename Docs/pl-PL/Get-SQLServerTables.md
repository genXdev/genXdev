...
> Pobiera listę nazw tabel z bazy danych SQL Server.

## Description

Wykonuje zapytania do tabel systemowych SQL Server w celu pobrania wszystkich nazw tabel zdefiniowanych przez użytkownika z bazy danych SQL Server. Obsługuje połączenie za pomocą bezpośredniego ciągu połączenia lub nazwy bazy danych z parametrami serwera. Zwraca nazwy tabel jako kolekcję ciągów.
