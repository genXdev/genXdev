...
> Pobiera dane kolumny z widoku SQL z opcjonalnym ograniczeniem liczby rekordów.

## Description

Wykonuje zapytanie SELECT względem określonego widoku SQL w celu pobrania danych z pojedynczej kolumny. Umożliwia połączenie za pomocą ciągu połączeniowego lub ścieżki pliku bazy danych. Pozwala ograniczyć liczbę zwracanych rekordów lub pobrać wszystkie rekordy.
...
| `-ColumnName` | String | ✅ | — | 3 | — | Nazwa kolumny. |
| `-Count` | Int32 | — | — | 4 | `100` | Liczba rekordów do zwrócenia. Domyślnie 100. Wartość -1 dla wszystkich. |
...
> Liczba rekordów do zwrócenia. Domyślnie 100. Wartość -1 dla wszystkich.
