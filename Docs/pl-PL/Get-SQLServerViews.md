...
> Pobiera listę widoków z bazy danych SQL Server.

## Description

Pobiera wszystkie nazwy widoków z określonej bazy danych SQL Server. Zwraca tablicę nazw widoków, które mogą być używane do dalszych operacji na bazie danych. Funkcja obsługuje dwa zestawy parametrów dla elastyczności: podanie ciągu połączenia lub nazwy bazy danych z serwerem.
