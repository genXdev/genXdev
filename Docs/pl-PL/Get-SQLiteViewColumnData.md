...
> Pobiera dane kolumny z widoku SQLite z opcjonalnym ograniczeniem liczby rekordów.

## Description

Wykonuje zapytanie SELECT na określonym widoku SQLite, aby pobrać dane z pojedynczej kolumny. Obsługuje łączenie za pomocą parametrów połączenia lub ścieżki pliku bazy danych. Pozwala ograniczyć liczbę zwracanych rekordów lub pobrać wszystkie rekordy.
...
| `-ViewName` | String | ✅ | — | 1 | — | Nazwa widoku. |
| `-ColumnName` | String | ✅ | — | 2 | — | Nazwa kolumny. |
| `-Count` | Int32 | — | — | 3 | `100` | Liczba rekordów do zwrócenia. Domyślnie 100. Wartość -1 dla wszystkich. |
