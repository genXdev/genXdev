...
> Wyświetla elementy do zrobienia z pliku README.md.

## Description

Pokazuje wszystkie pozycje do zrobienia z sekcji „## Todoos” pliku README.md. Może używać pliku README z bieżącego katalogu, katalogu profilu PowerShell lub katalogu OneDrive.
