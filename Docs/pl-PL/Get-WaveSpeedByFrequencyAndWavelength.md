...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-FrequencyInHertz` | Double | ✅ | — | 0 | `0` | Częstotliwość w Hz |
| `-WavelengthInMeters` | Double | ✅ | — | 1 | `0` | Długość fali w metrach |
| `-As` | String | — | — | 2 | — | Jednostka wyjściowa dla prędkości |
...
Oblicza prędkość fali za pomocą v = f * λ.
...
Oblicza prędkość fali z parametrami pozycyjnymi.
...
> Jednostka wyjściowa dla prędkości
