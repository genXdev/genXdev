...
> Zwraca odwrócony słownik dla wszystkich języków obsługiwanych przez Google Search.

## Description

* Zwraca słownik mapujący nazwy języków na odpowiadające im
  kody języków dla wszystkich języków obsługiwanych przez Google Search.
* Przydatny do wyszukiwania kodów językowych w zapytaniach internetowych i zadaniach tłumaczeniowych.
...
Pobiera słownik mapujący nazwy języków na ich kody.
