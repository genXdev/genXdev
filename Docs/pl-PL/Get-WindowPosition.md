...
> Pobiera informacje o położeniu i stanie okien.

## Description

Pobiera szczegółowe informacje o położeniu okna, jego rozmiarze, umiejscowieniu na monitorze, stanie dokowania oraz stanie fokusu dla określonych procesów lub uchwytów okien.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-ProcessName` | String | — | ✅ (ByValue, ByPropertyName) | 0 | — | Nazwa procesu okna, dla którego ma zostać uzyskana pozycja *(Parameter set: )* 🌐 *Supports wildcards* |
| `-Process` | Diagnostics.Process | — | ✅ (ByValue, ByPropertyName) | Named | — | Proces okna w celu uzyskania pozycji dla *(Parameter set: )* |
...
> Nazwa procesu okna, dla którego ma zostać uzyskana pozycja
...
> Proces okna w celu uzyskania pozycji dla
