...
> Otwiera wszystkie możliwe typy zapytań dla podanych terminów wyszukiwania lub adresów URL.

## Description

Wykonuje wszystkie polecenia cmdlet obsługujące zapytania stron internetowych, przetwarzając zarówno adresy URL, jak i terminy wyszukiwania. Dla adresów URL wykonuje zapytania specyficzne dla witryny, a dla terminów wyszukiwania wykonuje ogólne zapytania internetowe. Ta funkcja dynamicznie wykrywa i wykonuje wszystkie dostępne polecenia cmdlet zapytań z rodziny modułów GenXdev.Queries.
...
| `-ClearSession` | SwitchParameter | — | — | Named | — | Wyczyść sesję przeglądarki przed otwarciem. |
| `-SkipSession` | SwitchParameter | — | — | Named | — | Pomiń przywracanie sesji przeglądarki. |
...
Otwiera wszystkie możliwe typy zapytań dla "skryptowania powershell" na domyślnym monitorze.
...
Otwiera wszystkie możliwe typy zapytań dla adresu URL GitHub za pomocą aliasów i krótkich parametrów.
...
> Wyczyść sesję przeglądarki przed otwarciem.
...
> Pomiń przywracanie sesji przeglądarki.
...
- [ConvertTo-Uris](https://github.com/genXdev/genXdev/blob/main/Docs/pl-PL/ConvertTo-Uris.md)
