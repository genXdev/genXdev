...
> Otwiera zapytanie Bing CoPilot w przeglądarce internetowej

## Description

Otwiera zapytanie Bing CoPilot w przeglądarce internetowej. Funkcja automatycznie wpisuje zapytanie i wysyła je za pomocą funkcji Open-WebsiteAndPerformQuery. Zapewnia to wygodny sposób interakcji z Microsoft Copilot z poziomu PowerShell.
...
| `-Language` | String | — | — | 1 | — | Język zwróconych wyników wyszukiwania |
...
| `-ShowWindow` | SwitchParameter | — | — | Named | — | Otwiera w trybie pełnoekranowym |
...
| `-SessionOnly` | SwitchParameter | — | — | Named | — | Użyj trybu tylko dla sesji dla profilu przeglądarki. |
| `-ClearSession` | SwitchParameter | — | — | Named | — | Wyczyść sesję/profil przeglądarki przed otwarciem. |
| `-SkipSession` | SwitchParameter | — | — | Named | — | Pomiń ładowanie sesji/profilu przeglądarki. |
...
> Użyj trybu tylko dla sesji dla profilu przeglądarki.
...
> Wyczyść sesję/profil przeglądarki przed otwarciem.
...
> Pomiń ładowanie sesji/profilu przeglądarki.
...
- [Open-CloudLLMChat](https://github.com/genXdev/genXdev/blob/main/Docs/pl-PL/Open-CloudLLMChat.md)
