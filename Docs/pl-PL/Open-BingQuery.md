...
> Otwiera zapytanie wyszukiwania Bing w przeglądarce internetowej.

## Description

Otwiera jedno lub więcej zapytań wyszukiwania Bing w przeglądarce internetowej, korzystając z konfigurowalnych ustawień przeglądarki i przełączników wiersza poleceń. Ta funkcja zapewnia kompleksowy interfejs do przeprowadzania wyszukiwań Bing z szerokimi opcjami dostosowywania przeglądarki, w tym pozycjonowaniem okna, wyborem monitora, przeglądaniem prywatnym i automatyzacją naciśnięć klawiszy.

Funkcja automatycznie koduje zapytania URL i formatuje je na potrzeby interfejsu API wyszukiwania Bing. Obsługuje wszystkie główne przeglądarki, w tym Edge, Chrome i Firefox, z funkcjami takimi jak przeglądanie prywatne, tryb aplikacji, precyzyjne zarządzanie oknami i automatyzacja naciśnięć klawiszy.
...
Otwiera wyszukiwanie Bing dla „skryptowanie PowerShell” na domyślnym monitorze.
...
Otwiera wyszukiwanie Bing przy użyciu aliasu i krótkich nazw parametrów.
...
Otwiera sesję przeglądania prywatnego, aby wyszukać „machine learning” z wynikami w języku angielskim.
...
Wyszukuje wiele terminów przez potok i otwiera wyniki we wszystkich zainstalowanych przeglądarkach, umieszczając okna po lewej stronie ekranu.
