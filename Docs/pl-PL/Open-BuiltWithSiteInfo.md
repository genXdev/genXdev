...
> Otwiera zapytania witryny BuiltWith w przeglądarce internetowej.

## Description

Otwiera zapytanie BuiltWith w przeglądarce internetowej, z konfigurowalnymi ustawieniami monitora i opcjami zachowania przeglądarki. Funkcja analizuje stos technologiczny witryn poprzez odpytywanie usługi profilowania technologii BuiltWith.com, która dostarcza szczegółowych informacji o technologiach internetowych, frameworkach i usługach używanych przez strony internetowe.

BuiltWith.com to kompleksowa usługa wyszukiwania technologii, która identyfikuje technologie internetowe, frameworki, systemy zarządzania treścią, narzędzia analityczne, dostawców hostingu i inne komponenty oprogramowania używane przez dowolną witrynę. Ta funkcja zapewnia interfejs PowerShell do szybkiej analizy stosów technologicznych bez ręcznego przechodzenia na stronę BuiltWith.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Queries` | String[] | ✅ | ✅ (ByValue, ByPropertyName) | 0 | — | Adresy URL lub domeny witryn do zapytania na stronie BuiltWith.com |
| `-Language` | String | — | — | 1 | — | Język zwróconych wyników wyszukiwania |
| `-Monitor` | Int32 | — | — | 2 | `-1` | Monitor do użycia, 0 = domyślny, -1 = odrzuć, -2 = Skonfigurowany monitor dodatkowy, domyślnie -1, bez pozycjonowania |
...
Otwiera analizę technologii BuiltWith dla Microsoft.com na domyślnym monitorze.
...
Analizuje Microsoft.com przy użyciu danych wejściowych potoku z odrzuceniem pozycjonowania monitora.

## Parameter Details

### `-Queries <String[]>`

> Adresy URL lub domeny witryn do zapytania na stronie BuiltWith.com
