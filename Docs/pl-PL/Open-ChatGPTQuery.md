...
> Otwiera zapytanie ChatGPT w przeglądarce internetowej.

## Description

Otwiera ChatGPT w przeglądarce internetowej, automatycznie wprowadza określone zapytanie i wysyła je. Obsługuje wiele zapytań, które będą wykonywane przy użyciu podstawowej funkcji Open-WebsiteAndPerformQuery. Ta funkcja zapewnia wygodny sposób interakcji z OpenAI's ChatGPT z PowerShell z rozbudowanymi opcjami konfiguracji przeglądarki.
...
| `-ShowWindow` | SwitchParameter | — | — | Named | — | Pokaż okno przeglądarki |
...
Prześlij wiele zapytań używając pełnej nazwy parametru.
...
Prześlij zapytanie przy użyciu aliasu i potoku.
