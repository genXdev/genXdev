...
> Otwiera katalog progresywnych aplikacji internetowych GenXdev w przeglądarce internetowej.

## Description

Otwiera katalog opublikowanych progresywnych aplikacji internetowych GenXdev w przeglądarce internetowej.
Otwiera w trybie aplikacji z domyślnie włączonym trybem pełnoekranowym, aby zapewnić optymalne wrażenia wizualne podczas przeglądania katalogu. Obsługuje wszystkie standardowe opcje konfiguracji przeglądarki internetowej, w tym umiejscowienie monitora, rozmiar okna i preferencje językowe.

Funkcja automatycznie konfiguruje przeglądarkę dla najlepszych wrażeń podczas przeglądania katalogu i może otwierać wiele instancji przeglądarki jednocześnie. Zapewnia wszechstronne wsparcie językowe i respektuje preferencje użytkownika dotyczące wyboru i pozycjonowania przeglądarki.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Language` | String | — | — | 0 | — | Język zwróconych wyników wyszukiwania |
...
| `-ShowWindow` | SwitchParameter | — | — | Named | — | Pokaż okno przeglądarki (nie zminimalizowane ani ukryte) |
...
Otwiera katalog aplikacji GenXdev na monitorze 1 w trybie aplikacji z włączonym trybem pełnoekranowym.
...
Otwiera katalog aplikacji GenXdev na monitorze 1 za pomocą polecenia aliasu.
...
> Pokaż okno przeglądarki (nie zminimalizowane ani ukryte)
