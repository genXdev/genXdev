...
> Otwiera zapytanie GitHub CoPilot w przeglądarce internetowej

## Description

Otwiera zapytanie Github CoPilot w przeglądarce internetowej i automatycznie wprowadza określone zapytanie. Funkcja czeka na załadowanie strony przed wpisaniem zapytania. Ta funkcja wykorzystuje funkcję Open-WebsiteAndPerformQuery do automatyzacji przeglądarki i zapewnia wygodny sposób interakcji z GitHub Copilot z PowerShell z rozbudowanymi opcjami konfiguracji przeglądarki.
