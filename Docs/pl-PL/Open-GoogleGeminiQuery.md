...
> Otwiera zapytanie Google Gemini w przeglądarce internetowej

## Description

Otwiera zapytanie Google Gemini w przeglądarce internetowej, automatycznie wprowadza zapytanie i je zatwierdza. Zapewnia to szybki sposób interakcji z AI Google Gemini. Funkcja obsługuje zaawansowaną kontrolę przeglądarki, w tym wybór monitora, pozycjonowanie okna i funkcje automatyzacji klawiatury.
...
Otwiera Google Gemini i przesyła zapytanie „Co to jest PowerShell?”.
...
Używa aliasu, aby przesłać zapytanie dotyczące tablic za pomocą danych wejściowych potoku.
