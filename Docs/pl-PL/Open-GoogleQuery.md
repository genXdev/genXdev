...
> Otwiera zapytania Google w przeglądarce internetowej z konfigurowalnymi ustawieniami i rozbudowanymi opcjami dostosowywania.

## Description

Otwiera jedno lub więcej zapytań Google w przeglądarce internetowej z kompleksową obsługą wielu języków, wyboru monitora, pozycjonowania okna, wyboru przeglądarki i automatyzacji klawiatury. Funkcja zapewnia bogaty interfejs do przeprowadzania wyszukiwań Google z precyzyjną kontrolą nad zachowaniem i wyglądem przeglądarki.

Kluczowe funkcje obejmują:
- Obsługa ponad 100 języków poprzez filtrowanie językowe Google
- Obsługa wielu monitorów z automatycznym lub ręcznym wyborem monitora
- Pozycjonowanie okna (lewo, prawo, góra, dół, wyśrodkowane, pełny ekran)
- Obsługa trybu prywatnego/incognito
- Tryb aplikacji dla przeglądania bez rozpraszania uwagi
- Opcje blokowania rozszerzeń i wyskakujących okien
- Zarządzanie fokusem i manipulacja oknem
- Przetwarzanie wsadowe zapytań z obsługą potoku
- Automatyzacja naciśnięć klawiszy w oknach przeglądarki
- Inteligentne przekazywanie parametrów do podstawowych funkcji przeglądarki

Funkcja automatycznie formatuje zapytania wyszukiwania dla wyszukiwarki Google i stosuje filtrowanie językowe, gdy jest to określone. Wszystkie funkcje pozycjonowania i zarządzania przeglądarką są dziedziczone z podstawowej funkcji Open-Webbrowser.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Queries` | String[] | ✅ | ✅ (ByValue, ByPropertyName) | 0 | — | Hasła wyszukiwania do zapytania w Google |
| `-Language` | String | — | — | 1 | — | Język dla wyników wyszukiwania Google |
...
| `-Monitor` | Int32 | — | — | Named | `-1` | Monitor do użycia, 0 = domyślny, -1 = odrzuć, -2 = Skonfigurowany monitor pomocniczy, domyślnie -1 |
...
Otwiera wyszukiwarkę Google dla frazy "PowerShell scripting" w języku angielskim na głównym monitorze.
...
Otwiera wyszukiwarkę Google dla "algorytmy uczenia maszynowego" w trybie pełnoekranowym na monitorze 2 przy użyciu aliasów.
...
Otwiera wiele wyszukiwań Google w Chrome za pomocą wprowadzania potokowego, każde w języku angielskim.
...
Otwiera wyszukiwanie prywatne dla "sztuczna inteligencja" w nowym oknie.
...
Otwiera wyszukiwanie w trybie aplikacji (bez elementów sterujących przeglądarki) wyśrodkowane na ekranie.

## Parameter Details

### `-Queries <String[]>`

> Hasła wyszukiwania do zapytania w Google
...
> Język dla wyników wyszukiwania Google
...
> Monitor do użycia, 0 = domyślny, -1 = odrzuć, -2 = Skonfigurowany monitor pomocniczy, domyślnie -1
