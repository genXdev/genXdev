...
> Otwiera zapytanie wyszukiwania IMDB w przeglądarce internetowej.

## Description

Otwiera zapytanie „Internet Movie Database” w przeglądarce internetowej z rozbudowanymi opcjami konfiguracji. Ta funkcja zapewnia wygodne opakowanie wokół funkcji wyszukiwania IMDB, umożliwiając użytkownikom wyszukiwanie filmów, programów telewizyjnych, aktorów i innych treści rozrywkowych bezpośrednio z poziomu PowerShell.

Funkcja przyjmuje wyrażenia wyszukiwania i konstruuje odpowiednie adresy URL wyszukiwania IMDB, a następnie otwiera je w określonej przeglądarce internetowej z możliwością dostosowania pozycji okna, wyboru przeglądarki i opcji wyświetlania. Obsługuje wszystkie główne przeglądarki, w tym Edge, Chrome i Firefox, z opcjami przeglądania prywatnego, trybu pełnoekranowego i zarządzania oknami.

Kluczowe funkcje obejmują obsługę wielu monitorów, lokalizację językową, automatyzację klawiatury oraz kompleksowe opcje konfiguracji przeglądarki. Funkcja może obsługiwać wiele zapytań wyszukiwania jednocześnie i zapewnia opcje zarówno do interaktywnego użytku, jak i zautomatyzowanych przepływów pracy.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Queries` | String[] | ✅ | ✅ (ByValue, ByPropertyName) | 0 | — | Terminy wyszukiwania do zapytania w IMDB |
...
| `-DisablePopupBlocker` | SwitchParameter | — | — | Named | — | Wyłącza funkcję blokowania wyskakujących okienek przeglądarki |
...
| `-SendKeyEscape` | SwitchParameter | — | — | Named | — | Pomija znaki kontrolne podczas wysyłania naciśnięć klawiszy do przeglądarki |
| `-SendKeyHoldKeyboardFocus` | SwitchParameter | — | — | Named | — | Zapobiega przywracaniu fokusu klawiatury do programu PowerShell po wysłaniu klawiszy |
| `-SendKeyUseShiftEnter` | SwitchParameter | — | — | Named | — | Używa Shift+Enter zamiast zwykłego Entera dla podziału wierszy podczas wysyłania klawiszy |
...
Otwiera wyszukiwanie IMDB dla "Matrix" na domyślnym monitorze.
...
Otwiera wyszukiwanie IMDB dla „Matrixa” przy użyciu aliasu i parametrów skrótu.
...
Wyszukuje wiele filmów w IMDB z francuskimi wynikami w Chrome.
...
Wyszukuje Toma Hanksa na IMDB w trybie pełnoekranowym, a następnie przywraca fokus na program PowerShell.

## Parameter Details

### `-Queries <String[]>`

> Terminy wyszukiwania do zapytania w IMDB
...
> Wyłącza funkcję blokowania wyskakujących okienek przeglądarki
...
> Pomija znaki kontrolne podczas wysyłania naciśnięć klawiszy do przeglądarki
...
> Zapobiega przywracaniu fokusu klawiatury do programu PowerShell po wysłaniu klawiszy
...
> Używa Shift+Enter zamiast zwykłego Entera dla podziału wierszy podczas wysyłania klawiszy
