...
> Otwiera zapytania InstantStreetView w przeglądarce internetowej.

## Description

Otwiera zapytania InstantStreetView w konfigurowalny sposób przy użyciu przełączników wiersza poleceń przeglądarki internetowej. Obsługuje wiele zapytań i wybór monitora. Zapewnia kompleksową kontrolę przeglądarki, w tym pozycjonowanie okna, ustawienia językowe i funkcje specyficzne dla przeglądarki.

Funkcja automatycznie konstruuje adresy URL InstantStreetView poprzez kodowanie lokalizacji zapytań w formacie URL i otwieranie ich w określonej przeglądarce. Obsługuje wszystkie główne przeglądarki, w tym Edge, Chrome i Firefox, z szerokimi opcjami dostosowywania.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Queries` | String[] | ✅ | ✅ (ByValue, ByPropertyName) | 0 | — | Zapytania o lokalizację do wyświetlenia w InstantStreetView |
...
Otwiera InstantStreetView dla Times Square w domyślnej przeglądarce na głównym monitorze.
...
Otwiera InstantStreetView dla Wieży Eiffla przy użyciu aliasu 'isv' i wyświetla na drugim monitorze.
...
Otwiera InstantStreetView dla Big Bena w języku angielskim z użyciem trybu przeglądania prywatnego.
...
Otwiera wiele zapytań InstantStreetView za pomocą potoku w przeglądarce Chrome
umieszczonej po lewej stronie ekranu.

## Parameter Details

### `-Queries <String[]>`

> Zapytania o lokalizację do wyświetlenia w InstantStreetView
