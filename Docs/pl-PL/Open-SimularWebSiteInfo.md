...
> Otwiera informacje o witrynie SimilarWeb dla określonych adresów URL w przeglądarce internetowej.

## Description

Otwiera zapytanie „Podobna sieć” w przeglądarce internetowej w sposób konfigurowalny za pomocą przełączników wiersza poleceń. Umożliwia sprawdzanie analityki witryn i porównania do analizy ruchu witryn, badań konkurencji i analiz marketingowych w cyfrowym środowisku.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Queries` | String[] | ✅ | ✅ (ByValue, ByPropertyName) | 0 | — | Adresy URL witryn internetowych do analizy w serwisie SimilarWeb |
...
Otwiera analizę SimilarWeb dla Google.com na głównym monitorze.
...
Otwiera analizę SimilarWeb przy użyciu aliasu funkcji z pozycjonowaniem monitora.
...
Analizuje wiele witryn internetowych za pomocą danych wejściowych z potoku z wyśrodkowanym położeniem okna.
...
Zwraca adres URL SimilarWeb dla GitHub bez otwierania przeglądarki.

## Parameter Details

### `-Queries <String[]>`

> Adresy URL witryn internetowych do analizy w serwisie SimilarWeb
