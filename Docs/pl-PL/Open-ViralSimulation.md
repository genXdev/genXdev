...
> Otwiera symulację wirusa w przeglądarce internetowej z rozbudowanymi opcjami konfiguracji.

## Description

Otwiera grę symulacyjną wirusa pod adresem https://viral.genxdev.net/ w określonej przeglądarce internetowej z konfigurowalnymi ustawieniami okna, pozycjonowaniem i opcjami zachowania. Obsługuje wiele przeglądarek, tryb prywatny, tryb aplikacji i kompleksowe zarządzanie oknami.

Funkcja zapewnia interaktywną symulację wirusa z funkcjami takimi jak:
- Obsługa wielu przeglądarek (Edge, Chrome, Firefox)
- Kontrola pozycjonowania i rozmiaru okna
- Opcje pełnoekranowe i tryb aplikacji
- Możliwość przeglądania prywatnego
- Wsparcie automatyzacji klawiatury
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Language` | String | — | — | 0 | — | Język wyświetlania treści internetowych i ustawienia języka przeglądarki |
...
| `-Monitor` | Int32 | — | — | Named | `-2` | Monitor do użycia, 0 = domyślny, -1 = odrzuć, -2 = skonfigurowany monitor dodatkowy, domyślnie $Global:DefaultSecondaryMonitor lub 2, jeśli nie znaleziono |
...
Otwiera wirusową symulację w Google Chrome w trybie prywatnym i bez pełnoekranowego.
...
Otwiera symulację wirusa za pomocą aliasów w Chrome, w trybie incognito i bez pełnego ekranu.

## Parameter Details

### `-Language <String>`

> Język wyświetlania treści internetowych i ustawienia języka przeglądarki
