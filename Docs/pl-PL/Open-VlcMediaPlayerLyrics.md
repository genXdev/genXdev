...
> Otwiera przeglądarkę internetową, aby wyszukać teksty aktualnie odtwarzanych mediów w VLC.

## Description

Funkcja ta wykrywa, czy odtwarzacz VLC Media Player jest uruchomiony, i wyszukuje teksty piosenek na podstawie aktualnie odtwarzanego tytułu. Automatycznie otwiera zapytanie wyszukiwania w przeglądarce internetowej, aby znaleźć tekst aktualnie odtwarzanego utworu. Funkcja obsługuje wiele przeglądarek i zapewnia rozbudowane opcje pozycjonowania okna i wyświetlania.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Queries` | String[] | — | ✅ (ByValue, ByPropertyName) 🌐 Remaining | 0 | — | Wyszukiwane hasła do znalezienia utworu |
...
| `-SessionOnly` | SwitchParameter | — | — | Named | — | Użyj sesji, która nie jest zachowywana po zamknięciu przeglądarki |
| `-ClearSession` | SwitchParameter | — | — | Named | — | Wyczyść dane sesji przeglądarki przed otwarciem przeglądarki |
| `-SkipSession` | SwitchParameter | — | — | Named | — | Pomiń używanie istniejącej sesji przeglądarki |
...
Otwiera wyszukiwarkę Google w poszukiwaniu tekstu aktualnie odtwarzanego pliku w VLC.
...
Otwiera wyszukiwanie tekstów piosenek w Microsoft Edge w trybie prywatnym/incognito.

## Parameter Details

### `-Queries <String[]>`

> Wyszukiwane hasła do znalezienia utworu
...
> Użyj sesji, która nie jest zachowywana po zamknięciu przeglądarki
...
> Wyczyść dane sesji przeglądarki przed otwarciem przeglądarki
...
> Pomiń używanie istniejącej sesji przeglądarki
