...
> Otwiera informacje o stronie WaybackMachine w przeglądarce internetowej.

## Description

Otwiera zapytanie Waybackmachine w przeglądarce internetowej, wyświetlając historyczne wersje określonego adresu URL lub strony internetowej. Obsługuje wiele zapytań i wybór monitora. Zapewnia dostęp do zarchiwizowanych treści internetowych za pośrednictwem usługi Wayback Machine w Internet Archive.
...
| `-Language` | String | — | — | 1 | — | Preferencja językowa dla interfejsu przeglądarki i treści |
...
| `-SessionOnly` | SwitchParameter | — | — | Named | — | Używaj alternatywnych ustawień przechowywanych w sesji dla preferencji Wayback Machine |
| `-ClearSession` | SwitchParameter | — | — | Named | — | Czyść alternatywne ustawienia przechowywane w sesji dla preferencji Wayback Machine |
...
Otwiera archiwum Wayback Machine dla example.com na domyślnym monitorze.
...
Otwiera archiwum Wayback Machine dla example.com przy użyciu aliasów z odrzuconym pozycjonowaniem monitora.
...
Otwiera archiwum Wayback Machine dla microsoft.com w trybie incognito przeglądarki Chrome.
...
> Preferencja językowa dla interfejsu przeglądarki i treści
...
> Używaj alternatywnych ustawień przechowywanych w sesji dla preferencji Wayback Machine
...
> Czyść alternatywne ustawienia przechowywane w sesji dla preferencji Wayback Machine
