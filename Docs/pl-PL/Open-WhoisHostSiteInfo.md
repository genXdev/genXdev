...
> Otwiera zapytanie o informacje o hoście Whois w przeglądarce internetowej.

## Description

Otwiera zapytania o informacje hosta Whois w przeglądarce internetowej dla nazw domen lub adresów IP. Obsługuje konfigurowalny wybór monitora i wiele zapytań z rozbudowanymi opcjami konfiguracji przeglądarki, w tym pozycjonowaniem okna, wyborem przeglądarki i funkcjami automatyzacji.
...
| `-SessionOnly` | SwitchParameter | — | — | Named | — | Użyj alternatywnych ustawień zapisanych w sesji dla preferencji AI, takich jak język, kolekcje obrazów itp. |
...
| `-SkipSession` | SwitchParameter | — | — | Named | — | Przechowuj ustawienia tylko w preferencjach trwałych, bez wpływu na sesję, dla preferencji AI, takich jak język, kolekcje obrazów itp. |
...
Otwiera informacje Whois dla wielu domen na domyślnym monitorze.
...
Otwiera informacje Whois dla example.com przy użyciu aliasów i parametrów pozycyjnych.
...
Otwiera informacje Whois dla domen z potoku w trybie prywatnym Chrome.
...
> Użyj alternatywnych ustawień zapisanych w sesji dla preferencji AI, takich jak język, kolekcje obrazów itp.
...
> Przechowuj ustawienia tylko w preferencjach trwałych, bez wpływu na sesję, dla preferencji AI, takich jak język, kolekcje obrazów itp.
