...
> Otwiera holenderskie wyszukiwanie w Wikipedii w przeglądarce internetowej.

## Description

Otwiera zapytanie 'Wikipedia - Holandia' w przeglądarce internetowej z konfigurowalnymi opcjami wyświetlania. Obsługuje wyszukiwanie wielu terminów i określanie, na którym monitorze wyświetlić wyniki.
...
| `-SideBySide` | SwitchParameter | — | — | Named | — | Otwiera dwa okna przeglądarki obok siebie |
| `-SessionOnly` | SwitchParameter | — | — | Named | — | Używaj wyłącznie ciasteczek sesyjnych (bez trwałych ciasteczek) |
| `-ClearSession` | SwitchParameter | — | — | Named | — | Wyczyść dane sesji przeglądarki przed otwarciem |
...
> Otwiera dwa okna przeglądarki obok siebie
...
> Używaj wyłącznie ciasteczek sesyjnych (bez trwałych ciasteczek)
...
> Wyczyść dane sesji przeglądarki przed otwarciem
