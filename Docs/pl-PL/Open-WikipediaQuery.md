...
> Otwiera zapytanie Wikipedii w przeglądarce internetowej.

## Description

Otwiera jedno lub więcej zapytań wyszukiwania w Wikipedii w przeglądarce internetowej z rozbudowanymi opcjami konfiguracji. Obsługuje konfigurowalne zachowanie przeglądarki, wybór monitora i pozycjonowanie okna. Zapytania są kodowane w formacie URL i otwierane przy użyciu określonej domeny Wikipedii w wybranym języku z pełnym wsparciem lokalizacji.

Funkcja zapewnia kompleksową kontrolę nad przeglądarką, w tym tryby prywatne, pozycjonowanie okna, automatyzację klawiatury i obsługę wielu monitorów. Automatycznie obsługuje kodowanie URL i mapowanie kodów języków dla międzynarodowych domen Wikipedii.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Queries` | String[] | ✅ | ✅ (ByValue, ByPropertyName) | 0 | — | Zapytanie do wyszukiwania w Wikipedii, które należy wykonać |
| `-Language` | String | — | — | 1 | — | Język wyników wyszukiwania Wikipedii |
...
Otwiera wyszukiwanie w Wikipedii hasła „PowerShell” w języku angielskim na domyślnym monitorze.
...
Otwiera wyszukiwanie w Wikipedii za pomocą aliasu z parametrami pozycyjnymi.
...
Wyszukuje wiele terminów w niemieckiej Wikipedii, używając trybu przeglądania prywatnego.

## Parameter Details

### `-Queries <String[]>`

> Zapytanie do wyszukiwania w Wikipedii, które należy wykonać
...
> Język wyników wyszukiwania Wikipedii
