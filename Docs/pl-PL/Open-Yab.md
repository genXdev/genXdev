...
> Otwiera grę YAB w przeglądarce internetowej z konfigurowalnymi ustawieniami.

## Description

Otwiera stronę internetową gry YAB w określonej przeglądarce z różnymi opcjami wyświetlania i zachowania. Obsługuje różne tryby gry, w tym tryb widza. Gra YAB to internetowa gra logiczna, którą można grać interaktywnie lub oglądać w trybie widza, gdzie AI gra automatycznie.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Language` | String | — | — | 0 | — | Język interfejsu gry |
...
Otwiera grę YAB w trybie widza, używając przeglądarki Chrome, bez pełnego ekranu, z interfejsem w języku angielskim.
...
Otwiera grę YAB w przeglądarce Edge w trybie prywatnym na monitorze 2, używając aliasów do szybkiego dostępu.

## Parameter Details

### `-Language <String>`

> Język interfejsu gry
