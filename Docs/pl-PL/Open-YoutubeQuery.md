...
> Otwiera zapytania wyszukiwania YouTube w przeglądarce internetowej.

## Description

Otwiera jedno lub więcej zapytań wyszukiwania YouTube w przeglądarce internetowej z rozbudowanymi opcjami pozycjonowania i konfiguracji. Obsługuje konfigurowalny wybór monitora, ustawienia przeglądarki oraz automatyzację naciśnięć klawiszy poprzez dynamiczne parametry dziedziczone z polecenia Open-Webbrowser. Każde zapytanie otwiera się w osobnej instancji przeglądarki z pełną kontrolą nad pozycjonowaniem okna, typem przeglądarki i językiem wyszukiwania.
...
Otwiera wyszukiwanie w YouTube dla „PowerShell tutorial” na domyślnym monitorze.
...
Otwiera wyszukiwarkę YouTube dla "how to code" na skonfigurowanym drugim monitorze, używając aliasu funkcji.
