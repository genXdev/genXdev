...
> Przesuwa bieżące okno na stos okien z opcjonalnymi modyfikacjami.

## Description

Wypycha na stos pomocnika okna dla aktualnie skupionego okna.
Umożliwia zastosowanie różnych przekształceń okna przed lub po wypchnięciu.
Ta funkcja przechwytuje bieżące okno i przechowuje je do późniejszego odzyskania
za pomocą Polecenia Pop-Window, opcjonalnie stosując pozycjonowanie, zmiany rozmiaru i efekty wizualne.
