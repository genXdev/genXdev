...
> Rozszerza obiekty wejściowe na nazwy plików i katalogów, obsługując różne filtry i opcje wyjściowe.

## Description

Ta funkcja przetwarza obiekty wejściowe (pliki, katalogi lub kolekcje) i rozszerza je na nazwy plików i katalogów. Obsługuje filtrowanie, dopasowywanie wzorców i może zwracać wyniki jako obiekty. Funkcja jest zaprojektowana do pracy z wejściem potoku i zapewnia opcje rekurencji, alternatywnych strumieni danych i nie tylko.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-InputObject` | Object | — | ✅ (ByValue, ByPropertyName) | 0 | — | Obiekt wejściowy zawierający nazwy plików lub katalogów |
| `-File` | SwitchParameter | — | — | Named | — | Zwróć tylko pliki |
| `-Pattern` | String | — | — | 1 | — | Wzorzec wyrażenia regularnego do wyszukiwania w treści *(Parameter set: )* 🌐 *Supports wildcards* |
...
| `-Directory` | SwitchParameter | — | — | Named | — | Szukaj tylko katalogów *(Parameter set: )* |
| `-FilesAndDirectories` | SwitchParameter | — | — | Named | — | Uwzględniaj zarówno pliki, jak i katalogi *(Parameter set: )* |
...
> Obiekt wejściowy zawierający nazwy plików lub katalogów
