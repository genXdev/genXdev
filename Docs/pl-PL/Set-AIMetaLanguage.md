...
> Ustawia domyślny język oraz opcjonalnie katalogi obrazów dla operacji metadanych obrazów GenXdev.AI.

## Description

Ta funkcja konfiguruje globalny domyślny język dla operacji metadanych obrazów w module GenXdev.AI. Opcjonalnie może również ustawić globalne katalogi obrazów. Oba ustawienia są utrwalane w magazynie preferencji modułu do użytku między sesjami.
...
Ustawia trwale katalogi językowe i obrazków w preferencjach.
...
Ustawia język trwale w preferencjach.
...
Ustawia język tylko dla bieżącej sesji (zmienna globalna).
...
Czyści ustawienie języka sesji (zmienna globalna) bez wpływu na trwałe preferencje.
