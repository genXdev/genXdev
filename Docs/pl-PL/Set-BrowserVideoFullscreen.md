...
> Maksymalizuje pierwszy element wideo znaleziony w bieżącej karcie przeglądarki.

## Description

Wykonuje kod JavaScript, aby zlokalizować i zmaksymalizować pierwszy element wideo na bieżącej stronie internetowej. Wideo jest ustawione tak, aby pokrywało cały widoczny obszar z maksymalnym indeksem Z, zapewniając widoczność. Paski przewijania strony są ukryte dla czystego doświadczenia pełnoekranowego.
