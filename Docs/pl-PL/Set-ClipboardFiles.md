...
> Ustawia pliki w schowku systemu Windows na potrzeby operacji na plikach, takich jak kopiuj/wklej.

## Description

Ta funkcja kopiuje jedną lub więcej ścieżek plików do schowka systemu Windows,
umożliwiając operacje na plikach, takie jak wklejanie w Eksploratorze Windows. 
Automatycznie obsługuje tryby wątków STA i MTA, zapewniając zgodność w różnych 
kontekstach wykonywania PowerShell. Funkcja sprawdza istnienie plików przed 
dodaniem ścieżek do schowka.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-InputObject` | String[] | ✅ | ✅ (ByValue, ByPropertyName) | 0 | — | Tablica ścieżek plików do dodania do schowka |
...
> Tablica ścieżek plików do dodania do schowka
