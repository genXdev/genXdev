...
> Zmienia bieżącą lokalizację na katalog nadrzędny i wyświetla jego zawartość.

## Description

* Przechodzi o jeden poziom w górę w hierarchii systemu plików.
* Wyświetla zawartość nowego bieżącego katalogu.
* Zapewnia wygodny alias '..' do szybkiej nawigacji między katalogami.
...
Przechodzi do katalogu nadrzędnego i wyświetla listę jego zawartości.
...
Używa aliasu, aby przejść do katalogu nadrzędnego.
