...
> Nawiguje w górę o trzy poziomy w hierarchii systemu plików.

## Description

* Zmienia bieżący katalog roboczy, przechodząc o trzy poziomy w górę
  w hierarchii systemu plików.
* Wyświetla zawartość wynikowego katalogu.
...
Przechodzi o trzy poziomy katalogów w górę z bieżącej lokalizacji.
...
Używa aliasu, aby przejść o trzy poziomy katalogów w górę.
