...
> Konfiguruje wyrównanie paska zadań systemu Windows 11+ pomiędzy pozycją środkową a lewą.

## Description

Ustawia wyrównanie paska zadań w systemie Windows 11 i nowszych wersjach, modyfikując klucz rejestru 'TaskbarAl' w HKCU:\SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer\Advanced. Wyrównanie można ustawić na środek (wartość 1) lub lewo (wartość 0).
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Justify` | String | ✅ | — | 0 | — | Wyrównanie paska zadań (Centrum lub Lewo) |
...
> Wyrównanie paska zadań (Centrum lub Lewo)
