...
> Umieszcza okno na monitorze dodatkowym z określonymi opcjami układu.

## Description

Ta funkcja umożliwia pozycjonowanie okien na skonfigurowanym monitorze dodatkowym przy użyciu Set-WindowPosition z różnymi opcjami rozmieszczenia, w tym wyrównaniem, rozmiarem i ustawieniami obramowania. Obsługuje wybór monitora na podstawie konfiguracji globalnej i zapewnia wygodną otoczkę do pozycjonowania okien na monitorze dodatkowym.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Process` | Diagnostics.Process[] | — | ✅ (ByValue, ByPropertyName) | 0 | — | Proces pozycjonowania okna |
| `-Monitor` | Int32 | — | — | Named | `-2` | Monitor do użycia, 0=domyślny, -1=odrzuć, -2=skonfigurowany |
| `-Width` | Int32 | — | — | Named | `-1` | Początkowa szerokość okna |
| `-Height` | Int32 | — | — | Named | `-1` | Początkowa wysokość okna |
| `-X` | Int32 | — | — | Named | `-999999` | Początkowa pozycja X okna |
| `-Y` | Int32 | — | — | Named | `-999999` | Początkowa pozycja Y okna |
...
| `-FocusWindow` | SwitchParameter | — | — | Named | — | Ustaw fokus na oknie po jego pozycjonowaniu |
| `-SetForeground` | SwitchParameter | — | — | Named | — | Ustaw okno na pierwszym planie po pozycjonowaniu |
...
| `-KeysToSend` | String[] | — | — | Named | — | Naciśnięcia klawiszy do wysłania do okna po pozycjonowaniu |
...
| `-PassThru` | SwitchParameter | — | — | Named | — | Zwraca obiekt procesu po pozycjonowaniu |
| `-SideBySide` | SwitchParameter | — | — | Named | — | Umieść okno obok PowerShell na tym samym monitorze |
...
> Monitor do użycia, 0=domyślny, -1=odrzuć, -2=skonfigurowany
...
> Ustaw fokus na oknie po jego pozycjonowaniu
...
> Ustaw okno na pierwszym planie po pozycjonowaniu
...
> Naciśnięcia klawiszy do wysłania do okna po pozycjonowaniu
...
> Zwraca obiekt procesu po pozycjonowaniu
...
> Umieść okno obok PowerShell na tym samym monitorze
