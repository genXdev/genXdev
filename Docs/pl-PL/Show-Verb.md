...
> Wyświetla krótką alfabetyczną listę wszystkich czasowników programu PowerShell.

## Description

Wyświetla zatwierdzone czasowniki PowerShell w postaci listy rozdzielonej przecinkami. Jeśli podano konkretne czasowniki jako dane wejściowe, zostaną wyświetlone tylko pasujące czasowniki. Obsługuje symbole wieloznaczne.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Verb` | String[] | — | ✅ (ByValue, ByPropertyName) | 0 | `@()` | Co najmniej jeden wzór czasownika do filtrowania (obsługuje symbole wieloznaczne) 🌐 *Supports wildcards* |
...
> Co najmniej jeden wzór czasownika do filtrowania (obsługuje symbole wieloznaczne)
