...
> Otwiera adres URL w wielu przeglądarkach jednocześnie w układzie mozaikowym.

## Description

Ta funkcja tworzy układ mozaikowy okien przeglądarki, otwierając określony
URL w Chrome, Edge, Firefox oraz w oknie prywatnym. Przeglądarki są
rozmieszczone w siatce 2x2:
- Chrome: Lewy-górny kwadrant
- Edge: Lewy-dolny kwadrant
- Firefox: Prawy-górny kwadrant
- Okno prywatne: Prawy-dolny kwadrant

Wszystkie parametry z Open-Webbrowser są obsługiwane i przekazywane w celu kontroli
pozycjonowania, zachowania i wyglądu przeglądarki. Funkcja działa jak otoka,
która stosuje spójne pozycjonowanie w kwadrantach, jednocześnie pozwalając na pełną
konfigurację parametrów uruchamiania przeglądarki.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Url` | String | ✅ | ✅ (ByValue, ByPropertyName) | 0 | — | Adresy URL do otwarcia we wszystkich przeglądarkach jednocześnie |
...
> Adresy URL do otwarcia we wszystkich przeglądarkach jednocześnie
