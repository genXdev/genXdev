...
> Aktualizuje wsadowo słowa kluczowe obrazów, twarze, obiekty i sceny w wielu katalogach systemowych.

## Description

Ta funkcja systematycznie przetwarza obrazy w różnych katalogach systemowych, aby zaktualizować ich słowa kluczowe, dane rozpoznawania twarzy, dane wykrywania obiektów i dane klasyfikacji scen przy użyciu usług AI. Obejmuje magazyn multimediów, pliki systemowe, pliki do pobrania, OneDrive i osobiste foldery zdjęć.

Funkcja przetwarza obrazy, przechodząc przez każdy katalog i przetwarzając pliki indywidualnie. Funkcje DeepStack (twarze, obiekty, sceny) są wykonywane jako pierwsze, a następnie generowanie słów kluczowych i opisów.

Umożliwia to ustrukturyzowane wyjście danych dla operacji potokowych, takich jak:
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-ImageDirectories` | String[] | ✅ | — | 0 | — | Tablica ścieżek katalogów do przetworzenia w celu aktualizacji obrazów |
...
| `-TimeoutSeconds` | Int32 | — | — | Named | — | Limit czasu w sekundach dla żądania, domyślnie 24 godziny |
...
| `-NoRecurse` | SwitchParameter | — | — | Named | — | Nie przeszukuj podkatalogów podczas przetwarzania obrazów |
| `-RedoAll` | SwitchParameter | — | — | Named | — | Ponownie przetwórz wszystkie obrazy niezależnie od poprzedniego przetwarzania |
...
> Tablica ścieżek katalogów do przetworzenia w celu aktualizacji obrazów
...
> Nie przeszukuj podkatalogów podczas przetwarzania obrazów
...
> Ponownie przetwórz wszystkie obrazy niezależnie od poprzedniego przetwarzania
