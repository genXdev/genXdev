...
> Adiciona uma linha de ReleaseNote ao arquivo README com um carimbo de data/hora.

## Description

Adiciona uma linha de ReleaseNote ao arquivo README especificado, prefixada com a data atual no formato aaaammdd. A linha pode ser formatada como código e exibida opcionalmente.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Line` | String | — | — | 0 | `''` | O texto da descrição da nota de versão a ser adicionado |
| `-Code` | SwitchParameter | — | — | Named | — | Formatar a linha como código |
| `-Show` | SwitchParameter | — | — | Named | — | Exiba o README após adicionar a linha |
| `-UseHomeREADME` | SwitchParameter | — | — | Named | — | Use o README no diretório home |
...
> O texto da descrição da nota de versão a ser adicionado
...
> Exiba o README após adicionar a linha
...
> Use o README no diretório home
