...
Adiciona um item de tarefa com carimbo de data/hora à seção "## Todoos" de um arquivo README.md.
Os itens de tarefa podem ser marcados como concluídos e a seção modificada pode ser exibida.
Cada novo item de tarefa recebe automaticamente carimbo de data/hora, a menos que esteja marcando como concluído.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Line` | String | — | — | 0 | `''` | O texto do item de tarefa a adicionar |
...
> O texto do item de tarefa a adicionar
...
> Marcar item de tarefa como concluído
