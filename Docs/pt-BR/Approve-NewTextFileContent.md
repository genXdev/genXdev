...
> Comparação interativa de conteúdo de arquivos e aprovação usando WinMerge.

## Description

Facilita a comparação e mesclagem de conteúdo por meio do WinMerge, criando um arquivo temporário com as alterações propostas. O usuário pode revisar e modificar as alterações interativamente antes de aprová-las. Retorna o status de aprovação e o conteúdo final.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-ContentPath` | String | ✅ | — | 0 | — | Caminho para o arquivo de destino para comparação |
| `-Monitor` | Int32 | — | — | 1 | `-2` | O monitor a ser usado, 0 = padrão, -1 descarta, -2 = monitor secundário configurado, padrão é $Global:DefaultSecondaryMonitor ou 2 se não encontrado |
...
| `-KeysToSend` | String[] | — | — | Named | — | Toques de tecla para enviar à janela, consulte a documentação do cmdlet GenXdev\Send-Key |
...
> Caminho para o arquivo de destino para comparação
...
> Toques de tecla para enviar à janela, consulte a documentação do cmdlet GenXdev\Send-Key
