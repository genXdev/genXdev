...
> Converte nomes de tipo .NET para nomes de tipo LLM (Modelo de Linguagem).
...
Converte um tipo System.String para o equivalente de LLM.

## Parameter Details

### `-DotNetType <String>`

> O nome do tipo .NET para converter em um nome de tipo LLM
