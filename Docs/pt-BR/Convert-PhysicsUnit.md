...
Esta função converte quantidades físicas entre unidades compatíveis em categorias como comprimento, tempo, velocidade, etc. Ela infere a categoria das unidades e gera um erro para conversões incompatíveis.
...
Converte 10 segundos em minutos usando parâmetros posicionais.
