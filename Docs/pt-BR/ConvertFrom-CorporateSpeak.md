...
> Converte discurso corporativo educado e profissional em linguagem direta e clara usando IA.

## Description

Esta função processa texto de entrada para transformar comunicações diplomáticas e corporativas em uma linguagem mais direta e clara. Ela pode aceitar entrada diretamente por meio de parâmetros, do pipeline ou da área de transferência do sistema. A função aproveita modelos de IA para analisar e reformular o texto, preservando a intenção original.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Text` | String | — | ✅ (ByValue) | 0 | — | O texto para converter de linguagem corporativa |
...
> O texto para converter de linguagem corporativa
