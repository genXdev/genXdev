...
> Converte textos diretos ou ríspidos em linguagem corporativa educada e profissional usando inteligência artificial.

## Description

Esta função processa o texto de entrada para transformar linguagem direta ou potencialmente agressiva em comunicações corporativas diplomáticas e profissionais. Ela pode aceitar entrada diretamente por meio de parâmetros, do pipeline ou da área de transferência do sistema. A função utiliza modelos de IA para analisar e reformular o texto, preservando a intenção original.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Text` | String | — | ✅ (ByValue) | 0 | — | O texto para converter em linguagem corporativa |
...
> O texto para converter em linguagem corporativa
