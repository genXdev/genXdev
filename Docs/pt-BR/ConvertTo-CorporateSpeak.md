...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Text` | String | — | ✅ (ByValue) | 0 | — | Your request has been received and will be addressed promptly. We appreciate your input and will take it under advisement to ensure optimal outcomes. |
