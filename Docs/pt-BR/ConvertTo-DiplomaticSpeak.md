...
> Converte texto direto ou brusco em linguagem diplomática educada e diplomática.

## Description

Esta função transforma a entrada do usuário de frases diretas ou bruscas em linguagem diplomática e educada, adequada para discussões de alto nível, negociações ou comunicações formais. A função utiliza modelos de linguagem de IA para manter a intenção original enquanto suaviza o tom e torna a mensagem mais diplomática e profissional.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Text` | String | — | ✅ (ByValue) | 0 | — | The text is being translated into Portuguese (Brazil). |
...
> The text is being translated into Portuguese (Brazil).
