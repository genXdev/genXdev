...
> Copia arquivos correspondentes aos critérios de pesquisa em subpastas baseadas em data.
...
Tenta várias estratégias para determinar uma data de criação ou captura precisa para o arquivo especificado. As estratégias incluem a leitura de metadados EXIF de imagem, a interpretação de informações de data/hora de nomes de arquivo e o recurso à data da última gravação do arquivo quando nenhuma outra informação confiável está disponível.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-TargetFolder` | String | ✅ | — | 0 | — | Pasta raiz de destino onde os arquivos correspondentes serão copiados para subpastas baseadas em data |
...
Copy-FilesToDateFolder -PastaDestino 'D:\Arquivo' -Nome '*.jpg' -WhatIf
...
> Pasta raiz de destino onde os arquivos correspondentes serão copiados para subpastas baseadas em data
