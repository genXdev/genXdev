...
Ativa o protetor de tela do sistema Windows executando o executável padrão do protetor de tela (scrnsave.scr) com a opção /s para iniciá-lo imediatamente.
