...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-OutputFile` | String | ✅ | — | 0 | — | Caminho para o arquivo JSON onde os favoritos serão salvos |
...
> Caminho para o arquivo JSON onde os favoritos serão salvos
...
> Exportar favoritos do Google Chrome
...
> Exportar favoritos do Mozilla Firefox
