...
> Recupera o objeto de processo da janela que possui o foco do teclado atualmente.

## Description

* Este cmdlet usa chamadas de API do Windows por meio de P/Invoke para identificar e
  retornar o objeto Process associado à janela atualmente em foco.
* Ele aproveita as funções GetForegroundWindow e
  GetWindowThreadProcessId da User32.dll para determinar qual janela tem foco e obter
  seu ID de processo associado.
...
Recupera o objeto de processo da janela que atualmente possui o foco do teclado.
