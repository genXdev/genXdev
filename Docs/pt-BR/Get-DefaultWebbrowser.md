...
> Retorna o navegador da web padrão configurado para o usuário atual.

## Description

* Recupera informações sobre o navegador web padrão do sistema consultando o Registro do Windows.
* Retorna uma hashtable contendo o nome, descrição, caminho do ícone e caminho executável do navegador.
* A função verifica tanto as preferências do usuário quanto os registros de navegador em todo o sistema para determinar o navegador padrão.
...
Inicie o navegador padrão com uma URL específica.
