...
* Obtém o fator de escala de exibição do Windows atual configurado para um monitor no sistema.
* O fator de escala é expresso como uma porcentagem, onde 100 representa a escala padrão (96 DPI). Valores comuns são 100, 125, 150 e 200.
* Se nenhum monitor for especificado, retorna o fator de escala para o monitor principal.
...
> O índice do monitor a ser verificado (0 = monitor primário)
