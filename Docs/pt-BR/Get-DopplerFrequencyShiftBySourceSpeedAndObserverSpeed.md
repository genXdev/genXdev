...
| `-Medium` | String | ✅ | — | 3 | — | A mídia *(Parameter set: )* |
| `-As` | String | — | — | 4 | — | Unidade de saída para frequência |
...
Calcula a frequência deslocada por Doppler para um tom de 440 Hz com fonte se movendo a 10 m/s, observador estacionário, velocidade do som de 1480 m/s.

## Parameter Details

### `-OriginalFrequencyInHertz <Double>`

> Frequência original em Hz
...
> Velocidade da fonte em m/s (positiva em direção ao observador)
...
> Velocidade do observador em m/s (positiva em direção à fonte)
...
> Velocidade do som em m/s (padrão: 343)
