...
| `-AreaInSquareMeters` | Double | ✅ | — | 2 | `0` | Área de seção transversal em m² |
| `-Coefficient` | Double | ✅ | — | 3 | `0` | Coeficiente de arrasto |
| `-As` | String | — | — | 4 | — | Unidade de saída para força |
...
Calcula a força de arrasto usando velocidade de 10 m/s, densidade do ar de 1,225 kg/m³, área de 1 m² e coeficiente de 0,5, gerando saída em libra-força.
