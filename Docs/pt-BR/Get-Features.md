...
> Exibe recursos de um arquivo README.md.

## Description

Mostra todos os recursos da seção "## Recursos" de um arquivo README.md. Pode usar o README no local atual, diretório de perfil do PowerShell ou diretório do OneDrive.
