...
> Calcula a distância percorrida durante a queda livre para um determinado período de tempo.
...
> A velocidade terminal em metros por segundo (padrão: 53)
...
> A aceleração da gravidade em m/s² (padrão: 9,81)
