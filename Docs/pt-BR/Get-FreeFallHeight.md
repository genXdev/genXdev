...
> Calcula a altura de queda livre para uma determinada duração de tempo.
...
| `-As` | String | — | — | 2 | — | A unidade para a altura da saída |
...
Calcula a altura caída em 10 segundos com a velocidade terminal humana padrão.
...
> A duração da queda em segundos
...
> A unidade para a altura da saída
