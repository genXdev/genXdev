...
> Exibe ideias de um arquivo README.md.

## Description

Mostra todas as ideias da seção "## Ideias" de um arquivo README.md. Pode usar o README no local atual, no diretório de perfil do PowerShell ou no diretório do OneDrive.
