...
Exibe todos os problemas da seção "## Issues" de um arquivo README.md. Pode usar o README no local atual, no diretório de perfil do PowerShell ou no diretório do OneDrive.
