...
> Obtém o caminho de uma pasta conhecida do Windows usando a API Shell32.

## Description

Recupera o caminho de uma pasta conhecida do Windows especificada usando a função SHGetKnownFolderPath da API Shell32. Este método é mais confiável do que o uso de variáveis de ambiente, pois funciona de forma consistente em diferentes versões do Windows e configurações de idioma. Suporta todas as pastas conhecidas padrão do Windows, como Documentos, Downloads, AppData etc.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-KnownFolder` | String | ✅ | — | 0 | — | O nome da pasta conhecida do Windows para obter o caminho |
...
> O nome da pasta conhecida do Windows para obter o caminho
