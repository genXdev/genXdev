...
> Exibe ReleaseNotes a partir de um arquivo README.md.

## Description

Mostra todas as notas de versão da seção "## Notas de versão" de um arquivo README.md. Pode usar o README no diretório atual, no diretório de perfil do PowerShell ou no diretório do OneDrive.
...
> Limitar a saída às primeiras N linhas
