...
> Recupera as informações completas de esquema de um banco de dados SQL Server.

## Description

Esta função consulta tabelas do sistema do SQL Server e o esquema de informações para obter a definição completa do esquema de um banco de dados do SQL Server, incluindo tabelas, visualizações, índices, procedimentos armazenados e outros objetos do banco de dados. Ela aceita uma string de conexão ou um nome de banco de dados com parâmetros do servidor.
