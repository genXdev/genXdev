...
> Recupera as informações de esquema de uma tabela SQL Server especificada.

## Description

Esta função consulta o banco de dados SQL Server para obter informações detalhadas do esquema de uma tabela especificada. Ela usa a visão INFORMATION_SCHEMA.COLUMNS do SQL Server para retornar definições de colunas incluindo nomes, tipos, status de nulidade e valores padrão.
