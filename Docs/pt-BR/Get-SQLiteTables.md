...
Consulta a tabela de sistema sqlite_master para recuperar todos os nomes de tabelas definidas pelo usuário de um banco de dados SQLite. Suporta conexão tanto por uma string de conexão direta quanto por um caminho de arquivo de banco de dados. Retorna os nomes das tabelas como uma coleção de strings.
