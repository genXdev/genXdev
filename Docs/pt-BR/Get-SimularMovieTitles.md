...
> Encontra títulos de filmes semelhantes com base em propriedades comuns.

## Description

Analisa os filmes fornecidos para encontrar propriedades comuns e retorna uma lista de 10 títulos de filmes semelhantes. Usa IA para identificar padrões e temas entre os filmes de entrada para sugerir recomendações relevantes.
...
| `-LLMQueryType` | String | — | — | 1 | `'Knowledge'` | O tipo da consulta LLM |
...
| `-Language` | String | — | — | Named | — | Idioma para pesquisa ou sessão do navegador no IMDB |
| `-Monitor` | Int32 | — | — | Named | `-1` | Monitorar índice ou nome para posicionamento de janela do navegador |
...
| `-Private` | SwitchParameter | — | — | Named | — | Abrir o navegador no modo privado/anônimo |
| `-Chrome` | SwitchParameter | — | — | Named | — | Use o Google Chrome para a sessão do navegador |
| `-Chromium` | SwitchParameter | — | — | Named | — | Usar Chromium para sessão do navegador |
| `-Firefox` | SwitchParameter | — | — | Named | — | Use o Mozilla Firefox para a sessão do navegador |
...
| `-ApplicationMode` | SwitchParameter | — | — | Named | — | Abra o navegador no modo aplicativo (interface mínima) |
...
| `-SetForeground` | SwitchParameter | — | — | Named | — | Definir a janela do navegador como primeiro plano após abertura |
| `-Maximize` | SwitchParameter | — | — | Named | — | Maximizar a janela do navegador após abri-la |
...
| `-ReturnURL` | SwitchParameter | — | — | Named | — | Retorne a URL após abrir a pesquisa IMDB |
| `-ReturnOnlyURL` | SwitchParameter | — | — | Named | — | Retorne apenas a URL sem abrir o navegador |
| `-SendKeyEscape` | SwitchParameter | — | — | Named | — | Enviar a tecla Escape para o navegador após abrir |
| `-SendKeyHoldKeyboardFocus` | SwitchParameter | — | — | Named | — | Manter o foco do teclado no navegador após enviar as teclas |
...
| `-Attachments` | String[] | — | — | Named | — | Matriz de caminhos de arquivo para anexar |
| `-ImageDetail` | String | — | — | Named | — | Nível de detalhe da imagem para processamento de imagem. |
| `-Functions` | Collections.Hashtable[] | — | — | Named | — | Matriz de definições de funções que podem ser chamadas pelo modelo de IA durante o processamento. |
| `-ExposedCmdLets` | GenXdev.Helpers.ExposedCmdletDefinition[] | — | — | Named | — | Matriz de definições de comandos do PowerShell para usar como ferramentas que a IA pode invocar. |
| `-NoConfirmationToolFunctionNames` | String[] | — | — | Named | — | Matriz de nomes de comando que não exigem confirmação antes da execução. |
| `-AudioTemperature` | Double | — | — | Named | — | Temperatura para geração de áudio. |
| `-TemperatureResponse` | Double | — | — | Named | — | Temperatura para a geração de resposta. |
...
> Array de títulos de filmes para analisar semelhanças
...
> Idioma para pesquisa ou sessão do navegador no IMDB
...
> Monitorar índice ou nome para posicionamento de janela do navegador
...
> Cabeçalho HTTP Accept-Language para sessão do navegador
...
> Abrir o navegador no modo privado/anônimo
...
> Use o Google Chrome para a sessão do navegador
...
> Usar Chromium para sessão do navegador
...
> Use o Mozilla Firefox para a sessão do navegador
...
> Posição esquerda da janela do navegador em pixels
...
> Posição direita da janela do navegador em pixels
...
> Posição inferior da janela do navegador em pixels
...
> Abrir janela do navegador centralizada na tela
...
> Abrir navegador em modo de tela cheia
...
> Abra o navegador no modo aplicativo (interface mínima)
...
> Desativar extensões do navegador para a sessão
...
> Desativar bloqueador de pop-ups na sessão do navegador
...
> Definir a janela do navegador como primeiro plano após abertura
...
> Maximizar a janela do navegador após abri-la
...
> Restaurar o foco para a janela anterior após fechar o navegador
...
> Abrir cada resultado do IMDB em uma nova janela do navegador
...
> Retorne a URL após abrir a pesquisa IMDB
...
> Retorne apenas a URL sem abrir o navegador
...
> Enviar a tecla Escape para o navegador após abrir
...
> Manter o foco do teclado no navegador após enviar as teclas
...
> Use Shift+Enter ao enviar teclas para o navegador
...
> Atraso em milissegundos entre o envio de teclas para o navegador
...
> Abrir janela do navegador sem bordas
...
> Abra janelas do navegador lado a lado para cada resultado
...
> Nível de detalhe da imagem para processamento de imagem.
...
> Matriz de definições de funções que podem ser chamadas pelo modelo de IA durante o processamento.
...
> Matriz de definições de comandos do PowerShell para usar como ferramentas que a IA pode invocar.
...
> Matriz de nomes de comando que não exigem confirmação antes da execução.
...
> Desative a saída de pensamento.
...
> Quando especificado, copia a lista de strings resultante de volta para a área de transferência do sistema após o processamento.
