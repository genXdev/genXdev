...
Processa arquivos de áudio e converte fala em texto usando a biblioteca Whisper.NET, que implementa o sistema de reconhecimento automático de fala (ASR) Whisper da OpenAI. Suporta vários idiomas, recursos de tradução e várias configurações de qualidade de transcrição.
...
| `-Input` | Object | ✅ | ✅ (ByValue) | 0 | — | Caminho do arquivo de áudio, objeto FileInfo ou qualquer formato de áudio compatível com o Whisper. |
...
| `-ModelType` | Whisper.net.Ggml.GgmlType | — | — | Named | `Tiny` | Tipo de modelo Whisper a usar, padrão é LargeV3Turbo |
...
Transcreve um arquivo de áudio para texto usando as configurações padrão.
...
> Caminho para o diretório do arquivo do modelo
...
> Caminho do arquivo de áudio, objeto FileInfo ou qualquer formato de áudio compatível com o Whisper.
