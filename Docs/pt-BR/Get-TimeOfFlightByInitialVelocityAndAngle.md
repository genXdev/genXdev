...
> Calcula o tempo de voo para um projétil.

## Description

Usa T = (2 v sinθ) / g para movimento ideal.
...
Calcula o tempo de voo para um projétil lançado a 20 m/s a 45 graus, saída em minutos.
