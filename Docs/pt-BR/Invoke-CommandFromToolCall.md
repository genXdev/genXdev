...
> Executa uma chamada de ferramenta com validação e filtragem de parâmetros.

## Description

Esta função processa chamadas de ferramenta validando argumentos, filtrando parâmetros e executando callbacks com o devido tratamento de confirmação. Ela suporta tanto script block quanto callbacks de informações de comando.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-ToolCall` | Collections.Hashtable | ✅ | — | 0 | — | .EXTERNALSCRIPT \"<script-path>\" [-ArgumentList <arguments>] |
...
> .EXTERNALSCRIPT \"<script-path>\" [-ArgumentList <arguments>]
