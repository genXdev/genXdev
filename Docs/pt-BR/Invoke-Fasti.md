...
> Extrai arquivos de archive no diretório atual para suas próprias pastas e os exclui depois.

## Description

Extrai automaticamente formatos de arquivo comuns (zip, 7z, tar, etc.) encontrados no diretório atual para pastas individuais nomeadas de acordo com cada arquivo. Após a extração bem-sucedida, os arquivos originais são excluídos. Requer que o 7-Zip esteja instalado no sistema.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Password` | String | — | — | 0 | — | Insira a senha para o(s) arquivo(s) criptografado(s) |
| `-ExtractOutputToo` | SwitchParameter | — | — | Named | — | Extrair recursivamente arquivos encontrados dentro de pastas extraídas |
...
> Insira a senha para o(s) arquivo(s) criptografado(s)
...
> Extrair recursivamente arquivos encontrados dentro de pastas extraídas
