...
> Transforma texto usando processamento alimentado por IA.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Text` | String | — | ✅ (ByValue) | 0 | — | `Test-Connection` envia pacotes de solicitação de eco ICMP, ou pings, a um ou mais computadores remotos e retorna as respostas de eco. |
| `-Instructions` | String | — | — | 1 | `('Check and correct any spelling or grammar ' +
            'errors in the text. Return the corrected text without any ' +
            'additional comments or explanations.')` | .DESCRIPTION
O cmdlet Get-Service recupera os serviços do computador, incluindo serviços em execução e serviços interrompidos. Por padrão, esse cmdlet recupera todos os serviços no computador.

Você pode usar esse cmdlet para iniciar e interromper serviços. Especifique um nome de serviço ou exiba informações sobre o serviço.

O PowerShell inclui os seguintes aliases para Get-Service:

- Todos os ambientes: `gsv`

Exemplos de saída de Get-Service: |
...
> `Test-Connection` envia pacotes de solicitação de eco ICMP, ou pings, a um ou mais computadores remotos e retorna as respostas de eco.
