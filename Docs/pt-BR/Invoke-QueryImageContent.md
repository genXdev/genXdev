...
> Analisa o conteúdo da imagem usando capacidades de visão de IA
...
| `-SuppressRegex` | String | — | — | Named | — | Expressão regular para suprimir a saída. |
...
| `-DontSpeakThoughts` | SwitchParameter | — | — | Named | — | Se especificado, não fale os pensamentos do modelo. |
| `-NoVOX` | SwitchParameter | — | — | Named | — | Se especificado, desabilita VOX. |
...
| `-WithBeamSearchSamplingStrategy` | SwitchParameter | — | — | Named | — | Se especificado, use a estratégia de amostragem por busca em feixe. |
| `-OnlyResponses` | SwitchParameter | — | — | Named | — | Se especificado, retorna apenas as respostas. |
| `-DontAddThoughtsToHistory` | SwitchParameter | — | — | Named | — | Se especificado, não adicione pensamentos ao histórico. |
| `-ContinueLast` | SwitchParameter | — | — | Named | — | Desculpe, não tenho o contexto da conversa anterior. Poderia fornecer mais detalhes sobre o que deseja traduzir? |
| `-Speak` | SwitchParameter | — | — | Named | — | O conteúdo fornecido não contém texto para tradução. Por favor, forneça o texto que precisa ser traduzido. |
| `-SpeakThoughts` | SwitchParameter | — | — | Named | — | Fale os pensamentos do modelo. |
| `-OutputMarkdownBlocksOnly` | SwitchParameter | — | — | Named | — | ### Get-WinEvent
Obtenha eventos de logs de eventos e logs de rastreamento de eventos no computador local e em computadores remotos. |
| `-MarkupBlocksTypeFilter` | String[] | — | — | Named | — | Filtro para tipos de blocos de marcação. |
| `-ChatOnce` | SwitchParameter | — | — | Named | — | Se especificado, converse apenas uma vez. |
| `-NoSessionCaching` | SwitchParameter | — | — | Named | — | Desabilitar cache de sessão. |
...
Analisa uma imagem com limites específicos de temperatura e tokens.
...
Análise de imagem simples utilizando alias e parâmetros posicionais.

## Parameter Details

### `-Query <String>`

> A string de consulta para analisar a imagem
...
> Caminho para o arquivo de imagem para análise
...
> Temperatura para geração de resposta de áudio.
...
> Temperatura para a geração da resposta.
...
> Se especificado, não fale a saída.
...
> Se especificado, não fale os pensamentos do modelo.
...
> Se especificado, desabilita VOX.
...
> Se especificado, use a captura de áudio da área de trabalho.
...
> Se especificado, use a estratégia de amostragem por busca em feixe.
...
> Se especificado, retorna apenas as respostas.
...
> Se especificado, não adicione pensamentos ao histórico.
...
> Desculpe, não tenho o contexto da conversa anterior. Poderia fornecer mais detalhes sobre o que deseja traduzir?
...
> O conteúdo fornecido não contém texto para tradução. Por favor, forneça o texto que precisa ser traduzido.
...
> Filtro para tipos de blocos de marcação.
...
> Se especificado, converse apenas uma vez.
