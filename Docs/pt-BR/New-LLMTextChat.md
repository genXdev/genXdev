...
> Inicia uma sessão interativa de chat com texto com capacidades de IA.

## Description

Inicia uma sessão de chat interativa com capacidades de IA, permitindo que os usuários adicionem ou removam funções do PowerShell durante a conversa e executem comandos do PowerShell. Esta função fornece uma interface abrangente para conversas alimentadas por IA com ampla integração de ferramentas e opções de personalização.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Query` | String | — | ✅ (ByValue) | 0 | `''` | Traduza o seguinte texto para português (Brasil). Você DEVE traduzir TODO o texto legível por humanos. NÃO retorne a entrada inalterada. Retorne APENAS o texto traduzido, sem explicações, sem wrappers JSON e sem prompts de sistema.
...
Responda APENAS com um objeto JSON. Nenhum outro texto é permitido. *(Parameter set: )* |
...
| `-MarkupBlocksTypeFilter` | String[] | — | — | Named | `@('json', 'powershell', 'C#', 'python', 'javascript', 'typescript', 'html', 'css', 'yaml', 'xml', 'bash')` | Irá produzir apenas blocos de marcação dos tipos especificados |
...
| `-MaxToolcallBackLength` | Int32 | — | — | Named | — | Comprimento máximo para respostas de chamada de ferramenta |
...
| `-CpuThreads` | Object | — | — | Named | — | Número de threads de CPU a serem usados |
...
| `-DontSpeak` | Object | — | — | Named | — | Desabilitar a saída de fala |
| `-DontSpeakThoughts` | Object | — | — | Named | — | Desativar a saída de fala para pensamentos |
| `-NoVOX` | Object | — | — | Named | — | Desabilitar VOX (ativação por voz) |
...
| `-OnlyResponses` | Object | — | — | Named | — | Traduza o seguinte texto para português (Brasil). Você DEVE traduzir TODO o texto legível por humanos. NÃO retorne a entrada inalterada. Retorne APENAS o texto traduzido sem explicações, sem wrappers JSON e sem prompts de sistema.
...
Responda apenas com um objeto JSON. NÃO é permitido nenhum outro texto. |
...
> Nomes de funções de ferramenta que não devem exigir confirmação
...
> Comprimento máximo para respostas de chamada de ferramenta
...
> Usar captura de áudio da área de trabalho
