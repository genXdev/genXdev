...
> Gera arquivos de ajuda MAML XML para qualquer módulo PowerShell.

## Description

Gera arquivos de ajuda MAML XML para qualquer módulo do PowerShell, extraindo metadados de todos os cmdlets em um módulo usando Get-CmdletMetaData e produzindo tanto ModuleName.dll-Help.xml (para cmdlets C#) quanto ModuleName-help.xml (para cmdlets baseados em script).
...
| `-Force` | SwitchParameter | — | — | Named | — | Substituir arquivos de ajuda XML existentes sem avisar |
...
| `-LinkPrefix` | String | — | — | Named | — | Prefixo de URL para o link de Versão Online em cada link relacionado ao cmdlet (por exemplo, https://github.com/genXdev/genXdev/blob/main/Docs/pt-BR/) |
...
Gera um XML de ajuda em inglês para o módulo Pester em en-US.
...
Gera o arquivo de ajuda em holandês para GenXdev, sobrescrevendo arquivos existentes.
...
Mostra quais arquivos seriam criados sem realmente gravá-los.
...
Gera XML de ajuda em inglês com URLs de versão online por cmdlet apontando para documentos Markdown no GitHub. Get-Help <cmdlet> -Online abre o navegador.
...
> Substituir arquivos de ajuda XML existentes sem avisar
...
> Prefixo de URL para o link de Versão Online em cada link relacionado ao cmdlet (por exemplo, https://github.com/genXdev/genXdev/blob/main/Docs/pt-BR/)
...
> Instruções personalizadas para a tradução do LLM (passadas para Get-TextTranslation)
