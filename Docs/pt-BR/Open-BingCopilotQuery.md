...
> Abre uma consulta do Bing CoPilot em um navegador da web

## Description

Abre uma consulta do Bing CoPilot no navegador da web. A função automaticamente digita a consulta e a envia usando a função subjacente Open-WebsiteAndPerformQuery. Isso fornece uma maneira conveniente de interagir com o Microsoft Copilot a partir do PowerShell.
...
| `-ClearSession` | SwitchParameter | — | — | Named | — | Limpar a sessão/perfil do navegador antes de abrir. |
| `-SkipSession` | SwitchParameter | — | — | Named | — | Ignorar carregamento de sessão/perfil do navegador. |
...
> Limpar a sessão/perfil do navegador antes de abrir.
...
> Ignorar carregamento de sessão/perfil do navegador.
