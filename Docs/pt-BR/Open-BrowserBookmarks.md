...
> Abre favoritos do navegador que correspondam aos critérios de pesquisa especificados.

## Description

Pesquisa favoritos nos navegadores Microsoft Edge, Google Chrome e Mozilla Firefox com base em consultas de pesquisa fornecidas. Abre os favoritos correspondentes no navegador selecionado com configurações de janela e modos de navegador configuráveis.

Esta função fornece uma interface abrangente para localizar e abrir favoritos do navegador com opções avançadas de filtragem e exibição. Ela suporta múltiplos critérios de pesquisa e pode abrir resultados em qualquer navegador instalado com ampla personalização de posicionamento e comportamento da janela.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Queries` | String[] | — | ✅ (ByValue, ByPropertyName) | 0 | — | Termos de pesquisa para filtrar favoritos |
| `-Count` | Int32 | — | — | 1 | `50` | Número máximo de URLs para abrir |
| `-Edge` | SwitchParameter | — | — | Named | — | Selecionar no Microsoft Edge |
| `-Chrome` | SwitchParameter | — | — | Named | — | Selecionar no Google Chrome |
| `-Firefox` | SwitchParameter | — | — | Named | — | Selecionar no Firefox |
...
| `-ShowWindow` | SwitchParameter | — | — | Named | — | Mostrar a janela do navegador (não 1d ou oculta) |
...
Pesquisa por favoritos contendo "github" no Microsoft Edge e abre os primeiros 5 resultados no navegador padrão.
...
O mesmo que acima usando aliases - pesquisa nos favoritos do Edge por "gh" e abre 5 resultados no navegador padrão.
...
Pesquisa nos favoritos do Chrome por "development" e "tools", abre os primeiros 10 resultados no Firefox posicionado no lado esquerdo da tela.

## Parameter Details

### `-Queries <String[]>`

> Termos de pesquisa para filtrar favoritos
...
> Mostrar a janela do navegador (não 1d ou oculta)
