...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Queries` | String[] | ✅ | ✅ (ByValue, ByPropertyName) | 0 | — | Os URLs ou domínios de websites para consultar no BuiltWith.com |
| `-Language` | String | — | — | 1 | — | O idioma dos resultados de pesquisa retornados |
| `-Monitor` | Int32 | — | — | 2 | `-1` | O monitor a ser usado: 0 = padrão, -1 = descartar, -2 = Monitor secundário configurado, o padrão é -1, sem posicionamento |
