...
Abre o ChatGPT em um navegador web, insere automaticamente a consulta especificada e a submete. Suporta várias consultas que serão executadas usando a função subjacente Open-WebsiteAndPerformQuery. Esta função fornece uma maneira conveniente de interagir com o ChatGPT da OpenAI a partir do PowerShell com opções extensivas de configuração do navegador.
...
Envie várias consultas usando o nome completo do parâmetro.
