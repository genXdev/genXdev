...
> Abre uma consulta DeepSeek em um navegador web

## Description

Abre uma consulta do DeepSeek no navegador, digita a consulta e pressiona Enter para executar a pesquisa. Esta função aproveita o mecanismo de busca de IA do DeepSeek para fornecer respostas inteligentes e insights para as consultas fornecidas.
...
Abre o DeepSeek e pesquisa por "função powershell" usando as configurações padrão.
...
Usa o alias para pesquisar por "powershell function" com parâmetros padrão.
...
Abre o DeepSeek em modo de tela cheia no monitor principal para pesquisar por "fundamentos de aprendizado de máquina".
