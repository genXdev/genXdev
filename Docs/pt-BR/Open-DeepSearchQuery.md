...
> Abre uma consulta do DeepSeek em um navegador da web

## Description

Abre uma consulta do DeepSeek no navegador da web, digita a consulta e pressiona Enter para executar a pesquisa. Esta função aproveita o mecanismo de busca de IA do DeepSeek para fornecer respostas e insights inteligentes para as consultas fornecidas.
...
Abre o DeepSeek e pesquisa por "powershell function" usando as configurações padrão.
...
Usa o alias para pesquisar por "função do powershell" com parâmetros padrão.
...
Abre o DeepSeek em modo de tela cheia no monitor principal para pesquisar por "fundamentos de machine learning".
