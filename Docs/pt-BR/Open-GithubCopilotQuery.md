...
> Abre uma consulta do Github CoPilot em um navegador da web

## Description

Abre uma consulta do GitHub Copilot no navegador web e insere automaticamente a consulta especificada. A função aguarda o carregamento da página antes de digitar a consulta. Esta função usa a função subjacente Open-WebsiteAndPerformQuery para lidar com a automação do navegador e fornece uma maneira conveniente de interagir com o GitHub Copilot a partir do PowerShell, com opções extensas de configuração do navegador.
...
| `-NoBorders` | SwitchParameter | — | — | Named | — | Remova as bordas da janela e a barra de título para uma aparência mais limpa |
