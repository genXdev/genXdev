...
Abre uma consulta do Google Gemini no navegador web, insere automaticamente a consulta e a submete. Isso fornece uma maneira rápida de interagir com a IA Gemini do Google. A função suporta controle extensivo do navegador, incluindo seleção de monitor, posicionamento de janela e recursos de automação de teclado.
...
Abre o Google Gemini e envia a consulta "O que é PowerShell?".
...
Usa o alias para enviar uma consulta sobre arrays via entrada de pipeline.
