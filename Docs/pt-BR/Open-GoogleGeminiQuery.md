...
Abre uma consulta do Google Gemini no navegador da web, insere automaticamente a consulta e a submete. Isso fornece uma maneira rápida de interagir com a IA Gemini do Google. A função suporta controle extensivo do navegador, incluindo seleção de monitor, posicionamento de janela e recursos de automação de teclado.
