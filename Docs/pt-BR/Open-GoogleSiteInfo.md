...
> Abre consultas de informações do site do Google em um navegador da web.

## Description

Abre várias consultas de pesquisa do Google relacionadas a informações do site (site:, link:, related:) em um navegador da web para o(s) domínio(s) especificado(s).
...
| `-SessionOnly` | SwitchParameter | — | — | Named | — | Usar modo apenas de sessão para o perfil do navegador (sem dados persistentes) |
| `-ClearSession` | SwitchParameter | — | — | Named | — | Limpar dados de sessão/perfil do navegador antes de abrir |
| `-SkipSession` | SwitchParameter | — | — | Named | — | Ignorar o uso de uma sessão/perfil de navegador (usar padrão) |
...
> Usar modo apenas de sessão para o perfil do navegador (sem dados persistentes)
...
> Limpar dados de sessão/perfil do navegador antes de abrir
...
> Ignorar o uso de uma sessão/perfil de navegador (usar padrão)
