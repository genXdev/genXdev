...
> Abre um vídeo de uma citação de filme em um navegador da web.

## Description

Pesquisa e abre citações de filmes usando playphrase.me, permitindo especificar configurações de monitor e navegador. Esta função fornece acesso a um extenso banco de dados de citações de filmes com clipes de vídeo, suportando vários idiomas e opções avançadas de configuração do navegador.

Principais recursos:
- Pesquisar citações de filmes em um extenso banco de dados
- Suporte a vários idiomas com detecção automática de idioma
- Posicionamento avançado do navegador e gerenciamento de janelas
- Suporte para vários navegadores (Edge, Chrome, Firefox)
- Suporte ao modo de navegação privada
- Automação de teclado para interação com o navegador
- Suporte a vários monitores com posicionamento preciso
...
Abre uma pesquisa pela famosa citação do Exterminador do Futuro "I'll be back".
...
Abre uma pesquisa pela citação de Casablanca no monitor 1.
...
Abre uma busca pela citação de Star Wars em inglês usando navegação privada.
...
Abre várias pesquisas de citações de filmes no Chrome em modo tela cheia via pipeline.
