...
> Abre informações do site SimilarWeb para URLs especificadas em um navegador da web.

## Description

Abre uma consulta "Similar web" em um navegador da web de forma configurável usando opções de linha de comando. Permite verificar análises e comparações de sites para análise de tráfego de sites, pesquisa de concorrentes e insights de marketing digital.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Queries` | String[] | ✅ | ✅ (ByValue, ByPropertyName) | 0 | — | Os URLs de sites a serem analisados no SimilarWeb |
...
Abre uma análise do SimilarWeb para Google.com no monitor primário.
...
Abre uma análise do SimilarWeb usando o alias da função com posicionamento do monitor.
...
Analisa vários sites por meio de entrada pipeline com posicionamento centralizado da janela.
...
Retorna a URL do SimilarWeb para o GitHub sem abrir o navegador.

## Parameter Details

### `-Queries <String[]>`

> Os URLs de sites a serem analisados no SimilarWeb
