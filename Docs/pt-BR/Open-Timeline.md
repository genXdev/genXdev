...
| `-BrowserExtensions` | SwitchParameter | — | — | Named | — | Não impedir o carregamento de extensões do navegador |
...
| `-Language` | String | — | — | 1 | — | Substituir o idioma padrão do navegador ou selecionar [Todos] para alternar todos os idiomas a cada minuto |
| `-DragedNodeBackground` | String | — | — | Named | `$null` | Sobrescreva o estilo de cor CSS para pintar o fundo do nó atualmente arrastado |
| `-FocusedNodeBackground` | String | — | — | Named | `$null` | Substitua o estilo css-color para pintar o fundo do nó focado (no centro) |
| `-FocusedNodeForeground` | String | — | — | Named | `$null` | Substitua o css-color-style para pintar o texto em primeiro plano do nó focado (no centro) |
| `-UnFocusedNodeBackground` | String | — | — | Named | `$null` | Substitua o estilo css-color para pintar o fundo do nó focado (no centro) |
| `-UnFocusedNodeForeground` | String | — | — | Named | `$null` | Substituir o estilo de cor CSS para pintar o texto em primeiro plano do nó não focado (no centro) |
| `-BorderLightColor` | String | — | — | Named | `$null` | Substitua o estilo de cor padrão do css border-light-color |
| `-BorderDarkColor` | String | — | — | Named | `$null` | Substituir a cor da borda escura padrão do CSS |
| `-BorderWidth` | Int32 | — | — | Named | `1` | Substitui a largura padrão para pintar as bordas dos nós |
| `-RotationDelaySeconds` | Int32 | — | — | Named | `15` | Substitua a largura padrão para o atraso da rotação de fundo |
...
> Não impedir o carregamento de extensões do navegador
...
> Substituir o idioma padrão do navegador ou selecionar [Todos] para alternar todos os idiomas a cada minuto
...
> Sobrescreva o estilo de cor CSS para pintar o fundo do nó atualmente arrastado
...
> Substitua o estilo css-color para pintar o fundo do nó focado (no centro)
...
> Substitua o css-color-style para pintar o texto em primeiro plano do nó focado (no centro)
...
> Substituir o estilo de cor CSS para pintar o texto em primeiro plano do nó não focado (no centro)
...
> Substitua o estilo de cor padrão do css border-light-color
...
> Substituir a cor da borda escura padrão do CSS
...
> Substitui a largura padrão para pintar as bordas dos nós
...
> Substitua a largura padrão para o atraso da rotação de fundo
