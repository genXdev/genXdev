...
> Abre um jogo de simulação viral em um navegador da web com opções extensas de configuração.

## Description

Abre o jogo de simulação viral em https://viral.genxdev.net/ em um navegador web especificado com configurações de janela, posicionamento e comportamento ajustáveis. Suporta vários navegadores, navegação privada, modo aplicativo e recursos abrangentes de gerenciamento de janelas.

A função fornece uma experiência interativa de simulação viral com recursos como:
- Suporte a vários navegadores (Edge, Chrome, Firefox)
- Controles de posicionamento e redimensionamento de janela
- Opções de tela cheia e modo aplicativo
- Capacidades de navegação privada
- Suporte a automação de teclado
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Language` | String | — | — | 0 | — | As configurações de exibição de conteúdo da web e de idioma do navegador |
...
| `-Monitor` | Int32 | — | — | Named | `-2` | O monitor a ser usado, 0 = padrão, -1 descarta, -2 = monitor secundário configurado, padrão é $Global:DefaultSecondaryMonitor ou 2 se não encontrado |
...
Abre a simulação viral no Google Chrome em modo de navegação anônima e sem tela cheia.
...
Abre simulação viral usando aliases com Chrome, modo anônimo e sem tela cheia.

## Parameter Details

### `-Language <String>`

> As configurações de exibição de conteúdo da web e de idioma do navegador
...
- [Open-GameOfLife](https://github.com/genXdev/genXdev/blob/main/Docs/pt-BR/Open-GameOfLife.md)
