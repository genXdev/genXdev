...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Queries` | String[] | — | ✅ (ByValue, ByPropertyName) 🌐 Remaining | 0 | — | Termos de busca para encontrar uma faixa |
...
| `-SessionOnly` | SwitchParameter | — | — | Named | — | Use uma sessão que não persista após fechar o navegador |
