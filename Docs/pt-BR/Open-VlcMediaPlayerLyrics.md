...
> Abre um navegador da web para pesquisar letras da mídia atual em reprodução no VLC.

## Description

Esta função detecta se o VLC Media Player está em execução e pesquisa letras com base no título da mídia reproduzida atualmente. Ela abre automaticamente uma consulta de pesquisa em um navegador da web para encontrar letras da faixa atual. A função oferece suporte a vários navegadores e fornece opções extensas de posicionamento de janela e exibição.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Queries` | String[] | — | ✅ (ByValue, ByPropertyName) 🌐 Remaining | 0 | — | Termos de pesquisa para encontrar uma faixa |
...
| `-SessionOnly` | SwitchParameter | — | — | Named | — | Use uma sessão que não é mantida após fechar o navegador |
| `-ClearSession` | SwitchParameter | — | — | Named | — | Limpar os dados da sessão do navegador antes de abrir o navegador |
...
Abre uma pesquisa no Google para as letras da música que está sendo reproduzida no VLC.
...
Abre pesquisa de letras no Microsoft Edge usando o modo privado/anonimato.

## Parameter Details

### `-Queries <String[]>`

> Termos de pesquisa para encontrar uma faixa
...
> Use uma sessão que não é mantida após fechar o navegador
...
> Limpar os dados da sessão do navegador antes de abrir o navegador
...
> Pular usando qualquer sessão de navegador existente
...
> Abra janelas do navegador lado a lado
