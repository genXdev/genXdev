...
> Abre informações do site do WaybackMachine em um navegador web.

## Description

Abre uma consulta do Wayback Machine no navegador web, exibindo versões históricas da URL ou site especificado. Suporta múltiplas consultas e seleção de monitor. Fornece acesso ao conteúdo da web arquivado através do serviço Wayback Machine do Internet Archive.
...
| `-Language` | String | — | — | 1 | — | A preferência de idioma para a interface do navegador e o conteúdo |
...
| `-SessionOnly` | SwitchParameter | — | — | Named | — | Use configurações alternativas armazenadas na sessão para as preferências do Wayback Machine |
| `-ClearSession` | SwitchParameter | — | — | Named | — | Limpa as configurações alternativas armazenadas na sessão para as preferências do Wayback Machine |
...
Abre o arquivo da Wayback Machine para example.com no monitor padrão.
...
Abre o arquivo do Wayback Machine para example.com usando aliases com posicionamento de monitor descartado.
...
Abre o arquivo do Wayback Machine para microsoft.com no modo anônimo do Chrome.
...
> A preferência de idioma para a interface do navegador e o conteúdo
...
> Use configurações alternativas armazenadas na sessão para as preferências do Wayback Machine
...
> Limpa as configurações alternativas armazenadas na sessão para as preferências do Wayback Machine
