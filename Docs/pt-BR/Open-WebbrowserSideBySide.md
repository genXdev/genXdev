...
> Inicia uma nova janela do navegador web com posicionamento específico.

## Description

Abre uma nova janela do navegador (Edge ou Chrome) posicionada no lado direito do monitor primário em modo de fundo.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Url` | String[] | — | ✅ (ByValue) | 0 | — | As URLs para abrir no navegador |
...
> As URLs para abrir no navegador
