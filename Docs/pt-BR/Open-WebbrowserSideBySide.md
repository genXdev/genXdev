...
> Abre uma nova janela do navegador web com posicionamento específico.

## Description

Abre uma nova janela do navegador (Edge ou Chrome) posicionada no lado direito do monitor principal em modo de fundo.
