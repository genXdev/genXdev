...
> Abre pesquisas da Wikipédia holandesa em um navegador da web.

## Description

Abre uma consulta 'Wikipedia - Países Baixos' em um navegador da web, com opções de exibição configuráveis. Suporta pesquisa de vários termos e especificar em qual monitor exibir os resultados.
...
| `-SessionOnly` | SwitchParameter | — | — | Named | — | Use apenas cookies de sessão (sem cookies persistentes) |
| `-ClearSession` | SwitchParameter | — | — | Named | — | Limpar dados da sessão do navegador antes de abrir |
...
> Abre duas janelas do navegador lado a lado
...
> Use apenas cookies de sessão (sem cookies persistentes)
...
> Limpar dados da sessão do navegador antes de abrir
...
> Pular restauração da sessão anterior do navegador
