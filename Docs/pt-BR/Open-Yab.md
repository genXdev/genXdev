...
> Abre o jogo YAB em um navegador da web com configurações ajustáveis.

## Description

Abre o site do jogo YAB em um navegador especificado com várias opções de exibição e comportamento. Suporta diferentes modos de jogo, incluindo o modo espectador. O jogo YAB é um jogo de quebra-cabeça online que pode ser jogado interativamente ou assistido em modo espectador, onde a IA joga automaticamente.
...
| `-ShowWindow` | SwitchParameter | — | — | Named | — | Mostrar a janela do navegador (não minimizada ou oculta) |
...
Abre o jogo YAB no navegador Edge com navegação privada no monitor 2 usando aliases para acesso rápido.

## Parameter Details

### `-Language <String>`

> O idioma da interface do jogo
...
> Mostrar a janela do navegador (não minimizada ou oculta)
...
> Não inicie um novo jogo, apenas observe a IA jogar
