...
> Abre consultas de pesquisa do YouTube em um navegador da web.

## Description

Abre uma ou mais consultas de pesquisa do YouTube em um navegador da web com opções extensas de posicionamento e configuração. Suporta seleção configurável de monitor, configurações do navegador e automação de teclas através de parâmetros dinâmicos herdados do cmdlet Open-Webbrowser. Cada consulta é aberta em uma instância separada do navegador com controle total sobre o posicionamento da janela, tipo de navegador e idioma de pesquisa.
...
Abre uma pesquisa no YouTube por "Tutorial do PowerShell" no monitor padrão.
...
Abre uma pesquisa no YouTube para "how to code" no monitor secundário configurado, usando o alias da função.
