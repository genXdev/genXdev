...
> Remove o último auxiliar de janela ativo da pilha com modificações opcionais.

## Description

Remove uma janela auxiliar da pilha e, opcionalmente, aplica transformações à janela.
Se a pilha estiver vazia ou contiver janelas inválidas, retorna a janela atualmente
em foco. Esta função permite que você manipule janelas que foram salvas anteriormente
com Push-Window, aplicando vários efeitos de posicionamento, dimensionamento e visuais.
