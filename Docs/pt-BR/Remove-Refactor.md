...
Gerencia conjuntos de refatoração no sistema de preferências do GenXdev, removendo entradas especificadas. Funciona com conjuntos de refatoração personalizados e padrão. Conjuntos padrão são protegidos, a menos que explicitamente permitidos para remoção. Todos os conjuntos de refatoração são identificados pelo prefixo "refactor_set_" no sistema de preferências.
...
| `-RemoveDefault` | SwitchParameter | — | — | Named | — | Alternar para também remover o conjunto de refatoração padrão |
| `-PreferencesDatabasePath` | String | — | — | Named | — | Caminho do banco de dados para arquivos de dados de preferência |
| `-DefaultValue` | String | — | ✅ (ByPropertyName) | Named | — | O valor padrão se a preferência não for encontrada |
...
> Alternar para também remover o conjunto de refatoração padrão
