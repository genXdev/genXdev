...
> Expande objetos de entrada em nomes de arquivos e diretórios, oferecendo suporte a vários filtros e opções de saída.

## Description

Esta função processa objetos de entrada (arquivos, diretórios ou coleções)
e os expande em nomes de arquivos e diretórios. Ela suporta filtragem,
correspondência de padrões e pode gerar resultados como objetos. A função é
projetada para funcionar com entrada de pipeline e fornece opções para recursão,
fluxos de dados alternativos e muito mais.
...
| `-Pattern` | String | — | — | 1 | — | Padrão de expressão regular para pesquisar no conteúdo *(Parameter set: )* 🌐 *Supports wildcards* |
...
| `-Directory` | SwitchParameter | — | — | Named | — | Pesquise apenas diretórios *(Parameter set: )* |
| `-FilesAndDirectories` | SwitchParameter | — | — | Named | — | Inclua tanto arquivos quanto diretórios *(Parameter set: )* |
...
> Objeto de entrada contendo nomes de arquivos ou diretórios
