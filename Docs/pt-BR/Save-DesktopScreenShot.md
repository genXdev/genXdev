...
* Tira uma captura de tela da área de trabalho do monitor especificado e
  a salva como um arquivo de imagem.
* Suporta vários monitores e detecta automaticamente os limites corretos
  da tela e os fatores de escala para monitores de alta DPI.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Monitor` | Int32 | ✅ | ✅ (ByPropertyName) | 0 | `0` | Índice do monitor para capturar (0=primário, 1+=monitor específico, -1=todos os monitores) |
...
Captura uma captura de tela do segundo monitor com JPEG de alta qualidade.
...
> Índice do monitor para capturar (0=primário, 1+=monitor específico, -1=todos os monitores)
...
> Caminho completo onde a captura de tela será salva
...
> Nível de qualidade JPEG (1-100), aplica-se apenas ao formato JPEG
