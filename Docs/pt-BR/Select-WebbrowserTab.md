...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Id` | Int32 | — | — | 0 | `-1` | Identificador da guia da lista exibida *(Parameter set: )* |
| `-Name` | String | ✅ | — | 0 | — | Seleciona a primeira aba que contém esse nome na URL *(Parameter set: )* 🌐 *Supports wildcards* |
| `-ByReference` | PSObject | ✅ | — | Named | — | Selecionar aba usando referência de Get-ChromiumSessionReference *(Parameter set: )* |
...
| `-Force` | SwitchParameter | — | — | Named | — | Força reinicialização do navegador, se necessário |
