...
Esta função envia entrada de teclado para uma janela ou processo alvo usando o objeto Windows Script Host Shell. Ela pode direcionar janelas pelo nome do processo, ID do processo ou identificador de janela. A função suporta sequências de teclas especiais, caracteres de escape e várias opções de temporização para entrega confiável de teclas.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-KeysToSend` | String[] | ✅ | ✅ (ByValue, ByPropertyName) | 0 | — | A entrada do teclado a ser enviada como uma matriz de strings |
| `-ProcessName` | String | — | ✅ (ByPropertyName) | Named | — | Nome do processo para enviar teclas (suporta curingas) *(Parameter set: )* 🌐 *Supports wildcards* |
| `-ProcessId` | Int32 | — | ✅ (ByPropertyName) | Named | — | ID do processo para o qual enviar as teclas *(Parameter set: )* |
| `-WindowHandle` | Int64 | — | ✅ (ByPropertyName) | Named | — | Identificador da janela para enviar teclas *(Parameter set: )* |
| `-SendKeyEscape` | SwitchParameter | — | — | Named | — | Escapar caracteres de controle e modificadores no texto de entrada |
| `-SendKeyHoldKeyboardFocus` | SwitchParameter | — | — | Named | — | Manter o foco do teclado na janela de destino após enviar teclas |
| `-SendKeyUseShiftEnter` | SwitchParameter | — | — | Named | — | Use Shift+Enter em vez de Enter para novas linhas |
...
> A entrada do teclado a ser enviada como uma matriz de strings
...
> Nome do processo para enviar teclas (suporta curingas)
...
> ID do processo para o qual enviar as teclas
...
> Identificador da janela para enviar teclas
...
> Escapar caracteres de controle e modificadores no texto de entrada
...
> Manter o foco do teclado na janela de destino após enviar teclas
...
> Use Shift+Enter em vez de Enter para novas linhas
