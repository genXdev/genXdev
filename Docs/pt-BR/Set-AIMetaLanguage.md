...
> Define o idioma padrão e, opcionalmente, os diretórios de imagem para as operações de metadados de imagem do GenXdev.AI.
...
Define os diretórios de idioma e imagem persistentemente nas preferências.
...
Limpa a configuração de idioma da sessão (variável Global) sem afetar as preferências persistentes.
