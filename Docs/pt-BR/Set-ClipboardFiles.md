...
permitindo operações de arquivo como colar no Windows Explorer. Ela lida automaticamente com
os modos de threading STA e MTA, garantindo compatibilidade em diferentes contextos de
execução do PowerShell. A função valida a existência do arquivo antes de adicionar caminhos
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-InputObject` | String[] | ✅ | ✅ (ByValue, ByPropertyName) | 0 | — | Matriz de caminhos de arquivos para adicionar à área de transferência |
...
> Matriz de caminhos de arquivos para adicionar à área de transferência
