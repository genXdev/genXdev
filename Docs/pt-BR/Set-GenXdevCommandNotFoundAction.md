...
> Configura o tratamento personalizado para comando não encontrado

## Description

Configura o PowerShell para lidar com comandos desconhecidos navegando para diretórios.
