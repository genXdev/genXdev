...
> Exibe resultados de pesquisa de imagens em uma galeria web com layout de alvenaria.

## Description

Recebe resultados de busca de imagens e os exibe em um layout de alvenaria baseado em navegador. Pode operar em modo interativo com capacidades de edição e exclusão, ou em modo de exibição simples. Aceita objetos de dados de imagem normalmente do Find-Image e os renderiza com dicas de ferramentas ao passar o mouse mostrando metadados como reconhecimento facial, detecção de objetos e dados de classificação de cena.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-InputObject` | Object[] | — | ✅ (ByValue) | 0 | `@()` | Objetos de dados de imagem para exibir na galeria. |
| `-Interactive` | SwitchParameter | — | — | Named | — | Se conectará ao navegador e adicionará botões extras como Editar e Excluir |
| `-Title` | String | — | — | Named | `'Photo Gallery'` | Título para a galeria |
| `-Description` | String | — | — | Named | `('Hover over images to see face recognition ' +
            'and object detection data')` | Passe o mouse sobre as imagens para ver os dados de reconhecimento facial e detecção de objetos |
...
| `-NewWindow` | SwitchParameter | — | — | Named | — | Criar uma nova janela do navegador em vez de reutilizar a existente |
| `-OnlyReturnHtml` | SwitchParameter | — | — | Named | — | Only return the generated HTML instead of displaying it in a browser. |
| `-EmbedImages` | SwitchParameter | — | — | Named | — | Embede imagens como URLs de dados base64 em vez de URLs file:// para melhor portabilidade. |
...
| `-PassThru` | SwitchParameter | — | — | Named | — | Retornar o objeto auxiliar da janela do navegador para manipulação posterior |
