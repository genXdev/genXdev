...
> Abre uma URL em vários navegadores simultaneamente em um layout de mosaico.

## Description

Esta função cria um layout de mosaico de janelas do navegador abrindo a URL especificada no Chrome, Edge, Firefox e em uma janela de navegação privada. Os navegadores são organizados em um padrão de grade 2x2:
- Chrome: Quadrante superior esquerdo
- Edge: Quadrante inferior esquerdo
- Firefox: Quadrante superior direito
- Janela privada: Quadrante inferior direito

Todos os parâmetros do Open-Webbrowser são suportados e passados para controlar o posicionamento, comportamento e aparência do navegador. A função atua como um wrapper que aplica o posicionamento consistente dos quadrantes, permitindo personalização total dos parâmetros de inicialização do navegador.
...
> As URLs para abrir em todos os navegadores simultaneamente
