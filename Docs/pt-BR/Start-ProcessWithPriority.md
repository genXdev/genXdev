...
* Lança um executável com um nível de prioridade personalizável e fornece
  opções para espera e manipulação de processos.
* Encapsula Start-Process com funcionalidades adicionais para controlar
  a prioridade do processo e o comportamento de execução.
...
| `-NoWait` | SwitchParameter | — | — | Named | `False` | Não aguardar a conclusão do processo |
| `-PassThru` | SwitchParameter | — | — | Named | `False` | Retorna o objeto de processo |
...
> Caminho para o executável a ser executado
...
> Não aguardar a conclusão do processo
