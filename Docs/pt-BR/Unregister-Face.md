...
> Exclui uma face registrada pelo seu identificador do DeepStack.

## Description

Esta função exclui um rosto do sistema de reconhecimento facial do DeepStack usando seu identificador único. Ela se comunica com o endpoint da API para remover permanentemente os dados faciais registrados do sistema.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Identifier` | String | ✅ | ✅ (ByValue, ByPropertyName) | 0 | — | O identificador único do rosto a ser excluído do sistema DeepStack |
| `-ContainerName` | String | — | — | 1 | `'deepstack_face_recognition'` | O nome do contêiner Docker |
| `-VolumeName` | String | — | — | 2 | `'deepstack_face_data'` | O nome para o volume Docker para armazenamento persistente |
| `-ServicePort` | Int32 | — | — | 3 | `5000` | O número da porta para o serviço DeepStack |
| `-HealthCheckTimeout` | Int32 | — | — | 4 | `60` | Tempo máximo em segundos para aguardar a verificação de integridade do serviço |
| `-HealthCheckInterval` | Int32 | — | — | 5 | `3` | Intervalo em segundos entre tentativas de verificação de integridade |
...
> O identificador único do rosto a ser excluído do sistema DeepStack
