...
> Exibe informações de arquivo com nomes de exibição hiperlinkados para uma experiência de usuário aprimorada.

## Description

Esta função processa objetos de entrada de arquivo e os exibe em um formato amigável ao usuário, com nomes de arquivo hiperlinkados quando exibidos no console. Ela lida com diferentes tipos de entrada, incluindo strings, objetos FileInfo e outros tipos de objeto. A função detecta automaticamente se a saída está sendo redirecionada ou capturada em um pipeline e ajusta seu comportamento de acordo.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-CallerInvocation` | Object | ✅ | ✅ (ByValue) | 0 | — | As informações de invocação da função de chamada |
| `-Input` | Object | ✅ | ✅ (ByValue) | 1 | — | O objeto de entrada a ser processado, que pode ser um caminho de arquivo ou objeto |
| `-Prefix` | String | — | — | Named | — | Um prefixo de string opcional para antepor à exibição de saída para contexto adicional |
...
> As informações de invocação da função de chamada
...
> O objeto de entrada a ser processado, que pode ser um caminho de arquivo ou objeto
...
> Um prefixo de string opcional para antepor à exibição de saída para contexto adicional
...
> Caminho base para gerar caminhos de arquivo relativos na saída
...
> Força a saída a usar caminhos absolutos completos em vez de caminhos relativos
