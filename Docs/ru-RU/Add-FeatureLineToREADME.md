...
> Добавляет строку функции в файл README с временной меткой.

## Description

Добавляет строку с функцией в указанный файл README, с префиксом в виде текущей даты в формате yyyyMMdd. Строка может быть отформатирована как код и при необходимости отображаться.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Line` | String | — | — | 0 | `''` | Текст описания функции для добавления |
| `-Code` | SwitchParameter | — | — | Named | — | Форматируйте строку как код |
| `-Show` | SwitchParameter | — | — | Named | — | Отображение файла README после добавления строки |
...
> Текст описания функции для добавления
...
> Отображение файла README после добавления строки
...
> Используйте README в домашнем каталоге
