...
Позволяет отобразить изменённый раздел и открыть его в Visual Studio Code.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Line` | String | — | — | 0 | `''` | Текст идеи для добавления |
...
> Открыть README в Visual Studio Code
