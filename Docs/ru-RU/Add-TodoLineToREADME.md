...
Добавляет элемент задачи с отметкой времени в раздел "## Todoos" файла README.md.
Элементы задач могут быть отмечены как выполненные, и измененный раздел может быть отображен.
Каждый новый элемент задачи автоматически получает отметку времени, если не отмечается как выполненный.
