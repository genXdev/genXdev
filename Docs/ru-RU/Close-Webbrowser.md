...
Обеспечивает детальный контроль над закрытием экземпляров веб-браузера. Можно нацелиться на конкретные браузеры (Edge, Chrome, Firefox) или закрыть все браузеры. Поддерживает закрытие как главных окон, так и фоновых процессов.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Edge` | SwitchParameter | — | — | Named | — | Закрывает экземпляры браузера Microsoft Edge *(Parameter set: )* |
| `-Chrome` | SwitchParameter | — | — | Named | — | Закрывает экземпляры веб-браузера Google Chrome *(Parameter set: )* |
| `-Chromium` | SwitchParameter | — | — | Named | — | Закрывает браузер на основе Chromium, используемый по умолчанию *(Parameter set: )* |
...
> Закрывает экземпляры браузера Microsoft Edge
...
> Закрывает экземпляры веб-браузера Google Chrome
...
> Закрывает браузер на основе Chromium, используемый по умолчанию
...
> Закрывает экземпляры браузера Firefox
...
> Закрывает все экземпляры, включая фоновые задачи
