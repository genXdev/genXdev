...
> Преобразует PSCustomObject в HashTable рекурсивно.

## Description

* Эта функция преобразует PSCustomObject и все его вложенные свойства PSCustomObject в хэш-таблицы.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-InputObject` | Object | ✅ | ✅ (ByValue) | 0 | — | PSCustomObject для преобразования в HashTable |
...
Преобразуйте PSCustomObject в хэш-таблицу с вложенными свойствами.

## Parameter Details

### `-InputObject <Object>`

> PSCustomObject для преобразования в HashTable
