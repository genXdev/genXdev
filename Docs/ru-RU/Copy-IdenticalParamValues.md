...
> Копирует значения параметров из связанных параметров в новую хеш-таблицу на основе возможных параметров другой функции.
...
* Полученную хеш-таблицу можно использовать для вызова функции с помощью
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-BoundParameters` | Object[] | ✅ | — | 0 | — | Параметры источника для копирования |
| `-FunctionName` | String | ✅ | — | 1 | — | Имя целевой функции для фильтрации параметров |
...
Демонстрирует копирование связанных параметров для использования с подстановкой (splatting).

## Parameter Details

### `-BoundParameters <Object[]>`

> Параметры источника для копирования
...
> Имя целевой функции для фильтрации параметров
