...
> Проверяет, есть ли у текущего пользователя повышенные права.

## Description

Определяет, обладает ли текущий пользователь Windows правами администратора или оператора резервного копирования, проверяя их роли субъектов безопасности. Возвращает true, если пользователь имеет повышенные права, в противном случае false. Реализует надежную обработку ошибок, связанных с безопасностью и доступом.
