...
> Генерирует адаптивную галерею HTML в стиле masonry из данных изображений.

## Description

Создает интерактивную HTML-галерею с адаптивным макетом в стиле masonry для отображения изображений. Возможности включают:
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Images` | Object | ✅ | — | 0 | — | Массив объектов изображений с путем, ключевыми словами и описанием |
| `-FilePath` | String | — | — | 1 | `$null` | Путь к выходному файлу для создаваемого HTML-файла |
...
| `-CanEdit` | SwitchParameter | — | — | Named | `$false` | Включено ли редактирование |
| `-CanDelete` | SwitchParameter | — | — | Named | `$false` | Включено ли удаление |
| `-EmbedImages` | SwitchParameter | — | — | Named | `$false` | Встраивайте изображения в виде URI данных base64 вместо URL-адресов file:// для лучшей переносимости |
...
| `-RootMargin` | String | — | — | Named | `'1200px'` | IntersectionObserver rootMargin для триггера бесконечного скролла (например, "1200px") |
| `-Threshold` | Double | — | — | Named | `0.1` | Порог IntersectionObserver для триггера бесконечной прокрутки |
...
> Массив объектов изображений с путем, ключевыми словами и описанием
...
> Путь к выходному файлу для создаваемого HTML-файла
...
> Встраивайте изображения в виде URI данных base64 вместо URL-адресов file:// для лучшей переносимости
...
> Количество изображений для загрузки на страницу (для динамической загрузки)
...
> Максимальное количество изображений для загрузки в режиме печати
...
> IntersectionObserver rootMargin для триггера бесконечного скролла (например, "1200px")
...
> Порог IntersectionObserver для триггера бесконечной прокрутки
