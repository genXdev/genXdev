...
> Извлекает список уникальных имен пользователей из активных системных процессов.

## Description

Запрашивает все запущенные процессы в системе, извлекает связанное имя пользователя для каждого процесса и возвращает дедублицированный список пользователей, имеющих активные процессы. Это полезно для администрирования системы и мониторинга безопасности.
