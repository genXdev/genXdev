...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-DisplacedVolumeInCubicMeters` | Double | ✅ | — | 0 | `0` | Вытесненный объем в м³ |
| `-FluidDensityInKilogramsPerCubicMeter` | Double | ✅ | — | 1 | `0` | Плотность жидкости в кг/м³ |
| `-GravityInMetersPerSecondSquared` | Double | — | — | 2 | `0` | Ускорение свободного падения в м/с² (по умолчанию: 9,81) |
| `-As` | String | — | — | 3 | — | Единица измерения силы |

## Parameter Details

### `-DisplacedVolumeInCubicMeters <Double>`

> Вытесненный объем в м³
