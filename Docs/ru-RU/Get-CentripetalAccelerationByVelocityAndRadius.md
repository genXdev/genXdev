...
| `-As` | String | — | — | 2 | — | Единица измерения для ускорения |
...
Вычисляет центростремительное ускорение для скорости 20 м/с и радиуса 10 м, используя позиционные параметры.
...
> Единица измерения для ускорения
