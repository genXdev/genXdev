...
> Отображает функции из файла README.md.

## Description

Показывает все функции из раздела «## Features» файла README.md. Можно использовать README в текущем расположении, в каталоге профиля PowerShell или в каталоге OneDrive.
