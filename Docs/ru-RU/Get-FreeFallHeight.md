...
| `-As` | String | — | — | 2 | — | Единица измерения для высоты вывода |
...
Вычисляет высоту падения за 10 секунд при стандартной конечной скорости человека.
...
Вычисляет высоту падения за 5 секунд с использованием позиционного параметра и значения терминальной скорости по умолчанию.
...
> Единица измерения для высоты вывода
