...
> Распознает лица на загруженном изображении, сравнивая их с известными лицами с помощью DeepStack.

## Description

Эта функция анализирует файл изображения для идентификации лиц путем их сравнения с известными лицами в базе данных. Она использует локальный API распознавания лиц DeepStack, работающий на настраиваемом порту, и возвращает совпадения лиц с их оценками уверенности. Функция поддерживает ускорение GPU, пользовательские пороги уверенности и управление контейнерами Docker.
