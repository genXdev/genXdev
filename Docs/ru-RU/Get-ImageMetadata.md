...
Эта функция считывает EXIF, IPTC и другие метаданные из файла изображения. Она извлекает широкий спектр информации, включая данные о камере, настройки экспозиции, координаты GPS, даты, информацию об авторских правах и многое другое. Она поддерживает изображения, содержащие метаданные в их EXIF-данных (JPEG, TIFF), а также метаданные PNG.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-ImagePath` | String | ✅ | — | 0 | — | Путь к файлу изображения для анализа |
