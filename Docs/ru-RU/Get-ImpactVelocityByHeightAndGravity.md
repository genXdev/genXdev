...
Используется v = sqrt(2 g h), пренебрегая сопротивлением воздуха.
...
| `-As` | String | — | — | 2 | — | Единица вывода для скорости. По умолчанию 'м/с'. |
...
Вычисляет скорость удара при падении с высоты 100 метров и выводит результат в км/ч.
...
Вычисляет скорость удара при падении с высоты 50 метров, используя единицы измерения по умолчанию.
...
> Гравитация в м/с². По умолчанию 9,81.
...
> Единица вывода для скорости. По умолчанию 'м/с'.
