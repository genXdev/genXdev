...
Использует m = - (расстояние до изображения / расстояние до объекта).
...
Вычисляет увеличение с использованием позиционных параметров.
...
> Расстояние до изображения в метрах
