...
> Возвращает объект-помощник окна для главного окна терминала PowerShell.

## Description

* Возвращает вспомогательный объект WindowObj, представляющий главное окно
  текущего процесса узла PowerShell.
* Это позволяет манипулировать и взаимодействовать с самим окном терминала.
...
Извлекает объект WindowObj для текущего окна терминала PowerShell.
