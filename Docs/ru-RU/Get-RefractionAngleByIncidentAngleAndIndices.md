...
> Вычисляет угол преломления с использованием закона Снелла.
...
| `-As` | String | — | — | 3 | — | Единица измерения угла |
...
Вычисляет угол преломления при переходе света из воздуха (n=1) в воду (n=1.33) при угле падения 30 градусов.
...
Вычисляет угол преломления, когда свет переходит из воздуха (n=1) в стекло (n=1.5) под углом падения 45 градусов.
