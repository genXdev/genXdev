...
Показывает все примечания к выпуску из раздела "## Release notes" файла README.md. Можно использовать README в текущем местоположении, каталоге профиля PowerShell или каталоге OneDrive.
