...
> Извлекает данные из указанного столбца таблицы базы данных SQL.

## Description

Эта функция предоставляет удобный способ извлечения данных из одного столбца в таблице базы данных SQL. Она поддерживает два метода подключения: прямой путь к файлу базы данных или строка подключения. Функция включает опции для ограничения количества возвращаемых записей и использует правильное построение SQL-запросов для оптимальной производительности.
...
| `-TableName` | String | ✅ | — | 2 | — | Имя запрашиваемой таблицы |
| `-ColumnName` | String | ✅ | — | 3 | — | Имя извлекаемого столбца |
| `-Count` | Int32 | — | — | 4 | `100` | Количество возвращаемых записей. По умолчанию 100. Используйте -1 для всех. |
...
> Количество возвращаемых записей. По умолчанию 100. Используйте -1 для всех.
