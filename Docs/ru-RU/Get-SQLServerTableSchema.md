...
Эта функция запрашивает базу данных SQL Server для получения подробной информации о схеме указанной таблицы. Она использует представление INFORMATION_SCHEMA.COLUMNS SQL Server для возврата определений столбцов, включая имена, типы, статус nullable и значения по умолчанию.
...
| `-TableName` | String | ✅ | — | 2 | — | Имя таблицы |
