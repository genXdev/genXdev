...
> Извлекает список имен таблиц из базы данных SQLite.

## Description

Запрашивает системную таблицу sqlite_master для получения всех имен пользовательских таблиц из базы данных SQLite. Поддерживает подключение через прямую строку подключения или путь к файлу базы данных. Возвращает имена таблиц в виде коллекции строк.
