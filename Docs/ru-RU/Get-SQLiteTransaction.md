...
Создает объект подключения к базе данных SQLite и объект транзакции, который можно использовать для пакетных операций. Вызывающий код отвечает за фиксацию или откат транзакции. Подключение будет автоматически создано, если файл базы данных не существует.
...
> Создавать ли файл базы данных, если он не существует.
