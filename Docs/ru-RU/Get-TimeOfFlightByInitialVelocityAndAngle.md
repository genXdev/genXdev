...
Использует T = (2 v sinθ) / g для идеального движения.
...
| `-As` | String | — | — | 3 | — | Единица вывода для времени |
...
Вычисляет время полета снаряда, запущенного со скоростью 20 м/с под углом 45 градусов, вывод в минутах.
...
Вычисляет время полета для снаряда, запущенного со скоростью 30 м/с под углом 30 градусов.
