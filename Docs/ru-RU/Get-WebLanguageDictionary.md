...
> Возвращает обратный словарь для всех языков, поддерживаемых Google Поиском.

## Description

* Возвращает словарь, сопоставляющий названия языков с соответствующими
  кодами языков для всех языков, поддерживаемых Google Поиск.
* Полезен для поиска кодов языков в веб-запросах и задачах перевода.
...
Извлекает словарь, сопоставляющий названия языков с их кодами.
