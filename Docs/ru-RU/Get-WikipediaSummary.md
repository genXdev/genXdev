...
> Извлекает краткое описание темы из Википедии.

## Description

Запрашивает API Википедии для получения краткого описания указанной темы,
удаляя содержимое в скобках для улучшения читаемости.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Queries` | String[] | ✅ | ✅ (ByValue, ByPropertyName) | 0 | — | Выполняемый запрос |
