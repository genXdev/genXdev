...
| `-Edge` | SwitchParameter | — | — | Named | — | Импорт в Microsoft Edge |
...
> Путь к CSV-файлу с закладками для импорта
...
> Коллекция закладок для импорта
...
> Импорт в Firefox (не поддерживается)
