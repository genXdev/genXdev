...
> Импортирует JavaScript-букмарклеты GenXdev в коллекции закладок браузера.

## Description

Эта функция сканирует каталог на наличие файлов букмарклетов GenXdev с расширением
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-SnippetsPath` | String | — | — | 0 | `"$($MyInvocation.MyCommand.Module.ModuleBase)\Bookmarklets"` | Путь к каталогу, содержащему файлы фрагментов букмарклета |
...
Импортирует все файлы букмарклетов из каталога стандартных фрагментов в папку панели избранного Microsoft Edge.
...
> Путь к каталогу, содержащему файлы фрагментов букмарклета
...
> Целевая папка закладок в структуре закладок браузера
...
> Импорт букмарклетов в браузер Microsoft Edge
...
> Импорт букмарклетов в браузер Google Chrome
...
> Импорт букмарклетов в браузер Mozilla Firefox
