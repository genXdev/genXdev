...
> Выполняет вызов функции инструмента с проверкой и фильтрацией параметров.

## Description

Эта функция обрабатывает вызовы инструментов путем проверки аргументов, фильтрации параметров и выполнения обратных вызовов с надлежащей обработкой подтверждений. Она поддерживает как обратные вызовы блоков сценариев, так и обратные вызовы с информацией о командах.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-ToolCall` | Collections.Hashtable | ✅ | — | 0 | — | Объект вызова инструмента, содержащий функцию и аргументы |
...
| `-ForceAsText` | SwitchParameter | — | — | Named | — | Принудительный вывод в виде текста |
...
> Объект вызова инструмента, содержащий функцию и аргументы
