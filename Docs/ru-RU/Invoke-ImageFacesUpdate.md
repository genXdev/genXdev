...
> Обновляет метаданные распознавания лиц для файлов изображений в указанном каталоге.

## Description

Эта функция обрабатывает изображения в указанной директории для идентификации и анализа лиц с помощью технологии AI-распознавания. Она создает или обновляет файлы метаданных, содержащие информацию о лицах для каждого изображения. Метаданные сохраняются в отдельном файле с
