...
> Преобразует текст с помощью обработки на основе ИИ.

## Description

Эта функция обрабатывает входной текст с помощью моделей ИИ для выполнения различных преобразований, таких как проверка орфографии, добавление смайликов или любых других улучшений текста, указанных в инструкциях. Она может принимать входные данные напрямую через параметры, из конвейера или из системного буфера обмена.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Text` | String | — | ✅ (ByValue) | 0 | — | ========================== ПАКЕТНЫЙ ФАЙЛ ==========================
Получить данные из БД с помощью командлета Invoke-SqlCmd.
===========================================================================
Функция отображения справки пока недоступна. Для получения версии 3.0 этих команд введите Get-Help.
...
========================== ПАКЕТНЫЙ ФАЙЛ ==========================
Загрузить данные в таблицу или представление.
===========================================================================
Функция отображения справки пока недоступна. Для получения версии 3.0 этих команд введите Get-Help. |
| `-Instructions` | String | — | — | 1 | `('Check and correct any spelling or grammar ' +
            'errors in the text. Return the corrected text without any ' +
            'additional comments or explanations.')` | Инструкции для модели ИИ о том, как преобразовать текст |
...
> Инструкции для модели ИИ о том, как преобразовать текст
