...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Length` | Int32 | — | — | 0 | `32` | Длина токена в байтах (по умолчанию: 32, минимум: 16) |
| `-SetEnvironmentVariable` | SwitchParameter | — | — | Named | — | Сохраните токен в переменную пользовательской среды GENXDEV_MCP_TOKEN |
| `-Force` | SwitchParameter | — | — | Named | — | Перезаписать существующую переменную окружения без запроса подтверждения |

## Parameter Details

### `-Length <Int32>`

> Длина токена в байтах (по умолчанию: 32, минимум: 16)
...
> Сохраните токен в переменную пользовательской среды GENXDEV_MCP_TOKEN
...
> Перезаписать существующую переменную окружения без запроса подтверждения
