...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-DatabaseName` | String | ✅ | — | 0 | — | Имя базы данных SQL Server для создания *(Parameter set: )* |
...
| `-DataFilePath` | String | — | — | Named | — | Дополнительный путь к файлу данных (.mdf) для создания базы данных на основе файлов. *(Parameter set: )* |
| `-LogFilePath` | String | — | — | Named | — | Необязательный путь к файлу журнала (.ldf) для создания базы данных на основе файлов. *(Parameter set: )* |
| `-DetachAfterCreation` | SwitchParameter | — | — | Named | — | Отсоединить базу данных после создания (для файловых баз данных). *(Parameter set: )* |
...
> Имя базы данных SQL Server для создания
...
> Дополнительный путь к файлу данных (.mdf) для создания базы данных на основе файлов.
...
> Необязательный путь к файлу журнала (.ldf) для создания базы данных на основе файлов.
...
> Отсоединить базу данных после создания (для файловых баз данных).
