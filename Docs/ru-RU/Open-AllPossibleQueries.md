...
> Открывает все возможные типы запросов для указанных поисковых терминов или URL-адресов.

## Description

Выполняет все командлеты, обрабатывающие веб-запросы, обрабатывая как URL-адреса, так и поисковые запросы. Для URL-адресов выполняет запросы к конкретным сайтам, а для поисковых запросов — общие веб-запросы. Эта функция динамически обнаруживает и выполняет все доступные командлеты запросов из семейства модулей GenXdev.Queries.
...
| `-SessionOnly` | SwitchParameter | — | — | Named | — | Использовать сеансовый режим для профиля браузера. |
| `-ClearSession` | SwitchParameter | — | — | Named | — | Очистите сеанс браузера перед открытием. |
| `-SkipSession` | SwitchParameter | — | — | Named | — | Пропустить восстановление сеанса браузера. |
...
Открывает все возможные типы запросов для «сценариев PowerShell» на мониторе по умолчанию.
...
Открывает все возможные типы запросов для URL-адреса GitHub, используя псевдоним и короткие параметры.
...
> Использовать сеансовый режим для профиля браузера.
...
> Очистите сеанс браузера перед открытием.
...
> Пропустить восстановление сеанса браузера.
