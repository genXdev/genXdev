...
| `-ClearSession` | SwitchParameter | — | — | Named | — | Очистить сеанс/профиль браузера перед открытием. |
...
> Очистить сеанс/профиль браузера перед открытием.
...
> Пропустить загрузку сессии/профиля браузера.
