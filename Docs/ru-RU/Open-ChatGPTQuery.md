...
> Открывает запрос ChatGPT в веб-браузере.

## Description

Открывает ChatGPT в веб-браузере, автоматически вводит указанный запрос и отправляет его. Поддерживает несколько запросов, которые будут выполнены с использованием базовой функции Open-WebsiteAndPerformQuery. Эта функция предоставляет удобный способ взаимодействия с ChatGPT от OpenAI из PowerShell с расширенными возможностями настройки браузера.
...
| `-ShowWindow` | SwitchParameter | — | — | Named | — | Показать окно браузера |
...
Отправляйте несколько запросов, используя полное имя параметра.
...
Отправка запроса с использованием псевдонима и конвейера.
