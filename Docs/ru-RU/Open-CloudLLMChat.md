...
Открывает ChatGPT и отправляет запрос о функциях PowerShell.
...
Использует псевдоним для запроса к Google Gemini о машинном обучении.
