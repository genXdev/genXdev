...
> Открывает запрос DeepSeek в веб-браузере

## Description

Открывает запрос DeepSeek в веб-браузере, вводит запрос и нажимает Enter для выполнения поиска. Эта функция использует поисковую систему DeepSeek AI для предоставления интеллектуальных ответов и идей по указанным запросам.
...
Открывает DeepSeek и ищет "powershell function" с использованием настроек по умолчанию.
...
Использует псевдоним для поиска «функции PowerShell» с параметрами по умолчанию.
...
Открывает DeepSeek в полноэкранном режиме на основном мониторе для поиска «основ машинного обучения».
