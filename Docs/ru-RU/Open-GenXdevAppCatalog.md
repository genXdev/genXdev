...
> Открывает каталог прогрессивных веб-приложений GenXdev в веб-браузере.

## Description

Открывает каталог опубликованных прогрессивных веб-приложений GenXdev в веб-браузере. Открывается в режиме приложения с полноэкранным режимом, включенным по умолчанию, для обеспечения оптимального просмотра каталога. Поддерживаются все стандартные параметры конфигурации веб-браузера, включая размещение монитора, размер окна и языковые настройки.

Функция автоматически настраивает браузер для наилучшего просмотра каталога и может одновременно открывать несколько экземпляров браузера. Обеспечивается всесторонняя языковая поддержка, а также учитываются предпочтения пользователя при выборе и позиционировании браузера.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Language` | String | — | — | 0 | — | Язык возвращаемых результатов поиска |
...
| `-ShowWindow` | SwitchParameter | — | — | Named | — | Показать окно браузера (не свернутое и не скрытое) |
...
Открывает каталог приложений GenXdev на мониторе 1 в режиме приложения с полноэкранным режимом.
...
Открывает каталог приложений GenXdev на мониторе 1 с помощью команды псевдонима.
...
> Показать окно браузера (не свернутое и не скрытое)
