...
Открывает запрос Github CoPilot в веб-браузере и автоматически вводит указанный запрос. Функция ожидает загрузки страницы перед вводом запроса. Эта функция использует базовую функцию Open-WebsiteAndPerformQuery для автоматизации браузера и предоставляет удобный способ взаимодействия с GitHub Copilot из PowerShell с обширными возможностями настройки браузера.
