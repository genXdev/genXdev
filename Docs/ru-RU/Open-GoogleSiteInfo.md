...
> Открывает запросы информации о сайте Google в веб-браузере.

## Description

Открывает несколько поисковых запросов Google, связанных с информацией о сайте (site:, link:, related:), в веб-браузере для указанного домена (доменов).
...
| `-SessionOnly` | SwitchParameter | — | — | Named | — | Использовать сеансовый режим для профиля браузера (без сохранения данных) |
| `-ClearSession` | SwitchParameter | — | — | Named | — | Очистить данные сессии/профиля браузера перед открытием |
| `-SkipSession` | SwitchParameter | — | — | Named | — | Пропустить использование сеанса/профиля браузера (использовать по умолчанию) |
...
> Использовать сеансовый режим для профиля браузера (без сохранения данных)
...
> Очистить данные сессии/профиля браузера перед открытием
...
> Пропустить использование сеанса/профиля браузера (использовать по умолчанию)
