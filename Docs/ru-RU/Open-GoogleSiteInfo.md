...
Открывает несколько поисковых запросов Google, связанных с информацией о сайте (site:, link:, related:), в веб-браузере для указанного домена(ов).
...
| `-SessionOnly` | SwitchParameter | — | — | Named | — | Использовать сессионный режим для профиля браузера (без сохранения данных) |
| `-ClearSession` | SwitchParameter | — | — | Named | — | Очистить данные сеанса/профиля браузера перед открытием |
