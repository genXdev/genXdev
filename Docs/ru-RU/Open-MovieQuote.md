...
> Открывает видео с цитатой из фильма в веб-браузере.

## Description

Выполняет поиск и открывает цитаты из фильмов с помощью playphrase.me, позволяя указать настройки монитора и браузера. Эта функция предоставляет доступ к обширной базе данных цитат из фильмов с видеоклипами, поддерживая несколько языков и расширенные возможности настройки браузера.

Основные возможности:
- Поиск цитат из фильмов в обширной базе данных
- Поддержка нескольких языков с автоматическим определением языка
- Расширенное позиционирование браузера и управление окнами
...
Открывает поиск знаменитой фразы Терминатора «I'll be back».
...
Открывает поиск цитаты из Касабланки на мониторе 1.
...
Открывает поиск цитаты из «Звёздных войн» на английском языке в приватном режиме.
