...
> Открывает интерактивную шкалу времени, показывающую текущее время, дату, век и тысячелетие.

## Description

Открывает веб-интерактивную временную шкалу.
Поддерживает несколько языков и возможности визуальной настройки.
...
| `-Language` | String | — | — | 1 | — | Переопределить язык браузера по умолчанию или выбрать [Все] для смены всех языков каждую минуту |
| `-DragedNodeBackground` | String | — | — | Named | `$null` | Переопределите css-color-style для окрашивания фона узла, который в данный момент перетаскивается. |
| `-FocusedNodeBackground` | String | — | — | Named | `$null` | Переопределите css-color-style для закраски фона узла в фокусе (в центре) |
| `-FocusedNodeForeground` | String | — | — | Named | `$null` | Переопределите css-color-style для окрашивания текста переднего плана сфокусированного узла (в центре) |
| `-UnFocusedNodeBackground` | String | — | — | Named | `$null` | Переопределите css-color-style для закраски фона узла в фокусе (в центре) |
| `-UnFocusedNodeForeground` | String | — | — | Named | `$null` | Переопределить CSS-стиль цвета для окрашивания текста неактивного узла (в центре) на переднем плане |
| `-BorderLightColor` | String | — | — | Named | `$null` | Переопределить цветовую схему border-light-color по умолчанию для CSS |
| `-BorderDarkColor` | String | — | — | Named | `$null` | Переопределить цветовой стиль темно-бордового цвета границы по умолчанию |
| `-BorderWidth` | Int32 | — | — | Named | `1` | Переопределяет ширину по умолчанию для отрисовки границ узлов |
| `-RotationDelaySeconds` | Int32 | — | — | Named | `15` | Переопределите ширину по умолчанию для задержки фонового вращения |
...
Открывает интерактивную временную шкалу с визуальными эффектами в стиле Ван Гога на английском языке.
...
Открывает временную шкалу на мониторе 2, используя псевдонимы.
...
Открывает временную шкалу в режиме инкогнито Chrome в полноэкранном режиме.
...
> Используемый монитор: 0 — по умолчанию, -1 — игнорировать, -2 — настроенный вторичный монитор, по умолчанию Global:DefaultSecondaryMonitor или 2, если не найден
...
> Не препятствуйте загрузке расширений браузера
...
> Переопределить язык браузера по умолчанию или выбрать [Все] для смены всех языков каждую минуту
...
> Переопределите css-color-style для окрашивания фона узла, который в данный момент перетаскивается.
...
> Переопределите css-color-style для закраски фона узла в фокусе (в центре)
...
> Переопределите css-color-style для окрашивания текста переднего плана сфокусированного узла (в центре)
...
> Переопределить CSS-стиль цвета для окрашивания текста неактивного узла (в центре) на переднем плане
...
> Переопределить цветовую схему border-light-color по умолчанию для CSS
...
> Переопределить цветовой стиль темно-бордового цвета границы по умолчанию
...
> Переопределяет ширину по умолчанию для отрисовки границ узлов
...
> Переопределите ширину по умолчанию для задержки фонового вращения
