...
> Открывает информацию о сайте WaybackMachine в веб-браузере.

## Description

Открывает запрос Waybackmachine в веб-браузере, отображая исторические версии указанного URL или веб-сайта. Поддерживает несколько запросов и выбор монитора. Предоставляет доступ к архивному веб-контенту через сервис Wayback Machine Интернет-архива.
...
| `-Language` | String | — | — | 1 | — | Языковые настройки для интерфейса и содержимого браузера |
...
| `-SessionOnly` | SwitchParameter | — | — | Named | — | Используйте альтернативные настройки, сохраненные в сеансе, для предпочтений Wayback Machine |
| `-ClearSession` | SwitchParameter | — | — | Named | — | Очистка альтернативных настроек, сохраненных в сеансе для предпочтений Wayback Machine |
...
Открывает архив Wayback Machine для example.com с использованием псевдонимов с отбрасыванием позиционирования монитора.
...
> Языковые настройки для интерфейса и содержимого браузера
...
> Используйте альтернативные настройки, сохраненные в сеансе, для предпочтений Wayback Machine
...
> Очистка альтернативных настроек, сохраненных в сеансе для предпочтений Wayback Machine
