...
> Запускает новое окно веб-браузера с определенным позиционированием.

## Description

Открывает новое окно браузера (Edge или Chrome), расположенное в правой части основного монитора в фоновом режиме.
