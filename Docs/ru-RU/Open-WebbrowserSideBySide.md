...
> Запускает новое окно веб-браузера с указанным позиционированием.

## Description

Открывает новое окно браузера (Edge или Chrome), расположенное с правой стороны основного монитора, в фоновом режиме.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Url` | String[] | — | ✅ (ByValue) | 0 | — | URL-адреса для открытия в браузере |
...
> URL-адреса для открытия в браузере
