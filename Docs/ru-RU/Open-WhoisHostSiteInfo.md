...
> Открывает запрос информации о хосте Whois в веб-браузере.

## Description

Открывает запросы информации о хосте Whois в веб-браузере для доменных имен или IP-адресов. Поддерживает настраиваемый выбор монитора и несколько запросов с обширными параметрами настройки браузера, включая позиционирование окна, выбор браузера и функции автоматизации.
...
| `-SkipSession` | SwitchParameter | — | — | Named | — | Храните настройки только в постоянных предпочтениях, не влияя на сеанс для настроек ИИ, таких как язык, коллекции изображений и т. д. |
...
Открывает информацию Whois для нескольких доменов на мониторе по умолчанию.
...
Открывает информацию Whois для example.com с помощью псевдонимов и позиционных параметров.
...
Открывает информацию Whois для доменов из конвейера в приватном режиме Chrome.
...
> Храните настройки только в постоянных предпочтениях, не влияя на сеанс для настроек ИИ, таких как язык, коллекции изображений и т. д.
