...
Открывает один или несколько запросов Wolfram Alpha в веб-браузере. Поддерживает настраиваемый выбор монитора и параметры браузера через динамические параметры. Обеспечивает полное управление браузером, включая позиционирование, изменение размера и возможности автоматизации для расширенных рабочих процессов научных вычислений.
...
Открывает запрос Wolfram Alpha о массе Солнца на мониторе по умолчанию.
...
Открывает несколько запросов Wolfram Alpha с помощью псевдонима для быстрых научных вычислений.
...
Открывает запрос вычислений в полноэкранном режиме с предпочтением английского языка через конвейерный ввод.
