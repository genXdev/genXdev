...
> Открывает игру YAB в веб-браузере с настраиваемыми параметрами.

## Description

Открывает веб-сайт игры YAB в указанном браузере с различными опциями отображения и поведения. Поддерживает различные игровые режимы, включая режим зрителя. Игра YAB — это онлайн-головоломка, в которую можно играть интерактивно или наблюдать в режиме зрителя, где ИИ играет автоматически.
...
Открывает игру YAB в режиме зрителя с помощью браузера Chrome без полноэкранного режима, с интерфейсом на английском языке.
...
Открывает игру YAB в браузере Edge с приватным просмотром на мониторе 2, используя псевдонимы для быстрого доступа.
