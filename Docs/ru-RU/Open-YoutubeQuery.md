...
Открывает один или несколько поисковых запросов YouTube в веб-браузере с расширенными возможностями позиционирования и настройки. Поддерживает выбор монитора, настройки браузера и автоматизацию нажатий клавиш через динамические параметры, унаследованные от командлета Open-Webbrowser. Каждый запрос открывается в отдельном экземпляре браузера с полным контролем над положением окна, типом браузера и языком поиска.
...
Открывает поиск YouTube для "PowerShell tutorial" на мониторе по умолчанию.
...
Открывает поиск YouTube по запросу "как программировать" на настроенном дополнительном мониторе с помощью псевдонима функции.
