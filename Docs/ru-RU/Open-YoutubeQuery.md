...
> Открывает поисковые запросы YouTube в веб-браузере.

## Description

Открывает один или несколько поисковых запросов YouTube в веб-браузере с расширенными возможностями позиционирования и настройки. Поддерживает настраиваемый выбор монитора, настройки браузера и автоматизацию нажатия клавиш через динамические параметры, унаследованные от командлета Open-Webbrowser. Каждый запрос открывается в отдельном экземпляре браузера с полным контролем над позиционированием окна, типом браузера и языком поиска.
...
Открывает поиск YouTube по запросу «PowerShell tutorial» на мониторе по умолчанию.
...
Открывает поиск YouTube для "как программировать" на настроенном дополнительном мониторе с использованием псевдонима функции.
