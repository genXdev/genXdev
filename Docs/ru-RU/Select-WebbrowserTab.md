...
| `-Name` | String | ✅ | — | 0 | — | Выбирает первую вкладку с этим именем в URL *(Parameter set: )* 🌐 *Supports wildcards* |
| `-ByReference` | PSObject | ✅ | — | Named | — | Выберите вкладку, используя ссылку из Get-ChromiumSessionReference *(Parameter set: )* |
...
| `-Force` | SwitchParameter | — | — | Named | — | Перезапускает браузер при необходимости |
