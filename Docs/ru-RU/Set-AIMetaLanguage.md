...
> Устанавливает язык по умолчанию и, при необходимости, каталоги изображений для операций с метаданными изображений GenXdev.AI.
...
Устанавливает каталоги языков и изображений постоянно в настройках.
...
Задает язык постоянно в настройках.
...
Очищает настройку языка сеанса (глобальную переменную), не затрагивая постоянные предпочтения.
