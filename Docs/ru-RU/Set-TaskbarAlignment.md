...
Устанавливает выравнивание панели задач в Windows 11 и более новых версиях путем изменения раздела реестра 'TaskbarAl' по пути HKCU:\SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer\Advanced. Выравнивание может быть установлено по центру (значение 1) или слева (значение 0).
...
> Выравнивание панели задач (По центру или Слева)
