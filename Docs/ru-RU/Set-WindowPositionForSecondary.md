...
Set-WindowPosition с различными параметрами макета, включая выравнивание, размер и
настройки границ. Она обрабатывает выбор монитора на основе глобальной конфигурации и
предоставляет удобную оболочку для позиционирования окон на дополнительном мониторе.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Process` | Diagnostics.Process[] | — | ✅ (ByValue, ByPropertyName) | 0 | — | Процесс расположения окна |
| `-Monitor` | Int32 | — | — | Named | `-2` | Используемый монитор: 0 — по умолчанию, -1 — отклонить, -2 — настроить |
...
| `-FocusWindow` | SwitchParameter | — | — | Named | — | Сфокусировать окно после позиционирования |
| `-SetForeground` | SwitchParameter | — | — | Named | — | Установить окно на передний план после позиционирования |
...
> Используемый монитор: 0 — по умолчанию, -1 — отклонить, -2 — настроить
...
> Сфокусировать окно после позиционирования
...
> Установить окно на передний план после позиционирования
...
> Нажатия клавиш для отправки в окно после позиционирования
...
> Возвращает объект процесса после позиционирования
...
> Расположите окно рядом с PowerShell на одном мониторе
