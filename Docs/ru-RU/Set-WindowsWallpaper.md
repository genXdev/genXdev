...
> Устанавливает случайные обои из указанной папки.

## Description

* Выбирает случайный файл изображения из указанного каталога и устанавливает его в качестве обоев рабочего стола Windows.
...
Устанавливает случайные обои из каталога по умолчанию с помощью псевдонима.

## Parameter Details

### `-InputObject <Object>`

> Путь к каталогу, содержащему изображения обоев
