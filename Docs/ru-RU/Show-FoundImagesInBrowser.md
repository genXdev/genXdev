...
> Отображает результаты поиска изображений в веб-галерее в стиле каменной кладки (masonry layout).

## Description

Принимает результаты поиска изображений и отображает их в браузерной мозаичной раскладке. Может работать в интерактивном режиме с возможностями редактирования и удаления или в простом режиме отображения. Принимает объекты данных изображений, обычно из Find-Image, и отображает их с всплывающими подсказками, показывающими метаданные, такие как распознавание лиц, обнаружение объектов и данные классификации сцен.
...
| `-Interactive` | SwitchParameter | — | — | Named | — | Подключится к браузеру и добавит дополнительные кнопки, такие как «Изменить» и «Удалить» |
...
| `-NewWindow` | SwitchParameter | — | — | Named | — | Создать новое окно браузера вместо повторного использования существующего |
| `-OnlyReturnHtml` | SwitchParameter | — | — | Named | — | Возвращайте только сгенерированный HTML, не отображая его в браузере. |
| `-EmbedImages` | SwitchParameter | — | — | Named | — | Встраивайте изображения как data URL-адреса base64 вместо URL-адресов file:// для лучшей переносимости. |
| `-ShowOnlyPictures` | SwitchParameter | — | — | Named | — | Показывать только изображения в скругленном прямоугольнике, без текста снизу. |
...
| `-PassThru` | SwitchParameter | — | — | Named | — | Возвращает вспомогательный объект окна браузера для дальнейших манипуляций |
...
> Объекты данных изображений для отображения в галерее.
...
> Подключится к браузеру и добавит дополнительные кнопки, такие как «Изменить» и «Удалить»
...
> Наведите курсор на изображения, чтобы увидеть данные распознавания лиц и обнаружения объектов
...
> Создать новое окно браузера вместо повторного использования существующего
...
> Возвращайте только сгенерированный HTML, не отображая его в браузере.
...
> Встраивайте изображения как data URL-адреса base64 вместо URL-адресов file:// для лучшей переносимости.
...
> Показывать только изображения в скругленном прямоугольнике, без текста снизу.
...
> Возвращает вспомогательный объект окна браузера для дальнейших манипуляций
