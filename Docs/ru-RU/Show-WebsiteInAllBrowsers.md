...
> Открывает URL в нескольких браузерах одновременно в мозаичном расположении.

## Description

Эта функция создает мозаичный макет окон браузера, открывая указанный URL в Chrome, Edge, Firefox и окне приватного просмотра. Браузеры располагаются в виде сетки 2x2:
- Chrome: верхний левый квадрант
- Edge: нижний левый квадрант
- Firefox: верхний правый квадрант
- Окно приватного просмотра: нижний правый квадрант

Поддерживаются все параметры из Open-Webbrowser, которые передаются для управления позиционированием, поведением и внешним видом браузеров. Функция выступает как оболочка, применяющая единое позиционирование по квадрантам, допуская полную настройку параметров запуска браузера.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Url` | String | ✅ | ✅ (ByValue, ByPropertyName) | 0 | — | URL-адреса, которые нужно открыть во всех браузерах одновременно |
...
> URL-адреса, которые нужно открыть во всех браузерах одновременно
