...
> Немедленно останавливает любой выполняющийся вывод текста в речь.

## Description

Останавливает все активные и поставленные в очередь операции синтеза речи, отменяя как стандартные, так и настраиваемые речевые операции. Это обеспечивает немедленное прекращение звука для любых выполняемых действий преобразования текста в речь.
