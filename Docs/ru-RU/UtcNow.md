...
Возвращает текущую дату и время в формате UTC как объект System.DateTime. Эта функция предоставляет стандартизированный способ получения времени UTC в разных системах и часовых поясах. Возвращаемый объект DateTime может использоваться для синхронизации временных меток, ведения журнала и операций, пересекающих часовые пояса.
