...
> Förbättrar text genom att lägga till kontextuellt lämpliga emojis med hjälp av AI.

## Description

Denna funktion bearbetar inmatad text för att lägga till emojis som matchar det känslomässiga sammanhanget. Den kan acceptera inmatning direkt via parametrar, från pipeline eller från systemets urklipp. Funktionen använder AI-modeller för att analysera texten och välja lämpliga emojis, vilket gör meddelanden mer uttrycksfulla och engagerande.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Text` | String | — | ✅ (ByValue) | 0 | — | Texten att förbättra med emojis |
...
> Texten att förbättra med emojis
