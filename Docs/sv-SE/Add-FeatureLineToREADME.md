...
> Lägger till en funktionsrad i README-filen med en tidsstämpel.

## Description

Lägger till en funktionsrad i den angivna README-filen, markerad med aktuellt datum i formatet yyyyMMdd. Raden kan formateras som kod och visas valfritt.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Line` | String | — | — | 0 | `''` | Beskrivningstexten för funktionen att lägga till |
| `-Code` | SwitchParameter | — | — | Named | — | Formatera raden som kod |
| `-Show` | SwitchParameter | — | — | Named | — | Visa README efter att ha lagt till raden |
| `-UseHomeREADME` | SwitchParameter | — | — | Named | — | Använd README i hemkatalogen |
...
> Beskrivningstexten för funktionen att lägga till
...
> Visa README efter att ha lagt till raden
