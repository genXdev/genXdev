...
> Lägger till en idéartikel i filen README.md.

## Description

Lägger till en tidsstämplad idé i avsnittet "## Ideas" i en README.md-fil.
Kan visa det modifierade avsnittet och öppna i Visual Studio Code.
