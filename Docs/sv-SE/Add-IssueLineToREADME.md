...
> Lägger till en ärendepunkt i README.md-filen.

## Description

Lägger till en tidsstämplad fråga i avsnittet "## Issues" i en README.md-fil.
Kan visa det ändrade avsnittet och öppna i Visual Studio Code.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Line` | String | — | — | 0 | `''` | Texten att lägga till |
