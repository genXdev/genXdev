...
> Lägger till en ReleaseNote-rad i README-filen med en tidsstämpel.

## Description

Lägger till en ReleaseNote-rad i den angivna README-filen, med prefix för aktuellt datum i formatet yyyyMMdd. Raden kan formateras som kod och visas eventuellt.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Line` | String | — | — | 0 | `''` | ReleaseNote-beskrivningstexten som ska läggas till |
...
> ReleaseNote-beskrivningstexten som ska läggas till
