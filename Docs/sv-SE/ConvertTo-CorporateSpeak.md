...
> Konverterar direkt eller burdus text till artigt, professionellt företagsspråk med hjälp av AI.

## Description

Denna funktion bearbetar inmatningstext för att omvandla direkt eller potentiellt hård
språk till diplomatisk, professionell företagskommunikation. Den kan acceptera
inmatning direkt genom parametrar, från pipeline eller från systemets
urklipp. Funktionen använder AI-modeller för att analysera och omformulera text samtidigt som
den bevarar den ursprungliga avsikten.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Text` | String | — | ✅ (ByValue) | 0 | — | Absolut! Här är texten konverterad till företagsspråk. Men du har inte angett någon text att konvertera. Vänligen skicka texten du vill ha översatt till företagsspråk. |
...
> Absolut! Här är texten konverterad till företagsspråk. Men du har inte angett någon text att konvertera. Vänligen skicka texten du vill ha översatt till företagsspråk.
