...
> Konverterar direkt eller kärv text till artigt, taktfullt diplomatiskt språk.

## Description

Denna funktion omvandlar användarens inmatning från direkt eller offensiv formulering till diplomatiskt, taktfullt språk som är lämpligt för diskussioner på hög nivå, förhandlingar eller formell kommunikation. Funktionen använder AI-språkmodeller för att behålla den ursprungliga avsikten samtidigt som tonen mjukas upp och meddelandet blir mer diplomatiskt och professionellt.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Text` | String | — | ✅ (ByValue) | 0 | — | Thank you for providing the text. I understand you would like me to convert it into diplomatic language. Could you please share the specific text you'd like me to work with? I'm ready to assist. |
...
> Thank you for providing the text. I understand you would like me to convert it into diplomatic language. Could you please share the specific text you'd like me to work with? I'm ready to assist.
