...
> Konverterar PowerShell-funktioner till LLM OpenAI API-funktionsdefinitioner.

## Description

Tar exponerade cmdlet-definitioner och genererar LLM OpenAI API-kompatibla funktionsdefinitioner inklusive parameterinformation och callback-hanterare.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-ExposedCmdLets` | GenXdev.Helpers.ExposedCmdletDefinition[] | — | ✅ (ByValue) | 0 | `@()` | PowerShell-kommandon för att konvertera till verktygsfunktioner |
...
> PowerShell-kommandon för att konvertera till verktygsfunktioner
