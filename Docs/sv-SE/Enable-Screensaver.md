...
> Startar den konfigurerade Windows-skärmsläckaren.

## Description

Aktiverar Windows-systemets skärmsläckare genom att köra den standardmässiga skärmsläckarens körbara fil (scrnsave.scr) med växeln /s för att starta den omedelbart.
