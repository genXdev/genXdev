...
> Söker efter bildfiler och metadata i angivna kataloger med filtreringsfunktioner och valfri webbläsarbaserad gallerivisning.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Any` | String[] | — | — | 0 | `@()` | Matchar någon av alla möjliga metadata-typer. |
| `-Name` | String[] | — | — | 1 | `@('.\')` | Matris över sökvägar för att söka efter bilder |
| `-Language` | String | — | — | Named | — | Språk för beskrivningar och nyckelord. |
| `-DescriptionSearch` | String[] | — | — | Named | `@()` | Beskrivningstexten att söka efter, jokertecken tillåtna. |
| `-Keywords` | String[] | — | — | Named | `@()` | Nyckelorden att söka efter, jokertecken tillåtna. |
| `-People` | String[] | — | — | Named | `@()` | Personer att söka efter, jokertecken tillåtna. |
| `-Objects` | String[] | — | — | Named | `@()` | Objekt att leta efter, jokertecken tillåtna. |
| `-Scenes` | String[] | — | — | Named | `@()` | Scenkategorier att leta efter, jokertecken tillåtna. |
| `-PictureType` | String[] | — | — | Named | `@()` | Bildtyp att filtrera efter (t.ex. 'daylight', 'kväll', 'inomhus', etc). Stöder jokertecken. |
| `-StyleType` | String[] | — | — | Named | `@()` | Stiltyp att filtrera efter (t.ex. 'casual', 'formal', etc.). Stöder jokertecken. |
| `-OverallMood` | String[] | — | — | Named | `@()` | Allmän stämning att filtrera efter (t.ex. 'lugn', 'glad', 'ledsen', etc.). Stöder jokertecken. |
| `-MetaCameraMake` | String[] | — | — | Named | `@()` | Filtrera efter kamera märke i bildens EXIF-metadata. Stödjer jokertecken. |
| `-MetaCameraModel` | String[] | — | — | Named | `@()` | Filtrera efter kameramodell i bildens EXIF-metadata. Stödjer jokertecken. |
| `-MetaGPSLatitude` | Double[] | — | — | Named | — | Filtrera efter GPS-latitudintervall i bildens EXIF-metadata. |
| `-MetaGPSLongitude` | Double[] | — | — | Named | — | Filtrera efter GPS-längdgradsintervall i bildens EXIF-metadata. |
| `-MetaGPSAltitude` | Double[] | — | — | Named | — | Filtrera efter GPS-höjdintervall i bildens EXIF-metadata (i meter). |
| `-GeoLocation` | Double[] | — | — | Named | — | Geografiska koordinater [latitud, longitud] att söka nära. |
| `-GeoDistanceInMeters` | Double | — | — | Named | `1000` | Maximalt avstånd i meter från GeoLocation att söka efter bilder. |
| `-MetaExposureTime` | Double[] | — | — | Named | — | Filtrera efter exponeringstidsintervall i bildens EXIF-metadata (i sekunder). |
| `-MetaFNumber` | Double[] | — | — | Named | — | Filtrera efter F-nummer (bländare) intervall i bildens EXIF-metadata. |
| `-MetaISO` | Int32[] | — | — | Named | — | Filtrera efter ISO-känslighetsintervall i bildens EXIF-metadata. |
| `-MetaFocalLength` | Double[] | — | — | Named | — | Filtrera efter brännviddsintervall i bildens EXIF-metadata (i mm). |
| `-MetaWidth` | Int32[] | — | — | Named | — | Filtrera efter bildens breddintervall i pixlar från EXIF-metadata. |
| `-MetaHeight` | Int32[] | — | — | Named | — | Filtrera efter bildhöjdsintervall i pixlar från EXIF-metadata. |
| `-MetaDateTaken` | DateTime[] | — | — | Named | — | Filtrera efter datum taget från EXIF-metadata. Kan vara ett datumintervall. |
| `-Title` | String | — | — | Named | `'Photo Gallery'` | Titel för galleriet |
| `-Description` | String | — | — | Named | `('Hover over images to see face recognition ' +
            'and object detection data')` | Beskrivning för galleriet |
| `-AcceptLang` | String | — | — | Named | `$null` | Ange webbläsarens accept-lang HTTP-huvud |
| `-KeysToSend` | String[] | — | — | Named | — | Tangenttryckningar att skicka till webbläsarfönstret, se dokumentationen för cmdlet GenXdev\Send-Key |
...
| `-SendKeyUseShiftEnter` | SwitchParameter | — | — | Named | — | Anv├ñnd Skift+Retur ist├ñllet f├Âr Retur n├ñr du skickar tangenter |
| `-SendKeyDelayMilliSeconds` | Int32 | — | — | Named | — | Fördröjning mellan olika inmatningssträngar i millisekunder vid sändning av tangenter |
...
| `-Monitor` | Int32 | — | — | Named | `-2` | Monitorn som ska användas, 0 = standard, -1 = ignorera, -2 = konfigurerad sekundär bildskärm, som standard är `Global:DefaultSecondaryMonitor` eller 2 om den inte hittas |
...
| `-EmbedImages` | SwitchParameter | — | — | Named | — | Bädda in bilder som base64. |
| `-NoFallback` | SwitchParameter | — | — | Named | — | Växla för att inaktivera reservbeteende. |
| `-NeverRebuild` | SwitchParameter | — | — | Named | — | Växla för att hoppa över databasinitiering och återuppbyggnad. |
...
| `-HasNudity` | SwitchParameter | — | — | Named | — | Filtrera bilder som innehåller nakenhet. |
| `-NoNudity` | SwitchParameter | — | — | Named | — | Filtrera bort bilder som INTE innehåller nakenhet. |
| `-HasExplicitContent` | SwitchParameter | — | — | Named | — | Filtrera bilder som innehåller explicit innehåll. |
| `-NoExplicitContent` | SwitchParameter | — | — | Named | — | Filtrera bilder som INTE innehåller explicit innehåll. |
| `-ShowInBrowser` | SwitchParameter | — | — | Named | — | Visa sökresultaten i ett webbaserat bildgalleri. |
| `-PassThru` | SwitchParameter | — | — | Named | — | Returnera bilddata som objekt. När det används med -ShowInBrowser visas både galleriet och objekten returneras. |
| `-NoBorders` | SwitchParameter | — | — | Named | — | Ta bort fönsterkanter och titelrad för ett renare utseende |
| `-SideBySide` | SwitchParameter | — | — | Named | — | Placera webbläsarfönstret sida vid sida med PowerShell på samma bildskärm |
| `-Interactive` | SwitchParameter | — | — | Named | — | Ansluter till webbläsaren och lägger till ytterligare knappar som Redigera och Ta bort. Är endast effektiv när den används med -ShowInBrowser. |
...
| `-Chromium` | SwitchParameter | — | — | Named | — | Öppnas i Microsoft Edge eller Google Chrome, beroende på vilken som är standardwebbläsaren |
...
| `-Webkit` | SwitchParameter | — | — | Named | — | Öppnar den Playwright-hanterade WebKit-webbläsaren. Innebär -PlayWright |
...
| `-OnlyReturnHtml` | SwitchParameter | — | — | Named | — | Visa endast den genererade HTML-koden istället för att visa den i en webbläsare. |
| `-ShowOnlyPictures` | SwitchParameter | — | — | Named | — | Visa endast bilder i en rundad rektangel, ingen text nedanför. |
...
| `-AutoScrollPixelsPerSecond` | Int32 | — | — | Named | `$null` | Bläddra automatiskt sidan med detta antal pixlar per sekund (null för att avaktivera) |
| `-AutoAnimateRectangles` | SwitchParameter | — | — | Named | — | Animera rektanglar (objekt/ytor) i synligt område, cykla var 300:e ms |
| `-SingleColumnMode` | SwitchParameter | — | — | Named | `$false` | Tvinga enkelkolumnslayout (centrerad, 1/3 skärmbredd) |
| `-ImageUrlPrefix` | String | — | — | Named | `''` | Prefix som ska läggas till före varje bildsökväg (t.ex. för fjärr-URL:er) |
| `-MinConfidenceRatio` | Double | — | — | Named | — | Minsta konfidensförhållande (0.0-1.0) för att filtrera personer, scener och objekt efter konfidens. Returnerar endast data för personer, scener och objekt med konfidens större än eller lika med detta värde. |
...
> Matchar någon av alla möjliga metadata-typer.
...
> Matris över sökvägar för att söka efter bilder
...
> Språk för beskrivningar och nyckelord.
...
> Beskrivningstexten att söka efter, jokertecken tillåtna.
...
> Nyckelorden att söka efter, jokertecken tillåtna.
...
> Personer att söka efter, jokertecken tillåtna.
...
> Objekt att leta efter, jokertecken tillåtna.
...
> Scenkategorier att leta efter, jokertecken tillåtna.
...
> Bildtyp att filtrera efter (t.ex. 'daylight', 'kväll', 'inomhus', etc). Stöder jokertecken.
...
> Stiltyp att filtrera efter (t.ex. 'casual', 'formal', etc.). Stöder jokertecken.
...
> Allmän stämning att filtrera efter (t.ex. 'lugn', 'glad', 'ledsen', etc.). Stöder jokertecken.
...
> Filtrera efter kamera märke i bildens EXIF-metadata. Stödjer jokertecken.
...
> Filtrera efter kameramodell i bildens EXIF-metadata. Stödjer jokertecken.
...
> Filtrera efter GPS-latitudintervall i bildens EXIF-metadata.
...
> Filtrera efter GPS-längdgradsintervall i bildens EXIF-metadata.
...
> Filtrera efter GPS-höjdintervall i bildens EXIF-metadata (i meter).
...
> Geografiska koordinater [latitud, longitud] att söka nära.
...
> Maximalt avstånd i meter från GeoLocation att söka efter bilder.
...
> Filtrera efter exponeringstidsintervall i bildens EXIF-metadata (i sekunder).
...
> Filtrera efter F-nummer (bländare) intervall i bildens EXIF-metadata.
...
> Filtrera efter ISO-känslighetsintervall i bildens EXIF-metadata.
...
> Filtrera efter brännviddsintervall i bildens EXIF-metadata (i mm).
...
> Filtrera efter bildens breddintervall i pixlar från EXIF-metadata.
...
> Filtrera efter bildhöjdsintervall i pixlar från EXIF-metadata.
...
> Filtrera efter datum taget från EXIF-metadata. Kan vara ett datumintervall.
...
> Tangenttryckningar att skicka till webbläsarfönstret, se dokumentationen för cmdlet GenXdev\Send-Key
...
> Anv├ñnd Skift+Retur ist├ñllet f├Âr Retur n├ñr du skickar tangenter
...
> Fördröjning mellan olika inmatningssträngar i millisekunder vid sändning av tangenter
...
> Monitorn som ska användas, 0 = standard, -1 = ignorera, -2 = konfigurerad sekundär bildskärm, som standard är `Global:DefaultSecondaryMonitor` eller 2 om den inte hittas
...
> Växla för att inaktivera reservbeteende.
...
> Växla för att hoppa över databasinitiering och återuppbyggnad.
...
> Filtrera bilder som innehåller nakenhet.
...
> Filtrera bort bilder som INTE innehåller nakenhet.
...
> Filtrera bilder som innehåller explicit innehåll.
...
> Filtrera bilder som INTE innehåller explicit innehåll.
...
> Visa sökresultaten i ett webbaserat bildgalleri.
...
> Returnera bilddata som objekt. När det används med -ShowInBrowser visas både galleriet och objekten returneras.
...
> Ta bort fönsterkanter och titelrad för ett renare utseende
...
> Placera webbläsarfönstret sida vid sida med PowerShell på samma bildskärm
...
> Ansluter till webbläsaren och lägger till ytterligare knappar som Redigera och Ta bort. Är endast effektiv när den används med -ShowInBrowser.
...
> Öppnas i Microsoft Edge eller Google Chrome, beroende på vilken som är standardwebbläsaren
...
> Öppnar den Playwright-hanterade WebKit-webbläsaren. Innebär -PlayWright
...
> Visa endast den genererade HTML-koden istället för att visa den i en webbläsare.
...
> Visa endast bilder i en rundad rektangel, ingen text nedanför.
...
> Bläddra automatiskt sidan med detta antal pixlar per sekund (null för att avaktivera)
...
> Animera rektanglar (objekt/ytor) i synligt område, cykla var 300:e ms
...
> Tvinga enkelkolumnslayout (centrerad, 1/3 skärmbredd)
...
> Prefix som ska läggas till före varje bildsökväg (t.ex. för fjärr-URL:er)
...
> Minsta konfidensförhållande (0.0-1.0) för att filtrera personer, scener och objekt efter konfidens. Returnerar endast data för personer, scener och objekt med konfidens större än eller lika med detta värde.
