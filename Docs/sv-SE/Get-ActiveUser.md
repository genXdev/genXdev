...
> Hämtar en lista över unika användarnamn från för närvarande aktiva systemprocesser.

## Description

Frågar alla pågående processer i systemet, extraherar det associerade användarnamnet för varje process och returnerar en deduplicerad lista över användare som har aktiva processer. Detta är användbart för systemadministration och säkerhetsövervakning.
