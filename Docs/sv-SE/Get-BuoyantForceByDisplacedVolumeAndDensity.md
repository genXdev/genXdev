...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-DisplacedVolumeInCubicMeters` | Double | ✅ | — | 0 | `0` | Förflyttad volym i m³ |
| `-FluidDensityInKilogramsPerCubicMeter` | Double | ✅ | — | 1 | `0` | Fluidens densitet i kg/m³ |
| `-GravityInMetersPerSecondSquared` | Double | — | — | 2 | `0` | Gravitation i m/s² (standard: 9,81) |
| `-As` | String | — | — | 3 | — | Utdataenhet för kraft |

## Parameter Details

### `-DisplacedVolumeInCubicMeters <Double>`

> Förflyttad volym i m³
