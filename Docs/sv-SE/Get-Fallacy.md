...
> Analyserar text för att identifiera logiska felslut med hjälp av AI-baserad detektering.

## Description

Denna funktion analyserar den angivna texten för att upptäcka logiska felslut med hjälp av en AI-modell som är tränad på Wikipedias lista över felslut. Den returnerar detaljerad information om varje funnet felslut, inklusive det specifika citatet, felslutets namn, beskrivning, förklaring och formell klassificering. Funktionen använder ett strukturerat svarsformat för att säkerställa konsekvent utdata.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-InputObject` | Object | ✅ | ✅ (ByValue) | 0 | — | Text att analysera för att hitta felslut i |
...
| `-AudioTemperature` | Double | — | — | Named | — | Styr temperaturen för ljudgenerering. |
| `-TemperatureResponse` | Double | — | — | Named | — | Kontrollerar temperaturen för svarsskapande. |
| `-CpuThreads` | Int32 | — | — | Named | — | Antal CPU-trådar som ska användas för bearbetning. |
...
| `-SilenceThreshold` | Double | — | — | Named | — | Tröskelvärde för att upptäcka tystnad i ljud. |
| `-LengthPenalty` | Double | — | — | Named | — | Straff tillämpas för längre svar. |
| `-EntropyThreshold` | Double | — | — | Named | — | Tröskelvärde för entropi vid generering av svar. |
| `-LogProbThreshold` | Double | — | — | Named | — | Tröskelvärde för sannolikhetslogg för utdata. |
| `-NoSpeechThreshold` | Double | — | — | Named | — | Tröskelvärde för att upptäcka frånvaro av tal i ljud. |
| `-DontSpeak` | SwitchParameter | — | — | Named | — | Förhindrar att svaret talas. |
| `-DontSpeakThoughts` | SwitchParameter | — | — | Named | — | Förhindrar att modellen talar sina tankar. |
| `-NoVOX` | SwitchParameter | — | — | Named | — | Inaktiverar VOX (röstaktivering). |
| `-UseDesktopAudioCapture` | SwitchParameter | — | — | Named | — | Använd skrivbordsljudinspelning för inmatning. |
| `-NoContext` | SwitchParameter | — | — | Named | — | Inaktiverar kontext för begäran. |
| `-WithBeamSearchSamplingStrategy` | SwitchParameter | — | — | Named | — | Använd strategi för strålkraftsökning. |
| `-OnlyResponses` | SwitchParameter | — | — | Named | — | Hej, jag är en AI-assistent. |
...
Analyserar den angivna texten för logiska felslut och returnerar strukturerad information om eventuella upptäckta felslut.
...
Använder pipeline-indata för att analysera text med låg temperatur för fokuserad analys.
...
Använder aliaset för att analysera text för logiska felslut.

## Parameter Details

### `-InputObject <Object>`

> Text att analysera för att hitta felslut i
...
> Styr temperaturen för ljudgenerering.
...
> Kontrollerar temperaturen för svarsskapande.
...
> Antal CPU-trådar som ska användas för bearbetning.
...
> Tröskelvärde för att upptäcka tystnad i ljud.
...
> Straff tillämpas för längre svar.
...
> Tröskelvärde för entropi vid generering av svar.
...
> Tröskelvärde för sannolikhetslogg för utdata.
...
> Tröskelvärde för att upptäcka frånvaro av tal i ljud.
...
> Förhindrar att modellen talar sina tankar.
...
> Inaktiverar VOX (röstaktivering).
...
> Använd skrivbordsljudinspelning för inmatning.
...
> Inaktiverar kontext för begäran.
