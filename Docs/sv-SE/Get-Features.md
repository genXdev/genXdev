...
> Visar funktioner från en README.md-fil.

## Description

Visar alla funktioner från avsnittet "## Features" i en README.md-fil. Kan använda antingen README-filen på den aktuella platsen, PowerShell-profilkatalogen eller OneDrive-katalogen.
