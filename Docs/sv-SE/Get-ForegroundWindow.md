...
> Hämtar handtaget för det för närvarande aktiva förgrundsfönstret.

## Description

* Denna cmdlet hämtar fönsterhandtaget (HWND) för det fönster som
  för närvarande är i förgrunden och har tangentbordsfokus.
* Den använder Windows API-funktioner via P/Invoke för att interagera med
  User32.dll-biblioteket.
...
Hämtar och returnerar IntPtr-handtaget för det för närvarande aktiva fönstret.
...
Lagrar handtaget för det aktiva fönstret i en variabel och visar det.
