...
> Hämtar detaljerad information om GenXdev PowerShell-moduler.

## Description

Denna funktion granskar GenXdev PowerShell-moduler och returnerar information om deras konfiguration, versioner och förekomst av viktiga filer. Den kan bearbeta antingen angivna moduler eller alla tillgängliga moduler.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-ModuleName` | String[] | — | ✅ (ByValue, ByPropertyName) | 0 | `@()` | Modulnamn för analys |
