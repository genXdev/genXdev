...
> Visar ärenden från en README.md-fil.

## Description

Visar alla ärenden från avsnittet '## Ärenden' i en README.md-fil. Kan använda antingen README-filen i aktuell plats, PowerShell-profilkatalogen eller OneDrive-katalogen.
