...
> Hämtar sökvägen till en känd Windows-mapp med hjälp av Windows Shell32 API.

## Description

Hämtar sökvägen till en angiven Windows-känd mapp med Shell32 API:s
SHGetKnownFolderPath-funktion. Denna metod är mer tillförlitlig än att använda
miljövariabler eftersom den fungerar konsekvent över olika Windows-versioner
och språkinställningar. Stöder alla standard Windows-kända mappar som
Dokument, Hämtade filer, AppData osv.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-KnownFolder` | String | ✅ | — | 0 | — | Namnet på den kända Windows-mappen för att få sökvägen till |
...
> Namnet på den kända Windows-mappen för att få sökvägen till
