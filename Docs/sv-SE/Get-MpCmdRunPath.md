...
> Hämtar sökvägen till den körbara filen Windows Defender MpCmdRun.exe.

## Description

* Hittar och returnerar den fullständiga sökvägen till Windows Defender kommandoradsverktyg (MpCmdRun.exe).
* Cmdleten kontrollerar standardinstallationsplatsen i Program Files och ger lämplig felhantering om filen inte hittas.
...
Hämtar fullständig sökväg till kommandoradsverktyget för Windows Defender.
