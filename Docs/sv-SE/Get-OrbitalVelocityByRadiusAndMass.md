...
> Beräknar omloppshastighet.

## Description

Använder v = sqrt(G M / r).
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-RadiusInMeters` | Double | ✅ | — | 0 | `0` | Omloppsradie i meter |
| `-CentralMassInKilograms` | Double | ✅ | — | 1 | `0` | Central massa i kg |
| `-As` | String | — | — | 2 | — | Utdataenhet för hastighet |
...
Använder jordens massa och radie för demonstration.
...
Enkel beräkning med standardutdata i m/s.

## Parameter Details

### `-RadiusInMeters <Double>`

> Omloppsradie i meter
