...
> Visar versionsanteckningar från en README.md-fil.

## Description

Visar alla versionsinformation från avsnittet "## Versionsinformation" i en README.md-fil. Kan använda antingen README i aktuell plats, PowerShell-profilkatalogen eller OneDrive-katalogen.
...
| `-First` | Int32 | — | — | 0 | `0` | Begränsa utdata till de första N raderna |
...
> Begränsa utdata till de första N raderna
