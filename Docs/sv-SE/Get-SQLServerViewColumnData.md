...
> Hämtar kolumndata från en SQL-vy med valfri begränsning av poster.

## Description

Kör en SELECT-fråga mot en angiven SQL-vy för att hämta data från en enda kolumn. Stöder anslutning via antingen en anslutningssträng eller databasfilens sökväg. Tillåter begränsning av antalet returnerade poster eller hämtning av alla poster.
...
| `-ColumnName` | String | ✅ | — | 3 | — | Namnet på kolumnen. |
| `-Count` | Int32 | — | — | 4 | `100` | Antalet poster som ska returneras. Standard är 100. -1 för alla. |
