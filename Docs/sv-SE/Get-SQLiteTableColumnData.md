...
> Hämtar data från en specifik kolumn i en SQLite-databastabell.

## Description

Den här funktionen ger ett bekvämt sätt att extrahera data från en enskild kolumn i en SQLite-databastabell. Den stöder två anslutningsmetoder: direkt databasfilssökväg eller anslutningssträng. Funktionen innehåller alternativ för att begränsa antalet returnerade poster och använder korrekt SQLite-frågekonstruktion för optimal prestanda.
...
| `-TableName` | String | ✅ | — | 1 | — | Namnet på tabellen som ska frågas |
| `-ColumnName` | String | ✅ | — | 2 | — | Namnet på kolumnen att hämta |
| `-Count` | Int32 | — | — | 3 | `100` | Antal poster att returnera. Standard 100. Använd -1 för alla. |
