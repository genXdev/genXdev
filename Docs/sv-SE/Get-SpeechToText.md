...
> Konverterar ljudfiler till text med OpenAIs Whisper-taligenkänningsmodell.

## Description

Bearbetar ljudfiler och konverterar tal till text med hjälp av Whisper.NET-biblioteket, som implementerar OpenAIs Whisper automatiska taligenkänning (ASR)-system. Det stöder flera språk, översättningsmöjligheter och olika inställningar för transkriptionskvalitet.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-ModelFileDirectoryPath` | String | — | — | Named | — | Sökväg till modellfilsmappen |
| `-Input` | Object | ✅ | ✅ (ByValue) | 0 | — | Sökväg till ljudfil, FileInfo-objekt eller något ljudformat som stöds av Whisper. |
...
| `-ModelType` | Whisper.net.Ggml.GgmlType | — | — | Named | `Tiny` | Viskningsmodelltyp som ska användas, standard är LargeV3Turbo |
...
Transkriberar en ljudfil till text med standardinställningar.
...
Transkriberar alla WAV-filer i en katalog.
...
Transkriberar spanskt ljud och översätter det till engelska.
...
Returnerar SegmentData-objekt med exakt tidsinformation.

## Parameter Details

### `-ModelFileDirectoryPath <String>`

> Sökväg till modellfilsmappen
...
> Sökväg till ljudfil, FileInfo-objekt eller något ljudformat som stöds av Whisper.
