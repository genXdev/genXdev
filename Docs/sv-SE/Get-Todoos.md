...
> Visar todo-objekt från en README.md-fil.

## Description

Visar alla att-göra-poster från avsnittet "## Todoos" i en README.md-fil.
Kan använda antingen README-filen på nuvarande plats, PowerShell-profilkatalogen eller
OneDrive-katalogen.
