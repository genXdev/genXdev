...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-FrequencyInHertz` | Double | ✅ | — | 0 | `0` | Frekvens i Hz |
| `-WavelengthInMeters` | Double | ✅ | — | 1 | `0` | Våglängd i meter |
...
Beräknar våghastigheten med v = f * λ.
...
Beräknar våghastighet med positionsparametrar.
