...
> Returnerar en omvänd ordbok för alla språk som stöds av Google Sök.

## Description

Returnerar en ordbok som mappar språknamn till deras motsvarande språkkoder för alla språk som stöds av Google Search. Användbart för uppslag av språkkoder i webbfrågor och översättningsuppgifter.
...
Hämtar ordlistans mappning av språknamn till deras koder.
