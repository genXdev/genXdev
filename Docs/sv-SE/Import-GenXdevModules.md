...
> Importerar alla GenXdev PowerShell-moduler till den globala omfattningen.

## Description

Söker igenom den överordnade katalogen efter GenXdev-moduler och importerar varje modul till det globala scopet. Använder platsstackhantering för att bevara arbetskatalogen och ger visuell återkoppling för lyckade och misslyckade importer. Spårar funktionsantalets förändringar under importprocessen.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-DebugFailedModuleDefinitions` | SwitchParameter | — | — | Named | — | Aktivera felsökningsutdata för misslyckade moduldefinitioner |
...
> Aktivera felsökningsutdata för misslyckade moduldefinitioner
