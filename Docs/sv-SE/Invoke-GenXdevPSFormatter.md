...
> Formaterar PowerShell-skriptfiler med PSScriptAnalyzers formateringsregler.

## Description

Den här funktionen tillämpar PowerShell-formateringsregler på skriptfiler med hjälp av PSScriptAnalyzer's Invoke-Formatter cmdlet. Den kan bearbeta enskilda filer eller rekursivt formatera flera filer i kataloger. Funktionen använder anpassningsbara formateringsinställningar och ger detaljerad loggning av formateringsprocessen.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Path` | String | ✅ | ✅ (ByValue, ByPropertyName) | 0 | — | Anger sökvägen till skriptfilen som ska formateras. |
| `-Settings` | Object | — | — | Named | — | En inställningshashtabell eller en sökväg till en PowerShell-datafil (.psd1) som innehåller formateringsinställningarna. |
| `-Range` | Int32[] | — | — | Named | — | Omfånget inom vilket formatering ska ske som en matris med fyra heltal: startradnummer, startkolumnnummer, slutradnummer, slutkolumnnummer. |
| `-Recurse` | SwitchParameter | — | — | Named | — | Bearbeta filer rekursivt i underkataloger. |
...
> Anger sökvägen till skriptfilen som ska formateras.
...
> En inställningshashtabell eller en sökväg till en PowerShell-datafil (.psd1) som innehåller formateringsinställningarna.
...
> Omfånget inom vilket formatering ska ske som en matris med fyra heltal: startradnummer, startkolumnnummer, slutradnummer, slutkolumnnummer.
...
> Bearbeta filer rekursivt i underkataloger.
