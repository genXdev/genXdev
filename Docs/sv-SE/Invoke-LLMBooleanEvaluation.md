...
> Utvärderar ett påstående med hjälp av AI för att avgöra om det är sant eller falskt.

## Description

Denna funktion använder AI-modeller för att utvärdera påståenden och fastställa deras sanningsvärde. Den kan acceptera indata direkt via parametrar, från pipeline eller från systemets urklipp. Funktionen returnerar ett booleskt resultat tillsammans med konfidensnivå och resonemang från AI-modellen.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Text` | String | — | ✅ (ByValue) | 0 | — | Påståendet att utvärdera |
| `-Instructions` | String | — | — | 1 | `''` | Anvisningar för AI-modellen om hur uttalandet ska utvärderas |
...
| `-DontAddThoughtsToHistory` | SwitchParameter | — | — | Named | — | Tyvärr, jag kan inte översätta text som inte har angetts. Var god ange texten som ska översättas. |
...
| `-AllowDefaultTools` | SwitchParameter | — | — | Named | — | Tillåt AI att använda standardverktyg och funktioner |
...
Anger namnet på variabeln. Du kan inte använda specialtecken, inklusive blanksteg, eller reserverade objektnamn. Använd cmdleten Get-Item för att få en lista med giltiga variabelnamn.

.PARAMETER Value
Anger det ursprungliga värdet för variabeln.

.PARAMETER Description
Anger den beskrivning som används för variabeln. |
...
| `-TemperatureResponse` | Double | — | — | Named | — | Temperatur för svarsskapande |
| `-Language` | String | — | — | Named | — | swedish |
| `-CpuThreads` | Int32 | — | — | Named | — | Antal CPU-trådar som ska användas för bearbetning |
| `-SuppressRegex` | String | — | — | Named | — | Reguljärt uttryck att utelämna från utdata |
| `-AudioContextSize` | Int32 | — | — | Named | — | Ljudkontextstorlek för bearbetning |
| `-SilenceThreshold` | Double | — | — | Named | — | Ljudtröskel för ljuddetektering |
| `-LengthPenalty` | Double | — | — | Named | — | Längdstraff för sekvensgenerering |
| `-EntropyThreshold` | Double | — | — | Named | — | Utgångsfiltreringens entropitröskel |
| `-LogProbThreshold` | Double | — | — | Named | — | Tröskelvärde för log-sannolikhet vid utdatafiltrering |
| `-NoSpeechThreshold` | Double | — | — | Named | — | Ingen tröskel för ljuddetektering av tal |
| `-DontSpeak` | SwitchParameter | — | — | Named | — | Inaktivera talutmatning |
| `-DontSpeakThoughts` | SwitchParameter | — | — | Named | — | Inaktivera talutdata för tankar |
| `-NoVOX` | SwitchParameter | — | — | Named | — | Inaktivera VOX (röstaktivering) |
| `-UseDesktopAudioCapture` | SwitchParameter | — | — | Named | — | Använd skrivbordsljudinspelning som inmatning |
| `-NoContext` | SwitchParameter | — | — | Named | — | .PARAMETER ComputerName
Anger de datorer som ska övervakas från de definierade ResourcePools. |
| `-WithBeamSearchSamplingStrategy` | SwitchParameter | — | — | Named | — | Använd beam search-samplingsstrategi |
| `-OnlyResponses` | SwitchParameter | — | — | Named | — | Det här är ett exempel på en PowerShell-cmdlet-hjälptext som måste översättas till svenska. |
...
> Anvisningar för AI-modellen om hur uttalandet ska utvärderas
...
> Tyvärr, jag kan inte översätta text som inte har angetts. Var god ange texten som ska översättas.
...
> Tillåt AI att använda standardverktyg och funktioner
...
> Reguljärt uttryck att utelämna från utdata
...
> Ljudtröskel för ljuddetektering
...
> Använd skrivbordsljudinspelning som inmatning
...
> Det här är ett exempel på en PowerShell-cmdlet-hjälptext som måste översättas till svenska.
