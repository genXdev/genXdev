...
> Extraherar eller genererar en lista med relevanta strängar från inmatningstext med hjälp av AI-analys.

## Description

Denna funktion använder AI-modeller för att analysera inmatningstext och extrahera eller generera en lista med relevanta strängar. Den kan bearbeta text för att identifiera viktiga punkter, extrahera objekt från listor eller generera relaterade begrepp. Indata kan anges direkt via parametrar, från pipeline eller från systemets urklipp. Funktionen returnerar en strängmatris och kopierar eventuellt resultaten till urklipp.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Text` | String | — | ✅ (ByValue) | 0 | — | Texten att analysera och extrahera strängar från |
| `-Instructions` | String | — | — | 1 | `''` | @{response=Instruktioner för AI-modellen om hur man genererar stränglistan} |
...
| `-SetClipboard` | SwitchParameter | — | — | Named | — | Kopiera resultatet till Urklipp |
...
| `-AudioTemperature` | Double | — | — | Named | — | Temperatur för slumpmässighet i ljudsvar. |
| `-TemperatureResponse` | Double | — | — | Named | — | Temperatur för slumpmässighet i textrespons. |
| `-Language` | String | — | — | Named | — | Språkkod eller identifierare för svaret. |
...
| `-SilenceThreshold` | Double | — | — | Named | — | Tröskelvärde för tystnad vid ljuddetektering. |
...
| `-DontSpeakThoughts` | SwitchParameter | — | — | Named | — | Inaktivera talutmatning för tankar. |
...
> Texten att analysera och extrahera strängar från
...
> Temperatur för slumpmässighet i ljudsvar.
...
> Temperatur för slumpmässighet i textrespons.
...
> Språkkod eller identifierare för svaret.
...
> Tröskelvärde för tystnad vid ljuddetektering.
...
> Inaktivera talutmatning för tankar.
