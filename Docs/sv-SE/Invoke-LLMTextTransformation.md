...
> Omvandlar text med hjälp av AI-drivet bearbetning.

## Description

Denna funktion bearbetar inmatningstext med hjälp av AI-modeller för att utföra olika transformationer som stavningskontroll, lägga till emojis eller andra textförbättringar som specificeras genom instruktioner. Den kan acceptera indata direkt via parametrar, från pipeline eller från systemets urklipp.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Text` | String | — | ✅ (ByValue) | 0 | — | Den här kommandot avslutar den aktuella Windows PowerShell-sessionen. Om du använder PowerShell ISE (Integrated Scripting Environment) eller någon annan PowerShell-värd som stöder det, avslutas sessionen. Om du använder PowerShell-konsolen avslutas konsolfönstret. |
| `-Instructions` | String | — | — | 1 | `('Check and correct any spelling or grammar ' +
            'errors in the text. Return the corrected text without any ' +
            'additional comments or explanations.')` | Instruktioner för AI-modellen om hur texten ska omvandlas |
...
> Den här kommandot avslutar den aktuella Windows PowerShell-sessionen. Om du använder PowerShell ISE (Integrated Scripting Environment) eller någon annan PowerShell-värd som stöder det, avslutas sessionen. Om du använder PowerShell-konsolen avslutas konsolfönstret.
...
> Instruktioner för AI-modellen om hur texten ska omvandlas
