...
> Öppnar alla möjliga frågetyper för angivna söktermer eller URL:er.

## Description

Kör alla cmdlets som hanterar webbsidfrågor, bearbetar både webbadresser och söktermer. För webbadresser utför den platsspecifika frågor, och för söktermer utför den allmänna webbfrågor. Denna funktion upptäcker och kör dynamiskt alla tillgängliga fråge-cmdlets från GenXdev.Queries-modulfamiljen.
...
| `-ClearSession` | SwitchParameter | — | — | Named | — | Rensa webbläsarsessionen innan du öppnar. |
| `-SkipSession` | SwitchParameter | — | — | Named | — | Hoppa över återställning av webbläsarsession. |
...
Öppnar alla möjliga frågetyper för "powershell-skript" på standardmonitorn.
...
Öppnar alla möjliga frågetyper för GitHub-URL:en med alias och korta parametrar.
...
> Rensa webbläsarsessionen innan du öppnar.
...
> Hoppa över återställning av webbläsarsession.
...
- [ConvertTo-Uris](https://github.com/genXdev/genXdev/blob/main/Docs/sv-SE/ConvertTo-Uris.md)
