...
> Öppnar en Bing CoPilot-fråga i en webbläsare

## Description

Öppnar en Bing CoPilot-fråga i webbläsaren. Funktionen skriver automatiskt in frågan och skickar den med hjälp av den underliggande Open-WebsiteAndPerformQuery-funktionen. Detta ger ett bekvämt sätt att interagera med Microsoft Copilot från PowerShell.
...
| `-ShowWindow` | SwitchParameter | — | — | Named | — | Öppnas i fullskärmsläge |
...
| `-SessionOnly` | SwitchParameter | — | — | Named | — | Använd sessionsläge för webbläsarprofil. |
| `-ClearSession` | SwitchParameter | — | — | Named | — | Rensa webbläsarsession/profil innan du öppnar. |
| `-SkipSession` | SwitchParameter | — | — | Named | — | Hoppa över inläsning av webbläsarsession/profil. |
...
> Använd sessionsläge för webbläsarprofil.
...
> Rensa webbläsarsession/profil innan du öppnar.
...
> Hoppa över inläsning av webbläsarsession/profil.
...
- [Open-ChatGPTQuery](https://github.com/genXdev/genXdev/blob/main/Docs/sv-SE/Open-ChatGPTQuery.md)
- [Open-CloudLLMChat](https://github.com/genXdev/genXdev/blob/main/Docs/sv-SE/Open-CloudLLMChat.md)
- [Open-DeepSearchQuery](https://github.com/genXdev/genXdev/blob/main/Docs/sv-SE/Open-DeepSearchQuery.md)
- [Open-GithubCopilotQuery](https://github.com/genXdev/genXdev/blob/main/Docs/sv-SE/Open-GithubCopilotQuery.md)
- [Open-GoogleGeminiQuery](https://github.com/genXdev/genXdev/blob/main/Docs/sv-SE/Open-GoogleGeminiQuery.md)
- [Open-XGrokQuery](https://github.com/genXdev/genXdev/blob/main/Docs/sv-SE/Open-XGrokQuery.md)
