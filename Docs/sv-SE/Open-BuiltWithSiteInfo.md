...
> Öppnar BuiltWith webbplatsfrågor i en webbläsare.

## Description

Öppnar en BuiltWith-fråga i en webbläsare, med konfigurerbara monitorinställningar och
webbläsarbeteendealternativ. Funktionen analyserar webbplatsers teknikstackar genom att
fråga BuiltWith.coms teknikprofileringstjänst, som tillhandahåller detaljerad information
om webbteknologier, ramverk och tjänster som används av webbplatser.

BuiltWith.com är en omfattande teknikslagningstjänst som identifierar webbteknologier,
ramverk, innehållshanteringssystem, analysverktyg, webbhotell och andra programvarukomponenter
som används av en webbplats. Denna funktion tillhandahåller ett PowerShell-gränssnitt för att
snabbt analysera teknikstackar utan att manuellt navigera till BuiltWith-webbplatsen.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Queries` | String[] | ✅ | ✅ (ByValue, ByPropertyName) | 0 | — | Webbplats-URL:er eller domäner att efterfråga på BuiltWith.com |
| `-Language` | String | — | — | 1 | — | Språket för de returnerade sökresultaten |
| `-Monitor` | Int32 | — | — | 2 | `-1` | Övervakaren som ska användas, 0 = standard, -1 = kasta bort, -2 = Konfigurerad sekundär bildskärm, standard är -1, ingen positionering |
...
Öppnar en BuiltWith-teknologianalys för Microsoft.com på standardskärmen.
...
Analyserar Microsoft.com med pipeline-indata där monitorpositionering ignoreras.

## Parameter Details

### `-Queries <String[]>`

> Webbplats-URL:er eller domäner att efterfråga på BuiltWith.com
