...
> Öppnar ett gränssnitt för molnbaserad LLM-chatt för AI-frågor.

## Description

Denna funktion tillhandahåller ett enhetligt gränssnitt för att öppna olika molnbaserade AI-chattjänster i en webbläsare. Den stöder flera AI-plattformar inklusive ChatGPT, BingCopilot, Google Gemini, X Grok, DeepSearch och GitHub Copilot. Funktionen väljer automatiskt lämplig slutpunktsspecifik funktion och skickar vidare alla relevanta parametrar för webbläsarkonfiguration och fönsterplacering.
...
| `-EndPoint` | String | — | — | 1 | `'XGrok'` | Slutpunkten för att anropa frågan på |
...
Öppnar ChatGPT och skickar frågan om PowerShell-funktioner.
...
Använder aliaset för att fråga Google Gemini om maskininlärning.
...
Bearbetar flera frågor genom X Grok på standardmonitorn.
