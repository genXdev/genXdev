...
> Öppnar GenXdevs progressiva webbappskatalog i en webbläsare.

## Description

Öppnar katalogen med publicerade GenXdev progressiva webbappar i en webbläsare.
Öppnas i applikationsläge med helskärm aktiverad som standard för att ge en
optimal visningsupplevelse för katalogen. Stöder alla vanliga webbläsar-
konfigurationsalternativ inklusive placering av bildskärm, fönsterstorlek och
språkpreferenser.

Funktionen konfigurerar automatiskt webbläsaren för bästa katalogvisnings-
upplevelse och kan öppna flera webbläsarinstanser samtidigt. Den erbjuder
omfattande språkstöd och respekterar användarens preferenser för webbläsarval
och placering.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Language` | String | — | — | 0 | — | Språket för de returnerade sökresultaten |
...
| `-Monitor` | Int32 | — | — | Named | `-2` | Övervakaren som ska användas, 0 = standard, -1 = kasta bort, -2 = Konfigurerad sekundär bildskärm, standard är -1, ingen positionering |
| `-FullScreen` | SwitchParameter | — | — | Named | — | Öppnas i fullskärmsläge |
| `-ShowWindow` | SwitchParameter | — | — | Named | — | Visa webbläsarfönstret (inte minimerat eller dolt) |
...
Öppnar GenXdev-appkatalogen på bildskärm 1 i programläge med helskärmsläge aktiverat.
...
Öppnar GenXdev-appkatalogen på bildskärm 1 med hjälp av alias-kommandot.
...
> Visa webbläsarfönstret (inte minimerat eller dolt)
