...
> Öppnar en Google Gemini-fråga i en webbläsare

## Description

Öppnar en Google Gemini-fråga i webbläsaren, anger automatiskt frågan och skickar in den. Detta ger ett snabbt sätt att interagera med Googles Gemini AI. Funktionen stöder omfattande webbläsarkontroll inklusive val av skärm, fönsterplacering och tangentbordsautomationsfunktioner.
...
Öppnar Google Gemini och skickar frågan "Vad är PowerShell?".
...
Använder aliaset för att skicka en fråga om matriser via pipeline-indata.
