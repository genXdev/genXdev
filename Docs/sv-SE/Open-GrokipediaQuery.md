...
> Öppnar en Grokipedia-fråga i en webbläsare.

## Description

Öppnar en eller flera Grokipedia-sökfrågor i en webbläsare med omfattande konfigurationsalternativ. Stöder konfigurerbart webbläsarbeteende, val av bildskärm och fönsterpositionering. Frågor URL-kodas och öppnas med det angivna språkets Grokipedia-domän med full språkligt stöd.

Funktionen erbjuder omfattande webbläsarkontroll inklusive privat surfning, fönsterpositionering, tangentbordsautomatisering och stöd för flera bildskärmar. Den hanterar automatiskt URL-kodning och språkkodsmappning för internationella Grokipedia-domäner.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Queries` | String[] | ✅ | ✅ (ByValue, ByPropertyName) | 0 | — | Grokipedi-sökfrågan att utföra |
...
Öppnar en Grokipedia-sökning efter "PowerShell" på engelska på standardskärmen.
...
Öppnar en Grokipedia-sökning med aliaset via positionsparametrar.
...
Söker efter flera termer i Grokipedia med hjälp av privat surfläge.

## Parameter Details

### `-Queries <String[]>`

> Grokipedi-sökfrågan att utföra
