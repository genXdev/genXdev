...
> Öppnar en IMDB-sökfråga i en webbläsare.

## Description

Öppnar en "Internet Movie Database"-sökning i en webbläsare med omfattande konfigurationsalternativ. Denna funktion utgör ett praktiskt omslag för IMDB:s sökfunktion, vilket gör det möjligt för användare att söka efter filmer, TV-program, skådespelare och annat underhållningsinnehåll direkt från PowerShell.

Funktionen accepterar söktermer och konstruerar korrekta IMDB-sök-URL:er, som sedan öppnas i den angivna webbläsaren med möjlighet att anpassa fönsterplacering, webbläsarval och visningsalternativ. Den stöder alla större webbläsare inklusive Edge, Chrome och Firefox, med alternativ för privat surfning, helskärmsläge och fönsterhantering.

Viktiga funktioner inkluderar stöd för flera skärmar, språklokalisering, tangentbordsautomation och omfattande webbläsarkonfigurationsalternativ. Funktionen kan hantera flera sökfrågor samtidigt och erbjuder alternativ för både interaktiv användning och automatiserade arbetsflöden.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Queries` | String[] | ✅ | ✅ (ByValue, ByPropertyName) | 0 | — | Söktermerna att fråga på IMDB |
...
| `-DisablePopupBlocker` | SwitchParameter | — | — | Named | — | Inaktiverar webbläsarens popup-blockeringsfunktion |
...
| `-SendKeyEscape` | SwitchParameter | — | — | Named | — | Escaperar kontrolltecken när tangenttryckningar skickas till webbläsaren |
| `-SendKeyHoldKeyboardFocus` | SwitchParameter | — | — | Named | — | Förhindrar att tangentbordsfokus återgår till PowerShell efter att tangenttryckningar har skickats. |
| `-SendKeyUseShiftEnter` | SwitchParameter | — | — | Named | — | Använder Shift+Enter istället för vanlig Enter för radbrytningar när tangenttryckningar skickas |
...
Öppnar en IMDB-sökning för "The Matrix" på standardmonitorn.
...
Öppnar en IMDB-sökning för "The Matrix" med alias- och genvägsparametrarna.
...
Söker efter flera filmer på IMDB med franska språkresultat i Chrome.
...
Söker efter Tom Hanks på IMDB i fullskärmsläge, återför sedan fokus till PowerShell.

## Parameter Details

### `-Queries <String[]>`

> Söktermerna att fråga på IMDB
...
> Inaktiverar webbläsarens popup-blockeringsfunktion
...
> Escaperar kontrolltecken när tangenttryckningar skickas till webbläsaren
...
> Förhindrar att tangentbordsfokus återgår till PowerShell efter att tangenttryckningar har skickats.
...
> Använder Shift+Enter istället för vanlig Enter för radbrytningar när tangenttryckningar skickas
