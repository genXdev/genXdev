...
> Öppnar förfrågningar för Instant Street View i en webbläsare.

## Description

Öppnar InstantStreetView-frågor på ett konfigurerbart sätt med hjälp av webbläsarens kommandoradsväxlar. Stöder flera frågor och val av bildskärm. Ger omfattande webbläsarkontroll inklusive fönsterplacering, språkinställningar och webbläsarspecifika funktioner.

Funktionen konstruerar automatiskt InstantStreetView-URL:er genom att URL-koda platsfrågor och öppna dem i den angivna webbläsaren. Stöder alla större webbläsare inklusive Edge, Chrome och Firefox med omfattande anpassningsalternativ.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Queries` | String[] | ✅ | ✅ (ByValue, ByPropertyName) | 0 | — | Platsförfrågningarna att visa i InstantStreetView |
...
Öppnar InstantStreetView för Times Square i standardwebbläsaren på den primära skärmen.
...
Öppnar InstantStreetView för Eiffeltornet med aliaset 'isv' och visar på den sekundära skärmen.
...
Öppnar InstantStreetView för Big Ben på engelska med privat surfningsläge.
...
Öppnar flera InstantStreetView-frågor via pipeline i Chrome-webbläsaren placerade på vänster sida av skärmen.

## Parameter Details

### `-Queries <String[]>`

> Platsförfrågningarna att visa i InstantStreetView
