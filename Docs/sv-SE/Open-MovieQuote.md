...
> Öppnar en video av ett filmcitat i en webbläsare.

## Description

Söker efter och öppnar filmcitat med playphrase.me, vilket möjliggör specifikation
av bildskärms- och webbläsarinställningar. Denna funktion ger tillgång till en omfattande
databas med filmcitat med videoklipp, som stöder flera språk och
avancerade webbläsarkonfigurationsalternativ.

Huvudfunktioner:
- Sök filmcitat från en omfattande databas
- Flerspråksstöd med automatisk språkdetektering
- Avancerad webbläsarpositionering och fönsterhantering
- Stöd för flera webbläsare (Edge, Chrome, Firefox)
- Stöd för privat surfning
- Tangentbordsautomatisering för webbläsarinteraktion
- Stöd för flera bildskärmar med exakt positionering
...
Öppnar en sökning efter det berömda Terminator-citatet "I'll be back".
...
Öppnar en sökning efter Casablanca-citatet på bildskärm 1.
...
Öppnar en sökning efter Star Wars-citatet på engelska med privat surfläge.
...
Öppnar flera sökningar efter filmcitat i Chromes fullskärmsläge via pipeline.
