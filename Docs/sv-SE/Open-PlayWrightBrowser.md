...
> Startar en Playwright-hanterad webbläsare med en beständig användarprofil.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-BrowserType` | String | — | — | 0 | `'ChromiumNormal'` | Webbläsare att starta: Chrome, Edge, Chromium (identifierar automatiskt Chrome eller Edge), Firefox eller WebKit |
| `-Headless` | SwitchParameter | — | — | Named | — | Kör webbläsaren utan ett synligt fönster |
| `-Proxy` | String | — | — | Named | — | URL för proxyserver (t.ex. http://proxy:8080) |
| `-AcceptLang` | String | — | — | Named | — | Ställ in webbläsarens Accept-Language HTTP-huvud |
| `-Width` | Int32 | — | — | Named | `-1` | Inledande visningsportsbredd i pixlar |
| `-Height` | Int32 | — | — | Named | `-1` | Inledande visningsports höjd i pixlar |
| `-Force` | SwitchParameter | — | — | Named | — | Stäng befintlig webbläsare och starta om från början. |
...
| `-Fullscreen` | SwitchParameter | — | — | Named | — | Maximerar fönstret så att det fyller hela skärmen |
...
| `-PassThru` | SwitchParameter | — | — | Named | — | Returnerar ett fönsterhjälpobjekt för vidare manipulation. |
...
> Webbläsare att starta: Chrome, Edge, Chromium (identifierar automatiskt Chrome eller Edge), Firefox eller WebKit
...
> URL för proxyserver (t.ex. http://proxy:8080)
...
> Ställ in webbläsarens Accept-Language HTTP-huvud
...
> Inledande visningsportsbredd i pixlar
...
> Inledande visningsports höjd i pixlar
...
> Stäng befintlig webbläsare och starta om från början.
...
> Maximerar fönstret så att det fyller hela skärmen
...
> Returnerar ett fönsterhjälpobjekt för vidare manipulation.
