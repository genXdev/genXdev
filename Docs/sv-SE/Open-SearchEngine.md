...
> Öppnar en sökfråga i den angivna sökmotorn med hjälp av en webbläsare.

## Description

Den här funktionen tillhandahåller ett enhetligt gränssnitt för att söka över flera sökmotorer inklusive Google, Bing, GitHub, Wikipedia, YouTube och andra. Den stöder omfattande alternativ för webbläsarkonfiguration inklusive fönsterpositionering, storlek, webbläsarval och språkinställningar. Funktionen dirigerar dynamiskt frågor till lämpliga sökmotorspecifika funktioner.
...
| `-EndPoint` | String | — | — | 1 | `'Google'` | Slutpunkten för att anropa frågan på |
| `-Language` | String | — | — | 2 | — | Språket för de returnerade sökresultaten |
| `-Monitor` | Int32 | — | — | 3 | `-1` | Övervakaren som ska användas, 0 = standard, -1 = kasta bort, -2 = Konfigurerad sekundär bildskärm, standard är -1, ingen positionering |
...
Söker efter "PowerShell cmdlets" på Google med engelska språkresultat.
...
Använder aliaset 'q' för att söka efter 'GitHub PowerShell' på Bing med Chrome i privat läge.
...
> Slutpunkten för att anropa frågan på
