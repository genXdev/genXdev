...
> Öppnar en webbläsare för att söka efter texten till den för närvarande spelande VLC-median.

## Description

Denna funktion upptäcker om VLC Media Player körs och söker efter låttexter baserat på den för närvarande spelade medietiteln. Den öppnar automatiskt en sökfråga i en webbläsare för att hitta låttexter för det aktuella spåret. Funktionen stöder flera webbläsare och erbjuder omfattande alternativ för fönsterplacering och visning.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Queries` | String[] | — | ✅ (ByValue, ByPropertyName) 🌐 Remaining | 0 | — | Söktermer för att hitta ett spår |
...
| `-SessionOnly` | SwitchParameter | — | — | Named | — | Använd en session som inte sparas efter att du stängt webbläsaren |
| `-ClearSession` | SwitchParameter | — | — | Named | — | Rensa webbläsarsessionsdata innan du öppnar webbläsaren |
| `-SkipSession` | SwitchParameter | — | — | Named | — | Hoppa över att använda någon befintlig webbläsarsession |
...
Öppnar en Googlesökning efter texten till den aktuella VLC-media som spelas.
...
Öppnar sökning efter låttexter i Microsoft Edge med privat/inkognitoläge.

## Parameter Details

### `-Queries <String[]>`

> Söktermer för att hitta ett spår
...
> Använd en session som inte sparas efter att du stängt webbläsaren
...
> Rensa webbläsarsessionsdata innan du öppnar webbläsaren
...
> Hoppa över att använda någon befintlig webbläsarsession
