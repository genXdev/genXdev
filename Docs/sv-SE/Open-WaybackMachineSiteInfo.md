...
> Öppnar WayBackMachine-webbplatsinformation i en webbläsare.

## Description

Öppnar en Waybackmachine-fråga i en webbläsare och visar historiska versioner av den angivna URL:en eller webbplatsen. Stöder flera frågor och monitorval. Ger tillgång till arkiverat webbinnehåll via Internet Archives Wayback Machine-tjänst.
...
| `-Language` | String | — | — | 1 | — | Språkpreferensen för webbläsargränssnitt och innehåll |
...
| `-SessionOnly` | SwitchParameter | — | — | Named | — | Använd alternativa inställningar som lagras i sessionen för Wayback Machine-inställningar |
| `-ClearSession` | SwitchParameter | — | — | Named | — | Rensa alternativa inställningar som lagrats i sessionen för Wayback Machine-inställningar |
...
Öppnar Wayback Machine-arkivet för example.com på standardmonitorn.
...
Öppnar Wayback Machine-arkivet för example.com med alias, där monitorpositionering kasseras.
...
Öppnar Wayback Machine-arkivet för microsoft.com i Chromes inkognitoläge.
...
> Språkpreferensen för webbläsargränssnitt och innehåll
...
> Använd alternativa inställningar som lagras i sessionen för Wayback Machine-inställningar
...
> Rensa alternativa inställningar som lagrats i sessionen för Wayback Machine-inställningar
