...
> Startar ett nytt webbläsarfönster med specifik positionering.

## Description

Öppnar ett nytt webbläsarfönster (Edge eller Chrome) placerat på höger sida av den primära bildskärmen i bakgrundsläge.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Url` | String[] | — | ✅ (ByValue) | 0 | — | Webbadresserna som ska öppnas i webbläsaren |
