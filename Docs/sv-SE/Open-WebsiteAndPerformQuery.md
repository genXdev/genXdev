...
> Öppnar en webbsida i en webbläsare och utför en eller flera frågor.

## Description

Denna funktion öppnar en webbplats med URL-adress i standardwebbläsaren, anger en eller flera frågor och skickar in dem. Den har omfattande valmöjligheter för övervakning och alternativ för fönsterpositionering via den underliggande funktionen Open-Webbrowser.

Funktionen kopierar automatiskt varje fråga till urklipp och skickar den till webbläsarfönstret med hjälp av tangentbordsautomatisering. Den bevarar det ursprungliga urklippsinnehållet och återställer det efter att alla frågor har bearbetats.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Url` | String | ✅ | ✅ (ByPropertyName) | 0 | — | Webbplatsens URL att öppna |
| `-Queries` | String[] | ✅ | ✅ (ByValue, ByPropertyName) | 1 | — | Frågan att utföra. |
...
| `-SendKeyDelayMilliSeconds` | Int32 | — | — | Named | `500` | Fördröjning mellan att skicka olika tangentsekvenser i millisekunder |
...
Öppnar Google och söker efter "PowerShell".
...
Öppnar Google och söker efter 'PowerShell-tutorials' på standardskärmen.

## Parameter Details

### `-Url <String>`

> Webbplatsens URL att öppna
