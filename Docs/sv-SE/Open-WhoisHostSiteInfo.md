...
> Öppnar en Whois-värdinformationsfråga i en webbläsare.

## Description

Öppnar Whois-värdinformationsfrågor i en webbläsare för domännamn eller IP-adresser. Stöder konfigurerbart monitorval och flera frågor med omfattande webbläsarkonfigurationsalternativ inklusive fönsterpositionering, webbläsarval och automationsfunktioner.
...
| `-SessionOnly` | SwitchParameter | — | — | Named | — | Använd alternativa inställningar som lagras i sessionen för AI-preferenser som språk, bildsamlingar, etc. |
| `-ClearSession` | SwitchParameter | — | — | Named | — | Rensa alternativa inställningar lagrade i sessionen för AI-preferenser som språk, bildsamlingar, etc. |
| `-SkipSession` | SwitchParameter | — | — | Named | — | Lagra endast inställningar i beständiga preferenser utan att påverka sessionen för AI-preferenser som språk, bildsamlingar etc. |
...
Öppnar Whois-information för flera domäner på standardmonitorn.
...
Öppnar Whois-information för example.com med alias och positionsparametrar.
...
Öppnar Whois-information för domäner från pipeline i Chromes privata läge.
...
> Använd alternativa inställningar som lagras i sessionen för AI-preferenser som språk, bildsamlingar, etc.
...
> Rensa alternativa inställningar lagrade i sessionen för AI-preferenser som språk, bildsamlingar, etc.
...
> Lagra endast inställningar i beständiga preferenser utan att påverka sessionen för AI-preferenser som språk, bildsamlingar etc.
