...
> Öppnar nederländska Wikipedia-sökningar i en webbläsare.

## Description

Öppnar en 'Wikipedia - Nederländerna'-fråga i en webbläsare, med konfigurerbara visningsalternativ. Stöder sökning av flera termer och anger på vilken bildskärm resultaten ska visas.
...
| `-SideBySide` | SwitchParameter | — | — | Named | — | Öppnar två webbläsarfönster sida vid sida |
| `-SessionOnly` | SwitchParameter | — | — | Named | — | Använd sessionscookies (inga beständiga cookies) |
| `-ClearSession` | SwitchParameter | — | — | Named | — | Rensa webbläsarsessionsdata före öppning |
| `-SkipSession` | SwitchParameter | — | — | Named | — | Hoppa över att återställa föregående webbläsarsession |
...
> Öppnar två webbläsarfönster sida vid sida
...
> Använd sessionscookies (inga beständiga cookies)
...
> Rensa webbläsarsessionsdata före öppning
...
> Hoppa över att återställa föregående webbläsarsession
