...
> Öppnar en Wikipedia-fråga i en webbläsare.

## Description

Öppnar en eller flera Wikipedia-sökfrågor i en webbläsare med omfattande konfigurationsalternativ. Stöder konfigurerbart webbläsarbeteende, monitorval och fönsterpositionering. Frågor är URL-kodade och öppnas med det angivna språkets Wikipedia-domän med fullt lokaliseringsstöd.

Funktionen erbjuder omfattande webbläsarkontroll inklusive privat surfläge, fönsterpositionering, tangentbordsautomatisering och stöd för flera skärmar. Den hanterar automatiskt URL-kodning och språkkodsmappning för internationella Wikipedia-domäner.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Queries` | String[] | ✅ | ✅ (ByValue, ByPropertyName) | 0 | — | Sökfrågan för Wikipedia som ska utföras |
| `-Language` | String | — | — | 1 | — | Språket i Wikipedia-sökresultaten |
...
| `-PassThru` | SwitchParameter | — | — | Named | — | Returnerar ett PowerShell-processobjekt som representerar webbläsarprocessen |
...
| `-SessionOnly` | SwitchParameter | — | — | Named | — | Använd alternativa inställningar lagrade i sessionen för AI-preferenser. |
| `-ClearSession` | SwitchParameter | — | — | Named | — | Rensa alternativa inställningar som lagras i sessionen för AI-preferenser. |
| `-SkipSession` | SwitchParameter | — | — | Named | — | Lagra inställningar endast i beständiga preferenser utan att påverka sessionen. |
...
Öppnar en Wikipedia-sökning efter "PowerShell" på engelska på standardskärmen.
...
Öppnar en Wikipedia-sökning med aliaset med positionsparametrar.
...
Söker efter flera termer i tyska Wikipedia med privat surfläge.

## Parameter Details

### `-Queries <String[]>`

> Sökfrågan för Wikipedia som ska utföras
...
> Språket i Wikipedia-sökresultaten
...
> Returnerar ett PowerShell-processobjekt som representerar webbläsarprocessen
...
> Använd alternativa inställningar lagrade i sessionen för AI-preferenser.
...
> Rensa alternativa inställningar som lagras i sessionen för AI-preferenser.
