...
> Öppnar en Wolfram Alpha-fråga i en webbläsare.

## Description

Öppnar en eller flera Wolfram Alpha-frågor i en webbläsare. Stödjer konfigurerbar
monitorväljning och webbläsaralternativ genom dynamiska parametrar. Ger
omfattande webbläsarkontroll inklusive positionering, storleksändring och automationsmöjligheter för förbättrade vetenskapliga beräkningsarbetsflöden.
...
| `-SendKeyHoldKeyboardFocus` | SwitchParameter | — | — | Named | — | Förhindra att tangentbordsfokuset återgår till PowerShell efter att ha skickat tangenter. |
| `-SendKeyUseShiftEnter` | SwitchParameter | — | — | Named | — | Skicka Shift+Enter istället för vanlig Enter för radbrytningar när du skickar tangenter. |
...
Öppnar en Wolfram Alpha-fråga om solens massa på standardskärmen.
...
Öppnar flera Wolfram Alpha-frågor med aliaset för snabba vetenskapliga beräkningar.
...
Öppnar en kalkylfråga i helskärmsläge med engelska språkinställningar via pipeline-indata.
...
> Skicka Shift+Enter istället för vanlig Enter för radbrytningar när du skickar tangenter.
