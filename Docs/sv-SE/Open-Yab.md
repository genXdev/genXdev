...
> Öppnar YAB-spelet i en webbläsare med konfigurerbara inställningar.

## Description

Öppnar YAB-spelwebbplatsen i en angiven webbläsare med olika visnings- och beteendealternativ. Stöder olika spellägen inklusive åskådarläge. YAB-spelet är ett online-pusselspel som kan spelas interaktivt eller betraktas i åskådarläge där AI spelar automatiskt.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Language` | String | — | — | 0 | — | Spelets gränssnittsspråk |
...
Öppnar YAB-spelet i åskådarläge med Chrome-webbläsaren utan fullskärm, med engelskt gränssnitt.
...
Öppnar YAB-spelet i Edge-webbläsaren med privat surfning på bildskärm 2 med hjälp av alias för snabb åtkomst.

## Parameter Details

### `-Language <String>`

> Spelets gränssnittsspråk
