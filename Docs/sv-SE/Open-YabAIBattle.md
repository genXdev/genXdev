...
> Öppnar YabAI Battle-spelet i en webbläsare.
...
| `-SendKeyDelayMilliSeconds` | Int32 | — | — | Named | — | Fördröjning i millisekunder mellan sändning av varje tangent. |
...
| `-RestoreFocus` | SwitchParameter | — | — | Named | — | Återställ fokus till föregående fönster efter att ha öppnat webbläsaren. |
...
Öppnar YabAI Battle-spelet i Microsoft Edge med privat surfningsläge utan helskärm.
...
Öppnar spelet med alias för Edge, inkognitoläge och utan fullskärm.
...
Öppnar spelet i åskådarläge med Google Chrome för att titta på AI-strider.
...
Öppnar spelet med spanskt gränssnitt placerat på vänster sida av skärm 1.
...
> Fördröjning i millisekunder mellan sändning av varje tangent.
...
> Återställ fokus till föregående fönster efter att ha öppnat webbläsaren.
