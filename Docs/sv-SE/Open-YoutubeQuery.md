...
> Öppnar YouTube-sökfrågor i en webbläsare.

## Description

Öppnar en eller flera YouTube-sökfrågor i en webbläsare med omfattande
positionerings- och konfigurationsalternativ. Stöder konfigurerbar skärmval,
webbläsarinställningar och tangentautomation via dynamiska parametrar som ärvts
från Open-Webbrowser-cmdleten. Varje fråga öppnas i en separat webbläsarinstans
med full kontroll över fönsterpositionering, webbläsartyp och sökspråk.
...
Öppnar en YouTube-sökning efter 'PowerShell tutorial' på standardmonitorn.
...
Öppnar en YouTube-sökning efter 'how to code' på den konfigurerade sekundära skärmen med hjälp av funktionsaliaset.
