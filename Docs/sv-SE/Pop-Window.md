...
> Tar bort den senaste aktiva fönsterhjälpen från stacken med valfria ändringar.

## Description

Tar bort ett fönsterhjälpobjekt från stacken och tillämpar eventuellt fönstertransformationer. Om stacken är tom eller innehåller ogiltiga fönster returneras det för närvarande fokuserade fönstret. Denna funktion låter dig manipulera fönster som tidigare sparats med Push-Window, genom att tillämpa olika positionering, storleksändring och visuella effekter.
