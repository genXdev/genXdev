...
> Tar rekursivt bort allt innehåll från en katalog med avancerad felhantering.

## Description

Tar säkert bort alla filer och underkataloger i en angiven katalog med hjälp av en omvänd ordningsstrategi för att hantera djupa sökvägar. Innehåller stöd för WhatIf, utförlig loggning och alternativa borttagningsmetoder för låsta filer.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Path` | String | ✅ | ✅ (ByValue, ByPropertyName) | 0 | — | Sökvägen till katalogen som ska rensas |
| `-DeleteFolder` | SwitchParameter | — | — | Named | — | Ta även bort rotmappen som anges med parametern Path |
...
> Sökvägen till katalogen som ska rensas
...
> Ta även bort rotmappen som anges med parametern Path
