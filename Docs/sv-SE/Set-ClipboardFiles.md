...
> Sätter filer till Windows urklipp för filoperationer som kopiera/klistra in.

## Description

Denna funktion kopierar en eller flera filsökvägar till Windows urklipp,
så att filoperationer som klistra in i Windows Utforskaren möjliggörs. Den hanterar
både STA- och MTA-trådningslägen automatiskt, vilket säkerställer kompatibilitet i
olika PowerShell-körningskontexter. Funktionen validerar att filer finns
innan de lägger till sökvägar i urklipp.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-InputObject` | String[] | ✅ | ✅ (ByValue, ByPropertyName) | 0 | — | Matris av filvägar att lägga till i urklipp |
...
> Matris av filvägar att lägga till i urklipp
