...
> Navigerar upp tre katalognivåer i filsystemshierarkin.

## Description

Ändrar den aktuella arbetskatalogen genom att flytta upp tre föräldrakataloger i filsystemets hierarki.
Visar innehållet i den resulterande katalogen.
...
Navigerar upp tre katalognivåer från den aktuella platsen.
...
Använder aliaset för att navigera upp tre katalognivåer.
