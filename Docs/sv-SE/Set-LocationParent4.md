...
> Navigerar upp fyra katalognivåer i filsystemets hierarki.

## Description

* Flyttar upp fyra katalognivåer från den aktuella platsen i
  filsystemet.
* Efter navigering visas innehållet i den resulterande katalogen.
...
Navigerar upp fyra katalognivåer från den aktuella platsen.
...
Använder aliaset för att navigera upp fyra katalognivåer.
