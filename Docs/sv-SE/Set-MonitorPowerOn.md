...
> Aktiverar bildskärmens ström.

## Description

Använder Windows API via GenXdev.Helpers.WindowObj för att väcka skärmen från viloläge/avstängt läge. Detta är användbart för automatiseringsskript som behöver säkerställa att skärmen är påslagen.
...
Slår på bildskärmens ström med hjälp av ett alias.
