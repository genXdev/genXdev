...
> Konfigurerar justering av aktivitetsfältet i Windows 11+ mellan centrerad och vänster position.

## Description

Ställer in aktivitetsfältets justering i Windows 11 och nyare versioner genom att ändra registernyckeln 'TaskbarAl' under HKCU:\SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer\Advanced. Justeringen kan ställas in på antingen centrerad (värde 1) eller vänster (värde 0).
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Justify` | String | ✅ | — | 0 | — | Aktivitetsfältets justering (Centrerad eller Vänster) |
...
> Aktivitetsfältets justering (Centrerad eller Vänster)
