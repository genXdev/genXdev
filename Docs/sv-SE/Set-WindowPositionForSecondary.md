...
> @{response=Placerar ett fönster på den sekundära skärmen med angivna layoutalternativ.}

## Description

Denna funktion möjliggör placering av fönster på en konfigurerad sekundär bildskärm med hjälp av
Set-WindowPosition med olika layoutalternativ inklusive justering, storlek och
kantinställningar. Den hanterar bildskärmsval baserat på global konfiguration och
tillhandahåller en praktisk omslutningsfunktion för fönsterplacering på sekundär bildskärm.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Process` | Diagnostics.Process[] | — | ✅ (ByValue, ByPropertyName) | 0 | — | Fönsterpositioneringsprocessen |
| `-Monitor` | Int32 | — | — | Named | `-2` | Övervakaren som ska användas, 0=standard, -1=ignorera, -2=konfigurerad |
| `-Width` | Int32 | — | — | Named | `-1` | Fönstrets initiala bredd |
| `-Height` | Int32 | — | — | Named | `-1` | Fönstrets initialhöjd |
| `-X` | Int32 | — | — | Named | `-999999` | Fönstrets ursprungliga X-position |
| `-Y` | Int32 | — | — | Named | `-999999` | Fönstrets ursprungliga Y-position |
...
| `-FocusWindow` | SwitchParameter | — | — | Named | — | Fokusera fönstret efter positionering |
| `-SetForeground` | SwitchParameter | — | — | Named | — | Ställ fönstret i förgrunden efter positionering |
...
| `-KeysToSend` | String[] | — | — | Named | — | Tangenttryckningar att skicka till fönstret efter positionering |
...
| `-PassThru` | SwitchParameter | — | — | Named | — | Returnerar processobjektet efter positionering |
| `-SideBySide` | SwitchParameter | — | — | Named | — | Placera fönstret sida vid sida med PowerShell på samma bildskärm |
...
> Fönsterpositioneringsprocessen
...
> Övervakaren som ska användas, 0=standard, -1=ignorera, -2=konfigurerad
...
> Fokusera fönstret efter positionering
...
> Ställ fönstret i förgrunden efter positionering
...
> Tangenttryckningar att skicka till fönstret efter positionering
...
> Returnerar processobjektet efter positionering
...
> Placera fönstret sida vid sida med PowerShell på samma bildskärm
