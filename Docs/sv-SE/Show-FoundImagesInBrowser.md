...
> Visar bildsökresultat i ett murverkslayoutwebbgalleri.

## Description

Tar bildsökresultat och visar dem i en webbläsarbaserad murverkslayout.
Kan fungera i interaktivt läge med redigerings- och borttagningsfunktioner, eller i enkelt
visningsläge. Accepterar bilddataobjekt som vanligtvis kommer från Find-Image och renderar
dem med hover-verktygstips som visar metadata som ansiktsigenkänning, objektdetektering
och scenklassificeringsdata.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-InputObject` | Object[] | — | ✅ (ByValue) | 0 | `@()` | Bilddataobjekt som ska visas i galleriet. |
| `-Interactive` | SwitchParameter | — | — | Named | — | Ansluter till webbläsaren och lägger till ytterligare knappar som Redigera och Ta bort |
| `-Title` | String | — | — | Named | `'Photo Gallery'` | Titel för galleriet |
| `-Description` | String | — | — | Named | `('Hover over images to see face recognition ' +
            'and object detection data')` | Hovra över bilder för att se ansiktsigenkänning och objektdetekteringsdata |
...
| `-NewWindow` | SwitchParameter | — | — | Named | — | Skapa ett nytt webbläsarfönster istället för att återanvända det befintliga. |
| `-OnlyReturnHtml` | SwitchParameter | — | — | Named | — | <html><body><p>Detta är ett test.</p></body></html> |
| `-EmbedImages` | SwitchParameter | — | — | Named | — | Bädda in bilder som base64-data-URL:er istället för file://-URL:er för bättre portabilitet. |
| `-ShowOnlyPictures` | SwitchParameter | — | — | Named | — | Visa endast bilder i en rundad rektangel, ingen text under. |
...
| `-PassThru` | SwitchParameter | — | — | Named | — | Returnera webbläsarfönstrets hjälpobjekt för vidare hantering |
...
> Bilddataobjekt som ska visas i galleriet.
...
> Ansluter till webbläsaren och lägger till ytterligare knappar som Redigera och Ta bort
...
> Hovra över bilder för att se ansiktsigenkänning och objektdetekteringsdata
...
> Skapa ett nytt webbläsarfönster istället för att återanvända det befintliga.
...
> <html><body><p>Detta är ett test.</p></body></html>
...
> Bädda in bilder som base64-data-URL:er istället för file://-URL:er för bättre portabilitet.
...
> Visa endast bilder i en rundad rektangel, ingen text under.
...
> Returnera webbläsarfönstrets hjälpobjekt för vidare hantering
