...
> Visar en kort alfabetisk lista över alla PowerShell-verb.

## Description

Visar PowerShell-godkända verb i en kommaseparerad lista. Om specifika verb anges som indata visas endast matchande verb. Stöder jokertecken.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Verb` | String[] | — | ✅ (ByValue, ByPropertyName) | 0 | `@()` | Ett eller flera verbmönster att filtrera (stöder jokertecken) 🌐 *Supports wildcards* |
...
> Ett eller flera verbmönster att filtrera (stöder jokertecken)
