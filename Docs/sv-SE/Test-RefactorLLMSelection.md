...
> Utvärderar källfiler för omfaktoreringsberättigande med hjälp av LLM-analys.

## Description

Använder analys med Språkinlärningsmodell (LLM) för att avgöra om en källkodsfil
bör väljas för omstrukturering baserat på specificerade kriterier. Funktionen
bearbetar filinnehållet genom en LLM-fråga och returnerar ett booleskt svar.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-RefactorDefinition` | GenXdev.Helpers.RefactorDefinition | ✅ | — | 0 | — | Omdefinieringen av definition som innehåller LLM-inställningar |
| `-Path` | String | ✅ | — | 1 | — | Sökvägen till källfilen som ska utvärderas |
...
> Omdefinieringen av definition som innehåller LLM-inställningar
...
> Sökvägen till källfilen som ska utvärderas
