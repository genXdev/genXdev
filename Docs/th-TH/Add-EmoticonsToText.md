...
> ปรับปรุงข้อความโดยเพิ่มอิโมจิที่เหมาะสมกับบริบทโดยใช้ AI

## Description

ฟังก์ชันนี้ประมวลผลข้อความที่ป้อนเข้าเพื่อเพิ่มอิโมติคอนที่สอดคล้องกับบริบททางอารมณ์ สามารถรับข้อมูลเข้าได้โดยตรงผ่านพารามิเตอร์ จากไปป์ไลน์ หรือจากคลิปบอร์ดของระบบ ฟังก์ชันใช้ประโยชน์จากโมเดล AI เพื่อวิเคราะห์ข้อความและเลือกอิโมติคอนที่เหมาะสม ทำให้ข้อความมีความหมายและน่าสนใจยิ่งขึ้น
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Text` | String | — | ✅ (ByValue) | 0 | — | ข้อความที่จะเพิ่มอิโมติคอน |
