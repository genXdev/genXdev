...
> เพิ่มรายการไอเดียไปยังไฟล์ README.md

## Description

เพิ่มความคิดที่ประทับเวลาลงในส่วน "## Ideas" ของไฟล์ README.md สามารถแสดงส่วนที่แก้ไขและเปิดใน Visual Studio Code
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Line` | String | — | — | 0 | `''` | ข้อความไอเดียที่จะเพิ่ม |
