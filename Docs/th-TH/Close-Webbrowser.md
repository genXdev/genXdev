...
> ปิดอินสแตนซ์ของเว็บเบราว์เซอร์หนึ่งรายการขึ้นไปแบบเลือกได้

## Description

ให้การควบคุมแบบละเอียดในการปิดอินสแตนซ์ของเว็บเบราว์เซอร์ สามารถกำหนดเป้าหมายไปที่เบราว์เซอร์เฉพาะ (Edge, Chrome, Firefox) หรือปิดเบราว์เซอร์ทั้งหมด รองรับการปิดทั้งหน้าต่างหลักและกระบวนการพื้นหลัง
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Edge` | SwitchParameter | — | — | Named | — | ปิดอินสแตนซ์เบราว์เซอร์ Microsoft Edge *(Parameter set: )* |
| `-Chrome` | SwitchParameter | — | — | Named | — | ปิดอินสแตนซ์ของเบราว์เซอร์ Google Chrome *(Parameter set: )* |
| `-Chromium` | SwitchParameter | — | — | Named | — | ปิดเบราว์เซอร์ที่ใช้ Chromium เป็นค่าเริ่มต้น *(Parameter set: )* |
| `-Firefox` | SwitchParameter | — | — | Named | — | ปิดอินสแตนซ์ของเบราว์เซอร์ Firefox *(Parameter set: )* |
...
| `-IncludeBackgroundProcesses` | SwitchParameter | — | — | Named | — | ปิดอินสแตนซ์ทั้งหมดรวมถึงงานเบื้องหลัง |
...
> ปิดอินสแตนซ์เบราว์เซอร์ Microsoft Edge
...
> ปิดอินสแตนซ์ของเบราว์เซอร์ Google Chrome
...
> ปิดเบราว์เซอร์ที่ใช้ Chromium เป็นค่าเริ่มต้น
...
> ปิดอินสแตนซ์ของเบราว์เซอร์ Firefox
...
> ปิดอินสแตนซ์ทั้งหมดรวมถึงงานเบื้องหลัง
