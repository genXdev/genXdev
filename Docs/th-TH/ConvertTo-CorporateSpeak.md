...
> แปลงข้อความที่ตรงไปตรงมาหรือหยาบคายเป็นภาษาธุรกิจที่สุภาพและเป็นมืออาชีพโดยใช้ AI

## Description

ฟังก์ชันนี้ประมวลผลข้อความที่ป้อนเข้าเพื่อเปลี่ยนภาษาที่ตรงไปตรงมาหรือรุนแรงให้เป็นการสื่อสารในองค์กรแบบนักการทูตและมืออาชีพ สามารถรับอินพุตโดยตรงผ่านพารามิเตอร์ จากไปป์ไลน์ หรือจากคลิปบอร์ดของระบบ ฟังก์ชันนี้ใช้โมเดล AI เพื่อวิเคราะห์และถอดความข้อความในขณะที่คงความตั้งใจเดิมเอาไว้
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Text` | String | — | ✅ (ByValue) | 0 | — | ข้อความที่จะแปลงเป็นภาษาทางธุรกิจ |
...
> ข้อความที่จะแปลงเป็นภาษาทางธุรกิจ
