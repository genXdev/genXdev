...
> แปลงข้อความที่ตรงไปตรงมาหรือรุนแรงให้เป็นภาษาทางการทูตที่สุภาพและมีชั้นเชิง

## Description

ฟังก์ชันนี้จะแปลงอินพุตจากผู้ใช้ที่ตรงไปตรงมาหรือหยาบคายให้เป็นภาษาที่มีชั้นเชิงและเหมาะสมสำหรับการสนทนาระดับสูง การเจรจา หรือการสื่อสารที่เป็นทางการ ฟังก์ชันใช้โมเดลภาษา AI เพื่อรักษาเจตนาดั้งเดิมในขณะที่ทำให้โทนนุ่มนวลขึ้นและทำให้ข้อความมีชั้นเชิงและเป็นมืออาชีพมากขึ้น
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Text` | String | — | ✅ (ByValue) | 0 | — | ขอเรียนให้ทราบว่า หัวข้อที่ต้องดำเนินการแปลงเป็นภาษาในเชิงการทูตมีดังนี้ |
...
> ขอเรียนให้ทราบว่า หัวข้อที่ต้องดำเนินการแปลงเป็นภาษาในเชิงการทูตมีดังนี้
