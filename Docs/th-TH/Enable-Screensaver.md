...
> เริ่มการทำงานโปรแกรมรักษาหน้าจอ Windows ที่กำหนดค่าไว้

## Description

เปิดใช้งานโปรแกรมรักษาหน้าจอของ Windows โดยการเรียกใช้ไฟล์ปฏิบัติการโปรแกรมรักษาหน้าจอเริ่มต้น (scrnsave.scr) พร้อมกับสวิตช์ /s เพื่อเริ่มการทำงานทันที
