...
> ค้นหาไฟล์ที่ซ้ำกันข้ามหลายไดเรกทอรีตามเกณฑ์ที่กำหนดค่าได้

## Description

ค้นหาไฟล์ที่ซ้ำกันในไดเรกทอรีที่ระบุแบบเรียกซ้ำ ไฟล์ถือว่าเป็นไฟล์ซ้ำกันหากเนื้อหาเหมือนกันทุกประการหรือเริ่มต้นด้วยเนื้อหาเดียวกัน (สำหรับการเปรียบเทียบบางส่วนโดยใช้สวิตช์ -ComparePartial) cmdlet นี้ใช้แฮชด่วนของไบต์เริ่มต้นของไฟล์เพื่อจัดกลุ่มอย่างมีประสิทธิภาพก่อนที่จะทำการเปรียบเทียบเนื้อหาเต็ม ขนาดของแฮชด่วนนี้สามารถกำหนดค่าได้ด้วยพารามิเตอร์ -CompareByteLength ซึ่งช่วยให้สามารถปรับสมดุลระหว่างประสิทธิภาพและความแม่นยำในการตรวจจับไฟล์ซ้ำ โดยเฉพาะไฟล์ที่มีความยาวไม่ต่ำกว่าค่า CompareByteLength นี้เท่านั้นที่จะพิจารณาสำหรับการตรวจจับไฟล์ซ้ำ ไฟล์ที่เล็กกว่าจะถูกจัดกลุ่มตามชื่อไฟล์เท่านั้น
...
| `-ComparePartial` | SwitchParameter | — | — | Named | — | จะส่งคืนไฟล์ที่มีขนาดต่างกัน ตราบใดที่พวกมันมีชื่อไฟล์และเนื้อหาเดียวกัน ซึ่งตรวจจับการดาวน์โหลด/การคัดลอกที่เสียหาย |
| `-CompareByteLength` | Int32 | — | — | Named | `65536` | เปรียบเทียบความยาวไบต์ของไฟล์อย่างรวดเร็ว ใช้สำหรับการจัดทำดัชนีและค้นหาไฟล์ที่ซ้ำกันอย่างรวดเร็ว โดยจะไม่เปรียบเทียบเนื้อหาของไฟล์ |
...
> จะส่งคืนไฟล์ที่มีขนาดต่างกัน ตราบใดที่พวกมันมีชื่อไฟล์และเนื้อหาเดียวกัน ซึ่งตรวจจับการดาวน์โหลด/การคัดลอกที่เสียหาย
...
> เปรียบเทียบความยาวไบต์ของไฟล์อย่างรวดเร็ว ใช้สำหรับการจัดทำดัชนีและค้นหาไฟล์ที่ซ้ำกันอย่างรวดเร็ว โดยจะไม่เปรียบเทียบเนื้อหาของไฟล์
