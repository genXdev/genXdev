...
> ดึงรายชื่อผู้ใช้ที่ไม่ซ้ำกันจากกระบวนการของระบบที่กำลังทำงานอยู่

## Description

สอบถามกระบวนการที่กำลังทำงานทั้งหมดในระบบ ดึงชื่อผู้ใช้ที่เกี่ยวข้องกับแต่ละกระบวนการ และส่งคืนรายการผู้ใช้ที่ไม่มีซ้ำซึ่งมีกระบวนการที่ทำงานอยู่ ซึ่งมีประโยชน์สำหรับการบริหารระบบและการตรวจสอบความปลอดภัย
