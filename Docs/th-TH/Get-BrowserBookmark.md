...
> ส่งคืนบุ๊กมาร์กทั้งหมดจากเว็บเบราว์เซอร์ที่ติดตั้งไว้

## Description

เรียกคืนบุ๊กมาร์กจาก Microsoft Edge, Google Chrome หรือ Mozilla Firefox ที่ติดตั้งบนระบบ ฟังก์ชันสามารถกรองตามประเภทเบราว์เซอร์และส่งคืนข้อมูลบุ๊กมาร์กโดยละเอียด รวมถึงชื่อ, URL, ตำแหน่งโฟลเดอร์ และการประทับเวลา โดยจะจัดการการยินยอมสำหรับการติดตั้งแพ็กเกจ NuGet ของ System.Data.SQLite โดยอัตโนมัติเมื่ออ่านบุ๊กมาร์กของ Firefox
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Chrome` | SwitchParameter | — | — | Named | — | นำบุ๊กมาร์กจาก Google Chrome กลับมา |
| `-Edge` | SwitchParameter | — | — | Named | — | ส่งคืนบุ๊กมาร์กจาก Microsoft Edge |
| `-Firefox` | SwitchParameter | — | — | Named | — | ส่งคืนบุ๊กมาร์กจาก Mozilla Firefox *(Parameter set: )* |
| `-ForceConsent` | SwitchParameter | — | — | Named | — | บังคับให้ยินยอมการติดตั้งซอฟต์แวร์ของบุคคลที่สาม |
| `-ConsentToThirdPartySoftwareInstallation` | SwitchParameter | — | — | Named | — | ยินยอมให้ติดตั้งซอฟต์แวร์ของบุคคลที่สาม |
...
> นำบุ๊กมาร์กจาก Google Chrome กลับมา
...
> ส่งคืนบุ๊กมาร์กจาก Microsoft Edge
...
> ส่งคืนบุ๊กมาร์กจาก Mozilla Firefox
...
> บังคับให้ยินยอมการติดตั้งซอฟต์แวร์ของบุคคลที่สาม
...
> ยินยอมให้ติดตั้งซอฟต์แวร์ของบุคคลที่สาม
