...
> รับคีย์ภาษาเว็บเริ่มต้นตามการตั้งค่าภาษาปัจจุบันของระบบ

## Description

* ดึงข้อมูลภาษาและวัฒนธรรมของระบบปัจจุบัน และแมปไปยังคีย์พจนานุกรมภาษาเว็บที่เกี่ยวข้องที่ใช้โดยบริการแปลภาษา
...
ส่งคืน "อังกฤษ" สำหรับระบบภาษาอังกฤษ, "ดัตช์" สำหรับระบบภาษาดัตช์ ฯลฯ
