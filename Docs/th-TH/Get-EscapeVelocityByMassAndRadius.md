...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-MassInKilograms` | Double | ✅ | — | 0 | `0` | มวลของร่างกายในหน่วยกิโลกรัม |
| `-RadiusInMeters` | Double | ✅ | — | 1 | `0` | รัศมีเป็นเมตร |
| `-As` | String | — | — | 2 | — | หน่วยผลลัพธ์สำหรับความเร็ว |
...
คำนวณความเร็วหลุดพ้นสำหรับวัตถุที่มีมวลและรัศมีเท่าโลก
...
คำนวณความเร็วหลุดพ้นโดยใช้หน่วย m/s เป็นค่าเริ่มต้น

## Parameter Details

### `-MassInKilograms <Double>`

> มวลของร่างกายในหน่วยกิโลกรัม
