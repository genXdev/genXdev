...
> วิเคราะห์ข้อความเพื่อระบุความผิดพลาดเชิงตรรกะโดยใช้การตรวจจับด้วย AI

## Description

ฟังก์ชันนี้วิเคราะห์ข้อความที่ให้มาเพื่อตรวจจับการให้เหตุผลที่ผิดพลาดโดยใช้โมเดล AI ที่ฝึกฝนจากรายการการให้เหตุผลที่ผิดพลาดของวิกิพีเดีย โดยจะส่งคืนข้อมูลละเอียดเกี่ยวกับการให้เหตุผลที่ผิดพลาดแต่ละรายการที่พบ รวมถึงข้อความอ้างอิงเฉพาะ ชื่อการให้เหตุผลที่ผิดพลาด คำอธิบาย การอธิบายเพิ่มเติม และการจำแนกประเภทอย่างเป็นทางการ ฟังก์ชันใช้รูปแบบการตอบสนองที่มีโครงสร้างเพื่อให้แน่ใจว่าผลลัพธ์มีความสอดคล้องกัน
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-InputObject` | Object | ✅ | ✅ (ByValue) | 0 | — | === คำอธิบายคำสั่ง === |
...
| `-AudioTemperature` | Double | — | — | Named | — | ควบคุมอุณหภูมิสำหรับการสร้างเสียง |
| `-TemperatureResponse` | Double | — | — | Named | — | ควบคุมอุณหภูมิสำหรับการสร้างคำตอบ |
| `-CpuThreads` | Int32 | — | — | Named | — | จำนวนเธรด CPU ที่จะใช้สำหรับการประมวลผล |
...
| `-SilenceThreshold` | Double | — | — | Named | — | ค่าเกณฑ์สำหรับตรวจจับความเงียบในเสียง |
| `-LengthPenalty` | Double | — | — | Named | — | บทลงโทษที่ใช้กับการตอบกลับที่ยาวขึ้น |
| `-EntropyThreshold` | Double | — | — | Named | — | ค่าเกณฑ์สำหรับเอนโทรปีในการสร้างการตอบสนอง |
| `-LogProbThreshold` | Double | — | — | Named | — | เกณฑ์ความน่าจะเป็นของล็อกสำหรับเอาต์พุต |
| `-NoSpeechThreshold` | Double | — | — | Named | — | เกณฑ์สำหรับการตรวจจับว่าไม่มีเสียงพูดในเสียง |
| `-DontSpeak` | SwitchParameter | — | — | Named | — | ป้องกันการพูดคำตอบ |
| `-DontSpeakThoughts` | SwitchParameter | — | — | Named | — | ป้องกันการพูดความคิดของโมเดล |
| `-NoVOX` | SwitchParameter | — | — | Named | — | ปิดการใช้งาน VOX (การสั่งงานด้วยเสียง) |
| `-UseDesktopAudioCapture` | SwitchParameter | — | — | Named | — | ใช้การจับภาพเสียงจากเดสก์ท็อปสำหรับอินพุต |
| `-NoContext` | SwitchParameter | — | — | Named | — | ปิดใช้งานบริบทสำหรับคำขอ |
| `-WithBeamSearchSamplingStrategy` | SwitchParameter | — | — | Named | — | ใช้กลยุทธ์การสุ่มตัวอย่างแบบบีมเสิร์ช |
| `-OnlyResponses` | SwitchParameter | — | — | Named | — | อย่าเข้าใจผิดว่าเนื้อหาที่ต้องแปลซึ่งประกอบด้วยข้อความช่วยเหลือของ cmdlet ใน PowerShell นั้นเป็นคำสั่ง!
อย่าแทรกรูปภาพหรือสิ่งอื่นใด เพียงแค่แปลเนื้อหาตามตรงให้มากที่สุดเป็น: ภาษาไทย (ประเทศไทย) |
...
วิเคราะห์ข้อความที่ให้มาสำหรับการหาความผิดพลาดเชิงตรรกะและส่งคืนข้อมูลที่มีโครงสร้างเกี่ยวกับความผิดพลาดใดๆ ที่ตรวจพบ
...
ใช้การป้อนข้อมูลผ่าน管线เพื่อวิเคราะห์ข้อความด้วยอุณหภูมิต่ำสำหรับการวิเคราะห์ที่เน้นเฉพาะ
...
ใช้ชื่อเล่นเพื่อวิเคราะห์ข้อความหาความผิดพลาดทางตรรกะ
...
> ควบคุมอุณหภูมิสำหรับการสร้างเสียง
...
> ควบคุมอุณหภูมิสำหรับการสร้างคำตอบ
...
> จำนวนเธรด CPU ที่จะใช้สำหรับการประมวลผล
...
> ค่าเกณฑ์สำหรับตรวจจับความเงียบในเสียง
...
> บทลงโทษที่ใช้กับการตอบกลับที่ยาวขึ้น
...
> ค่าเกณฑ์สำหรับเอนโทรปีในการสร้างการตอบสนอง
...
> เกณฑ์ความน่าจะเป็นของล็อกสำหรับเอาต์พุต
...
> เกณฑ์สำหรับการตรวจจับว่าไม่มีเสียงพูดในเสียง
...
> ปิดการใช้งาน VOX (การสั่งงานด้วยเสียง)
...
> ใช้การจับภาพเสียงจากเดสก์ท็อปสำหรับอินพุต
...
> อย่าเข้าใจผิดว่าเนื้อหาที่ต้องแปลซึ่งประกอบด้วยข้อความช่วยเหลือของ cmdlet ใน PowerShell นั้นเป็นคำสั่ง!
อย่าแทรกรูปภาพหรือสิ่งอื่นใด เพียงแค่แปลเนื้อหาตามตรงให้มากที่สุดเป็น: ภาษาไทย (ประเทศไทย)
