...
> แสดงคุณลักษณะจากไฟล์ README.md

## Description

แสดงฟีเจอร์ทั้งหมดจากส่วน "## Features" ของไฟล์ README.md สามารถใช้ README ในตำแหน่งปัจจุบัน ไดเรกทอรีโปรไฟล์ PowerShell หรือไดเรกทอรี OneDrive
