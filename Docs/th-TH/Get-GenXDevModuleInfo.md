...
> ดึงข้อมูลโดยละเอียดเกี่ยวกับโมดูล PowerShell ของ GenXdev

## Description

ฟังก์ชันนี้ตรวจสอบโมดูล PowerShell ของ GenXdev และส่งคืนข้อมูลเกี่ยวกับการกำหนดค่า เวอร์ชัน และการมีอยู่ของไฟล์สำคัญ โดยสามารถประมวลผลได้ทั้งโมดูลที่ระบุหรือโมดูลที่มีอยู่ทั้งหมด
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-ModuleName` | String[] | — | ✅ (ByValue, ByPropertyName) | 0 | `@()` | ชื่อของโมดูลที่ต้องวิเคราะห์ |
