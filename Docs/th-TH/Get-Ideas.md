...
> แสดงแนวคิดจากไฟล์ README.md

## Description

แสดงแนวคิดทั้งหมดจากส่วน "## Ideas" ของไฟล์ README.md สามารถใช้ README ในตำแหน่งปัจจุบัน ไดเรกทอรีโปรไฟล์ PowerShell หรือไดเรกทอรี OneDrive
