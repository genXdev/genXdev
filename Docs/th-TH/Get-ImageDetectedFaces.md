...
> จดจำใบหน้าในรูปภาพที่อัปโหลดโดยเปรียบเทียบกับใบหน้าที่รู้จักโดยใช้ DeepStack

## Description

ฟังก์ชันนี้วิเคราะห์ไฟล์รูปภาพเพื่อระบุใบหน้าโดยเปรียบเทียบกับใบหน้าที่รู้จักในฐานข้อมูล โดยใช้ API การจดจำใบหน้าของ DeepStack ในเครื่องที่ทำงานบนพอร์ตที่กำหนดค่าได้ และส่งคืนใบหน้าที่ตรงกันพร้อมคะแนนความเชื่อมั่น ฟังก์ชันรองรับการเร่งความเร็วด้วย GPU, เกณฑ์ความเชื่อมั่นที่กำหนดเอง และการจัดการคอนเทนเนอร์ Docker
