...
> แสดงปัญหาจากไฟล์ README.md

## Description

แสดงปัญหาทั้งหมดจากส่วน "## Issues" ในไฟล์ README.md สามารถใช้ README ในตำแหน่งปัจจุบัน ไดเรกทอรีโปรไฟล์ PowerShell หรือไดเรกทอรี OneDrive
