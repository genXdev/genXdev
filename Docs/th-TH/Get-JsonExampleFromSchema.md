...
> สร้างสตริง JSON ตัวอย่างที่มนุษย์อ่านได้จากคำจำกัดความของ JSON Schema

## Description

แปลง JSON Schema ใดๆ (รูปแบบ json_schema ของ OpenAI หรือ schema ดิบ) ให้เป็นสตริง JSON ตัวอย่างที่กระชับ เหมาะสำหรับการแทรกเข้าไปในคำแนะนำระบบของ LLM รองรับอ็อบเจกต์แบบซ้อนกัน อาร์เรย์ ประเภทสเกลาร์ เอนัม ยูเนียน การประกอบแบบ oneOf/anyOf/allOf และคำแนะนำรูปแบบเช่น date-time และ email

ฟังก์ชันจะสร้างทรีอ็อบเจกต์ PowerShell โดยการเดิน Schema แบบเรียกซ้ำ จากนั้นทำซีเรียลไลซ์เป็นสตริง JSON ที่กระชับผ่าน ConvertTo-Json
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Schema` | Object | — | — | 0 | — | คำจำกัดความของ JSON Schema (สตริง JSON หรือ PSCustomObject) รองรับรูปแบบ wrapper json_schema ของ OpenAI และวัตถุ JSON Schema ดิบ |
...
@{response=สร้าง: {"items":[{"id":0,"label":"..."}]}}

## Parameter Details

### `-Schema <Object>`

> คำจำกัดความของ JSON Schema (สตริง JSON หรือ PSCustomObject) รองรับรูปแบบ wrapper json_schema ของ OpenAI และวัตถุ JSON Schema ดิบ
