...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-MassInKilograms` | Double | ✅ | — | 0 | `0` | มวลเป็นกิโลกรัม |
| `-HeightInMeters` | Double | ✅ | — | 1 | `0` | ความสูงเป็นเมตร |
| `-GravityInMetersPerSecondSquared` | Double | — | — | 2 | `0` | แรงโน้มถ่วงในหน่วย m/s² (ค่าเริ่มต้น: 9.81) |
| `-As` | String | — | — | 3 | — | หน่วยส่งออกสำหรับพลังงาน |
...
คำนวณพลังงานศักย์โน้มถ่วงสำหรับมวล 10 กิโลกรัม ที่ความสูง 5 เมตร โดยแสดงผลลัพธ์เป็นแคลอรี่
...
สาธิตการใช้พารามิเตอร์แบบตำแหน่งเพื่อคำนวณพลังงานศักย์
