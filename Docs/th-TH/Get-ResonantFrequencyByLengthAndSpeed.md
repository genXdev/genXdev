...
> คำนวณความถี่เรโซแนนซ์สำหรับท่อปิด

## Description

ใช้ f = v / (4 L) สำหรับความถี่มูลฐาน
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-LengthInMeters` | Double | ✅ | — | 0 | `0` | ความยาวเป็นเมตร |
| `-SpeedInMetersPerSecond` | Double | ✅ | — | 1 | `0` | ความเร็วคลื่นในหน่วย m/s *(Parameter set: )* |
| `-Medium` | String | ✅ | — | 1 | — | ตัวกลาง *(Parameter set: )* |
| `-As` | String | — | — | 2 | — | หน่วยเอาต์พุตสำหรับความถี่ |
...
คำนวณความถี่เรโซแนนซ์สำหรับท่อยาว 0.5 เมตรในอากาศ แสดงผลในหน่วยกิโลเฮิรตซ์
...
คำนวณความถี่เรโซแนนซ์สำหรับท่อยาว 1 เมตร ด้วยความเร็วคลื่นเสียง 343 เมตร/วินาที
