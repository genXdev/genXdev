...
> อัปเดตข้อมูลเมตา EXIF สำหรับรูปภาพในไดเรกทอรี

## Description

ฟังก์ชันนี้จะดึงข้อมูลและอัปเดตเมทาดาทา EXIF สำหรับรูปภาพในไดเรกทอรีที่ระบุ
โดยจะประมวลผลแต่ละภาพเพื่อดึงข้อมูลเมทาดาทา EXIF แบบละเอียด รวมถึงรายละเอียดของกล้อง
พิกัด GPS การตั้งค่าการเปิดรับแสง และข้อมูลทางเทคนิคอื่นๆ ข้อมูลเมทาดาทาจะถูกจัดเก็บ
ในสตรีม NTFS สำรองเป็น :EXIF.json เพื่อใช้ในภายหลังโดยฟังก์ชันการจัดทำดัชนีและค้นหา
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-ImageDirectories` | String[] | — | — | 0 | `@('.\')` | อาร์เรย์ของเส้นทางไดเรกทอรีที่ต้องประมวลผลเพื่ออัปเดตข้อมูลเมตาของรูปภาพ |
| `-RetryFailed` | SwitchParameter | — | — | Named | — | จะลองอัปเดตข้อมูลเมตาของรูปภาพที่ล้มเหลวก่อนหน้านี้อีกครั้ง |
| `-OnlyNew` | SwitchParameter | — | — | Named | — | ประมวลผลเฉพาะรูปภาพที่ยังไม่มีไฟล์ข้อมูลเมตา |
| `-Recurse` | SwitchParameter | — | — | Named | — | หากระบุ ให้ประมวลผลภาพในโฟลเดอร์ย่อยแบบวนซ้ำ |
| `-Force` | SwitchParameter | — | — | Named | — | บังคับให้สร้าง metadata ใหม่แม้ว่าจะมีอยู่แล้วก็ตาม |
| `-PassThru` | SwitchParameter | — | — | Named | — | ส่งคืนวัตถุที่มีโครงสร้างแทนที่จะส่งออกไปยังคอนโซล |
...
| `-SkipSession` | SwitchParameter | — | — | Named | — | อย่าใช้การตั้งค่าสำรองที่เก็บในเซสชันสำหรับค่ากำหนด AI เช่น ภาษา, ชุดรูปภาพ ฯลฯ |
...
> อาร์เรย์ของเส้นทางไดเรกทอรีที่ต้องประมวลผลเพื่ออัปเดตข้อมูลเมตาของรูปภาพ
...
> จะลองอัปเดตข้อมูลเมตาของรูปภาพที่ล้มเหลวก่อนหน้านี้อีกครั้ง
...
> ประมวลผลเฉพาะรูปภาพที่ยังไม่มีไฟล์ข้อมูลเมตา
...
> หากระบุ ให้ประมวลผลภาพในโฟลเดอร์ย่อยแบบวนซ้ำ
...
> บังคับให้สร้าง metadata ใหม่แม้ว่าจะมีอยู่แล้วก็ตาม
...
> ส่งคืนวัตถุที่มีโครงสร้างแทนที่จะส่งออกไปยังคอนโซล
...
> อย่าใช้การตั้งค่าสำรองที่เก็บในเซสชันสำหรับค่ากำหนด AI เช่น ภาษา, ชุดรูปภาพ ฯลฯ
