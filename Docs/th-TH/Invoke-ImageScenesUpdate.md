...
> อัปเดตข้อมูลเมตาการจำแนกประเภทฉากสำหรับไฟล์รูปภาพในไดเรกทอรีที่ระบุ

## Description

ฟังก์ชันนี้ประมวลผลภาพในไดเรกทอรีที่ระบุเพื่อจำแนกฉากโดยใช้ปัญญาประดิษฐ์ โดยสร้างไฟล์เมทาดาทา JSON ที่ประกอบด้วยการจำแนกฉาก คะแนนความเชื่อมั่น และป้ายกำกับ ฟังก์ชันรองรับการประมวลผลแบบแบตช์พร้อมเกณฑ์ความเชื่อมั่นที่ปรับได้ และสามารถข้ามไฟล์เมทาดาทาที่มีอยู่หรือลองทำการจำแนกที่ล้มเหลวก่อนหน้านี้อีกครั้ง
...
ประมวลผลภาพทั้งหมดใน C:\Photos และ D:\Pictures และไดเรกทอรีย่อยเพื่อการจำแนกฉาก
...
ใช้นามแฝงเพื่อลองจัดประเภทที่ล้มเหลวอีกครั้ง และดำเนินการเฉพาะรูปภาพใหม่ในหลายไดเรกทอรี
...
บังคับให้สร้างคอนเทนเนอร์ใหม่และใช้การเร่งด้วย GPU เพื่อการประมวลผลที่เร็วขึ้น
...
ประมวลผลภาพทั้งหมดแบบเรียกซ้ำและจัดเก็บเฉพาะการจำแนกประเภทฉากที่มีความเชื่อมั่น >= 60%
