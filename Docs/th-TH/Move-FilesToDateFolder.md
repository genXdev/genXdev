...
> ย้ายไฟล์ที่ตรงตามเกณฑ์การค้นหาไปยังโฟลเดอร์ย่อยตามวันที่

## Description

ค้นหาไฟล์โดยใช้พารามิเตอร์ชุดเดียวกันกับ `Find-Item` และย้ายไฟล์ที่ตรงกันแต่ละไฟล์ไปยังโฟลเดอร์ย่อยของ `TargetFolder` ตามวันที่สร้างหรือวันที่สื่อของไฟล์ cmdlet รองรับการจับคู่เนื้อหา การค้นหาทั่วทั้งไดรฟ์ และตัวกรองหลายรายการ สามารถลบโฟลเดอร์ต้นทางที่ว่างเปล่าหลังการย้ายได้ตามต้องการ

พยายามใช้หลายกลยุทธ์เพื่อระบุวันที่สร้างหรือวันที่บันทึกที่ถูกต้องของไฟล์ที่ระบุ กลยุทธ์รวมถึงการอ่านข้อมูลเมตา EXIF ของภาพ การแยกข้อมูลวันที่/เวลาจากชื่อไฟล์ และการถอยกลับไปใช้เวลาที่เขียนล่าสุดของไฟล์เมื่อไม่มีข้อมูลที่เชื่อถือได้อื่นใด
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-TargetFolder` | String | ✅ | — | 0 | — | โฟลเดอร์รากปลายทางที่ไฟล์ที่ตรงกันจะถูกย้ายไปยังโฟลเดอร์ย่อยตามวันที่ |
...
> โฟลเดอร์รากปลายทางที่ไฟล์ที่ตรงกันจะถูกย้ายไปยังโฟลเดอร์ย่อยตามวันที่
