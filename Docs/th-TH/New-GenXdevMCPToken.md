...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Length` | Int32 | — | — | 0 | `32` | ความยาวของโทเค็นเป็นไบต์ (ค่าเริ่มต้น: 32, ขั้นต่ำ: 16) |
| `-SetEnvironmentVariable` | SwitchParameter | — | — | Named | — | เก็บโทเค็นในตัวแปรสภาพแวดล้อมผู้ใช้ GENXDEV_MCP_TOKEN |
| `-Force` | SwitchParameter | — | — | Named | — | เขียนทับตัวแปรสภาพแวดล้อมที่มีอยู่แล้วโดยไม่ต้องแจ้งให้ทราบ |

## Parameter Details

### `-Length <Int32>`

> ความยาวของโทเค็นเป็นไบต์ (ค่าเริ่มต้น: 32, ขั้นต่ำ: 16)
...
> เก็บโทเค็นในตัวแปรสภาพแวดล้อมผู้ใช้ GENXDEV_MCP_TOKEN
...
> เขียนทับตัวแปรสภาพแวดล้อมที่มีอยู่แล้วโดยไม่ต้องแจ้งให้ทราบ
