...
> เปิดข้อความค้นหา Bing CoPilot ในเว็บเบราว์เซอร์

## Description

เปิดการค้นหา Bing CoPilot ในเว็บเบราว์เซอร์ ฟังก์ชันจะพิมพ์ข้อความค้นหาโดยอัตโนมัติและส่งโดยใช้ฟังก์ชัน Open-WebsiteAndPerformQuery ที่อยู่ภายใต้ ซึ่งเป็นวิธีที่สะดวกในการโต้ตอบกับ Microsoft Copilot จาก PowerShell
...
| `-ClearSession` | SwitchParameter | — | — | Named | — | ล้างเซสชัน/โปรไฟล์ของเบราว์เซอร์ก่อนเปิด |
| `-SkipSession` | SwitchParameter | — | — | Named | — | ข้ามการโหลดเซสชัน/โปรไฟล์ของเบราว์เซอร์ |
...
> ล้างเซสชัน/โปรไฟล์ของเบราว์เซอร์ก่อนเปิด
...
> ข้ามการโหลดเซสชัน/โปรไฟล์ของเบราว์เซอร์
