...
> เปิดบุ๊กมาร์กเบราว์เซอร์ที่ตรงกับเกณฑ์การค้นหาที่ระบุ

## Description

ค้นหาบุ๊กมาร์กใน Microsoft Edge, Google Chrome และ Mozilla Firefox ตามคำค้นหาที่ให้ไว้ เปิดบุ๊กมาร์กที่ตรงกันในเบราว์เซอร์ที่เลือกด้วยการตั้งค่าหน้าต่างและโหมดเบราว์เซอร์ที่ปรับแต่งได้

ฟังก์ชันนี้มีอินเทอร์เฟซที่ครอบคลุมสำหรับการค้นหาและเปิดบุ๊กมาร์กของเบราว์เซอร์พร้อมตัวเลือกการกรองและการแสดงผลขั้นสูง รองรับเกณฑ์การค้นหาหลายรายการและสามารถเปิดผลลัพธ์ในเบราว์เซอร์ที่ติดตั้งใดก็ได้ พร้อมการปรับแต่งตำแหน่งหน้าต่างและพฤติกรรมอย่างละเอียด
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Queries` | String[] | — | ✅ (ByValue, ByPropertyName) | 0 | — | คำค้นหาเพื่อกรองบุ๊กมาร์ก |
| `-Count` | Int32 | — | — | 1 | `50` | จำนวน URL สูงสุดที่จะเปิด |
| `-Edge` | SwitchParameter | — | — | Named | — | เลือกใน Microsoft Edge |
| `-Chrome` | SwitchParameter | — | — | Named | — | เลือกใน Google Chrome |
| `-Firefox` | SwitchParameter | — | — | Named | — | เลือกใน Firefox |
...
| `-ShowWindow` | SwitchParameter | — | — | Named | — | แสดงหน้าต่างเบราว์เซอร์ (ไม่ใช่ 1d หรือซ่อนอยู่) |
...
ค้นหาบุ๊กมาร์กที่มีคำว่า "github" ใน Microsoft Edge และเปิด
ผลลัพธ์ 5 รายการแรกในเบราว์เซอร์เริ่มต้น
...
เหมือนกับข้างต้นโดยใช้นามแฝง - ค้นหาบุ๊กมาร์ก Edge สำหรับ "gh" และเปิดผลลัพธ์ 5 รายการในเบราว์เซอร์เริ่มต้น
...
ค้นหาบุ๊กมาร์ก Chrome สำหรับ "development" และ "tools" เปิดผลลัพธ์ 10 รายการแรกใน Firefox ที่วางตำแหน่งทางด้านซ้ายของหน้าจอ

## Parameter Details

### `-Queries <String[]>`

> คำค้นหาเพื่อกรองบุ๊กมาร์ก
...
> แสดงหน้าต่างเบราว์เซอร์ (ไม่ใช่ 1d หรือซ่อนอยู่)
