...
> เปิดการค้นหาเว็บไซต์ BuiltWith ในเว็บเบราว์เซอร์

## Description

เปิดการค้นหา BuiltWith ในเว็บเบราว์เซอร์ พร้อมการตั้งค่าการตรวจสอบและตัวเลือกพฤติกรรมของเบราว์เซอร์ที่กำหนดค่าได้ ฟังก์ชันนี้จะวิเคราะห์สแต็กเทคโนโลยีของเว็บไซต์โดยสอบถามบริการสร้างโปรไฟล์เทคโนโลยีของ BuiltWith.com ซึ่งให้ข้อมูลโดยละเอียดเกี่ยวกับเทคโนโลยีเว็บ เฟรมเวิร์ก และบริการที่เว็บไซต์ใช้

BuiltWith.com เป็นบริการค้นหาเทคโนโลยีที่ครอบคลุม ซึ่งระบุเทคโนโลยีเว็บ เฟรมเวิร์ก ระบบจัดการเนื้อหา เครื่องมือวิเคราะห์ ผู้ให้บริการโฮสติ้ง และส่วนประกอบซอฟต์แวร์อื่นๆ ที่เว็บไซต์ใดๆ ใช้ ฟังก์ชันนี้มีอินเทอร์เฟซ PowerShell เพื่อวิเคราะห์สแต็กเทคโนโลยีอย่างรวดเร็วโดยไม่ต้องนำทางไปยังเว็บไซต์ BuiltWith ด้วยตนเอง
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Queries` | String[] | ✅ | ✅ (ByValue, ByPropertyName) | 0 | — | URL หรือโดเมนของเว็บไซต์ที่ต้องการสอบถามบน BuiltWith.com |
| `-Language` | String | — | — | 1 | — | ภาษาของผลลัพธ์การค้นหาที่ส่งคืน |
| `-Monitor` | Int32 | — | — | 2 | `-1` | จอภาพที่จะใช้ 0 = ค่าเริ่มต้น, -1 = ไม่ใช้, -2 = จอภาพรองที่กำหนดค่าไว้, ค่าเริ่มต้นคือ -1, ไม่มีการจัดตำแหน่ง |
...
เปิดการวิเคราะห์เทคโนโลยี BuiltWith สำหรับ Microsoft.com บนจอภาพเริ่มต้น.
...
วิเคราะห์ Microsoft.com โดยใช้การป้อนข้อมูลแบบไปป์ไลน์ โดยละทิ้งตำแหน่งการวางมอนิเตอร์

## Parameter Details

### `-Queries <String[]>`

> URL หรือโดเมนของเว็บไซต์ที่ต้องการสอบถามบน BuiltWith.com
