...
> เปิดคำถาม ChatGPT ในเว็บเบราว์เซอร์

## Description

เปิด ChatGPT ในเว็บเบราว์เซอร์ ป้อนข้อความค้นหาที่ระบุโดยอัตโนมัติและส่งข้อความนั้น รองรับข้อความค้นหาหลายรายการที่จะดำเนินการโดยใช้ฟังก์ชัน Open-WebsiteAndPerformQuery พื้นฐาน ฟังก์ชันนี้เป็นวิธีที่สะดวกในการโต้ตอบกับ ChatGPT ของ OpenAI จาก PowerShell พร้อมตัวเลือกการกำหนดค่าเบราว์เซอร์ที่ครอบคลุม
...
| `-ShowWindow` | SwitchParameter | — | — | Named | — | แสดงหน้าต่างเบราว์เซอร์ |
...
ส่งคิวรีหลายรายการโดยใช้ชื่อพารามิเตอร์แบบเต็ม
...
ส่งแบบสอบถามโดยใช้นามแฝงและไปป์ไลน์
...
- [Open-CloudLLMChat](https://github.com/genXdev/genXdev/blob/main/Docs/th-TH/Open-CloudLLMChat.md)
