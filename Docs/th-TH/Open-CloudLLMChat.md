...
> เปิดอินเทอร์เฟซแชท LLM คลาวด์สำหรับสอบถามข้อมูล AI

## Description

ฟังก์ชันนี้มีอินเทอร์เฟซแบบรวมสำหรับเปิดบริการแชท AI บนคลาวด์ต่างๆ ในเว็บเบราว์เซอร์ รองรับแพลตฟอร์ม AI หลายตัวรวมถึง ChatGPT, BingCopilot, Google Gemini, X Grok, DeepSearch และ GitHub Copilot ฟังก์ชันจะเลือกฟังก์ชันเฉพาะของจุดสิ้นสุดที่เหมาะสมโดยอัตโนมัติและส่งต่อพารามิเตอร์ที่เกี่ยวข้องทั้งหมดสำหรับการกำหนดค่าเบราว์เซอร์และการวางตำแหน่งหน้าต่าง
...
| `-EndPoint` | String | — | — | 1 | `'XGrok'` | จุดสิ้นสุดที่ใช้เรียกใช้คิวรี |
...
| `-Minimize` | SwitchParameter | — | — | Named | — | ย่อหน้าต่างให้เล็กสุดหลังจากวางตำแหน่ง |
...
เปิด ChatGPT และส่งคำถามเกี่ยวกับฟังก์ชัน PowerShell
...
ใช้นามแฝงถาม Google Gemini เกี่ยวกับการเรียนรู้ของเครื่อง
...
ประมวลผลหลายคำถามผ่าน X Grok บนจอภาพเริ่มต้น
...
> ย่อหน้าต่างให้เล็กสุดหลังจากวางตำแหน่ง
...
- [Open-BingCopilotQuery](https://github.com/genXdev/genXdev/blob/main/Docs/th-TH/Open-BingCopilotQuery.md)
- [Open-ChatGPTQuery](https://github.com/genXdev/genXdev/blob/main/Docs/th-TH/Open-ChatGPTQuery.md)
- [Open-DeepSearchQuery](https://github.com/genXdev/genXdev/blob/main/Docs/th-TH/Open-DeepSearchQuery.md)
- [Open-GithubCopilotQuery](https://github.com/genXdev/genXdev/blob/main/Docs/th-TH/Open-GithubCopilotQuery.md)
- [Open-GoogleGeminiQuery](https://github.com/genXdev/genXdev/blob/main/Docs/th-TH/Open-GoogleGeminiQuery.md)
- [Open-XGrokQuery](https://github.com/genXdev/genXdev/blob/main/Docs/th-TH/Open-XGrokQuery.md)
