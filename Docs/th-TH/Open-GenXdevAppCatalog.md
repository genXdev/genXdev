...
> เปิดแค็ตตาล็อกแอปพลิเคชันเว็บแบบก้าวหน้าของ GenXdev ในเว็บเบราว์เซอร์

## Description

เปิดแคตตาล็อกที่มีเว็บแอปพลิเคชันโปรเกรสซีฟของ GenXdev ที่เผยแพร่แล้วในเว็บเบราว์เซอร์
เปิดในโหมดแอปพลิเคชันโดยเปิดใช้งานแบบเต็มหน้าจอตามค่าเริ่มต้นเพื่อให้
ประสบการณ์การรับชมที่ดีที่สุดสำหรับแคตตาล็อก รองรับตัวเลือกการกำหนดค่าเบราว์เซอร์มาตรฐานทั้งหมด 
รวมถึงการวางตำแหน่งจอภาพ การปรับขนาดหน้าต่าง และการตั้งค่าภาษา

ฟังก์ชันจะกำหนดค่าเบราว์เซอร์โดยอัตโนมัติเพื่อประสบการณ์การรับชมแคตตาล็อกที่ดีที่สุด
และสามารถเปิดอินสแตนซ์เบราว์เซอร์หลายตัวพร้อมกันได้ รองรับภาษา
ที่หลากหลายและเคารพความชอบของผู้ใช้ในการเลือกและวางตำแหน่งเบราว์เซอร์
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Language` | String | — | — | 0 | — | ภาษาของผลลัพธ์การค้นหาที่ส่งคืน |
...
เปิดแค็ตตาล็อกแอป GenXdev บนจอภาพที่ 1 ในโหมดแอปพลิเคชันโดยเปิดแบบเต็มหน้าจอ
...
เปิดแคตตาล็อกแอป GenXdev บนจอภาพที่ 1 โดยใช้คำสั่งนามแฝง
