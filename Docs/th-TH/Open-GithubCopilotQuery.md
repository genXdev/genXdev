...
> เปิดการสอบถาม Github CoPilot ในเว็บเบราว์เซอร์

## Description

เปิดข้อความค้นหาของ Github CoPilot ในเว็บเบราว์เซอร์และป้อนข้อความค้นหาที่ระบุโดยอัตโนมัติ ฟังก์ชันนี้จะรอให้หน้าเว็บโหลดเสร็จก่อนจึงจะพิมพ์ข้อความค้นหา ฟังก์ชันนี้ใช้ฟังก์ชัน Open-WebsiteAndPerformQuery ที่อยู่ภายใต้เพื่อจัดการการทำงานอัตโนมัติของเบราว์เซอร์ และเป็นวิธีที่สะดวกในการโต้ตอบกับ GitHub Copilot จาก PowerShell พร้อมตัวเลือกการกำหนดค่าเบราว์เซอร์ที่ครอบคลุม
