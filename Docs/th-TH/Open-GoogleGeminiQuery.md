...
> เปิดการค้นหา Google Gemini ในเว็บเบราว์เซอร์

## Description

เปิดคำค้นหา Google Gemini ในเว็บเบราว์เซอร์ ป้อนคำค้นหาโดยอัตโนมัติ และส่งคำค้นหา นี่เป็นวิธีที่รวดเร็วในการโต้ตอบกับ AI Gemini ของ Google ฟังก์ชันนี้รองรับการควบคุมเบราว์เซอร์ที่ครอบคลุม รวมถึงการเลือกจอภาพ การวางตำแหน่งหน้าต่าง และคุณสมบัติการทำงานอัตโนมัติของคีย์บอร์ด
...
เปิด Google Gemini และส่งคำค้นหา "PowerShell คืออะไร"
...
ใช้นามแฝงเพื่อส่งข้อความค้นหาเกี่ยวกับอาร์เรย์ผ่านทางอินพุตไปป์ไลน์
