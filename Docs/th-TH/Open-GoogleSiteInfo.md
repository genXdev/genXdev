...
> เปิดการค้นหาข้อมูลไซต์ Google ในเว็บเบราว์เซอร์

## Description

เปิดการค้นหาของ Google หลายรายการที่เกี่ยวข้องกับข้อมูลไซต์ (site:, link:, related:) ในเว็บเบราว์เซอร์สำหรับโดเมนที่ระบุ
...
| `-SessionOnly` | SwitchParameter | — | — | Named | — | ใช้โหมดเฉพาะเซสชันสำหรับโปรไฟล์เบราว์เซอร์ (ไม่มีข้อมูลคงค้าง) |
| `-ClearSession` | SwitchParameter | — | — | Named | — | ล้างข้อมูลเซสชัน/โปรไฟล์เบราว์เซอร์ก่อนเปิด |
| `-SkipSession` | SwitchParameter | — | — | Named | — | ข้ามการใช้เซสชัน/โปรไฟล์เบราว์เซอร์ (ใช้ค่าเริ่มต้น) |
...
> ใช้โหมดเฉพาะเซสชันสำหรับโปรไฟล์เบราว์เซอร์ (ไม่มีข้อมูลคงค้าง)
...
> ล้างข้อมูลเซสชัน/โปรไฟล์เบราว์เซอร์ก่อนเปิด
...
> ข้ามการใช้เซสชัน/โปรไฟล์เบราว์เซอร์ (ใช้ค่าเริ่มต้น)
