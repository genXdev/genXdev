...
> เปิดแบบสอบถาม Grokipedia ในเว็บเบราว์เซอร์

## Description

เปิดคำค้นหา Grokipedia หนึ่งรายการขึ้นไปในเว็บเบราว์เซอร์พร้อมตัวเลือกการกำหนดค่าที่หลากหลาย รองรับการกำหนดพฤติกรรมของเบราว์เซอร์ การเลือกจอภาพ และการวางตำแหน่งหน้าต่าง คำค้นหาจะถูกเข้ารหัส URL และเปิดโดยใช้โดเมน Grokipedia ตามภาษาที่ระบุพร้อมการรองรับการแปลเป็นภาษาท้องถิ่นอย่างสมบูรณ์

ฟังก์ชันนี้มีการควบคุมเบราว์เซอร์ที่ครอบคลุม รวมถึงโหมดการเรียกดูส่วนตัว การวางตำแหน่งหน้าต่าง ระบบอัตโนมัติแป้นพิมพ์ และการรองรับหลายจอภาพ จัดการการเข้ารหัส URL และการแมปโค้ดภาษาโดยอัตโนมัติสำหรับโดเมน Grokipedia นานาชาติ
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Queries` | String[] | ✅ | ✅ (ByValue, ByPropertyName) | 0 | — | คำค้นหา Grokipedia ที่จะดำเนินการ |
...
เปิดการค้นหา Grokipedia สำหรับ "PowerShell" เป็นภาษาอังกฤษบนจอภาพเริ่มต้น
...
เปิดการค้นหา Grokipedia โดยใช้นามแฝงพร้อมพารามิเตอร์ตำแหน่ง
...
ค้นหาคำศัพท์หลายคำใน Grokipedia โดยใช้โหมดการเรียกดูแบบส่วนตัว

## Parameter Details

### `-Queries <String[]>`

> คำค้นหา Grokipedia ที่จะดำเนินการ
