...
> เปิดการค้นหา InstantStreetView ในเว็บเบราว์เซอร์

## Description

เปิดการค้นหา InstantStreetView ในลักษณะที่สามารถกำหนดค่าได้โดยใช้สวิตช์บรรทัดคำสั่งของเว็บเบราว์เซอร์ รองรับหลายการค้นหาและการเลือกจอภาพ ให้การควบคุมเบราว์เซอร์ที่ครอบคลุมรวมถึงการวางตำแหน่งหน้าต่าง การตั้งค่าภาษา และคุณสมบัติเฉพาะเบราว์เซอร์

ฟังก์ชันจะสร้าง URL ของ InstantStreetView โดยอัตโนมัติด้วยการเข้ารหัส URL ของการค้นหาตำแหน่งที่ตั้งและเปิดในเบราว์เซอร์ที่ระบุ รองรับเบราว์เซอร์หลักทั้งหมดรวมถึง Edge, Chrome และ Firefox พร้อมตัวเลือกการปรับแต่งที่หลากหลาย
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Queries` | String[] | ✅ | ✅ (ByValue, ByPropertyName) | 0 | — | ข้อความค้นหาสถานที่เพื่อดูใน InstantStreetView |
...
เปิด InstantStreetView สำหรับไทม์สแควร์ในเบราว์เซอร์เริ่มต้นบนจอภาพหลัก
...
เปิด InstantStreetView สำหรับหอไอเฟลโดยใช้นามแฝง 'isv' และแสดงบนจอมอนิเตอร์รอง
...
เปิด InstantStreetView สำหรับหอนาฬิกาบิ๊กเบนในภาษาไทยโดยใช้โหมดการเรียกดูแบบส่วนตัว
...
เปิดการค้นหา InstantStreetView หลายรายการผ่านไปป์ไลน์ในเบราว์เซอร์ Chrome โดยวางไว้ที่ด้านซ้ายของหน้าจอ

## Parameter Details

### `-Queries <String[]>`

> ข้อความค้นหาสถานที่เพื่อดูใน InstantStreetView
