...
> เปิดข้อมูลเว็บไซต์ SimilarWeb สำหรับ URL ที่ระบุในเว็บเบราว์เซอร์

## Description

เปิดการค้นหา "Similar web" ในเว็บเบราว์เซอร์ในลักษณะที่ปรับแต่งได้โดยใช้สวิตช์บรรทัดคำสั่ง ช่วยให้ตรวจสอบการวิเคราะห์เว็บไซต์และการเปรียบเทียบสำหรับการวิเคราะห์ปริมาณการเข้าชมเว็บไซต์ การวิจัยคู่แข่ง และข้อมูลเชิงลึกด้านการตลาดดิจิทัล
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Queries` | String[] | ✅ | ✅ (ByValue, ByPropertyName) | 0 | — | URL เว็บไซต์ที่ต้องการวิเคราะห์บน SimilarWeb |
...
เปิดการวิเคราะห์ SimilarWeb สำหรับ Google.com บนจอภาพหลัก
...
เปิดการวิเคราะห์ SimilarWeb โดยใช้นามแฝงของฟังก์ชันพร้อมการวางตำแหน่งมอนิเตอร์
...
วิเคราะห์หลายเว็บไซต์ผ่านอินพุตไปป์ไลน์พร้อมตำแหน่งหน้าต่างที่อยู่กึ่งกลาง
...
ส่งคืน URL ของ SimilarWeb สำหรับ GitHub โดยไม่ต้องเปิดเบราว์เซอร์

## Parameter Details

### `-Queries <String[]>`

> URL เว็บไซต์ที่ต้องการวิเคราะห์บน SimilarWeb
