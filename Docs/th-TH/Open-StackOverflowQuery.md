...
> เปิดการค้นหา Stack Overflow ในเว็บเบราว์เซอร์

## Description

เปิดคำค้นหา Stack Overflow หนึ่งรายการขึ้นไปในเว็บเบราว์เซอร์ พร้อมตัวเลือกการกำหนดค่าเบราว์เซอร์และการแสดงผลที่ครอบคลุม ฟังก์ชันนี้มี wrapper ขั้นสูงสำหรับฟังก์ชันการค้นหา Stack Overflow พร้อมตัวเลือกมากมายสำหรับการวางตำแหน่งหน้าต่าง การเลือกเบราว์เซอร์ และการปรับแต่งพฤติกรรม

คุณสมบัติหลัก:
- รองรับคำค้นหาหลายรายการด้วยอินพุตแบบไปป์ไลน์
- การตรวจจับและเลือกเบราว์เซอร์อัจฉริยะ (Edge, Chrome, Firefox, เบราว์เซอร์ทั้งหมด)
- การวางตำแหน่งหน้าต่างขั้นสูง (ซ้าย, ขวา, บน, ล่าง, กึ่งกลาง, เต็มหน้าจอ)
- รองรับมอนิเตอร์หลายจอ พร้อมการเลือกมอนิเตอร์อัตโนมัติหรือด้วยตนเอง
- รองรับโหมดการเรียกดูส่วนตัว/ไม่ระบุตัวตน
- โหมดแอปพลิเคชันสำหรับการเรียกดูแบบไร้สิ่งรบกวน
- รองรับการปรับภาษาในเครื่องสำหรับผลการค้นหาระหว่างประเทศ
...
- ตัวเลือกส่งคืน URL สำหรับเวิร์กโฟลว์อัตโนมัติ

ฟังก์ชันจะตรวจจับความสามารถของระบบโดยอัตโนมัติและปรับพฤติกรรมตามนั้น สำหรับเบราว์เซอร์ที่ไม่ได้ติดตั้งในระบบ การดำเนินการจะถูกข้ามอย่างเงียบ ๆ โดยไม่มีข้อผิดพลาด
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Queries` | String[] | ✅ | ✅ (ByValue, ByPropertyName) | 0 | — | ข้อความค้นหาที่จะดำเนินการบน Stack Overflow |
| `-Language` | String | — | — | 1 | — | ภาษาของผลลัพธ์การค้นหาที่ส่งกลับสำหรับเนื้อหา Stack Overflow ที่แปลเป็นภาษาท้องถิ่น |
...
| `-SessionOnly` | SwitchParameter | — | — | Named | — | ใช้การตั้งค่าทางเลือกที่เก็บไว้ในเซสชันสำหรับการตั้งค่าการค้นหา Stack Overflow |
| `-ClearSession` | SwitchParameter | — | — | Named | — | ล้างการตั้งค่าทางเลือกที่เก็บไว้ในเซสชันสำหรับการค้นหา Stack Overflow |
| `-SkipSession` | SwitchParameter | — | — | Named | — | จัดเก็บการตั้งค่าเฉพาะในค่ากำหนดถาวรโดยไม่ส่งผลต่อเซสชันสำหรับการค้นหา Stack Overflow |
...
เปิดการค้นหา Stack Overflow สำหรับ "powershell array" บนจอภาพหลัก
...
เปิดการค้นหา Stack Overflow โดยใช้นามแฝงพร้อมการวางตำแหน่งหน้าจอ
...
เปิดการค้นหา Stack Overflow หลายรายการใน Chrome โดยตั้งค่าภาษาเป็นภาษาอังกฤษ
...
ส่งคืน URL การค้นหา Stack Overflow โดยไม่ต้องเปิดเบราว์เซอร์

## Parameter Details

### `-Queries <String[]>`

> ข้อความค้นหาที่จะดำเนินการบน Stack Overflow
...
> ภาษาของผลลัพธ์การค้นหาที่ส่งกลับสำหรับเนื้อหา Stack Overflow ที่แปลเป็นภาษาท้องถิ่น
...
> ใช้การตั้งค่าทางเลือกที่เก็บไว้ในเซสชันสำหรับการตั้งค่าการค้นหา Stack Overflow
...
> ล้างการตั้งค่าทางเลือกที่เก็บไว้ในเซสชันสำหรับการค้นหา Stack Overflow
...
> จัดเก็บการตั้งค่าเฉพาะในค่ากำหนดถาวรโดยไม่ส่งผลต่อเซสชันสำหรับการค้นหา Stack Overflow
