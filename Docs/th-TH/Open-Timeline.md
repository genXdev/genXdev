...
> เปิดเส้นเวลาแบบโต้ตอบที่แสดงเวลา วันที่ ศตวรรษ และสหัสวรรษปัจจุบัน

## Description

เปิดไทม์ไลน์แบบโต้ตอบผ่านเว็บ
รองรับหลายภาษาและตัวเลือกปรับแต่งภาพ
...
| `-Monitor` | Int32 | — | — | Named | `-2` | จอภาพที่จะใช้, 0 = ค่าเริ่มต้น, -1 = ยกเลิก, -2 = จอภาพรองที่กำหนดค่าไว้, ค่าเริ่มต้นคือ Global:DefaultSecondaryMonitor หรือ 2 หากไม่พบ |
...
| `-BrowserExtensions` | SwitchParameter | — | — | Named | — | อย่าป้องกันการโหลดส่วนขยายของเบราว์เซอร์ |
...
| `-Language` | String | — | — | 1 | — | แทนที่ภาษาเริ่มต้นของเบราว์เซอร์ หรือเลือก [ทั้งหมด] เพื่อหมุนเวียนทุกภาษาทุกนาที |
| `-DragedNodeBackground` | String | — | — | Named | `$null` | เขียนทับสไตล์สี CSS สำหรับการระบายสีพื้นหลังของโหนดที่กำลังถูกลาก |
| `-FocusedNodeBackground` | String | — | — | Named | `$null` | เขียนทับ css-color-style สำหรับการระบายพื้นหลังของโหนดที่โฟกัส (ตรงกลาง) |
| `-FocusedNodeForeground` | String | — | — | Named | `$null` | แทนที่สไตล์ css-color สำหรับการวาดข้อความ foreground ของโหนดที่โฟกัส (ที่อยู่ตรงกลาง) |
| `-UnFocusedNodeBackground` | String | — | — | Named | `$null` | เขียนทับ css-color-style สำหรับการระบายพื้นหลังของโหนดที่โฟกัส (ตรงกลาง) |
| `-UnFocusedNodeForeground` | String | — | — | Named | `$null` | แทนที่ css-color-style สำหรับการระบายสีข้อความด้านหน้าของโหนดที่ไม่ได้โฟกัส (ตรงกลาง) |
| `-BorderLightColor` | String | — | — | Named | `$null` | เขียนทับ colorstyle ของ css border-light-color เริ่มต้น |
| `-BorderDarkColor` | String | — | — | Named | `$null` | แทนที่สี border-dark-color เริ่มต้นของ CSS |
| `-BorderWidth` | Int32 | — | — | Named | `1` | แทนที่ความกว้างเริ่มต้นสำหรับการวาดขอบของโหนด |
| `-RotationDelaySeconds` | Int32 | — | — | Named | `15` | แทนที่ความกว้างเริ่มต้นสำหรับเวลาหน่วงการหมุนพื้นหลัง |
...
เปิดไทม์ไลน์แบบโต้ตอบพร้อมภาพที่ได้รับแรงบันดาลใจจากแวนโก๊ะเป็นภาษาอังกฤษ
...
เปิดไทม์ไลน์บนจอภาพ 2 โดยใช้นามแฝง
...
เปิดไทม์ไลน์ในโหมดไม่ระบุตัวตนของ Chrome แบบเต็มหน้าจอ
...
> จอภาพที่จะใช้, 0 = ค่าเริ่มต้น, -1 = ยกเลิก, -2 = จอภาพรองที่กำหนดค่าไว้, ค่าเริ่มต้นคือ Global:DefaultSecondaryMonitor หรือ 2 หากไม่พบ
...
> อย่าป้องกันการโหลดส่วนขยายของเบราว์เซอร์
...
> แทนที่ภาษาเริ่มต้นของเบราว์เซอร์ หรือเลือก [ทั้งหมด] เพื่อหมุนเวียนทุกภาษาทุกนาที
...
> เขียนทับสไตล์สี CSS สำหรับการระบายสีพื้นหลังของโหนดที่กำลังถูกลาก
...
> เขียนทับ css-color-style สำหรับการระบายพื้นหลังของโหนดที่โฟกัส (ตรงกลาง)
...
> แทนที่สไตล์ css-color สำหรับการวาดข้อความ foreground ของโหนดที่โฟกัส (ที่อยู่ตรงกลาง)
...
> แทนที่ css-color-style สำหรับการระบายสีข้อความด้านหน้าของโหนดที่ไม่ได้โฟกัส (ตรงกลาง)
...
> เขียนทับ colorstyle ของ css border-light-color เริ่มต้น
...
> แทนที่สี border-dark-color เริ่มต้นของ CSS
...
> แทนที่ความกว้างเริ่มต้นสำหรับการวาดขอบของโหนด
...
> แทนที่ความกว้างเริ่มต้นสำหรับเวลาหน่วงการหมุนพื้นหลัง
