...
> เปิดเกมจำลองการแพร่เชื้อในเว็บเบราว์เซอร์พร้อมตัวเลือกการกำหนดค่าที่ครอบคลุม

## Description

เปิดเกมจำลองการแพร่ระบาดของไวรัสที่ https://viral.genxdev.net/ ในเว็บเบราว์เซอร์ที่ระบุ พร้อมการตั้งค่าหน้าต่าง ตำแหน่ง และลักษณะการทำงานที่ปรับแต่งได้ รองรับหลายเบราว์เซอร์ การเรียกดูแบบส่วนตัว โหมดแอปพลิเคชัน และคุณสมบัติการจัดการหน้าต่างที่ครอบคลุม

ฟังก์ชันนี้ให้ประสบการณ์การจำลองการแพร่ระบาดแบบโต้ตอบพร้อมคุณสมบัติต่างๆ เช่น:
- รองรับหลายเบราว์เซอร์ (Edge, Chrome, Firefox)
- การควบคุมตำแหน่งและขนาดของหน้าต่าง
- ตัวเลือกโหมดเต็มหน้าจอและโหมดแอปพลิเคชัน
- ความสามารถในการเรียกดูแบบส่วนตัว
- รองรับระบบอัตโนมัติของแป้นพิมพ์
- รองรับหลายจอภาพ
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Language` | String | — | — | 0 | — | ภาษาในการแสดงผลเนื้อหาเว็บและการตั้งค่าภาษาของเบราว์เซอร์ |
...
เปิดการจำลองการแพร่ระบาดใน Google Chrome ด้วยโหมดการเรียกดูแบบส่วนตัวและไม่เต็มหน้าจอ
...
เปิดการจำลองการแพร่ระบาดโดยใช้นามแฝงกับ Chrome โหมดไม่ระบุตัวตน และไม่เต็มหน้าจอ

## Parameter Details

### `-Language <String>`

> ภาษาในการแสดงผลเนื้อหาเว็บและการตั้งค่าภาษาของเบราว์เซอร์
