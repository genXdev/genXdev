...
> เปิดเว็บเบราว์เซอร์เพื่อค้นหาเนื้อเพลงของสื่อที่กำลังเล่นใน VLC

## Description

ฟังก์ชันนี้ตรวจจับว่า VLC Media Player กำลังทำงานอยู่หรือไม่ และค้นหาเนื้อเพลงตามชื่อสื่อที่กำลังเล่นอยู่ โดยจะเปิดคำค้นหาในเว็บเบราว์เซอร์โดยอัตโนมัติเพื่อค้นหาเนื้อเพลงสำหรับแทร็กปัจจุบัน ฟังก์ชันนี้รองรับเบราว์เซอร์หลายตัวและมีตัวเลือกการวางตำแหน่งหน้าต่างและการแสดงผลที่หลากหลาย
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Queries` | String[] | — | ✅ (ByValue, ByPropertyName) 🌐 Remaining | 0 | — | คำค้นหาเพื่อหาแทร็ก |
| `-EndPoint` | String | — | — | 1 | `'Google'` | ปลายทางสำหรับเรียกใช้คิวรี |
...
| `-NoBorders` | SwitchParameter | — | — | Named | — | ลบเส้นขอบหน้าต่างออกจากหน้าต่างเบราว์เซอร์ |
| `-SessionOnly` | SwitchParameter | — | — | Named | — | ใช้เซสชันที่ไม่ได้ถูกคงไว้หลังจากปิดเบราว์เซอร์ |
| `-ClearSession` | SwitchParameter | — | — | Named | — | ล้างข้อมูลเซสชันของเบราว์เซอร์ก่อนเปิดเบราว์เซอร์ |
| `-SkipSession` | SwitchParameter | — | — | Named | — | ข้ามการใช้เซสชันเบราว์เซอร์ที่มีอยู่แล้ว |
...
เปิดการค้นหา Google สำหรับเนื้อเพลงของสื่อ VLC ที่กำลังเล่นอยู่
...
เปิดการค้นหาเนื้อเพลงใน Microsoft Edge โดยใช้โหมดส่วนตัว/ไม่ระบุตัวตน
...
> ลบเส้นขอบหน้าต่างออกจากหน้าต่างเบราว์เซอร์
...
> ใช้เซสชันที่ไม่ได้ถูกคงไว้หลังจากปิดเบราว์เซอร์
...
> ล้างข้อมูลเซสชันของเบราว์เซอร์ก่อนเปิดเบราว์เซอร์
...
> ข้ามการใช้เซสชันเบราว์เซอร์ที่มีอยู่แล้ว
