...
> เปิดข้อมูลไซต์ WaybackMachine ในเว็บเบราว์เซอร์

## Description

เปิดการค้นหา Waybackmachine ในเว็บเบราว์เซอร์ แสดงเวอร์ชันประวัติของ URL หรือเว็บไซต์ที่ระบุ รองรับหลายคำค้นหาและการเลือกมอนิเตอร์ ให้การเข้าถึงเนื้อหาเว็บที่เก็บถาวรผ่านบริการ Wayback Machine ของ Internet Archive
...
| `-Language` | String | — | — | 1 | — | การกำหนดค่าภาษาสำหรับอินเทอร์เฟซและเนื้อหาของเบราว์เซอร์ |
...
| `-SessionOnly` | SwitchParameter | — | — | Named | — | ใช้การตั้งค่าสำรองที่เก็บไว้ในเซสชันสำหรับค่ากำหนดของ Wayback Machine |
| `-ClearSession` | SwitchParameter | — | — | Named | — | ล้างการตั้งค่าทางเลือกที่เก็บไว้ในเซสชันสำหรับการตั้งค่า Wayback Machine |
...
เปิดคลัง Wayback Machine สำหรับ example.com บนมอนิเตอร์เริ่มต้น
...
เปิดที่เก็บ Wayback Machine สำหรับ example.com โดยใช้นามแฝงที่มีการยกเลิกการกำหนดตำแหน่งมอนิเตอร์
...
เปิดคลังข้อมูล Wayback Machine สำหรับ microsoft.com ในโหมดไม่ระบุตัวตนของ Chrome
...
> การกำหนดค่าภาษาสำหรับอินเทอร์เฟซและเนื้อหาของเบราว์เซอร์
...
> ใช้การตั้งค่าสำรองที่เก็บไว้ในเซสชันสำหรับค่ากำหนดของ Wayback Machine
...
> ล้างการตั้งค่าทางเลือกที่เก็บไว้ในเซสชันสำหรับการตั้งค่า Wayback Machine
