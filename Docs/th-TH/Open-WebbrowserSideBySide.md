...
> เปิดหน้าต่างเว็บเบราว์เซอร์ใหม่พร้อมตำแหน่งที่ระบุ

## Description

เปิดหน้าต่างเบราว์เซอร์ใหม่ (Edge หรือ Chrome) ที่วางตำแหน่งไว้ทางด้านขวาของจอภาพหลักในโหมดพื้นหลัง
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Url` | String[] | — | ✅ (ByValue) | 0 | — | URL ที่จะเปิดในเบราว์เซอร์ |
