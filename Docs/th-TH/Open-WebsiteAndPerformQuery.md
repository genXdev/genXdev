...
> เปิดหน้าเว็บในเว็บเบราว์เซอร์และดำเนินการค้นหาหนึ่งรายการขึ้นไป

## Description

ฟังก์ชันนี้เปิดเว็บไซต์ตาม URL ในเว็บเบราว์เซอร์เริ่มต้น ป้อนหนึ่งข้อความค้นหาหรือมากกว่าแล้วส่งข้อความเหล่านั้น รองรับการเลือกจอภาพและตัวเลือกการวางตำแหน่งหน้าต่างที่ครอบคลุมผ่านฟังก์ชัน Open-Webbrowser ที่อยู่เบื้องหลัง

ฟังก์ชันจะคัดลอกแต่ละข้อความค้นหาไปยังคลิปบอร์ดโดยอัตโนมัติและส่งไปยังหน้าต่างเบราว์เซอร์โดยใช้ระบบอัตโนมัติของแป้นพิมพ์ โดยจะเก็บเนื้อหาคลิปบอร์ดเดิมไว้และเรียกคืนหลังจากประมวลผลข้อความค้นหาทั้งหมดแล้ว
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Url` | String | ✅ | ✅ (ByPropertyName) | 0 | — | URL ของเว็บไซต์ที่ต้องการเปิด |
...
| `-SendKeyDelayMilliSeconds` | Int32 | — | — | Named | `500` | ความล่าช้าระหว่างการส่งลำดับคีย์ต่างๆ ในหน่วยมิลลิวินาที |
...
เปิด Google และค้นหา "PowerShell"
...
เปิด Google และค้นหา "บทเรียน PowerShell" บนจอภาพเริ่มต้น
