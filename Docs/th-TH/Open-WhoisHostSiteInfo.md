...
> เปิดการสอบถามข้อมูลโฮสต์ Whois ในเว็บเบราว์เซอร์

## Description

เปิดการค้นหาข้อมูลโฮสต์ Whois ในเว็บเบราว์เซอร์สำหรับชื่อโดเมนหรือที่อยู่ IP รองรับการเลือกมอนิเตอร์ที่ปรับแต่งได้และการค้นหาหลายรายการพร้อมตัวเลือกการกำหนดค่าเบราว์เซอร์ที่ครอบคลุม รวมถึงการจัดตำแหน่งหน้าต่าง การเลือกเบราว์เซอร์ และคุณสมบัติอัตโนมัติ
...
| `-SessionOnly` | SwitchParameter | — | — | Named | — | ใช้การตั้งค่าสำรองที่จัดเก็บในเซสชันสำหรับค่ากำหนด AI เช่น ภาษา อัลบั้มรูปภาพ ฯลฯ |
| `-ClearSession` | SwitchParameter | — | — | Named | — | ล้างการตั้งค่าสำรองที่จัดเก็บในเซสชันสำหรับการตั้งค่าปัญญาประดิษฐ์ เช่น ภาษา คลังรูปภาพ ฯลฯ |
| `-SkipSession` | SwitchParameter | — | — | Named | — | จัดเก็บการตั้งค่าเฉพาะในค่ากำหนดถาวรโดยไม่ส่งผลกระทบต่อเซสชันสำหรับการตั้งค่า AI เช่น ภาษา, คอลเล็กชันรูปภาพ ฯลฯ |
...
เปิดข้อมูล Whois สำหรับหลายโดเมนบนหน้าจอมอนิเตอร์เริ่มต้น
...
เปิดข้อมูล Whois สำหรับ example.com โดยใช้นามแฝงและพารามิเตอร์ตำแหน่ง
...
เปิดข้อมูล Whois สำหรับโดเมนจากไปป์ไลน์ในโหมดส่วนตัวของ Chrome
...
> ใช้การตั้งค่าสำรองที่จัดเก็บในเซสชันสำหรับค่ากำหนด AI เช่น ภาษา อัลบั้มรูปภาพ ฯลฯ
...
> ล้างการตั้งค่าสำรองที่จัดเก็บในเซสชันสำหรับการตั้งค่าปัญญาประดิษฐ์ เช่น ภาษา คลังรูปภาพ ฯลฯ
...
> จัดเก็บการตั้งค่าเฉพาะในค่ากำหนดถาวรโดยไม่ส่งผลกระทบต่อเซสชันสำหรับการตั้งค่า AI เช่น ภาษา, คอลเล็กชันรูปภาพ ฯลฯ
