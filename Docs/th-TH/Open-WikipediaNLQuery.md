...
> เปิดการค้นหาภาษาดัตช์ของ Wikipedia ในเว็บเบราว์เซอร์

## Description

เปิดการค้นหา 'Wikipedia - The Netherlands' ในเว็บเบราว์เซอร์ พร้อมตัวเลือกการแสดงผลที่ปรับแต่งได้ รองรับการค้นหาหลายคำและระบุจอภาพที่จะแสดงผลลัพธ์
...
| `-SideBySide` | SwitchParameter | — | — | Named | — | เปิดหน้าต่างเบราว์เซอร์สองหน้าต่างเคียงข้างกัน |
| `-SessionOnly` | SwitchParameter | — | — | Named | — | ใช้คุกกี้เฉพาะเซสชันเท่านั้น (ไม่มีคุกกี้ถาวร) |
| `-ClearSession` | SwitchParameter | — | — | Named | — | ล้างข้อมูลเซสชันเบราว์เซอร์ก่อนเปิด |
...
> เปิดหน้าต่างเบราว์เซอร์สองหน้าต่างเคียงข้างกัน
...
> ใช้คุกกี้เฉพาะเซสชันเท่านั้น (ไม่มีคุกกี้ถาวร)
...
> ล้างข้อมูลเซสชันเบราว์เซอร์ก่อนเปิด
