...
> เปิดการค้นหาวิกิพีเดียในเว็บเบราว์เซอร์

## Description

เปิดการค้นหาวิกิพีเดียอย่างน้อยหนึ่งรายการในเว็บเบราว์เซอร์พร้อมตัวเลือกการกำหนดค่าที่ครอบคลุม รองรับพฤติกรรมของเบราว์เซอร์ที่ปรับแต่งได้ การเลือกจอภาพ และการวางตำแหน่งหน้าต่าง คำค้นหาจะถูกเข้ารหัส URL และเปิดโดยใช้โดเมนวิกิพีเดียในภาษาที่ระบุพร้อมการรองรับการแปลเป็นภาษาท้องถิ่นเต็มรูปแบบ

ฟังก์ชันนี้ให้การควบคุมเบราว์เซอร์ที่ครอบคลุม รวมถึงโหมดการเรียกดูส่วนตัว การวางตำแหน่งหน้าต่าง ระบบอัตโนมัติของแป้นพิมพ์ และการรองรับหลายจอภาพ นอกจากนี้ยังจัดการการเข้ารหัส URL และการจับคู่รหัสภาษาโดยอัตโนมัติสำหรับโดเมนวิกิพีเดียนานาชาติ
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Queries` | String[] | ✅ | ✅ (ByValue, ByPropertyName) | 0 | — | คำค้นหาในวิกิพีเดียที่ต้องดำเนินการ |
| `-Language` | String | — | — | 1 | — | ภาษาของผลการค้นหาจากวิกิพีเดีย |
...
| `-Monitor` | Int32 | — | — | Named | `-1` | จอภาพที่จะใช้ 0 = ค่าเริ่มต้น, -1 = ไม่แสดงผล, -2 = จอภาพรองที่กำหนดค่าไว้ |
...
| `-PassThru` | SwitchParameter | — | — | Named | — | ส่งกลับวัตถุกระบวนการ PowerShell ที่แทนกระบวนการเบราว์เซอร์ |
...
เปิดการค้นหา Wikipedia สำหรับ "PowerShell" เป็นภาษาอังกฤษบนจอภาพเริ่มต้น
...
เปิดการค้นหาวิกิพีเดียโดยใช้นามแฝงพร้อมพารามิเตอร์ตำแหน่ง
...
ค้นหาคำศัพท์หลายคำในวิกิพีเดียภาษาเยอรมันโดยใช้โหมดการเรียกดูแบบส่วนตัว

## Parameter Details

### `-Queries <String[]>`

> คำค้นหาในวิกิพีเดียที่ต้องดำเนินการ
...
> ภาษาของผลการค้นหาจากวิกิพีเดีย
...
> จอภาพที่จะใช้ 0 = ค่าเริ่มต้น, -1 = ไม่แสดงผล, -2 = จอภาพรองที่กำหนดค่าไว้
...
> ส่งกลับวัตถุกระบวนการ PowerShell ที่แทนกระบวนการเบราว์เซอร์
