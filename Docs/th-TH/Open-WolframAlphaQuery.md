...
> เปิดการค้นหา Wolfram Alpha ในเว็บเบราว์เซอร์

## Description

เปิดหนึ่งรายการขึ้นไปของ Wolfram Alpha ในเว็บเบราว์เซอร์ รองรับการเลือกมอนิเตอร์และตัวเลือกเบราว์เซอร์ที่กำหนดค่าได้ผ่านพารามิเตอร์แบบไดนามิก ให้ความสามารถในการควบคุมเบราว์เซอร์อย่างครอบคลุม รวมถึงการวางตำแหน่ง การปรับขนาด และคุณสมบัติอัตโนมัติสำหรับเวิร์กโฟลว์การคำนวณทางวิทยาศาสตร์ที่ได้รับการปรับปรุง
...
| `-SendKeyEscape` | SwitchParameter | — | — | Named | — | หนีอักขระควบคุมเมื่อส่งคีย์ |
| `-SendKeyHoldKeyboardFocus` | SwitchParameter | — | — | Named | — | ป้องกันการคืนโฟกัสของแป้นพิมพ์กลับไปยัง PowerShell หลังจากส่งคีย์ |
| `-SendKeyUseShiftEnter` | SwitchParameter | — | — | Named | — | ส่ง Shift+Enter แทน Enter ปกติสำหรับการขึ้นบรรทัดใหม่เมื่อส่งคีย์ |
...
| `-PassThru` | SwitchParameter | — | — | Named | — | ส่งคืนออบเจ็กต์ [System.Diagnostics.Process] ของกระบวนการเบราว์เซอร์ |
...
เปิดการค้นหา Wolfram Alpha สำหรับมวลดวงอาทิตย์บนจอภาพหลัก
...
เปิดการค้นหา Wolfram Alpha หลายรายการโดยใช้นามแฝงสำหรับการคำนวณทางวิทยาศาสตร์อย่างรวดเร็ว
...
เปิดคำสั่งแคลคูลัสในโหมดเต็มหน้าจอโดยกำหนดภาษาเป็นภาษาอังกฤษ
ผ่านอินพุตแบบไปป์ไลน์
...
> ส่ง Shift+Enter แทน Enter ปกติสำหรับการขึ้นบรรทัดใหม่เมื่อส่งคีย์
...
> ส่งคืนออบเจ็กต์ [System.Diagnostics.Process] ของกระบวนการเบราว์เซอร์
