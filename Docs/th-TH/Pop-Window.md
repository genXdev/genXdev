...
> นำตัวช่วยหน้าต่างที่ใช้งานล่าสุดออกจากสแต็ก โดยสามารถปรับเปลี่ยนได้ตามต้องการ

## Description

ดึงหน้าต่างช่วยออกจากสแต็กและสามารถใช้การแปลงหน้าต่างได้ตามต้องการ
หากสแต็กว่างเปล่าหรือมีหน้าต่างที่ไม่ถูกต้อง ให้คืนค่าหน้าต่างที่กำลังโฟกัสอยู่ในปัจจุบัน
ฟังก์ชันนี้ช่วยให้คุณจัดการหน้าต่างที่เคยบันทึกไว้ด้วย Push-Window โดยใช้การปรับตำแหน่ง ขนาด และเอฟเฟกต์ภาพต่างๆ
