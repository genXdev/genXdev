...
> ผลักหน้าต่างปัจจุบันไปยังสแต็กหน้าต่างโดยมีการปรับเปลี่ยนตามตัวเลือก

## Description

ดันตัวช่วยหน้าต่างสำหรับหน้าต่างที่โฟกัสอยู่ในปัจจุบันขึ้นไปบนสแต็ก
อนุญาตให้ใช้การแปลงหน้าต่างต่างๆ ก่อนหรือหลังการดัน
ฟังก์ชันนี้จะจับภาพหน้าต่างปัจจุบันและเก็บไว้เพื่อเรียกคืนในภายหลัง
ด้วย Pop-Window โดยสามารถกำหนดตำแหน่ง ขนาด และเอฟเฟกต์ภาพได้ตามต้องการ
