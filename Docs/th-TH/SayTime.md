...
> ประกาศเวลาปัจจุบันโดยใช้ข้อความเป็นเสียงพูด

## Description

ฟังก์ชันนี้จะรับเวลาในปัจจุบันและใช้ระบบข้อความเป็นเสียงของระบบ
เพื่อประกาศเวลาออกมาในรูปแบบชั่วโมงและนาที มีประโยชน์สำหรับ
การช่วยเหลือการเข้าถึงหรือเมื่อคุณต้องการการประกาศเวลาที่ได้ยินได้
