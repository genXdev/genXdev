...
> ตั้งค่าไฟล์ไปยังคลิปบอร์ดของ Windows สำหรับการดำเนินการกับไฟล์ เช่น การคัดลอก/วาง

## Description

ฟังก์ชันนี้คัดลอกหนึ่งหรือหลายเส้นทางไฟล์ไปยังคลิปบอร์ดของ Windows
ทำให้สามารถดำเนินการกับไฟล์ได้ เช่น การวางใน Windows Explorer โดยจัดการ
โหมดเธรดทั้ง STA และ MTA โดยอัตโนมัติ ทำให้รองรับกับบริบทการทำงาน
ของ PowerShell ที่แตกต่างกัน ฟังก์ชันจะตรวจสอบการมีอยู่ของไฟล์ก่อนเพิ่ม
เส้นทางไปยังคลิปบอร์ด
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-InputObject` | String[] | ✅ | ✅ (ByValue, ByPropertyName) | 0 | — | อาร์เรย์ของเส้นทางไฟล์ที่จะเพิ่มไปยังคลิปบอร์ด |
...
> อาร์เรย์ของเส้นทางไฟล์ที่จะเพิ่มไปยังคลิปบอร์ด
