...
> แก้ไขเส้นทางจริงของโฟลเดอร์ที่รู้จักใน Windows

## Description

ใช้ API Shell32 ของ Windows เพื่อย้ายโฟลเดอร์ระบบ เช่น เอกสาร ดาวน์โหลด เดสก์ท็อป หรือโฟลเดอร์ Windows ที่รู้จักอื่น ๆ ไปยังตำแหน่งใหม่ ฟังก์ชันนี้จะตรวจสอบว่าเส้นทางเป้าหมายมีอยู่ ค้นหา GUID เฉพาะของโฟลเดอร์จากรีจิสทรีของโฟลเดอร์ที่รู้จัก และใช้ API SHSetKnownFolderPath เพื่อดำเนินการย้าย กรณีการใช้งานทั่วไปรวมถึงการย้ายโฟลเดอร์ผู้ใช้ไปยังไดรฟ์อื่นเพื่อจัดการพื้นที่หรือจัดระเบียบ ควรใช้ความระมัดระวังเมื่อย้ายโฟลเดอร์ที่สำคัญต่อระบบ เนื่องจากอาจส่งผลต่อความเสถียรของระบบ
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-KnownFolder` | String | ✅ | — | 0 | — | โฟลเดอร์ที่รู้จักเพื่อแก้ไข |
| `-Path` | String | ✅ | — | 1 | — | เส้นทางใหม่สำหรับโฟลเดอร์ที่รู้จัก |
...
> เส้นทางใหม่สำหรับโฟลเดอร์ที่รู้จัก
