...
ใช้ Windows API ผ่าน GenXdev.Helpers.WindowObj เพื่อปลุกจอภาพจากสถานะพักเครื่อง/ปิดเครื่อง ซึ่งมีประโยชน์สำหรับสคริปต์อัตโนมัติที่ต้องการให้แน่ใจว่าจอภาพเปิดอยู่
