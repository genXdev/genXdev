...
> กำหนดการจัดตำแหน่งแถบงานใน Windows 11+ ระหว่างตำแหน่งกึ่งกลางและซ้าย

## Description

กำหนดการจัดวางแถบงานใน Windows 11 และรุ่นที่ใหม่กว่าโดยการแก้ไขรีจิสตรีคีย์ 'TaskbarAl' ภายใต้ HKCU:\SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer\Advanced การจัดวางสามารถตั้งค่าให้อยู่กึ่งกลาง (ค่า 1) หรือชิดซ้าย (ค่า 0)
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Justify` | String | ✅ | — | 0 | — | การจัดตำแหน่งแถบงาน (กึ่งกลางหรือซ้าย) |
...
> การจัดตำแหน่งแถบงาน (กึ่งกลางหรือซ้าย)
