...
> นำทางแท็บเบราว์เซอร์ปัจจุบันไปยัง URL ที่ระบุ

## Description

กำหนดตำแหน่ง (URL) ของแท็บเว็บเบราว์เซอร์ที่เลือกอยู่ในปัจจุบัน รองรับทั้ง
เบราว์เซอร์ Edge และ Chrome ผ่านสวิตช์เสริม การนำทางรวมถึง
การตรวจสอบความถูกต้องของ URL และรับประกันการโหลดหน้าที่เหมาะสมผ่านการทำงานแบบอะซิงโครนัส
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Url` | String | ✅ | ✅ (ByValue, ByPropertyName) | 0 | — | URL ที่จะนำทางไป |
| `-NoAutoSelectTab` | SwitchParameter | — | — | Named | — | ป้องกันการเลือกแท็บโดยอัตโนมัติ |
| `-Edge` | SwitchParameter | — | — | Named | — | นำทางโดยใช้เบราว์เซอร์ Microsoft Edge *(Parameter set: )* |
| `-Chrome` | SwitchParameter | — | — | Named | — | นำทางโดยใช้เบราว์เซอร์ Google Chrome *(Parameter set: )* |
| `-Chromium` | SwitchParameter | — | — | Named | — | นำทางโดยใช้ Microsoft Edge หรือ Google Chrome ขึ้นอยู่กับว่าเบราว์เซอร์เริ่มต้นคืออะไร |
| `-Firefox` | SwitchParameter | — | — | Named | — | นำทางโดยใช้เบราว์เซอร์ Firefox |
| `-Webkit` | SwitchParameter | — | — | Named | — | นำทางโดยใช้เบราว์เซอร์ WebKit ที่จัดการโดย Playwright |
...
> นำทางโดยใช้เบราว์เซอร์ Microsoft Edge
...
> นำทางโดยใช้เบราว์เซอร์ Google Chrome
...
> นำทางโดยใช้ Microsoft Edge หรือ Google Chrome ขึ้นอยู่กับว่าเบราว์เซอร์เริ่มต้นคืออะไร
...
> นำทางโดยใช้เบราว์เซอร์ Firefox
...
> นำทางโดยใช้เบราว์เซอร์ WebKit ที่จัดการโดย Playwright
