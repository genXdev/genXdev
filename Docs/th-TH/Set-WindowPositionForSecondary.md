...
> วางตำแหน่งหน้าต่างบนจอภาพรองด้วยตัวเลือกเค้าโครงที่ระบุ

## Description

ฟังก์ชันนี้ช่วยให้สามารถวางตำแหน่งหน้าต่างบนจอภาพรองที่กำหนดค่าไว้ โดยใช้ Set-WindowPosition พร้อมตัวเลือกเค้าโครงต่างๆ รวมถึงการจัดตำแหน่ง ขนาด และการตั้งค่าขอบเขต ฟังก์ชันจะจัดการการเลือกจอภาพตามการกำหนดค่าระดับโลก และให้ตัวห่อหุ้มที่สะดวกสำหรับการวางตำแหน่งหน้าต่างบนจอภาพรอง
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Process` | Diagnostics.Process[] | — | ✅ (ByValue, ByPropertyName) | 0 | — | กระบวนการของหน้าต่างในการวางตำแหน่ง |
| `-Monitor` | Int32 | — | — | Named | `-2` | จอภาพที่จะใช้ 0=ค่าเริ่มต้น, -1=ละทิ้ง, -2=กำหนดค่าเอง |
| `-Width` | Int32 | — | — | Named | `-1` | ความกว้างเริ่มต้นของหน้าต่าง |
| `-Height` | Int32 | — | — | Named | `-1` | ความสูงเริ่มต้นของหน้าต่าง |
| `-X` | Int32 | — | — | Named | `-999999` | ตำแหน่ง X เริ่มต้นของหน้าต่าง |
| `-Y` | Int32 | — | — | Named | `-999999` | ตำแหน่ง Y เริ่มต้นของหน้าต่าง |
...
| `-FocusWindow` | SwitchParameter | — | — | Named | — | โฟกัสหน้าต่างหลังจากจัดตำแหน่ง |
| `-SetForeground` | SwitchParameter | — | — | Named | — | ตั้งค่าหน้าต่างให้อยู่เบื้องหน้าหลังจากจัดตำแหน่ง |
...
| `-KeysToSend` | String[] | — | — | Named | — | การกดแป้นพิมพ์ที่จะส่งไปยังหน้าต่างหลังจากวางตำแหน่ง |
...
| `-PassThru` | SwitchParameter | — | — | Named | — | ส่งกลับออบเจ็กต์กระบวนการหลังจากกำหนดตำแหน่ง |
| `-SideBySide` | SwitchParameter | — | — | Named | — | วางหน้าต่างเคียงข้างกับ PowerShell บนจอภาพเดียวกัน |
...
> จอภาพที่จะใช้ 0=ค่าเริ่มต้น, -1=ละทิ้ง, -2=กำหนดค่าเอง
...
> โฟกัสหน้าต่างหลังจากจัดตำแหน่ง
...
> ตั้งค่าหน้าต่างให้อยู่เบื้องหน้าหลังจากจัดตำแหน่ง
...
> การกดแป้นพิมพ์ที่จะส่งไปยังหน้าต่างหลังจากวางตำแหน่ง
...
> ส่งกลับออบเจ็กต์กระบวนการหลังจากกำหนดตำแหน่ง
...
> วางหน้าต่างเคียงข้างกับ PowerShell บนจอภาพเดียวกัน
