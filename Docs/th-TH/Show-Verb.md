...
> แสดงรายการคำกริยาของ PowerShell ทั้งหมดแบบเรียงลำดับตามตัวอักษรสั้นๆ

## Description

แสดงคำกริยาที่ได้รับการอนุมัติของ PowerShell ในรายการที่คั่นด้วยเครื่องหมายจุลภาค หากระบุคำกริยาเฉพาะเป็นอินพุต จะแสดงเฉพาะคำกริยาที่ตรงกันเท่านั้น รองรับอักขระตัวแทน
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Verb` | String[] | — | ✅ (ByValue, ByPropertyName) | 0 | `@()` | รูปแบบกริยาตั้งแต่หนึ่งรูปแบบขึ้นไปสำหรับกรอง (รองรับอักขระตัวแทน) 🌐 *Supports wildcards* |
...
> รูปแบบกริยาตั้งแต่หนึ่งรูปแบบขึ้นไปสำหรับกรอง (รองรับอักขระตัวแทน)
