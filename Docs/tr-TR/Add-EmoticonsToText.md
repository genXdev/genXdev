...
> Yapay zeka kullanarak bağlama uygun emoticonlar ekleyerek metni zenginleştirir.

## Description

Bu işlev, duygusal bağlamla eşleşen emojiler eklemek için giriş metnini işler. Girişi doğrudan parametreler, işlem hattı veya sistem panosu aracılığıyla kabul edebilir. İşlev, metni analiz etmek ve uygun emojileri seçmek için AI modellerinden yararlanarak mesajları daha anlamlı ve etkileyici hale getirir.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Text` | String | — | ✅ (ByValue) | 0 | — | Geliştirilecek metin 👍 😄 |
