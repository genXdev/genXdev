...
> README.md dosyasına bir fikir öğesi ekler.

## Description

Bir README.md dosyasının "## Fikirler" bölümüne zaman damgalı bir fikir ekler.
Değiştirilen bölümü görüntüleyebilir ve Visual Studio Code'da açabilir.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Line` | String | — | — | 0 | `''` | Eklenecek fikir metni |
