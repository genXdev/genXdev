...
> README.md dosyasına bir yapılacak öğe ekler.

## Description

README.md dosyasının "## Todoos" bölümüne zaman damgalı bir yapılacak öğesi ekler. Yapılacak öğeleri tamamlandı olarak işaretlenebilir ve değiştirilen bölüm görüntülenebilir. Tamamlandı olarak işaretlenmediği sürece her yeni yapılacak öğesine otomatik olarak zaman damgası eklenir.
...
> Yapılacak öğeyi tamamlandı olarak işaretle
