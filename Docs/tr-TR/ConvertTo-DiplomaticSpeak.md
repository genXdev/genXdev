...
> Kaba veya doğrudan metni kibar, diplomatik bir dile dönüştürür.

## Description

Bu işlev, kullanıcı girdisini doğrudan veya sert ifadelerden diplomatik, incelikli bir dile dönüştürerek üst düzey tartışmalar, müzakereler veya resmi iletişimler için uygun hale getirir. İşlev, orijinal amacı korurken tonu yumuşatmak ve mesajı daha diplomatik ve profesyonel kılmak için yapay zeka dil modellerini kullanır.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Text` | String | — | ✅ (ByValue) | 0 | — | Diplomasi diline çevrilecek metin |
...
> Diplomasi diline çevrilecek metin
