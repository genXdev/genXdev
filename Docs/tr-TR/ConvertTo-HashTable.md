...
> Bir PSCustomObject'i yinelemeli olarak bir HashTable'a dönüştürür.

## Description

* Bu işlev, bir PSCustomObject'i ve onun tüm iç içe geçmiş PSCustomObject özelliklerini HashTable'lara dönüştürür.
* Dizileri ve diğer koleksiyon türlerini, her bir öğeyi yinelemeli olarak işleyerek ele alır.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-InputObject` | Object | ✅ | ✅ (ByValue) | 0 | — | HashTable'a dönüştürülecek PSCustomObject |
...
Bir PSCustomObject'i iç içe özelliklerle bir HashTable'a dönüştürün.

## Parameter Details

### `-InputObject <Object>`

> HashTable'a dönüştürülecek PSCustomObject
