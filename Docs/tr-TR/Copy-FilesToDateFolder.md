...
> Arama kriterleriyle eşleşen dosyaları tarih bazlı alt klasörlere kopyalar.

## Description

Dosyaları, `Find-Item` ile aynı parametre kümesini kullanarak arar ve eşleşen her dosyayı, dosyanın oluşturulma veya medya tarihine göre `TargetFolder` içindeki bir alt klasöre kopyalar. Cmdlet, içerik eşleştirme, sürücü genelinde aramalar ve birçok filtreyi destekler.

Belirtilen dosya için doğru bir oluşturulma veya çekim tarihi belirlemek amacıyla birkaç strateji dener. Stratejiler arasında resim EXIF meta verilerini okuma, dosya adlarından tarih/saat bilgisi ayrıştırma ve başka güvenilir bilgi olmadığında dosyanın son yazma zamanına geri dönme yer alır.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-TargetFolder` | String | ✅ | — | 0 | — | Eşleşen dosyaların tarih tabanlı alt klasörlere kopyalanacağı hedef kök klasör |
...
> Eşleşen dosyaların tarih tabanlı alt klasörlere kopyalanacağı hedef kök klasör
