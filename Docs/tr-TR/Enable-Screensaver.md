...
> Yapılandırılan Windows ekran koruyucusunu başlatır.

## Description

Varsayılan ekran koruyucu yürütülebilir dosyasını (scrnsave.scr) /s anahtarıyla çalıştırarak Windows sistem ekran koruyucusunu hemen başlatır.
