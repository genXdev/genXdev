...
> Şu anda etkin olan sistem işlemlerinden benzersiz kullanıcı adlarının bir listesini alır.

## Description

Sistemdeki tüm çalışan işlemleri sorgular, her işlemle ilişkili kullanıcı adını çıkarır ve aktif işlemi olan kullanıcıların yinelenmeyen bir listesini döndürür. Bu, sistem yönetimi ve güvenlik izleme için kullanışlıdır.
