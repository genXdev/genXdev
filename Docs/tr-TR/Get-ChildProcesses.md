...
> Geçerli PowerShell işleminin alt işlemleri olan tüm işlemleri alır.

## Description

* Tüm çalışan işlemleri inceler ve ana işlem zincirinde geçerli PowerShell işlemini ata olarak içerenleri tanımlar.
* Bu hem doğrudan alt işlemleri hem de onların soyundan gelenleri (torunlar vb.) içerir.
...
Geçerli PowerShell oturumunun tüm alt işlemlerini alın.
...
Ayrıntılı işlem algılama bilgisi ile alt işlemleri ayrıntılı çıktıyla al.
