...
> Klavye odağına sahip pencerenin işlem nesnesini alır.

## Description

* Bu cmdlet, P/Invoke aracılığıyla Windows API çağrılarını kullanarak o anda odaklanmış pencereyle ilişkili İşlem nesnesini tanımlar ve döndürür.
* Hangi pencerenin odağa sahip olduğunu belirlemek ve ilişkili işlem kimliğini almak için User32.dll işlevleri GetForegroundWindow ve GetWindowThreadProcessId'den yararlanır.
...
O anda klavye odağına sahip olan pencere için işlem nesnesini alır.
