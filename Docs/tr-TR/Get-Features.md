...
> Bir README.md dosyasındaki özellikleri görüntüler.

## Description

Bir README.md dosyasının "## Özellikler" bölümünden tüm özellikleri gösterir. Geçerli konumdaki, PowerShell profil dizinindeki veya OneDrive dizinindeki README'yi kullanabilir.
