...
> GenXdev PowerShell modülleri hakkında ayrıntılı bilgiler alır.

## Description

Bu işlev, GenXdev PowerShell modüllerini inceler ve bunların yapılandırması, sürümleri ve anahtar dosyalarının varlığı hakkında bilgi döndürür. Belirtilen modülleri veya mevcut tüm modülleri işleyebilir.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-ModuleName` | String[] | — | ✅ (ByValue, ByPropertyName) | 0 | `@()` | Analiz edilecek modüllerin adları |
...
> Analiz edilecek modüllerin adları
