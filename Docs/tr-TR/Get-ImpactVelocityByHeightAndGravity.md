...
> Yükseklikten çarpma hızını hesaplar.

## Description

Hava direncini ihmal ederek v = sqrt(2 g h) kullanır.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-HeightInMeters` | Double | ✅ | — | 0 | `0` | Metre cinsinden yükseklik |
| `-GravityInMetersPerSecondSquared` | Double | — | — | 1 | `0` | m/s² cinsinden yerçekimi. Varsayılan 9.81. |
| `-As` | String | — | — | 2 | — | Hız için çıktı birimi. Varsayılan 'm/s'. |
...
100 metrelik bir düşüş için çarpma hızını hesaplar ve km/saat cinsinden verir.
...
Varsayılan birimleri kullanarak 50 metrelik bir düşüş için çarpma hızını hesaplar.
...
> Hız için çıktı birimi. Varsayılan 'm/s'.
