...
> Bir README.md dosyasından sorunları görüntüler.

## Description

Bir README.md dosyasının "## Issues" bölümündeki tüm sorunları gösterir. Geçerli konumdaki, PowerShell profil dizinindeki veya OneDrive dizinindeki README'yi kullanabilir.
