...
> Windows Shell32 API'sini kullanarak bir Windows bilinen klasörünün yolunu alır.

## Description

Shell32 API'sindeki SHGetKnownFolderPath işlevini kullanarak belirtilen bir Windows bilinen klasörünün yolunu alır. Bu yöntem, ortam değişkenlerini kullanmaktan daha güvenilirdir çünkü farklı Windows sürümleri ve dil ayarlarında tutarlı bir şekilde çalışır. Belgeler, İndirilenler, AppData gibi tüm standart Windows bilinen klasörlerini destekler.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-KnownFolder` | String | ✅ | — | 0 | — | Yolun alınacağı bilinen Windows klasör adı |
...
> Yolun alınacağı bilinen Windows klasör adı
