...
> Windows Defender MpCmdRun.exe yürütülebilir dosyasının yolunu alır.

## Description

* Windows Defender komut satırı yardımcı programının (MpCmdRun.exe) tam yolunu bulur ve döndürür.
* Cmdlet, Program Files'daki standart kurulum konumunu kontrol eder ve dosya bulunamazsa uygun hata işleme sağlar.
...
Windows Defender komut satırı aracının tam yolunu alır.
