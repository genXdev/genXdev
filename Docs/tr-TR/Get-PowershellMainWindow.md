...
> PowerShell terminalinin ana penceresi için bir pencere yardımcı nesnesi döndürür.

## Description

* Geçerli PowerShell ana bilgisayar işleminin ana penceresini temsil eden bir WindowObj yardımcı nesnesi alır.
* Bu, terminal penceresinin kendisini değiştirmeye ve etkileşime izin verir.
...
Geçerli PowerShell terminal penceresi için WindowObj'yi alır.
