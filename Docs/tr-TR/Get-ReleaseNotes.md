...
> Bir README.md dosyasından ReleaseNotes'ları görüntüler.

## Description

Bir README.md dosyasının "## Release notes" bölümündeki tüm Sürüm Notlarını gösterir. Geçerli konumdaki, PowerShell profil dizinindeki veya OneDrive dizinindeki README'yi kullanabilir.
