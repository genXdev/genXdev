...
> Bir SQL veritabanı tablosundan, isteğe bağlı kayıt sınırlaması ile veri alır.

## Description

Bu işlev, bir bağlantı dizesi veya veritabanı dosya yolu kullanarak bir SQL veritabanı tablosundan veri sorgular. Veritabanına bağlanma ve Count parametresi aracılığıyla alınan veri miktarını kontrol etme konusunda esneklik sağlar.
...
| `-TableName` | String | ✅ | — | 2 | — | Veri sorgulamak için tablonun adı. |
| `-Count` | Int32 | — | — | 3 | `100` | Döndürülecek maksimum kayıt sayısı. Tümü için -1. |
