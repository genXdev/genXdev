...
> Belirtilen bir SQL Server tablosu için şema bilgilerini alır.

## Description

Bu işlev, belirtilen bir tablo için ayrıntılı şema bilgisi almak üzere SQL Server veritabanını sorgular. Sütun adları, türleri, boş değer kabul edilebilirliği ve varsayılan değerler dahil olmak üzere sütun tanımlarını döndürmek için SQL Server INFORMATION_SCHEMA.COLUMNS görünümünü kullanır.
...
| `-TableName` | String | ✅ | — | 2 | — | Tablonun adı |
