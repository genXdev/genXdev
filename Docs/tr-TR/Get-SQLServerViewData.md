...
> Bir SQL veritabanı görünümünden isteğe bağlı kayıt sınırlamasıyla veri alır.

## Description

Bir SQL veritabanı görünümünü bir bağlantı dizesi veya veritabanı dosya yolu kullanarak sorgular. İşlev, döndürülen kayıtların sayısını sınırlamayı destekler ve sorgu yürütmeyi izlemek için ayrıntılı çıktı sağlar.
...
| `-ViewName` | String | ✅ | — | 2 | — | Sorgulanacak görünümün adı. |
| `-Count` | Int32 | — | — | 3 | `100` | Döndürülecek kayıt sayısı. Tüm kayıtlar için -1. |
