...
> Belirli bir sürede sesin kat ettiği mesafeyi hesaplar.

## Description

Mesafe = hız * zaman formülünü kullanır, varsayılan olarak havadaki ses hızını alır.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-TimeInSeconds` | Double | ✅ | — | 0 | `0` | Saniye cinsinden süre |
| `-SpeedOfSoundInMetersPerSecond` | Double | — | — | 1 | `0` | Ses hızı (varsayılan: 343) m/s cinsinden *(Parameter set: )* |
| `-Medium` | String | ✅ | — | 1 | — | Sesin içinde yayıldığı ortam *(Parameter set: )* |
| `-As` | String | — | — | 2 | — | Çıktı mesafesi için birim |
...
Sesin 5 saniyede suda ne kadar uzağa gittiğini hesaplar ve sonucu kilometreye dönüştürür.
...
Belirli bir ses hızını kullanarak mesafeyi hesaplar.
...
> Ses hızı (varsayılan: 343) m/s cinsinden
