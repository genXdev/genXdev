...
> README.md dosyasındaki yapılacak işler öğelerini görüntüler.

## Description

README.md dosyasının "## Todoos" bölümündeki tüm yapılacak öğelerini gösterir. Geçerli konumdaki, PowerShell profil dizinindeki veya OneDrive dizinindeki README'yi kullanabilir.
