...
> GenXdev JavaScript yer imi uygulamalarını tarayıcı yer imi koleksiyonlarına aktarır.

## Description

Bu işlev, GenXdev yer imi dosyalarını uzantıyla birlikte bir dizini tarar.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-SnippetsPath` | String | — | — | 0 | `"$($MyInvocation.MyCommand.Module.ModuleBase)\Bookmarklets"` | Yer imi kod parçacığı dosyalarını içeren dizinin yolu |
| `-TargetFolder` | String | — | — | 1 | `""` | Tarayıcı yer imi yapısındaki hedef yer imi klasörü |
| `-Edge` | SwitchParameter | — | — | Named | — | Microsoft Edge tarayıcısına yer imi ekleme |
| `-Chrome` | SwitchParameter | — | — | Named | — | Yer imi kodlarını Google Chrome tarayıcısına aktarın |
| `-Firefox` | SwitchParameter | — | — | Named | — | Mozilla Firefox tarayıcısına yer imi ekle |
...
Varsayılan snippet dizinindeki tüm bookmarklet dosyalarını Microsoft Edge'in yer imi çubuğu klasörüne aktarır.
...
İçe aktarma işlemini gerçekleştirmeden, belirtilen yoldan Google Chrome'a hangi bookmarkletlerin içe aktarılacağını gösterir.

## Parameter Details

### `-SnippetsPath <String>`

> Yer imi kod parçacığı dosyalarını içeren dizinin yolu
...
> Tarayıcı yer imi yapısındaki hedef yer imi klasörü
...
> Microsoft Edge tarayıcısına yer imi ekleme
...
> Yer imi kodlarını Google Chrome tarayıcısına aktarın
...
> Mozilla Firefox tarayıcısına yer imi ekle
