...
> Bir dizindeki görsellerin EXIF meta verilerini günceller.

## Description

Bu işlev, belirtilen dizinlerdeki görseller için EXIF meta verilerini çıkarır ve günceller.
Her görseli işleyerek kamera ayrıntıları, GPS koordinatları, pozlama ayarları ve diğer teknik bilgiler dahil olmak üzere ayrıntılı EXIF meta verilerini çıkarır.
Meta veriler, daha sonra dizin oluşturma ve arama işlevleri tarafından kullanılmak üzere :EXIF.json olarak alternatif NTFS akışlarında saklanır.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-ImageDirectories` | String[] | — | — | 0 | `@('.\')` | Görüntü meta verisi güncellemeleri için işlenecek dizin yolları dizisi |
| `-RetryFailed` | SwitchParameter | — | — | Named | — | Daha önce başarısız olan görüntü meta veri güncellemelerini yeniden dene |
| `-OnlyNew` | SwitchParameter | — | — | Named | — | Yalnızca henüz meta veri dosyası olmayan görüntüleri işle |
| `-Recurse` | SwitchParameter | — | — | Named | — | Belirtilmişse, alt dizinlerdeki görüntüleri yinelemeli olarak işler |
| `-Force` | SwitchParameter | — | — | Named | — | Meta veri zaten mevcut olsa bile yeniden oluşturmayı zorla |
| `-PassThru` | SwitchParameter | — | — | Named | — | Konsola çıktı vermek yerine yapılandırılmış nesneler döndür |
...
| `-SkipSession` | SwitchParameter | — | — | Named | — | Yapay zeka tercihleri (Dil, Görsel koleksiyonları vb.) için oturumda depolanan alternatif ayarları kullanmayın |
...
> Görüntü meta verisi güncellemeleri için işlenecek dizin yolları dizisi
...
> Daha önce başarısız olan görüntü meta veri güncellemelerini yeniden dene
...
> Yalnızca henüz meta veri dosyası olmayan görüntüleri işle
...
> Belirtilmişse, alt dizinlerdeki görüntüleri yinelemeli olarak işler
...
> Meta veri zaten mevcut olsa bile yeniden oluşturmayı zorla
...
> Konsola çıktı vermek yerine yapılandırılmış nesneler döndür
...
> Yapay zeka tercihleri (Dil, Görsel koleksiyonları vb.) için oturumda depolanan alternatif ayarları kullanmayın
