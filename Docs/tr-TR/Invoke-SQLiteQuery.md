...
> Bir SQLite veritabanına, işlem desteği ile bir veya daha fazla SQL sorgusu yürütür.

## Description

Parametre desteği ve yapılandırılabilir işlem yalıtımı ile bir SQLite veritabanına karşı SQL sorguları yürütür. Toplu işlemler için harici bir işlem kullanabilir veya kendi dahili işlemini oluşturabilir. Harici bir işlem kullanıldığında, işlemi tamamlama/geri alma sorumluluğu çağırana aittir. Bağlantı önceliği: İşlem > ConnectionString > DatabaseFilePath.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-ConnectionString` | String | — | — | 0 | — | SQLite veritabanına bağlantı dizesi. |
| `-DatabaseFilePath` | String | — | — | 1 | — | SQLite veritabanı dosyasının yolu. |
| `-Transaction` | Object | — | — | 2 | — | Sorgular için kullanılacak mevcut bir SQLite işlemi. |
| `-Queries` | String[] | ✅ | ✅ (ByValue, ByPropertyName) 🌐 Remaining | 3 | — | Yürütülecek sorgu veya sorgular. |
| `-SqlParameters` | Collections.Hashtable[] | — | ✅ (ByValue, ByPropertyName) 🌐 Remaining | 4 | `@()` | Sorgu parametreleri karma tablolar olarak. |
...
> Sorgular için kullanılacak mevcut bir SQLite işlemi.
