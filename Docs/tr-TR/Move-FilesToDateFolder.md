...
> Arama ölçütleriyle eşleşen dosyaları tarih tabanlı alt klasörlere taşır.

## Description

Dosyaları, `Find-Item` ile aynı parametre kümesini kullanarak arar ve eşleşen her dosyayı, dosyanın oluşturulma veya medya tarihine göre `TargetFolder` içinde bir alt klasöre taşır. Cmdlet; içerik eşleme, sürücü genelinde arama ve birçok filtreyi destekler. Taşıma işleminden sonra boş kaynak klasörleri isteğe bağlı olarak silebilir.

Belirtilen dosya için doğru bir oluşturulma veya çekim tarihi belirlemek üzere çeşitli stratejiler dener. Stratejiler; resim EXIF meta verilerini okuma, dosya adlarından tarih/saat bilgilerini ayrıştırma ve başka güvenilir bilgi olmadığında dosyanın son yazma zamanına geri dönmeyi içerir.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-TargetFolder` | String | ✅ | — | 0 | — | Eşleşen dosyaların tarihe dayalı alt klasörlere taşınacağı hedef kök klasör |
...
| `-DeleteEmptyDirs` | SwitchParameter | — | — | Named | — | Dosyalar taşındıktan sonra boş kaynak dizinlerini sil |
| `-TargetFolderNameDateSyntax` | String | — | — | Named | `'Year + Month'` | Hedef klasör adı tarih sözdizimi |
...
> Eşleşen dosyaların tarihe dayalı alt klasörlere taşınacağı hedef kök klasör
...
> Dosyalar taşındıktan sonra boş kaynak dizinlerini sil
...
> Hedef klasör adı tarih sözdizimi
