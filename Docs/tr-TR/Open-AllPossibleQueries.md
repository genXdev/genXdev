...
> Verilen arama terimleri veya URL'ler için mümkün olan tüm sorgu türlerini açar.

## Description

Web sayfası sorgularını işleyen tüm cmdlet'leri yürütür, hem URL'leri hem de arama terimlerini işler. URL'ler için siteye özgü sorgular gerçekleştirir, arama terimleri için ise genel web sorguları yürütür. Bu işlev, GenXdev.Queries modül ailesindeki tüm kullanılabilir sorgu cmdlet'lerini dinamik olarak keşfeder ve yürütür.
...
| `-ClearSession` | SwitchParameter | — | — | Named | — | Tarayıcı oturumunu açmadan önce temizleyin. |
| `-SkipSession` | SwitchParameter | — | — | Named | — | Tarayıcı oturum geri yüklemeyi atla. |
...
Varsayılan monitörde "powershell scripting" için tüm olası sorgu türlerini açar.
...
GitHub URL'si için takma ad ve kısa parametreler kullanarak olası tüm sorgu türlerini açar.
...
> Tarayıcı oturumunu açmadan önce temizleyin.
...
> Tarayıcı oturum geri yüklemeyi atla.
...
- [ConvertTo-Uris](https://github.com/genXdev/genXdev/blob/main/Docs/tr-TR/ConvertTo-Uris.md)
