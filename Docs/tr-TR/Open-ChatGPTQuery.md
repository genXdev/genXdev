...
> Bir ChatGPT sorgusunu web tarayıcısında açar.

## Description

ChatGPT'yi bir web tarayıcısında açar, belirtilen sorguyu otomatik olarak girer ve gönderir. Temeldeki Open-WebsiteAndPerformQuery işlevi kullanılarak yürütülecek birden çok sorguyu destekler. Bu işlev, PowerShell'den OpenAI'nin ChatGPT'si ile kapsamlı tarayıcı yapılandırma seçenekleriyle etkileşim kurmanın kullanışlı bir yolunu sağlar.
...
| `-ShowWindow` | SwitchParameter | — | — | Named | — | Tarayıcı penceresini göster |
...
Tam parametre adını kullanarak birden çok sorgu gönderin.
...
Bir takma ad ve işlem hattı kullanarak sorgu gönderin.
