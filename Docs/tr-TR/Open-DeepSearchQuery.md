...
> DeepSeek sorgusunu bir web tarayıcısında açar

## Description

Web tarayıcısında bir DeepSeek sorgusu açar, sorguyu yazar ve aramayı çalıştırmak için Enter tuşuna basar. Bu işlev, sağlanan sorgular için akıllı yanıtlar ve içgörüler sağlamak üzere DeepSeek AI arama motorunu kullanır.
...
DeepSeek'i açar ve varsayılan ayarları kullanarak "powershell function" arar.
...
Varsayılan parametrelerle 'powershell function' aramak için takma adı kullanır.
...
DeepSeek'i birincil monitörde tam ekran modunda açarak "makine öğrenimi temelleri"ni arar.
