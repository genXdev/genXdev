...
> GenXdev progresif web uygulamaları kataloğunu bir web tarayıcısında açar.

## Description

Yayınlanmış GenXdev ilerici web uygulamaları kataloğunu bir web tarayıcısında açar. Katalog için en iyi görüntüleme deneyimini sağlamak amacıyla varsayılan olarak tam ekran etkinleştirilmiş uygulama modunda açar. Monitör yerleşimi, pencere boyutlandırması ve dil tercihleri dahil tüm standart web tarayıcı yapılandırma seçeneklerini destekler.

İşlev, en iyi katalog görüntüleme deneyimi için tarayıcıyı otomatik olarak yapılandırır ve aynı anda birden çok tarayıcı örneğini açabilir. Kapsamlı dil desteği sağlar ve tarayıcı seçimi ile konumlandırması için kullanıcı tercihlerine saygı gösterir.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Language` | String | — | — | 0 | — | Döndürülen arama sonuçlarının dili |
...
| `-ShowWindow` | SwitchParameter | — | — | Named | — | Tarayıcı penceresini göster (simge durumunda veya gizli değil) |
...
GenXdev uygulama kataloğunu monitör 1'de tam ekran uygulama modunda açar.
...
GenXdev uygulama kataloğunu takma ad komutunu kullanarak monitör 1'de açar.
...
> Tarayıcı penceresini göster (simge durumunda veya gizli değil)
...
- [Open-GameOfLife](https://github.com/genXdev/genXdev/blob/main/Docs/tr-TR/Open-GameOfLife.md)
