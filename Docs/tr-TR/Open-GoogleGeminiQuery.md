...
> Bir Google Gemini sorgusunu web tarayıcısında açar

## Description

Google Gemini sorgusunu web tarayıcısında açar, sorguyu otomatik olarak girer ve gönderir. Bu, Google'ın Gemini AI'sı ile hızlı bir şekilde etkileşim kurmanın bir yolunu sağlar. İşlev, monitör seçimi, pencere konumlandırma ve klavye otomasyon özellikleri dahil olmak üzere kapsamlı tarayıcı kontrolünü destekler.
...
Google Gemini'yi açar ve "PowerShell nedir?" sorgusunu gönderir.
...
Diziler hakkında bir sorgu göndermek için diğer adı kullanır.
