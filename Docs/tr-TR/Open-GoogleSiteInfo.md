...
> Google site bilgi sorgularını bir web tarayıcısında açar.

## Description

Belirtilen alan ad(lar)ı için site bilgileriyle (site:, link:, related:) ilgili birden çok Google arama sorgusunu bir web tarayıcısında açar.
...
| `-NoBorders` | SwitchParameter | — | — | Named | — | Tarayıcı penceresinden pencere kenarlıklarını kaldırır |
| `-SessionOnly` | SwitchParameter | — | — | Named | — | Tarayıcı profili için yalnızca oturum modunu kullan (kalıcı veri yok) |
| `-ClearSession` | SwitchParameter | — | — | Named | — | Tarayıcı oturum/profil verilerini açmadan önce temizle |
| `-SkipSession` | SwitchParameter | — | — | Named | — | Bir tarayıcı oturumu/profil kullanmayı atla (varsayılanı kullan) |
...
> Tarayıcı penceresinden pencere kenarlıklarını kaldırır
...
> Tarayıcı profili için yalnızca oturum modunu kullan (kalıcı veri yok)
...
> Tarayıcı oturum/profil verilerini açmadan önce temizle
...
> Bir tarayıcı oturumu/profil kullanmayı atla (varsayılanı kullan)
