...
> Bir Grokipedia sorgusunu bir web tarayıcısında açar.

## Description

Bir veya daha fazla Grokipedia arama sorgusunu, kapsamlı yapılandırma seçenekleriyle bir web tarayıcısında açar. Yapılandırılabilir tarayıcı davranışı, monitör seçimi ve pencere konumlandırmayı destekler. Sorgular URL kodlanır ve tam yerelleştirme desteğiyle belirtilen dilin Grokipedia alan adı kullanılarak açılır.

İşlev, özel tarama modları, pencere konumlandırma, klavye otomasyonu ve çoklu monitör desteği dahil olmak üzere kapsamlı tarayıcı kontrolü sağlar. Uluslararası Grokipedia alan adları için URL kodlama ve dil kodu eşlemesini otomatik olarak işler.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Queries` | String[] | ✅ | ✅ (ByValue, ByPropertyName) | 0 | — | Yürütülecek Grokipedia arama sorgusu |
...
Varsayılan monitörde İngilizce "PowerShell" için bir Grokipedia araması açar.
...
Konumsal parametrelerle takma ad kullanarak bir Grokipedia araması açar.
...
Gizli tarama modunu kullanarak Grokipedia'da birden çok terim arar.

## Parameter Details

### `-Queries <String[]>`

> Yürütülecek Grokipedia arama sorgusu
