...
> InstantStreetView sorgularını bir web tarayıcısında açar.

## Description

InstantStreetView sorgularını, web tarayıcı komut satırı anahtarlarını kullanarak yapılandırılabilir bir şekilde açar. Birden çok sorguyu ve monitör seçimini destekler. Pencere konumlandırma, dil ayarları ve tarayıcıya özgü özellikler dahil olmak üzere kapsamlı tarayıcı kontrolü sağlar.

İşlev, konum sorgularını URL kodlayarak ve belirtilen tarayıcıda açarak InstantStreetView URL'lerini otomatik olarak oluşturur. Kapsamlı özelleştirme seçenekleriyle Edge, Chrome ve Firefox dahil tüm büyük tarayıcıları destekler.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Queries` | String[] | ✅ | ✅ (ByValue, ByPropertyName) | 0 | — | InstantStreetView'da görüntülenecek konum sorguları |
...
| `-SideBySide` | SwitchParameter | — | — | Named | — | Tarayıcı pencerelerini yan yana açın |
...
Times Meydanı için InstantStreetView'i birincil monitördeki varsayılan tarayıcıda açar.
...
Eyfel Kulesi için 'isv' takma adını kullanarak InstantStreetView'i açar ve ikincil monitörde görüntüler.
...
Big Ben için InstantStreetView'i gizli tarama modunda İngilizce dilinde açar.
...
Chrome tarayıcısında, ekranın sol tarafında konumlandırılmış birden fazla InstantStreetView sorgusunu boru hattı aracılığıyla açar.

## Parameter Details

### `-Queries <String[]>`

> InstantStreetView'da görüntülenecek konum sorguları
...
> Tarayıcı pencerelerini yan yana açın
