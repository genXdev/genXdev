...
> Belirtilen URL'ler için SimilarWeb web sitesi bilgilerini bir web tarayıcısında açar.

## Description

Yapılandırılabilir bir şekilde komut satırı anahtarları kullanarak web tarayıcısında "Benzer web" sorgusu açar. Web sitesi trafik analizi, rakip araştırması ve dijital pazarlama içgörüleri için web sitesi analitiğini ve karşılaştırmalarını kontrol etmeye olanak tanır.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Queries` | String[] | ✅ | ✅ (ByValue, ByPropertyName) | 0 | — | SimilarWeb'de analiz edilecek web sitesi URL'leri |
...
Google.com için bir SimilarWeb analizini birincil monitörde açar.
...
Monitör konumlandırmayla işlev takma adını kullanarak bir SimilarWeb analizi açar.
...
Borulu girişle birden çok web sitesini analiz eder ve pencere ortalanmış konumda açılır.
...
GitHub için SimilarWeb URL'sini tarayıcıyı açmadan döndürür.

## Parameter Details

### `-Queries <String[]>`

> SimilarWeb'de analiz edilecek web sitesi URL'leri
