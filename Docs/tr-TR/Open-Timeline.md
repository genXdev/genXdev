...
> Geçerli zamanı, tarihi, yüzyılı ve milenyumu gösteren etkileşimli bir zaman çizelgesi açar.

## Description

Web tabanlı etkileşimli bir zaman çizelgesi açar.
Birden çok dili ve görsel özelleştirme seçeneklerini destekler.
...
| `-BrowserExtensions` | SwitchParameter | — | — | Named | — | Tarayıcı uzantılarının yüklenmesini engelleme |
...
| `-SpectateOnly` | SwitchParameter | — | — | Named | — | Yeni bir oyuna başlama, sadece AI'nın oynamasını izle |
...
| `-Language` | String | — | — | 1 | — | Varsayılan tarayıcı dilini geçersiz kılın veya tüm dillerin her dakika dönmesi için [Tümü]'nü seçin |
| `-DragedNodeBackground` | String | — | — | Named | `$null` | Sürüklenen düğümün arka planını boyamak için css-renk-stilini geçersiz kıl |
| `-FocusedNodeBackground` | String | — | — | Named | `$null` | Odaklanan düğümün (ortadaki) arka planını boyamak için css-color-style'ı geçersiz kıl |
| `-FocusedNodeForeground` | String | — | — | Named | `$null` | Odaklanmış düğümün (merkezdeki) ön plan metnini boyamak için css-color-style'ı geçersiz kılın |
| `-UnFocusedNodeBackground` | String | — | — | Named | `$null` | Odaklanan düğümün (ortadaki) arka planını boyamak için css-color-style'ı geçersiz kıl |
| `-UnFocusedNodeForeground` | String | — | — | Named | `$null` | Odaklanmamış düğümün (ortadaki) ön plan metnini boyamak için css-color-style'u geçersiz kıl |
| `-BorderLightColor` | String | — | — | Named | `$null` | Varsayılan css border-light-color renk stilini geçersiz kıl |
| `-BorderDarkColor` | String | — | — | Named | `$null` | Varsayılan css border-dark-color renk stilini geçersiz kıl |
| `-BorderWidth` | Int32 | — | — | Named | `1` | Düğüm kenarlarını boyamak için varsayılan genişliği geçersiz kıl |
| `-RotationDelaySeconds` | Int32 | — | — | Named | `15` | Arka plan döndürme gecikmesi için varsayılan genişliği geçersiz kıl |
...
Van Gogh ilhamlı görsellerle İngilizce bir etkileşimli zaman çizelgesi açar.
...
Zaman çizelgesini 2. monitörde takma adlar kullanarak açar.
...
Zaman çizelgesini Chrome gizli modunda tam ekranda açar.
...
> Tarayıcı uzantılarının yüklenmesini engelleme
...
> Yeni bir oyuna başlama, sadece AI'nın oynamasını izle
...
> Varsayılan tarayıcı dilini geçersiz kılın veya tüm dillerin her dakika dönmesi için [Tümü]'nü seçin
...
> Sürüklenen düğümün arka planını boyamak için css-renk-stilini geçersiz kıl
...
> Odaklanan düğümün (ortadaki) arka planını boyamak için css-color-style'ı geçersiz kıl
...
> Odaklanmış düğümün (merkezdeki) ön plan metnini boyamak için css-color-style'ı geçersiz kılın
...
> Odaklanmamış düğümün (ortadaki) ön plan metnini boyamak için css-color-style'u geçersiz kıl
...
> Varsayılan css border-light-color renk stilini geçersiz kıl
...
> Varsayılan css border-dark-color renk stilini geçersiz kıl
...
> Düğüm kenarlarını boyamak için varsayılan genişliği geçersiz kıl
...
> Arka plan döndürme gecikmesi için varsayılan genişliği geçersiz kıl
