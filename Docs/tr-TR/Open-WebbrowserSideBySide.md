...
> Belirli bir konumlandırma ile yeni bir web tarayıcı penceresi başlatır.

## Description

Birincil monitörün sağ tarafında arka plan modunda konumlandırılmış yeni bir tarayıcı penceresi (Edge veya Chrome) açar.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Url` | String[] | — | ✅ (ByValue) | 0 | — | Tarayıcıda açılacak URL'ler |
