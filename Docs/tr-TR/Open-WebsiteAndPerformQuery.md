...
> Bir web sayfasını bir web tarayıcısında açar ve bir veya daha fazla sorgu gerçekleştirir.

## Description

Bu işlev, varsayılan web tarayıcısında bir URL ile bir web sitesini açar, bir veya daha fazla sorgu girer ve bunları gönderir. Altta yatan Open-Webbrowser işlevi aracılığıyla kapsamlı monitör seçimi ve pencere konumlandırma seçeneklerini destekler.

İşlev, her sorguyu otomatik olarak panoya kopyalar ve klavye otomasyonu kullanarak tarayıcı penceresine gönderir. Orijinal pano içeriğini korur ve tüm sorgular işlendikten sonra geri yükler.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Url` | String | ✅ | ✅ (ByPropertyName) | 0 | — | Açılacak web sitesinin URL'si |
...
| `-SendKeyDelayMilliSeconds` | Int32 | — | — | Named | `500` | Farklı anahtar dizileri gönderme arasındaki milisaniye cinsinden gecikme |
...
Google'ı açar ve "PowerShell" için arama yapar.
...
Varsayılan monitörde Google'ı açar ve "PowerShell eğitimleri" için arama yapar.

## Parameter Details

### `-Url <String>`

> Açılacak web sitesinin URL'si
