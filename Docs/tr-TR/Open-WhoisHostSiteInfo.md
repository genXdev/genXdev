...
> Bir web tarayıcısında Whois ana bilgisayar bilgisi sorgusu açar.

## Description

Etki alanı adları veya IP adresleri için Whois ana bilgisayar bilgisi sorgularını bir web tarayıcısında açar. Yapılandırılabilir monitör seçimini ve pencere konumlandırma, tarayıcı seçimi ve otomasyon özellikleri dahil olmak üzere kapsamlı tarayıcı yapılandırma seçenekleriyle birden çok sorguyu destekler.
...
| `-SessionOnly` | SwitchParameter | — | — | Named | — | Oturumda depolanan alternatif ayarları, Dil, Görsel koleksiyonlar vb. AI tercihleri için kullanın. |
| `-ClearSession` | SwitchParameter | — | — | Named | — | Dil, Görsel Koleksiyonları vb. gibi AI tercihleri için oturumda depolanan alternatif ayarları temizleyin. |
| `-SkipSession` | SwitchParameter | — | — | Named | — | Yapay zeka tercihleri (Dil, Görsel koleksiyonları vb.) için ayarları yalnızca kalıcı tercihlerde sakla, oturumu etkilemeden. |
...
Varsayılan monitörde birden çok etki alanı için Whois bilgilerini açar.
...
example.com için takma adlar ve konumsal parametreler kullanarak Whois bilgilerini açar.
...
Boru hattından gelen alan adları için Whois bilgilerini Chrome gizli modunda açar.
...
> Oturumda depolanan alternatif ayarları, Dil, Görsel koleksiyonlar vb. AI tercihleri için kullanın.
...
> Dil, Görsel Koleksiyonları vb. gibi AI tercihleri için oturumda depolanan alternatif ayarları temizleyin.
...
> Yapay zeka tercihleri (Dil, Görsel koleksiyonları vb.) için ayarları yalnızca kalıcı tercihlerde sakla, oturumu etkilemeden.
