...
> Hollanda Wikipedia aramalarını bir web tarayıcısında açar.

## Description

Bir web tarayıcıda 'Wikipedia - Hollanda' sorgusunu yapılandırılabilir görüntüleme seçenekleriyle açar. Birden çok terimle arama yapmayı ve sonuçların hangi monitörde görüntüleneceğini belirtmeyi destekler.
...
| `-SideBySide` | SwitchParameter | — | — | Named | — | İki tarayıcı penceresini yan yana açar |
| `-SessionOnly` | SwitchParameter | — | — | Named | — | Yalnızca oturum çerezlerini kullan (kalıcı çerez yok) |
| `-ClearSession` | SwitchParameter | — | — | Named | — | Tarayıcı oturum verilerini açmadan önce temizle |
...
> İki tarayıcı penceresini yan yana açar
...
> Yalnızca oturum çerezlerini kullan (kalıcı çerez yok)
...
> Tarayıcı oturum verilerini açmadan önce temizle
