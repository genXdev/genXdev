...
> Bir Wikipedia sorgusunu web tarayıcısında açar.

## Description

Bir veya daha fazla Wikipedia arama sorgusunu kapsamlı yapılandırma seçenekleriyle bir web tarayıcısında açar. Yapılandırılabilir tarayıcı davranışı, monitör seçimi ve pencere konumlandırmayı destekler. Sorgular URL kodlanır ve tam yerelleştirme desteğiyle belirtilen dilin Wikipedia alan adı kullanılarak açılır.

İşlev; özel tarama modları, pencere konumlandırma, klavye otomasyonu ve çoklu monitör desteği dahil olmak üzere kapsamlı tarayıcı kontrolü sağlar. Uluslararası Wikipedia alan adları için URL kodlama ve dil kodu eşlemesini otomatik olarak işler.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Queries` | String[] | ✅ | ✅ (ByValue, ByPropertyName) | 0 | — | Yürütülecek Wikipedia arama sorgusu |
| `-Language` | String | — | — | 1 | — | Wikipedia arama sonuçlarının dili |
...
| `-Monitor` | Int32 | — | — | Named | `-1` | Kullanılacak monitör, 0 = varsayılan, -1 = yok say, -2 = Yapılandırılmış ikincil monitör |
...
| `-PassThru` | SwitchParameter | — | — | Named | — | Tarayıcı sürecini temsil eden bir PowerShell süreç nesnesi döndürür. |
...
| `-SessionOnly` | SwitchParameter | — | — | Named | — | Yapay zeka tercihleri için oturumda depolanan alternatif ayarları kullanın. |
| `-ClearSession` | SwitchParameter | — | — | Named | — | Yapay zeka tercihleri için oturumda depolanan alternatif ayarları temizleyin. |
...
Varsayılan monitörde İngilizce olarak "PowerShell" için bir Wikipedia araması açar.
...
Takma ad ile konumsal parametreler kullanarak bir Wikipedia araması açar.
...
Özel tarama modunu kullanarak Almanca Vikipedi'de birden çok terimi arar.

## Parameter Details

### `-Queries <String[]>`

> Yürütülecek Wikipedia arama sorgusu
...
> Wikipedia arama sonuçlarının dili
...
> Kullanılacak monitör, 0 = varsayılan, -1 = yok say, -2 = Yapılandırılmış ikincil monitör
...
> Tarayıcı sürecini temsil eden bir PowerShell süreç nesnesi döndürür.
...
> Yapay zeka tercihleri için oturumda depolanan alternatif ayarları kullanın.
...
> Yapay zeka tercihleri için oturumda depolanan alternatif ayarları temizleyin.
