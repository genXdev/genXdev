...
> Bir Wolfram Alpha sorgusunu bir web tarayıcısında açar.

## Description

Bir veya daha fazla Wolfram Alpha sorgusunu bir web tarayıcısında açar. Dinamik parametreler aracılığıyla yapılandırılabilir monitör seçimi ve tarayıcı seçeneklerini destekler. Gelişmiş bilimsel hesaplama iş akışları için konumlandırma, boyutlandırma ve otomasyon yetenekleri dahil kapsamlı tarayıcı kontrolü sağlar.
...
| `-SendKeyEscape` | SwitchParameter | — | — | Named | — | Anahtarları gönderirken kontrol karakterlerini kaçış karakteri ile kullanın. |
| `-SendKeyHoldKeyboardFocus` | SwitchParameter | — | — | Named | — | Tuşları gönderdikten sonra klavye odağının PowerShell'e dönmesini engelle. |
| `-SendKeyUseShiftEnter` | SwitchParameter | — | — | Named | — | Tuş gönderirken normal Enter yerine satır sonu için Shift+Enter gönder. |
...
Varsayılan monitörde güneşin kütlesi için bir Wolfram Alpha sorgusu açar.
...
Hızlı bilimsel hesaplamalar için takma adı kullanarak birden çok Wolfram Alpha sorgusu açar.
...
Bir hesaplama sorgusunu, boru hattı girişi aracılığıyla İngilizce dil tercihiyle tam ekran modunda açar.
...
> Tuş gönderirken normal Enter yerine satır sonu için Shift+Enter gönder.
