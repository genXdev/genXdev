...
> Bir X Grok sorgusunu web tarayıcısında açar

## Description

Bir X Grok sorgusunu web tarayıcısında açar, sorguyu yazar ve aramayı gerçekleştirmek için Enter tuşuna basar. Bu işlev, otomatik tarayıcı kontrolü aracılığıyla X'in Grok AI asistanıyla etkileşime geçmenin kullanışlı bir yolunu sağlar. İşlev, monitör seçimi, pencere konumlandırma ve klavye otomasyonu özellikleri dahil olmak üzere kapsamlı tarayıcı kontrolünü destekler.
