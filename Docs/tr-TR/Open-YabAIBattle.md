...
> YabAI Battle oyununu bir web tarayıcısında açar.

## Description

Bu fonksiyon, pencere yerleşimi, tarayıcı seçimi ve görüntüleme modu için kapsamlı özelleştirme seçenekleriyle YabAI Savaş oyununu bir web tarayıcısında başlatır. Oyun özelinde URL oluşturma ve parametre işleme ile GenXdev\Open-Webbrowser fonksiyonunu sarmalar.

Fonksiyon iki oyun modunu destekler:
- Savaş modu: Yeni bir Yapay Zeka vs Yapay Zeka savaşı başlatır
- Seyirci modu: Mevcut yapay zeka savaşlarını izler

Tarayıcı konumlandırma seçenekleri arasında sol, sağ, üst, alt, ortalı ve tam ekran modları ile çoklu monitör desteği bulunur. Fonksiyon, optimum oyun deneyimi için uygulama modu ayarlarını ve tarayıcı uzantı yönetimini otomatik olarak işler.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Language` | String | — | — | 0 | — | Oyun arayüzünün dili |
...
| `-Monitor` | Int32 | — | — | Named | `-2` | Kullanılacak monitör, 0 = varsayılan, -1 = at, -2 = Yapılandırılmış ikincil monitör, varsayılan $Global:DefaultSecondaryMonitor veya bulunamazsa 2 |
...
| `-SendKeyDelayMilliSeconds` | Int32 | — | — | Named | — | Her bir tuşu gönderme arasındaki gecikme (milisaniye cinsinden). |
...
| `-RestoreFocus` | SwitchParameter | — | — | Named | — | Tarayıcıyı açtıktan sonra odağı önceki pencereye geri ver. |
...
YabAI Battle oyununu Microsoft Edge'de gizli tarama modunda, tam ekran olmadan açar.
...
Edge için takma adlar, gizli mod ve tam ekran olmadan oyunu açar.
...
Yapay zeka savaşlarını izlemek için Google Chrome'u kullanarak oyunu izleme modunda açar.
...
Oyunu, monitör 1'in sol tarafında konumlandırılmış İspanyolca dil arayüzüyle açar.

## Parameter Details

### `-Language <String>`

> Oyun arayüzünün dili
...
> Her bir tuşu gönderme arasındaki gecikme (milisaniye cinsinden).
...
> Tarayıcıyı açtıktan sonra odağı önceki pencereye geri ver.
