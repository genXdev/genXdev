...
> Geçerli pencereyi isteğe bağlı değişikliklerle birlikte pencere yığınına iter.

## Description

Şu anda odaklanmış pencere için bir pencere yardımcısını yığına iter.
İtmeden önce veya sonra çeşitli pencere dönüşümleri uygulamaya izin verir.
Bu işlev, geçerli pencereyi yakalar ve isteğe bağlı olarak konumlandırma, boyutlandırma ve görsel efektler uygulayarak,
daha sonra Pop-Window ile alınmak üzere saklar.
