...
> Bir pencereye veya sürece simülasyon tuş vuruşları gönderir.

## Description

Bu işlev, Windows Script Host Shell nesnesini kullanarak bir hedef pencereye veya işleme klavye girişi gönderir. İşlem adı, işlem kimliği veya pencere tanıtıcısına göre pencereleri hedefleyebilir. İşlev, özel tuş dizilerini, kaçış karakterlerini ve güvenilir tuş teslimi için çeşitli zamanlama seçeneklerini destekler.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-KeysToSend` | String[] | ✅ | ✅ (ByValue, ByPropertyName) | 0 | — | Dizi olarak gönderilecek klavye girişi |
| `-ProcessName` | String | — | ✅ (ByPropertyName) | Named | — | Tuşların gönderileceği işlemin adı (joker karakterler desteklenir) *(Parameter set: )* 🌐 *Supports wildcards* |
| `-ProcessId` | Int32 | — | ✅ (ByPropertyName) | Named | — | Tuş gönderilecek işlemin kimliği *(Parameter set: )* |
| `-WindowHandle` | Int64 | — | ✅ (ByPropertyName) | Named | — | Tuş göndermek için pencere tanıtıcısı *(Parameter set: )* |
| `-SendKeyEscape` | SwitchParameter | — | — | Named | — | Giriş metnindeki kontrol karakterlerini ve değiştiricileri kaçış karakterleri ile işaretle |
| `-SendKeyHoldKeyboardFocus` | SwitchParameter | — | — | Named | — | Tuşları gönderdikten sonra hedef penceredeki klavye odağını tut |
| `-SendKeyUseShiftEnter` | SwitchParameter | — | — | Named | — | Yeni satırlar için Enter yerine Shift+Enter kullanın |
| `-SendKeyDelayMilliSeconds` | Int32 | — | — | Named | `10` | Farklı giriş dizeleri arasındaki milisaniye cinsinden gecikme |
...
> Dizi olarak gönderilecek klavye girişi
...
> Tuşların gönderileceği işlemin adı (joker karakterler desteklenir)
...
> Tuş gönderilecek işlemin kimliği
...
> Tuş göndermek için pencere tanıtıcısı
...
> Giriş metnindeki kontrol karakterlerini ve değiştiricileri kaçış karakterleri ile işaretle
...
> Tuşları gönderdikten sonra hedef penceredeki klavye odağını tut
...
> Yeni satırlar için Enter yerine Shift+Enter kullanın
...
> Farklı giriş dizeleri arasındaki milisaniye cinsinden gecikme
