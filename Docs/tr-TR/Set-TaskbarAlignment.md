...
> Windows 11+ görev çubuğu hizalamasını merkez ve sol konumlar arasında yapılandırır.

## Description

Windows 11 ve daha yeni sürümlerde görev çubuğu hizalamasını, HKCU:\SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer\Advanced altındaki 'TaskbarAl' kayıt defteri anahtarını değiştirerek ayarlar. Hizalama, ortaya (değer 1) veya sola (değer 0) ayarlanabilir.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Justify` | String | ✅ | — | 0 | — | Görev çubuğu hizalaması (Ortada veya Sol) |
...
> Görev çubuğu hizalaması (Ortada veya Sol)
