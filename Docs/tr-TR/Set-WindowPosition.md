...
> Açık konumlandırma parametreleri sağlandığında pencereleri konumlandırır ve yeniden boyutlandırır.

## Description

Konumlandırma parametreleri belirtildiğinde pencere konumlandırma ve boyutlandırma üzerinde hassas kontrol sağlar. Birden çok monitör, kenarlık kaldırma ve sol/sağ bölme, üst/alt bölme ve ortalama yerleştirme gibi çeşitli önceden tanımlanmış konumları destekler. Pencereler koordinatlarla veya önceden tanımlanmış düzenler kullanılarak konumlandırılabilir. Konumlandırma parametreleri olmadan işlev, pencere üzerinde herhangi bir işlem yapmaz.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-ProcessName` | String | — | ✅ (ByValue, ByPropertyName) | 0 | — | Pencerenin konumlandırılacağı işlemin adı *(Parameter set: )* 🌐 *Supports wildcards* |
| `-Process` | Diagnostics.Process | — | ✅ (ByValue, ByPropertyName) | Named | — | Pencerenin konumlandırılması süreci *(Parameter set: )* |
...
| `-Monitor` | Int32 | — | — | Named | `-1` | Monitör seçimi: 0=birincil, 1+=belirli monitör, -1=mevcut, -2=ikincil |
| `-NoBorders` | SwitchParameter | — | — | Named | — | Pencerenin kenarlıklarını kaldırır |
| `-Width` | Int32 | — | — | Named | `-1` | Piksel cinsinden pencere genişliği |
| `-Height` | Int32 | — | — | Named | `-999999` | Pencere yüksekliği piksel cinsinden |
| `-X` | Int32 | — | — | Named | `-999999` | Pencerenin piksel cinsinden yatay konumu |
| `-Y` | Int32 | — | — | Named | `-999999` | Pencerenin piksel cinsinden dikey konumu |
...
> Pencerenin konumlandırılacağı işlemin adı
...
> Monitör seçimi: 0=birincil, 1+=belirli monitör, -1=mevcut, -2=ikincil
...
> Pencerenin piksel cinsinden yatay konumu
...
> Pencerenin piksel cinsinden dikey konumu
