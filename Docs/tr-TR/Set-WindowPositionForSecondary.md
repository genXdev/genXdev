...
> Bir pencereyi belirtilen düzen seçenekleriyle ikincil monitöre konumlandırır.

## Description

Bu işlev, yapılandırılmış bir ikincil monitörde pencereleri konumlandırmak için Set-WindowPosition kullanarak hizalama, boyut ve kenarlık ayarları dahil olmak üzere çeşitli yerleşim seçenekleri sunar. Monitör seçimini genel yapılandırmaya göre yönetir ve ikincil monitör penceresi konumlandırması için kullanışlı bir sarmalayıcı sağlar.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Process` | Diagnostics.Process[] | — | ✅ (ByValue, ByPropertyName) | 0 | — | Pencerenin konumlandırılması süreci |
| `-Monitor` | Int32 | — | — | Named | `-2` | Kullanılacak monitör, 0=varsayılan, -1=at, -2=yapılandırılmış |
| `-Width` | Int32 | — | — | Named | `-1` | Pencerenin başlangıç genişliği |
| `-Height` | Int32 | — | — | Named | `-1` | Pencerenin başlangıç yüksekliği |
| `-X` | Int32 | — | — | Named | `-999999` | Pencerenin başlangıç X konumu |
| `-Y` | Int32 | — | — | Named | `-999999` | Pencerenin başlangıçtaki Y konumu |
...
| `-FocusWindow` | SwitchParameter | — | — | Named | — | Pencereyi konumlandırdıktan sonra odakla |
| `-SetForeground` | SwitchParameter | — | — | Named | — | Konumlandırmadan sonra pencereyi ön plana getir |
...
| `-KeysToSend` | String[] | — | — | Named | — | Pencerenin konumlandırılmasından sonra gönderilecek tuş vuruşları |
...
| `-PassThru` | SwitchParameter | — | — | Named | — | Konumlandırdıktan sonra işlem nesnesini döndürür |
| `-SideBySide` | SwitchParameter | — | — | Named | — | Pencereyi PowerShell ile aynı monitörde yan yana yerleştirin |
...
> Pencerenin konumlandırılması süreci
...
> Kullanılacak monitör, 0=varsayılan, -1=at, -2=yapılandırılmış
...
> Pencereyi konumlandırdıktan sonra odakla
...
> Konumlandırmadan sonra pencereyi ön plana getir
...
> Pencerenin konumlandırılmasından sonra gönderilecek tuş vuruşları
...
> Konumlandırdıktan sonra işlem nesnesini döndürür
...
> Pencereyi PowerShell ile aynı monitörde yan yana yerleştirin
