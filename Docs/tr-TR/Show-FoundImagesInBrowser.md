...
> Görsel arama sonuçlarını masonry düzeninde bir web galerisinde görüntüler.

## Description

Görsel arama sonuçlarını alır ve bunları tarayıcı tabanlı bir mozaik düzeninde görüntüler.
Düzenleme ve silme özellikleriyle etkileşimli modda veya basit görüntüleme modunda çalışabilir.
Genellikle Find-Image'dan gelen görsel veri nesnelerini kabul eder ve yüz tanıma, nesne tespiti ve sahne sınıflandırma verileri gibi meta verileri gösteren fareyle üzerine gelme ipuçlarıyla işler.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-InputObject` | Object[] | — | ✅ (ByValue) | 0 | `@()` | Galeride görüntülenecek resim veri nesneleri. |
| `-Interactive` | SwitchParameter | — | — | Named | — | Tarayıcıya bağlanacak ve Düzenle ve Sil gibi ek düğmeler ekleyecek |
| `-Title` | String | — | — | Named | `'Photo Gallery'` | Galeri için başlık |
| `-Description` | String | — | — | Named | `('Hover over images to see face recognition ' +
            'and object detection data')` | Yüz tanıma ve nesne algılama verilerini görmek için görsellerin üzerine gelin. |
...
| `-NewWindow` | SwitchParameter | — | — | Named | — | Mevcut olanı yeniden kullanmak yerine yeni bir tarayıcı penceresi oluşturun |
| `-OnlyReturnHtml` | SwitchParameter | — | — | Named | — | Yalnızca oluşturulan HTML'yi tarayıcıda görüntülemek yerine döndürün. |
| `-EmbedImages` | SwitchParameter | — | — | Named | — | Daha iyi taşınabilirlik için dosya:// URL'leri yerine resimleri base64 veri URL'leri olarak gömün. |
...
| `-PassThru` | SwitchParameter | — | — | Named | — | İleri düzey işlemler için tarayıcı penceresi yardımcı nesnesini döndürür |
...
> Galeride görüntülenecek resim veri nesneleri.
...
> Tarayıcıya bağlanacak ve Düzenle ve Sil gibi ek düğmeler ekleyecek
...
> Yüz tanıma ve nesne algılama verilerini görmek için görsellerin üzerine gelin.
...
> Mevcut olanı yeniden kullanmak yerine yeni bir tarayıcı penceresi oluşturun
...
> Yalnızca oluşturulan HTML'yi tarayıcıda görüntülemek yerine döndürün.
...
> İleri düzey işlemler için tarayıcı penceresi yardımcı nesnesini döndürür
