...
> Покращує текст, додаючи контекстуально доречні емодзі за допомогою ШІ.

## Description

Ця функція обробляє вхідний текст, додаючи емодзі, що відповідають емоційному контексту. Вона може приймати вхідні дані безпосередньо через параметри, з конвеєра або з системного буфера обміну. Функція використовує моделі AI для аналізу тексту та вибору відповідних емодзі, роблячи повідомлення більш виразними та привабливими.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Text` | String | — | ✅ (ByValue) | 0 | — | Текст для покращення емодзі |
