...
> Додає рядок функції до файлу README з позначкою часу.

## Description

Додає рядок функції до вказаного файлу README, з префіксом поточної дати у форматі yyyyMMdd. Рядок може бути відформатований як код і за бажанням відображатися.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Line` | String | — | — | 0 | `''` | Текст опису функції для додавання |
| `-Code` | SwitchParameter | — | — | Named | — | `Форматуйте рядок як код` |
| `-Show` | SwitchParameter | — | — | Named | — | Відобразити README після додавання рядка |
| `-UseHomeREADME` | SwitchParameter | — | — | Named | — | Використовуйте README у домашньому каталозі |
...
> Текст опису функції для додавання
...
> Відобразити README після додавання рядка
...
> Використовуйте README у домашньому каталозі
