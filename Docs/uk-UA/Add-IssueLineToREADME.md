...
> Додає елемент проблеми до файлу README.md.

## Description

Додає задачу з позначкою часу до розділу "## Issues" файлу README.md.
Може відобразити змінений розділ та відкрити його у Visual Studio Code.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Line` | String | — | — | 0 | `''` | Текст проблеми для додавання |
