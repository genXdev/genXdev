...
> Додає рядок до файлу README.md у вказаному розділі.

## Description

Знаходить і змінює файл README.md, додаючи новий рядок до вказаного розділу.
Може створити розділ, якщо його не існує. Підтримує форматування рядків як блоків
коду та показ зміненого розділу.

Спочатку шукатиме в поточному каталозі, потім підніматиметься каталогами, щоб знайти
розташування README. Якщо не знайдено, використовуватиме README в каталозі профілю PowerShell.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Line` | String | — | — | Named | `''` | Рядок для додавання до README |
| `-Section` | String | ✅ | — | 0 | — | Розділ, до якого потрібно додати рядок |
| `-Code` | SwitchParameter | — | — | Named | — | Відкрити у Visual Studio Code після зміни |
...
| `-Done` | SwitchParameter | — | — | Named | — | Позначити елемент як виконаний |
...
> Розділ, до якого потрібно додати рядок
...
> Відкрити у Visual Studio Code після зміни
...
> Позначити елемент як виконаний
