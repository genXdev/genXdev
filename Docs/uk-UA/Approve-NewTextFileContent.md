...
> Інтерактивне порівняння та затвердження вмісту файлів за допомогою WinMerge.

## Description

Сприяє порівнянню та злиттю вмісту через WinMerge шляхом створення тимчасового файлу із запропонованими змінами. Користувач може інтерактивно переглядати та змінювати запропоновані зміни перед затвердженням. Повертає статус затвердження та остаточний вміст.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-ContentPath` | String | ✅ | — | 0 | — | Шлях до цільового файлу для порівняння |
