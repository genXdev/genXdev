...
> Transforms direct or blunt expressions into polite, tactful diplomatic language.

## Description

Ця функція перетворює введення користувача з прямого або різкого формулювання на дипломатичну, тактовну мову, придатну для обговорень на високому рівні, переговорів або офіційної комунікації. Функція використовує мовні моделі ШІ, щоб зберегти початковий намір, пом'якшуючи тон і роблячи повідомлення більш дипломатичним та професійним.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Text` | String | — | ✅ (ByValue) | 0 | — | Текст для перетворення на дипломатичну мову |
...
> Текст для перетворення на дипломатичну мову
