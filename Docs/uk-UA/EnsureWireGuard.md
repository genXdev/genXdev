...
> Забезпечує встановлення та запуск служби WireGuard VPN через контейнер Docker.

## Description

Ця функція налаштовує та керує службою VPN WireGuard за допомогою Docker Desktop. Вона автоматично перевіряє, чи Docker Desktop запущений, завантажує останній образ Docker WireGuard, створює постійні сховища даних і керує життєвим циклом контейнера, включаючи моніторинг стану та можливості перезапуску.

WireGuard — це простий, швидкий і сучасний VPN, який використовує передову криптографію. Він пропонує чудову продуктивність і простоту порівняно з традиційними рішеннями VPN, такими як OpenVPN, з мінімальними накладними витратами на конфігурацію та чудовою підтримкою різних платформ.
