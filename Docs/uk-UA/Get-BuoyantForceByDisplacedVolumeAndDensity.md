...
> Обчислює силу Архімеда.

## Description

Використовує F = ρ V g.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-DisplacedVolumeInCubicMeters` | Double | ✅ | — | 0 | `0` | Витіснений об'єм у м³ |
| `-FluidDensityInKilogramsPerCubicMeter` | Double | ✅ | — | 1 | `0` | Густина рідини в кг/м³ |
| `-GravityInMetersPerSecondSquared` | Double | — | — | 2 | `0` | Гравітація в м/с² (за замовчуванням: 9,81) |
| `-As` | String | — | — | 3 | — | Одиниця виміру сили |

## Parameter Details

### `-DisplacedVolumeInCubicMeters <Double>`

> Витіснений об'єм у м³
