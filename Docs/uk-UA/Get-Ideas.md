...
> Відображає ідеї з файлу README.md.

## Description

Показує всі ідеї з розділу "## Ideas" файлу README.md. Можна використовувати або README у поточному розташуванні, каталозі профілю PowerShell, або каталозі OneDrive.
