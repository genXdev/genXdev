...
> Відображає проблеми з файлу README.md.

## Description

Показує всі завдання з розділу «## Завдання» файлу README.md. Можна використовувати README в поточному розташуванні, каталозі профілю PowerShell або каталозі OneDrive.
