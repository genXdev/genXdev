...
| `-VelocityInMetersPerSecond` | Double | ✅ | — | 1 | `0` | Швидкість у м/с |
| `-As` | String | — | — | 2 | — | Одиниця виміру енергії |
...
Обчислює кінетичну енергію для маси 10 кг, що рухається зі швидкістю 5 м/с, і виводить результат у калоріях.
...
Обчислює кінетичну енергію для тіла масою 5 кг, що рухається зі швидкістю 10 м/с, з використанням позиційних параметрів.
