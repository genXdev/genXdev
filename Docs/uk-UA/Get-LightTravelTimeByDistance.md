...
> Обчислює час, необхідний світлу для подолання відстані.

## Description

Використовує t = d / c, де c залежить від середовища.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-DistanceInMeters` | Double | ✅ | — | 0 | `0` | Відстань у метрах |
| `-SpeedOfLightInMetersPerSecond` | Double | — | — | 1 | `0` | Швидкість світла в м/с (за замовчуванням: 299792458) *(Parameter set: )* |
| `-Medium` | String | ✅ | — | 1 | — | Середовище, через яке поширюється світло *(Parameter set: )* |
| `-As` | String | — | — | 2 | — | Одиниця виводу для часу |
...
Обчислює час, за який світло досягає сонця через воду, у хвилинах.
...
Обчислює час проходження світлом 300000000 метрів зі швидкістю 225000000 м/с.
...
> Швидкість світла в м/с (за замовчуванням: 299792458)
...
> Середовище, через яке поширюється світло
