...
> Повертає допоміжний об'єкт вікна для головного вікна терміналу PowerShell.

## Description

* Отримує допоміжний об'єкт WindowObj, що представляє головне вікно поточного процесу хоста PowerShell.
* Це дозволяє маніпулювати вікном терміналу та взаємодіяти з ним.
...
Отримує об'єкт WindowObj для поточного вікна терміналу PowerShell.
