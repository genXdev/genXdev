...
> Відображає примітки до випуску з файлу README.md.

## Description

Показує всі примітки про випуски з розділу "## Release notes" файлу README.md. Можна використовувати README в поточному розташуванні, каталозі профілю PowerShell або каталозі OneDrive.
