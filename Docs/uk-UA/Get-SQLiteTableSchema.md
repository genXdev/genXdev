...
> Отримує інформацію про схему для вказаної таблиці SQLite.

## Description

Ця функція запитує базу даних SQLite для отримання детальної інформації про схему зазначеної таблиці. Вона використовує команду SQLite PRAGMA table_info для повернення визначень стовпців, включаючи назви, типи, можливість null та значення за замовчуванням.
...
| `-TableName` | String | ✅ | — | 1 | — | Назва таблиці |
