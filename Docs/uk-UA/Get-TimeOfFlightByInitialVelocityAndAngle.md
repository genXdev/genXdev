...
> Обчислює час польоту снаряда.

## Description

Використовує T = (2 v sinθ) / g для ідеального руху.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-InitialVelocityInMetersPerSecond` | Double | ✅ | — | 0 | `0` | Початкова швидкість у м/с |
| `-AngleInDegrees` | Double | ✅ | — | 1 | `0` | Кут запуску в градусах |
| `-GravityInMetersPerSecondSquared` | Double | — | — | 2 | `0` | Гравітація в м/с² (за замовчуванням: 9,81) |
| `-As` | String | — | — | 3 | — | Одиниця виводу для часу |
...
Обчислює час польоту для снаряда, запущеного зі швидкістю 20 м/с під кутом 45 градусів, результат у хвилинах.
...
Обчислює час польоту для снаряда, запущеного зі швидкістю 30 м/с під кутом 30 градусів.
