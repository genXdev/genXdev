...
> Отримує інформацію про положення та стан вікон.

## Description

Отримує детальну інформацію про позиціонування вікна, розмір, розташування на моніторі, стан закріплення та статус фокусу для вказаних процесів або дескрипторів вікон.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-ProcessName` | String | — | ✅ (ByValue, ByPropertyName) | 0 | — | Назва процесу вікна, для якого потрібно отримати позицію *(Parameter set: )* 🌐 *Supports wildcards* |
| `-Process` | Diagnostics.Process | — | ✅ (ByValue, ByPropertyName) | Named | — | Процес вікна для отримання позиції *(Parameter set: )* |
...
> Назва процесу вікна, для якого потрібно отримати позицію
...
> Процес вікна для отримання позиції
