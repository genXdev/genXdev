...
> Виконує виклик функції інструмента з перевіркою та фільтрацією параметрів.

## Description

Ця функція обробляє виклики інструментів шляхом перевірки аргументів, фільтрації параметрів і виконання зворотних викликів з належною обробкою підтверджень. Вона підтримує як блоки сценаріїв, так і зворотні виклики з інформацією про команди.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-ToolCall` | Collections.Hashtable | ✅ | — | 0 | — | Об'єкт виклику інструменту, що містить деталі функції та аргументи |
...
| `-ForceAsText` | SwitchParameter | — | — | Named | — | Примусово вивести як текст |
...
> Об'єкт виклику інструменту, що містить деталі функції та аргументи
