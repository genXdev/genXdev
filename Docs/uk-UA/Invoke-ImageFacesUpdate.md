...
> Оновлює метадані розпізнавання облич для файлів зображень у вказаному каталозі.

## Description

Ця функція обробляє зображення у вказаному каталозі для ідентифікації та аналізу
облич за допомогою технології штучного інтелекту. Вона створює або оновлює файли метаданих,
що містять інформацію про обличчя для кожного зображення. Метадані зберігаються в окремому файлі.
