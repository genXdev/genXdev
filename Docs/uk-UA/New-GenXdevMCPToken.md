...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Length` | Int32 | — | — | 0 | `32` | Довжина токена в байтах (за замовчуванням: 32, мінімум: 16) |
| `-SetEnvironmentVariable` | SwitchParameter | — | — | Named | — | Збережіть токен у змінній середовища користувача GENXDEV_MCP_TOKEN |
| `-Force` | SwitchParameter | — | — | Named | — | Перезаписати існуючу змінну середовища без підтвердження |

## Parameter Details

### `-Length <Int32>`

> Довжина токена в байтах (за замовчуванням: 32, мінімум: 16)
...
> Збережіть токен у змінній середовища користувача GENXDEV_MCP_TOKEN
...
> Перезаписати існуючу змінну середовища без підтвердження
