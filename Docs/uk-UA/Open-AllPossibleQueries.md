...
> Відкриває всі можливі типи запитів для заданих пошукових термінів або URL-адрес.

## Description

Виконує всі командлети, які обробляють веб-запити, обробляючи як URL-адреси, так і пошукові терміни. Для URL-адрес виконує запити, специфічні для сайту, а для пошукових термінів виконує загальні веб-запити. Ця функція динамічно виявляє та виконує всі доступні командлети запитів із сімейства модулів GenXdev.Queries.
...
| `-SessionOnly` | SwitchParameter | — | — | Named | — | Використовуйте режим лише для сесії для профілю браузера. |
| `-ClearSession` | SwitchParameter | — | — | Named | — | Очистити сеанс браузера перед відкриттям. |
| `-SkipSession` | SwitchParameter | — | — | Named | — | Пропустити відновлення сеансу браузера. |
...
Відкриває всі можливі типи запитів для «powershell scripting» на моніторі за замовчуванням.
...
Відкриває всі можливі типи запитів для URL-адреси GitHub, використовуючи псевдоніми та короткі параметри.
...
> Використовуйте режим лише для сесії для профілю браузера.
...
> Очистити сеанс браузера перед відкриттям.
...
> Пропустити відновлення сеансу браузера.
...
- [ConvertTo-Uris](https://github.com/genXdev/genXdev/blob/main/Docs/uk-UA/ConvertTo-Uris.md)
