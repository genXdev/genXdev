...
> Відкриває запит Bing CoPilot у веббраузері

## Description

Відкриває запит Bing CoPilot у веб-браузері. Функція автоматично вводить запит і надсилає його за допомогою функції Open-WebsiteAndPerformQuery. Це забезпечує зручний спосіб взаємодії з Microsoft Copilot з PowerShell.
...
| `-ClearSession` | SwitchParameter | — | — | Named | — | Очистити сеанс/профіль браузера перед відкриттям. |
| `-SkipSession` | SwitchParameter | — | — | Named | — | Пропустити завантаження сесії/профілю браузера. |
...
> Очистити сеанс/профіль браузера перед відкриттям.
...
> Пропустити завантаження сесії/профілю браузера.
...
- [Open-DeepSearchQuery](https://github.com/genXdev/genXdev/blob/main/Docs/uk-UA/Open-DeepSearchQuery.md)
