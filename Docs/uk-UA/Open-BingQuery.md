...
> Відкриває пошуковий запит Bing у веб-браузері.

## Description

Відкриває один або кілька пошукових запитів Bing у веб-браузері з використанням настроюваних налаштувань браузера та параметрів командного рядка. Ця функція надає комплексний інтерфейс для виконання пошуку Bing з широкими можливостями налаштування браузера, включаючи позиціонування вікна, вибір монітора, приватний перегляд та автоматизацію натискань клавіш.

Функція автоматично кодує запити в URL-форматі та форматує їх для пошукового API Bing. Вона підтримує всі основні браузери, включаючи Edge, Chrome та Firefox, з такими функціями, як приватний перегляд, режим програми, точне керування вікнами та автоматизація натискань клавіш.
...
Відкриває пошук Bing за запитом «Написання сценаріїв PowerShell» на моніторі за замовчуванням.
...
Відкриває пошук Bing, використовуючи псевдонім та короткі назви параметрів.
...
Відкриває сеанс приватного перегляду для пошуку «machine learning» з результатами англійською мовою.
...
Виконує пошук за кількома термінами через конвеєр і відкриває результати у всіх встановлених браузерах, розташовуючи вікна у лівій частині екрана.
