...
> Відкриває закладки браузера, які відповідають вказаним критеріям пошуку.

## Description

Виконує пошук закладок у браузерах Microsoft Edge, Google Chrome та Mozilla Firefox на основі наданих пошукових запитів. Відкриває відповідні закладки у вибраному браузері з налаштовуваними параметрами вікна та режимами роботи браузера.

Ця функція забезпечує комплексний інтерфейс для пошуку та відкриття закладок браузера з розширеними параметрами фільтрації та відображення. Вона підтримує кілька критеріїв пошуку та може відкривати результати в будь-якому встановленому браузері з широкими можливостями налаштування позиції вікна та поведінки.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Queries` | String[] | — | ✅ (ByValue, ByPropertyName) | 0 | — | Пошукові терміни для фільтрації закладок |
| `-Count` | Int32 | — | — | 1 | `50` | Максимальна кількість URL-адрес для відкриття |
| `-Edge` | SwitchParameter | — | — | Named | — | Виберіть у Microsoft Edge |
| `-Chrome` | SwitchParameter | — | — | Named | — | Виберіть у Google Chrome |
| `-Firefox` | SwitchParameter | — | — | Named | — | Вибрати у Firefox |
...
| `-ShowWindow` | SwitchParameter | — | — | Named | — | OK |
...
| `-Minimize` | SwitchParameter | — | — | Named | — | Згорнути вікно після розташування |
...
Виконує пошук закладок, що містять «github», у Microsoft Edge та відкриває перші 5 результатів у браузері за замовчуванням.
...
Те саме, що й вище, використовуючи псевдоніми - шукає закладки Edge за запитом "gh" і відкриває 5 результатів у браузері за замовчуванням.
...
Виконує пошук закладок Chrome за запитом 'development' та 'tools', відкриває перші 10 результатів у Firefox, розташованому з лівого боку екрана.

## Parameter Details

### `-Queries <String[]>`

> Пошукові терміни для фільтрації закладок
...
> Максимальна кількість URL-адрес для відкриття
...
> Згорнути вікно після розташування
