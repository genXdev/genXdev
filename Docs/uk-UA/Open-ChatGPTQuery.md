...
> Відкриває запит до ChatGPT у веб-браузері.

## Description

Відкриває ChatGPT у веб-браузері, автоматично вводить зазначений запит і
надсилає його. Підтримує кілька запитів, які виконуються за допомогою
вбудованої функції Open-WebsiteAndPerformQuery. Ця функція забезпечує
зручний спосіб взаємодії з OpenAI ChatGPT з PowerShell з широкими
можливостями налаштування браузера.
...
| `-ShowWindow` | SwitchParameter | — | — | Named | — | Показати вікно браузера |
...
Надсилайте кілька запитів, використовуючи повне ім'я параметра.
...
Надішліть запит за допомогою псевдоніма та конвеєра.
