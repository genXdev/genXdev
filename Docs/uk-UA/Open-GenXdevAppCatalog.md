...
> Відкриває каталог прогресивних веб-додатків GenXdev у веб-браузері.

## Description

Відкриває каталог опублікованих прогресивних веб-додатків GenXdev у веб-браузері.
Відкривається в режимі додатку з повноекранним режимом, увімкненим за замовчуванням, щоб забезпечити
оптимальний перегляд каталогу. Підтримує всі стандартні параметри конфігурації веб-браузера,
включаючи розташування монітора, розмір вікна та мовні налаштування.

Функція автоматично налаштовує браузер для найкращого перегляду каталогу
і може одночасно відкривати кілька екземплярів браузера. Вона забезпечує
всебічну мовну підтримку та враховує вподобання користувача щодо вибору
браузера та його розташування.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Language` | String | — | — | 0 | — | Мова повернутих результатів пошуку |
...
| `-Monitor` | Int32 | — | — | Named | `-2` | Монітор для використання: 0 = за замовчуванням, -1 = ігнорувати, -2 = налаштований додатковий монітор, за замовчуванням -1, без позиціонування |
| `-FullScreen` | SwitchParameter | — | — | Named | — | Відкривається в режимі повного екрана |
| `-ShowWindow` | SwitchParameter | — | — | Named | — | I'll show the browser window (not minimized or hidden). Let me bring it to the foreground. |
...
Відкриває каталог застосунків GenXdev на моніторі 1 у режимі застосунку з повноекранним режимом.
...
Відкриває каталог програм GenXdev на моніторі 1 за допомогою команди-псевдоніма.
...
> I'll show the browser window (not minimized or hidden). Let me bring it to the foreground.
...
- [Open-ViralSimulation](https://github.com/genXdev/genXdev/blob/main/Docs/uk-UA/Open-ViralSimulation.md)
