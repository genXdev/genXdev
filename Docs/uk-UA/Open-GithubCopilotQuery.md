...
> Відкриває запит GitHub CoPilot у веб-браузері

## Description

Відкриває запит Github CoPilot у веб-браузері та автоматично вводить вказаний запит. Функція чекає завантаження сторінки перед введенням запиту. Ця функція використовує базову функцію Open-WebsiteAndPerformQuery для автоматизації браузера та забезпечує зручний спосіб взаємодії з GitHub Copilot з PowerShell із широкими можливостями налаштування браузера.
