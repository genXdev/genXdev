...
> Відкриває запит Google Gemini у веб-браузері

## Description

Відкриває запит до Google Gemini у веббраузері, автоматично вводить запит і надсилає його. Це забезпечує швидкий спосіб взаємодії зі штучним інтелектом Gemini від Google. Функція підтримує розширене керування браузером, включаючи вибір монітора, позиціонування вікна та функції автоматизації клавіатури.
...
Відкриває Google Gemini та надсилає запит «Що таке PowerShell?».
...
Використовує псевдонім для подання запиту про масиви через вхід конвеєра.
