...
> Відкриває запити інформації про сайти Google у веб-браузері.

## Description

@{response=Відкриває кілька пошукових запитів Google, пов'язаних з інформацією про сайт (site:, link:, related:), у веб-браузері для вказаного домену(ів).}
...
| `-SessionOnly` | SwitchParameter | — | — | Named | — | Використовувати режим лише сесії для профілю браузера (без постійних даних) |
| `-ClearSession` | SwitchParameter | — | — | Named | — | Очистити дані сесії/профілю браузера перед відкриттям |
| `-SkipSession` | SwitchParameter | — | — | Named | — | Пропустити використання сесії/профілю браузера (використовувати стандартний) |
...
> Використовувати режим лише сесії для профілю браузера (без постійних даних)
...
> Очистити дані сесії/профілю браузера перед відкриттям
...
> Пропустити використання сесії/профілю браузера (використовувати стандартний)
