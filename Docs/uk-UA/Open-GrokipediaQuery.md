...
> Відкриває запит Grokipedia у веб-браузері.

## Description

Відкриває один або кілька пошукових запитів Grokipedia у веб-браузері з широкими можливостями налаштування. Підтримує налаштовувану поведінку браузера, вибір монітора та позиціювання вікон. Запити кодуються в URL і відкриваються з використанням домену Grokipedia зазначеної мови з повною підтримкою локалізації.

Функція забезпечує комплексне керування браузером, включаючи режими приватного перегляду, позиціювання вікон, автоматизацію клавіатури та підтримку кількох моніторів. Вона автоматично обробляє кодування URL та відображення кодів мов для міжнародних доменів Grokipedia.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Queries` | String[] | ✅ | ✅ (ByValue, ByPropertyName) | 0 | — | Запит на пошук у Грокіпедії, який потрібно виконати |
...
Відкриває пошук Grokipedia для «PowerShell» англійською мовою на моніторі за замовчуванням.
...
Відкриває пошук у Grokipedia, використовуючи псевдонім із позиційними параметрами.
...
Шукає кілька термінів у Грокіпедії, використовуючи режим приватного перегляду.

## Parameter Details

### `-Queries <String[]>`

> Запит на пошук у Грокіпедії, який потрібно виконати
