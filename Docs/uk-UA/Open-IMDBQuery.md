...
> Відкриває пошуковий запит IMDB у веб-браузері.

## Description

Відкриває запит до «Internet Movie Database» у веб-браузері з розширеними
налаштуваннями. Ця функція забезпечує зручну обгортку
функціональності пошуку IMDB, дозволяючи користувачам шукати фільми,
телевізійні шоу, акторів та інший розважальний контент безпосередньо з PowerShell.

Функція приймає пошукові терміни та формує правильні URL-адреси пошуку IMDB,
потім відкриває їх у вказаному веб-браузері з налаштовуваним
позиціонуванням вікна, вибором браузера та параметрами відображення. Підтримує всі основні
браузери, включаючи Edge, Chrome та Firefox, з опціями для приватного
перегляду, повноекранного режиму та керування вікнами.

Ключові функції включають підтримку кількох моніторів, локалізацію мови, автоматизацію
клавіатури та комплексні параметри налаштування браузера. Функція
може обробляти кілька пошукових запитів одночасно та надає опції як для
інтерактивного використання, так і для автоматизованих робочих процесів.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Queries` | String[] | ✅ | ✅ (ByValue, ByPropertyName) | 0 | — | Умови пошуку для запиту на IMDB |
| `-Language` | String | — | — | 1 | — | Мова повернутих результатів пошуку |
...
| `-DisablePopupBlocker` | SwitchParameter | — | — | Named | — | Вимикає функцію блокування спливаючих вікон браузера |
...
| `-SendKeyEscape` | SwitchParameter | — | — | Named | — | Екранує керуючі символи під час надсилання натискань клавіш у браузер. |
| `-SendKeyHoldKeyboardFocus` | SwitchParameter | — | — | Named | — | Запобігає поверненню фокусу клавіатури до PowerShell після надсилання натискань клавіш |
| `-SendKeyUseShiftEnter` | SwitchParameter | — | — | Named | — | Використовує Shift+Enter замість звичайного Enter для розривів рядків під час надсилання клавіш. |
...
Відкриває пошук IMDB для «Матриці» на моніторі за замовчуванням.
...
Відкриває пошук IMDB для "Матриця" з використанням параметрів псевдоніма та скорочення.
...
Шукає кілька фільмів на IMDB з результатами французькою мовою в Chrome.
...
Шукає Тома Хенкса на IMDB у повноекранному режимі, потім повертає фокус на PowerShell.

## Parameter Details

### `-Queries <String[]>`

> Умови пошуку для запиту на IMDB
...
> Вимикає функцію блокування спливаючих вікон браузера
...
> Екранує керуючі символи під час надсилання натискань клавіш у браузер.
...
> Запобігає поверненню фокусу клавіатури до PowerShell після надсилання натискань клавіш
...
> Використовує Shift+Enter замість звичайного Enter для розривів рядків під час надсилання клавіш.
