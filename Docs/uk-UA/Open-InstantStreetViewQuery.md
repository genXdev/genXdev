...
> Відкриває запити InstantStreetView у веб-браузері.

## Description

Відкриває запити InstantStreetView у налаштовуваному режимі, використовуючи параметри командного рядка веб-браузера. Підтримує кілька запитів і вибір монітора. Надає повний контроль над браузером, включаючи позиціонування вікна, налаштування мови та специфічні функції браузера.

Функція автоматично створює URL-адреси InstantStreetView шляхом кодування запитів місцезнаходження та відкриває їх у вказаному браузері. Підтримує всі основні браузери, включаючи Edge, Chrome та Firefox, з широкими можливостями налаштування.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Queries` | String[] | ✅ | ✅ (ByValue, ByPropertyName) | 0 | — | Запити на місцезнаходження для перегляду в InstantStreetView |
...
| `-Monitor` | Int32 | — | — | Named | `-1` | Монітор для використання: 0 = за замовчуванням, -1 = ігнорувати, -2 = налаштований додатковий монітор, за замовчуванням $Global:DefaultSecondaryMonitor або 2, якщо не знайдено |
...
Відкриває InstantStreetView для Times Square у типовому браузері на основному моніторі.
...
Відкриває InstantStreetView для Ейфелевої вежі з використанням псевдоніма 'isv' і відображає на вторинному моніторі.
...
Відкриває InstantStreetView для Біг-Бену англійською мовою з використанням приватного режиму перегляду.
...
Відкриває декілька запитів InstantStreetView через конвеєр у браузері Chrome, розташованих у лівій частині екрана.

## Parameter Details

### `-Queries <String[]>`

> Запити на місцезнаходження для перегляду в InstantStreetView
