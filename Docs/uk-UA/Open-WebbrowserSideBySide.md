...
> Запускає нове вікно веб-браузера з певним позиціонуванням.

## Description

Відкриває нове вікно браузера (Edge або Chrome), розташоване з правого боку основного монітора у фоновому режимі.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Url` | String[] | — | ✅ (ByValue) | 0 | — | Посилання для відкриття в браузері |
