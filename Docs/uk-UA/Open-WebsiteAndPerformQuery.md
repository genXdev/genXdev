...
> Відкриває веб-сторінку у веб-браузері та виконує один або кілька запитів.

## Description

Ця функція відкриває веб-сайт за URL-адресою у веб-браузері за замовчуванням, вводить один або кілька запитів і надсилає їх. Вона підтримує розширені можливості вибору монітора та налаштування позиції вікна через базову функцію Open-Webbrowser.

Функція автоматично копіює кожен запит у буфер обміну та надсилає його у вікно браузера за допомогою автоматизації клавіатури. Вона зберігає початковий вміст буфера обміну та відновлює його після обробки всіх запитів.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Url` | String | ✅ | ✅ (ByPropertyName) | 0 | — | URL веб-сайту для відкриття |
...
| `-SendKeyDelayMilliSeconds` | Int32 | — | — | Named | `500` | Затримка між надсиланням різних послідовностей клавіш у мілісекундах |
...
Відкриває Google і шукає «PowerShell».
...
Відкриває Google і виконує пошук 'PowerShell tutorials' на моніторі за замовчуванням.

## Parameter Details

### `-Url <String>`

> URL веб-сайту для відкриття
