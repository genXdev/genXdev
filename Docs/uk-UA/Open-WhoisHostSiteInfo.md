...
> Відкриває запит інформації про хост Whois у веб-браузері.

## Description

Відкриває запити інформації про хост Whois у веб-браузері для доменних імен або IP-адрес. Підтримує налаштовуваний вибір монітора та кілька запитів з розширеними параметрами конфігурації браузера, включаючи позиціонування вікна, вибір браузера та функції автоматизації.
...
| `-SessionOnly` | SwitchParameter | — | — | Named | — | Використовуйте альтернативні налаштування, збережені в сеансі, для уподобань ШІ, таких як мова, колекції зображень тощо. |
| `-ClearSession` | SwitchParameter | — | — | Named | — | Очистити альтернативні налаштування, збережені в сесії для AI-уподобань, такі як мова, колекції зображень тощо. |
| `-SkipSession` | SwitchParameter | — | — | Named | — | Зберігайте налаштування лише в постійних налаштуваннях, не впливаючи на сеанс для налаштувань ШІ, таких як мова, колекції зображень тощо. |
...
Відкриває інформацію Whois для кількох доменів на моніторі за замовчуванням.
...
Відкриває інформацію Whois для example.com, використовуючи псевдоніми та позиційні параметри.
...
Відкриває інформацію Whois для доменів з конвеєра в приватному режимі Chrome.
...
> Використовуйте альтернативні налаштування, збережені в сеансі, для уподобань ШІ, таких як мова, колекції зображень тощо.
...
> Очистити альтернативні налаштування, збережені в сесії для AI-уподобань, такі як мова, колекції зображень тощо.
...
> Зберігайте налаштування лише в постійних налаштуваннях, не впливаючи на сеанс для налаштувань ШІ, таких як мова, колекції зображень тощо.
