...
> Відкриває пошук у нідерландській Вікіпедії у веб-браузері.

## Description

Відкриває запит 'Вікіпедія - Нідерланди' у веббраузері з настроюваними параметрами відображення. Підтримує пошук кількох термінів і вказування, на якому моніторі показувати результати.
...
| `-SideBySide` | SwitchParameter | — | — | Named | — | Відкриває два вікна браузера поруч |
| `-SessionOnly` | SwitchParameter | — | — | Named | — | Використовувати лише сеансові файли cookie (без постійних файлів cookie) |
| `-ClearSession` | SwitchParameter | — | — | Named | — | Очистити дані сеансу браузера перед відкриттям |
| `-SkipSession` | SwitchParameter | — | — | Named | — | Пропустити відновлення попереднього сеансу браузера |
...
> Відкриває два вікна браузера поруч
...
> Використовувати лише сеансові файли cookie (без постійних файлів cookie)
...
> Очистити дані сеансу браузера перед відкриттям
...
> Пропустити відновлення попереднього сеансу браузера
