...
> Відкриває запит Wolfram Alpha у веб-браузері.

## Description

Відкриває один або кілька запитів Wolfram Alpha у веб-браузері. Підтримує налаштовуваний
вибір монітора та параметри браузера через динамічні параметри. Забезпечує
комплексне керування браузером, включаючи позиціонування, зміну розміру та автоматизацію
для розширених робочих процесів наукових обчислень.
...
| `-SendKeyEscape` | SwitchParameter | — | — | Named | — | Екрануйте керуючі символи під час надсилання ключів. |
...
| `-SendKeyUseShiftEnter` | SwitchParameter | — | — | Named | — | Надсилати Shift+Enter замість звичайного Enter для перенесення рядка під час надсилання клавіш. |
...
Відкриває запит Wolfram Alpha для маси Сонця на стандартному моніторі.
...
Відкриває кілька запитів до Wolfram Alpha, використовуючи псевдонім для швидких наукових обчислень.
...
Відкриває запит обчислень у повноекранному режимі з вибором англійської мови через вхідні дані конвеєра.
...
> Надсилати Shift+Enter замість звичайного Enter для перенесення рядка під час надсилання клавіш.
