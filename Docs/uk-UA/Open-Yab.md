...
> Відкриває гру YAB у веб-браузері з настроюваними параметрами.

## Description

Відкриває веб-сайт гри YAB у вказаному браузері з різними параметрами відображення та поведінки. Підтримує різні режими гри, включаючи режим спостерігача. Гра YAB - це онлайн-головоломка, в яку можна грати інтерактивно або спостерігати в режимі глядача, де ШІ грає автоматично.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Language` | String | — | — | 0 | — | Мова інтерфейсу гри |
...
| `-SpectateOnly` | SwitchParameter | — | — | Named | — | Не починайте нову гру, просто спостерігайте за грою ШІ |
...
Відкриває гру YAB у режимі глядача за допомогою браузера Chrome без повноекранного режиму, з англомовним інтерфейсом.
...
Відкриває гру YAB у браузері Edge із закритим переглядом на моніторі 2 за допомогою псевдонімів для швидкого доступу.
...
> Не починайте нову гру, просто спостерігайте за грою ШІ
