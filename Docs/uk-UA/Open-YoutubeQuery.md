...
> Відкриває пошукові запити YouTube у веб-переглядачі.

## Description

Відкриває один або кілька пошукових запитів YouTube у веб-браузері з розширеними можливостями позиціонування та налаштування. Підтримує налаштовуваний вибір монітора, параметри браузера та автоматизацію натискань клавіш через динамічні параметри, успадковані від командлета Open-Webbrowser. Кожен запит відкривається в окремому екземплярі браузера з повним контролем позиціонування вікна, типу браузера та мови пошуку.
...
Відкриває пошук YouTube за запитом "PowerShell tutorial" на моніторі за замовчуванням.
...
Відкриває пошук YouTube за запитом «як кодувати» на налаштованому додатковому моніторі, використовуючи псевдонім функції.
