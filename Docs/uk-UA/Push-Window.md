...
> Розміщує поточне вікно в стек вікон з необов'язковими змінами.

## Description

Поміщає в стек хелпер вікна для поточного активного вікна.
Дозволяє застосовувати різні перетворення вікна до або після поміщення.
Ця функція захоплює поточне вікно та зберігає його для подальшого отримання
за допомогою Pop-Window, з можливістю застосування позиціонування, зміни розміру та візуальних
ефектів.
