...
> Розширює вхідні об'єкти в імена файлів та каталогів, підтримуючи різні фільтри та параметри виведення.

## Description

Ця функція обробляє вхідні об'єкти (файли, каталоги або колекції) і розширює їх до імен файлів та каталогів. Вона підтримує фільтрацію, зіставлення з шаблоном і може виводити результати як об'єкти. Функція призначена для роботи з вхідними даними конвеєра та надає можливості для рекурсії, альтернативних потоків даних тощо.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-InputObject` | Object | — | ✅ (ByValue, ByPropertyName) | 0 | — | Вхідний об'єкт, що містить імена файлів або каталогів |
| `-File` | SwitchParameter | — | — | Named | — | Повернути лише файли |
| `-Pattern` | String | — | — | 1 | — | Регулярний вираз для пошуку у вмісті *(Parameter set: )* 🌐 *Supports wildcards* |
...
| `-Directory` | SwitchParameter | — | — | Named | — | Шукати лише каталоги *(Parameter set: )* |
| `-FilesAndDirectories` | SwitchParameter | — | — | Named | — | Включає як файли, так і каталоги *(Parameter set: )* |
...
> Вхідний об'єкт, що містить імена файлів або каталогів
