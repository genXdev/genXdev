...
> Максимізує перший відеоелемент, знайдений на поточній вкладці браузера.

## Description

Виконує JavaScript-код для пошуку та розгортання на весь екран першого відеоелемента на поточній веб-сторінці. Відео встановлюється таким чином, щоб заповнити всю область перегляду з максимальним z-індексом для забезпечення видимості. Смуги прокрутки сторінки приховані для чистого повноекранного перегляду.
