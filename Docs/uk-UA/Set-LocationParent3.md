...
> Переміщує вгору на три рівні каталогів в ієрархії файлової системи.

## Description

* Змінює поточний робочий каталог, переходячи на три рівні вгору по ієрархії файлової системи.
* Відображає вміст отриманого каталогу.
...
Переходить на три рівні каталогів вгору від поточного розташування.
...
Використовує псевдонім для переходу на три рівні каталогів вгору.
