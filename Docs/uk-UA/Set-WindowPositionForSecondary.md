...
> Розташовує вікно на вторинному моніторі з указаними параметрами макета.

## Description

Ця функція дозволяє розташовувати вікна на налаштованому додатковому моніторі за допомогою Set-WindowPosition з різними параметрами макета, включаючи вирівнювання, розмір та налаштування меж. Вона обробляє вибір монітора на основі глобальної конфігурації та надає зручну оболонку для позиціонування вікон на додатковому моніторі.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Process` | Diagnostics.Process[] | — | ✅ (ByValue, ByPropertyName) | 0 | — | Процес позиціонування вікна |
| `-Monitor` | Int32 | — | — | Named | `-2` | Монітор для використання: 0 — за замовчуванням, -1 — ігнорувати, -2 — налаштований. |
| `-Width` | Int32 | — | — | Named | `-1` | Початкова ширина вікна |
| `-Height` | Int32 | — | — | Named | `-1` | Початкова висота вікна |
| `-X` | Int32 | — | — | Named | `-999999` | Початкова позиція X вікна |
| `-Y` | Int32 | — | — | Named | `-999999` | Початкова позиція Y вікна |
...
| `-FocusWindow` | SwitchParameter | — | — | Named | — | Встановити фокус на вікно після позиціонування |
| `-SetForeground` | SwitchParameter | — | — | Named | — | Встановлювати вікно на передній план після позиціонування |
...
| `-KeysToSend` | String[] | — | — | Named | — | Натискання клавіш для відправки у вікно після позиціонування |
...
| `-PassThru` | SwitchParameter | — | — | Named | — | Повертає об'єкт процесу після позиціонування |
| `-SideBySide` | SwitchParameter | — | — | Named | — | Розташувати вікно поруч із PowerShell на тому ж моніторі |
...
> Монітор для використання: 0 — за замовчуванням, -1 — ігнорувати, -2 — налаштований.
...
> Встановити фокус на вікно після позиціонування
...
> Встановлювати вікно на передній план після позиціонування
...
> Натискання клавіш для відправки у вікно після позиціонування
...
> Повертає об'єкт процесу після позиціонування
...
> Розташувати вікно поруч із PowerShell на тому ж моніторі
