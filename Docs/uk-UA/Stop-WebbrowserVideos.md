...
> Призупиняє відтворення відео у всіх активних сесіях браузера.

## Description

Перебирає всі активні сеанси браузера та призупиняє відтворення відео шляхом виконання команд JavaScript. Функція зберігає початковий стан сеансу та елегантно обробляє помилки.
