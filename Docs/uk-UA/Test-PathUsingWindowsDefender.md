...
> Сканує файли або каталоги на наявність шкідливого програмного забезпечення за допомогою Захисника Windows.

## Description

Виконує цілеспрямоване сканування зазначених файлів або каталогів за допомогою інтерфейсу командного рядка Windows Defender (MpCmdRun.exe).
* Може виконувати сканування в режимі лише виявлення або з автоматичним усуненням загроз.
* Повертає true, якщо загрози не виявлено, false, якщо загрози знайдено або сканування не виконується.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-FilePath` | String | ✅ | ✅ (ByValue, ByPropertyName) | 0 | — | Шлях до файлу або каталогу, який потрібно сканувати |
| `-EnableRemediation` | SwitchParameter | — | — | Named | `False` | Наказує Windows Defender виконати дію щодо загроз |
...
Сканує вказаний файл і виводить докладний вивід.
...
Сканує файл за допомогою псевдоніма та вмикає виправлення.
...
Передає шлях до файлу до командлета за допомогою псевдоніма.

## Parameter Details

### `-FilePath <String>`

> Шлях до файлу або каталогу, який потрібно сканувати
...
> Наказує Windows Defender виконати дію щодо загроз
