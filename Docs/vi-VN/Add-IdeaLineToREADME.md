...
> Thêm một mục ý tưởng vào tệp README.md.

## Description

Thêm một ý tưởng có dấu thời gian vào phần "## Ideas" của tệp README.md.
Có thể hiển thị phần đã sửa đổi và mở trong Visual Studio Code.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Line` | String | — | — | 0 | `''` | Văn bản ý tưởng để thêm vào |
