...
> Thêm một mục vấn đề vào tệp README.md.

## Description

Thêm một vấn đề có dấu thời gian vào phần "## Issues" của tệp README.md. Có thể hiển thị phần đã sửa đổi và mở trong Visual Studio Code.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Line` | String | — | — | 0 | `''` | Văn bản vấn đề cần thêm |
