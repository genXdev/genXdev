...
> Thêm một dòng ReleaseNote vào tệp README có kèm dấu thời gian.

## Description

Thêm một dòng Ghi chú Phát hành vào tệp README đã chỉ định, có tiền tố là ngày hiện tại ở định dạng yyyyMMdd. Dòng này có thể được định dạng dưới dạng mã và hiển thị tùy chọn.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Line` | String | — | — | 0 | `''` | Văn bản mô tả ghi chú phát hành để thêm vào |
| `-Code` | SwitchParameter | — | — | Named | — | Định dạng dòng dưới dạng mã |
| `-Show` | SwitchParameter | — | — | Named | — | Hiển thị README sau khi thêm dòng |
| `-UseHomeREADME` | SwitchParameter | — | — | Named | — | Sử dụng README trong thư mục chính |
...
> Văn bản mô tả ghi chú phát hành để thêm vào
...
> Hiển thị README sau khi thêm dòng
...
> Sử dụng README trong thư mục chính
