...
> Đóng tab trình duyệt web hiện đang được chọn.

## Description

Đóng tab trình duyệt web hiện đang được chọn bằng phương thức CloseAsync() của ChromeDriver. Nếu không có tab nào được chọn, hàm sẽ tự động cố gắng chọn tab cuối cùng đã sử dụng trước khi đóng nó.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Edge` | SwitchParameter | — | — | Named | — | Điều hướng bằng trình duyệt Microsoft Edge |
| `-Chrome` | SwitchParameter | — | — | Named | — | Điều hướng bằng trình duyệt Google Chrome |
