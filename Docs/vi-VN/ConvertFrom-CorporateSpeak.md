...
> Chuyển đổi ngôn ngữ công sở lịch sự, chuyên nghiệp thành ngôn ngữ trực tiếp, rõ ràng bằng AI.

## Description

Chức năng này xử lý văn bản đầu vào để chuyển đổi các thông điệp ngoại giao, doanh nghiệp thành ngôn ngữ trực tiếp và rõ ràng hơn. Nó có thể chấp nhận đầu vào trực tiếp thông qua tham số, từ pipeline, hoặc từ clipboard hệ thống. Chức năng tận dụng các mô hình AI để phân tích và diễn đạt lại văn bản trong khi vẫn giữ nguyên ý định ban đầu.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Text` | String | — | ✅ (ByValue) | 0 | — | Văn bản cần chuyển đổi từ ngôn ngữ doanh nghiệp |
...
> Văn bản cần chuyển đổi từ ngôn ngữ doanh nghiệp
