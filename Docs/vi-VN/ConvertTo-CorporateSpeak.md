...
> Chuyển đổi văn bản trực tiếp hoặc thô lỗ thành ngôn ngữ doanh nghiệp lịch sự, chuyên nghiệp bằng AI.

## Description

Hàm này xử lý văn bản đầu vào để chuyển đổi ngôn ngữ trực tiếp hoặc có khả năng gay gắt thành các thông điệp giao tiếp doanh nghiệp ngoại giao, chuyên nghiệp. Nó có thể chấp nhận đầu vào trực tiếp thông qua tham số, từ pipeline hoặc từ clipboard hệ thống. Hàm sử dụng các mô hình AI để phân tích và diễn đạt lại văn bản trong khi vẫn giữ nguyên ý định ban đầu.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Text` | String | — | ✅ (ByValue) | 0 | — | Văn bản cần chuyển đổi sang ngôn ngữ doanh nghiệp |
...
> Văn bản cần chuyển đổi sang ngôn ngữ doanh nghiệp
