...
> Chuyển đổi văn bản trực tiếp hoặc thô lỗ thành ngôn ngữ ngoại giao lịch sự, khéo léo.

## Description

Hàm này chuyển đổi đầu vào của người dùng từ cách diễn đạt trực tiếp hoặc thô thiển thành ngôn ngữ ngoại giao, tế nhị phù hợp cho các cuộc thảo luận cấp cao, đàm phán hoặc giao tiếp trang trọng. Hàm sử dụng các mô hình ngôn ngữ AI để giữ nguyên ý định ban đầu trong khi làm dịu giọng điệu và làm cho thông điệp trở nên ngoại giao và chuyên nghiệp hơn.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Text` | String | — | ✅ (ByValue) | 0 | — | Văn bản cần chuyển đổi sang ngôn ngữ ngoại giao |
...
> Văn bản cần chuyển đổi sang ngôn ngữ ngoại giao
