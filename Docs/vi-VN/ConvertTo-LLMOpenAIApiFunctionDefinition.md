...
> Chuyển đổi các hàm PowerShell thành định nghĩa hàm API OpenAI LLM.

## Description

Lấy các định nghĩa cmdlet được hiển thị và tạo ra các định nghĩa hàm tương thích với API OpenAI LLM, bao gồm thông tin tham số và trình xử lý callback.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-ExposedCmdLets` | GenXdev.Helpers.ExposedCmdletDefinition[] | — | ✅ (ByValue) | 0 | `@()` | Lệnh PowerShell để chuyển đổi thành các hàm công cụ |
...
> Lệnh PowerShell để chuyển đổi thành các hàm công cụ
