...
> Khởi động trình bảo vệ màn hình Windows đã được cấu hình.

## Description

Kích hoạt trình bảo vệ màn hình Windows hệ thống bằng cách thực thi tệp thực thi trình bảo vệ màn hình mặc định (scrnsave.scr) với công tắc /s để khởi động ngay lập tức.
