...
> Trả về tất cả các dấu trang từ các trình duyệt web đã cài đặt.

## Description

Truy xuất các dấu trang từ trình duyệt Microsoft Edge, Google Chrome hoặc Mozilla Firefox được cài đặt trên hệ thống. Hàm có thể lọc theo loại trình duyệt và trả về thông tin chi tiết về dấu trang bao gồm tên, URL, vị trí thư mục và dấu thời gian. Tự động xử lý sự đồng ý cho việc cài đặt gói NuGet System.Data.SQLite khi đọc dấu trang của Firefox.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Chrome` | SwitchParameter | — | — | Named | — | Trả về các dấu trang từ Google Chrome |
| `-Edge` | SwitchParameter | — | — | Named | — | Trả về các dấu trang từ Microsoft Edge |
| `-Firefox` | SwitchParameter | — | — | Named | — | Trả về các dấu trang từ Mozilla Firefox *(Parameter set: )* |
| `-ForceConsent` | SwitchParameter | — | — | Named | — | Buộc đồng ý cài đặt phần mềm của bên thứ ba |
| `-ConsentToThirdPartySoftwareInstallation` | SwitchParameter | — | — | Named | — | Đồng ý cài đặt phần mềm của bên thứ ba |
...
> Trả về các dấu trang từ Google Chrome
...
> Trả về các dấu trang từ Microsoft Edge
...
> Trả về các dấu trang từ Mozilla Firefox
...
> Buộc đồng ý cài đặt phần mềm của bên thứ ba
...
> Đồng ý cài đặt phần mềm của bên thứ ba
