...
> Hiển thị các tính năng từ tệp README.md.

## Description

Hiển thị tất cả các tính năng từ phần "## Features" của tệp README.md. Có thể sử dụng README ở vị trí hiện tại, thư mục hồ sơ PowerShell hoặc thư mục OneDrive.
