...
> Truy xuất thông tin chi tiết về các mô-đun PowerShell của GenXdev.

## Description

Hàm này kiểm tra các mô-đun PowerShell của GenXdev và trả về thông tin về cấu hình, phiên bản và sự hiện diện của các tệp chính. Nó có thể xử lý các mô-đun được chỉ định hoặc tất cả các mô-đun có sẵn.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-ModuleName` | String[] | — | ✅ (ByValue, ByPropertyName) | 0 | `@()` | Tên của các mô-đun cần phân tích |
...
> Tên của các mô-đun cần phân tích
