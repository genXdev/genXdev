...
> Hiển thị các vấn đề từ tệp README.md.

## Description

Hiển thị tất cả các vấn đề từ phần "## Issues" của tệp README.md. Có thể sử dụng README ở vị trí hiện tại, thư mục hồ sơ PowerShell hoặc thư mục OneDrive.
