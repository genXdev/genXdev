...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-MassInKilograms` | Double | ✅ | — | 0 | `0` | Khối lượng (kg) |
| `-VelocityInMetersPerSecond` | Double | ✅ | — | 1 | `0` | Vận tốc tính bằng m/s |
| `-As` | String | — | — | 2 | — | Đơn vị đo năng lượng |
...
Tính động năng cho một khối lượng 10kg di chuyển với vận tốc 5 m/s và xuất ra dưới dạng calo.
...
Tính động năng cho khối lượng 5kg di chuyển với vận tốc 10 m/s sử dụng tham số vị trí.
