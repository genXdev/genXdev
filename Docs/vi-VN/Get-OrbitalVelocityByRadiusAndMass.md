...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-RadiusInMeters` | Double | ✅ | — | 0 | `0` | Bán kính quỹ đạo tính bằng mét |
| `-CentralMassInKilograms` | Double | ✅ | — | 1 | `0` | Khối lượng trung tâm tính bằng kg |
| `-As` | String | — | — | 2 | — | Đơn vị đầu ra cho vận tốc |
...
Sử dụng khối lượng và bán kính Trái Đất để minh họa.
...
Tính toán đơn giản với đầu ra m/s mặc định.

## Parameter Details

### `-RadiusInMeters <Double>`

> Bán kính quỹ đạo tính bằng mét
...
> Khối lượng trung tâm tính bằng kg
