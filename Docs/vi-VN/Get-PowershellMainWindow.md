...
> Trả về một đối tượng trợ giúp cửa sổ cho cửa sổ chính của terminal PowerShell.

## Description

* Truy xuất đối tượng trợ giúp WindowObj đại diện cho cửa sổ chính của quy trình máy chủ PowerShell hiện tại.
* Điều này cho phép thao tác và tương tác với chính cửa sổ terminal.
...
Truy xuất WindowObj cho cửa sổ terminal PowerShell hiện tại.
