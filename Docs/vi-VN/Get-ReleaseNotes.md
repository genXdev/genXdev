...
> Hiển thị Ghi chú Phát hành từ tệp README.md.

## Description

Hiển thị tất cả ReleaseNotes từ phần "## Release notes" của tệp README.md. Có thể sử dụng README trong thư mục hiện tại, thư mục hồ sơ PowerShell hoặc thư mục OneDrive.
