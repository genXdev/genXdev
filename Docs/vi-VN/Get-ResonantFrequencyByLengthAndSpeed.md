...
> Tính tần số cộng hưởng cho một ống kín.

## Description

Sử dụng f = v / (4 L) cho tần số cơ bản.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-LengthInMeters` | Double | ✅ | — | 0 | `0` | Chiều dài tính bằng mét |
| `-SpeedInMetersPerSecond` | Double | ✅ | — | 1 | `0` | Tốc độ sóng tính bằng m/s *(Parameter set: )* |
| `-Medium` | String | ✅ | — | 1 | — | Phương tiện *(Parameter set: )* |
| `-As` | String | — | — | 2 | — | Đơn vị đầu ra cho tần số |
...
Tính tần số cộng hưởng cho một ống dài 0.5 mét trong không khí, đầu ra theo kilohertz.
...
Tính tần số cộng hưởng cho một ống dài 1 mét với tốc độ sóng 343 m/s.
