...
> Truy xuất dữ liệu từ một khung nhìn cơ sở dữ liệu SQL với khả năng giới hạn số bản ghi tùy chọn.

## Description

Truy vấn một khung nhìn cơ sở dữ liệu SQL bằng cách sử dụng chuỗi kết nối hoặc đường dẫn tệp cơ sở dữ liệu. Hàm hỗ trợ giới hạn số lượng bản ghi được trả về và cung cấp đầu ra chi tiết để theo dõi việc thực thi truy vấn.
...
| `-ViewName` | String | ✅ | — | 2 | — | Tên của chế độ xem cần truy vấn. |
| `-Count` | Int32 | — | — | 3 | `100` | Số lượng bản ghi cần trả về. -1 cho tất cả các bản ghi. |
