...
> Hiển thị các mục công việc từ tệp README.md.

## Description

Hiển thị tất cả các mục todo từ phần "## Todoos" của tệp README.md. Có thể sử dụng README ở vị trí hiện tại, thư mục hồ sơ PowerShell hoặc thư mục OneDrive.
