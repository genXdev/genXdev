...
> Trả về một từ điển đảo ngược cho tất cả các ngôn ngữ được hỗ trợ bởi Google Tìm kiếm.

## Description

* Trả về một từ điển ánh xạ tên ngôn ngữ thành mã ngôn ngữ tương ứng cho tất cả các ngôn ngữ được Google Tìm kiếm hỗ trợ.
* Hữu ích cho việc tra cứu mã ngôn ngữ trong các truy vấn web và tác vụ dịch thuật.
...
Truy xuất bảng ánh xạ tên ngôn ngữ sang mã của chúng.
