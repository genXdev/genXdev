...
> Nhập tất cả các mô-đun PowerShell của GenXdev vào phạm vi toàn cục.

## Description

Quét thư mục cha để tìm các mô-đun GenXdev và nhập từng mô-đun vào phạm vi toàn cục. Sử dụng quản lý ngăn xếp vị trí để bảo toàn thư mục làm việc và cung cấp phản hồi trực quan cho việc nhập thành công và thất bại. Theo dõi số lượng hàm thay đổi trong quá trình nhập.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-DebugFailedModuleDefinitions` | SwitchParameter | — | — | Named | — | Bật đầu ra gỡ lỗi cho các định nghĩa mô-đun không thành công |
...
> Bật đầu ra gỡ lỗi cho các định nghĩa mô-đun không thành công
