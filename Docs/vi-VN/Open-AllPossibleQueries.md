...
> Mở tất cả các loại truy vấn khả dụng cho các cụm từ tìm kiếm hoặc URL đã cho.

## Description

Thực thi tất cả các lệnh ghép xử lý truy vấn trang web, xử lý cả URL và từ khóa tìm kiếm. Đối với URL, nó thực hiện các truy vấn dành riêng cho trang web, và đối với từ khóa tìm kiếm, nó thực hiện các truy vấn web chung. Hàm này tự động khám phá và thực thi tất cả các lệnh ghép truy vấn có sẵn từ họ mô-đun GenXdev.Queries.
...
| `-ShowWindow` | SwitchParameter | — | — | Named | — | Mở chế độ toàn màn hình |
...
| `-SessionOnly` | SwitchParameter | — | — | Named | — | Sử dụng chế độ chỉ phiên cho hồ sơ trình duyệt. |
| `-ClearSession` | SwitchParameter | — | — | Named | — | Xóa phiên trình duyệt trước khi mở. |
| `-SkipSession` | SwitchParameter | — | — | Named | — | Bỏ qua khôi phục phiên trình duyệt. |
...
Mở tất cả các loại truy vấn có thể cho "script powershell" trên màn hình mặc định.
...
Mở tất cả các loại truy vấn có thể cho URL GitHub bằng cách sử dụng bí danh và tham số ngắn.
...
> Sử dụng chế độ chỉ phiên cho hồ sơ trình duyệt.
...
> Xóa phiên trình duyệt trước khi mở.
...
> Bỏ qua khôi phục phiên trình duyệt.
...
- [ConvertTo-Uris](https://github.com/genXdev/genXdev/blob/main/Docs/vi-VN/ConvertTo-Uris.md)
