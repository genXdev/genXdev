...
> Mở một truy vấn Bing CoPilot trong trình duyệt web

## Description

Mở một truy vấn Bing CoPilot trong trình duyệt web. Hàm tự động nhập truy vấn và gửi nó bằng hàm Open-WebsiteAndPerformQuery bên dưới. Điều này cung cấp một cách thuận tiện để tương tác với Microsoft Copilot từ PowerShell.
...
| `-ClearSession` | SwitchParameter | — | — | Named | — | Xóa phiên/lược sử trình duyệt trước khi mở. |
| `-SkipSession` | SwitchParameter | — | — | Named | — | Bỏ qua việc tải hồ sơ/phiên trình duyệt. |
...
> Xóa phiên/lược sử trình duyệt trước khi mở.
...
> Bỏ qua việc tải hồ sơ/phiên trình duyệt.
