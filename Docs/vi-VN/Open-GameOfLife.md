...
> Mở mô phỏng Conway's Game of Life trong trình duyệt web.

## Description

Mở một mô phỏng Conway's Game of Life tương tác trong cửa sổ trình duyệt web với các tùy chọn định vị và cấu hình mở rộng. Conway's Game of Life là một máy tự động tế bào do nhà toán học John Conway phát minh vào năm 1970, bao gồm một lưới các ô có thể ở một trong hai trạng thái: sống hoặc chết.

Hàm này cung cấp khả năng điều khiển trình duyệt toàn diện bao gồm định vị cửa sổ, chọn trình duyệt, duyệt web riêng tư và khả năng tương tác tự động. Mô phỏng chạy tại https://conway.genxdev.net/ và hỗ trợ nhiều chế độ tương tác.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Language` | String | — | — | 0 | — | Tùy chọn ngôn ngữ cho giao diện trình duyệt và nội dung địa phương hóa |
...
| `-SendKeyEscape` | SwitchParameter | — | — | Named | — | Thoát khỏi các ký tự điều khiển khi gửi các tổ hợp phím đến cửa sổ trình duyệt. |
| `-SendKeyHoldKeyboardFocus` | SwitchParameter | — | — | Named | — | Ngăn chặn việc trả lại tiêu điểm bàn phím cho PowerShell sau khi gửi các tổ hợp phím đến cửa sổ trình duyệt. |
| `-SendKeyUseShiftEnter` | SwitchParameter | — | — | Named | — | Sử dụng Shift+Enter thay vì Enter thông thường để xuống dòng khi gửi tổ hợp phím đến trình duyệt. |
...
| `-RestoreFocus` | SwitchParameter | — | — | Named | — | Khôi phục tiêu điểm cửa sổ PowerShell sau khi mở trình duyệt. |
...
| `-SessionOnly` | SwitchParameter | — | — | Named | — | Sử dụng chế độ chỉ phiên cho hồ sơ trình duyệt (cookie và dữ liệu bị xóa khi đóng). |
| `-ClearSession` | SwitchParameter | — | — | Named | — | Xóa dữ liệu phiên/hồ sơ trình duyệt trước khi mở. |
| `-SkipSession` | SwitchParameter | — | — | Named | — | Bỏ qua việc khôi phục phiên trình duyệt trước đó. |
...
Mở trò chơi Conway's Game of Life ở chế độ toàn màn hình trên màn hình 1.
...
Mở Game of Life bằng tiếng Pháp sử dụng Chrome ở chế độ riêng tư.
...
Mở Game of Life trên màn hình chính ở chế độ ứng dụng bằng cách sử dụng bí danh.
...
Mở Conway's Game of Life trong Microsoft Edge, đặt ở phía bên trái với kích thước cụ thể.

## Parameter Details

### `-Language <String>`

> Tùy chọn ngôn ngữ cho giao diện trình duyệt và nội dung địa phương hóa
...
> Thoát khỏi các ký tự điều khiển khi gửi các tổ hợp phím đến cửa sổ trình duyệt.
...
> Ngăn chặn việc trả lại tiêu điểm bàn phím cho PowerShell sau khi gửi các tổ hợp phím đến cửa sổ trình duyệt.
...
> Sử dụng Shift+Enter thay vì Enter thông thường để xuống dòng khi gửi tổ hợp phím đến trình duyệt.
...
> Khôi phục tiêu điểm cửa sổ PowerShell sau khi mở trình duyệt.
...
> Sử dụng chế độ chỉ phiên cho hồ sơ trình duyệt (cookie và dữ liệu bị xóa khi đóng).
...
> Bỏ qua việc khôi phục phiên trình duyệt trước đó.
