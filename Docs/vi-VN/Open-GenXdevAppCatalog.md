...
> Mở danh mục ứng dụng web tiến bộ của GenXdev trong trình duyệt web.

## Description

Mở danh mục chứa các ứng dụng web tiến bộ GenXdev đã được xuất bản trong trình duyệt web.
Mở ở chế độ ứng dụng với chế độ toàn màn hình được bật theo mặc định để cung cấp
trải nghiệm xem tối ưu cho danh mục. Hỗ trợ tất cả các tùy chọn cấu hình trình duyệt web tiêu chuẩn
bao gồm vị trí màn hình, kích thước cửa sổ và tùy chọn ngôn ngữ.

Chức năng tự động cấu hình trình duyệt để có trải nghiệm xem danh mục tốt nhất
và có thể mở nhiều phiên bản trình duyệt cùng lúc. Cung cấp
hỗ trợ ngôn ngữ toàn diện và tôn trọng tùy chọn của người dùng về lựa chọn
và định vị trình duyệt.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Language` | String | — | — | 0 | — | Ngôn ngữ của kết quả tìm kiếm được trả về |
...
| `-ShowWindow` | SwitchParameter | — | — | Named | — | Hiển thị cửa sổ trình duyệt (không thu nhỏ hoặc ẩn) |
...
Mở cửa hàng ứng dụng GenXdev trên màn hình 1 ở chế độ ứng dụng với chế độ toàn màn hình được bật.
...
Mở cửa hàng ứng dụng GenXdev trên màn hình 1 bằng cách sử dụng lệnh bí danh.
...
> Hiển thị cửa sổ trình duyệt (không thu nhỏ hoặc ẩn)
...
- [Open-Timeline](https://github.com/genXdev/genXdev/blob/main/Docs/vi-VN/Open-Timeline.md)
