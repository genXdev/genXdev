...
> Mở một truy vấn Github CoPilot trong trình duyệt web

## Description

Mở một truy vấn Github CoPilot trong trình duyệt web và tự động nhập truy vấn đã chỉ định. Hàm đợi trang tải xong trước khi nhập truy vấn. Hàm này sử dụng hàm Open-WebsiteAndPerformQuery cơ bản để xử lý tự động hóa trình duyệt và cung cấp một cách thuận tiện để tương tác với GitHub Copilot từ PowerShell với các tùy chọn cấu hình trình duyệt mở rộng.
