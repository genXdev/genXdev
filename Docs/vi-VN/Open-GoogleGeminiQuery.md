...
> Mở một truy vấn Google Gemini trong trình duyệt web

## Description

Mở một truy vấn Google Gemini trong trình duyệt web, tự động nhập truy vấn và gửi nó. Điều này cung cấp cách nhanh chóng để tương tác với AI Gemini của Google. Hàm hỗ trợ kiểm soát trình duyệt mở rộng bao gồm lựa chọn màn hình, định vị cửa sổ và các tính năng tự động hóa bàn phím.
...
Mở Google Gemini và gửi truy vấn "PowerShell là gì?".
...
Sử dụng bí danh để gửi truy vấn về mảng qua đầu vào đường ống.
