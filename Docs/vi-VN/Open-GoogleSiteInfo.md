...
> Mở các truy vấn thông tin trang web của Google trong trình duyệt web.

## Description

Mở nhiều truy vấn tìm kiếm Google liên quan đến thông tin trang web (site:, link:, related:) trong trình duyệt web cho (các) tên miền đã chỉ định.
...
| `-NoBorders` | SwitchParameter | — | — | Named | — | Xóa viền cửa sổ khỏi cửa sổ trình duyệt |
| `-SessionOnly` | SwitchParameter | — | — | Named | — | Sử dụng chế độ chỉ phiên cho hồ sơ trình duyệt (không có dữ liệu liên tục) |
| `-ClearSession` | SwitchParameter | — | — | Named | — | Xóa dữ liệu phiên/hồ sơ trình duyệt trước khi mở |
| `-SkipSession` | SwitchParameter | — | — | Named | — | Bỏ qua việc sử dụng phiên/hồ sơ trình duyệt (sử dụng mặc định) |
...
> Xóa viền cửa sổ khỏi cửa sổ trình duyệt
...
> Sử dụng chế độ chỉ phiên cho hồ sơ trình duyệt (không có dữ liệu liên tục)
...
> Xóa dữ liệu phiên/hồ sơ trình duyệt trước khi mở
...
> Bỏ qua việc sử dụng phiên/hồ sơ trình duyệt (sử dụng mặc định)
