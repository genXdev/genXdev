...
> Mở một truy vấn Grokipedia trong trình duyệt web.

## Description

Mở một hoặc nhiều truy vấn tìm kiếm Grokipedia trong trình duyệt web với các tùy chọn cấu hình mở rộng. Hỗ trợ hành vi trình duyệt có thể cấu hình, lựa chọn màn hình và định vị cửa sổ. Các truy vấn được mã hóa URL và mở bằng tên miền Grokipedia theo ngôn ngữ đã chỉ định với hỗ trợ bản địa hóa đầy đủ.

Hàm cung cấp khả năng kiểm soát trình duyệt toàn diện bao gồm chế độ duyệt web riêng tư, định vị cửa sổ, tự động hóa bàn phím và hỗ trợ nhiều màn hình. Nó tự động xử lý mã hóa URL và ánh xạ mã ngôn ngữ cho các tên miền Grokipedia quốc tế.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Queries` | String[] | ✅ | ✅ (ByValue, ByPropertyName) | 0 | — | Truy vấn tìm kiếm Grokipedia để thực thi |
...
Mở một tìm kiếm Grokipedia cho "PowerShell" bằng tiếng Anh trên màn hình mặc định.
...
Mở tìm kiếm Grokipedia bằng bí danh với các tham số vị trí.
...
Tìm kiếm nhiều thuật ngữ trên Grokipedia bằng chế độ duyệt web riêng tư.

## Parameter Details

### `-Queries <String[]>`

> Truy vấn tìm kiếm Grokipedia để thực thi
