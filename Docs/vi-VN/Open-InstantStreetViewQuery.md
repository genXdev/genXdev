...
> Mở các truy vấn InstantStreetView trong trình duyệt web.

## Description

Mở các truy vấn InstantStreetView theo cách có thể cấu hình sử dụng các công tắc dòng lệnh trình duyệt web. Hỗ trợ nhiều truy vấn và lựa chọn màn hình. Cung cấp khả năng kiểm soát trình duyệt toàn diện bao gồm định vị cửa sổ, cài đặt ngôn ngữ và các tính năng dành riêng cho trình duyệt.

Hàm tự động xây dựng các URL InstantStreetView bằng cách mã hóa URL các truy vấn vị trí và mở chúng trong trình duyệt được chỉ định. Hỗ trợ tất cả các trình duyệt chính bao gồm Edge, Chrome và Firefox với các tùy chọn tùy chỉnh mở rộng.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Queries` | String[] | ✅ | ✅ (ByValue, ByPropertyName) | 0 | — | Các truy vấn vị trí để xem trong InstantStreetView |
...
| `-SideBySide` | SwitchParameter | — | — | Named | — | Mở các cửa sổ trình duyệt cạnh nhau |
...
Mở InstantStreetView cho Times Square trong trình duyệt mặc định trên màn hình chính.
...
Mở InstantStreetView cho Tháp Eiffel bằng bí danh 'isv' và hiển thị trên màn hình phụ.
...
Mở InstantStreetView cho Big Ben bằng tiếng Anh sử dụng chế độ duyệt web riêng tư.
...
Mở nhiều truy vấn InstantStreetView qua pipeline trong trình duyệt Chrome, được đặt ở phía bên trái màn hình.

## Parameter Details

### `-Queries <String[]>`

> Các truy vấn vị trí để xem trong InstantStreetView
...
> Mở các cửa sổ trình duyệt cạnh nhau
