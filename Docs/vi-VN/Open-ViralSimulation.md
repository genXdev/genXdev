...
> Mở một trò chơi mô phỏng virus trong trình duyệt web với nhiều tùy chọn cấu hình.

## Description

Mở trò chơi mô phỏng virus tại https://viral.genxdev.net/ trong một trình duyệt web được chỉ định với các tùy chọn cài đặt cửa sổ, định vị và hành vi có thể cấu hình. Hỗ trợ nhiều trình duyệt, duyệt web riêng tư, chế độ ứng dụng và các tính năng quản lý cửa sổ toàn diện.

Hàm này cung cấp trải nghiệm mô phỏng virus tương tác với các tính năng như:
- Hỗ trợ nhiều trình duyệt (Edge, Chrome, Firefox)
- Các điều khiển định vị và kích thước cửa sổ
- Tùy chọn toàn màn hình và chế độ ứng dụng
- Khả năng duyệt web riêng tư
- Hỗ trợ tự động hóa bàn phím
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Language` | String | — | — | 0 | — | Ngôn ngữ hiển thị nội dung web và cài đặt ngôn ngữ trình duyệt |
...
| `-Monitor` | Int32 | — | — | Named | `-2` | Màn hình sử dụng, 0 = mặc định, -1 là bỏ qua, -2 = Màn hình phụ đã cấu hình, mặc định là $Global:DefaultSecondaryMonitor hoặc 2 nếu không tìm thấy |
...
Mở mô phỏng virus trong Google Chrome với chế độ duyệt web riêng tư và không toàn màn hình.
...
Mở mô phỏng lan truyền bằng bí danh với Chrome, chế độ ẩn danh và không toàn màn hình.

## Parameter Details

### `-Language <String>`

> Ngôn ngữ hiển thị nội dung web và cài đặt ngôn ngữ trình duyệt
