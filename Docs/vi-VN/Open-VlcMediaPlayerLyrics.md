...
> Mở trình duyệt web để tìm kiếm lời bài hát của tệp đa phương tiện đang phát trong VLC.

## Description

Chức năng này phát hiện xem VLC Media Player có đang chạy hay không và tìm kiếm lời bài hát dựa trên tiêu đề phương tiện đang phát. Nó tự động mở một truy vấn tìm kiếm trong trình duyệt web để tìm lời bài hát cho bản nhạc hiện tại. Chức năng hỗ trợ nhiều trình duyệt và cung cấp các tùy chọn định vị cửa sổ và hiển thị mở rộng.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Queries` | String[] | — | ✅ (ByValue, ByPropertyName) 🌐 Remaining | 0 | — | Các thuật ngữ tìm kiếm để tìm một bản nhạc |
| `-EndPoint` | String | — | — | 1 | `'Google'` | Điểm cuối để gọi truy vấn |
...
| `-SessionOnly` | SwitchParameter | — | — | Named | — | Sử dụng phiên không được duy trì sau khi đóng trình duyệt |
| `-ClearSession` | SwitchParameter | — | — | Named | — | Xóa dữ liệu phiên trình duyệt trước khi mở trình duyệt |
| `-SkipSession` | SwitchParameter | — | — | Named | — | Bỏ qua việc sử dụng phiên trình duyệt hiện có |
...
Mở tìm kiếm Google cho lời bài hát đang phát trong VLC.
...
Mở tìm kiếm lời bài hát trong Microsoft Edge bằng chế độ riêng tư/ẩn danh.

## Parameter Details

### `-Queries <String[]>`

> Các thuật ngữ tìm kiếm để tìm một bản nhạc
...
> Sử dụng phiên không được duy trì sau khi đóng trình duyệt
...
> Xóa dữ liệu phiên trình duyệt trước khi mở trình duyệt
...
> Bỏ qua việc sử dụng phiên trình duyệt hiện có
