...
> Mở thông tin trang web WaybackMachine trong trình duyệt web.

## Description

Mở một truy vấn Waybackmachine trong trình duyệt web, hiển thị các phiên bản lịch sử của URL hoặc trang web đã chỉ định. Hỗ trợ nhiều truy vấn và lựa chọn màn hình. Cung cấp quyền truy cập vào nội dung web đã lưu trữ thông qua dịch vụ Wayback Machine của Internet Archive.
...
| `-Language` | String | — | — | 1 | — | Ngôn ngữ ưu tiên cho giao diện và nội dung trình duyệt |
...
| `-SessionOnly` | SwitchParameter | — | — | Named | — | Sử dụng cài đặt thay thế được lưu trong phiên cho các tùy chọn Wayback Machine |
| `-ClearSession` | SwitchParameter | — | — | Named | — | Xóa các thiết lập thay thế đã lưu trong phiên làm việc cho sở thích Wayback Machine |
...
Mở kho lưu trữ Wayback Machine cho example.com trên màn hình mặc định.
...
Mở kho lưu trữ Wayback Machine cho example.com bằng cách sử dụng bí danh với vị trí màn hình bị loại bỏ.
...
Mở kho lưu trữ Wayback Machine cho microsoft.com trong chế độ ẩn danh của Chrome.
...
> Ngôn ngữ ưu tiên cho giao diện và nội dung trình duyệt
...
> Sử dụng cài đặt thay thế được lưu trong phiên cho các tùy chọn Wayback Machine
...
> Xóa các thiết lập thay thế đã lưu trong phiên làm việc cho sở thích Wayback Machine
