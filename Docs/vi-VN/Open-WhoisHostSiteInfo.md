...
> Mở một truy vấn thông tin máy chủ Whois trong trình duyệt web.

## Description

Mở các truy vấn thông tin máy chủ Whois trong trình duyệt web cho tên miền hoặc địa chỉ IP. Hỗ trợ lựa chọn màn hình có thể cấu hình và nhiều truy vấn với các tùy chọn cấu hình trình duyệt toàn diện bao gồm định vị cửa sổ, lựa chọn trình duyệt và các tính năng tự động hóa.
...
| `-SessionOnly` | SwitchParameter | — | — | Named | — | Sử dụng các thiết lập thay thế được lưu trong phiên làm việc cho các tùy chọn AI như Ngôn ngữ, Bộ sưu tập hình ảnh, v.v. |
| `-ClearSession` | SwitchParameter | — | — | Named | — | Xóa cài đặt thay thế rõ ràng được lưu trữ trong phiên cho các tùy chọn AI như Ngôn ngữ, Bộ sưu tập hình ảnh, v.v. |
| `-SkipSession` | SwitchParameter | — | — | Named | — | Chỉ lưu cài đặt vào tùy chọn liên tục mà không ảnh hưởng đến phiên làm việc cho các tùy chọn AI như Ngôn ngữ, Bộ sưu tập hình ảnh, v.v. |
...
Mở thông tin Whois cho nhiều tên miền trên màn hình mặc định.
...
Mở thông tin Whois cho example.com bằng cách sử dụng bí danh và tham số vị trí.
...
Mở thông tin Whois cho các tên miền từ pipeline trong chế độ riêng tư của Chrome.
...
> Sử dụng các thiết lập thay thế được lưu trong phiên làm việc cho các tùy chọn AI như Ngôn ngữ, Bộ sưu tập hình ảnh, v.v.
...
> Xóa cài đặt thay thế rõ ràng được lưu trữ trong phiên cho các tùy chọn AI như Ngôn ngữ, Bộ sưu tập hình ảnh, v.v.
...
> Chỉ lưu cài đặt vào tùy chọn liên tục mà không ảnh hưởng đến phiên làm việc cho các tùy chọn AI như Ngôn ngữ, Bộ sưu tập hình ảnh, v.v.
