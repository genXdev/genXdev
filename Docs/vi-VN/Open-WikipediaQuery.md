...
> Mở một truy vấn Wikipedia trong trình duyệt web.

## Description

Mở một hoặc nhiều truy vấn tìm kiếm Wikipedia trong trình duyệt web với các tùy chọn cấu hình mở rộng. Hỗ trợ hành vi trình duyệt có thể cấu hình, lựa chọn màn hình và định vị cửa sổ. Các truy vấn được mã hóa URL và mở bằng tên miền Wikipedia của ngôn ngữ đã chỉ định với hỗ trợ bản địa hóa đầy đủ.

Chức năng cung cấp khả năng kiểm soát trình duyệt toàn diện bao gồm chế độ duyệt web riêng tư, định vị cửa sổ, tự động hóa bàn phím và hỗ trợ nhiều màn hình. Nó tự động xử lý mã hóa URL và ánh xạ mã ngôn ngữ cho các tên miền Wikipedia quốc tế.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Queries` | String[] | ✅ | ✅ (ByValue, ByPropertyName) | 0 | — | Truy vấn tìm kiếm Wikipedia cần thực hiện |
| `-Language` | String | — | — | 1 | — | Ngôn ngữ của kết quả tìm kiếm Wikipedia |
...
| `-PassThru` | SwitchParameter | — | — | Named | — | Trả về một đối tượng xử lý PowerShell đại diện cho quy trình trình duyệt |
...
| `-SessionOnly` | SwitchParameter | — | — | Named | — | Sử dụng cài đặt thay thế được lưu trong phiên cho các tùy chọn AI. |
| `-ClearSession` | SwitchParameter | — | — | Named | — | Xóa các thiết lập thay thế được lưu trong phiên làm việc cho các tùy chọn AI. |
| `-SkipSession` | SwitchParameter | — | — | Named | — | Chỉ lưu cài đặt vào tùy chọn cố định mà không ảnh hưởng đến phiên làm việc. |
...
Mở tìm kiếm Wikipedia cho "PowerShell" bằng tiếng Anh trên màn hình mặc định.
...
Mở tìm kiếm Wikipedia bằng cách sử dụng bí danh với tham số vị trí.
...
Tìm kiếm nhiều thuật ngữ trên Wikipedia tiếng Đức bằng chế độ duyệt web riêng tư.

## Parameter Details

### `-Queries <String[]>`

> Truy vấn tìm kiếm Wikipedia cần thực hiện
...
> Ngôn ngữ của kết quả tìm kiếm Wikipedia
...
> Trả về một đối tượng xử lý PowerShell đại diện cho quy trình trình duyệt
...
> Sử dụng cài đặt thay thế được lưu trong phiên cho các tùy chọn AI.
...
> Xóa các thiết lập thay thế được lưu trong phiên làm việc cho các tùy chọn AI.
