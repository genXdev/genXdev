...
> Mở trò chơi YAB trong trình duyệt web với các cài đặt có thể cấu hình.

## Description

Mở trang web trò chơi YAB trong trình duyệt đã chỉ định với các tùy chọn hiển thị và hành vi khác nhau. Hỗ trợ các chế độ chơi khác nhau bao gồm chế độ khán giả. Trò chơi YAB là một trò chơi giải đố trực tuyến có thể chơi tương tác hoặc xem ở chế độ khán giả nơi AI tự động chơi.
...
Mở trò chơi YAB ở chế độ khán giả bằng trình duyệt Chrome, không toàn màn hình, với giao diện ngôn ngữ tiếng Anh.
...
Mở trò chơi YAB trong trình duyệt Edge ở chế độ duyệt web riêng tư trên màn hình 2 bằng cách sử dụng bí danh để truy cập nhanh.
