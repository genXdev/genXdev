...
> Mở trò chơi YabAI Battle trong trình duyệt web.

## Description

Hàm này khởi chạy trò chơi YabAI Battle trong trình duyệt web với các tùy chọn tùy chỉnh mở rộng cho vị trí cửa sổ, lựa chọn trình duyệt và chế độ hiển thị. Nó cung cấp một lớp bọc quanh hàm GenXdev\Open-Webbrowser với việc xây dựng URL dành riêng cho trò chơi và xử lý tham số.

Hàm hỗ trợ hai chế độ trò chơi:
- Chế độ Battle: Bắt đầu trận đấu AI vs AI mới
- Chế độ Spectate: Xem các trận đấu AI hiện có

Các tùy chọn định vị trình duyệt bao gồm chế độ trái, phải, trên, dưới, căn giữa và toàn màn hình với hỗ trợ nhiều màn hình. Hàm tự động xử lý cài đặt chế độ ứng dụng và quản lý tiện ích mở rộng trình duyệt để có trải nghiệm chơi game tối ưu.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Language` | String | — | — | 0 | — | Ngôn ngữ của giao diện trò chơi |
...
| `-SendKeyDelayMilliSeconds` | Int32 | — | — | Named | — | Độ trễ tính bằng mili giây giữa mỗi lần gửi phím. |
...
| `-RestoreFocus` | SwitchParameter | — | — | Named | — | Khôi phục tiêu điểm về cửa sổ trước đó sau khi mở trình duyệt. |
...
Mở trò chơi YabAI Battle trong Microsoft Edge bằng chế độ duyệt web riêng tư mà không toàn màn hình.
...
Mở trò chơi bằng cách sử dụng bí danh cho Edge, chế độ ẩn danh và không toàn màn hình.
...
Mở trò chơi ở chế độ xem sử dụng Google Chrome để xem các trận đấu AI.
...
Mở trò chơi với giao diện ngôn ngữ Tây Ban Nha được đặt ở bên trái màn hình 1.

## Parameter Details

### `-Language <String>`

> Ngôn ngữ của giao diện trò chơi
...
> Độ trễ tính bằng mili giây giữa mỗi lần gửi phím.
...
> Khôi phục tiêu điểm về cửa sổ trước đó sau khi mở trình duyệt.
