...
> Đẩy cửa sổ hiện tại lên ngăn xếp cửa sổ với các sửa đổi tùy chọn.

## Description

Đẩy một trình trợ giúp cửa sổ cho cửa sổ đang được tập trung lên ngăn xếp.
Cho phép áp dụng các biến đổi cửa sổ khác nhau trước hoặc sau khi đẩy.
Hàm này chụp cửa sổ hiện tại và lưu trữ nó để truy xuất sau
với Pop-Window, đồng thời tùy chọn áp dụng định vị, kích thước và hiệu ứng
hình ảnh.
