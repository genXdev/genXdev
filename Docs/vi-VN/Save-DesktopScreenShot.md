...
> Chụp ảnh màn hình của màn hình được chỉ định và lưu vào đường dẫn đã chỉ định.

## Description

* Chụp ảnh màn hình desktop từ màn hình được chỉ định và lưu thành tệp ảnh.
* Hỗ trợ nhiều màn hình và tự động phát hiện ranh giới màn hình chính xác cũng như tỷ lệ thu phóng cho màn hình có độ phân giải cao (high-DPI).
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Monitor` | Int32 | ✅ | ✅ (ByPropertyName) | 0 | `0` | Chỉ mục màn hình để ghi (0=màn hình chính, 1+=màn hình cụ thể, -1=tất cả các màn hình) |
| `-OutputPath` | String | ✅ | ✅ (ByPropertyName) | 1 | — | Đường dẫn đầy đủ nơi ảnh chụp màn hình sẽ được lưu |
| `-Quality` | Int32 | — | — | Named | `0` | Mức chất lượng JPEG (1-100), chỉ áp dụng cho định dạng JPEG |
...
Chụp ảnh màn hình của màn hình chính và lưu dưới dạng PNG.
...
Chụp ảnh màn hình của màn hình thứ hai với chất lượng JPEG cao.
...
Chụp tất cả màn hình kết hợp thành một ảnh chụp màn hình duy nhất.

## Parameter Details

### `-Monitor <Int32>`

> Chỉ mục màn hình để ghi (0=màn hình chính, 1+=màn hình cụ thể, -1=tất cả các màn hình)
...
> Đường dẫn đầy đủ nơi ảnh chụp màn hình sẽ được lưu
...
> Mức chất lượng JPEG (1-100), chỉ áp dụng cho định dạng JPEG
