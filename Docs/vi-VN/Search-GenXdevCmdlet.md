...
> Tìm kiếm lệnh ghép ngắn GenXdev và tùy chọn mở nó trong IDE để chỉnh sửa.

## Description

Hàm này tìm kiếm các lệnh ghép ngắn của GenXdev sử dụng một mẫu và tùy chọn mở tệp nguồn của lệnh ghép ngắn được tìm thấy trong Visual Studio Code hoặc Visual Studio để chỉnh sửa. Nó truy xuất thông tin lệnh ghép ngắn và cung cấp các phím tắt để nhanh chóng điều hướng đến định nghĩa hàm.
...
| `-OnlyPublished` | SwitchParameter | — | — | Named | — | Giới hạn tìm kiếm chỉ trong các đường dẫn mô-đun đã được xuất bản |
| `-FromScripts` | SwitchParameter | — | — | Named | — | Tìm kiếm trong các tệp lệnh thay vì các tệp mô-đun |
| `-Code` | SwitchParameter | — | — | Named | — | Mở cmdlet đã tìm thấy trong Visual Studio Code |
| `-VisualStudio` | SwitchParameter | — | — | Named | — | Mở cmdlet đã tìm thấy trong Visual Studio |
| `-EditCmdlet` | SwitchParameter | — | — | Named | — | Cũng mở tệp trong trình soạn thảo sau khi tìm thấy |
...
> Giới hạn tìm kiếm chỉ trong các đường dẫn mô-đun đã được xuất bản
...
> Mở cmdlet đã tìm thấy trong Visual Studio Code
...
> Mở cmdlet đã tìm thấy trong Visual Studio
...
> Cũng mở tệp trong trình soạn thảo sau khi tìm thấy
