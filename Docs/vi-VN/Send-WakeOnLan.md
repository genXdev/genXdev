...
> Gửi một gói tin ma thuật Wake-on-LAN để đánh thức các máy tính từ xa trên mạng.

## Description

Xây dựng và phát gói tin ma thuật Wake-on-LAN (WOL) đến (các) địa chỉ MAC được chỉ định. Gói tin ma thuật là một broadcast UDP chứa địa chỉ MAC mục tiêu được lặp lại 16 lần, kích hoạt các giao diện mạng được hỗ trợ để bật nguồn máy tính. Hỗ trợ địa chỉ broadcast và cổng tùy chỉnh.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-MacAddress` | String[] | ✅ | ✅ (ByValue, ByPropertyName) | 0 | — | Một hoặc nhiều địa chỉ MAC để gửi gói tin ma thuật tới (ví dụ: 00:11:22:33:44:55) |
| `-BroadcastAddress` | String | — | — | 1 | `"255.255.255.255"` | Địa chỉ IP phát để gửi gói tin ma thuật tới (mặc định: 255.255.255.255) |
| `-Port` | Int32 | — | — | 2 | `4000` | Cổng UDP để gửi gói tin ma thuật (mặc định: 4000) |
...
Gửi một gói tin ma thuật để đánh thức máy tính có địa chỉ MAC được chỉ định.
...
Gửi gói tin ma thuật đến nhiều máy tính qua cổng 9 thông qua đầu vào pipeline.

## Parameter Details

### `-MacAddress <String[]>`

> Một hoặc nhiều địa chỉ MAC để gửi gói tin ma thuật tới (ví dụ: 00:11:22:33:44:55)
...
> Địa chỉ IP phát để gửi gói tin ma thuật tới (mặc định: 255.255.255.255)
...
> Cổng UDP để gửi gói tin ma thuật (mặc định: 4000)
