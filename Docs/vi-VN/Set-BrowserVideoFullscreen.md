...
> Phóng to video đầu tiên được tìm thấy trong tab trình duyệt hiện tại.

## Description

Thực thi mã JavaScript để xác định vị trí và phóng to phần tử video đầu tiên trên trang web hiện tại. Video được thiết lập để bao phủ toàn bộ khung nhìn với chỉ số z tối đa nhằm đảm bảo hiển thị. Các thanh cuộn trang bị ẩn để có trải nghiệm toàn màn hình sạch sẽ.
