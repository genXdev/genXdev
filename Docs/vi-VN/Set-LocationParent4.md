...
> Điều hướng lên bốn cấp thư mục trong hệ thống phân cấp hệ thống tệp tin.

## Description

* Di chuyển lên bốn cấp thư mục từ vị trí hiện tại trong hệ thống tệp.
* Sau khi di chuyển, hiển thị nội dung của thư mục kết quả.
...
Di chuyển lên bốn cấp thư mục từ vị trí hiện tại.
...
Sử dụng bí danh để điều hướng lên bốn cấp thư mục.
