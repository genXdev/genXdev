...
> Định vị và thay đổi kích thước cửa sổ khi các tham số định vị rõ ràng được cung cấp.

## Description

Cung cấp khả năng kiểm soát chính xác vị trí và kích thước cửa sổ khi các tham số định vị được chỉ định. Hỗ trợ nhiều màn hình, loại bỏ viền và nhiều vị trí đặt sẵn như chia trái/phải, chia trên/dưới và đặt ở giữa. Cửa sổ có thể được định vị bằng tọa độ hoặc sử dụng bố cục được xác định trước. Nếu không có tham số định vị, hàm sẽ không thực hiện hành động nào trên cửa sổ.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-ProcessName` | String | — | ✅ (ByValue, ByPropertyName) | 0 | — | Tên tiến trình của cửa sổ cần định vị *(Parameter set: )* 🌐 *Supports wildcards* |
| `-Process` | Diagnostics.Process | — | ✅ (ByValue, ByPropertyName) | Named | — | Quy trình đặt vị trí của cửa sổ *(Parameter set: )* |
| `-WindowHelper` | GenXdev.Helpers.WindowObj[] | — | ✅ (ByValue, ByPropertyName) | Named | — | Đối tượng trợ giúp Get-Window để thao tác trực tiếp với cửa sổ *(Parameter set: )* |
| `-Monitor` | Int32 | — | — | Named | `-1` | Lựa chọn màn hình: 0=màn hình chính, 1+=màn hình cụ thể, -1=hiện tại, -2=màn hình phụ |
| `-NoBorders` | SwitchParameter | — | — | Named | — | Loại bỏ các đường viền của cửa sổ |
| `-Width` | Int32 | — | — | Named | `-1` | Chiều rộng cửa sổ tính bằng pixel |
| `-Height` | Int32 | — | — | Named | `-999999` | Chiều cao cửa sổ tính bằng pixel |
| `-X` | Int32 | — | — | Named | `-999999` | Vị trí ngang của cửa sổ tính bằng pixel |
| `-Y` | Int32 | — | — | Named | `-999999` | Vị trí dọc của cửa sổ tính bằng pixel |
...
| `-Fullscreen` | SwitchParameter | — | — | Named | — | Phóng to cửa sổ |
...
| `-FocusWindow` | SwitchParameter | — | — | Named | — | Lấy tiêu điểm cửa sổ sau khi mở |
| `-SetForeground` | SwitchParameter | — | — | Named | — | Đưa cửa sổ lên nền trước sau khi mở |
...
> Tên tiến trình của cửa sổ cần định vị
...
> Đối tượng trợ giúp Get-Window để thao tác trực tiếp với cửa sổ
...
> Lựa chọn màn hình: 0=màn hình chính, 1+=màn hình cụ thể, -1=hiện tại, -2=màn hình phụ
...
> Chiều rộng cửa sổ tính bằng pixel
...
> Chiều cao cửa sổ tính bằng pixel
...
> Vị trí ngang của cửa sổ tính bằng pixel
...
> Vị trí dọc của cửa sổ tính bằng pixel
...
> Lấy tiêu điểm cửa sổ sau khi mở
...
> Đưa cửa sổ lên nền trước sau khi mở
