...
> Mở một URL trong nhiều trình duyệt cùng lúc với bố cục hình khảm.

## Description

Hàm này tạo bố cục dạng lưới cho các cửa sổ trình duyệt bằng cách mở URL đã chỉ định trong Chrome, Edge, Firefox và cửa sổ duyệt web riêng tư. Các trình duyệt được sắp xếp theo mẫu lưới 2x2:
- Chrome: Góc trên bên trái
- Edge: Góc dưới bên trái
- Firefox: Góc trên bên phải
- Cửa sổ riêng tư: Góc dưới bên phải

Tất cả các tham số từ Open-Webbrowser đều được hỗ trợ và truyền qua để kiểm soát vị trí, hành vi và giao diện của trình duyệt. Hàm này hoạt động như một trình bao bọc áp dụng định vị góc phần tư nhất quán trong khi cho phép tùy chỉnh đầy đủ các tham số khởi chạy trình duyệt.
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Url` | String | ✅ | ✅ (ByValue, ByPropertyName) | 0 | — | Các URL cần mở đồng thời trong tất cả các trình duyệt |
| `-Monitor` | Int32 | — | — | Named | `-1` | Màn hình sử dụng, 0 = mặc định, -1 là bỏ qua, -2 = Màn hình phụ đã cấu hình, mặc định là $Global:DefaultSecondaryMonitor hoặc 2 nếu không tìm thấy |
...
> Các URL cần mở đồng thời trong tất cả các trình duyệt
