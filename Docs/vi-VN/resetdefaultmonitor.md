...
> Khôi phục cấu hình màn hình phụ mặc định.

## Description

Tập lệnh này khôi phục cấu hình màn hình phụ mặc định cho hệ thống,
đặt màn hình phụ về giá trị mặc định ban đầu.
Điều này hữu ích cho người dùng muốn quay lại thiết lập nhiều màn hình trước đó sau khi sử dụng cấu hình song song.
Xem thêm: hàm 'sidebyside' để chuyển đổi sang chế độ song song cho các cửa sổ mới.
...
Khôi phục cấu hình màn hình phụ mặc định cho hệ thống.
