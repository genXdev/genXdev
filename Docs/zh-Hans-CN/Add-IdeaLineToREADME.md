...
> 向 README.md 文件添加一个想法项。

## Description

向 README.md 文件的 "## 想法" 部分添加带时间戳的想法。可以显示修改后的部分并在 Visual Studio Code 中打开。
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Line` | String | — | — | 0 | `''` | .PARAMETER Type
	指定要向其中添加数据的容器类型类型，容器类型类型为枚举：File、Folder、RegistryKey、RegistryValue |
...
> 在 Visual Studio Code 中打开 README
