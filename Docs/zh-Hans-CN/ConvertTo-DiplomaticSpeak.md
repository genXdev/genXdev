...
> The user has provided a set of instructions, but the instructions themselves are not the content to be translated. The actual content to be translated is missing from the input. Please provide the text you wish to have translated.

## Description

该功能将用户输入的直白或生硬措辞转化为适用于高层讨论、谈判或正式交流的外交辞令、得体语言。该功能利用AI语言模型在保持原始意图的同时，软化语气，使信息更具外交风范和专业性。
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Text` | String | — | ✅ (ByValue) | 0 | — | We have carefully considered your proposal and believe there are some areas that may benefit from further discussion to ensure mutual understanding and alignment. We would welcome the opportunity to explore alternative approaches that could better serve our shared interests. |
...
> We have carefully considered your proposal and believe there are some areas that may benefit from further discussion to ensure mutual understanding and alignment. We would welcome the opportunity to explore alternative approaches that could better serve our shared interests.
