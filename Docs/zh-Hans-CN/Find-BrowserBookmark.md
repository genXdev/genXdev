...
在 Microsoft Edge、Google Chrome 或 Mozilla Firefox 的收藏夹中搜索。
返回名称、URL 或文件夹路径中包含一个或多个搜索查询的收藏夹。如果未提供查询，则返回所选浏览器的所有收藏夹。
...
| `-Edge` | SwitchParameter | — | — | Named | — | 搜索 Microsoft Edge 书签 |
| `-Chrome` | SwitchParameter | — | — | Named | — | 在谷歌浏览器书签中搜索 |
| `-Firefox` | SwitchParameter | — | — | Named | — | 在 Firefox 书签中搜索 |
| `-Count` | Int32 | — | — | Named | `99999999` | 要返回的最大结果数 |
| `-PassThru` | SwitchParameter | — | — | Named | — | 返回书签对象，而不仅仅是URL |
