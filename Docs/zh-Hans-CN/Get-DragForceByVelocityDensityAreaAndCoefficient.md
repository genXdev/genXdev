...
| `-AreaInSquareMeters` | Double | ✅ | — | 2 | `0` | 以平方米为单位的横截面积 |
| `-Coefficient` | Double | ✅ | — | 3 | `0` | 阻力系数 |
| `-As` | String | — | — | 4 | — | 力的输出单位 |
...
使用速度 10 m/s、空气密度 1.225 kg/m³、面积 1 m² 和系数 0.5 计算阻力，以磅力输出。
...
使用位置参数计算阻力：速度 20 m/s，密度 1.225 kg/m³，面积 2 m²，系数 0.3。
