...
| `-AudioTemperature` | Double | — | — | Named | — | 音频响应随机性的温度参数。 |
| `-TemperatureResponse` | Double | — | — | Named | — | 文本响应随机性的温度参数。 |
| `-Language` | String | — | — | Named | — | 响应语言代码或标识符。 |
...
| `-DontSpeakThoughts` | SwitchParameter | — | — | Named | — | 对思考过程禁用语音输出。 |
