...
在网页浏览器中打开ChatGPT，自动输入指定的查询并提交。支持多个查询，这些查询将使用底层的Open-WebsiteAndPerformQuery函数执行。此函数提供了一种便捷的方式，通过PowerShell与OpenAI的ChatGPT交互，并带有广泛的浏览器配置选项。
...
| `-ShowWindow` | SwitchParameter | — | — | Named | — | 显示浏览器窗口 |
