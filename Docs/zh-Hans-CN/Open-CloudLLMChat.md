...
此函数提供了一个统一接口，用于在网页浏览器中打开各种基于云的AI聊天服务。它支持多种AI平台，包括ChatGPT、BingCopilot、Google Gemini、X Grok、DeepSearch和GitHub Copilot。该函数会自动选择合适的端点特定函数，并传递所有相关的浏览器配置和窗口定位参数。
...
| `-EndPoint` | String | — | — | 1 | `'XGrok'` | 用于执行查询的端点 |
