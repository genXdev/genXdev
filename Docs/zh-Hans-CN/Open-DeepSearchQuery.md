...
> 在网页浏览器中打开 DeepSeek 查询

## Description

在网页浏览器中打开 DeepSeek 查询，输入查询内容并按下回车键以执行搜索。此功能利用 DeepSeek AI 搜索引擎为所提供的查询提供智能答案和见解。
...
使用默认设置打开DeepSeek并搜索“powershell function”。
...
在主显示器上以全屏模式打开 DeepSeek，搜索“机器学习基础”。
...
- [Open-BingCopilotQuery](https://github.com/genXdev/genXdev/blob/main/Docs/zh-Hans-CN/Open-BingCopilotQuery.md)
