...
> 在网络浏览器中打开 Google Gemini 查询

## Description

在网络浏览器中打开 Google Gemini 查询，自动输入查询并提交。这提供了一种与 Google 的 Gemini AI 交互的快速方式。该函数支持广泛的浏览器控制，包括显示器选择、窗口定位和键盘自动化功能。
...
打开 Google Gemini 并提交查询“什么是 PowerShell？”。
