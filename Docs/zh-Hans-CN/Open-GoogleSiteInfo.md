...
> 在网络浏览器中打开 Google 站点信息查询。

## Description

在网页浏览器中打开与指定域名的站点信息相关的多个Google搜索查询（site:、link:、related:）。
...
| `-SessionOnly` | SwitchParameter | — | — | Named | — | 对浏览器配置文件使用仅会话模式（无持久数据） |
| `-ClearSession` | SwitchParameter | — | — | Named | — | 打开浏览器前清除会话/配置文件数据 |
| `-SkipSession` | SwitchParameter | — | — | Named | — | 跳过使用浏览器会话/配置文件（使用默认） |
