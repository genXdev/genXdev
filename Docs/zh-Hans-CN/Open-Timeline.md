...
> 打开一个互动时间线，显示当前时间、日期、世纪和千年。

## Description

打开一个基于Web的交互式时间线。支持多种语言和视觉自定义选项。
...
| `-BrowserExtensions` | SwitchParameter | — | — | Named | — | 不要阻止加载浏览器扩展 |
...
| `-Language` | String | — | — | 1 | — | 覆盖默认浏览器语言，或选择[全部]以便每分钟轮换所有语言 |
| `-DragedNodeBackground` | String | — | — | Named | `$null` | 覆盖用于绘制当前拖拽节点背景的CSS颜色样式 |
| `-FocusedNodeBackground` | String | — | — | Named | `$null` | 覆盖用于绘制聚焦节点（中心）背景的css颜色样式 |
| `-FocusedNodeForeground` | String | — | — | Named | `$null` | 覆盖用于绘制聚焦节点（居中）前景文本的 css-color-style |
| `-UnFocusedNodeBackground` | String | — | — | Named | `$null` | 覆盖用于绘制聚焦节点（中心）背景的css颜色样式 |
| `-UnFocusedNodeForeground` | String | — | — | Named | `$null` | 覆盖用于绘制未聚焦节点（在中心）前景文本的 css-color-style |
| `-BorderLightColor` | String | — | — | Named | `$null` | 覆盖默认 CSS 边框光色的颜色样式 |
| `-BorderDarkColor` | String | — | — | Named | `$null` | 覆盖默认的CSS边框深色颜色样式 |
...
> 覆盖用于绘制聚焦节点（居中）前景文本的 css-color-style
...
> 覆盖用于绘制未聚焦节点（在中心）前景文本的 css-color-style
