...
> 在网络浏览器中打开一款病毒模拟游戏，提供丰富的配置选项。

## Description

在指定的网络浏览器中打开位于 https://viral.genxdev.net/ 的病毒模拟游戏，支持可配置的窗口设置、定位和行为选项。支持多种浏览器、隐私浏览、应用模式以及全面的窗口管理功能。

该函数提供交互式病毒模拟体验，具有以下特点：
...
使用别名在 Chrome 浏览器中以隐身模式（不全屏）打开病毒模拟程序。
