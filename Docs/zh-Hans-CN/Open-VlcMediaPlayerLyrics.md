...
> 打开网页浏览器，搜索当前正在播放的VLC媒体的歌词。

## Description

此函数检测 VLC 媒体播放器是否正在运行，并根据当前播放的媒体标题搜索歌词。它会在网页浏览器中自动打开搜索查询，以查找当前曲目的歌词。该函数支持多种浏览器，并提供丰富的窗口定位和显示选项。
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Queries` | String[] | — | ✅ (ByValue, ByPropertyName) 🌐 Remaining | 0 | — | 用于查找曲目的搜索词 |
...
| `-SessionOnly` | SwitchParameter | — | — | Named | — | 使用一个在关闭浏览器后不会持久化的会话 |
...
在 Microsoft Edge 中使用隐私/无痕模式打开歌词搜索。
