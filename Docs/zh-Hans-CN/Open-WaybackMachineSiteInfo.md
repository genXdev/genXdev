...
> 在网页浏览器中打开 Wayback Machine 网站信息。

## Description

在网络浏览器中打开Wayback Machine查询，显示指定URL或网站的历史版本。支持多次查询和监控选择。通过互联网档案馆的Wayback Machine服务提供对存档网络内容的访问。
...
| `-SessionOnly` | SwitchParameter | — | — | Named | — | 使用会话中存储的替代设置来配置Wayback Machine偏好 |
| `-ClearSession` | SwitchParameter | — | — | Named | — | 清除存储在会话中的 Wayback Machine 偏好设置的替代设置 |
...
打开默认监视器上 example.com 的 Wayback Machine 存档。
...
使用别名打开 example.com 的 Wayback Machine 存档，并丢弃定位监控。
...
以Chrome浏览器的隐身模式打开microsoft.com的Wayback Machine存档。
