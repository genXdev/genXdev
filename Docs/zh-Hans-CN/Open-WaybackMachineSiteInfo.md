...
> 在 Web 浏览器中打开 WaybackMachine 网站信息。

## Description

在网页浏览器中打开Waybackmachine查询，显示指定URL或网站的历史版本。支持多个查询和监控选择。通过互联网档案馆的Wayback Machine服务提供对存档网页内容的访问。
...
| `-Language` | String | — | — | 1 | — | 浏览器界面和内容的语言偏好 |
...
| `-SessionOnly` | SwitchParameter | — | — | Named | — | 对 Wayback Machine 偏好设置使用会话中存储的替代设置 |
| `-ClearSession` | SwitchParameter | — | — | Named | — | 清除会话中存储的Wayback Machine偏好设置的备用选项 |
...
在默认监视器上打开 example.com 的 Wayback Machine 存档。
...
使用别名打开 example.com 的 Wayback Machine 存档，并放弃监视器定位。
...
在 Chrome 的无痕模式下打开 microsoft.com 的 Wayback Machine 存档。
...
> 对 Wayback Machine 偏好设置使用会话中存储的替代设置
...
> 清除会话中存储的Wayback Machine偏好设置的备用选项
