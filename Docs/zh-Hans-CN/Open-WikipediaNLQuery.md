...
在网页浏览器中打开“荷兰 - 维基百科”查询，具有可配置的显示选项。支持搜索多个术语，并指定在哪个显示器上显示结果。
...
| `-NoBorders` | SwitchParameter | — | — | Named | — | 从浏览器窗口中移除窗口边框 |
| `-SideBySide` | SwitchParameter | — | — | Named | — | 并排打开两个浏览器窗口 |
| `-SessionOnly` | SwitchParameter | — | — | Named | — | 仅使用会话Cookie（无持久性Cookie） |
| `-ClearSession` | SwitchParameter | — | — | Named | — | 在打开前清除浏览器会话数据 |
