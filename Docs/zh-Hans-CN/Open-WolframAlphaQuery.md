...
> 在网络浏览器中打开 Wolfram Alpha 查询。

## Description

在网页浏览器中打开一个或多个 Wolfram Alpha 查询。支持通过动态参数配置监视器选择和浏览器选项。提供全面的浏览器控制功能，包括定位、调整大小和自动化能力，以增强科学计算工作流程。
...
在默认显示器上打开关于太阳质量的 Wolfram Alpha 查询。
...
使用别名打开多个 Wolfram Alpha 查询，以快速进行科学计算。
