...
> 通过可配置设置在网络浏览器中打开YAB游戏。

## Description

在指定的浏览器中打开YAB游戏网站，提供多种显示和行为选项。支持不同的游戏模式，包括观众模式。YAB游戏是一款在线拼图游戏，可以互动游玩，也可以在观众模式下观看AI自动游戏。
...
使用Chrome浏览器以观战模式打开YAB游戏，不进入全屏，界面语言为英语。
...
在显示器2上使用Edge浏览器的隐私模式打开YAB游戏，并使用别名快速访问。
