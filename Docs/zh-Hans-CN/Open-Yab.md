...
> 在网页浏览器中打开YAB游戏，并提供可配置设置。

## Description

在指定浏览器中打开 YAB 游戏网站，支持多种显示和行为选项。支持不同的游戏模式，包括旁观模式。YAB 游戏是一款在线益智游戏，可以互动游玩，也可以在旁观模式下观看人工智能自动进行游戏。
...
| `-Monitor` | Int32 | — | — | Named | `-2` | 要使用的显示器，0 = 默认，-1 = 丢弃，-2 = 已配置的辅助显示器，默认值为 -1，无定位 |
| `-FullScreen` | SwitchParameter | — | — | Named | — | 以全屏模式打开 |
| `-ShowWindow` | SwitchParameter | — | — | Named | — | 显示浏览器窗口（非最小化或隐藏状态） |
...
使用Chrome浏览器以观众模式打开YAB游戏，不启用全屏，界面语言为英语。
...
在Edge浏览器中以隐私浏览模式在监视器2上打开YAB游戏，使用别名以便快速访问。
...
- [Open-YabAIBattle](https://github.com/genXdev/genXdev/blob/main/Docs/zh-Hans-CN/Open-YabAIBattle.md)
