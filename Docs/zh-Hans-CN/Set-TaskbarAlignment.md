...
> 配置 Windows 11+ 任务栏对齐方式，在居中和左对齐之间切换。

## Description

通过修改 HKCU:\SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer\Advanced 下的注册表项 'TaskbarAl'，在 Windows 11 及更新版本中设置任务栏对齐方式。对齐方式可设置为居中（值 1）或左对齐（值 0）。
...
|:---|:---|:---:|:---|:---:|:---|:---|
| `-Justify` | String | ✅ | — | 0 | — | 任务栏对齐方式（居中或左侧） |
