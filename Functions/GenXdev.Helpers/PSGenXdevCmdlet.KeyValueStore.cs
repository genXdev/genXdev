...
public abstract partial class PSGenXdevCmdlet : PSCmdlet
{
        ...
        string DatabasePath = null)
    {
        ...
        foreach (string filename in allFilenames)
        {
            ...
            // Write merged data to local path (always, immediate)
            WriteJsonAtomic(localFilePath, mergedData);

            // OneDrive shadow: debounced at 10s. Each call resets the timer;
            // the write fires once the shadow file hasn't been touched for
            // 10 seconds. Guaranteed eventual write, never skipped.
            WriteJsonAtomic(shadowFilePath, mergedData, debounceMs: 10000);
        }
