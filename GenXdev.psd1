@{
    ...
    GUID                 = '2f620801-0483-4628-8497-b3d433b65172'
    ...
    Description          = 'GenXdev PowerShell Utilities and helpers'
    ...
    RequiredModules      = @(
        ...
        @{ModuleName = 'GenXdev.Coding'; ModuleVersion = '3.3.2026'; },
        @{ModuleName = 'GenXdev.Media'; ModuleVersion = '3.3.2026'; }
    )
