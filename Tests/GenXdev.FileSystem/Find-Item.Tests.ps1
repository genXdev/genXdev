Pester\Describe 'Find-Item 1' {
    ...
    Pester\AfterAll {
        ...
        GenXdev\Remove-AllItems $tempDriveDir -DeleteFolder
    }
    ...
    Pester\AfterEach {
        ...
        GenXdev\Remove-AllItems $testDir
    }
    ...
    Pester\It 'Should match the pattern' {
        ...
        $found = @(GenXdev\Find-Item -SearchMask "$PSScriptRoot\..\..\..\..\..\**\Genx*\3.26.2026\Functions\GenXdev*\*.cs" -PassThru | Microsoft.PowerShell.Utility\Select-Object -ExpandProperty FullName)
